  ...
  qx.Mixin.define("qx.core.MLogging", {
    members: {
      ...
      debug: function debug(varargs) {
        this.__P_172_1("debug", arguments);
      },
      /**
      ...
      error: function error(varargs) {
        this.__P_172_1("error", arguments);
      },
      /**
      ...
      trace: function trace(varargs) {
        this.__P_172_1("trace", arguments);
      },
      /**
       ...
       */
      __P_172_1: function __P_172_1(level, varargs) {
        var argumentsArray = qx.lang.Array.fromArguments(varargs);
        argumentsArray.unshift(this);
        this.__P_172_0[level].apply(this.__P_172_0, argumentsArray);
      }
    }
  });
...
//# sourceMappingURL=MLogging.js.map?dt=1731948102685