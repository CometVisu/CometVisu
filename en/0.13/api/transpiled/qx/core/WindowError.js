  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_168_0 = failMessage;
      this.__P_168_1 = uri || "";
      this.__P_168_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_168_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_168_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
...
//# sourceMappingURL=WindowError.js.map?dt=1672653488930