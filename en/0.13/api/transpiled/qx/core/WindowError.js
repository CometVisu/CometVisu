  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_178_0 = failMessage;
      this.__P_178_1 = uri || "";
      this.__P_178_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_178_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_178_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
...
//# sourceMappingURL=WindowError.js.map?dt=1735222417408