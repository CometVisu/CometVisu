  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    ...
    members: {
      __P_175_0: true ? qx.core.Property : null,
      /*
      ---------------------------------------------------------------------------
        BASICS
      ---------------------------------------------------------------------------
      ...
      */
      ...
      clone: function clone() {
        ...
        var user = this.__P_175_0.$$store.user;
        var setter = this.__P_175_0.$$method.set;
        var name;
    ...
    */
    destruct: function destruct() {
      ...
      // only of properties are available
      {
        ...
        var clazz = this.constructor;
        var properties;
        var store = this.__P_175_0.$$store;
...
//# sourceMappingURL=Object.js.map?dt=1735222417262