  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_168_5: function __P_168_5(inheritables) {
       ...
       */
      __P_168_6: function __P_168_6(clazz, config, name) {
       ...
       */
      __P_168_14: function __P_168_14(clazz, name, variant) {
       ...
       * @return {String[]} the string builder array
       */
      __P_168_15: function __P_168_15(clazz, name, variant) {
        var config = clazz.$$properties[name];
        var members = clazz.prototype;
        var code = [];
       ...
       */
      __P_168_16: function __P_168_16(variant, name) {
       ...
       */
      __P_168_18: function __P_168_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_168_20: function __P_168_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_168_27: qx.core.Environment.select("qx.debug", {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_168_22: function __P_168_22(code, name, variant, incomingValue) {
       ...
       * @param name {String} name of the property
       */
      __P_168_19: function __P_168_19(code, config, name) {
        if (config.inheritable) {
       ...
       * @param variant {String} Method variant.
       */
      __P_168_25: function __P_168_25(code, config, name, variant) {
...
//# sourceMappingURL=Property.js.map?dt=1677345924664