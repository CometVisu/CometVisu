  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_162_0: qx.event.Registration,
      /**
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_162_0.addListener(this, type, listener, self, capture);
        }
        return null;
      },
      /**
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_162_0.removeListener(this, type, listener, self, capture);
        }
        return false;
      },
      /**
      ...
      removeListenerById: function removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_162_0.removeListenerById(this, id);
        }
        return false;
      },
      /**
      ...
      hasListener: function hasListener(type, capture) {
        return this.__P_162_0.hasListener(this, type, capture);
      },
      /**
      ...
      dispatchEvent: function dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_162_0.dispatchEvent(this, evt);
        }
        return true;
      },
       ...
       */
      __P_162_3: function __P_162_3(result) {
        var _this = this;
        if (qx.core.Environment.get("qx.promise")) {
          ...
          var newPromise = result.then(function (result) {
            delete _this.__P_162_1[hashCode];
            var promise = _this.__P_162_2;
            if (promise && Object.keys(_this.__P_162_1).length == 0) {
              _this.__P_162_1 = null;
              _this.__P_162_2 = null;
              promise.resolve();
            }
            return result;
          })["catch"](function (err) {
          ...
          this.__P_162_1[hashCode] = newPromise;
          return newPromise;
        } else {
          return result;
        }
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  if (!_this2.__P_162_2) {
                    _this2.__P_162_2 = new qx.Promise();
                  }
                  promise = _this2.__P_162_2;
                  _context.next = 7;
                  return promise;
                case 7:
                case "end":
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_162_3(this.__P_162_0.fireEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        ...
        if (!this.$$disposed) {
          return this.__P_162_3(this.__P_162_0.fireEventAsync(this, type, clazz, args));
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_162_3(this.__P_162_0.fireNonBubblingEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        ...
        if (!this.$$disposed) {
          return this.__P_162_3(this.__P_162_0.fireNonBubblingEventAsync(this, type, clazz, args));
        }
        return qx.Promise.resolve(true);
      },
      /**
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_162_3(this.__P_162_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return true;
      },
      /**
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        ...
        if (!this.$$disposed) {
          ...
          return this.__P_162_3(this.__P_162_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return qx.Promise.resolve(true);
      }
    }
...
//# sourceMappingURL=MEvent.js.map?dt=1673093851910