  ...
  qx.Class.define("qx.ui.table.model.Filtered", {
    ...
    members: {
      ...
      addBetweenFilter: function addBetweenFilter(filter, value1, value2, target) {
        if (this.__P_455_0[filter] === "between" && target != null) {
      ...
      addNumericFilter: function addNumericFilter(filter, value1, target) {
        var temp = null;
        if (this.__P_455_0[filter] === "numeric" && target != null) {
          if (value1 != null) {
      ...
      applyFilters: function applyFilters() {
        ...
        for (var row = 0; row < rowLength; row++) {
          ...
          for (i in this.Filters) {
            if (this.__P_455_0[this.Filters[i][0]] === "numeric") {
            ...
            } else if (this.__P_455_0[this.Filters[i][0]] === "between") {
      ...
      resetHiddenRows: function resetHiddenRows() {
        ...
        this.Filters = [];
        this.setData(qx.lang.Array.clone(this.__P_455_2));
      },
      // overridden
      setData: function setData(rowArr, clearSorting) {
        this.__P_455_2 = qx.lang.Array.clone(rowArr);
        this.Filters = [];
        qx.ui.table.model.Filtered.superclass.prototype.setData.call(this, rowArr, clearSorting);
      }
    },
    destruct: function destruct() {
      this.__P_455_2 = this.__P_455_0 = this.Filters = null;
    }
  });
  qx.ui.table.model.Filtered.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Filtered.js.map?dt=1702815237240