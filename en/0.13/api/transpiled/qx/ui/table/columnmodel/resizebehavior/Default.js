  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.columnmodel.resizebehavior.Default", {
    ...
    construct: function construct() {
      ...
      this.__P_673_1 = new qx.ui.layout.HBox();
      this.__P_673_1.connectToWidget(this);
      this.__P_673_2 = new qx.util.DeferredCall(this._computeColumnsFlexWidth, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      setWidth: function setWidth(col, width, flex) {
        ...
        if (col >= this.__P_673_0.length) {
          throw new Error("Column number out of range");
        }

        // Set the new width
        this.__P_673_0[col].setColumnWidth(width, flex);
        this.__P_673_2.schedule();
      },
      /**
      ...
      setMinWidth: function setMinWidth(col, width) {
        ...
        // Set the new width
        this.__P_673_0[col].setMinWidth(width);
        this.__P_673_2.schedule();
      },
      /**
      ...
      setMaxWidth: function setMaxWidth(col, width) {
        ...
        // Set the new width
        this.__P_673_0[col].setMaxWidth(width);
        this.__P_673_2.schedule();
      },
      /**
      ...
      onAppear: function onAppear(event, forceRefresh) {
        ...
        if (forceRefresh === true || !this.__P_673_4 || this.getInitializeWidthsOnEveryAppear()) {
       ...
       */
      __P_673_5: function __P_673_5() {
        this.__P_673_1.invalidateChildrenCache();
        var children = this.__P_673_3;
    ...
    */
    destruct: function destruct() {
      this.__P_673_0 = this.__P_673_3 = null;
      this._disposeObjects("__P_673_1", "__P_673_2");
    }
  });
  qx.ui.table.columnmodel.resizebehavior.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1735341798832