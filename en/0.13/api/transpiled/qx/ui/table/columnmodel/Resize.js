    ...
    */
    ...
    members: {
      ...
      init: function init(numColumns, table) {
        ...
        if (this.__P_686_2 == null) {
          this.__P_686_2 = table;
      ...
      _onappear: function _onappear(event) {
        ...
        this.__P_686_2._updateScrollerWidths();
        this.__P_686_2._updateScrollBarVisibility();
        this.__P_686_0 = false;
        this.__P_686_1 = true;
      },
      /**
      ...
      _onTableWidthChanged: function _onTableWidthChanged(event) {
        ...
        if (this.__P_686_0 || !this.__P_686_1) {
          // Yup.  Ignore it.
          return;
        }
        this.__P_686_0 = true;
      ...
      _onverticalscrollbarchanged: function _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__P_686_2 && !this.__P_686_2.isDisposed()) {
            this.__P_686_2._updateScrollerWidths();
            this.__P_686_2._updateScrollBarVisibility();
          }
        }, this, 0);
...
//# sourceMappingURL=Resize.js.map?dt=1778272852688