    ...
    */
    ...
    members: {
      ...
      _onappear: function _onappear(event) {
        ...
        this.__P_452_2._updateScrollerWidths();
        this.__P_452_2._updateScrollBarVisibility();
        this.__P_452_0 = false;
        this.__P_452_1 = true;
      },
      /**
      ...
      _onTableWidthChanged: function _onTableWidthChanged(event) {
        ...
        if (this.__P_452_0 || !this.__P_452_1) {
          // Yup.  Ignore it.
          return;
        }
        this.__P_452_0 = true;
      ...
      _onverticalscrollbarchanged: function _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__P_452_2 && !this.__P_452_2.isDisposed()) {
            this.__P_452_2._updateScrollerWidths();
            this.__P_452_2._updateScrollBarVisibility();
          }
        }, this, 0);
...
//# sourceMappingURL=Resize.js.map?dt=1709410165446