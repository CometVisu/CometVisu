    ...
    */
    ...
    members: {
      ...
      createCellEditor: function createCellEditor(cellInfo) {
        ...
        this.__P_664_1 = cellEditorFactoryFunction(cellInfo);
        var cellEditor = this.__P_664_1.createCellEditor(cellInfo);

        // save the cell info to the editor (needed for getting the value)
        this.__P_664_0[cellEditor.toHashCode()] = cellInfo;
        return cellEditor;
      },
      // interface implementation
      getCellEditorValue: function getCellEditorValue(cellEditor) {
        var cellEditorFactoryFunction = this.getCellEditorFactoryFunction();
        var cellInfo = this.__P_664_0[cellEditor.toHashCode()];
        // update the propper factory
        this.__P_664_1 = cellEditorFactoryFunction(cellInfo);
        var value = this.__P_664_1.getCellEditorValue(cellEditor);
        return value;
      }
    },
    /*
...
//# sourceMappingURL=Dynamic.js.map?dt=1735383881614