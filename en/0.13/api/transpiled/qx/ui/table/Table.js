  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      this.__P_677_0 = new qx.ui.container.Composite(new qx.ui.layout.HBox());
      this._add(this.__P_677_0, {
        flex: 1
      });
      ...
      // Create the models
      this.__P_677_1 = this.getNewSelectionManager()(this);
      ...
      {
        this.__P_677_4 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    ...
    */
    ...
    members: {
      ...
      _applySelectionModel: function _applySelectionModel(value, old) {
        this.__P_677_1.setSelectionModel(value);
        if (old != null) {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_677_12) {
          this.__P_677_12 = new qx.ui.table.model.Simple();
          this.__P_677_12.setColumns([]);
          this.__P_677_12.setData([]);
        }
        return this.__P_677_12;
      },
      // property modifier
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_677_11) {
          var columnModel = this.__P_677_11 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_677_5) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_677_5) {
            ...
            this.__P_677_0.add(paneScroller, {
              flex: flex
            });
      ...
      _getPaneScrollerArr: function _getPaneScrollerArr() {
        return this.__P_677_0.getChildren();
      },
      /**
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (removeCount) {
          ...
          if (this.__P_677_3 >= removeStart && this.__P_677_3 < removeStart + removeCount) {
            this.setFocusedCell();
          }
        }
        for (var i = 0; i < scrollerArr.length; i++) {
        ...
        if (rowCount != this.__P_677_7) {
          this.__P_677_7 = rowCount;
          this._updateScrollBarVisibility();
          this._updateStatusBar();
        ...
        if (colCount != this.__P_677_8) {
          this.__P_677_8 = colCount;
      ...
      _onKeyDown: function _onKeyDown(evt) {
        ...
        // No editing mode
        var oldFocusedRow = this.__P_677_3;
        var consumed = false;
        ...
        if (this.isEditing()) {
          ...
          if (evt.getModifiers() == 0) {
            switch (identifier) {
              case "Enter":
                ...
                if (this.__P_677_3 != oldFocusedRow) {
          ...
          if (evt.isCtrlPressed()) {
            ...
            switch (identifier) {
              case "Space":
                this.__P_677_1.handleSelectKeyDown(this.__P_677_3, evt);
                break;
              case "F2":
              case "Enter":
                this.startEditing();
                ...
                break;
              case "Home":
                this.setFocusedCell(this.__P_677_2, 0, true);
                break;
              case "End":
                var rowCount = this.getTableModel().getRowCount();
                this.setFocusedCell(this.__P_677_2, rowCount - 1, true);
                break;
              case "Left":
        ...
        if (oldFocusedRow != this.__P_677_3 && this.getRowFocusChangeModifiesSelection()) {
          // The focus moved -> Let the selection manager handle this event
          this.__P_677_1.handleMoveKeyDown(this.__P_677_3, evt);
        }
        if (consumed) {
          evt.preventDefault();
          evt.stopPropagation();
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        var data = evt.getData();
        if (this.__P_677_10 != null && data.col != null && data.visible != null) {
          this.__P_677_10[data.col].setColumnVisible(data.visible);
        }
        this._updateScrollerWidths();
        this._updateScrollBarVisibility();
      },
      ...
      moveFocusedCell: function moveFocusedCell(deltaX, deltaY) {
        var col = this.__P_677_2;
        var row = this.__P_677_3;
      ...
      isEditing: function isEditing() {
        if (this.__P_677_2 != null) {
          var x = this.getTableColumnModel().getVisibleX(this.__P_677_2);
          var metaColumn = this._getMetaColumnAtColumnX(x);
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_677_13 == null) {
              this.__P_677_13 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_677_14 = qx.event.Timer.once(function () {
                // reset the last visible state of the vertical scroll bar
                // in a timeout to prevent infinite loops.
                this.__P_677_13 = null;
                this.__P_677_14 = null;
              }, this, 0);
            }
          }
          ...
          // has changed...
          if (isLast && verNeeded != this.__P_677_13) {
      ...
      _initColumnMenu: function _initColumnMenu() {
        ...
        for (var iCol = 0, l = tableModel.getColumnCount(); iCol < l; iCol++) {
          ...
          this.__P_677_10[col] = menuButton;
        }
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_677_5[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_677_4) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_677_4);
      }
      ...
      this._disposeObjects("__P_677_1", "__P_677_0", "__P_677_12", "__P_677_12", "__P_677_11", "__P_677_14");
      this._disposeMap("__P_677_10");
    }
  });
