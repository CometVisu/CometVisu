  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      this.__P_434_0 = new qx.ui.container.Composite(new qx.ui.layout.HBox());
      this._add(this.__P_434_0, {
        flex: 1
      });
      ...
      // Create the models
      this.__P_434_1 = this.getNewSelectionManager()(this);
    ...
    */
    ...
    members: {
      ...
      _applySelectionModel: function _applySelectionModel(value, old) {
        this.__P_434_1.setSelectionModel(value);
        if (old != null) {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_434_11) {
          this.__P_434_11 = new qx.ui.table.model.Simple();
          this.__P_434_11.setColumns([]);
          this.__P_434_11.setData([]);
        }
        return this.__P_434_11;
      },
      // property modifier
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_434_10) {
          var columnModel = this.__P_434_10 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_434_4) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_434_4) {
            ...
            this.__P_434_0.add(paneScroller, {
              flex: flex
            });
      ...
      _getPaneScrollerArr: function _getPaneScrollerArr() {
        return this.__P_434_0.getChildren();
      },
      /**
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (removeCount) {
          ...
          if (this.__P_434_3 >= removeStart && this.__P_434_3 < removeStart + removeCount) {
            this.setFocusedCell();
          }
        }
        for (var i = 0; i < scrollerArr.length; i++) {
        ...
        if (rowCount != this.__P_434_6) {
          this.__P_434_6 = rowCount;
          this._updateScrollBarVisibility();
          this._updateStatusBar();
        ...
        if (colCount != this.__P_434_7) {
          this.__P_434_7 = colCount;
      ...
      _onKeyDown: function _onKeyDown(evt) {
        ...
        // No editing mode
        var oldFocusedRow = this.__P_434_3;
        var consumed = false;
        ...
        if (this.isEditing()) {
          ...
          if (evt.getModifiers() == 0) {
            switch (identifier) {
              case "Enter":
                ...
                if (this.__P_434_3 != oldFocusedRow) {
          ...
          if (evt.isCtrlPressed()) {
            ...
            switch (identifier) {
              case "Space":
                this.__P_434_1.handleSelectKeyDown(this.__P_434_3, evt);
                break;
              case "F2":
              case "Enter":
                this.startEditing();
                ...
                break;
              case "Home":
                this.setFocusedCell(this.__P_434_2, 0, true);
                break;
              case "End":
                var rowCount = this.getTableModel().getRowCount();
                this.setFocusedCell(this.__P_434_2, rowCount - 1, true);
                break;
              case "Left":
        ...
        if (oldFocusedRow != this.__P_434_3 && this.getRowFocusChangeModifiesSelection()) {
          // The focus moved -> Let the selection manager handle this event
          this.__P_434_1.handleMoveKeyDown(this.__P_434_3, evt);
        }
        if (consumed) {
          evt.preventDefault();
          evt.stopPropagation();
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        var data = evt.getData();
        if (this.__P_434_9 != null && data.col != null && data.visible != null) {
          this.__P_434_9[data.col].setColumnVisible(data.visible);
        }
        this._updateScrollerWidths();
        this._updateScrollBarVisibility();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        if (!this.isEditing() && (col != this.__P_434_2 || row != this.__P_434_3)) {
          if (col === null) {
            col = 0;
          }
          this.__P_434_2 = col;
      ...
      moveFocusedCell: function moveFocusedCell(deltaX, deltaY) {
        var col = this.__P_434_2;
        var row = this.__P_434_3;
      ...
      isEditing: function isEditing() {
        if (this.__P_434_2 != null) {
          var x = this.getTableColumnModel().getVisibleX(this.__P_434_2);
          var metaColumn = this._getMetaColumnAtColumnX(x);
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_434_12 == null) {
              this.__P_434_12 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_434_13 = qx.event.Timer.once(function () {
                // reset the last visible state of the vertical scroll bar
                // in a timeout to prevent infinite loops.
                this.__P_434_12 = null;
                this.__P_434_13 = null;
              }, this, 0);
            }
          }
          ...
          // has changed...
          if (isLast && verNeeded != this.__P_434_12) {
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_434_4[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_434_1", "__P_434_0", "__P_434_11", "__P_434_11", "__P_434_10", "__P_434_13");
      this._disposeMap("__P_434_9");
    }
  });
  qx.ui.table.Table.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Table.js.map?dt=1672653513939