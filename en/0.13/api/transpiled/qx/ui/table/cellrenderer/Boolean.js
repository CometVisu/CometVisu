  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_681_0 = qx.util.AliasManager.getInstance();
      this.initIconTrue();
      this.initIconFalse();

      // dynamic theme switch
      {
        this.__P_681_1 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
    },
    /*
     *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      _applyIconTrue: function _applyIconTrue(value) {
        this.__P_681_2 = this.__P_681_0.resolve(value);
      },
      // property apply
      _applyIconFalse: function _applyIconFalse(value) {
        this.__P_681_3 = this.__P_681_0.resolve(value);
      },
      // overridden
      _identifyImage: function _identifyImage(cellInfo) {
        ...
        if (rm.has(this.__P_681_2)) {
          id = this.__P_681_2;
        } else {
          ids = rm.getIds(this.__P_681_2);
        ...
        switch (cellInfo.value) {
          case true:
            imageHints.url = this.__P_681_2;
            break;
          case false:
            imageHints.url = this.__P_681_3;
            break;
          default:
            imageHints.url = null;
            break;
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_681_1) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_681_1);
      }
    }
  });
...
//# sourceMappingURL=Boolean.js.map?dt=1778272852472