  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    members: {
      ...
      _identifyImage: function _identifyImage(cellInfo) {
        ...
        if (rm.has(this.__P_439_1)) {
          ...
          ids = rm.getIds(this.__P_439_1); // If ID was found, we'll use its first (likely only) element here.
    ...
    */
    destruct: function destruct() {
      this.__P_439_0 = null; // remove dynamic theme listener
...
//# sourceMappingURL=Boolean.js.map?dt=1685978147088