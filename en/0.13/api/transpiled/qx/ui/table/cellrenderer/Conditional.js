  ...
  qx.Class.define("qx.ui.table.cellrenderer.Conditional", {
    ...
    */
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.conditions = [];
      this.__P_668_0 = align || "";
      this.__P_668_1 = color || "";
      this.__P_668_2 = style || "";
      this.__P_668_3 = weight || "";
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
       ...
       */
      __P_668_4: function __P_668_4(condition, style) {
        if (condition[1] != null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_668_0,
          color: this.__P_668_1,
          "font-style": this.__P_668_2,
          "font-weight": this.__P_668_3
        };
        for (i in this.conditions) {
          ...
          if (cond_test == true) {
            this.__P_668_4(this.conditions[i], style);
          }
        }
        var styleString = [];
...
//# sourceMappingURL=Conditional.js.map?dt=1735341798612