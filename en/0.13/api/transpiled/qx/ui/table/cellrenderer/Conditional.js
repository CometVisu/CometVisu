  ...
  qx.Class.define("qx.ui.table.cellrenderer.Conditional", {
    ...
    */
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.conditions = [];
      this.__P_448_0 = align || "";
      this.__P_448_1 = color || "";
      this.__P_448_2 = style || "";
      this.__P_448_3 = weight || "";
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
       ...
       */
      __P_448_4: function __P_448_4(condition, style) {
        if (condition[1] != null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_448_0,
          color: this.__P_448_1,
          "font-style": this.__P_448_2,
          "font-weight": this.__P_448_3
        };
        for (i in this.conditions) {
          ...
          if (cond_test == true) {
            this.__P_448_4(this.conditions[i], style);
          }
        }
        var styleString = [];
...
//# sourceMappingURL=Conditional.js.map?dt=1702901331002