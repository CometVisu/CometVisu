  ...
  qx.Class.define("qx.ui.table.pane.Model", {
    ...
    */
    ...
    construct: function construct(tableColumnModel) {
      ...
      this.__P_679_0 = new qx.util.DeferredCall(function () {
    ...
    */
    ...
    members: {
      ...
      setTableColumnModel: function setTableColumnModel(tableColumnModel) {
        if (this.__P_679_2) {
          this.__P_679_2.removeListener("visibilityChangedPre", this._onColVisibilityChanged, this);
          this.__P_679_2.removeListener("headerCellRendererChanged", this._onHeaderCellRendererChanged, this);
        }
        this.__P_679_2 = tableColumnModel;
        this.__P_679_2.addListener("visibilityChangedPre", this._onColVisibilityChanged, this);
        this.__P_679_2.addListener("headerCellRendererChanged", this._onHeaderCellRendererChanged, this);
        this.__P_679_1 = null;
      },
      /**
      ...
      getColumnCount: function getColumnCount() {
        if (this.__P_679_1 == null) {
          var firstX = this.getFirstColumnX();
          var maxColCount = this.getMaxColumnCount();
          var totalColCount = this.__P_679_2.getVisibleColumnCount();
          if (maxColCount == -1 || firstX + maxColCount > totalColCount) {
            this.__P_679_1 = totalColCount - firstX;
          } else {
            this.__P_679_1 = maxColCount;
          }
        }
        return this.__P_679_1;
      },
      /**
      ...
      getColumnAtX: function getColumnAtX(xPos) {
        var firstX = this.getFirstColumnX();
        return this.__P_679_2.getVisibleColumnAtX(firstX + xPos);
      },
      /**
      ...
      getX: function getX(col) {
        var firstX = this.getFirstColumnX();
        var maxColCount = this.getMaxColumnCount();
        var x = this.__P_679_2.getVisibleX(col) - firstX;
      ...
      getColumnLeft: function getColumnLeft(col) {
        ...
        for (var x = 0; x < colCount; x++) {
          ...
          left += this.__P_679_2.getColumnWidth(currCol);
        }
        return -1;
      },
      /**
      ...
      getTotalWidth: function getTotalWidth() {
        ...
        for (var x = 0; x < colCount; x++) {
          ...
          totalWidth += this.__P_679_2.getColumnWidth(col);
        }
        return totalWidth;
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_679_2 = null;
      this._disposeObjects("__P_679_0");
    }
  });
  qx.ui.table.pane.Model.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Model.js.map?dt=1735341799097