  ...
  qx.Class.define("qx.ui.table.pane.FocusIndicator", {
    ...
    members: {
      ...
      moveToCell: function moveToCell(col, row, editing) {
        ...
        if (!this.__P_449_0.getShowCellFocusIndicator() && !this.__P_449_0.getTable().getTableModel().isColumnEditable(col)) {
          this.exclude();
          return;
        } else {
          this.show();
...
//# sourceMappingURL=FocusIndicator.js.map?dt=1677017723732