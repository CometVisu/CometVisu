  ...
  qx.Class.define("qx.ui.table.pane.FocusIndicator", {
    ...
    members: {
      ...
      moveToCell: function moveToCell(col, row, editing) {
        ...
        if (!this.__P_448_0.getShowCellFocusIndicator() && !this.__P_448_0.getTable().getTableModel().isColumnEditable(col)) {
          this.exclude();
          return;
        } else {
          this.show();
        ...
        if (col == null) {
          ...
          var xPos = this.__P_448_0.getTablePaneModel().getX(col);
          if (xPos === -1) {
            this.hide();
            this.setRow(null);
            this.setColumn(null);
          } else {
            var table = this.__P_448_0.getTable();
            var columnModel = table.getTableColumnModel();
            var paneModel = this.__P_448_0.getTablePaneModel();
            var firstRow = this.__P_448_0.getTablePane().getFirstVisibleRow();
            ...
            if (editing && this.__P_448_0.getMinCellEditHeight() && this.__P_448_0.getMinCellEditHeight() > userHeight) {
              userTop -= Math.floor((this.__P_448_0.getMinCellEditHeight() - userHeight) / 2);
              userHeight = this.__P_448_0.getMinCellEditHeight();
            }
...
//# sourceMappingURL=FocusIndicator.js.map?dt=1673093875103