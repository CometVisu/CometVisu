  ...
  qx.Class.define("qx.ui.table.pane.Scroller", {
    ...
    */
    ...
    construct: function construct(table) {
      ...
      // init child controls
      this.__P_680_1 = this._showChildControl("header");
      this.__P_680_2 = this._showChildControl("pane");

      // the top line containing the header clipper and the top right widget
      this.__P_680_3 = new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({
        minWidth: 0
      });
      this._add(this.__P_680_3, {
        row: 0,
        column: 0,
        colSpan: 2
      });
      ...
      this._headerClipper.add(this.__P_680_1);
      ...
      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this.__P_680_4 = new qx.ui.container.Composite();
        this.__P_680_4.setLayout(new qx.ui.layout.Canvas());
        this.__P_680_4.add(this._paneClipper, {
          edge: 0
        });
        this._add(this.__P_680_4, {
          row: 1,
          column: 0
        });
      } else {
      ...
      // init scroll bars
      this.__P_680_5 = this._showChildControl("scrollbar-x");
      this.__P_680_6 = this._showChildControl("scrollbar-y");

      // init focus indicator
      this.__P_680_7 = this.getChildControl("focus-indicator");
      ...
      this.__P_680_8 = new qx.event.Timer();
      this.__P_680_8.addListener("interval", this._oninterval, this);
    ...
    */
    ...
    members: {
      ...
      _applyHorizontalScrollBarVisible: function _applyHorizontalScrollBarVisible(value, old) {
        if (value === null) {
          this.__P_680_5.setVisibility("hidden");
        } else {
          this.__P_680_5.setVisibility(value ? "visible" : "excluded");
        }
      },
      // property modifier
      _applyVerticalScrollBarVisible: function _applyVerticalScrollBarVisible(value, old) {
        this.__P_680_6.setVisibility(value ? "visible" : "excluded");
      },
      // property modifier
      ...
      _applyShowCellFocusIndicator: function _applyShowCellFocusIndicator(value, old) {
        if (value) {
          this.__P_680_7.setDecorator("table-scroller-focus-indicator");
          this._updateFocusIndicator();
        } else {
          if (this.__P_680_7) {
            this.__P_680_7.setDecorator(null);
          }
        }
      },
      /**
      ...
      getScrollY: function getScrollY() {
        return this.__P_680_6.getPosition();
      },
      /**
      ...
      setScrollY: function setScrollY(scrollY, renderSync) {
        this.__P_680_6.scrollTo(scrollY);
        if (renderSync) {
          this._updateContent();
        }
      },
      ...
      getScrollX: function getScrollX() {
        return this.__P_680_5.getPosition();
      },
      /**
       * Set the current position of the vertical scroll bar.
       *
      ...
      setScrollX: function setScrollX(scrollX) {
        this.__P_680_5.scrollTo(scrollX);
      },
      /**
      ...
      setColumnWidth: function setColumnWidth(col, width) {
        this.__P_680_1.setColumnWidth(col, width);
        this.__P_680_2.setColumnWidth(col, width);
      ...
      onColOrderChanged: function onColOrderChanged() {
        this.__P_680_1.onColOrderChanged();
        this.__P_680_2.onColOrderChanged();
        this.updateHorScrollBarMaximum();
      },
      /**
      ...
      onTableModelDataChanged: function onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn) {
        this.__P_680_2.onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn);
        var rowCount = this.getTable().getTableModel().getRowCount();
        if (rowCount != this.__P_680_9) {
      ...
      onSelectionChanged: function onSelectionChanged() {
        this.__P_680_2.onSelectionChanged();
      },
      /**
       * Event handler. Called when the table gets or looses the focus.
       */
      onFocusChanged: function onFocusChanged() {
        this.__P_680_2.onFocusChanged();
      },
      /**
      ...
      onTableModelMetaDataChanged: function onTableModelMetaDataChanged() {
        this.__P_680_1.onTableModelMetaDataChanged();
        this.__P_680_2.onTableModelMetaDataChanged();
      },
      /**
       * Event handler. Called when the pane model has changed.
       */
      _onPaneModelChanged: function _onPaneModelChanged() {
        this.__P_680_1.onPaneModelChanged();
        this.__P_680_2.onPaneModelChanged();
      },
      /**
      ...
      _onResizePane: function _onResizePane() {
        ...
        this._updateContent();
        this.__P_680_1._updateContent();
        this.__P_680_0._updateScrollBarVisibility();
      },
      /**
      ...
      _onRoll: function _onRoll(e) {
        ...
        this.__P_680_6.scrollBy(parseInt(delta.y, 10));
        var scrolled = delta.y != 0 && !this.__P_680_29(this.__P_680_6, delta.y);
        ...
        this.__P_680_5.scrollBy(parseInt(delta.x, 10));

        // Update the focus
        if (this.__P_680_21 && this.getFocusCellOnPointerMove()) {
          this._focusCellAtPagePos(this.__P_680_21, this.__P_680_22);
        }
        scrolled = scrolled || delta.x != 0 && !this.__P_680_29(this.__P_680_5, delta.x);
       ...
       */
      __P_680_29: function __P_680_29(scrollBar, delta) {
       ...
       */
      __P_680_30: function __P_680_30(pageX) {
        var table = this.getTable();
        // We are currently resizing -> Update the position
        var headerCell = this.__P_680_1.getHeaderWidgetAtColumn(this.__P_680_15);
        var minColumnWidth = headerCell.getSizeHint().minWidth;
        var newWidth = Math.max(minColumnWidth, this.__P_680_17 + pageX - this.__P_680_16);
        if (this.getLiveResize()) {
          var columnModel = table.getTableColumnModel();
          columnModel.setColumnWidth(this.__P_680_15, newWidth, true);
        } else {
          var paneModel = this.getTablePaneModel();
          this._showResizeLine(paneModel.getColumnLeft(this.__P_680_15) + newWidth);
        }
        this.__P_680_16 += newWidth - this.__P_680_17;
        this.__P_680_17 = newWidth;
      },
      /**
       ...
       *
       */
      __P_680_31: function __P_680_31(pageX) {
        ...
        if (this.__P_680_1.isShowingColumnMoveFeedback() || pageX > this.__P_680_14 + tapTolerance || pageX < this.__P_680_14 - tapTolerance) {
          this.__P_680_13 += pageX - this.__P_680_14;
          this.__P_680_1.showColumnMoveFeedback(this._moveColumn, this.__P_680_13);

          // Get the responsible scroller
          var targetScroller = this.__P_680_0.getTablePaneScrollerAtPageX(pageX);
      ...
      _onPointermoveHeader: function _onPointermoveHeader(e) {
        ...
        this.__P_680_21 = pageX;
        this.__P_680_22 = pageY;
        if (this.__P_680_15 != null) {
          // We are currently resizing -> Update the position
          this.__P_680_30(pageX);
          useResizeCursor = true;
          e.stopPropagation();
        } else if (this._moveColumn != null) {
          // We are moving a column
          this.__P_680_31(pageX);
          e.stopPropagation();
        } else {
        ...
        this.__P_680_1.setPointerOverColumn(pointerOverColumn);
      },
      /**
      ...
      _onPointermovePane: function _onPointermovePane(e) {
        ...
        this.__P_680_1.setPointerOverColumn(null);
      },
      /**
      ...
      _startResizeHeader: function _startResizeHeader(resizeCol, pageX) {
        ...
        // The pointer is over a resize region -> Start resizing
        this.__P_680_15 = resizeCol;
        this.__P_680_16 = pageX;
        this.__P_680_17 = columnModel.getColumnWidth(this.__P_680_15);
      ...
      _startMoveHeader: function _startMoveHeader(moveCol, pageX) {
        ...
        this.__P_680_14 = pageX;
        this.__P_680_13 = this.getTablePaneModel().getColumnLeft(moveCol);
        this._headerClipper.capture();
      },
      /**
      ...
      _onPointerupFocusIndicator: function _onPointerupFocusIndicator(e) {
        if (this.__P_680_18 && !this.__P_680_19 && !this.isEditing() && this.__P_680_7.getRow() == this.__P_680_18.row && this.__P_680_7.getColumn() == this.__P_680_18.col) {
          this.fireEvent("cellTap", qx.ui.table.pane.CellEvent, [this, e, this.__P_680_18.row, this.__P_680_18.col], true);
          this.__P_680_19 = true;
      ...
      _stopResizeHeader: function _stopResizeHeader() {
        ...
        if (!this.getLiveResize()) {
          ...
          columnModel.setColumnWidth(this.__P_680_15, this.__P_680_17, true);
        }
        this.__P_680_15 = null;
      ...
      _stopMoveHeader: function _stopMoveHeader() {
        ...
        this.__P_680_1.hideColumnMoveFeedback();
      ...
      _onTapPane: function _onTapPane(e) {
        ...
        if (row != null && col != null) {
          ...
          if (this.__P_680_7.isHidden() || this.__P_680_18 && !this.__P_680_19 && !this.isEditing() && row == this.__P_680_18.row && col == this.__P_680_18.col) {
      ...
      _onContextMenu: function _onContextMenu(e) {
        ...
        if (!this.getShowCellFocusIndicator() || row === null || this.__P_680_18 && row == this.__P_680_18.row && col == this.__P_680_18.col) {
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(pageX) {
        var paneModel = this.getTablePaneModel();
        var columnModel = this.getTable().getTableColumnModel();
        var paneLeft = this.__P_680_2.getContentLocation().left;
      ...
      _focusCellAtPagePos: function _focusCellAtPagePos(pageX, pageY) {
        ...
        if (row != -1 && row != null) {
          // The pointer is over the data -> update the focus
          var col = this._getColumnForPageX(pageX);
          this.__P_680_0.setFocusedCell(col, row);
        }
      },
      /**
      ...
      setFocusedCell: function setFocusedCell(col, row) {
        if (!this.isEditing()) {
          this.__P_680_2.setFocusedCell(col, row, this.__P_680_11);
          this.__P_680_23 = col;
          this.__P_680_24 = row;
          this._updateFocusIndicator();
        }
      ...
      startEditing: function startEditing() {
        ...
        var table = this.getTable();
        var tableModel = table.getTableModel();
        var col = this.__P_680_23;
        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          var row = this.__P_680_24;
          var xPos = this.getTablePaneModel().getX(col);
          var value = tableModel.getValue(col, row);

          // scroll cell into view
          this.scrollCellVisible(col, row);
          this.__P_680_25 = table.getTableColumnModel().getCellEditorFactory(col);
          var cellInfo = {
            col: col,
            row: row,
            xPos: xPos,
          ...
          // Get a cell editor
          this._cellEditor = this.__P_680_25.createCellEditor(cellInfo);
          ...
          if (this._cellEditor === null) {
            ...
            this.__P_680_27 = this.__P_680_7.addListener("pointerdown", function (e) {
              _this.__P_680_18 = {
                row: _this.__P_680_24,
                col: _this.__P_680_23
              };
              e.stopPropagation();
            });
            this._updateFocusIndicator(true);
            this.__P_680_7.add(this._cellEditor);
            this.__P_680_7.addState("editing");
            this.__P_680_7.setKeepActive(false);
      ...
      flushEditor: function flushEditor(cancel) {
        if (this.isEditing()) {
          var value = this.__P_680_25.getCellEditorValue(this._cellEditor);
          var oldValue = this.getTable().getTableModel().getValue(this.__P_680_23, this.__P_680_24);
          this.getTable().getTableModel().setValue(this.__P_680_23, this.__P_680_24, value);
          this.__P_680_0.focus();
          if (cancel) {
            this.cancelEditing();
          }

          // Fire an event containing the value change.
          this.__P_680_0.fireDataEvent("dataEdited", {
            row: this.__P_680_24,
            col: this.__P_680_23,
            oldValue: oldValue,
            value: value
      ...
      cancelEditing: function cancelEditing() {
        if (this.isEditing()) {
          if (!(this._cellEditor instanceof qx.ui.window.Window)) {
            this.__P_680_7.removeState("editing");
            this.__P_680_7.setKeepActive(true);
            if (this.__P_680_27 !== null) {
              this.__P_680_7.removeListenerById(this.__P_680_27);
              this.__P_680_27 = null;
            }
            this._updateFocusIndicator();
          }
          this._cellEditor.destroy();
          this._cellEditor = null;
          this.__P_680_25 = null;
        }
      },
      /**
      ...
      _getColumnForPageX: function _getColumnForPageX(pageX) {
        ...
        var paneModel = this.getTablePaneModel();
        var colCount = paneModel.getColumnCount();
        var currX = this.__P_680_2.getContentLocation().left;
      ...
      _getResizeColumnForPageX: function _getResizeColumnForPageX(pageX) {
        var contentLocation = this.__P_680_1.getContentLocation() || this.__P_680_2.getContentLocation();
        if (contentLocation) {
      ...
      _getRowForPagePos: function _getRowForPagePos(pageX, pageY) {
        var panePos = this.__P_680_2.getContentLocation();
        ...
        if (pageY >= panePos.top && pageY <= panePos.bottom) {
          ...
          var rowHeight = this.__P_680_2.getRenderedRowHeight();
          var scrollY = this.__P_680_6.getPosition();
          if (this.getTable().getKeepFirstVisibleRowComplete()) {
        ...
        var headerPos = this.__P_680_1.getContentLocation();
      ...
      setTopRightWidget: function setTopRightWidget(widget) {
        var oldWidget = this.__P_680_26;
        if (oldWidget != null) {
          this.__P_680_3.remove(oldWidget);
        }
        if (widget != null) {
          this.__P_680_3.add(widget);
        }
        this.__P_680_26 = widget;
      },
      /**
      ...
      _startInterval: function _startInterval(timeout) {
        this.__P_680_8.setInterval(timeout);
        this.__P_680_8.start();
      },
      /**
      ...
      _oninterval: qx.event.GlobalError.observeMethod(function () {
        if (this.__P_680_11 && !this.__P_680_2._layoutPending) {
          this.__P_680_11 = false;
          this._updateContent();
        }
      }),
      /**
      ...
      _updateContent: function _updateContent() {
        ...
        var scrollX = this.__P_680_5.getPosition();
        var scrollY = this.__P_680_6.getPosition();
        var rowHeight = this.getTable().getRowHeight();
        var firstRow = Math.floor(scrollY / rowHeight);
        var oldFirstRow = this.__P_680_2.getFirstVisibleRow();
        this.__P_680_2.setFirstVisibleRow(firstRow);
        ...
        this.__P_680_2.setVisibleRowCount(visibleRowCount);
      ...
      _updateFocusIndicator: function _updateFocusIndicator(editing) {
        ...
        this.__P_680_7.moveToCell(this.__P_680_23, this.__P_680_24, editing);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_680_18 = this.__P_680_26 = this.__P_680_0 = null;
      this._disposeObjects("__P_680_5", "__P_680_6", "_headerClipper", "_paneClipper", "__P_680_7", "__P_680_1", "__P_680_2", "__P_680_3", "__P_680_8", "__P_680_4");
    }
  });
  qx.ui.table.pane.Scroller.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Scroller.js.map?dt=1722153855050