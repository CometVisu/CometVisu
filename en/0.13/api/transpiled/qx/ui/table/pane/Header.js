  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      // add blocker
      this.__P_458_0 = new qx.ui.core.Blocker(this);
      this.__P_458_1 = paneScroller;
    ...
    */
    ...
    members: {
      ...
      getTable: function getTable() {
        return this.__P_458_1.getTable();
      },
      /**
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__P_458_3) {
          if (this.__P_458_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_458_3);
            if (widget != null) {
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_458_2 == null) {
          ...
          this.__P_458_2 = feedback;
        }
        this.__P_458_2.setLayoutProperties({
          left: pos.left + x
        });
        this.__P_458_2.show();
      },
    ...
    */
    destruct: function destruct() {
      this.__P_458_0.dispose();
      this._disposeObjects("__P_458_1");
    }
  });
  qx.ui.table.pane.Header.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Header.js.map?dt=1703705689969