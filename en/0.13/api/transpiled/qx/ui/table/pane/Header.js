  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      // add blocker
      this.__P_692_0 = new qx.ui.core.Blocker(this);
      this.__P_692_1 = paneScroller;
    ...
    */
    ...
    members: {
      ...
      getTable: function getTable() {
        return this.__P_692_1.getTable();
      },
      /**
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__P_692_3) {
          if (this.__P_692_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_692_3);
            if (widget != null) {
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_692_2 == null) {
          ...
          this.__P_692_2 = feedback;
        }
        this.__P_692_2.setLayoutProperties({
          left: pos.left + x
        });
        this.__P_692_2.show();
      },
...
//# sourceMappingURL=Header.js.map?dt=1778272852973