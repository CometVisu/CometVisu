  ...
  qx.Class.define("qx.ui.table.pane.Pane", {
    ...
    */
    members: {
      ...
      getTable: function getTable() {
        return this.__P_417_0.getTable();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, massUpdate) {
        if (col != this.__P_417_6 || row != this.__P_417_5) {
          var oldRow = this.__P_417_5;
          this.__P_417_6 = col;
          this.__P_417_5 = row; // Update the focused row background
      ...
      _applyMaxCacheLines: function _applyMaxCacheLines(value, old) {
        if (this.__P_417_7 >= value && value !== -1) {
          this.__P_417_8();
        }
      },
       ...
       *     index is not cached.
       */
      __P_417_9: function __P_417_9(row, selected, focused) {
        if (!selected && !focused && this.__P_417_3[row]) {
          return this.__P_417_3[row];
        } else {
          return null;
        }
      },
       ...
       * @param focused {Boolean} Whether the row is currently focused
       */
      __P_417_10: function __P_417_10(row, rowString, selected, focused) {
        var maxCacheLines = this.getMaxCacheLines();

        if (!selected && !focused && !this.__P_417_3[row] && maxCacheLines > 0) {
          this._applyMaxCacheLines(maxCacheLines);

          this.__P_417_3[row] = rowString;
          this.__P_417_7 += 1;
        }
      },
      ...
      _updateRowStyles: function _updateRowStyles(onlyRow) {
        ...
        for (; y < end; y++, row++) {
          ...
          cellInfo.focusedRow = this.__P_417_5 == row;
      ...
      _getRowsHtml: function _getRowsHtml(firstRow, rowCount) {
        ...
        for (var row = firstRow; row < firstRow + rowCount; row++) {
          ...
          var focusedRow = this.__P_417_5 == row;

          var cachedRow = this.__P_417_9(row, selected, focusedRow);
          ...
          this.__P_417_10(row, rowString, selected, focusedRow);
      ...
      _scrollContent: function _scrollContent(rowOffset) {
        ...
        if (!this.__P_417_4) {
          this.__P_417_4 = document.createElement("div");
        }

        var tableDummy = '<div>';
        tableDummy += this._getRowsHtml(firstRow + addRowBase, Math.abs(rowOffset));
        tableDummy += '</div>';
        this.__P_417_4.innerHTML = tableDummy;
        var newTableRows = this.__P_417_4.firstChild.childNodes; // append new lines
        ...
        if (this.__P_417_5 !== null) {
          this._updateRowStyles(this.__P_417_5 - rowOffset);

          this._updateRowStyles(this.__P_417_5);
        }
      ...
      _updateSingleRow: function _updateSingleRow(row) {
        ...
        this.__P_417_4.innerHTML = "<div>" + this._getRowsHtml(row, 1) + "</div>";
        var newTableRows = this.__P_417_4.firstChild.childNodes;
      ...
      _updateAllRows: function _updateAllRows() {
        ...
        this.__P_417_1 = colCount;
        this.__P_417_2 = rowCount;
        this.fireEvent("paneUpdated");
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__P_417_4 = this.__P_417_0 = this.__P_417_3 = null;
...
//# sourceMappingURL=Pane.js.map?dt=1649957697857