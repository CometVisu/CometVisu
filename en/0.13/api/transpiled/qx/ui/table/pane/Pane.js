  ...
  qx.Class.define("qx.ui.table.pane.Pane", {
    ...
    */
    ...
    members: {
      ...
      _applyMaxCacheLines: function _applyMaxCacheLines(value, old) {
        if (this.__P_452_7 >= value && value !== -1) {
          this.__P_452_8();
        }
      },
      /**
       ...
       *     index is not cached.
       */
      __P_452_9: function __P_452_9(row, selected, focused) {
        if (!selected && !focused && this.__P_452_3[row]) {
          return this.__P_452_3[row];
        } else {
          return null;
        }
      },
      ...
      _updateRowStyles: function _updateRowStyles(onlyRow) {
        ...
        for (; y < end; y++, row++) {
          ...
          cellInfo.focusedRow = this.__P_452_5 == row;
    ...
    */
    destruct: function destruct() {
      this.__P_452_4 = this.__P_452_0 = this.__P_452_3 = null;
...
//# sourceMappingURL=Pane.js.map?dt=1677017723928