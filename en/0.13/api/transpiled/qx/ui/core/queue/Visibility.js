  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_334_1[widget.toHashCode()]) {
          delete this.__P_334_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_334_0, widget);
        }
        delete this.__P_334_2[widget.toHashCode()];
      },
      /**
      ...
      isVisible: function isVisible(widget) {
        return this.__P_334_2[widget.toHashCode()] || false;
      },
      /**
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __P_334_3: function __P_334_3(widget) {
        var data = this.__P_334_2;
      ...
      add: function add(widget) {
        ...
        this.__P_334_0.unshift(widget);
        this.__P_334_1[widget.toHashCode()] = widget;
...
//# sourceMappingURL=Visibility.js.map?dt=1705596676893