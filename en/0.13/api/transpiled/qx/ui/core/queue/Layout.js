  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__P_323_0[widget.toHashCode()];
      },
      /**
      ...
      add: function add(widget) {
        this.__P_323_0[widget.toHashCode()] = widget;
      ...
      isScheduled: function isScheduled(widget) {
        return !!this.__P_323_0[widget.toHashCode()];
      },
      /**
       ...
       */
      __P_323_2: function __P_323_2() {
        var sortedQueue = [];
        var levels = this.__P_323_3();
...
//# sourceMappingURL=Layout.js.map?dt=1672653505812