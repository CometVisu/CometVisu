  ...
  qx.Class.define("qx.ui.core.queue.Appearance", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_330_1[widget.toHashCode()]) {
          qx.lang.Array.remove(this.__P_330_0, widget);
          delete this.__P_330_1[widget.toHashCode()];
        }
      },
      /**
      ...
      add: function add(widget) {
        ...
        this.__P_330_0.unshift(widget);
        this.__P_330_1[widget.toHashCode()] = widget;
      ...
      has: function has(widget) {
        return !!this.__P_330_1[widget.toHashCode()];
      },
      /**
...
//# sourceMappingURL=Appearance.js.map?dt=1709410158714