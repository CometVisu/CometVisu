  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct: function construct(selectionProvider) {
      ...
      this.__P_546_0 = selectionProvider;
    },
    /*
    *****************************************************************************
       EVENTS
    ...
    */
    ...
    members: {
      ...
      */
      ...
      getSelectables: function getSelectables(all) {
        var items = this.__P_546_0.getItems();
        var result = [];
        for (var i = 0; i < items.length; i++) {
          if (this.__P_546_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
        }
      ...
      */
      // apply method
      __P_546_1: function __P_546_1(value, old) {
        if (!value) {
          this.__P_546_4(this.__P_546_2);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_546_4: function __P_546_4(item) {
        var oldSelected = this.__P_546_2;
       ...
       *    <code>false</code> otherwise.
       */
      __P_546_3: function __P_546_3(item) {
        var items = this.__P_546_0.getItems();
        for (var i = 0; i < items.length; i++) {
          if (items[i] === item) {
            return true;
    ...
    destruct: function destruct() {
      if (this.__P_546_0.toHashCode) {
        this._disposeObjects("__P_546_0");
      } else {
        this.__P_546_0 = null;
      }
      this._disposeObjects("__P_546_2");
    }
  });
  qx.ui.core.SingleSelectionManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SingleSelectionManager.js.map?dt=1729101259991