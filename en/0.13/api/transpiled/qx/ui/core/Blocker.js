  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__P_532_0, this);
      widget.addListener("move", this.__P_532_0, this);
      widget.addListener("disappear", this.__P_532_1, this);
    ...
    */
    ...
    members: {
       ...
       */
      __P_532_0: function __P_532_0(e) {
        var data = e.getData();
        if (this.isBlocked()) {
       ...
       */
      __P_532_1: function __P_532_1() {
        if (this.isBlocked()) {
          this.getBlockerElement().getParent().remove(this.getBlockerElement());
          this._widget.addListenerOnce("appear", this.__P_532_8, this);
        }
      },
      /**
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_532_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_532_9("opacity", value);
      },
      /**
       ...
       */
      __P_532_9: function __P_532_9(key, value) {
        var blockers = [];
        this.__P_532_4 && blockers.push(this.__P_532_4);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_532_2.push(activeWidget);
        this.__P_532_3.push(focusedWidget);
        if (activeWidget) {
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_532_3.length;
        if (focusElementsLength > 0) {
          widget = this.__P_532_3.pop();
          if (widget && !widget.isDisposed() && widget.isFocusable()) {
            widget.focus();
          }
        }
        var activeElementsLength = this.__P_532_2.length;
        if (activeElementsLength > 0) {
          widget = this.__P_532_2.pop();
       ...
       */
      __P_532_10: function __P_532_10() {
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_532_4) {
          this.__P_532_4 = this.__P_532_10();
          this.__P_532_4.setStyle("zIndex", 15);
          if (!widget) {
            if (this._isRoot) {
              widget = this._widget;
            } else {
          ...
          widget.getContentElement().add(this.__P_532_4);
          this.__P_532_4.exclude();
        }
        return this.__P_532_4;
      },
      /**
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_532_7) {
            this.__P_532_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
          return;
        }
        var parent;
        ...
        if (this.__P_532_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__P_532_11, this);
          blocker.addListener("keypress", this.__P_532_12, this);
          blocker.addListener("keydown", this.__P_532_12, this);
          blocker.addListener("keyup", this.__P_532_12, this);
      ...
      unblock: function unblock() {
        if (this.__P_532_7) {
          this._widget.removeListenerById(this.__P_532_7);
          this.__P_532_7 = null;
        }
        if (!this.isBlocked()) {
          return;
       ...
       */
      __P_532_13: function __P_532_13() {
        this._restoreActiveWidget();
        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__P_532_11, this);
        blocker.removeListener("keypress", this.__P_532_12, this);
        blocker.removeListener("keydown", this.__P_532_12, this);
        blocker.removeListener("keyup", this.__P_532_12, this);
        blocker.exclude();
       ...
       */
      __P_532_12: function __P_532_12(e) {
       ...
       */
      __P_532_11: function __P_532_11() {
        //
    ...
    */
    destruct: function destruct() {
      ...
      this._widget.removeListener("resize", this.__P_532_0, this);
      this._widget.removeListener("move", this.__P_532_0, this);
      this._widget.removeListener("appear", this.__P_532_8, this);
      this._widget.removeListener("disappear", this.__P_532_1, this);
      if (this.__P_532_7) {
        this._widget.removeListenerById(this.__P_532_7);
      }
      this._disposeObjects("__P_532_4", "__P_532_6");
      this.__P_532_2 = this.__P_532_3 = this._widget = null;
    }
  });
  qx.ui.core.Blocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Blocker.js.map?dt=1735222442922