    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_542_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_542_2);

          // Remove the listener when the element disappears.
          this.__P_542_4 = function () {
            this.__P_542_5();
          };
          this.addListener("disappear", this.__P_542_4, this);
        }
       ...
       */
      __P_542_5: function __P_542_5() {
        if (this.__P_542_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_542_2);
          this.__P_542_2 = null;
        }
        if (this.__P_542_4) {
          this.removeListener("disappear", this.__P_542_4, this);
          this.__P_542_4 = null;
        }
      },
      /**
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          // Bind target and livupdate to placeToWidget
          this.__P_542_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_542_2);

          // Remove the listener when the element disappears.
          this.addListener("disappear", function () {
            if (_this.__P_542_2) {
              qx.event.Idle.getInstance().removeListener("interval", _this.__P_542_2);
              _this.__P_542_2 = null;
            }
          });
        }
        this._place(coords);
       ...
       *    first argument
       */
      __P_542_6: function __P_542_6(callback) {
        var _this2 = this;
        var size = null;
...
//# sourceMappingURL=MPlacement.js.map?dt=1731948134032