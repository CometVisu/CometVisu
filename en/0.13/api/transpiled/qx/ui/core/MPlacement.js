  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_316_5(); // Bind target and livupdate to placeToWidget


          this.__P_316_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_316_2); // Remove the listener when the element disappears.
...
//# sourceMappingURL=MPlacement.js.map?dt=1685978134823