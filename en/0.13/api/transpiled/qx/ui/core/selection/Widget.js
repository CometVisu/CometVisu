    ...
    members: {
      ...
      */
      ...
      _isSelectable: function _isSelectable(item) {
        return this._isItemSelectable(item) && item.getLayoutParent() === this.__P_332_0;
      },
      // overridden
      ...
      */
      ...
      _getDimension: function _getDimension() {
        return this.__P_332_0.getInnerSize();
      },
      // overridden
...
//# sourceMappingURL=Widget.js.map?dt=1677345942686