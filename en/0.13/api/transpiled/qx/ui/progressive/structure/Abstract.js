  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Abstract", {
    ...
    construct: function construct(pane) {
      ...
      if (!pane) {
        this.__P_434_0 = new qx.ui.core.Widget();
        this.__P_434_1 = this.__P_434_0;
      } else {
        this.__P_434_0 = null;
        this.__P_434_1 = pane;
      }
      this.__P_434_1.getContentElement().setStyle("overflowY", "auto");
    },
    members: {
      __P_434_0: null,
      __P_434_1: null,
    ...
    destruct: function destruct() {
      ...
      this.__P_434_0 = this.__P_434_1 = null;
    }
  });
  qx.ui.progressive.structure.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1703705688503