  ...
  qx.Class.define("qx.ui.progressive.Progressive", {
    ...
    members: {
      ...
      removeRenderer: function removeRenderer(name) {
        if (!this.__P_646_0[name]) {
          throw new Error("No existing renderer named " + name);
        }
        delete this.__P_646_0[name];
      },
      /**
      ...
      render: function render() {
        ...
        var state = new qx.ui.progressive.State({
          ...
          pane: this.__P_646_1.getPane(),
          batchSize: this.getBatchSize(),
          rendererData: this.__P_646_6(),
          userData: {}
        });

        // Record render start time
        this.__P_646_5 = new Date();
        ...
        if (this.__P_646_2) {
          ...
          this.__P_646_4 = state.getModel().getElementCount();

          // Let listeners know we're beginning to render
          this.fireDataEvent("renderStart", {
            state: state,
            initial: this.__P_646_4
          });

          // Begin rendering
          this.__P_646_7(state);
        } else {
      ...
      _applyDataModel: function _applyDataModel(value, old) {
        if (old) {
          ...
          old.removeListener("dataAvailable", this.__P_646_8, this);
        ...
        value.addListener("dataAvailable", this.__P_646_8, this);
      },
      /**
       ...
       *
       */
      __P_646_7: function __P_646_7(state) {
        var current;
        var element;
        var renderer;
        for (var i = state.getBatchSize(); i > 0; i--) {
          ...
          if (!current) {
            ...
            this.debug("Render time: " + (new Date() - this.__P_646_5) + "ms");
            this.__P_646_3 = false;
          ...
          renderer = this.__P_646_0[element.renderer];
       ...
       */
      __P_646_6: function __P_646_6() {
        var rendererData = {};
        for (var name in this.__P_646_0) {
          rendererData[name] = {};
        }
        return rendererData;
      },
       ...
       *
       */
      __P_646_8: function __P_646_8(e) {
        this.__P_646_4 = e.getData();
        this.render();
      }
    },
    /**
    ...
    destruct: function destruct() {
      ...
      for (var name in this.__P_646_0) {
        // ... dispose it
        this.__P_646_0[name].dispose();
      }

      // Clean up references
      this.__P_646_5 = this.__P_646_0 = this.__P_646_1 = null;
    }
  });
  qx.ui.progressive.Progressive.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Progressive.js.map?dt=1735383880861