  ...
  qx.Class.define("qx.ui.progressive.model.Default", {
    ...
    members: {
      ...
      addElements: function addElements(elems) {
        ...
        this.__P_649_0 = this.__P_649_0.concat(elems);

        // Tell Progressive that data is available
        this.fireDataEvent("dataAvailable", this.__P_649_0.length);
      },
      /**
...
//# sourceMappingURL=Default.js.map?dt=1717235415071