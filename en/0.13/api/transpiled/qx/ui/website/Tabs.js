    ...
    members: {
      ...
      init: function init() {
        ...
        if (active.length > 0) {
          ...
          this.__P_493_1(activePage);
          this._showPage(active, null);
          this.__P_493_2(activePage);
        }
       ...
       */
      __P_493_1: function __P_493_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __P_493_2: function __P_493_2(elem) {
...
//# sourceMappingURL=Tabs.js.map?dt=1677017728263