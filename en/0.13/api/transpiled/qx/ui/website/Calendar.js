    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (this.getConfig("selectionMode") == "single") {
          ...
          if (!this.__P_496_0) {
            this.__P_496_0 = value.map(function (val) {
      ...
      _selectDay: function _selectDay(e) {
        ...
        if (this.getConfig("selectionMode") == "range") {
          var range = this.__P_496_0.slice(0);
          if (range.length == 2) {
            range = [];
          }
          range.push(newStr);
          this.__P_496_0 = range;
...
//# sourceMappingURL=Calendar.js.map?dt=1700345612704