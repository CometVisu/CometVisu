  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Table", {
    ...
    statics: {
       ...
       */
      __P_735_1: function __P_735_1(n) {
       ...
       * @return {Boolean} The result of the check
       */
      __P_735_2: function __P_735_2(val) {
        var d = new Date(val);
       ...
       */
      __P_735_3: function __P_735_3(htmlCollection, htmlElement) {
        var index = -1;
       ...
       */
      __P_735_4: function __P_735_4() {
        return (new Date().getTime() + "" + Math.floor(Math.random() * 1000000)).substr(0, 18);
      },
      /** */
      __P_735_5: ["single", "multiple", "none"],
      /** */
      __P_735_6: "qx-table-cell",
      /** */
      __P_735_7: "qx-table-header",
      /** */
      __P_735_8: "qx-table-row-selection",
      /** */
      __P_735_9: "qx-table-selection-input",
      /** */
      __P_735_10: "qx-table-all-columns",
      /** */
      __P_735_11: "data-qx-table-col-name",
      /** */
      __P_735_12: "data-qx-table-col-type",
      /** */
      __P_735_13: "data-qx-table-cell-key",
      /** */
      __P_735_14: "cellKey",
      /** */
      __P_735_15: "qx-table-input-label",
      /** */
      __P_735_16: "qx-table-row-selected",
      /** */
      __P_735_17: "qx-table-sort-asc",
      /** */
      __P_735_18: "qqx-table-sort-desc"
    },
    members: {
      __P_735_0: null,
      __P_735_19: null,
      ...
      init: function init() {
        ...
        this.__P_735_24 = "input" + qx.ui.website.Table.__P_735_4();
        this.__P_735_27(model);
        this.setModel(model);
        this.setSortingFunction(this.__P_735_28);
        this.__P_735_29();
        this.__P_735_25 = null;
        return true;
      },
      /**
      ...
      setColumnType: function setColumnType(columnName, type) {
        this.__P_735_30(columnName);
        this.__P_735_19[columnName].type = type;
        return this;
      },
      /**
      ...
      getColumnType: function getColumnType(columnName) {
        this.eq(0).__P_735_30(columnName);
        return this.eq(0).__P_735_19[columnName].type;
      },
      /**
      ...
      getCell: function getCell(row, col) {
        return qxWeb(this.eq(0).__P_735_31().rows.item(row).cells.item(col));
      },
      /**
      ...
      getRows: function getRows() {
        return qxWeb(this.eq(0).__P_735_31().rows);
      },
      /**
      ...
      unsetSortingFunction: function unsetSortingFunction() {
        this.__P_735_20 = this.__P_735_28;
        return this;
      },
      /**
      ...
      unsetFilterFunction: function unsetFilterFunction() {
        this.__P_735_21 = this.__P_735_32;
        return this;
      },
      /**
      ...
      setColumnFilter: function setColumnFilter(columnName, func) {
        ...
        this.__P_735_22[columnName] = func;
        return this;
      },
      /**
      ...
      getColumnFilter: function getColumnFilter(columnName) {
        if (this.__P_735_22) {
          return this.__P_735_22[columnName];
        }
        return null;
      },
      /**
      ...
      sort: function sort(columnName, dir) {
        ...
        this.__P_735_33(this.__P_735_34(columnName, dir));
        this.emit("sort", {
      ...
      filter: function filter(keyword, columnName) {
        if (columnName) {
          ...
          columnName = qx.ui.website.Table.__P_735_10;
        }
        if (!this.__P_735_23) {
          this.__P_735_23 = {};
        }
        if (this.__P_735_23[columnName]) {
          this.__P_735_23[columnName].keyword = keyword;
          this.__P_735_31().appendChild(this.__P_735_23[columnName].rows);
        } else {
          this.__P_735_23[columnName] = {
            keyword: keyword,
            rows: document.createDocumentFragment()
          };
        }
        this.__P_735_35(keyword, columnName);
        this.emit("filter", {
          columName: columnName,
          keyword: keyword
        });
      ...
      resetFilter: function resetFilter(columnName) {
        var filters = null;
        filters = this.__P_735_23;
        if (filters) {
          if (columnName) {
            this.__P_735_31().appendChild(filters[columnName].rows);
          } else {
            for (var col in filters) {
              this.__P_735_31().appendChild(filters[col].rows);
            }
          }
        }
        return this;
      ...
      setContent: function setContent(tableData) {
        var rows = this.__P_735_36(tableData);
       ...
       */
      __P_735_36: function __P_735_36(data) {
        var rows = qxWeb();
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_35: function __P_735_35(keyword, columnName) {
        var colIndex = this.__P_735_37(columnName);
        var filterFunc = columnName == qx.ui.website.Table.__P_735_10 ? this.getRowFilter() : this.getColumnFilter(columnName);
        filterFunc = filterFunc || this.__P_735_32;
        var rows = this.__P_735_38(),
          data = {};
        for (var i = 0; i < rows.length; i++) {
          ...
          if (!filterFunc.bind(this)(data)) {
            this.__P_735_23[columnName].rows.appendChild(rows[i]);
          }
        }
        return this;
      },
      ...
      getSortingData: function getSortingData() {
        return this.__P_735_26;
      },
      //overridden
      render: function render() {
        var sortingData = this.getSortingData();
        var rowSelection = this.getConfig("rowSelection");
        this.__P_735_39(this.__P_735_0);
        if (qx.ui.website.Table.__P_735_5.indexOf(rowSelection) != -1) {
          this.__P_735_40(rowSelection);
        }
        if (sortingData) {
          this.__P_735_33(this.__P_735_34(sortingData.columnName, sortingData.direction));
        }
        return this;
      },
      //Private API
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_40: function __P_735_40(rowSelection) {
        switch (rowSelection) {
          case "none":
            qxWeb("." + qx.ui.website.Table.__P_735_8).remove();
            break;
          case "multiple":
          case "single":
            this.__P_735_41("checkbox");
            break;
          case "single":
            this.__P_735_41("radio");
            break;
        }
        return this;
      },
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_41: function __P_735_41(type) {
        this.__P_735_42(this.__P_735_43(), type);
        var rows = this.find("tbody")[0].getElementsByTagName("tr");
        for (var i = 0; i < rows.length; i++) {
          this.__P_735_42(rows.item(i), type);
        }
        return this;
      },
      /**
       ...
       */
      __P_735_42: function __P_735_42(row, type, nodeName) {
        var cssPrefix = this.getCssPrefix();
        var clazz = qx.ui.website.Table;
        var headerInput = qxWeb("." + clazz.__P_735_7 + " input");
        ...
        var inputName = this.__P_735_24;
        var className = nodeName == "th" ? clazz.__P_735_8 + " " + clazz.__P_735_7 : clazz.__P_735_8;
        var currentInput = qxWeb(row).find("." + clazz.__P_735_8);
        if (currentInput.length > 0) {
          if (currentInput[0].type != type) {
            currentInput[0].type = type;
          }
        } else {
          var id = qx.ui.website.Table.__P_735_4();
          var inputNode = qxWeb.create("<" + nodeName + " class='" + className + "'><input id='" + id + "' name='" + inputName + "' " + checked + " class='" + cssPrefix + "-" + type + " " + clazz.__P_735_9 + "' type='" + type + "' /><label class='" + clazz.__P_735_15 + "' for='" + id + "'></label></" + nodeName + ">");
          if (row.cells.item(0)) {
       ...
       */
      __P_735_30: function __P_735_30(columnName) {
        var data = this.__P_735_19;
       ...
       */
      __P_735_43: function __P_735_43() {
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_27: function __P_735_27(model) {
        this.__P_735_44(this[0].tHead);
        this.__P_735_44(this[0].tFoot);
        var data = {},
          cells = null,
          colName = null,
          cell = null;
        var headerRow = this.__P_735_43();
        cells = headerRow.cells;
        for (var i = 0, l = cells.length; i < l; i++) {
          cell = qxWeb(cells.item(i));
          colName = this.__P_735_45(cell[0]) || qx.ui.website.Table.__P_735_4();
          if (!cell[0].getAttribute(qx.ui.website.Table.__P_735_11)) {
            cell.setAttribute(qx.ui.website.Table.__P_735_11, colName);
          }
          data[colName] = {
            type: cell[0].getAttribute(qx.ui.website.Table.__P_735_12) || "String",
            name: colName
          };
        }
        this.__P_735_19 = data;
        return this;
      },
      /**
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_44: function __P_735_44(footOrHead) {
        if (footOrHead && footOrHead.rows.length > 0) {
          if (footOrHead.rows.item(0).cells.length > 0) {
            var row = this.__P_735_43();
            if (!qxWeb(row.cells.item(0)).hasClass(qx.ui.website.Table.__P_735_7)) {
              qxWeb(row.cells).addClass(qx.ui.website.Table.__P_735_7);
            }
          }
        }
        return this;
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_33: function __P_735_33(dataRows) {
        for (var i = 0, l = dataRows.length; i < l; i++) {
          if (i) {
            qxWeb(dataRows[i]).insertAfter(dataRows[i - 1]);
          } else {
            qxWeb(dataRows[i]).insertBefore(qxWeb(this.__P_735_31().rows.item(0)));
          }
        }
        return this;
      },
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_29: function __P_735_29() {
        this.on("tap", this.__P_735_46);
        this.on("cellClick", function (data) {
          if (data.cell && data.cell.hasClass(qx.ui.website.Table.__P_735_7)) {
            this.__P_735_20.bind(this)(data);
          }
        }, this);
        this.on("pointerover", this.__P_735_47, this);
        this.on("pointerout", this.__P_735_48, this);
        return this;
      },
      /**
       ...
       */
      __P_735_49: function __P_735_49() {
        return qxWeb("." + qx.ui.website.Table.__P_735_8).length > 0;
      },
      /**
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_50: function __P_735_50(cell) {
        var clazz = qx.ui.website.Table;
        var inputs = qxWeb("." + clazz.__P_735_9);
        var clickedInput = cell.find("input");
        var selectionMode = this.getConfig("rowSelection");
        var headerInput = qxWeb("." + clazz.__P_735_7 + " input");
        var selection = [];
        if (selectionMode == "multiple") {
          if (cell.hasClass(clazz.__P_735_7)) {
        ...
        qxWeb("." + clazz.__P_735_16).removeClass(clazz.__P_735_16);
        selectedRows.addClass(clazz.__P_735_16);
       ...
       */
      __P_735_51: function __P_735_51(eventType, cell, target) {
        var row = cell[0].parentNode,
          cells = row.cells;
        var colNumber = qx.ui.website.Table.__P_735_3(cells, cell[0]);
        var tHead = this.__P_735_43();
        var headCell = tHead.cells.item(colNumber);
        var colName = this.__P_735_45(headCell);
        var columnIndex = this.getConfig("rowSelection") != "none" ? this.__P_735_37(colName) - 1 : this.__P_735_37(colName);
        var data = {
          cell: qxWeb(cell),
          row: qxWeb(row),
          target: target,
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_46: function __P_735_46(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var clazz = qx.ui.website.Table;
        while (!(cell.hasClass(clazz.__P_735_6) || cell.hasClass(clazz.__P_735_7) || cell.hasClass(clazz.__P_735_8))) {
        ...
        if (cell.hasClass(clazz.__P_735_8)) {
          window.setTimeout(function () {
            this.__P_735_50(cell);
          }.bind(this), 5);
        } else {
          if (cell && cell.length > 0) {
            this.__P_735_51("cellClick", cell, target);
          }
        }
        return this;
      },
       ...
       */
      __P_735_47: function __P_735_47(e) {
        var target = e.getTarget();
        var cell = qxWeb(target);
        var hovered = this.__P_735_25;
        ...
        if (cell && cell.length > 0 && (hovered && hovered.cell[0] != cell[0] || !hovered) && !cell.hasClass("qx-table-row-selection")) {
          ...
          this.__P_735_25 = this.__P_735_51("cellHover", cell, target);
        }
      },
      /**
       * pointerout callback
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_39: function __P_735_39(model) {
        if (model && model.length > 0) {
          ...
          if (this.__P_735_31().rows.length > model.length) {
            this.__P_735_52(model.length);
          }
          ...
          for (var i = 0, rowCount = model.length; i < rowCount; i++) {
            row = model[i];
            if (!this.__P_735_53(i)) {
              createdRow = this.__P_735_31().insertRow(i);
              if (this.__P_735_49()) {
                this.__P_735_42(createdRow, inputType, "td");
              }
            }
            for (var j = 0, colCount = row.length; j < colCount; j++) {
              renderedColIndex = this.__P_735_49() ? j + 1 : j;
              colName = this.__P_735_45(tHead.cells.item(renderedColIndex));
              colMeta = this.__P_735_54(colName);
              coltemplate = this.getTemplate(colName) || coltemplate;
              renderedRow = this.__P_735_31().rows.item(i);
              cell = qxWeb.create(qxWeb.template.render(coltemplate, model[i][j]))[0];
              if (cell.nodeName.toUpperCase() != "TD") {
                break;
              }
              if (!this.__P_735_55(i, renderedColIndex)) {
       ...
       * @return {qx.ui.website.Table} <code>this</code> reference for chaining.
       */
      __P_735_52: function __P_735_52(rowCount) {
        var renderedRows = this.__P_735_31().rows;
       ...
       */
      __P_735_54: function __P_735_54(columName) {
        return this.__P_735_19[columName];
      },
      /**
       * Gets the Root element containing the data rows
       * @return {HTMLElement} The element containing the data rows
       */
      __P_735_31: function __P_735_31() {
       ...
       * @return {Boolean} The result of the check
       */
      __P_735_53: function __P_735_53(index) {
        if (this.__P_735_31().rows.item(index)) {
          return true;
        }
        return false;
      },
       ...
       * @return {Boolean} The result of the check
       */
      __P_735_55: function __P_735_55(rowIndex, colIndex) {
        if (!this.__P_735_53(rowIndex)) {
          return false;
        }
        if (this.__P_735_31().rows.item(rowIndex).cells.item(colIndex)) {
          return true;
        }
        return false;
      },
      ...
      setSortingClass: function setSortingClass(columnName, dir) {
        ...
        this.__P_735_26 = data;
        this.__P_735_56(this[0].tHead, columnName, dir);
      },
      /**
       ...
       * @param dir {String} The sorting direction
       */
      __P_735_56: function __P_735_56(HeaderOrFooter, columnName, dir) {
        var rows = this.__P_735_43();
        if (HeaderOrFooter && rows) {
          qxWeb(rows.cells).removeClasses(["qx-table-sort-asc", "qx-table-sort-desc"]);
          var cell = qxWeb("[" + qx.ui.website.Table.__P_735_11 + "='" + columnName + "'], #" + columnName);
       ...
       */
      __P_735_34: function __P_735_34(columnName, direction) {
        var meta = this.__P_735_54(columnName);
        ...
        var model = this.__P_735_38();
        var columnIndex = this.__P_735_37(columnName);
        return model.sort(function (a, b) {
          var x = this.__P_735_57(qxWeb(a.cells.item(columnIndex)));
          var y = this.__P_735_57(qxWeb(b.cells.item(columnIndex)));
      ...
      _compareNumber: function _compareNumber(x, y, direction) {
        x = qx.ui.website.Table.__P_735_1(x) ? Number(x) : 0;
        y = qx.ui.website.Table.__P_735_1(y) ? Number(y) : 0;
        if (direction == "asc") {
          return x - y;
       ...
       */
      __P_735_45: function __P_735_45(headerCell) {
        return headerCell.getAttribute(qx.ui.website.Table.__P_735_11) || headerCell.getAttribute("id");
      },
      /**
       * Compares two Dates
      ...
      _compareDate: function _compareDate(x, y, direction) {
        x = qx.ui.website.Table.__P_735_2(x) ? new Date(x) : new Date(0);
        y = qx.ui.website.Table.__P_735_2(y) ? new Date(y) : new Date(0);
        if (direction == "asc") {
          return x - y;
        } else if (direction == "desc") {
          return y - x;
       ...
       */
      __P_735_57: function __P_735_57(cell) {
        return cell.getAttribute(qx.ui.website.Table.__P_735_13) || this.__P_735_58(cell);
      },
      /**
       ...
       */
      __P_735_58: function __P_735_58(cell) {
       ...
       */
      __P_735_38: function __P_735_38() {
        ...
        for (var i = 0, l = rows.length; i < l; i++) {
          ...
          for (var j = 0, len = cells.length; j < len; j++) {
            cell = qxWeb(cells[j]);
            if (!cell.hasClass(qx.ui.website.Table.__P_735_6)) {
              cell.addClass(qx.ui.website.Table.__P_735_6);
            }
          }
       ...
       */
      __P_735_28: function __P_735_28(data) {
        var dir = "asc";
       ...
       */
      __P_735_32: function __P_735_32(data) {
        var caseSensitive = this.getConfig("caseSensitive");
        var cell = data.columnName == qx.ui.website.Table.__P_735_10 ? data.row : data.cell;
        var cellValue = this.__P_735_58(cell);
        if (caseSensitive) {
       ...
       */
      __P_735_37: function __P_735_37(columnName) {
        var tHead = this.__P_735_43();
        var cells = tHead.cells;
        for (var i = 0; i < cells.length; i++) {
          if (columnName == this.__P_735_45(cells.item(i))) {
            return i;
          }
        }
        return -1;
...
//# sourceMappingURL=Table.js.map?dt=1778272855110