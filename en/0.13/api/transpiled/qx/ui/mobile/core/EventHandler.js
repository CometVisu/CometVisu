  ...
  qx.Class.define("qx.ui.mobile.core.EventHandler", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_618_0 = qx.event.Registration.getManager(window);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    statics: {
       ...
       */
      __P_618_6: function __P_618_6(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }
        var EventHandler = qx.ui.mobile.core.EventHandler;
        EventHandler.__P_618_2 = qx.bom.Viewport.getScrollLeft();
        EventHandler.__P_618_3 = qx.bom.Viewport.getScrollTop();
        EventHandler.__P_618_4 = domEvent.getScreenTop();
        EventHandler.__P_618_7();
        ...
        EventHandler.__P_618_1 = target;
        EventHandler.__P_618_8 = window.setTimeout(function () {
          EventHandler.__P_618_8 = null;
          var target = EventHandler.__P_618_1;
       ...
       */
      __P_618_9: function __P_618_9(domEvent) {
        qx.ui.mobile.core.EventHandler.__P_618_10();
      },
      /**
       ...
       */
      __P_618_11: function __P_618_11(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }
        var EventHandler = qx.ui.mobile.core.EventHandler;
        var deltaY = domEvent.getScreenTop() - EventHandler.__P_618_4;
        if (EventHandler.__P_618_1 && Math.abs(deltaY) >= qx.event.handler.GestureCore.TAP_MAX_DISTANCE[domEvent.getPointerType()]) {
          EventHandler.__P_618_10();
        }
        if (EventHandler.__P_618_1 && (EventHandler.__P_618_2 != qx.bom.Viewport.getScrollLeft() || EventHandler.__P_618_3 != qx.bom.Viewport.getScrollTop())) {
          EventHandler.__P_618_10();
        }
      },
      /**
       ...
       */
      __P_618_7: function __P_618_7() {
        var EventHandler = qx.ui.mobile.core.EventHandler;
        if (EventHandler.__P_618_8) {
          window.clearTimeout(EventHandler.__P_618_8);
          EventHandler.__P_618_8 = null;
        }
      },
      /**
       ...
       */
      __P_618_10: function __P_618_10() {
        var EventHandler = qx.ui.mobile.core.EventHandler;
        EventHandler.__P_618_7();
        var activeTarget = EventHandler.__P_618_1;
        if (activeTarget) {
          qx.bom.element.Class.remove(activeTarget, "active");
        }
        EventHandler.__P_618_1 = null;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        var listeners = this.__P_618_0.getListeners(currentWidget, type, capture);
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(document, "pointerdown", statics.__P_618_6);
      qx.event.Registration.addListener(document, "pointerup", statics.__P_618_9);
      qx.event.Registration.addListener(document, "pointercancel", statics.__P_618_9);
      qx.event.Registration.addListener(document, "pointermove", statics.__P_618_11);
    }
  });
  qx.ui.mobile.core.EventHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=EventHandler.js.map?dt=1735341796721