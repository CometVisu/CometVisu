  ...
  qx.Class.define("qx.ui.mobile.core.EventHandler", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_390_0 = qx.event.Registration.getManager(window);
    },
    ...
    */
    statics: {
       ...
       */
      __P_390_6: function __P_390_6(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }

        var EventHandler = qx.ui.mobile.core.EventHandler;
        EventHandler.__P_390_2 = qx.bom.Viewport.getScrollLeft();
        EventHandler.__P_390_3 = qx.bom.Viewport.getScrollTop();
        EventHandler.__P_390_4 = domEvent.getScreenTop();

        EventHandler.__P_390_7();
        ...
        EventHandler.__P_390_1 = target;
        EventHandler.__P_390_8 = window.setTimeout(function () {
          EventHandler.__P_390_8 = null;
          var target = EventHandler.__P_390_1;
       ...
       */
      __P_390_9: function __P_390_9(domEvent) {
        qx.ui.mobile.core.EventHandler.__P_390_10();
      },
       ...
       */
      __P_390_11: function __P_390_11(domEvent) {
        if (!domEvent.isPrimary()) {
          return;
        }
        ...
        var deltaY = domEvent.getScreenTop() - EventHandler.__P_390_4;

        if (EventHandler.__P_390_1 && Math.abs(deltaY) >= qx.event.handler.GestureCore.TAP_MAX_DISTANCE[domEvent.getPointerType()]) {
          EventHandler.__P_390_10();
        }

        if (EventHandler.__P_390_1 && (EventHandler.__P_390_2 != qx.bom.Viewport.getScrollLeft() || EventHandler.__P_390_3 != qx.bom.Viewport.getScrollTop())) {
          EventHandler.__P_390_10();
        }
      },
       ...
       */
      __P_390_7: function __P_390_7() {
        var EventHandler = qx.ui.mobile.core.EventHandler;

        if (EventHandler.__P_390_8) {
          window.clearTimeout(EventHandler.__P_390_8);
          EventHandler.__P_390_8 = null;
        }
      },
       ...
       */
      __P_390_10: function __P_390_10() {
        var EventHandler = qx.ui.mobile.core.EventHandler;

        EventHandler.__P_390_7();

        var activeTarget = EventHandler.__P_390_1;

        if (activeTarget) {
          qx.bom.element.Class.remove(activeTarget, "active");
        }

        EventHandler.__P_390_1 = null;
      }
    },
    ...
    */
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        var listeners = this.__P_390_0.getListeners(currentWidget, type, capture);
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(document, "pointerdown", statics.__P_390_6);
      qx.event.Registration.addListener(document, "pointerup", statics.__P_390_9);
      qx.event.Registration.addListener(document, "pointercancel", statics.__P_390_9);
      qx.event.Registration.addListener(document, "pointermove", statics.__P_390_11);
    }
  });
  qx.ui.mobile.core.EventHandler.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=EventHandler.js.map?dt=1685978142758