  ...
  qx.Class.define("qx.ui.mobile.core.Widget", {
    ...
    */
    ...
    statics: {
      ...
      onShutdown: function onShutdown() {
        window.clearTimeout(qx.ui.mobile.core.Widget.__P_634_3);
        delete qx.ui.mobile.core.Widget.__P_634_1;
      },
      /**
      ...
      getCurrentId: function getCurrentId() {
        return qx.ui.mobile.core.Widget.__P_634_2;
      },
      /**
      ...
      registerWidget: function registerWidget(widget) {
        var id = widget.getId();
        var registry = qx.ui.mobile.core.Widget.__P_634_1;
        registry[id] = widget;
      },
      /**
      ...
      unregisterWidget: function unregisterWidget(id) {
        delete qx.ui.mobile.core.Widget.__P_634_1[id];
      },
      /**
      ...
      getWidgetById: function getWidgetById(id) {
        return qx.ui.mobile.core.Widget.__P_634_1[id];
      },
      /**
      ...
      scheduleDomUpdated: function scheduleDomUpdated() {
        if (qx.ui.mobile.core.Widget.__P_634_3 == null) {
          qx.ui.mobile.core.Widget.__P_634_3 = window.setTimeout(qx.ui.mobile.core.Widget.domUpdated, 0);
        }
      },
      /**
      ...
      domUpdated: qx.event.GlobalError.observeMethod(function () {
        ...
        window.clearTimeout(clazz.__P_634_3);
        clazz.__P_634_3 = null;
    ...
    members: {
      ...
      */
      ...
      _transformId: function _transformId(value) {
        if (value == null) {
          var clazz = qx.ui.mobile.core.Widget;
          value = clazz.ID_PREFIX + clazz.__P_634_2++;
        }
        return value;
      },
      // property apply
      ...
      */
      ...
      _addAt: function _addAt(child, index, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__P_634_0, child);
        }
        var ref = this.__P_634_0[index];
        if (ref) {
      ...
      _addBefore: function _addBefore(child, beforeWidget, layoutProperties) {
        ...
        qx.lang.Array.insertBefore(this.__P_634_0, child, beforeWidget);
        this._domUpdated();
      },
      /**
      ...
      _addAfter: function _addAfter(child, afterWidget, layoutProperties) {
        ...
        qx.lang.Array.insertAfter(this.__P_634_0, child, afterWidget);
        this._domUpdated();
      },
      /**
      ...
      _removeAt: function _removeAt(index) {
        ...
        var child = this.__P_634_0[index];
        this._remove(child);
      },
      /**
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__P_634_0.concat();
      ...
      setLayoutParent: function setLayoutParent(parent) {
        if (this.__P_634_6 === parent) {
          return;
        }
        var oldParent = this.__P_634_6;
        if (oldParent && !oldParent.$$disposed) {
          this.__P_634_6.removeChild(this);
        }
        this.__P_634_6 = parent || null;
      },
      /**
      ...
      _hasChildren: function _hasChildren() {
        return this.__P_634_0 && this.__P_634_0.length > 0;
      },
      /*
       ---------------------------------------------------------------------------
         Layout handling
      ...
      _setLayout: function _setLayout(layout) {
        if (this.__P_634_7) {
          this.__P_634_7.connectToWidget(null);
          for (var i = 0; i < this._getChildren().length; i++) {
            var child = this._getChildren()[i];
            this.__P_634_7.disconnectFromChildWidget(child);
          }
        }
        if (layout) {
          layout.connectToWidget(this);
        }
        this.__P_634_7 = layout;
        this._domUpdated();
      },
      /**
      ...
      */
       ...
       * @param properties {Map} The animation properties to set. Key / value pairs.
       */
      __P_634_8: function __P_634_8(action, properties) {
      ...
      show: function show(properties) {
        this.__P_634_8("visible", properties);
      },
      /**
       * Hide this widget.
       *
      ...
      hide: function hide(properties) {
        this.__P_634_8("hidden", properties);
      },
      /**
      ...
      exclude: function exclude(properties) {
        this.__P_634_8("excluded", properties);
      },
      /**
      ...
      */
      ...
      getContentElement: function getContentElement() {
        if (!this.__P_634_5) {
          this.__P_634_5 = this._getContentElement();
        }
        return this.__P_634_5;
      },
      /**
       * Returns the content DOM element of the widget.
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_634_6 = this.__P_634_4 = this.__P_634_5 = null;
      if (this.__P_634_7) {
        this.__P_634_7.dispose();
      }
      this.__P_634_7 = null;
    },
    /*
...
//# sourceMappingURL=Widget.js.map?dt=1778272850677