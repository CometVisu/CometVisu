  ...
  qx.Class.define("qx.ui.mobile.core.DomUpdatedHandler", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_630_0 = manager;
      this.__P_630_1 = {};

      // Register
      qx.ui.mobile.core.DomUpdatedHandler.__P_630_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
      ...
      refresh: function refresh() {
        ...
        for (var hash in targets) {
          ...
          if (target && !target.$$disposed && target.isSeeable()) {
            ...
            this.__P_630_0.dispatchEvent(target, evt);
          }
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__P_630_0 = this.__P_630_1 = null;

      // Deregister
      delete qx.ui.mobile.core.DomUpdatedHandler.__P_630_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=DomUpdatedHandler.js.map?dt=1782595077676