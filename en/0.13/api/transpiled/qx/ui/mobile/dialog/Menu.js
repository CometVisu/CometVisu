    ...
    */
    ...
    members: {
      ...
      _createClearButton: function _createClearButton() {
        ...
        clearButton.addListener("tap", this.__P_396_4, this);
        clearButton.exclude();
        return clearButton;
      },
      /**
      ...
      _applyNullable: function _applyNullable(value, old) {
        if (value) {
          this.__P_396_2.setVisibility("visible");
        } else {
          this.__P_396_2.setVisibility("excluded");
        }
      },
      // property apply
...
//# sourceMappingURL=Menu.js.map?dt=1677362762147