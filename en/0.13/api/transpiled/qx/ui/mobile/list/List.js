  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.List", {
    ...
    construct: function construct(delegate) {
      ...
      this.__P_417_0 = new qx.ui.mobile.list.provider.Provider(this);
    ...
    members: {
      ...
      _onTrackStart: function _onTrackStart(evt) {
        ...
        if (element && qx.bom.element.Class.has(element, "list-item") && qx.bom.element.Class.has(element, "removable")) {
          this.__P_417_3 = element;
          this.__P_417_1 = qx.bom.element.Dimension.getWidth(element) / 2;
      ...
      _onTrack: function _onTrack(evt) {
        ...
        var element = this.__P_417_3;
        var delta = evt.getDelta();
        var deltaX = Math.round(delta.x * 0.1) / 0.1;
        if (this.__P_417_2 === null) {
          this.__P_417_2 = delta.axis == "x";
        }
        if (!this.__P_417_2) {
          return;
        }
        var opacity = 1 - Math.abs(deltaX) / this.__P_417_1;
      ...
      _onTrackEnd: function _onTrackEnd(evt) {
        ...
        var element = this.__P_417_3;
        if (Math.abs(evt.getDelta().x) > this.__P_417_1) {
      ...
      _applyModel: function _applyModel(value, old) {
        if (old != null) {
          old.removeListener("changeBubble", this.__P_417_4, this);
        }
        if (value != null) {
          value.addListener("changeBubble", this.__P_417_4, this);
        }
        if (old != null) {
          old.removeListener("change", this.__P_417_5, this);
        }
        if (value != null) {
          value.addListener("change", this.__P_417_5, this);
        }
        if (old != null) {
          old.removeListener("changeLength", this.__P_417_6, this);
        }
        if (value != null) {
          value.addListener("changeLength", this.__P_417_6, this);
        }
        this.__P_417_7();
      },
      // property apply
      _applyDelegate: function _applyDelegate(value, old) {
        this.__P_417_0.setDelegate(value);
      },
      /**
       * Listen on model 'changeLength' event.
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __P_417_6: function __P_417_6(evt) {
        this.__P_417_7();
      },
      /**
       ...
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __P_417_5: function __P_417_5(evt) {
       ...
       */
      __P_417_4: function __P_417_4(evt) {
        if (evt) {
       ...
       */
      __P_417_8: function __P_417_8(index) {
        var renderedItems = qx.bom.Selector.query(".list-item", this.getContentElement());
        var oldNode = renderedItems[index];
        var newNode = this.__P_417_0.getItemElement(this.getModel().getItem(index), index);
      ...
      __P_417_7: function __P_417_7() {
        ...
        for (var index = 0; index < this.getItemCount(); index++) {
          ...
          var itemElement = this.__P_417_0.getItemElement(item, index);
          var itemHeight = null;
      ...
      _renderGroup: function _renderGroup(itemIndex, groupIndex) {
        var group = this.__P_417_10(itemIndex);
        if (itemIndex === 0) {
          return this.__P_417_0.getGroupElement(group, groupIndex);
        } else {
          var previousGroup = this.__P_417_10(itemIndex - 1);
       ...
       */
      __P_417_10: function __P_417_10(index) {
    ...
    destruct: function destruct() {
      this.__P_417_3 = null;
      this._disposeObjects("__P_417_0");
      {
...
//# sourceMappingURL=List.js.map?dt=1709410163761