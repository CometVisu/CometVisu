  ...
  qx.Class.define("qx.ui.mobile.list.renderer.group.Default", {
    ...
    members: {
      ...
      setImage: function setImage(source) {
        this.__P_640_0.setSource(source);
      },
      /**
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__P_640_1.setValue(title.translate());
        } else {
          this.__P_640_1.setValue(title);
        }
      },
      /**
      ...
      _init: function _init() {
        this.__P_640_0 = this._createImage();
        this.add(this.__P_640_0);
        this.__P_640_2 = this._createRightContainer();
        this.add(this.__P_640_2, {
          flex: 1
        });
        this.__P_640_1 = this._createTitle();
        this.__P_640_2.add(this.__P_640_1);
      },
      /**
      ...
      reset: function reset() {
        this.__P_640_0.setSource(null);
        this.__P_640_1.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_640_0", "__P_640_1", "__P_640_2");
    }
  });
  qx.ui.mobile.list.renderer.group.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1735222447526