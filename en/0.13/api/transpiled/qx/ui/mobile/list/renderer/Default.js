  ...
  qx.Class.define("qx.ui.mobile.list.renderer.Default", {
    ...
    members: {
      ...
      setImage: function setImage(source) {
        this.__P_652_0.setSource(source);
      },
      /**
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__P_652_1.setValue(title.translate());
        } else {
          this.__P_652_1.setValue(title);
        }
      },
      /**
      ...
      setSubtitle: function setSubtitle(subtitle) {
        if (subtitle && subtitle.translate) {
          this.__P_652_2.setValue(subtitle.translate());
        } else {
          this.__P_652_2.setValue(subtitle);
        }
      },
      /**
      ...
      _init: function _init() {
        this.__P_652_0 = this._createImage();
        this.add(this.__P_652_0);
        this.__P_652_3 = this._createRightContainer();
        this.add(this.__P_652_3, {
          flex: 1
        });
        this.__P_652_1 = this._createTitle();
        this.__P_652_3.add(this.__P_652_1);
        this.__P_652_2 = this._createSubtitle();
        this.__P_652_3.add(this.__P_652_2);
      },
      /**
      ...
      reset: function reset() {
        this.__P_652_0.setSource(null);
        this.__P_652_1.setValue("");
        this.__P_652_2.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_652_0", "__P_652_1", "__P_652_2", "__P_652_3");
    }
  });
  qx.ui.mobile.list.renderer.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1778272851359