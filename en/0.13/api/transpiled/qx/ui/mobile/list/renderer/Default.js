    ...
    members: {
      ...
      setSubtitle: function setSubtitle(subtitle) {
        if (subtitle && subtitle.translate) {
          this.__P_639_2.setValue(subtitle.translate());
        } else {
          this.__P_639_2.setValue(subtitle);
        }
      },
      /**
      ...
      _init: function _init() {
        ...
        this.__P_639_3 = this._createRightContainer();
        this.add(this.__P_639_3, {
          flex: 1
        });
        this.__P_639_1 = this._createTitle();
        this.__P_639_3.add(this.__P_639_1);
        this.__P_639_2 = this._createSubtitle();
        this.__P_639_3.add(this.__P_639_2);
      },
      /**
      ...
      reset: function reset() {
        ...
        this.__P_639_2.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_639_0", "__P_639_1", "__P_639_2", "__P_639_3");
    }
  });
  qx.ui.mobile.list.renderer.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1735383880597