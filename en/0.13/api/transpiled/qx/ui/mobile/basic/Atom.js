  ...
  qx.Class.define("qx.ui.mobile.basic.Atom", {
    ...
    */
    ...
    members: {
      ...
      _applyLabel: function _applyLabel(value, old) {
        if (this.__P_382_2) {
          this.__P_382_2.setValue(value);
        } else {
          this.__P_382_2 = this._createLabelWidget(value);
        }
      },
      // property apply
      _applyIcon: function _applyIcon(value, old) {
        if (this.__P_382_3) {
          this.__P_382_3.setSource(value);
        } else {
       ...
       */
      __P_382_5: function __P_382_5(verticalLayout, hasNoLabel) {
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_382_1", "__P_382_2", "__P_382_3", "__P_382_4");
    }
  });
  qx.ui.mobile.basic.Atom.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Atom.js.map?dt=1691935438329