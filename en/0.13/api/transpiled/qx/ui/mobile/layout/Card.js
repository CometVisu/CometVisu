  ...
  qx.Class.define("qx.ui.mobile.layout.Card", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_636_0 = new qx.ui.mobile.layout.CardAnimation();
    },
    /*
    *****************************************************************************
       EVENTS
    ...
    */
    ...
    members: {
      ...
      _showWidget: function _showWidget(widget, properties) {
        if (this.__P_636_1 == widget) {
          return;
        }
        if (this.__P_636_3) {
          this.__P_636_6();
        }
        this.__P_636_1 = widget;
        if (this.__P_636_2 && this.getShowAnimation() && qx.core.Environment.get("css.transform.3d")) {
      ...
      _swapWidget: function _swapWidget() {
        if (this.__P_636_2) {
          this.__P_636_2.removeCssClass("active");
          this.__P_636_2.exclude();
        }
        this.__P_636_2 = this.__P_636_1;
        this.__P_636_2.addCssClass("active");
      },
      /**
       ...
       * @param widget {qx.ui.mobile.core.Widget} The target widget
       */
      __P_636_7: function __P_636_7(widget) {
        if (widget.isDisposed()) {
          return;
        }
        // Fix size of current and next widget, then start animation.
        this.__P_636_3 = true;
        this.fireDataEvent("animationStart", [this.__P_636_2, widget]);
        var fromElement = this.__P_636_2.getContainerElement();
        ...
        var fromCssClasses = this.__P_636_8("out");
        var toCssClasses = this.__P_636_8("in");
        this._widget.addCssClass("animationParent");
        var toElementAnimation = this.__P_636_0.getAnimation(this.__P_636_4, "in", this.__P_636_5);
        var fromElementAnimation = this.__P_636_0.getAnimation(this.__P_636_4, "out", this.__P_636_5);
      ...
      _onAnimationEnd: function _onAnimationEnd(evt) {
        this.__P_636_6();
        this.fireDataEvent("animationEnd", [this.__P_636_2, this.__P_636_1]);
      },
      /**
       * Stops the animation for the page transition.
       */
      __P_636_6: function __P_636_6() {
        if (this.__P_636_3) {
          var fromElement = this.__P_636_2.getContainerElement();
          var toElement = this.__P_636_1.getContainerElement();
          ...
          qx.bom.element.Class.removeClasses(fromElement, this.__P_636_8("out"));
          qx.bom.element.Class.removeClasses(toElement, this.__P_636_8("in"));
          this._swapWidget();
          this._widget.removeCssClass("animationParent");
          this.__P_636_3 = false;
        }
      },
      /**
       ...
       */
      __P_636_8: function __P_636_8(direction) {
        var classes = ["animationChild", this.__P_636_4, direction];
        if (this.__P_636_5) {
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_636_0");
    }
  });
  qx.ui.mobile.layout.Card.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Card.js.map?dt=1735222447370