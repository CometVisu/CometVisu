    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_648_0) {
            for (var property in this.__P_648_0) {
              this.reset(property);
              this.set(property, this.__P_648_0[property]);
            }
          }
        } else {
          this.__P_648_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_648_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_648_2: function __P_648_2(widget) {
        if (!this.__P_648_1) {
          this.__P_648_1 = {};
        }
        var cache = this.__P_648_1;
...
//# sourceMappingURL=Abstract.js.map?dt=1782595078230