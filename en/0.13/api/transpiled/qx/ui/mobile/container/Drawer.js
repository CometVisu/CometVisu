  ...
  qx.Class.define("qx.ui.mobile.container.Drawer", {
    ...
    */
    ...
    construct: function construct(parent, layout) {
      ...
      this.__P_384_0 = this.getLayoutParent();
      this.__P_384_0.addCssClass("drawer-parent");
      this.__P_384_0.addListener("swipe", this._onParentSwipe, this);
      this.__P_384_0.addListener("pointerdown", this._onParentPointerDown, this);
      this.__P_384_1 = [0, 0];
      this.forceHide();
    },
    /*
    ...
    */
    members: {
      ...
      _applyPositionZ: function _applyPositionZ(value, old) {
        ...
        this.addCssClass(value);
        if (this.__P_384_0) {
          this.__P_384_0.setTranslateX(0);
          this.__P_384_0.setTranslateY(0);
        }
      },
      // property apply
      ...
      _applyTransitionDuration: function _applyTransitionDuration(value, old) {
        this.__P_384_2 = value > 0;
      },
      /**
       * Shows the drawer.
       */
      show: function show() {
        if (!this.isHidden() || this.__P_384_3 === true) {
          return;
        }
        this.__P_384_3 = true;
      ...
      hide: function hide() {
        ...
        if (this.getTransitionDuration() > 0) {
          ...
          var listenerId = qx.bom.Element.addListener(transitionTarget, "transitionEnd", function (evt) {
            ...
            this._disableTransition();
            this.__P_384_0.removeCssClass("blocked");
            this.__P_384_3 = false;
            qx.bom.Element.removeListenerById(transitionTarget, listenerId);
          }, this);
          setTimeout(function () {
      ...
      _onParentPointerDown: function _onParentPointerDown(evt) {
        this.__P_384_1 = [evt.getViewportLeft(), evt.getViewportTop()];
        ...
        if (isShown && this.isHideOnParentTap()) {
          ...
          if (orientation == "left" && this.__P_384_1[0] > location.right || orientation == "top" && this.__P_384_1[1] > location.bottom || orientation == "bottom" && this.__P_384_1[1] < location.top || orientation == "right" && this.__P_384_1[0] < location.left) {
      ...
      _onParentSwipe: function _onParentSwipe(evt) {
        ...
        if (isHidden) {
          var location = qx.bom.element.Location.get(this.getContainerElement());
          if (direction == "right" && this.getOrientation() == "left" && this.__P_384_1[0] < location.right + this.getTapOffset() && this.__P_384_1[0] > location.right || direction == "left" && this.getOrientation() == "right" && this.__P_384_1[0] > location.left - this.getTapOffset() && this.__P_384_1[0] < location.left || direction == "down" && this.getOrientation() == "top" && this.__P_384_1[1] < this.getTapOffset() + location.bottom && this.__P_384_1[1] > location.bottom || direction == "up" && this.getOrientation() == "bottom" && this.__P_384_1[1] > location.top - this.getTapOffset() && this.__P_384_1[1] < location.top) {
            this.show();
          }
        }
      }
    ...
    destruct: function destruct() {
      ...
      this.__P_384_0.removeListener("swipe", this._onParentSwipe, this);
      this.__P_384_0.removeListener("pointerdown", this._onParentPointerDown, this);
      qx.util.DisposeUtil.destroyContainer(this);
      this.__P_384_1 = this.__P_384_0 = this.__P_384_2 = null;
    }
  });
  qx.ui.mobile.container.Drawer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Drawer.js.map?dt=1673093871186