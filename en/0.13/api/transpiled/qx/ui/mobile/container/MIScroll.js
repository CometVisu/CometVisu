    ...
    members: {
      ...
      _scrollTo: function _scrollTo(x, y, time) {
        if (this._isScrollable()) {
          ...
          if (this.__P_613_2) {
            this.__P_613_2.scrollTo(-x, -y, time);
          } else {
      ...
      __P_613_0: function __P_613_0() {
        ...
        if (!window.iScroll) {
          ...
          loader.on("load", this.__P_613_3, this);
          loader.open("GET", path);
          loader.send();
        } else {
          this.addListenerOnce("appear", function () {
            _this._setScroll(_this.__P_613_4());
          });
        }
      },
      /**
       ...
       */
      __P_613_3: function __P_613_3(request) {
        if (request.status < 400) {
          if (!this.isDisposed()) {
            this._setScroll(this.__P_613_4());
...
//# sourceMappingURL=MIScroll.js.map?dt=1731948137918