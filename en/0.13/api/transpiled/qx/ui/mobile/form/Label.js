    ...
    */
    ...
    members: {
      ...
      setLabelFor: function setLabelFor(elementId) {
        if (this.__P_398_0) {
          this.__P_398_0.removeListener("changeEnabled", this._changeEnabled, this);
        }
        this.__P_398_0 = qx.ui.mobile.core.Widget.getWidgetById(elementId);
        if (this.__P_398_0) {
          this.__P_398_0.addListener("changeEnabled", this._changeEnabled, this);
          this.setEnabled(this.__P_398_0.getEnabled());
        }
      ...
      _onTap: function _onTap(evt) {
        if (this.__P_398_0 && qx.core.Environment.get("event.dispatchevent")) {
          var target = this.__P_398_0.getContentElement();
...
//# sourceMappingURL=Label.js.map?dt=1673093872068