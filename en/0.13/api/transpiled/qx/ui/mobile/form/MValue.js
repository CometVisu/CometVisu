    ...
    */
    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (this.__P_629_0 != value) {
          if (this._setValue) {
            this._setValue(value);
          } else {
            this._setAttribute("value", value);
          }
          this.__P_629_3(value);
        }
      },
      /**
      ...
      _onChangeContent: function _onChangeContent(evt) {
        this.__P_629_3(this._convertValue(evt.getData()));
      },
      /**
      ...
      _onInput: function _onInput(evt) {
        ...
        if (this.getLiveUpdate()) {
          if (this._setValue) {
            ...
            this.__P_629_3(this._convertValue(data));
          }
        }
      },
      /**
       ...
       */
      __P_629_3: function __P_629_3(value) {
        if (this.__P_629_0 != value) {
          this.__P_629_0 = value;
...
//# sourceMappingURL=MValue.js.map?dt=1735222447104