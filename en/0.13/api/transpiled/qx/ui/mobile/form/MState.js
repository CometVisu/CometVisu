    ...
    */
    ...
    members: {
      ...
      hasState: function hasState(state) {
        return this.__P_408_0 !== null && this.__P_408_0[state];
      },
      /**
      ...
      replaceState: function replaceState(oldState, newState) {
        if (this.hasState(oldState)) {
          delete this.__P_408_0[oldState];
          this.__P_408_0[newState] = true;
...
//# sourceMappingURL=MState.js.map?dt=1705596681352