    ...
    */
    ...
    members: {
      ...
      validate: function validate() {
        ...
        this.__P_406_0 = [];
        if (this.__P_406_1 != null) {
          this.__P_406_1.resetForm();
        }
        ...
        for (var i = 0; i < groups.length; i++) {
          ...
          for (var j = 0; j < group.items.length; j++) {
            ...
            if (!item.isValid()) {
              this.__P_406_0.push(item);
              if (this.__P_406_1 != null) {
                this.__P_406_1.showErrorForItem(item);
              } else {
...
//# sourceMappingURL=Form.js.map?dt=1705596681286