    ...
    */
    ...
    members: {
      ...
      validate: function validate() {
        ...
        this.__P_625_0 = [];
        if (this.__P_625_1 != null) {
          this.__P_625_1.resetForm();
        }
        ...
        for (var i = 0; i < groups.length; i++) {
          ...
          for (var j = 0; j < group.items.length; j++) {
            ...
            if (!item.isValid()) {
              this.__P_625_0.push(item);
              if (this.__P_625_1 != null) {
                this.__P_625_1.showErrorForItem(item);
              } else {
...
//# sourceMappingURL=Form.js.map?dt=1717235413929