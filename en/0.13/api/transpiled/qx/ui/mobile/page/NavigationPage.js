    ...
    */
    ...
    members: {
      ...
      getTitleWidget: function getTitleWidget() {
        if (!this.__P_655_4) {
          this.__P_655_4 = this._createTitleWidget();
        }
        return this.__P_655_4;
      },
      /**
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (this.__P_655_4) {
          this.__P_655_4.setValue(value);
        }
      },
      // interface implementation
      getLeftContainer: function getLeftContainer() {
        if (!this.__P_655_5) {
          this.__P_655_5 = this._createLeftContainer();
        }
        return this.__P_655_5;
      },
      // interface implementation
      getRightContainer: function getRightContainer() {
        if (!this.__P_655_6) {
          this.__P_655_6 = this._createRightContainer();
        }
        return this.__P_655_6;
      },
      /**
      ...
      _createLeftContainer: function _createLeftContainer() {
        ...
        this.__P_655_0 = this._createBackButton();
        this.__P_655_0.addListener("tap", this._onBackButtonTap, this);
        this._showBackButton();
        container.add(this.__P_655_0);
        return container;
      },
      /**
      ...
      _createRightContainer: function _createRightContainer() {
        ...
        this.__P_655_1 = this._createButton();
        this.__P_655_1.addListener("tap", this._onButtonTap, this);
        this._showButton();
        container.add(this.__P_655_1);
        return container;
      },
      /**
      ...
      _applyContentCssClass: function _applyContentCssClass(value, old) {
        if (this.__P_655_2) {
          this.__P_655_2.setDefaultCssClass(value);
        }
      },
      /**
      ...
      _initialize: function _initialize() {
        ...
        this.__P_655_3 = this._createScrollContainer();
        this.__P_655_2 = this._createContent();
        if (this.__P_655_2) {
          this.__P_655_3.add(this.__P_655_2, {
            flex: 1
          });
        }
        if (this.__P_655_3) {
          this.add(this.__P_655_3, {
            flex: 1
          });
        }
      },
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_655_5", "__P_655_6", "__P_655_0", "__P_655_1", "__P_655_4");
      this.__P_655_5 = this.__P_655_6 = this.__P_655_0 = this.__P_655_1 = null;
      this.__P_655_4 = this.__P_655_2 = this.__P_655_3 = null;
      this._isTablet = null;
    }
  });
...
//# sourceMappingURL=NavigationPage.js.map?dt=1778272851488