  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_468_0, this, true);

      // Instantiate timers
      this.__P_468_1 = new qx.event.Timer();
      this.__P_468_1.addListener("interval", this.__P_468_2, this);
      this.__P_468_3 = new qx.event.Timer();
      this.__P_468_3.addListener("interval", this.__P_468_4, this);
    ...
    */
    ...
    members: {
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__P_468_6) {
          this.__P_468_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }
        return this.__P_468_6;
      },
      /**
       * Get the shared tooltip, which is used to display the
       * {@link qx.ui.core.Widget#toolTipText} and
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__P_468_7) {
          this.__P_468_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });
          this.__P_468_7.setLabel(""); // trigger label widget creation
          this.__P_468_7.syncAppearance();
        }
        return this.__P_468_7;
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_468_1.startWith(value.getShowTimeout());

          // Register hide handler
          Registration.addListener(el, "pointerout", this.__P_468_8, this, true);
          Registration.addListener(el, "focusout", this.__P_468_9, this, true);
          Registration.addListener(el, "pointermove", this.__P_468_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__P_468_8, this, true);
          Registration.removeListener(el, "focusout", this.__P_468_9, this, true);
          Registration.removeListener(el, "pointermove", this.__P_468_10, this, true);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_468_2: function __P_468_2(e) {
        var current = this.getCurrent();
        if (current && !current.isDisposed()) {
          this.__P_468_3.startWith(current.getHideTimeout());
          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__P_468_5);
          }
          current.show();
        }
        this.__P_468_1.stop();
       ...
       * @param e {qx.event.type.Event} Event object
       */
      __P_468_4: function __P_468_4(e) {
        var current = this.getCurrent();
      ...
      */
       ...
       */
      __P_468_10: function __P_468_10(e) {
        var pos = this.__P_468_5;
       ...
       */
      __P_468_0: function __P_468_0(e) {
       ...
       */
      __P_468_8: function __P_468_8(e) {
        var target = qx.ui.core.Widget.getWidgetByElement(e.getTarget());
        if (!target) {
          return;
        }
      ...
      */
       ...
       */
      __P_468_9: function __P_468_9(e) {
        var target = qx.ui.core.Widget.getWidgetByElement(e.getTarget());
        if (!target) {
          return;
        }
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_468_0, this, true);

      // Dispose timers
      this._disposeObjects("__P_468_1", "__P_468_3", "__P_468_6");
      this.__P_468_5 = null;
    }
  });
...
//# sourceMappingURL=Manager.js.map?dt=1700345610965