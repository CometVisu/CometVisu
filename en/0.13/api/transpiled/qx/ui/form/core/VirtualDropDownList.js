  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_347_0, this);
      this.__P_347_1 = new qx.data.Array();
      this.initSelection(this.__P_347_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__P_347_5(helper, listSelection);
      ...
      */
       ...
       */
      __P_347_7: function __P_347_7(event) {
        if (this.__P_347_2) {
          return;
        }
        ...
        this.__P_347_5(selection, listSelection);

        this.__P_347_3 = false;
        this.__P_347_2 = true;

        this.__P_347_5(listSelection, selection);

        this.__P_347_2 = false;
      },
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_347_5(listSelection, this.getSelection());
       ...
       */
      __P_347_0: function __P_347_0(event) {
        if (this.isVisible()) {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__P_347_7, this);

        if (old != null) {
          old.removeListener("change", this.__P_347_7, this);
        }

        this.__P_347_5(value, this.getChildControl("list").getSelection(value));
      },
      ...
      */
       ...
       */
      __P_347_5: function __P_347_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          if (this.__P_347_4 > 0) {
            uiList.setWidth(this.__P_347_4);
          } else {
...
//# sourceMappingURL=VirtualDropDownList.js.map?dt=1664617313042