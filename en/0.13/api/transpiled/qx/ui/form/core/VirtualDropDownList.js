  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_592_0, this);
      this.__P_592_1 = new qx.data.Array();
      this.initSelection(this.__P_592_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__P_592_5(helper, listSelection);
        helper.dispose();
        this.__P_592_3 = false;
      },
      /*
      ---------------------------------------------------------------------------
        INTERNAL API
      ...
      */
       ...
       */
      __P_592_7: function __P_592_7(event) {
        if (this.__P_592_2) {
          return;
        }
        ...
        var listSelection = this.getChildControl("list").getSelection();
        this.__P_592_3 = true;
        this.__P_592_5(selection, listSelection);
        this.__P_592_3 = false;
        this.__P_592_2 = true;
        this.__P_592_5(listSelection, selection);
        this.__P_592_2 = false;
      },
      /**
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_592_2 = true;
          this.__P_592_5(listSelection, this.getSelection());
          this.__P_592_2 = false;
        }
      },
      /**
       ...
       */
      __P_592_0: function __P_592_0(event) {
        if (this.isVisible()) {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__P_592_7, this);
        if (old != null) {
          old.removeListener("change", this.__P_592_7, this);
        }
        this.__P_592_5(value, this.getChildControl("list").getSelection(value));
      },
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ...
      */
       ...
       */
      __P_592_5: function __P_592_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          this.setWidth(null);
          if (this.__P_592_4 > 0) {
            uiList.setWidth(this.__P_592_4);
          } else {
      ...
      _getMaxListItemWidth: function _getMaxListItemWidth() {
        return this.__P_592_4;
      }
    },
    destruct: function destruct() {
      if (this.__P_592_1) {
        this.__P_592_1.dispose();
      }
    }
  });
...
//# sourceMappingURL=VirtualDropDownList.js.map?dt=1722153849575