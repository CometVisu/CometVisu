    ...
    members: {
      ...
      */
      ...
      _setPreselectedItem: function _setPreselectedItem() {
        if (this.__P_344_0) {
          var label = this.__P_344_0.getLabel();
          if (this.getFormat() != null) {
            label = this.getFormat().call(this, this.__P_344_0);
          }
...
//# sourceMappingURL=ComboBox.js.map?dt=1673093868287