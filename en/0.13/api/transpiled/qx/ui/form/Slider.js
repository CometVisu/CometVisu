    ...
    members: {
      ...
      */
        ...
        if (this.__P_358_3) {
          ...
          if (e.getType() === "pointerup") {
            ...
            if (this.__P_358_13) {
              ...
              deltaSlider = e.getDocumentTop() - (this._valueToPosition(this.getValue()) + this.__P_358_0);
      ...
      _onPointerMove: function _onPointerMove(e) {
        if (this.__P_358_3) {
          var dragStop = this.__P_358_13 ? e.getDocumentLeft() : e.getDocumentTop();
          var position = dragStop - this.__P_358_4;
      ...
      */
       ...
       * @param e {qx.event.type.Pointer} Incoming pointer event
       */
      __P_358_14: function __P_358_14(e) {
        var isHorizontal = this.__P_358_13;
        var cursorLocation = isHorizontal ? e.getDocumentLeft() : e.getDocumentTop();
      ...
      */
       ...
       */
      __P_358_17: function __P_358_17(value) {
       ...
       * @param duration {Number} The time in milliseconds the slide to should take.
       */
      __P_358_16: function __P_358_16(to, duration) {
...
//# sourceMappingURL=Slider.js.map?dt=1691935435529