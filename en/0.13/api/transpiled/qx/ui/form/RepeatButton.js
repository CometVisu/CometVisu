  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_583_0 = new qx.event.AcceleratingTimer();
      this.__P_583_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          this.addState("hovered");
          if (this.hasState("pressed") && !this.__P_583_1) {
            this.execute();
          }
        }
        this.__P_583_3();
      ...
      */
       ...
       *
       */
      __P_583_2: function __P_583_2() {
        this.fireEvent("press");
        this.__P_583_1 = false;
        this.__P_583_0.set({
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_583_0");
    }
  });
  qx.ui.form.RepeatButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RepeatButton.js.map?dt=1735222444905