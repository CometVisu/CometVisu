    ...
    members: {
      ...
      */
      ...
      _applyNumberFormat: function _applyNumberFormat(value, old) {
        ...
        this._applyValue(this.__P_586_0, undefined);
      },
      /**
      ...
      */
      ...
      _onTextChange: function _onTextChange(e) {
        ...
        if (!isNaN(value)) {
          ...
          if (value === this.__P_586_0) {
            this._applyValue(this.__P_586_0);
          } else {
            this.setValue(value);
          }
        } else {
...
//# sourceMappingURL=Spinner.js.map?dt=1729101262430