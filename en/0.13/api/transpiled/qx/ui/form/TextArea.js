    ...
    */
    ...
    members: {
      ...
      */
       ...
       *
       */
      __P_589_3: function __P_589_3() {
        var _this = this;
        if (this.isAutoSize()) {
          var clone = this.__P_589_4();
          if (clone && this.getBounds()) {
            // Remember original area height
            this.__P_589_2 = this.__P_589_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__P_589_2);
       ...
       * original element
       */
      __P_589_4: function __P_589_4() {
        this.__P_589_0 = this.__P_589_0 || this.__P_589_7();
        return this.__P_589_0;
      },
      /**
       ...
       */
      __P_589_6: function __P_589_6(clone) {
      ...
      */
      ...
      _applyAutoSize: function _applyAutoSize(value, old) {
        if (value) {
          this.__P_589_3();
          this.addListener("input", this.__P_589_3, this);
          ...
          this.removeListener("input", this.__P_589_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__P_589_1 || hint.height;
        }
        return hint;
      }
    },
...
//# sourceMappingURL=TextArea.js.map?dt=1735383878164