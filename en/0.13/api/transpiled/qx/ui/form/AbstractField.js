  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.AbstractField", {
    ...
    statics: {
       ...
       */
      __P_342_2: function __P_342_2() {
        if (qx.ui.form.AbstractField.__P_342_1) {
          return;
        }

        qx.ui.form.AbstractField.__P_342_1 = true;
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.__P_342_3 = !qx.core.Environment.get("css.placeholder");
      ...
      if (this.__P_342_3) {
        ...
        qx.ui.form.AbstractField.__P_342_2(); // add a class to the input to restrict the placeholder color
    ...
    members: {
      ...
      */
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (updateInsets && this.__P_342_3) {
          if (this.__P_342_3) {
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_342_9.width * 10,
          height: this.__P_342_9.height || 16
        };
      },
      // overridden
      _applyFont: function _applyFont(value, old) {
        if (old && this.__P_342_7 && this.__P_342_8) {
          this.__P_342_7.removeListenerById(this.__P_342_8);
        ...
        if (value) {
          ...
          if (this.__P_342_7 instanceof qx.bom.webfonts.WebFont && !this.__P_342_7.isValid()) {
            this.__P_342_8 = this.__P_342_7.addListener("changeStatus", this._onWebFontStatusChange, this);
          }

          styles = this.__P_342_7.getStyles();
        } else {
        ...
        if (value) {
          this.__P_342_9 = qx.bom.Label.getTextSize("A", styles);
        } else {
          delete this.__P_342_9;
        } // Update layout
      ...
      */
      ...
      _onHtmlInput: function _onHtmlInput(e) {
        var value = e.getData();
        var fireEvents = true;
        this.__P_342_4 = false; // value unchanged; Firefox fires "input" when pressing ESC [BUG #5309]

        if (this.__P_342_6 && this.__P_342_6 === value) {
          fireEvents = false;
        ...
        if (this.getFilter() != null) {
          ...
          if (filteredValue != value) {
            fireEvents = this.__P_342_6 !== filteredValue;
            value = filteredValue;
        ...
        if (fireEvents) {
          ...
          this.fireDataEvent("input", value, this.__P_342_6);
          this.__P_342_6 = value; // check for the live change event

          if (this.getLiveUpdate()) {
            this.__P_342_10(value);
      ...
      _onWebFontStatusChange: function _onWebFontStatusChange(ev) {
        if (ev.getData().valid === true) {
          var styles = this.__P_342_7.getStyles();
       ...
       */
      __P_342_10: function __P_342_10(value) {
        var old = this.__P_342_5;
        this.__P_342_5 = value;
      ...
      */
      ...
      setValue: function setValue(value) {
        ...
        if (value === null) {
          ...
          this.__P_342_4 = false; // native placeholders will be removed by the browser
        ...
        if (qx.lang.Type.isString(value)) {
          ...
          if (elem.getValue() != value) {
            ...
            elem.setValue(value);
            var data = this.__P_342_4 ? null : value;
            this.__P_342_5 = oldValue;

            this.__P_342_10(data); // reset the input value on setValue calls [BUG #6892]


            this.__P_342_6 = this.__P_342_5;
      ...
      getValue: function getValue() {
        return this.isDisposed() || this.__P_342_4 ? null : this.getContentElement().getValue();
      },
      ...
      _onChangeContent: function _onChangeContent(e) {
        this.__P_342_4 = e.getData() === null;

        this.__P_342_10(e.getData());
      },
      ...
      */
      ...
      _syncPlaceholder: function _syncPlaceholder() {
        if (this.hasState("showingPlaceholder") && this.__P_342_3) {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        if (!this.__P_342_3 && qx.ui.form.AbstractField.__P_342_0) {
          qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__P_342_0);
          qx.ui.form.AbstractField.__P_342_0 = null;

          qx.ui.form.AbstractField.__P_342_2();
        }
      },
    ...
    */
    destruct: function destruct() {
      ...
      this._placeholder = this.__P_342_7 = null;
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this._onChangeLocale, this);
      }

      if (this.__P_342_7 && this.__P_342_8) {
        this.__P_342_7.removeListenerById(this.__P_342_8);
      }
...
//# sourceMappingURL=AbstractField.js.map?dt=1685978137384