  ...
  qx.Class.define("qx.ui.form.AbstractField", {
    ...
    statics: {
      ...
      __P_341_2: function __P_341_2() {
        if (qx.ui.form.AbstractField.__P_341_1) {
          return;
        }
        qx.ui.form.AbstractField.__P_341_1 = true;
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.__P_341_3 = !qx.core.Environment.get("css.placeholder");
      if (value != null) {
        this.setValue(value);
      }
      ...
      if (this.__P_341_3) {
        ...
        qx.ui.form.AbstractField.__P_341_2();
    ...
    members: {
      ...
      */
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (updateInsets && this.__P_341_3) {
          if (this.__P_341_3) {
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_341_9.width * 10,
          height: this.__P_341_9.height || 16
        };
      },
      // overridden
      _applyFont: function _applyFont(value, old) {
        if (old && this.__P_341_7 && this.__P_341_8) {
          this.__P_341_7.removeListenerById(this.__P_341_8);
          this.__P_341_8 = null;
        }
        ...
        var styles;
        if (value) {
          this.__P_341_7 = qx.theme.manager.Font.getInstance().resolve(value);
          if (this.__P_341_7 instanceof qx.bom.webfonts.WebFont) {
            this.__P_341_8 = this.__P_341_7.addListener("changeStatus", this._onWebFontStatusChange, this);
          }
          styles = this.__P_341_7.getStyles();
        } else {
        ...
        // Compute text size
        if (value) {
          this.__P_341_9 = qx.bom.Label.getTextSize("A", styles);
        } else {
          delete this.__P_341_9;
        }
      ...
      */
      ...
      _onHtmlInput: function _onHtmlInput(e) {
        ...
        if (this.getFilter() != null) {
          ...
          if (filteredValue != value) {
            fireEvents = this.__P_341_6 !== filteredValue;
            value = filteredValue;
        ...
        if (fireEvents) {
          ...
          this.fireDataEvent("input", value, this.__P_341_6);
          this.__P_341_6 = value;

          // check for the live change event
          if (this.getLiveUpdate()) {
            this.__P_341_10(value);
          }
      ...
      _onWebFontStatusChange: function _onWebFontStatusChange(ev) {
        if (ev.getData().valid === true) {
          var styles = this.__P_341_7.getStyles();
          this.__P_341_9 = qx.bom.Label.getTextSize("A", styles);
          qx.ui.core.queue.Layout.add(this);
        }
      },
       ...
       */
      __P_341_10: function __P_341_10(value) {
        var old = this.__P_341_5;
        this.__P_341_5 = value;
        if (old != value) {
      ...
      */
      ...
      setValue: function setValue(value) {
        ...
        if (qx.lang.Type.isString(value)) {
          ...
          if (elem.getValue() != value) {
            ...
            elem.setValue(value);
            var data = this.__P_341_4 ? null : value;
            this.__P_341_5 = oldValue;
            this.__P_341_10(data);
            // reset the input value on setValue calls [BUG #6892]
            this.__P_341_6 = this.__P_341_5;
          }
      ...
      getValue: function getValue() {
        return this.isDisposed() || this.__P_341_4 ? null : this.getContentElement().getValue();
      },
      /**
      ...
      _onChangeContent: function _onChangeContent(e) {
        this.__P_341_4 = e.getData() === null;
        this.__P_341_10(e.getData());
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _syncPlaceholder: function _syncPlaceholder() {
        if (this.hasState("showingPlaceholder") && this.__P_341_3) {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        if (!this.__P_341_3 && qx.ui.form.AbstractField.__P_341_0) {
          qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__P_341_0);
          qx.ui.form.AbstractField.__P_341_0 = null;
          qx.ui.form.AbstractField.__P_341_2();
        }
      },
      /**
    ...
    */
    destruct: function destruct() {
      ...
      this._placeholder = this.__P_341_7 = null;
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this._onChangeLocale, this);
      }
      if (this.__P_341_7 && this.__P_341_8) {
        this.__P_341_7.removeListenerById(this.__P_341_8);
      }
...
//# sourceMappingURL=AbstractField.js.map?dt=1673093868067