    ...
    members: {
      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        ...
        var styles;
        if (value) {
          this.__P_342_7 = qx.theme.manager.Font.getInstance().resolve(value);
          if (this.__P_342_7 instanceof qx.bom.webfonts.WebFont) {
...
//# sourceMappingURL=AbstractField.js.map?dt=1677362756493