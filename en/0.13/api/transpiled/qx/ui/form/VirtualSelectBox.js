    ...
    members: {
      ...
      */
      ...
      __P_363_14: function __P_363_14(lastFilterValue) {
        ...
        this.__P_363_8 = filterValue; // _searchRegExp is used in default _searchMatch function to avoid recreation of regexp object
        // for each list item
      ...
      __P_363_3: function __P_363_3() {
        ...
        this.__P_363_13(); // set label converter
      ...
      __P_363_5: function __P_363_5(value, old) {
        this.__P_363_12 = value; // make sure we have strings for both markers
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1685978139486