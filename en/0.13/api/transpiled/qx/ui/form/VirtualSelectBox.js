  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_591_1 = new qx.event.Timer(500);
      this.__P_591_1.addListener("interval", this.__P_591_2, this);
      this.getSelection().addListener("change", this._updateSelectionValue, this);
      if (this.isIncrementalSearch()) {
        this.__P_591_3();
      }
      this.initHtmlMarkers(['<span style="' + this.__P_591_4() + '">', "</span>"]);
    },
    properties: {
      // overridden
      appearance: {
    ...
    members: {
      ...
      */
      ...
      _removeBindings: function _removeBindings() {
        while (this.__P_591_0.length > 0) {
          var id = this.__P_591_0.pop();
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            if (!this.isIncrementalSearch()) {
              this.__P_591_6 += this.__P_591_7(event.getKeyIdentifier());
              this.__P_591_1.restart();
            }
            break;
          default:
      ...
      */
       ...
       * __searchValue value.
       */
      __P_591_2: function __P_591_2() {
        this.__P_591_1.stop();
        var searchValue = this.__P_591_6;
       ...
       */
      __P_591_7: function __P_591_7(keyIdentifier) {
      ...
      */
      ...
      _searchRegExp: null,
      __P_591_13: function __P_591_13() {
        var _this = this;
        var input = this.__P_591_11 = new qx.ui.form.TextField().set({
          appearance: "widget",
          liveUpdate: true,
          height: 0,
          width: 1 // must be > 0
        ...
        input.addListener("changeValue", function (e) {
          if (_this.__P_591_10 === 0) {
            _this.__P_591_14();
          }
        });
      },
      __P_591_4: function __P_591_4() {
      ...
      _highlightFilterValuePlainFunction: function _highlightFilterValuePlainFunction(parts) {
        ...
        return parts[1] + this.__P_591_12[0] + parts[2] + this.__P_591_12[1] + parts[3];
      },
      ...
      _highlightFilterValueHtmlFunction: function _highlightFilterValueHtmlFunction(parts) {
        ...
        return qx.module.util.String.escapeHtml(parts[1]) + this.__P_591_12[0] + qx.module.util.String.escapeHtml(parts[2]) + this.__P_591_12[1] + qx.module.util.String.escapeHtml(parts[3]);
      },
      ...
      __P_591_14: function __P_591_14(lastFilterValue) {
        this.__P_591_10++;
        var filterValue = lastFilterValue !== undefined ? lastFilterValue : this.__P_591_11.getValue();
        this.__P_591_8 = filterValue;
        ...
        if (item) {
          this.__P_591_9 = filterValue;
          this.getSelection().setItem(0, item);
        } else {
          var len = filterValue.length;
          var last = len > this.__P_591_9.length + 1 ? this.__P_591_11.getValue().charAt(len - 1) : "";
          filterValue = this.__P_591_9 + last;
          this.__P_591_14(filterValue);
        }
        // make sure length of dropdown is updated
        this.__P_591_10--;
      },
      __P_591_3: function __P_591_3() {
        ...
        labelOptions.converter = function (data, model, source, target) {
          var filterValue = that.__P_591_8;
      ...
      __P_591_5: function __P_591_5(value, old) {
        this.__P_591_12 = value;
        ...
        if (value.length < 2) {
          this.__P_591_12[1] = this.__P_591_12[0];
        }
      },
      _applyIncrementalSearch: function _applyIncrementalSearch(value, old) {
        if (value) {
          this.__P_591_1.stop();
          this.__P_591_1.setEnabled(false);
          this.__P_591_3();
        } else {
          this.__P_591_1.setEnabled(true);
        }
      }
    },
    destruct: function destruct() {
      ...
      this.__P_591_1.removeListener("interval", this.__P_591_2, this);
      this.__P_591_1.dispose();
      this.__P_591_1 = null;
    }
  });
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1735222445246