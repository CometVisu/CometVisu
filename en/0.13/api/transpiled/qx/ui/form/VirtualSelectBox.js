  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_371_1 = new qx.event.Timer(500);
      this.__P_371_1.addListener("interval", this.__P_371_2, this);
      this.getSelection().addListener("change", this._updateSelectionValue, this);
      if (this.isIncrementalSearch()) {
        this.__P_371_3();
      }
      this.initHtmlMarkers(['<span style="' + this.__P_371_4() + '">', "</span>"]);
    },
    properties: {
      // overridden
      appearance: {
    ...
    members: {
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            if (!this.isIncrementalSearch()) {
              this.__P_371_6 += this.__P_371_7(event.getKeyIdentifier());
              this.__P_371_1.restart();
            }
            break;
          default:
      ...
      */
       ...
       * __searchValue value.
       */
      __P_371_2: function __P_371_2() {
        this.__P_371_1.stop();
        var searchValue = this.__P_371_6;
       ...
       */
      __P_371_7: function __P_371_7(keyIdentifier) {
      ...
      */
      ...
      _searchRegExp: null,
      __P_371_13: function __P_371_13() {
        var _this = this;
        var input = this.__P_371_11 = new qx.ui.form.TextField().set({
          appearance: "widget",
          liveUpdate: true,
          height: 0,
          width: 1 // must be > 0
        ...
        input.addListener("changeValue", function (e) {
          if (_this.__P_371_10 === 0) {
            _this.__P_371_14();
          }
        });
      },
      __P_371_4: function __P_371_4() {
      ...
      _highlightFilterValuePlainFunction: function _highlightFilterValuePlainFunction(parts) {
        ...
        return parts[1] + this.__P_371_12[0] + parts[2] + this.__P_371_12[1] + parts[3];
      },
      ...
      _highlightFilterValueHtmlFunction: function _highlightFilterValueHtmlFunction(parts) {
        ...
        return qx.module.util.String.escapeHtml(parts[1]) + this.__P_371_12[0] + qx.module.util.String.escapeHtml(parts[2]) + this.__P_371_12[1] + qx.module.util.String.escapeHtml(parts[3]);
      },
      ...
      __P_371_14: function __P_371_14(lastFilterValue) {
        this.__P_371_10++;
        var filterValue = lastFilterValue !== undefined ? lastFilterValue : this.__P_371_11.getValue();
        this.__P_371_8 = filterValue;
        ...
        if (item) {
          this.__P_371_9 = filterValue;
          this.getSelection().setItem(0, item);
        } else {
          var len = filterValue.length;
          var last = len > this.__P_371_9.length + 1 ? this.__P_371_11.getValue().charAt(len - 1) : "";
          filterValue = this.__P_371_9 + last;
          this.__P_371_14(filterValue);
        }
        // make sure length of dropdown is updated
        this.__P_371_10--;
      },
      __P_371_3: function __P_371_3() {
        ...
        labelOptions.converter = function (data, model, source, target) {
          var filterValue = that.__P_371_8;
      ...
      __P_371_5: function __P_371_5(value, old) {
        this.__P_371_12 = value;
        ...
        if (value.length < 2) {
          this.__P_371_12[1] = this.__P_371_12[0];
        }
      },
      _applyIncrementalSearch: function _applyIncrementalSearch(value, old) {
        if (value) {
          this.__P_371_1.stop();
          this.__P_371_1.setEnabled(false);
          this.__P_371_3();
        } else {
          this.__P_371_1.setEnabled(true);
        }
      }
    },
    destruct: function destruct() {
      ...
      this.__P_371_1.removeListener("interval", this.__P_371_2, this);
      this.__P_371_1.dispose();
      this.__P_371_1 = null;
    }
  });
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1705596679002