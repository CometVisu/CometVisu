    ...
    members: {
      ...
      remove: function remove(field) {
        ...
        for (var i = 0; i < this.__P_594_0.length; i++) {
          var storedItem = this.__P_594_0[i];
          if (storedItem.item === field) {
            this.__P_594_0.splice(i, 1);
            return true;
          }
        }
        return false;
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__P_594_0.length; i++) {
          ...
          this.__P_594_0[i].init = item.getValue();
        }
      },
      /**
      ...
      redefineItem: function redefineItem(field) {
        ...
        var dataEntry;
        for (var i = 0; i < this.__P_594_0.length; i++) {
          if (this.__P_594_0[i].item === field) {
            dataEntry = this.__P_594_0[i];
       ...
       * @private
       */
      __P_594_1: function __P_594_1(field) {
...
//# sourceMappingURL=Resetter.js.map?dt=1782595076245