  ...
  qx.Class.define("qx.ui.form.Resetter", {
    ...
    members: {
      ...
      remove: function remove(field) {
        this.__P_584_1(field);
        for (var i = 0; i < this.__P_584_0.length; i++) {
          var storedItem = this.__P_584_0[i];
          if (storedItem.item === field) {
            this.__P_584_0.splice(i, 1);
            return true;
          }
        }
        return false;
      ...
      resetItem: function resetItem(field) {
        this.__P_584_1(field);
        for (var i = 0; i < this.__P_584_0.length; i++) {
          var dataEntry = this.__P_584_0[i];
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__P_584_0.length; i++) {
          var item = this.__P_584_0[i].item;
          // set the new init value for the item
          this.__P_584_0[i].init = item.getValue();
        }
      },
      /**
      ...
      redefineItem: function redefineItem(field) {
        ...
        var dataEntry;
        for (var i = 0; i < this.__P_584_0.length; i++) {
          if (this.__P_584_0[i].item === field) {
            dataEntry = this.__P_584_0[i];
       ...
       * @private
       */
      __P_584_1: function __P_584_1(field) {
...
//# sourceMappingURL=Resetter.js.map?dt=1735222444923