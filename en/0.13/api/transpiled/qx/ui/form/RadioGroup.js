  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.addListener("changeSelection", this.__P_362_1, this);
      if (varargs != null) {
    ...
    members: {
      ...
      */
      ...
      _applyGroupedProperty: function _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__P_362_0.length; i++) {
          item = this.__P_362_0[i];
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_362_0.length; i++) {
          this.__P_362_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__P_362_0.length; i++) {
          this.__P_362_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__P_362_0.indexOf(item) != -1;
      },
      /**
       ...
       * @param e {qx.event.type.Data} Data event.
       */
      __P_362_1: function __P_362_1(e) {
        ...
        if (value) {
          ...
          if (this.__P_362_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
...
//# sourceMappingURL=RadioGroup.js.map?dt=1700345604750