  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_362_0 = dropdown.getSelection();

      this.__P_362_0.addListener("change", this.__P_362_1, this);
    ...
    members: {
      ...
      */
       ...
       */
      __P_362_1: function __P_362_1(event) {
        if (this.__P_362_4 == true) {
          return;
        }

        var selected = this.__P_362_0.getItem(0);

        if (selected) {
          selected = this.__P_362_6(selected);
      ...
      */
      ...
      __P_362_5: function __P_362_5() {
        ...
        if (selected === undefined || this.__P_362_6(selected) !== value) {
          // only reset the old selection if there is one
          if (selected !== undefined) {
            // reset the old selection
            this.__P_362_4 = true;
            selection.removeAll();
            this.__P_362_4 = false;
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__P_362_6(modelItem);
       ...
       */
      __P_362_6: function __P_362_6(modelItem) {
    ...
    destruct: function destruct() {
      ...
      this.__P_362_0.removeListener("change", this.__P_362_1, this);
...
//# sourceMappingURL=VirtualComboBox.js.map?dt=1685978139373