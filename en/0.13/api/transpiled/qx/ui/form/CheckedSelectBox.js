  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.CheckedSelectBox", {
    ...
    construct: function construct() {
      ...
      this.__P_572_0 = new qx.data.Array();
      this.__P_572_0.addListener("change", this.__P_572_1, this);
      this.__P_572_2 = [];
    ...
    members: {
      ...
      setModelSelection: function setModelSelection(value) {
        this.__P_572_1.replace(value ? value : []);
      },
      /**
       * @Override
       * @see qx.ui.form.IModelSelection
       ...
       */
      __P_572_1: function __P_572_1(evt) {
        var checked = [];
        var selected = {};
      ...
      _onListChangeChecked: function _onListChangeChecked(evt) {
        ...
        if (!qx.lang.Array.equals(modelSelection, this.getModelSelection().toArray())) {
          this.__P_572_0.replace(modelSelection);
          ...
          while (this.__P_572_2.length > modelSelection.length) {
            var tag = this.__P_572_2.pop();
            detachTag(tag);
          }
          modelSelection.forEach(function (itemModel, index) {
            var tag = _this.getChildControl("tag#" + index);
            if (_this.__P_572_2.length <= index) {
              _this.__P_572_2.push(tag);
            } else {
              _this.__P_572_2[index] = tag;
            }
...
//# sourceMappingURL=CheckedSelectBox.js.map?dt=1735341794410