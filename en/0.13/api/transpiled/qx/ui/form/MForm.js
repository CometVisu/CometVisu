  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MForm", {
    construct: function construct() {
      {
        qx.locale.Manager.getInstance().addListener("changeLocale", this.__P_578_0, this);
      }
    },
    properties: {
      /**
    ...
    members: {
       ...
       */
      __P_578_0: qx.core.Environment.select("qx.dynlocale", {
    ...
    destruct: function destruct() {
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this.__P_578_0, this);
      }
    }
  });
...
//# sourceMappingURL=MForm.js.map?dt=1717235410962