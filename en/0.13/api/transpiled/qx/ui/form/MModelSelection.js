  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_580_0 = new qx.data.Array();

      // listen to the changes
      this.__P_580_0.addListener("change", this.__P_580_1, this);
      this.addListener("changeSelection", this.__P_580_2, this);
    },
    events: {
      /**
    ...
    members: {
       ...
       */
      __P_580_1: function __P_580_1() {
        this.__P_580_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];
        var modelSelection = this.__P_580_0.toArray();
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__P_580_0.removeAll();
          return;
        }
        // add the first two parameter
        modelSelection.unshift(this.__P_580_0.getLength()); // remove index
        modelSelection.unshift(0); // start index

        var returnArray = this.__P_580_0.splice.apply(this.__P_580_0, modelSelection);
        returnArray.dispose();
      }
    },
...
//# sourceMappingURL=MModelSelection.js.map?dt=1735341794739