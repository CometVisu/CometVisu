  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractImage", {
    ...
    */
    ...
    members: {
       ...
       *    <code>height</code>
       */
      __P_479_2: function __P_479_2(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__P_479_0;
          height = this.__P_479_1;
        }
        return {
          width: width,
          height: height
       ...
       *   </ul>
       */
      __P_479_3: function __P_479_3(imageData) {
      ...
      getContent: function getContent(value, states) {
        ...
        var content = "";
        var imageData = this.__P_479_3(this._identifyImage(value));
...
//# sourceMappingURL=AbstractImage.js.map?dt=1702901334343