  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractImage", {
    ...
    */
    ...
    members: {
       ...
       *    <code>height</code>
       */
      __P_699_2: function __P_699_2(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__P_699_0;
          height = this.__P_699_1;
        }
        return {
          width: width,
          height: height
       ...
       *   </ul>
       */
      __P_699_3: function __P_699_3(imageData) {
      ...
      getContent: function getContent(value, states) {
        ...
        var content = "";
        var imageData = this.__P_699_3(this._identifyImage(value));
...
//# sourceMappingURL=AbstractImage.js.map?dt=1735383883407