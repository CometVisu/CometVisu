  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractImage", {
    ...
    */
    ...
    members: {
       ...
       *    <code>height</code>
       */
      __P_698_2: function __P_698_2(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__P_698_0;
          height = this.__P_698_1;
        }
        return {
          width: width,
          height: height
       ...
       *   </ul>
       */
      __P_698_3: function __P_698_3(imageData) {
      ...
      getContent: function getContent(value, states) {
        ...
        var content = "";
        var imageData = this.__P_698_3(this._identifyImage(value));
...
//# sourceMappingURL=AbstractImage.js.map?dt=1722153856389