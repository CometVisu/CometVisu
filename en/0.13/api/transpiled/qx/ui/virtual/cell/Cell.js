  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__P_701_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__P_701_1 = {};
      this.__P_701_2 = {};
      this.__P_701_3 = {};
      this.__P_701_4 = {};
    ...
    */
    ...
    members: {
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        var store;
        if (this.__P_701_10) {
          store = this.__P_701_2;
        } else {
          store = this.__P_701_1;
        }
        if (styles === null) {
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        var value = this._getValue(name);
        if (this.__P_701_10) {
          var paddingStore = this.__P_701_4;
        } else {
          paddingStore = this.__P_701_3;
        }
        if (value === null) {
      ...
      */
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__P_701_0.getCssClass(this.__P_701_9) || "";
       ...
       */
      __P_701_11: function __P_701_11(states) {
        ...
        if (this.__P_701_9 == statesKey) {
          return;
        }
        this.__P_701_9 = statesKey;
        var themeStyles = this.__P_701_5[this.__P_701_9];
        if (!themeStyles) {
          this.__P_701_12();
          this.__P_701_13(states);
          this.__P_701_14(states);
          this.__P_701_15();
          this.__P_701_5[this.__P_701_9] = 1;
        }
        this.__P_701_16();
      },
      /**
       ...
       */
      __P_701_12: function __P_701_12() {
        var PropertyUtil = qx.util.PropertyUtil;
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __P_701_13: function __P_701_13(states) {
        this.__P_701_2 = {};
        this.__P_701_10 = true;
        var appearance = this.getAppearance();
        var PropertyUtil = qx.util.PropertyUtil;
        ...
        this.__P_701_10 = false;
      },
      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __P_701_14: function __P_701_14() {
        var styleString = Object.values(this.__P_701_2).join(";");
        this.__P_701_0.computeClassForStyles(this.__P_701_9, styleString);
      },
      /**
       * Cache the themed values for the current state combination
       */
      __P_701_15: function __P_701_15() {
        var properties = this.__P_701_8;
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = {};
        ...
        this.__P_701_6[this.__P_701_9] = themeValues;
      },
      /**
       * Apply the themed values to the properties
       */
      __P_701_16: function __P_701_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__P_701_6[this.__P_701_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__P_701_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__P_701_3;
        var theme = this.__P_701_4;
    ...
    destruct: function destruct() {
      this.__P_701_0 = this.__P_701_1 = this.__P_701_2 = this.__P_701_3 = this.__P_701_4 = this.__P_701_5 = this.__P_701_6 = this.__P_701_8 = null;
    }
  });
  qx.ui.virtual.cell.Cell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Cell.js.map?dt=1722151860392