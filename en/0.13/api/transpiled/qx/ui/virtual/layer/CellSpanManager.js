    ...
    */
    ...
    members: {
      ...
      findCellsInWindow: function findCellsInWindow(firstRow, firstColumn, rowCount, columnCount) {
        ...
        return this.__P_724_0(horizontalInWindow, verticalInWindow);
      },
      /**
       ...
       */
      __P_724_0: function __P_724_0(setA, setB) {
        var intersection = [];
        for (var key in setA) {
          if (setB[key]) {
...
//# sourceMappingURL=CellSpanManager.js.map?dt=1778272854515