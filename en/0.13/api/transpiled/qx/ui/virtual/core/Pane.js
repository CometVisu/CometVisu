  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Pane", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__P_704_0 = new qx.ui.virtual.core.Axis(cellHeight, rowCount);
      this.__P_704_1 = new qx.ui.virtual.core.Axis(cellWidth, columnCount);
      this.__P_704_2 = 0;
      this.__P_704_3 = 0;
      this.__P_704_4 = 0;
      this.__P_704_5 = 0;
      ...
      this.__P_704_8 = new qx.ui.container.Composite();
      this.__P_704_8.setUserBounds(0, 0, 0, 0);
      this._add(this.__P_704_8);
      this.__P_704_9 = [];
      this.__P_704_0.addListener("change", this.fullUpdate, this);
      this.__P_704_1.addListener("change", this.fullUpdate, this);
    ...
    members: {
      ...
      */
      ...
      addLayer: function addLayer(layer) {
        this.__P_704_9.push(layer);
        layer.setUserBounds(0, 0, 0, 0);
        this.__P_704_8.add(layer);
      },
      /**
      ...
      getVisibleLayers: function getVisibleLayers() {
        var layers = [];
        for (var i = 0; i < this.__P_704_9.length; i++) {
          var layer = this.__P_704_9[i];
          if (layer.isVisible()) {
            layers.push(layer);
          }
        }
      ...
      */
      ...
      getScrollMaxX: function getScrollMaxX() {
        ...
        if (paneSize) {
          return Math.max(0, this.__P_704_1.getTotalSize() - paneSize.width);
        }
        return 0;
      },
      /**
      ...
      getScrollMaxY: function getScrollMaxY() {
        var paneSize = this.getInnerSize();
        if (paneSize) {
          return Math.max(0, this.__P_704_0.getTotalSize() - paneSize.height);
        }
        return 0;
      },
      /**
      ...
      setScrollY: function setScrollY(value) {
        ...
        if (this.__P_704_2 !== value) {
          var old = this.__P_704_2;
          this.__P_704_2 = value;
      ...
      setScrollX: function setScrollX(value) {
        ...
        if (value !== this.__P_704_3) {
          var old = this.__P_704_3;
          this.__P_704_3 = value;
          this._deferredUpdateScrollPosition();
      ...
      getScrollSize: function getScrollSize() {
        return {
          width: this.__P_704_1.getTotalSize(),
          height: this.__P_704_0.getTotalSize()
        };
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      scrollRowIntoView: function scrollRowIntoView(row) {
        ...
        var itemTop = this.__P_704_0.getItemPosition(row);
        var itemBottom = itemTop + this.__P_704_0.getItemSize(row);
      ...
      scrollColumnIntoView: function scrollColumnIntoView(column) {
        ...
        var itemLeft = this.__P_704_1.getItemPosition(column);
        var itemRight = itemLeft + this.__P_704_1.getItemSize(column);
      ...
      */
      ...
      getCellAtPosition: function getCellAtPosition(documentX, documentY) {
        ...
        rowData = this.__P_704_0.getItemAtPosition(this.getScrollY() + documentY - paneLocation.top);
        columnData = this.__P_704_1.getItemAtPosition(this.getScrollX() + documentX - paneLocation.left);
      ...
      */
      ...
      prefetchX: function prefetchX(minLeft, maxLeft, minRight, maxRight) {
        ...
        var paneRight = this.__P_704_3 + bounds.width;
        var rightAvailable = this.__P_704_5 - paneRight;
        if (this.__P_704_3 - this.__P_704_6.left < Math.min(this.__P_704_3, minLeft) || this.__P_704_6.right - paneRight < Math.min(rightAvailable, minRight)) {
          var left = Math.min(this.__P_704_3, maxLeft);
          var right = Math.min(rightAvailable, maxRight);
          this._setLayerWindow(layers, this.__P_704_3 - left, this.__P_704_2, bounds.width + left + right, bounds.height, false);
        }
      },
      /**
      ...
      prefetchY: function prefetchY(minAbove, maxAbove, minBelow, maxBelow) {
        ...
        var paneBottom = this.__P_704_2 + bounds.height;
        var belowAvailable = this.__P_704_4 - paneBottom;
        if (this.__P_704_2 - this.__P_704_6.top < Math.min(this.__P_704_2, minAbove) || this.__P_704_6.bottom - paneBottom < Math.min(belowAvailable, minBelow)) {
          var above = Math.min(this.__P_704_2, maxAbove);
          var below = Math.min(belowAvailable, maxBelow);
          this._setLayerWindow(layers, this.__P_704_3, this.__P_704_2 - above, bounds.width, bounds.height + above + below, false);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onResize: function _onResize() {
        if (this.getContentElement().getDomElement()) {
          this.__P_704_10 = true;
          this._updateScrollPosition();
          this.__P_704_10 = null;
      ...
      _onPointerDown: function _onPointerDown(e) {
        this.__P_704_13 = this.getCellAtPosition(e.getDocumentLeft(), e.getDocumentTop());
      },
      /**
      ...
      _onContextmenu: function _onContextmenu(e) {
        this.__P_704_14(e, "cellContextmenu");
      },
      /**
      ...
      _checkScrollBounds: function _checkScrollBounds() {
        ...
        if (this.__P_704_3 < 0) {
          this.__P_704_3 = 0;
        } else if (this.__P_704_3 > maxx) {
          this.__P_704_3 = maxx;
        }
        if (this.__P_704_2 < 0) {
          this.__P_704_2 = 0;
        } else if (this.__P_704_2 > maxy) {
          this.__P_704_2 = maxy;
        }
      },
      /**
       ...
       */
      __P_704_14: function __P_704_14(e, cellEventType) {
        var coords = this.getCellAtPosition(e.getDocumentLeft(), e.getDocumentTop());
        if (!coords) {
          return;
        }
        var pointerDownCoords = this.__P_704_13;
      ...
      */
      ...
      syncWidget: function syncWidget(jobs) {
        if (this.__P_704_7._fullUpdate) {
          this._checkScrollBounds();
          this._fullUpdate();
        } else if (this.__P_704_7._updateScrollPosition) {
          this._checkScrollBounds();
          this._updateScrollPosition();
        }
        this.__P_704_7 = {};
      ...
      _setLayerWindow: function _setLayerWindow(layers, left, top, minWidth, minHeight, doFullUpdate) {
        var rowCellData = this.__P_704_0.getItemAtPosition(top);
        if (rowCellData) {
          var firstRow = rowCellData.index;
          var rowSizes = this.__P_704_0.getItemSizes(firstRow, minHeight + rowCellData.offset);
        ...
        var columnCellData = this.__P_704_1.getItemAtPosition(left);
        if (columnCellData) {
          var firstColumn = columnCellData.index;
          var columnSizes = this.__P_704_1.getItemSizes(firstColumn, minWidth + columnCellData.offset);
        ...
        this.__P_704_8.setUserBounds((this.getPaddingLeft() || 0) + (this.__P_704_6.left - this.__P_704_3), (this.getPaddingTop() || 0) + (this.__P_704_6.top - this.__P_704_2), layerWidth, layerHeight);
        this.__P_704_11 = columnSizes;
        this.__P_704_12 = rowSizes;
        for (var i = 0; i < this.__P_704_9.length; i++) {
          var layer = this.__P_704_9[i];
       ...
       * it was.
       */
      __P_704_15: function __P_704_15() {
        if (this.__P_704_10) {
          return;
        }
        var scrollSize = this.getScrollSize();
        if (this.__P_704_4 !== scrollSize.height || this.__P_704_5 !== scrollSize.width) {
          this.__P_704_4 = scrollSize.height;
          this.__P_704_5 = scrollSize.width;
          this.fireEvent("update");
        }
      },
      /**
      ...
      isUpdatePending: function isUpdatePending() {
        return !!this.__P_704_7._fullUpdate;
      },
      /**
      ...
      _fullUpdate: function _fullUpdate() {
        ...
        this._setLayerWindow(layers, this.__P_704_3, this.__P_704_2, bounds.width, bounds.height, true);
        this.__P_704_15();
      },
      /**
      ...
      _deferredUpdateScrollPosition: function _deferredUpdateScrollPosition() {
        this.__P_704_7._updateScrollPosition = 1;
        qx.ui.core.queue.Widget.add(this);
      },
      /**
      ...
      _updateScrollPosition: function _updateScrollPosition() {
        ...
        var paneWindow = {
          top: this.__P_704_2,
          bottom: this.__P_704_2 + bounds.height,
          left: this.__P_704_3,
          right: this.__P_704_3 + bounds.width
        };
        if (this.__P_704_6.top <= paneWindow.top && this.__P_704_6.bottom >= paneWindow.bottom && this.__P_704_6.left <= paneWindow.left && this.__P_704_6.right >= paneWindow.right) {
          // only update layer container offset
          this.__P_704_8.setUserBounds((this.getPaddingLeft() || 0) + (this.__P_704_6.left - paneWindow.left), (this.getPaddingTop() || 0) + (this.__P_704_6.top - paneWindow.top), this.__P_704_6.right - this.__P_704_6.left, this.__P_704_6.bottom - this.__P_704_6.top);
        } else {
          this._setLayerWindow(layers, this.__P_704_3, this.__P_704_2, bounds.width, bounds.height, false);
        }
        this.__P_704_15();
      }
    },
    destruct: function destruct() {
      this._disposeArray("__P_704_9");
      this._disposeObjects("__P_704_0", "__P_704_1", "__P_704_8");
      this.__P_704_6 = this.__P_704_7 = this.__P_704_11 = this.__P_704_12 = null;
    }
  });
  qx.ui.virtual.core.Pane.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Pane.js.map?dt=1729101270092