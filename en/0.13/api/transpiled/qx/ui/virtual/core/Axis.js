  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_719_1: function __P_719_1() {
        if (this.__P_719_0) {
          return this.__P_719_0;
        }
       ...
       */
      __P_719_2: function __P_719_2(position) {
        var ranges = this.__P_719_0 || this.__P_719_1();
        var start = 0;
      ...
      getItemAtPosition: function getItemAtPosition(position) {
        ...
        var range = this.__P_719_2(position);
       ...
       */
      __P_719_3: function __P_719_3(index) {
        var ranges = this.__P_719_0 || this.__P_719_1();
        var start = 0;
        var end = ranges.length - 1;
      ...
      getItemPosition: function getItemPosition(index) {
        ...
        var range = this.__P_719_3(index);
    ...
    destruct: function destruct() {
      this.customSizes = this.__P_719_0 = null;
    }
  });
  qx.ui.virtual.core.Axis.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Axis.js.map?dt=1782595081151