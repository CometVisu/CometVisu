  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_475_2: function __P_475_2(position) {
        var ranges = this.__P_475_0 || this.__P_475_1();
        var start = 0;
      ...
      getItemAtPosition: function getItemAtPosition(position) {
        ...
        var range = this.__P_475_2(position);
       ...
       */
      __P_475_3: function __P_475_3(index) {
        var ranges = this.__P_475_0 || this.__P_475_1();
        var start = 0;
        var end = ranges.length - 1;
      ...
      getItemPosition: function getItemPosition(index) {
        ...
        var range = this.__P_475_3(index);
    ...
    destruct: function destruct() {
      this.customSizes = this.__P_475_0 = null;
    }
  });
  qx.ui.virtual.core.Axis.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Axis.js.map?dt=1672653517474