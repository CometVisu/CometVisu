  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_484_2: function __P_484_2(position) {
        var ranges = this.__P_484_0 || this.__P_484_1();
        var start = 0;
      ...
      getItemAtPosition: function getItemAtPosition(position) {
        ...
        var range = this.__P_484_2(position);
       ...
       */
      __P_484_3: function __P_484_3(index) {
        var ranges = this.__P_484_0 || this.__P_484_1();
        var start = 0;
        var end = ranges.length - 1;
      ...
      getItemPosition: function getItemPosition(index) {
        ...
        var range = this.__P_484_3(index);
    ...
    destruct: function destruct() {
      this.customSizes = this.__P_484_0 = null;
    }
  });
  qx.ui.virtual.core.Axis.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Axis.js.map?dt=1702815239208