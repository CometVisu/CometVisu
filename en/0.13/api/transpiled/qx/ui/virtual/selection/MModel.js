  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_715_0 = new qx.data.Array();
      this.__P_715_0.addListener("change", this._onChangeSelection, this);
      this._applySelection(this.__P_715_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
      ...
      setSelection: function setSelection(value) {
        if (value) {
          this.__P_715_0.replace(value);
        } else {
          this.__P_715_0.removeAll();
        }
      },
      /**
      ...
      */
       ...
       */
      __P_715_5: function __P_715_5(newSelection) {
        var selection = this.getSelection();
...
//# sourceMappingURL=MModel.js.map?dt=1735383883992