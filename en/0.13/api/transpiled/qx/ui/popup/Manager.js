  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_379_0 = []; // Register pointerdown handler

      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_379_1, this, true); // Hide all popups on window blur
    ...
    */
    members: {
      ...
      remove: function remove(obj) {
        qx.lang.Array.remove(this.__P_379_0, obj);
      ...
      hideAll: function hideAll() {
        var l = this.__P_379_0.length,
            current = {};

        while (l--) {
          current = this.__P_379_0[l];
      ...
      */
       ...
       *
       */
      __P_379_2: function __P_379_2() {
        var min = 1e7;

        for (var i = 0; i < this.__P_379_0.length; i++) {
          this.__P_379_0[i].setZIndex(min++);
        }
      },
      ...
      */
       ...
       */
      __P_379_1: function __P_379_1(e) {
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_379_1, this, true);
...
//# sourceMappingURL=Manager.js.map?dt=1648710504434