  ...
  qx.Class.define("qx.ui.control.DateChooser", {
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_303_2[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_303_1[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_303_3(helpDate));
      ...
      __P_303_3: function __P_303_3(date) {
        var d = new Date(date);
        d.setHours(0, 0, 0, 0);
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_303_0 = this.__P_303_1 = this.__P_303_2 = null;
    }
  });
  qx.ui.control.DateChooser.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DateChooser.js.map?dt=1672653504552