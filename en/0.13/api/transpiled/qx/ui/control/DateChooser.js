  ...
  qx.Class.define("qx.ui.control.DateChooser", {
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_312_2[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_312_1[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_312_3(helpDate));
      ...
      __P_312_3: function __P_312_3(date) {
        var d = new Date(date);
        d.setHours(0, 0, 0, 0);
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_312_0 = this.__P_312_1 = this.__P_312_2 = null;
    }
  });
  qx.ui.control.DateChooser.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DateChooser.js.map?dt=1705596675903