    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_529_1: ["maroon", "red", "orange", "yellow", "olive", "purple", "fuchsia", "lime", "green", "navy", "blue", "aqua", "teal", "black", "#333", "#666", "#999", "#BBB", "#EEE", "white"],
      /**
          ...
          case "preset-grid":
            ...
            for (var i = 0; i < 2; i++) {
              for (var j = 0; j < 10; j++) {
                ...
                colorField.setBackgroundColor(this.__P_529_1[colorPos]);
      ...
      getValue: function getValue() {
        return this.__P_529_6 ? null : qx.util.ColorUtil.rgbToHexString([this.getRed(), this.getGreen(), this.getBlue()]);
      },
      /**
      ...
      */
      ...
      _applyRed: function _applyRed(value, old) {
        if (this.__P_529_0 === null) {
          this.__P_529_0 = "redModifier";
        }
        if (this.__P_529_0 !== "rgbSpinner") {
          this.getChildControl("rgb-spinner-red").setValue(value);
        }
        if (this.__P_529_0 !== "hexField") {
          this._setHexFromRgb();
        }
        switch (this.__P_529_0) {
          case "rgbSpinner":
          case "hexField":
          case "redModifier":
            this._setHueFromRgb();
      ...
      _applyGreen: function _applyGreen(value, old) {
        ...
        this._setPreviewFromRgb();
        this.__P_529_8();
        if (this.__P_529_0 === "greenModifier") {
          this.__P_529_0 = null;
        }
      },
      // property apply
      _applyBlue: function _applyBlue(value, old) {
        ...
        this._setPreviewFromRgb();
        this.__P_529_8();
        if (this.__P_529_0 === "blueModifier") {
          this.__P_529_0 = null;
        }
      },
      /*
      ...
      */
      ...
      _applyHue: function _applyHue(value, old) {
        if (this.__P_529_0 === null) {
          this.__P_529_0 = "hueModifier";
        }
        if (this.__P_529_0 !== "hsbSpinner") {
          this.getChildControl("hsb-spinner-hue").setValue(value);
        }
        if (this.__P_529_0 !== "hueSaturationField") {
      ...
      _applySaturation: function _applySaturation(value, old) {
        if (this.__P_529_0 === null) {
          this.__P_529_0 = "saturationModifier";
        }
        if (this.__P_529_0 !== "hsbSpinner") {
        ...
        if (this.__P_529_0 === "saturationModifier") {
          this.__P_529_0 = null;
        }
      },
      // property apply
      _applyBrightness: function _applyBrightness(value, old) {
        if (this.__P_529_0 === null) {
          this.__P_529_0 = "brightnessModifier";
        }
        if (this.__P_529_0 !== "hsbSpinner") {
          this.getChildControl("hsb-spinner-brightness").setValue(value);
        }
        if (this.__P_529_0 !== "brightnessField") {
        ...
        if (this.__P_529_0 === "brightnessModifier") {
          this.__P_529_0 = null;
        }
      },
      /*
      ...
      */
      ...
      _onBrightnessHandlePointerDown: function _onBrightnessHandlePointerDown(e) {
        ...
        this.__P_529_2 = "brightness-handle";
        ...
        this.__P_529_3 = locationBrightnessField.top + (e.getDocumentTop() - locationBrightnessHandle.top) - fieldBounds.top;
      ...
      _onBrightnessHandlePointerMove: function _onBrightnessHandlePointerMove(e) {
        ...
        if (this.__P_529_2 === "brightness-handle") {
      ...
      _onBrightnessFieldPointerDown: function _onBrightnessFieldPointerDown(e) {
        ...
        this.__P_529_3 = location.top + bounds.height / 2;
      ...
      _setBrightnessOnFieldEvent: function _setBrightnessOnFieldEvent(e) {
        var value = qx.lang.Number.limit(e.getDocumentTop() - this.__P_529_3, 0, 256);
        this.__P_529_0 = "brightnessField";
        if (this.getChildControl("brightness-handle").getBounds()) {
      ...
      */
      ...
      _onHueSaturationHandlePointerMove: function _onHueSaturationHandlePointerMove(e) {
        // Update if captured currently (through previous pointerdown)
        if (this.__P_529_2 === "hue-saturation-handle") {
      ...
      _onHueSaturationFieldPointerDown: function _onHueSaturationFieldPointerDown(e) {
        ...
        this.__P_529_4 = location.top + handleBounds.height / 2 - fieldBounds.top;
        this.__P_529_5 = location.left + handleBounds.width / 2 - fieldBounds.left;
        ...
        this.__P_529_2 = "hue-saturation-handle";
      },
      /**
      ...
      _setHueSaturationOnFieldEvent: function _setHueSaturationOnFieldEvent(e) {
        var vTop = qx.lang.Number.limit(e.getDocumentTop() - this.__P_529_4, 0, 256);
        var vLeft = qx.lang.Number.limit(e.getDocumentLeft() - this.__P_529_5, 0, 256);
        this.getChildControl("hue-saturation-handle").setDomPosition(vLeft, vTop);
        this.__P_529_0 = "hueSaturationField";
...
//# sourceMappingURL=ColorSelector.js.map?dt=1726089072995