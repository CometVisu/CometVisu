    ...
    members: {
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__P_696_0 == null) {
            this.__P_696_0 = [];
          }
          this.__P_696_0[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        if (columnIndex == this._treeColumn) {
          return this.__P_696_1.getAllowNodeEdit();
        }
        return this.__P_696_0 ? this.__P_696_0[columnIndex] == true : false;
      },
      // overridden
      ...
      setValue: function setValue(columnIndex, rowIndex, value) {
        ...
        if (columnIndex === this._treeColumn) {
          if (!this.__P_696_1.getAllowNodeEdit() || value["label"] === undefined) {
            return;
          }
       ...
       */
      __P_696_4: function __P_696_4(nodeId, level) {
        ...
        var index = 0;
        var children = this.__P_696_2[nodeId] = [];
        for (var i = 0; i < numChildren; i++) {
          ...
          if (!this.__P_696_3) {
            this.__P_696_5(child, i == numChildren - 1);
          }
          ...
          if (child.bOpened) {
            ...
            this.__P_696_4(childNodeId, level + 1);
          }
          index++;
        }
      },
       ...
       *   {@link #addLeaf}.
       */
      __P_696_6: function __P_696_6(nodeId) {
        var tempTreeData = this.__P_696_2;
       ...
       */
      __P_696_5: function __P_696_5(node, isLastChild) {
       ...
       */
      __P_696_7: function __P_696_7() {
        // Reset the __tempTreeData
        this.__P_696_2 = [];
        this.__P_696_3 = false;
      ...
      isNodeEditable: function isNodeEditable(rowIndex) {
        return this.__P_696_1.getAllowNodeEdit() && this.getNodeFromRow(rowIndex).bCanEdit;
      }
    },
    destruct: function destruct() {
      this._rowArr = this._nodeArr = this._nodeRowMap = this._selections = this.__P_696_1 = this.__P_696_2 = null;
    },
...
//# sourceMappingURL=SimpleTreeDataModel.js.map?dt=1726089083396