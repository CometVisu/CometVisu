  ...
  qx.Class.define("qx.ui.splitpane.Pane", {
    ...
    */
    ...
    construct: function construct(orientation) {
      ...
      this.__P_431_1.addListener("pointerdown", this._onPointerDown, this);
      this.__P_431_1.addListener("pointerup", this._onPointerUp, this);
      this.__P_431_1.addListener("pointermove", this._onPointerMove, this);
      this.__P_431_1.addListener("pointerout", this._onPointerOut, this);
      this.__P_431_1.addListener("losecapture", this._onPointerUp, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          ...
          case "splitter":
            ...
            control.addListener("move", this.__P_431_9, this);
            break;
        }
       ...
       */
      __P_431_9: function __P_431_9(e) {
        this.__P_431_10(e.getData());
      },
      /**
       ...
       */
      __P_431_11: function __P_431_11(orientation) {
        var _this = this;
        this.__P_431_1 = new qx.ui.splitpane.Blocker(orientation);
        this.getContentElement().add(this.__P_431_1);
        ...
        splitter.addListener("resize", function (e) {
          ...
          if (_this.getChildControl("splitter").isKnobVisible() && (bounds.height == 0 || bounds.width == 0)) {
            _this.__P_431_1.hide();
          } else {
            _this.__P_431_1.show();
          }
        });
      },
      /**
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__P_431_6 = value === "horizontal";
        if (!this.__P_431_1) {
          this.__P_431_11(value);
        }

        // update the blocker
        this.__P_431_1.setOrientation(value);
       ...
       *   they can be added.
       */
      __P_431_10: function __P_431_10(bounds) {
        var splitter = this.getChildControl("splitter");
        ...
        if (this.__P_431_6) {
          ...
          if (width || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__P_431_1.setWidth(offset, width || 6);
            this.__P_431_1.setLeft(offset, left);
          }
          ...
          if (height || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__P_431_1.setHeight(offset, height || 6);
            this.__P_431_1.setTop(offset, top);
          }
        }
      },
      /*
      ...
      */
      ...
      remove: function remove(widget) {
        this._remove(widget);
        qx.lang.Array.remove(this.__P_431_0, widget);
      },
      /**
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        this.__P_431_2 = this.__P_431_6 ? e.getDocumentLeft() - splitterLocation.left + paneLocation.left : e.getDocumentTop() - splitterLocation.top + paneLocation.top;
      ...
      _onPointerMove: function _onPointerMove(e) {
        ...
        if (this.__P_431_3) {
          ...
          var slider = this.getChildControl("slider");
          var pos = this.__P_431_7;
          if (this.__P_431_6) {
            slider.setDomLeft(pos);
            this.__P_431_1.setStyle("left", pos - this.getOffset() + "px");
          } else {
            slider.setDomTop(pos);
            this.__P_431_1.setStyle("top", pos - this.getOffset() + "px");
          }
          e.stop();
        }
      },
      ...
      */
      ...
      _finalizeSizes: function _finalizeSizes() {
        var beginSize = this.__P_431_7;
        var endSize = this.__P_431_8;
        if (beginSize == null) {
          return;
        }
       ...
       */
      __P_431_12: function __P_431_12() {
        if (this.__P_431_6) {
          var min = "minWidth",
            size = "width",
            max = "maxWidth",
            pointer = this.__P_431_4;
        } else {
          var min = "minHeight",
            size = "height",
            max = "maxHeight",
            pointer = this.__P_431_5;
        }
        var children = this._getChildren();
        ...
        var beginSize = pointer - this.__P_431_2;
        ...
        // Store sizes
        this.__P_431_7 = beginSize;
        this.__P_431_8 = endSize;
      },
      /**
...
//# sourceMappingURL=Pane.js.map?dt=1672653513444