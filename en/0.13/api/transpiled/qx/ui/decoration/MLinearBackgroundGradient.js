  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function _styleLinearBackgroundGradient(styles) {
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__P_563_4(startColors[i]);
            var endColor = this.__P_563_4(endColors[i]);
            var unit = units[i];
       ...
       */
      __P_563_1: function __P_563_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_563_2: function __P_563_2(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        var me = qx.ui.decoration.MLinearBackgroundGradient.__P_563_2;
        if (!me.__P_563_5) {
          me.__P_563_5 = document.createElement("canvas");
        }
        ...
        me.__P_563_5.width = width;
        me.__P_563_5.height = height;
        var ctx = me.__P_563_5.getContext("2d");
        if (isVertical) {
        ...
        backgroundStyle.push("url(" + me.__P_563_5.toDataURL() + ") " + size);
        return true;
      },
      /**
       * Compute CSS rules to style the background with gradients.
       ...
       */
      __P_563_3: function __P_563_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_563_0: function __P_563_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       */
      __P_563_4: function __P_563_4(color) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1729101261075