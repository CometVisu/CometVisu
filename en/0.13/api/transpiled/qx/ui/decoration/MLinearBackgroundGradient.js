  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function _styleLinearBackgroundGradient(styles) {
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__P_336_4(startColors[i]);
            var endColor = this.__P_336_4(endColors[i]);
            var unit = units[i];
       ...
       */
      __P_336_1: function __P_336_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_336_2: function __P_336_2(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        var me = qx.ui.decoration.MLinearBackgroundGradient.__P_336_2;
        if (!me.__P_336_5) {
          me.__P_336_5 = document.createElement("canvas");
        }
        ...
        me.__P_336_5.width = width;
        me.__P_336_5.height = height;
        var ctx = me.__P_336_5.getContext("2d");
        if (isVertical) {
        ...
        backgroundStyle.push("url(" + me.__P_336_5.toDataURL() + ") " + size);
        return true;
      },
      /**
       * Compute CSS rules to style the background with gradients.
       ...
       */
      __P_336_3: function __P_336_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_336_0: function __P_336_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       */
      __P_336_4: function __P_336_4(color) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1673093867741