  ...
  qx.Class.define("qx.ui.command.GroupManager", {
    ...
    members: {
      ...
      add: function add(group) {
        if (this.__P_537_0.includes(group)) {
          return false;
        }
        this.__P_537_0.push(group);
      ...
      remove: function remove(group) {
        var index = this.__P_537_0.indexOf(group);
        if (index === -1) {}
      ...
      setActive: function setActive(group) {
        ...
        for (var i = 0; i < this.__P_537_0.length; i++) {
          var item = this.__P_537_0[i];
          if (item == group) {
            item.setActive(true);
            this.__P_537_1 = item;
            continue;
      ...
      block: function block() {
        if (this.__P_537_1) {
          this.__P_537_1.setActive(false);
        }
      },
      /**
      ...
      _getGroup: function _getGroup(group) {
        ...
        return this.__P_537_0[index];
      }
    },
    destruct: function destruct() {
      this.__P_537_0 = this.__P_537_1 = null;
    }
  });
  qx.ui.command.GroupManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=GroupManager.js.map?dt=1782595074264