  ...
  qx.Class.define("qx.ui.command.GroupManager", {
    ...
    members: {
      ...
      add: function add(group) {
        if (this.__P_264_0.includes(group)) {
          return false;
        }

        this.__P_264_0.push(group); // deactivate added group to prevent collusions
      ...
      remove: function remove(group) {
        var index = this.__P_264_0.indexOf(group);
      ...
      setActive: function setActive(group) {
        ...
        for (var i = 0; i < this.__P_264_0.length; i++) {
          var item = this.__P_264_0[i];
      ...
      block: function block() {
        if (this.__P_264_1) {
          this.__P_264_1.setActive(false);
        }
      },
      ...
      _getGroup: function _getGroup(group) {
        ...
        return this.__P_264_0[index];
      }
    },
    destruct: function destruct() {
      this.__P_264_0 = this.__P_264_1 = null;
    }
  });
  qx.ui.command.GroupManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=GroupManager.js.map?dt=1647161232824