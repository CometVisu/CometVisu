  ...
  qx.Class.define("qx.ui.menu.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Create open timer
      this.__P_620_1 = new qx.event.Timer();
      this.__P_620_1.addListener("interval", this._onOpenInterval, this);

      // Create close timer
      this.__P_620_2 = new qx.event.Timer();
      this.__P_620_2.addListener("interval", this._onCloseInterval, this);
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    members: {
      ...
      */
      ...
      scheduleClose: function scheduleClose(menu) {
        ...
        if (!menu.isVisible()) {
          ...
          if (this.__P_620_4) {
            this.cancelClose(this.__P_620_4);
          }
        }

        // When the menu is visible and not scheduled already
        // then schedule it for closing
        else if (this.__P_620_4 != menu) {
          // menu.debug("Schedule close");
          this.__P_620_4 = menu;
          this.__P_620_2.restartWith(menu.getCloseInterval());
        }
      },
      /**
      ...
      */
      ...
      preventContextMenuOnce: function preventContextMenuOnce() {
        qx.event.Registration.addListener(document.body, "contextmenu", this.__P_620_5, this, true);
      },
      /**
       ...
       * @internal
       */
      __P_620_5: function __P_620_5(e) {
        ...
        // stop only once
        qx.event.Registration.removeListener(document.body, "contextmenu", this.__P_620_5, this, true);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__P_620_0.length > 0 && !this._isInMenu(target)) {
          this.hideAll();
        }
      },
      /*
      ...
      */
      ...
      _onKeyUpDown: function _onKeyUpDown(e) {
        ...
        if (this.__P_620_7[iden] || this.__P_620_6[iden] && menu.getSelectedButton()) {
          e.stopPropagation();
        }
      },
      /**
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        var iden = e.getKeyIdentifier();
        var navigation = this.__P_620_7[iden];
        var selection = this.__P_620_6[iden];
        if (navigation) {
          switch (iden) {
            case "Up":
      ...
      _onRoll: function _onRoll(e) {
        var target = e.getTarget();
        target = qx.ui.core.Widget.getWidgetByElement(target, true);
        if (this.__P_620_0.length > 0 && !this._isInMenu(target) && !this._isMenuOpener(target) && !e.getMomentum()) {
          this.hideAll();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_620_1", "__P_620_2");
      this._disposeArray("__P_620_0");
    }
  });
  qx.ui.menu.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1778272850020