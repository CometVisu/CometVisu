    ...
    */
    ...
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_609_2: function __P_609_2() {
        var menuBounds = this._getMenuBounds();
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_609_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_609_1) {
          this.__P_609_1.call(this);
          delete this.__P_609_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
...
//# sourceMappingURL=Menu.js.map?dt=1735222446279