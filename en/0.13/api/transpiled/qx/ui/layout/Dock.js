  ...
  qx.Class.define("qx.ui.layout.Dock", {
    ...
    */
    ...
    members: {
      ...
      __P_597_4: function __P_597_4() {
        ...
        this.__P_597_0 = result;

        // Cache edges for faster access
        var edges = [];
        for (var i = 0; i < length; i++) {
          edge = result[i].getLayoutProperties().edge;
          edges[i] = this.__P_597_2[edge] || 5;
        }
        this.__P_597_1 = edges;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        var children = this.__P_597_0;
        var edges = this.__P_597_1;
    ...
    */
    destruct: function destruct() {
      this.__P_597_1 = this.__P_597_0 = null;
    }
  });
  qx.ui.layout.Dock.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Dock.js.map?dt=1735383878701