  ...
  qx.Class.define("qx.ui.layout.Grid", {
    ...
    */
    ...
    members: {
      ...
      __P_599_9: function __P_599_9() {
        ...
        this.__P_599_2 = grid;
        this.__P_599_3 = colSpans;
        this.__P_599_4 = rowSpans;
        this.__P_599_5 = maxRowIndex;
        this.__P_599_6 = maxColIndex;
        this.__P_599_7 = null;
        this.__P_599_8 = null;
      ...
      _setRowData: function _setRowData(row, key, value) {
        var rowData = this.__P_599_0[row];
        if (!rowData) {
          this.__P_599_0[row] = {};
          this.__P_599_0[row][key] = value;
        } else {
          rowData[key] = value;
        }
      },
      ...
      _setColumnData: function _setColumnData(column, key, value) {
        var colData = this.__P_599_1[column];
        if (!colData) {
          this.__P_599_1[column] = {};
          this.__P_599_1[column][key] = value;
        } else {
          colData[key] = value;
        }
      },
      ...
      getCellAlign: function getCellAlign(row, column) {
        ...
        var rowData = this.__P_599_0[row];
        var colData = this.__P_599_1[column];
        var widget = this.__P_599_2[row][column];
        if (widget) {
          var widgetProps = {
      ...
      _fixHeightsRowSpan: function _fixHeightsRowSpan(rowHeights) {
        ...
        for (var i = 0, l = this.__P_599_4.length; i < l; i++) {
          var widget = this.__P_599_4[i];
      ...
      _getRowHeights: function _getRowHeights() {
        if (this.__P_599_7 != null) {
          return this.__P_599_7;
        }
        var rowHeights = [];
        var maxRowIndex = this.__P_599_5;
        var maxColIndex = this.__P_599_6;
        for (var row = 0; row <= maxRowIndex; row++) {
          var minHeight = 0;
          var height = 0;
          var maxHeight = 0;
          for (var col = 0; col <= maxColIndex; col++) {
            var widget = this.__P_599_2[row][col];
            if (!widget) {
              continue;
            }
        ...
        if (this.__P_599_4.length > 0) {
          this._fixHeightsRowSpan(rowHeights);
        }
        this.__P_599_7 = rowHeights;
        return rowHeights;
      },
      /**
      ...
      _getColWidths: function _getColWidths() {
        if (this.__P_599_8 != null) {
          return this.__P_599_8;
        }
        var colWidths = [];
        var maxColIndex = this.__P_599_6;
        var maxRowIndex = this.__P_599_5;
    ...
    */
    destruct: function destruct() {
      this.__P_599_2 = this.__P_599_0 = this.__P_599_1 = this.__P_599_3 = this.__P_599_4 = this.__P_599_8 = this.__P_599_7 = null;
    }
  });
  qx.ui.layout.Grid.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Grid.js.map?dt=1735383878818