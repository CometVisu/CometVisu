  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.LineSizeIterator", {
    ...
    construct: function construct(children, spacing) {
      this.__P_601_0 = children;
      this.__P_601_1 = spacing;
      this.__P_601_2 = children.length > 0;
      this.__P_601_3 = 0;
    },
    members: {
      __P_601_0: null,
      ...
      computeNextLine: function computeNextLine(availWidth) {
        ...
        var children = this.__P_601_0;
        var lineHeight = 0;
        var lineWidth = 0;
        var lineChildren = [];
        var gapsBefore = [];
        for (var i = this.__P_601_3; i < children.length; i++) {
          var child = children[i];
          var size = child.getSizeHint();
          var gapBefore = this.__P_601_4(i);
          var childWidth = size.width + gapBefore;
          var isFirstChild = i == this.__P_601_3;
       ...
       */
      __P_601_4: function __P_601_4(childIndex) {
        var isFirstInLine = childIndex == this.__P_601_3;
        if (isFirstInLine) {
          return this.__P_601_0[childIndex].getMarginLeft();
        } else {
          return Math.max(this.__P_601_0[childIndex - 1].getMarginRight(), this.__P_601_0[childIndex].getMarginLeft(), this.__P_601_1);
        }
      },
      /**
...
//# sourceMappingURL=LineSizeIterator.js.map?dt=1735222445843