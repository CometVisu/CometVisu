  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_600_4: function __P_600_4() {
        var children = this._getLayoutChildren();
        var length = children.length;
        var enableFlex = false;
        var reuse = this.__P_600_0 && this.__P_600_0.length != length && this.__P_600_1 && this.__P_600_0;
        var props;

        // Sparse array (keep old one if lengths has not been modified)
        var widths = reuse ? this.__P_600_0 : new Array(length);
        var flexs = reuse ? this.__P_600_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_600_0 = widths;
          this.__P_600_1 = flexs;
        }
        this.__P_600_2 = enableFlex;
        this.__P_600_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_600_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedWidth > availWidth;
          for (i = 0; i < length; i += 1) {
            flex = this.__P_600_1[i];
            if (flex > 0) {
              hint = children[i].getSizeHint();
              flexibles[i] = {
                min: hint.minWidth,
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_600_1[i];
          var percent = this.__P_600_0[i];
          if (flex) {
    ...
    */
    destruct: function destruct() {
      this.__P_600_0 = this.__P_600_1 = this.__P_600_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1735222445829