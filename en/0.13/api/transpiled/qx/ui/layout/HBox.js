  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    members: {
      ...
      */
      ...
      __P_371_4: function __P_371_4() {
        ...
        var reuse = this.__P_371_0 && this.__P_371_0.length != length && this.__P_371_1 && this.__P_371_0;
        var props;

        // Sparse array (keep old one if lengths has not been modified)
        var widths = reuse ? this.__P_371_0 : new Array(length);
        var flexs = reuse ? this.__P_371_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_371_0 = widths;
          this.__P_371_1 = flexs;
        }
        this.__P_371_2 = enableFlex;
        this.__P_371_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_371_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedWidth > availWidth;
          for (i = 0; i < length; i += 1) {
            flex = this.__P_371_1[i];
            if (flex > 0) {
              hint = children[i].getSizeHint();
              flexibles[i] = {
                min: hint.minWidth,
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_371_1[i];
          var percent = this.__P_371_0[i];
          if (flex) {
    ...
    */
    destruct: function destruct() {
      this.__P_371_0 = this.__P_371_1 = this.__P_371_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1672653509511