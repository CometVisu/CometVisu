  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_373_4: function __P_373_4() {
        var children = this._getLayoutChildren();
        var length = children.length;
        var enableFlex = false;
        var reuse = this.__P_373_0 && this.__P_373_0.length != length && this.__P_373_1 && this.__P_373_0;
        var props;

        // Sparse array (keep old one if lengths has not been modified)
        var heights = reuse ? this.__P_373_0 : new Array(length);
        var flexs = reuse ? this.__P_373_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_373_0 = heights;
          this.__P_373_1 = flexs;
        }
        this.__P_373_2 = enableFlex;
        this.__P_373_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_373_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedHeight > availHeight;
          for (i = 0; i < length; i += 1) {
            flex = this.__P_373_1[i];
            if (flex > 0) {
              hint = children[i].getSizeHint();
              flexibles[i] = {
                min: hint.minHeight,
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_373_1[i];
          var percent = this.__P_373_0[i];
          if (flex) {
    ...
    */
    destruct: function destruct() {
      this.__P_373_0 = this.__P_373_1 = this.__P_373_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1672653509647