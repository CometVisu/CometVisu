  ...
  qx.Class.define("qx.ui.root.Application", {
    ...
    */
    ...
    construct: function construct(doc) {
      // Symbolic links
      this.__P_437_0 = qx.dom.Node.getWindow(doc);
      this.__P_437_1 = doc;
      ...
      // Resize handling
      qx.event.Registration.addListener(this.__P_437_0, "resize", this._onResize, this);
      ...
      this.addListener("touchmove", this.__P_437_2, this);
    ...
    */
    ...
    members: {
      ...
      _computeSizeHint: function _computeSizeHint() {
        var width = qx.bom.Viewport.getWidth(this.__P_437_0);
        var height = qx.bom.Viewport.getHeight(this.__P_437_0);
        return {
          minWidth: width,
          width: width,
          maxWidth: width,
       ...
       */
      __P_437_2: function __P_437_2(e) {
...
//# sourceMappingURL=Application.js.map?dt=1705596682663