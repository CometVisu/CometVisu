  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.core.AbstractItem", {
    ...
    members: {
      ...
      */
      ...
      addSpacer: function addSpacer() {
        if (!this.__P_427_2) {
          this.__P_427_2 = new qx.ui.core.Spacer();
        } else {
          this._remove(this.__P_427_2);
        }

        this._add(this.__P_427_2);
      },
      ...
      */
      ...
      _applyIconOpened: function _applyIconOpened(value, old) {
        if (this.isOpen()) {
          ...
          if (this.__P_427_5() && this.__P_427_3()) {
            this.__P_427_4(value);
      ...
      */
      __P_427_4: function __P_427_4(url) {
      ...
      */
      ...
      _updateIndent: function _updateIndent() {
        ...
        if (this.__P_427_2) {
          this.__P_427_2.setWidth((this.getLevel() + 1) * this.getIndent() - openWidth);
        }
      },
      // property apply
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_427_2");
    }
  });
  qx.ui.tree.core.AbstractItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractItem.js.map?dt=1650225672160