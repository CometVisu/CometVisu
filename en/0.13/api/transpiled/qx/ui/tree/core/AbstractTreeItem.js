    ...
    members: {
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        if (!this.__P_464_1) {
          this.__P_464_1 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
      ...
      */
      ...
      addAt: function addAt(treeItem, index) {
        if (index == this.__P_464_0.length) {
          this.add(treeItem);
          return;
        }
        var oldParent = treeItem.getParent();
...
//# sourceMappingURL=AbstractTreeItem.js.map?dt=1677017725324