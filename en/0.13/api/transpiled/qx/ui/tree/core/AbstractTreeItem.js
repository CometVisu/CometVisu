    ...
    members: {
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        if (!this.__P_463_1) {
          this.__P_463_1 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
      ...
      */
      ...
      getChildren: function getChildren() {
        return this.__P_463_0;
      },
      // overridden
      hasChildren: function hasChildren() {
        return this.__P_463_0 ? this.__P_463_0.length > 0 : false;
      },
      /**
      ...
      addAt: function addAt(treeItem, index) {
        if (index == this.__P_463_0.length) {
          this.add(treeItem);
          return;
        }
        var oldParent = treeItem.getParent();
      ...
      addBefore: function addBefore(treeItem, before) {
        ...
        this.addAt(treeItem, this.__P_463_0.indexOf(before));
      },
      /**
      ...
      addAfter: function addAfter(treeItem, after) {
        ...
        this.addAt(treeItem, this.__P_463_0.indexOf(after) + 1);
      },
      /**
      ...
      remove: function remove(varargs) {
        for (var i = 0, l = arguments.length; i < l; i++) {
          var treeItem = arguments[i];
          if (this.__P_463_0.indexOf(treeItem) == -1) {
          ...
          qx.lang.Array.remove(this.__P_463_0, treeItem);
      ...
      removeAll: function removeAll() {
        ...
        var children = this.__P_463_0.concat();
        for (var i = this.__P_463_0.length - 1; i >= 0; i--) {
          this.remove(this.__P_463_0[i]);
        }
        return children;
      }
    },
    destruct: function destruct() {
      this._disposeArray("__P_463_0");
      this._disposeObjects("__P_463_1");
    }
  });
  qx.ui.tree.core.AbstractTreeItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractTreeItem.js.map?dt=1673093876282