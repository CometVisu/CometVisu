  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_297_1 || 0,
          height: this.__P_297_2 || 0
        };
      },
      // overridden
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        this.__P_297_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__P_297_9() === "font") {
          var el = this.getContentElement();
          if (this.__P_297_5) {
            el = el.getChild(0);
          }
      ...
      */
       ...
       */
      __P_297_10: function __P_297_10(mode) {
        this.__P_297_3 = mode;
      },
      /**
       ...
       */
      __P_297_9: function __P_297_9() {
        if (this.__P_297_3 == null) {
          var source = this.getSource();
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_297_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_297_3 = "scaled";
          } else {
            this.__P_297_3 = "nonScaled";
          }
        }
        return this.__P_297_3;
      },
      /**
       ...
       */
      __P_297_11: function __P_297_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_297_5 = new qx.html.Element("div");
            element.connectObject(this);
       ...
       */
      __P_297_7: function __P_297_7() {
        if (this.$$disposed) {
          return null;
        }
        var mode = this.__P_297_9();
        if (this.__P_297_0[mode] == null) {
          this.__P_297_0[mode] = this.__P_297_11(mode);
        }
        var element = this.__P_297_0[mode];
        if (!this.__P_297_4) {
          this.__P_297_4 = element;
        }
        return element;
      },
      /**
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_297_12(element);
          return;
        }
        this.__P_297_13(source);
        ...
        var contentEl = this.__P_297_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_297_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_297_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_297_17(contentEl, source);
          this.__P_297_16();
        } else {
          this.__P_297_18(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_297_13: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            this.__P_297_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_297_9() != "alphaScaled") {
              this.__P_297_10("alphaScaled");
            } else if (!this.getScale() && this.__P_297_9() != "nonScaled") {
              this.__P_297_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_297_9() != "scaled") {
              this.__P_297_10("scaled");
            } else if (!this.getScale() && this.__P_297_9() != "nonScaled") {
              this.__P_297_10("nonScaled");
            }
          }
          this.__P_297_19(this.__P_297_7());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_297_10("font");
          } else if (this.getScale() && this.__P_297_9() != "scaled") {
            this.__P_297_10("scaled");
          } else if (!this.getScale() && this.__P_297_9() != "nonScaled") {
            this.__P_297_10("nonScaled");
          }
       ...
       */
      __P_297_19: function __P_297_19(elementToAdd) {
        var currentContentElement = this.__P_297_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_297_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_297_15: function __P_297_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_297_20(source);
          ...
          this.__P_297_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_297_22: function __P_297_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_297_22(el, width, height);
          }
        } else {
          this.__P_297_21();
        }
       ...
       * @param source {String} source path
       */
      __P_297_17: function __P_297_17(el, source) {
       ...
       * @param source {String} source path
       */
      __P_297_18: function __P_297_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_297_23, this);
        } else {
          this.__P_297_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_297_12: function __P_297_12(el) {
        if (el != null) {
      ...
      __P_297_20: function __P_297_20(source) {
       ...
       * @param source {String} source path
       */
      __P_297_8: function __P_297_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_297_20(source);
          ...
          this.__P_297_22(el, this.__P_297_1, this.__P_297_2);
       ...
       */
      __P_297_23: function __P_297_23(source, imageInfo) {
        ...
        // Update image
        this.__P_297_17(this.__P_297_14(), source);
      },
      /**
       ...
       */
      __P_297_21: function __P_297_21(width, height) {
        if (width === undefined) {
          width = this.__P_297_1;
        }
        if (height === undefined) {
          height = this.__P_297_2;
        }
      ...
      _recalc: function _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_297_1 || height != this.__P_297_2) {
          this.__P_297_1 = width;
          this.__P_297_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_297_0) {
        if (this.__P_297_0.hasOwnProperty(mode)) {
          this.__P_297_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_297_4;
      if (this.__P_297_5) {
        delete this.__P_297_5;
      }
      this._disposeMap("__P_297_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1673093865371