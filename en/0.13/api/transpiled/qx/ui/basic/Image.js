    ...
    members: {
      ...
      */
      ...
      _styleSource: function _styleSource() {
        ...
        var contentEl = this.__P_298_14(); // Detect if the image registry knows this image
      ...
      __P_298_15: function __P_298_15(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_298_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_298_8(el, source); // Compare with old sizes and relayout if necessary
...
//# sourceMappingURL=Image.js.map?dt=1685978132833