  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        if (this.__P_307_1) {
          this.__P_307_4 = this.__P_307_5();
          delete this.__P_307_1;
        }
        return {
          width: this.__P_307_4.width,
          height: this.__P_307_4.height
        };
      },
      // overridden
      ...
      _getContentHeightForWidth: function _getContentHeightForWidth(width) {
        ...
        return this.__P_307_5(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        var _this = this;
        if (old && this.__P_307_0 && this.__P_307_3) {
          this.__P_307_0.removeListenerById(this.__P_307_3);
          this.__P_307_3 = null;
        }
        // Apply
        var styles;
        if (value) {
          ...
          this.__P_307_0 = value;
          if (this.__P_307_0 instanceof qx.bom.webfonts.WebFont && !this.__P_307_0.isValid()) {
            this.__P_307_3 = this.__P_307_0.addListener("changeStatus", function (evt) {
              if (evt.getData().valid) {
                _this.__P_307_1 = true;
                qx.ui.core.queue.Layout.add(_this);
              }
            });
          }
          styles = this.__P_307_0.getStyles();
        } else {
          this.__P_307_0 = null;
       ...
       */
      __P_307_5: function __P_307_5(width) {
        var Label = qx.bom.Label;
        var font = this.getFont();
        var styles = font ? this.__P_307_0.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy: function _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_307_2);
          this.__P_307_2 = null;
        }
        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_307_2 = this.addListener("tap", function () {
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__P_307_0 && this.__P_307_3) {
        this.__P_307_0.removeListenerById(this.__P_307_3);
      }
      this.__P_307_0 = null;
    }
...
//# sourceMappingURL=Label.js.map?dt=1705596675533