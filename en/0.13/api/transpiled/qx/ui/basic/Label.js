  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      {
        this.__P_536_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        if (this.__P_536_2) {
          this.__P_536_5 = this.__P_536_6();
          delete this.__P_536_2;
        }
        return {
          width: this.__P_536_5.width,
          height: this.__P_536_5.height
        };
      },
      // overridden
      ...
      _getContentHeightForWidth: function _getContentHeightForWidth(width) {
        ...
        return this.__P_536_6(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        var _this = this;
        if (old && this.__P_536_1 && this.__P_536_4) {
          this.__P_536_1.removeListenerById(this.__P_536_4);
          this.__P_536_4 = null;
        }
        // Apply
        var styles;
        if (value) {
          ...
          this.__P_536_1 = value;
          if (this.__P_536_1 instanceof qx.bom.webfonts.WebFont && !this.__P_536_1.isValid()) {
            this.__P_536_4 = this.__P_536_1.addListener("changeStatus", function (evt) {
              if (evt.getData().valid) {
                _this.__P_536_2 = true;
                qx.ui.core.queue.Layout.add(_this);
              }
            });
          }
          styles = this.__P_536_1.getStyles();
        } else {
          this.__P_536_1 = null;
       ...
       */
      __P_536_6: function __P_536_6(width) {
        var Label = qx.bom.Label;
        var font = this.getFont();
        var styles = font ? this.__P_536_1.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy: function _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_536_3);
          this.__P_536_3 = null;
        }
        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_536_3 = this.addListener("tap", function () {
    ...
    */
    destruct: function destruct() {
      if (true && this.__P_536_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_536_0);
      }
      if (this.__P_536_1 && this.__P_536_4) {
        this.__P_536_1.removeListenerById(this.__P_536_4);
      }
      this.__P_536_1 = null;
    }
...
//# sourceMappingURL=Label.js.map?dt=1778272846239