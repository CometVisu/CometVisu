  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.application.Routing", {
    ...
    construct: function construct() {
      this.__P_97_0 = new qx.event.Messaging();
      this.__P_97_1 = qx.bom.History.getInstance();
      this.__P_97_1.addListener("changeState", this.__P_97_2, this);
    },
    statics: {
      DEFAULT_PATH: "/",
      __P_97_3: [],
    ...
    members: {
      ...
      _getPathOrFallback: function _getPathOrFallback(path, defaultPath) {
        if (path == "" || path == null || !this.__P_97_0.has("get", path)) {
      ...
      onGet: function onGet(route, handler, scope) {
        return this.__P_97_0.on("get", route, handler, scope);
      },
      /**
      ...
      onPost: function onPost(route, handler, scope) {
        return this.__P_97_0.on("post", route, handler, scope);
      },
      /**
      ...
      onPut: function onPut(route, handler, scope) {
        return this.__P_97_0.on("put", route, handler, scope);
      },
      /**
      ...
      onDelete: function onDelete(route, handler, scope) {
        return this.__P_97_0.on("delete", route, handler, scope);
      },
      /**
      ...
      onAny: function onAny(route, handler, scope) {
        return this.__P_97_0.onAny(route, handler, scope);
      },
      /**
      ...
      _executeGet: function _executeGet(path, customData, fromEvent) {
        this.__P_97_5 = path;
        var history = this.__P_97_6(path);
        if (history) {
          if (!customData) {
            ...
            this.__P_97_7(path, customData);
          }
        } else {
          this.__P_97_8(path, customData);
          qx.application.Routing.__P_97_4 = [];
        }
        this.__P_97_1.setState(path);
        this.__P_97_0.emit("get", path, null, customData);
      },
      /**
       * Executes the get operation and informs all matching route handler.
       *
      ...
      executePost: function executePost(path, params, customData) {
        this.__P_97_0.emit("post", path, params, customData);
      },
      /**
      ...
      executePut: function executePut(path, params, customData) {
        this.__P_97_0.emit("put", path, params, customData);
      },
      /**
      ...
      executeDelete: function executeDelete(path, params, customData) {
        this.__P_97_0.emit("delete", path, params, customData);
      },
      /**
       ...
       */
      __P_97_8: function __P_97_8(path, customData) {
        qx.application.Routing.__P_97_3.unshift({
          path: path,
       ...
       * @param customData {var} The custom data to store.
       */
      __P_97_7: function __P_97_7(path, customData) {
        var register = [qx.application.Routing.__P_97_3, qx.application.Routing.__P_97_4];
       ...
       */
      __P_97_6: function __P_97_6(path) {
        var back = qx.application.Routing.__P_97_3;
        var forward = qx.application.Routing.__P_97_4;
        var found = false;
        var entry = null;
      ...
      back: function back(customData) {
        ...
        var path,
          back = qx.application.Routing.__P_97_3;
        if (back.length > 0) {
      ...
      dispose: function dispose() {
        this.__P_97_1.removeListener("changeState", this.__P_97_2, this);
      }
    }
  });
...
//# sourceMappingURL=Routing.js.map?dt=1672653483714