    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        config.include = this.__P_112_0(config.include);
        config.patch = this.__P_112_0(config.patch);
        ...
        this.__P_112_1(theme, config);
        this.__P_112_2(theme, config);
       ...
       */
      __P_112_0: function __P_112_0(objectOrArray) {
        if (!objectOrArray) {
          return [];
        }
       ...
       * @param config {Map} config structure
       */
      __P_112_2: function __P_112_2(theme, config) {
      ...
      */
       ...
       */
      __P_112_3: function __P_112_3(config) {
        for (var i = 0, keys = this.__P_112_4, l = keys.length; i < l; i++) {
          if (config[keys[i]]) {
            return keys[i];
          }
        }
       ...
       */
      __P_112_1: function __P_112_1(theme, config) {
        var type = this.__P_112_3(config);
      ...
      __P_112_4: ["colors", "borders", "decorations", "fonts", "icons", "widgets", "appearances", "meta"],
      /** @type {Map} allowed keys in theme definition */
      __P_112_5: qx.core.Environment.select("qx.debug", {
        "true": {
          title: "string",
          // String
          aliases: "object",
      ...
      __P_112_6: qx.core.Environment.select("qx.debug", {
        "true": {
          color: "object",
          border: "object",
          decoration: "object",
       ...
       */
      __P_112_7: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          var allowed = this.__P_112_5;
      ...
      patch: function patch(theme, mixinTheme) {
        this.__P_112_8(mixinTheme);
        var type = this.__P_112_3(mixinTheme);
        if (type !== this.__P_112_3(theme)) {
       ...
       */
      __P_112_8: function __P_112_8(mixinTheme) {
...
//# sourceMappingURL=Theme.js.map?dt=1778272818293