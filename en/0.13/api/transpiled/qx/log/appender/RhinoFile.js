  ...
  qx.Class.define("qx.log.appender.RhinoFile", {
    statics: {
      ...
      log: function log(logMessage, level) {
        if (!qx.log.appender.RhinoFile.__P_242_0) {
          qx.log.appender.RhinoFile.create();
        }

        var logFile = qx.log.appender.RhinoFile.__P_242_0;
      ...
      create: function create() {
        if (qx.log.appender.RhinoFile.__P_242_0) {
          qx.log.appender.RhinoFile.__P_242_0.close();
        }
        ...
        qx.log.appender.RhinoFile.__P_242_0 = new java.io.BufferedWriter(fstream);
      }
    }
  });
...
//# sourceMappingURL=RhinoFile.js.map?dt=1660800161906