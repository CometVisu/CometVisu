  ...
  qx.Class.define("qx.log.appender.Console", {
    statics: {
      ...
      */
      ...
      toggle: function toggle() {
        if (!this.__P_273_0) {
          this.init();
        } else if (this.__P_273_0.style.display == "none") {
          this.show();
        } else {
      ...
      show: function show() {
        if (!this.__P_273_0) {
          ...
          this.__P_273_0.style.display = "block";
          this.__P_273_1.scrollTop = this.__P_273_1.scrollHeight;
        }
      },
      /*
    ...
    */
    defer: function defer(statics) {
      qx.event.Registration.addListener(document.documentElement, "keypress", statics.__P_273_5, statics);
      qx.event.Registration.addListener(document.documentElement, "longtap", statics.__P_273_5, statics);
    }
  });
  qx.log.appender.Console.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Console.js.map?dt=1677345936545