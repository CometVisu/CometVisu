  ...
  qx.Class.define("qx.log.appender.RhinoConsole", {
    statics: {
      ...
      log: function log(logMessage, level) {
        if (level == "error") {
          this.__P_277_1.println(logMessage);
        } else {
    ...
    defer: function defer() {
      if (typeof java !== "undefined" && typeof java.lang !== "undefined") {
        qx.log.appender.RhinoConsole.__P_277_0 = java.lang.System.out;
        qx.log.appender.RhinoConsole.__P_277_1 = java.lang.System.err;
      }
    }
  });
...
//# sourceMappingURL=RhinoConsole.js.map?dt=1676809317098