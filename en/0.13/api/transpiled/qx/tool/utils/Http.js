  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.tool.utils.Http", {
    ...
    statics: {
       ...
       */
      downloadToTempfile: function downloadToTempfile(url, contentTypeRegEx) {
                ...
                return new Promise(function (resolve, reject) {
                  http.get(url, function (res) {
                    ...
                    if (statusCode !== 200) {
                      ...
                      error = new Error("Invalid content-type, received ".concat(contentType));
                    }
                    if (error) {
                      res.resume();
                      reject(error);
                    ...
                    var outFile = fs.createWriteStream(tmpFilename);
  ...
  qx.tool.utils.Http.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Http.js.map?dt=1731948132190