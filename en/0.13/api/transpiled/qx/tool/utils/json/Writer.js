  ...
  qx.Class.define("qx.tool.utils.json.Writer", {
    ...
    members: {
      ...
      write: function write(str) {
        ...
        while (true) {
          ...
          if (pos > -1) {
            ...
            this.__P_530_2 = this.buffer.length;
            this.buffer += this.__P_530_1;
            startPos = pos + 1;
          } else {
      ...
      indent: function indent(count) {
        if (this.__P_530_0 + count < 0) {
          throw new Error("Unbalanced indent");
        }
        this.__P_530_0 += count;
        var indentStr = this.__P_530_1;
        if (count > 0) {
          var str = "";
        ...
        var line = this.buffer.substring(this.__P_530_2);
        if (!line.match(/[^\s]/)) {
          this.buffer = this.buffer.substring(0, this.__P_530_2) + indentStr;
        }
        this.__P_530_1 = indentStr;
        return this;
      },
      /**
      ...
      matchIndent: function matchIndent() {
        ...
        var m = line.match(/^([\s]*)/);
        var indent = m[0];
        var oldIndent = this.__P_530_1;
        this.__P_530_1 = indent;
        return oldIndent;
      },
      /**
...
//# sourceMappingURL=Writer.js.map?dt=1778272846009