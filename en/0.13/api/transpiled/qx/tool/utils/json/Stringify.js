...
(function () {
  ...
  qx.Class.define("qx.tool.utils.json.Stringify", {
    ...
    statics: {
       ...
       */
      prettyPrint: function prettyPrint(ast) {
       ...
       * @return {String}
       */
      reprint: function reprint(object, ast) {
        var writer = new qx.tool.utils.json.Writer();
        if (!ast) {
          prettyPojo(object);
          return writer.buffer;
       ...
       */
      astToObject: function astToObject(ast, settings) {
        function writeNode(node) {
          var result;
          switch (node.type) {
            case "object":
       ...
       */
      isSameLiteral: function isSameLiteral(node, object) {
        ...
        if (_typeof(node.value) !== _typeof(object)) {
          return false;
        }
...
//# sourceMappingURL=Stringify.js.map?dt=1735222442331