...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.MetaLoader", {
    ...
    construct: function construct(manager) {
      qx.tool.compiler.resources.ResourceLoader.constructor.call(this, ".meta", manager);
    },
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return qx.tool.utils.Json.loadJsonAsync(asset.getSourceFilename());
              case 2:
                asset.getFileInfo().meta = _context.sent;
              case 3:
              case "end":
...
//# sourceMappingURL=MetaLoader.js.map?dt=1731948129850