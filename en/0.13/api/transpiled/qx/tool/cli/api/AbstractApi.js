  ...
  qx.Class.define("qx.tool.cli.api.AbstractApi", {
    ...
    members: {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", _this.getConfiguration());
              case 1:
              case "end":
      ...
      require: function (_require) {
        ...
        var mod = path.join(process.cwd(), "node_modules");
        if (!fs.existsSync(mod)) {
          fs.mkdirSync(mod);
        }
        mod = path.join(mod, module);
        var exists = fs.existsSync(mod);
        if (!exists) {
       ...
       */
      loadNpmModule: function loadNpmModule(module) {
        ...
        var s = "npm install --no-package-lock ".concat(module);
...
//# sourceMappingURL=AbstractApi.js.map?dt=1722151841645