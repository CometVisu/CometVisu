    ...
    members: {
      ...
      process: function process() {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var runner, _yield$runner$runMigr, applied, pending;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                runner = new qx.tool.migration.Runner().set({
                  dryRun: Boolean(_this.argv.dryRun),
                  verbose: Boolean(_this.argv.verbose),
                  qxVersion: _this.argv.qxVersion || null
                });
                _context.next = 3;
                return runner.runMigrations();
              case 3:
                _yield$runner$runMigr = _context.sent;
                applied = _yield$runner$runMigr.applied;
                pending = _yield$runner$runMigr.pending;
                qx.tool.compiler.Console.info("Finished ".concat(_this.argv.dryRun ? "checking" : "running", " migrations: ").concat(applied, " migrations applied, ").concat(pending, " migrations pending."));
              case 7:
              case "end":
...
//# sourceMappingURL=Migrate.js.map?dt=1731948126128