        ...
        return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return qx.tool.cli.commands.config.Set.superclass.prototype.process.call(_this);
              case 2:
                _this._checkKey(_this.argv);
                _context.next = 5;
                return qx.tool.cli.ConfigDb.getInstance();
              case 5:
                cfg = _context.sent;
                setting = qx.tool.cli.commands.Config.KNOWN_VALUES[_this.argv.key];
                value = _this.argv.value;
              ...
              case 11:
                value = _context.sent;
              case 12:
                keyInfo = _this._breakout(_this.argv.key);
                parent = cfg.db(keyInfo.parentKey, {});
                if (value === undefined) {
...
//# sourceMappingURL=Set.js.map?dt=1735341787052