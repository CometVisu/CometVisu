        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return qx.tool.cli.commands.config.Get.superclass.prototype.process.call(_this);
              case 2:
              ...
              case 5:
                cfg = _context.sent;
                value = cfg.db(_this.argv.key);
                if (_this.argv.bare) {
                  qx.tool.compiler.Console.info(value || "");
                } else if (value !== undefined) {
                  qx.tool.compiler.Console.info(_this.argv.key + "=" + value);
                } else {
                  qx.tool.compiler.Console.info(_this.argv.key + " is not set");
                }
              case 8:
              case "end":
...
//# sourceMappingURL=Get.js.map?dt=1722151843600