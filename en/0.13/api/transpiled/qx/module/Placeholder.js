  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Placeholder", {
    statics: {
       ...
       */
      __P_267_0: function __P_267_0(item) {
       ...
       */
      __P_267_1: function __P_267_1(item) {
      ...
      updatePlaceholder: function updatePlaceholder() {
        ...
        if (!qxWeb.env.get("css.placeholder")) {
          for (var i = 0; i < this.length; i++) {
            ...
            if (!placeholderEl) {
              placeholderEl = qx.module.Placeholder.__P_267_1(item);
            ...
            qx.module.Placeholder.__P_267_0(item);
          }
...
//# sourceMappingURL=Placeholder.js.map?dt=1664557348756