  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Placeholder", {
    statics: {
       ...
       */
      __P_301_0: function __P_301_0(item) {
       ...
       */
      __P_301_1: function __P_301_1(item) {
      ...
      updatePlaceholder: function updatePlaceholder() {
        ...
        if (!qxWeb.env.get("css.placeholder")) {
          for (var i = 0; i < this.length; i++) {
            ...
            var placeholderEl = item.getProperty(qx.module.Placeholder.PLACEHOLDER_NAME);
            if (!placeholderEl) {
              placeholderEl = qx.module.Placeholder.__P_301_1(item);
            }
            ...
            qx.module.Placeholder.__P_301_0(item);
          }
        }
        return this;
      }
...
//# sourceMappingURL=Placeholder.js.map?dt=1778272828410