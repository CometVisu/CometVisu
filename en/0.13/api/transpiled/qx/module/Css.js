  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__P_288_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__P_288_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight: function _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__P_288_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth: function _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__P_288_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __P_288_2: function __P_288_2(tagName, doc) {
        var defaults = qx.module.Css.__P_288_1;
        if (!defaults[tagName]) {
       ...
       */
      __P_288_0: function __P_288_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__P_288_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=Css.js.map?dt=1722153822144