  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.TextSelection", {
    statics: {
       ...
       * @attach {qxWeb}
       */
      __P_295_0: function __P_295_0(el) {
       ...
       * @attach {qxWeb}
       */
      __P_295_1: function __P_295_1(el) {
    ...
    members: {
      ...
      getTextSelection: function getTextSelection() {
        var el = this[0];
        if (el) {
          if (!qx.module.TextSelection.__P_295_0(el)) {
            el = qx.module.TextSelection.__P_295_1(el);
          }
...
//# sourceMappingURL=TextSelection.js.map?dt=1735222424501