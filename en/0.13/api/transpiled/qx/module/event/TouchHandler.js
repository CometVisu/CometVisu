  ...
  qx.Bootstrap.define("qx.module.event.TouchHandler", {
    statics: {
      ...
      register: function register(element) {
        if (!element.__P_299_0) {
          if (!element.$$emitter) {
            element.$$emitter = new qx.event.Emitter();
          }
          element.__P_299_0 = new qx.event.handler.TouchCore(element, element.$$emitter);
        }
      },
      /**
...
//# sourceMappingURL=TouchHandler.js.map?dt=1735222424763