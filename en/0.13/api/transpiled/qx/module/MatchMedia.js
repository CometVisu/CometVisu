  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.MatchMedia", {
    statics: {
       ...
       */
      __P_290_0: function __P_290_0(query, className) {
        if (query.isMatching()) {
    ...
    members: {
      ...
      mediaQueryToClass: function mediaQueryToClass(queryString, className) {
        ...
        var callback = qx.module.MatchMedia.__P_290_0.bind(this, query, className);
...
//# sourceMappingURL=MatchMedia.js.map?dt=1705596673568