  ...
  qx.Class.define("qx.Promise", {
    ...
    construct: function construct(fn, context) {
      ...
      if (fn instanceof qx.Promise.Impl) {
        ...
        this.__P_111_1 = new qx.Promise.Impl(fn);
      } else {
        this.__P_111_1 = new qx.Promise.Impl(this.__P_111_2.bind(this));
      }
      qx.core.Assert.assertTrue(!this.__P_111_1.$$qxPromise);
      this.__P_111_1.$$qxPromise = this;
      if (context !== undefined && context !== null) {
        this.__P_111_1 = this.__P_111_1.bind(context);
      }
    },
    /**
     * Destructor
    ...
    destruct: function destruct() {
      delete this.__P_111_1.$$qxPromise;
      delete this.__P_111_1;
    },
    members: {
      /** The Promise */
      __P_111_1: null,
      ...
      bind: function bind(context) {
        return qx.Promise.__P_111_5(this.__P_111_1.bind(context));
      },
      /**
       ...
       * @return {qx.Promise}
       */
      mapSeries: function mapSeries(iterator) {
       ...
       */
      __P_111_2: function __P_111_2(resolve, reject) {
        this.__P_111_3 = {
          resolve: resolve,
          reject: reject,
          complete: false
      ...
      _callIterableMethod: function _callIterableMethod(methodName, args) {
        args = qx.Promise.__P_111_7(args);
        return qx.Promise.__P_111_5(this.__P_111_1.then(function (value) {
          var newP = qx.Promise.Impl.resolve(value instanceof qx.data.Array ? value.toArray() : value);
          return qx.Promise.__P_111_5(newP[methodName].apply(newP, args));
        }));
      },
      /**
      ...
      _callMethod: function _callMethod(methodName, args) {
        args = qx.Promise.__P_111_7(args);
        return qx.Promise.__P_111_5(this.__P_111_1[methodName].apply(this.__P_111_1, args));
      },
      /**
    ...
    statics: {
       ...
       */
      __P_111_8: new Error("Default Error"),
      /* *********************************************************************************
       *
       * Promise API methods
       *
      ...
      resolve: function resolve(value, context) {
        ...
        if (value instanceof qx.Promise) {
          ...
          promise = qx.Promise.__P_111_5(qx.Promise.Impl.resolve(value));
        }
      ...
      reject: function reject(reason, context) {
        ...
        if (reason === undefined) {
          args.shift();
          args.unshift(qx.Promise.__P_111_8);
        } else if (!(reason instanceof Error)) {
          qx.log.Logger.warn("Rejecting a promise with a non-Error value");
        }
        var promise = qx.Promise.__P_111_9("reject", args, 0);
        if (context !== undefined) {
          promise = promise.bind(context);
        }
        return promise;
      ...
      all: function all(iterable) {
        return qx.Promise.__P_111_9("all", arguments);
      },
      /**
       ...
       */
      race: function race(iterable) {
        return qx.Promise.__P_111_9("race", arguments);
      },
      /* *********************************************************************************
       *
       ...
       */
      any: function any(iterable) {
        return qx.Promise.__P_111_9("any", arguments);
      },
      /**
       ...
       */
      some: function some(iterable, count) {
        return qx.Promise.__P_111_9("some", arguments);
      },
      /**
      ...
      forEach: function forEach(iterable, iterator) {
        return qx.Promise.__P_111_9("each", arguments);
      },
      /**
      ...
      filter: function filter(iterable, iterator, options) {
        return qx.Promise.__P_111_9("filter", arguments);
      },
      /**
      ...
      map: function map(iterable, iterator, options) {
        return qx.Promise.__P_111_9("map", arguments);
      },
      /**
       * Given an <code>Iterable</code>(arrays are <code>Iterable</code>), or a promise of an
       * <code>Iterable</code>, which produces promises (or a mix of promises and values), iterate over
      ...
      mapSeries: function mapSeries(iterable, iterator) {
        return qx.Promise.__P_111_9("mapSeries", arguments);
      },
      /**
       * Given an <code>Iterable</code> (arrays are <code>Iterable</code>), or a promise of an
      ...
      reduce: function reduce(iterable, reducer, initialValue) {
        return qx.Promise.__P_111_9("reduce", arguments);
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          return qx.Promise.__P_111_5(wrappedCb.apply(this, arguments));
        };
      },
      /**
      ...
      props: function props(input) {
        return qx.Promise.__P_111_9("props", arguments);
      },
      /**
       ...
       * @return {qx.Promise}
       */
      promisify: function promisify(f) {
        return function () {
          var _this = this;
          ...
          return new qx.Promise(function (resolve, reject) {
            ...
            args.push(callback);
            f.call.apply(f, [_this].concat(args));
          });
        };
      },
      /* *********************************************************************************
       ...
       */
      __P_111_0: function __P_111_0() {
        if (qx.Promise.__P_111_10) {
          return;
        }
        qx.Promise.__P_111_10 = true;
        var isNode = typeof process !== "undefined";
        if (isNode) {
          process.on("unhandledRejection", qx.Promise.__P_111_11.bind(this));
        } else {
          qx.bom.Event.addNativeListener(window, "unhandledrejection", qx.Promise.__P_111_11.bind(this));
        }
      },
      /**
       ...
       * @param e {NativeEvent}
       */
      __P_111_11: function __P_111_11(e) {
       ...
       * @return {Object}
       */
      __P_111_5: function __P_111_5(value) {
       ...
       */
      __P_111_7: function __P_111_7(args, minArgs) {
       ...
       * @return {Object?}
       */
      __P_111_9: function __P_111_9(methodName, args, minArgs) {
        args = qx.Promise.__P_111_7(args, minArgs);
        return qx.Promise.__P_111_5(qx.Promise.Impl[methodName].apply(qx.Promise.Impl, qx.Promise.__P_111_12(args)));
      },
      /**
       ...
       */
      __P_111_12: function __P_111_12(args) {
        var dest = [];
...
//# sourceMappingURL=Promise.js.map?dt=1782595050814