  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_91_3: function __P_91_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_91_4: function __P_91_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      */
       ...
       */
      __P_91_2: qx.core.Environment.select("qx.debug", {
       ...
       */
      __P_91_6: qx.core.Environment.select("qx.debug", {
...
//# sourceMappingURL=Interface.js.map?dt=1677362721988