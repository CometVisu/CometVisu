  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.WebWorker", {
    ...
    construct: function construct(src) {
      ...
      this.__P_118_0 = qx.core.Environment.get("html.webworker");
      this.__P_118_0 ? this.__P_118_1(src) : this.__P_118_2(src);
    },
    events: {
    ...
    members: {
       ...
       * @param src {String} The path to worker as an URL
       */
      __P_118_1: function __P_118_1(src) {
      ...
      postMessage: function postMessage(msg) {
        ...
        if (this.__P_118_0) {
          ...
          setTimeout(function () {
            try {
              that.__P_118_3.onmessage && that.__P_118_3.onmessage({
                data: msg
              });
            } catch (ex) {
...
//# sourceMappingURL=WebWorker.js.map?dt=1677017688631