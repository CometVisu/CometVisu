  ...
  qx.Bootstrap.define("qx.bom.storage.Memory", {
    statics: {
      ...
      getLocal: function getLocal() {
        ...
        return this.__P_166_0 = new qx.bom.storage.Memory();
      },
      /**
       * Returns an instance of {@link qx.bom.storage.Memory} which is of course
       * not persisted on reload.
      ...
      getSession: function getSession() {
        ...
        return this.__P_166_1 = new qx.bom.storage.Memory();
      }
    },
    ...
    members: {
      ...
      getLength: function getLength() {
        return Object.keys(this.__P_166_2).length;
      },
      /**
      ...
      getKey: function getKey(index) {
        var keys = Object.keys(this.__P_166_2);
        return keys[index];
      },
      /**
...
//# sourceMappingURL=Memory.js.map?dt=1782595052859