  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Location", {
    statics: {
       ...
       */
      __P_140_3: qx.core.Environment.select("engine.name", {
        ...
        if (mode) {
          ...
          switch (mode) {
            case "padding":
              ...
              top += this.__P_140_1(elem, "paddingTop");
              right -= this.__P_140_1(elem, "paddingRight");
              bottom -= this.__P_140_1(elem, "paddingBottom");
            // no break here
            ...
            case "border":
              left += this.__P_140_1(elem, "borderLeftWidth");
              top += this.__P_140_1(elem, "borderTopWidth");
            ...
            case "margin":
              ...
              right += this.__P_140_1(elem, "marginRight");
              bottom += this.__P_140_1(elem, "marginBottom");
              break;
          }
        }
        return {
       ...
       */
      __P_140_5: function __P_140_5(body) {
        var top = body.offsetTop;
        var left = body.offsetLeft;
...
//# sourceMappingURL=Location.js.map?dt=1677017690435