  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.FileReader", {
    ...
    statics: {
       ...
       */
      getFile: function getFile(inputElement, index) {
    ...
    members: {
       ...
       */
      _handleLoadStart: function _handleLoadStart(e) {
       ...
       *   - total {Number} The length of the entire body being transferred
       */
      _handleProgress: function _handleProgress(e) {
       ...
       *   - total {Number} The length of the entire body being transferred
       */
      _handleAbort: function _handleAbort(e) {
       ...
       *   - total {Number} The length of the entire body being transferred
       */
      _handleLoadEnd: function _handleLoadEnd(e) {
...
//# sourceMappingURL=FileReader.js.map?dt=1643469606138