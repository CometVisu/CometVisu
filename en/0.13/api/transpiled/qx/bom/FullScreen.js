  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.FullScreen", {
    ...
    construct: function construct(element) {
      this.__P_110_0 = element || window.document;
      this.__P_110_1();
      var self = this;
      // forward the event
      qx.bom.Event.addNativeListener(this.__P_110_0, this.__P_110_2, function (e) {
        self.emit("change", e);
      });
    },
    events: {
    ...
    members: {
      __P_110_0: null,
      __P_110_3: "fullscreenElement",
      __P_110_4: "requestFullscreen",
      __P_110_5: "cancelFullscreen",
      __P_110_2: "fullscreenchange",
      /**
       ...
       */
      __P_110_1: function __P_110_1() {
        var prefix = qx.bom.Style.VENDOR_PREFIXES;

        // check for the hidden attribute name
        for (var i = 0; i < prefix.length; i++) {
          var pfix = prefix[i].toLowerCase();
          if (this.__P_110_0[pfix + "FullScreenElement"] !== undefined || this.__P_110_0[pfix + "FullscreenElement"] !== undefined) {
            this.__P_110_2 = pfix + "fullscreenchange";
            if (pfix == "moz") {
              this.__P_110_3 = pfix + "FullScreenElement";
              this.__P_110_4 = pfix + "RequestFullScreen";
            } else {
              this.__P_110_3 = pfix + "FullscreenElement";
              this.__P_110_4 = pfix + "RequestFullscreen";
            }
        ...
        if (this.__P_110_0[pfix + "CancelFullScreen"]) {
          this.__P_110_5 = pfix + "CancelFullScreen";
        } else if (this.__P_110_0[pfix + "CancelFullscreen"]) {
          this.__P_110_5 = pfix + "CancelFullscreen";
        } else if (this.__P_110_0[pfix + "ExitFullScreen"]) {
          this.__P_110_5 = pfix + "ExitFullScreen";
        } else if (this.__P_110_0[pfix + "ExitFullscreen"]) {
          this.__P_110_5 = pfix + "ExitFullscreen";
        } else if (this.__P_110_0["exitFullscreen"]) {
          this.__P_110_5 = "exitFullscreen";
        }
      },
      /**
      ...
      isFullScreen: function isFullScreen() {
        return this.__P_110_0[this.__P_110_3] !== undefined ? !!this.__P_110_0[this.__P_110_3] : false;
      },
      /**
      ...
      request: function request() {
        if (this.__P_110_0.documentElement[this.__P_110_4]) {
          this.__P_110_0.documentElement[this.__P_110_4]();
        }
      },
      /**
      ...
      cancel: function cancel() {
        if (this.__P_110_0[this.__P_110_5]) {
          this.__P_110_0[this.__P_110_5]();
        }
      }
    }
  });
...
//# sourceMappingURL=FullScreen.js.map?dt=1705596661657