  ...
  qx.Bootstrap.define("qx.bom.Style", {
    ...
    defer: function defer(statics) {
      if (window.CSS && window.CSS.supports) {
        qx.bom.Style.__P_116_1 = window.CSS.supports.bind(window.CSS);
      } else if (window.supportsCSS) {
        qx.bom.Style.__P_116_1 = window.supportsCSS.bind(window);
      }
    }
  });
...
//# sourceMappingURL=Style.js.map?dt=1692560698209