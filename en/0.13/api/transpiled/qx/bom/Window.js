  ...
  qx.Class.define("qx.bom.Window", {
    statics: {
      ...
      open: function open(url, name, options, modal, useNativeModalDialog, listener, self) {
        ...
        var configurationString = this.__P_136_6(options, modal && useNativeModalDialog);
        if (modal) {
          if (this.__P_136_5() && useNativeModalDialog) {
            newWindow = window.showModalDialog(url, [window.self], configurationString);
          } else {
            this.getBlocker().block();
            if (this.__P_136_2 == null) {
              this.__P_136_2 = new qx.event.Timer(500);
              this.__P_136_2.addListener("interval", this.__P_136_7, this);
            }
            this.__P_136_1 = window.open(url, name, configurationString);
            this.__P_136_2.restart();
            newWindow = this.__P_136_1;
          }
        } else {
       ...
       */
      __P_136_6: function __P_136_6(options, modality) {
        var configurationString;
        var value;
        var configuration = [];
        if (modality && this.__P_136_5()) {
          for (var key in options) {
            if (qx.bom.Window.__P_136_3[key]) {
              var suffix = "";
              if (key != "scrollbars" && key != "resizable") {
                suffix = "px";
              }
              value = qx.bom.Window.__P_136_3[key] + ":" + options[key] + suffix;
          ...
          for (var key in options) {
            if (qx.bom.Window.__P_136_4[key]) {
       ...
       */
      __P_136_7: function __P_136_7() {
        if (this.isClosed(this.__P_136_1)) {
      ...
      getBlocker: function getBlocker() {
        if (this.__P_136_0 == null) {
          this.__P_136_0 = new qx.bom.Blocker();
        }
...
//# sourceMappingURL=Window.js.map?dt=1778272819334