  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Pdfjs", {
    statics: {
      ...
      getPdfjs: function getPdfjs(callback, context) {
        qx.bom.client.Pdfjs.__P_124_0(callback, context);
      },
  ...
  (function () {
    ...
    var PluginDetect = {
      ...
      ev: {
        $: 1,
        handler: function handler(d, c, b, a) {
          return function () {
            d(c, b, a);
          };
        },
        ...
        callArray: function callArray(a) {
          var b = this;
          b.callArray0(a);
      ...
      DOM: {
        ...
        isEnabled: {
          $: 1,
          objectTag: function objectTag() {
            var a = this.$;
            return a.browser.isIE ? a.browser.ActiveXEnabled : 1;
          },
          objectTagUsingActiveX: function objectTagUsingActiveX() {
      ...
      file: {
        ...
        getValidLength: function getValidLength(a) {
          return a && a[this.valid] ? a[this.valid].length : 0;
        },
        getAnyLength: function getAnyLength(a) {
          return a && a[this.any] ? a[this.any].length : 0;
        },
        getValid: function getValid(c, a) {
          var b = this;
          return c && c[b.valid] ? b.get(c[b.valid], a) : null;
        },
        getAny: function getAny(c, a) {
          var b = this;
    ...
    qx.bom.client.Pdfjs.__P_124_1 = function () {
...
//# sourceMappingURL=Pdfjs.js.map?dt=1664548972309