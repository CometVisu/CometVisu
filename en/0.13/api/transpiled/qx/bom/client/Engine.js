  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_140_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_140_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_140_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_140_3()) {
...
//# sourceMappingURL=Engine.js.map?dt=1778272819507