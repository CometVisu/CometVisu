    ...
    */
    members: {
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                (_this.getCss() || []).forEach(function (url) {
                  ...
                  qx.bom.webfonts.WebFontLoader.__P_154_2(url);
                });
                ...
                if (fontFaces) {
                  ...
                  _this.__P_154_0 = qx.lang.Array.clone(fontFaces);
                  _this.__P_154_1 = new qx.Promise();
                }
      ...
      __P_154_3: function __P_154_3() {
        ...
        var fontFace = this.__P_154_0.pop();

        this.__P_154_4(fontFace);

        if (this.__P_154_0.length == 0) {
          this.__P_154_0 = null;

          this.__P_154_1.resolve(true);
        }
       ...
       * @returns
       */
      __P_154_4: function __P_154_4(fontFace) {
        ...
        if (qx.bom.webfonts.WebFontLoader.__P_154_5[fontLookupKey]) {
          return;
        }

        if (!qx.bom.webfonts.WebFontLoader.__P_154_6) {
          var _styleSheet = qx.bom.Stylesheet.createElement();

          qx.bom.webfonts.WebFontLoader.__P_154_6 = _styleSheet;
        }
        ...
        for (var _i2 = 0; _i2 < fontFaceSrcRules.length; _i2++) {
          strSources += "src: url('" + fontFaceSrcRules[_i2].url + "')";

          if (_i2 > 0) {
            strSources += " format('" + fontFaceSrcRules[_i2].format + "')";
          }
        ...
        rule = "@font-face {\n" + rule + "}\n";
        var styleSheet = qx.bom.webfonts.WebFontLoader.__P_154_6;

        try {
          if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
            var cssText = qx.bom.webfonts.WebFontLoader.__P_154_7(styleSheet.cssText);
        ...
        qx.bom.webfonts.WebFontLoader.__P_154_5[fontLookupKey] = true;
      },
      // property apply
    ...
    statics: {
      ...
      getLoader: function getLoader(name, create) {
        var loader = qx.bom.webfonts.WebFontLoader.__P_154_10[name];

        if (!loader && create) {
          loader = qx.bom.webfonts.WebFontLoader.__P_154_10[name] = new qx.bom.webfonts.WebFontLoader(name);
        }
       ...
       * @param {String} url
       */
      __P_154_2: function __P_154_2(url) {
        if (qx.bom.webfonts.WebFontLoader.__P_154_9[url]) {
          return;
        }

        qx.bom.Stylesheet.includeFile(url);
        qx.bom.webfonts.WebFontLoader.__P_154_9[url] = true;
      },
       ...
       */
      __P_154_11: function __P_154_11(sources) {
      ...
      getPreferredFormats: function getPreferredFormats() {
        if (qx.bom.webfonts.WebFontLoader.__P_154_8) {
          return qx.bom.webfonts.WebFontLoader.__P_154_8;
        }
        ...
        return qx.bom.webfonts.WebFontLoader.__P_154_8 = preferredFormats;
      },
       ...
       */
      __P_154_7: function __P_154_7(cssText) {
...
//# sourceMappingURL=WebFontLoader.js.map?dt=1685978112314