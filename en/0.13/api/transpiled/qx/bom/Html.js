  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    statics: {
       ...
       */
      __P_101_0: function __P_101_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_101_0);
      },
       ...
       */
      __P_101_2: function __P_101_2(html, context) {
      ...
      clean: function clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__P_101_2(obj, context);
...
//# sourceMappingURL=Html.js.map?dt=1664609795638