  ...
  qx.Class.define("qx.bom.Shortcut", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_114_2: function __P_114_2(event) {
        if (this.getEnabled() && this.__P_114_3(event)) {
       ...
       * @param event {qx.event.type.KeySequence} The key event object
       */
      __P_114_4: function __P_114_4(event) {
        if (this.getEnabled() && this.__P_114_3(event)) {
          if (this.isAutoRepeat()) {
            this.execute(event.getTarget());
          }
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (value) {
          qx.event.Registration.addListener(document.documentElement, "keydown", this.__P_114_2, this);
          qx.event.Registration.addListener(document.documentElement, "keypress", this.__P_114_4, this);
        } else {
          qx.event.Registration.removeListener(document.documentElement, "keydown", this.__P_114_2, this);
          qx.event.Registration.removeListener(document.documentElement, "keypress", this.__P_114_4, this);
        }
      },
      // property apply
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_114_0 = this.__P_114_1 = null;
    }
  });
  qx.bom.Shortcut.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Shortcut.js.map?dt=1676809304426