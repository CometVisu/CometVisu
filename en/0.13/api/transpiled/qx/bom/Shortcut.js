  ...
  qx.Class.define("qx.bom.Shortcut", {
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_91_2: function __P_91_2(event) {
        if (this.getEnabled() && this.__P_91_3(event)) {
       ...
       * @param event {qx.event.type.KeySequence} The key event object
       */
      __P_91_4: function __P_91_4(event) {
        if (this.getEnabled() && this.__P_91_3(event)) {
          if (this.isAutoRepeat()) {
            this.execute(event.getTarget());
          }
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (value) {
          qx.event.Registration.addListener(document.documentElement, "keydown", this.__P_91_2, this);
          qx.event.Registration.addListener(document.documentElement, "keypress", this.__P_91_4, this);
        } else {
          qx.event.Registration.removeListener(document.documentElement, "keydown", this.__P_91_2, this);
          qx.event.Registration.removeListener(document.documentElement, "keypress", this.__P_91_4, this);
        }
      },
      // property apply
      _applyShortcut: function _applyShortcut(value, old) {
        if (value) {
          ...
          this.__P_91_1 = null; // To support shortcuts with "+" and "-" as keys it is necessary
          ...
          for (var i = 0; i < al; i++) {
            var identifier = this.__P_91_5(a[i]);
      ...
      */
       ...
       */
      __P_91_3: function __P_91_3(e) {
        var key = this.__P_91_1;
        ...
        if (!this.__P_91_0.Shift && e.isShiftPressed() || this.__P_91_0.Shift && !e.isShiftPressed() || !this.__P_91_0.Control && e.isCtrlPressed() || this.__P_91_0.Control && !e.isCtrlPressed() || !this.__P_91_0.Meta && e.isMetaPressed() || this.__P_91_0.Meta && !e.isMetaPressed() || !this.__P_91_0.Alt && e.isAltPressed() || this.__P_91_0.Alt && !e.isAltPressed()) {
          return false;
        }
      ...
      */
       ...
       */
      __P_91_5: function __P_91_5(keyName) {
        ...
        var keyIdentifier = this.__P_91_6[keyName] || qx.lang.String.firstUp(keyName);
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_91_0 = this.__P_91_1 = null;
    }
  });
  qx.bom.Shortcut.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Shortcut.js.map?dt=1646073033360