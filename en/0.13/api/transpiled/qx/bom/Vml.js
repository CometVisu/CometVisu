  ...
  qx.Class.define("qx.bom.Vml", {
    ...
    */
    statics: {
       ...
       */
      createImage: function createImage(source, width, height, xOffset, yOffset, imageWidth, imageHeight) {
       ...
       *     is required, when an yOffset is given.
       */
      updateImage: function updateImage(image, source, width, height, xOffset, yOffset, imageWidth, imageHeight) {
...
//# sourceMappingURL=Vml.js.map?dt=1664788503002