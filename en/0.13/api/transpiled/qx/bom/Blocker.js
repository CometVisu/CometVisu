    ...
    members: {
      ...
      */
      ...
      block: function block(element) {
        if (!this.__P_109_4) {
          qx.event.Registration.addListener(window, "resize", this.__P_109_8, this);
          this.__P_109_3 = element;
          var styles = this.__P_109_9();
          this.__P_109_10(styles);
          this.__P_109_4 = true;
        }
      },
      /**
      ...
      unblock: function unblock() {
        if (this.__P_109_4) {
          this.__P_109_11();
          qx.event.Registration.removeListener(window, "resize", this.__P_109_8, this);
          this.__P_109_4 = false;
        }
      },
      /**
      ...
      setBlockerColor: function setBlockerColor(color) {
        qx.bom.element.Style.set(this.__P_109_2, "backgroundColor", color);
      },
      /**
      ...
      getBlockerColor: function getBlockerColor() {
        return qx.bom.element.Style.get(this.__P_109_2, "backgroundColor");
      },
      /**
      ...
      setBlockerOpacity: function setBlockerOpacity(opacity) {
        qx.bom.element.Opacity.set(this.__P_109_2, opacity);
      },
      /**
      ...
      getBlockerOpacity: function getBlockerOpacity() {
        return qx.bom.element.Opacity.get(this.__P_109_2);
      },
      /**
      ...
      setBlockerZIndex: function setBlockerZIndex(zIndex) {
        qx.bom.element.Style.set(this.__P_109_2, "zIndex", zIndex);
      },
      /**
      ...
      getBlockerZIndex: function getBlockerZIndex() {
        return qx.bom.element.Style.get(this.__P_109_2, "zIndex");
      },
      /*
      ---------------------------------------------------------------------------
        PRIVATE API
      ...
      */
       ...
       */
      __P_109_12: function __P_109_12() {
        this.__P_109_2 = qx.dom.Element.create("div");
        qx.bom.element.Style.setStyles(this.__P_109_2, {
          display: "block",
          opacity: this.__P_109_6,
          backgroundColor: this.__P_109_7
        });
        this.setBlockerZIndex(this.__P_109_5);
      },
      /**
       ...
       */
      __P_109_13: function __P_109_13() {
        this.__P_109_1 = qx.bom.Iframe.create();
        qx.bom.element.Attribute.set(this.__P_109_1, "allowTransparency", false);

        /* eslint-disable no-script-url */
        qx.bom.element.Attribute.set(this.__P_109_1, "src", "javascript:false;");

        /* eslint-enable no-script-url */
        qx.bom.element.Style.setStyles(this.__P_109_1, {
          display: "block",
          opacity: this.__P_109_6
        });
      },
      ...
      __P_109_9: function __P_109_9() {
        ...
        if (this.__P_109_14()) {
          ...
          styles.width = qx.bom.element.Dimension.getWidth(this.__P_109_3) + "px";
          styles.height = qx.bom.element.Dimension.getHeight(this.__P_109_3) + "px";
          styles.left = qx.bom.element.Location.getLeft(this.__P_109_3) + "px";
          styles.top = qx.bom.element.Location.getTop(this.__P_109_3) + "px";
        }
        return styles;
      },
      /**
       ...
       */
      __P_109_10: function __P_109_10(styles) {
        var target = document.body;
        qx.bom.element.Style.setStyles(this.__P_109_2, styles);
        qx.dom.Element.insertEnd(this.__P_109_2, target);
        if (qx.core.Environment.get("engine.name") == "mshtml") {
          styles.zIndex = this.getBlockerZIndex() - 1;
          qx.bom.element.Style.setStyles(this.__P_109_1, styles);
          qx.dom.Element.insertEnd(this.__P_109_1, document.body);
        }
      },
      /**
       * Remove the blocker elements.
       */
      __P_109_11: function __P_109_11() {
        qx.dom.Element.remove(this.__P_109_2);
        if (qx.core.Environment.get("engine.name") == "mshtml") {
          qx.dom.Element.remove(this.__P_109_1);
        }
      },
      /**
       ...
       */
      __P_109_8: function __P_109_8(e) {
        if (this.__P_109_14()) {
       ...
       */
      __P_109_15: function __P_109_15(dimension) {
        qx.bom.element.Style.setStyles(this.__P_109_2, dimension);
        if (qx.core.Environment.get("engine.name") == "mshtml") {
          qx.bom.element.Style.setStyles(this.__P_109_1, dimension);
        }
      },
      /**
       ...
       */
      __P_109_14: function __P_109_14() {
        return this.__P_109_3 == null || qx.dom.Node.isWindow(this.__P_109_3) || qx.dom.Node.isDocument(this.__P_109_3);
      }
    }
  });
...
//# sourceMappingURL=Blocker.js.map?dt=1735341764001