  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        this.__P_153_4 = false;
        callbackParam = this.__P_153_2 || "callback";
        callbackName = this.__P_153_3 || this.__P_153_8 + "qx.bom.request.Jsonp." + this.__P_153_1 + ".callback";

        // Default callback
        if (!this.__P_153_3) {
          // Store globally available reference to this object
          this.constructor[this.__P_153_1] = this;
          ...
          // callback method.
          if (!window[this.__P_153_3]) {
            this.__P_153_5 = true;
            window[this.__P_153_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__P_153_3 + " already exists");
            }
          }
        }
        if (qx.core.Environment.get("qx.debug.io")) {
        ...
        this.__P_153_6 = url = qx.util.Uri.appendParamsToUrl(url, query);
        this.__P_153_9("open", [method, url]);
      },
      /**
      ...
      callback: function callback(data) {
        ...
        this.constructor[this.__P_153_1] = undefined;
        this.__P_153_10();
      },
      /**
      ...
      getGeneratedUrl: function getGeneratedUrl() {
        return this.__P_153_6;
      },
      dispose: function dispose() {
        // In case callback was not called
        this.__P_153_10();
        this.__P_153_9("dispose");
      },
      /**
       * Handle native load.
       */
      _onNativeLoad: function _onNativeLoad() {
        ...
        this.status = this.__P_153_4 ? 200 : 500;
        this.__P_153_9("_onNativeLoad");
      },
      /**
       *  Delete custom callback if dynamically created before.
       */
      __P_153_10: function __P_153_10() {
        if (this.__P_153_5 && window[this.__P_153_3]) {
          window[this.__P_153_3] = undefined;
          this.__P_153_5 = false;
        }
      },
      /**
       ...
       */
      __P_153_9: function __P_153_9(method, args) {
      ...
      __P_153_0: function __P_153_0() {
        ...
        this.__P_153_1 = "qx" + new Date().valueOf() + ("" + Math.random()).substring(2, 5);
      }
    }
  });
...
//# sourceMappingURL=Jsonp.js.map?dt=1735383849040