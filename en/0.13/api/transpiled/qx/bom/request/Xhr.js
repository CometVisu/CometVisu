  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct: function construct() {
      var boundFunc = qx.Bootstrap.bind(this.__P_156_0, this);
      ...
      if (qx.event && qx.event.GlobalError && qx.event.GlobalError.observeMethod) {
        this.__P_156_1 = qx.event.GlobalError.observeMethod(boundFunc);
      } else {
        this.__P_156_1 = boundFunc;
      }
      this.__P_156_2 = qx.Bootstrap.bind(this.__P_156_3, this);
      this.__P_156_4 = qx.Bootstrap.bind(this.__P_156_5, this);
      this.__P_156_6 = qx.Bootstrap.bind(this.__P_156_7, this);
      this.__P_156_8();
      ...
      if (window.attachEvent) {
        this.__P_156_9 = qx.Bootstrap.bind(this.__P_156_10, this);
        window.attachEvent("onunload", this.__P_156_9);
      }
    },
    statics: {
      UNSENT: 0,
    ...
    members: {
      ...
      */
      ...
      open: function open(method, url, async, user, password) {
        ...
        this.__P_156_12 = false;
        this.__P_156_13 = false;
        this.__P_156_14 = false;
        ...
        if (!this.__P_156_17() && this.readyState > qx.bom.request.Xhr.UNSENT) {
        ...
        try {
          ...
          if (this.__P_156_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__P_156_18 = new window.XDomainRequest();
              this.__P_156_18.onerror = qx.Bootstrap.bind(function () {
        ...
        if (qx.core.Environment.get("engine.name") === "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && this.__P_156_18.readyState > 0) {
          this.__P_156_18.setRequestHeader("If-Modified-Since", "-1");
        }

        // BUGFIX: Firefox
        // Firefox < 4 fails to trigger onreadystatechange OPENED for sync requests
        if (qx.core.Environment.get("engine.name") === "gecko" && parseInt(qx.core.Environment.get("engine.version"), 10) < 2 && !this.__P_156_16) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        if (key == "If-Match" || key == "If-Modified-Since" || key == "If-None-Match" || key == "If-Range") {
          this.__P_156_14 = true;
        }
        this.__P_156_18.setRequestHeader(key, value);
        return this;
      },
      /**
       * Sends request.
      ...
      send: function send(data) {
        ...
        //
        if (!this.__P_156_16 && this.__P_156_19) {
          throw this.__P_156_19;
        }
        ...
        // Timeout
        if (this.timeout > 0) {
          this.__P_156_21 = window.setTimeout(this.__P_156_6, this.timeout);
        }
        ...
        data = data !== null && this.__P_156_22.indexOf(dataType) === -1 ? data.toString() : data;
        ...
        try {
          ...
          if (this.__P_156_16) {
            this.__P_156_18.responseType = this.responseType;
          }
          this.__P_156_18.send(data);
        } catch (SendError) {
          if (!this.__P_156_16) {
            throw SendError;
          }
        ...
        if (qx.core.Environment.get("engine.name") === "gecko" && !this.__P_156_16) {
          // Properties all set, only missing native readystatechange event
          this.__P_156_0();
        }

        // Set send flag
        this.__P_156_13 = true;
        return this;
      },
      /**
      ...
      abort: function abort() {
        this.__P_156_11();
        this.__P_156_12 = true;
        this.__P_156_18.abort();
        if (this.__P_156_18 && this.readyState !== qx.bom.request.Xhr.DONE) {
          this.readyState = this.__P_156_18.readyState;
        }
        return this;
      },
      /**
      ...
      getResponseHeader: function getResponseHeader(header) {
        this.__P_156_11();
        if (qx.core.Environment.get("browser.documentmode") === 9 && this.__P_156_18.aborted) {
          return "";
        }
        return this.__P_156_18.getResponseHeader(header);
      },
      /**
      ...
      getAllResponseHeaders: function getAllResponseHeaders() {
        ...
        return this.__P_156_18.getAllResponseHeaders();
      },
      /**
      ...
      overrideMimeType: function overrideMimeType(mimeType) {
        this.__P_156_11();
        if (this.__P_156_18.overrideMimeType) {
          this.__P_156_18.overrideMimeType(mimeType);
        } else {
      ...
      */
      ...
      dispose: function dispose() {
        ...
        window.clearTimeout(this.__P_156_21);

        // Remove unload listener in IE. Aborting on unload is no longer required
        // for this instance.
        if (window.detachEvent) {
          window.detachEvent("onunload", this.__P_156_9);
        }

        // May fail in IE
        try {
          this.__P_156_18.onreadystatechange;
        ...
        this.__P_156_18.onreadystatechange = noop;
        this.__P_156_18.onload = noop;
        this.__P_156_18.onerror = noop;
        this.__P_156_18.onprogress = noop;

        // Abort any network activity
        this.abort();

        // Remove reference to native XHR
        this.__P_156_18 = null;
        this.responseText = null;
        this.__P_156_20 = true;
        return true;
      },
      /**
      ...
      */
       ...
       * Init native XHR.
       */
      __P_156_8: function __P_156_8() {
        // Create native XHR or equivalent and hold reference
        this.__P_156_18 = this._createNativeXhr();

        // Track native ready state changes
        this.__P_156_18.onreadystatechange = this.__P_156_1;

        // Track native abort, when supported
        if (qx.Bootstrap.getClass(this.__P_156_18.onabort) !== "Undefined") {
          this.__P_156_18.onabort = this.__P_156_2;
        }

        // Track native progress, when supported
        if (qx.Bootstrap.getClass(this.__P_156_18.onprogress) !== "Undefined") {
          this.__P_156_18.onprogress = this.__P_156_4;
          this.progress = {
        ...
        // Reset flags
        this.__P_156_20 = this.__P_156_13 = this.__P_156_12 = false;

        // Initialize data white list
        this.__P_156_22 = ["ArrayBuffer", "Blob", "File", "HTMLDocument", "String", "FormData"];
      },
      /**
       * Track native abort.
       *
       ...
       */
      __P_156_5: function __P_156_5(e) {
       ...
       */
      __P_156_0: function __P_156_0() {
        var nxhr = this.__P_156_18,
        ...
        // without send flag
        if (this.readyState === qx.bom.request.Xhr.DONE && this.__P_156_12 && !this.__P_156_13) {
          return;
        }
        ...
        // be fired.
        if (!this.__P_156_16 && (nxhr.readyState == 2 || nxhr.readyState == 3)) {
          return;
        }
       ...
       */
      __P_156_23: function __P_156_23() {
       ...
       */
      __P_156_27: function __P_156_27() {
       ...
       */
      __P_156_28: function __P_156_28() {
        var error;
       ...
       */
      __P_156_25: function __P_156_25() {
       ...
       */
      __P_156_26: function __P_156_26() {
        // BUGFIX: IE
       ...
       */
      __P_156_10: function __P_156_10() {
        try {
          // Abort and dispose
          if (this) {
            this.dispose();
       ...
       */
      __P_156_17: function __P_156_17() {
       ...
       */
      __P_156_11: function __P_156_11() {
        if (this.__P_156_20) {
...
//# sourceMappingURL=Xhr.js.map?dt=1735341766148