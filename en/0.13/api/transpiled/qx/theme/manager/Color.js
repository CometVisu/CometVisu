    ...
    members: {
      _applyTheme: function _applyTheme(value) {
        ...
        if (value) {
          ...
          for (var name in colors) {
            if (!dest[name]) {
              dest[name] = this.__P_456_0(colors, name);
            }
          }
        }
      },
      ...
      __P_456_0: function __P_456_0(colors, name) {
        ...
        if (typeof color === "string") {
          ...
          return this.__P_456_0(colors, color(name));
        }
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.colors[value]) {
          return cache[value] = this.__P_456_0(theme.colors, value);
        }
        return value;
      },
      /**
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.colors[value] !== undefined) {
          cache[value] = this.__P_456_0(theme.colors, value);
          return true;
        }
        return false;
      }
...
//# sourceMappingURL=Color.js.map?dt=1722153835648