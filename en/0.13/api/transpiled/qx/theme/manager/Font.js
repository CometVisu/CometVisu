    ...
    members: {
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.fonts[value]) {
          ...
          var font = new fontClass(); // Inject information about custom charcter set tests before we apply the
      ...
      __P_293_0: function __P_293_0(fontDefs) {
        ...
        var _loop = function _loop() {
          ...
          if (fontDef.sources) {
            ...
            var family = fontDef.family[0]; // Make sure that there is a font definition
        ...
        for (var _fontId2 in createdFonts) {
          var _font = createdFonts[_fontId2];
...
//# sourceMappingURL=Font.js.map?dt=1685978131140