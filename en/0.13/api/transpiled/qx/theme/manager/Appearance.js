    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_466_3: function __P_466_3(id, theme, defaultId, chain) {
        ...
        if (!entry) {
          ...
          while (!entry && splitted.length > 0) {
            ...
            if (entry) {
              ...
              if (typeof alias === "string") {
                ...
                return this.__P_466_3(mapped, theme, defaultId, chainCopy);
              }
            }
          }
          ...
          for (var i = 0; i < end.length - 1; i++) {
            ...
            var resolved = this.__P_466_3(subId, theme, null, chainCopy);
            if (resolved) {
              return resolved;
            }
          }
          ...
          if (defaultId != null) {
            return this.__P_466_3(defaultId, theme, null, chainCopy);
          }
          ...
          return this.__P_466_3(entry, theme, defaultId, chainCopy);
        } else if (entry.include && !entry.style) {
          return this.__P_466_3(entry.include, theme, defaultId, chainCopy);
        }
        return id;
      },
      /**
      ...
      styleFrom: function styleFrom(id, states, theme, defaultId) {
        ...
        // Resolve ID
        var aliasMap = this.__P_466_1;
        if (!aliasMap[theme.name]) {
          aliasMap[theme.name] = {};
        }
        var resolved = aliasMap[theme.name][id];
        if (!resolved) {
          resolved = aliasMap[theme.name][id] = this.__P_466_3(id, theme, defaultId);
        }
...
//# sourceMappingURL=Appearance.js.map?dt=1782595068590