  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.ImageLoader", {
    statics: {
      ...
      __P_255_2: /\.(png|gif|jpg|jpeg|bmp)\b/i,
      /** @type {RegExp} Image types of a data URL */
      __P_255_3: /^data:image\/(png|gif|jpg|jpeg|bmp)\b/i,
      /**
      ...
      isLoaded: function isLoaded(source) {
        var entry = this.__P_255_0[source];
      ...
      getFormat: function getFormat(source) {
        ...
        if (!entry || !entry.format) {
          var result = this.__P_255_3.exec(source);
          if (result != null) {
            // If width and height aren't defined, provide some defaults
            var width = entry && qx.lang.Type.isNumber(entry.width) ? entry.width : this.__P_255_1.width;
            var height = entry && qx.lang.Type.isNumber(entry.height) ? entry.height : this.__P_255_1.height;
            entry = {
              loaded: true,
              format: result[1],
              width: width,
      ...
      load: function load(source, callback, context) {
        ...
        if (entry.loaded || entry.loading || entry.failed) {
          ...
          var boundCallback = qx.lang.Function.listener(this.__P_255_4, this, el, source);
      ...
      abort: function abort(source) {
        ...
        this.__P_255_0[source] = null;
      },
      /**
       * Calls a method based on qx.globalErrorHandling
       */
      __P_255_4: function __P_255_4() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_255_5),
          "false": this.__P_255_5
        });
       ...
       */
      __P_255_5: function __P_255_5(event, element, source) {
        // Shorthand
        var entry = this.__P_255_0[source];
        ...
        if (event.type === "load" && isImageAvailable(element)) {
          ...
          var result = this.__P_255_2.exec(source);
          if (result != null) {
...
//# sourceMappingURL=ImageLoader.js.map?dt=1735383855314