  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.ImageLoader", {
    statics: {
      ...
      __P_263_2: /\.(png|gif|jpg|jpeg|bmp)\b/i,
      /** @type {RegExp} Image types of a data URL */
      __P_263_3: /^data:image\/(png|gif|jpg|jpeg|bmp|svg)\b/i,
      /**
      ...
      isLoaded: function isLoaded(source) {
        var entry = this.__P_263_0[source];
      ...
      getFormat: function getFormat(source) {
        ...
        if (!entry || !entry.format) {
          var result = this.__P_263_3.exec(source);
          if (result != null) {
            // If width and height aren't defined, provide some defaults
            var width = entry && qx.lang.Type.isNumber(entry.width) ? entry.width : this.__P_263_1.width;
            var height = entry && qx.lang.Type.isNumber(entry.height) ? entry.height : this.__P_263_1.height;
            entry = {
              loaded: true,
              format: result[1],
              width: width,
       ...
       */
      load: function load(source, callback, context, options) {
        options !== null && options !== void 0 ? options : options = {};
        // Shorthand
        var entry = this.__P_263_0[source];
        if (!entry || options.retryFailed && entry.failed) {
          entry = this.__P_263_0[source] = {};
        }
        ...
        if (entry.loaded || entry.loading || entry.failed) {
          ...
          var boundCallback = qx.lang.Function.listener(this.__P_263_4, this, el, source);
      ...
      abort: function abort(source) {
        ...
        this.__P_263_0[source] = null;
      },
      /**
       * Calls a method based on qx.globalErrorHandling
       */
      __P_263_4: function __P_263_4() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_263_5),
          "false": this.__P_263_5
        });
       ...
       */
      __P_263_5: function __P_263_5(event, element, source) {
        // Shorthand
        var entry = this.__P_263_0[source];
        ...
        if (event.type === "load" && isImageAvailable(element)) {
          ...
          var result = this.__P_263_2.exec(source);
          if (result != null) {
...
//# sourceMappingURL=ImageLoader.js.map?dt=1782595057604