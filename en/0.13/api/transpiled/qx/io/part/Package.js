  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.io.part.Package", {
    ...
    construct: function construct(urls, id, loaded) {
      this.__P_267_0 = loaded ? "complete" : "initialized";
      this.__P_267_1 = urls;
      this.__P_267_2 = id;
    },
    members: {
      ...
      saveClosure: function saveClosure(closure) {
        if (this.__P_267_0 == "error") {
          return;
        }
        this.__P_267_3 = closure;
        if (!this.__P_267_4) {
          this.execute();
        } else {
          clearTimeout(this.__P_267_5);
          this.__P_267_0 = "cached";
          this.__P_267_6(this);
        }
      },
      /**
      ...
      execute: function execute() {
        if (this.__P_267_3) {
          this.__P_267_3();
          delete this.__P_267_3;
        }
        if (qx.$$packageData[this.__P_267_2]) {
          this.__P_267_7(qx.$$packageData[this.__P_267_2]);
          delete qx.$$packageData[this.__P_267_2];
        }
        this.__P_267_0 = "complete";
      },
      /**
      ...
      loadClosure: function loadClosure(notifyPackageResult, self) {
        if (this.__P_267_0 !== "initialized") {
          return;
        }
        this.__P_267_4 = true;
        this.__P_267_0 = "loading";
        this.__P_267_6 = qx.Bootstrap.bind(notifyPackageResult, self);
        this.__P_267_8(this.__P_267_1, function () {}, function () {
          this.__P_267_0 = "error";
          notifyPackageResult.call(self, this);
        }, this);
        var pkg = this;
        this.__P_267_5 = setTimeout(function () {
          pkg.__P_267_0 = "error";
      ...
      load: function load(notifyPackageResult, self) {
        ...
        this.__P_267_4 = false;
        this.__P_267_0 = "loading";
        this.__P_267_8(this.__P_267_1, function () {
          this.__P_267_0 = "complete";
          this.execute();
          notifyPackageResult.call(self, this);
        }, function () {
       ...
       */
      __P_267_8: function __P_267_8(urlList, callback, errBack, self) {
        if (urlList.length == 0) {
          callback.call(self);
          return;
        }
        ...
        var _loadScripts = function loadScripts(urls) {
          ...
          loader.onerror = function () {
            if (self.__P_267_0 == "loading") {
              clearTimeout(self.__P_267_5);
              loader.dispose();
       ...
       */
      __P_267_7: qx.$$loader.importPackageData
    }
  });
  qx.io.part.Package.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Package.js.map?dt=1778272826770