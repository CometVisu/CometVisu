...
(function () {
  ...
  qx.Class.define("qx.io.transport.PostMessage", {
     ...
     */
    construct: function construct(windowOrWorker) {
      var _this = this;
      windowOrWorker.addEventListener("message", function (evt) {
        _this.fireDataEvent("message", evt.data);
      });
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _this2.getEndpoint().postMessage(message);
                case 2:
                case "end":
...
//# sourceMappingURL=PostMessage.js.map?dt=1673093861559