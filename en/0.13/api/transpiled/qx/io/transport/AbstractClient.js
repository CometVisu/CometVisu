  ...
  qx.Class.define("qx.io.transport.AbstractClient", {
    ...
    statics: {
      ...
      registerTransport: function registerTransport(uriRegExp, transportClass) {
        if (!this.constructor.__P_281_0) {
          this.constructor.__P_281_0 = [];
        }
        ...
        this.constructor.__P_281_0.push({
          uriRegExp: uriRegExp,
    ...
    members: {
      ...
      selectTransport: function selectTransport(transportOrUri) {
        ...
        if (qx.lang.Type.isString(transportOrUri)) {
          ...
          uri = transportOrUri;
          var _iterator = _createForOfIteratorHelper(this.constructor.__P_281_0.reverse()),
            _step;
          try {
...
//# sourceMappingURL=AbstractClient.js.map?dt=1782595058281