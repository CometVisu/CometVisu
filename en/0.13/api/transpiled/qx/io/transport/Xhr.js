  ...
  qx.Class.define("qx.io.transport.Xhr", {
    ...
    members: {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 22:
                // notify listeners
                _this.fireDataEvent("message", req.getResponse()); // discard old object
      ...
      _createTransportImpl: function _createTransportImpl() {
        ...
        req.setCache(false);
        req.setRequestHeader("Content-Type", "application/json; charset=utf-8"); // disable parsing, we are going to parse the JSON ourselves
...
//# sourceMappingURL=Xhr.js.map?dt=1685978126965