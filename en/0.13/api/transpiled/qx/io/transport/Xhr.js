  ...
  qx.Class.define("qx.io.transport.Xhr", {
    ...
    members: {
      ...
      getTransportImpl: function getTransportImpl() {
        this.__P_265_0 = this._createTransportImpl();
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  req = _this.__P_265_0 || _this.getTransportImpl();
                  req.setRequestData(message);
                  _this.__P_265_0 = null; // free the internal reference for the next request
                  _context.prev = 4;
                  _context.next = 7;
...
//# sourceMappingURL=Xhr.js.map?dt=1672653499361