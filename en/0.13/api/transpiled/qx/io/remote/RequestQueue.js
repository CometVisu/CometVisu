  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct: function construct() {
      ...
      // timeout handling
      this.__P_252_3 = new qx.event.Timer(500);
      this.__P_252_3.addListener("interval", this._oninterval, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    members: {
      ...
      */
      ...
      _check: function _check() {
        ...
        if (this.__P_252_1.length == 0 && this.__P_252_0.length == 0) {
          this.__P_252_3.stop();
        }
        ...
        if (this.__P_252_0.length == 0 || this.__P_252_0[0].isAsynchronous() && this.__P_252_1.length >= this.getMaxConcurrentRequests()) {
          return;
        }

        // Checking number of total requests
        if (this.getMaxTotalRequests() != null && this.__P_252_2 >= this.getMaxTotalRequests()) {
          return;
        }
        var vRequest = this.__P_252_0.shift();
        ...
        // Add to active queue
        this.__P_252_1.push(vTransport);
      ...
      _remove: function _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__P_252_1, vTransport);
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        ...
        this.__P_252_3.setEnabled(value);
      },
      /*
      ---------------------------------------------------------------------------
        CORE METHODS
      ...
      */
      ...
      add: function add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__P_252_0.push(vRequest);
        } else {
          this.__P_252_0.unshift(vRequest);
        }
        this._check();
        if (this.getEnabled()) {
          this.__P_252_3.start();
        }
      },
      /**
      ...
      abort: function abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__P_252_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__P_252_0, vRequest);
        }
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__P_252_1");
      this._disposeObjects("__P_252_3");
      this.__P_252_0 = null;
    }
  });
...
//# sourceMappingURL=RequestQueue.js.map?dt=1673093860768