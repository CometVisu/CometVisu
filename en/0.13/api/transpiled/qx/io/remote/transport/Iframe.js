  ...
  qx.Class.define("qx.io.remote.transport.Iframe", {
    ...
    */
    construct: function construct() {
      ...
      qx.bom.element.Style.set(this.__P_256_0, "display", "none"); // Create form element with textarea as conduit for request data.
      ...
      qx.dom.Element.insertEnd(this.__P_256_2, this.__P_256_1); // Finally, attach iframe to DOM and add listeners

      qx.dom.Element.insertEnd(this.__P_256_0, qx.dom.Node.getBodyElement(document));
      qx.event.Registration.addListener(this.__P_256_0, "load", this._onload, this); // qx.event.handler.Iframe does not yet support the readystatechange event
    ...
    */
    destruct: function destruct() {
      if (this.__P_256_0) {
        ...
        qx.bom.Event.removeNativeListener(this.__P_256_0, "readystatechange", this.__P_256_3); // Reset source to a blank image for gecko
...
//# sourceMappingURL=Iframe.js.map?dt=1685978125911