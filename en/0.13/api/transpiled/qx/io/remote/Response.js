    ...
    members: {
      ...
      */
      ...
      clone: function clone(embryo) {
        var clone = qx.io.remote.Response.superclass.prototype.clone.call(this, embryo);
      ...
      getResponseHeader: function getResponseHeader(vHeader) {
        if (this.__P_262_0) {
          return this.__P_262_0[vHeader.toLowerCase()] || null;
        }
        return null;
      },
      /**
...
//# sourceMappingURL=Response.js.map?dt=1705596671664