  ...
  qx.Class.define("qx.io.rest.Resource", {
    ...
    members: {
      ...
      map: function map(action, method, url, check) {
        ...
        this.__P_270_4(action, method, url, check);
       ...
       *   <code>qx.io.rest.Resource.REQUIRED</code> (to verify existence).
       */
      __P_270_4: function __P_270_4(action, method, url, check) {
        this.__P_270_2[action] = [method, url, check];
        ...
        this.__P_270_5(action + "Success");
        this.__P_270_5(action + "Error");
      ...
      invoke: function invoke(action, params, data) {
        ...
        // Cache parameters
        this.__P_270_2[action].params = params;
      ...
      poll: function poll(action, interval, params, immediately) {
        ...
        if (this.__P_270_1[action]) {
          this.__P_270_1[action].dispose();
        }

        // Fallback to previous params
        if (typeof params == "undefined") {
          params = this.__P_270_2[action].params;
        }
        ...
        var timer = this.__P_270_1[action] = new qx.event.Timer(interval);
      ...
      longPoll: function longPoll(action) {
        ...
        var handlerId = this.__P_270_0[action] = this.addListener(action + "Success", function longPollHandler() {
          if (res.isDisposed()) {
            return;
          }
          if (!throttle()) {
       ...
       */
      __P_270_3: function __P_270_3(description) {
       ...
       */
      __P_270_5: function __P_270_5(type) {
    ...
    destruct: function destruct() {
      var action;
      if (this.__P_270_1) {
        for (action in this.__P_270_1) {
          var timer = this.__P_270_1[action];
          timer.stop();
          timer.dispose();
        }
      }
      if (this.__P_270_0) {
        for (action in this.__P_270_0) {
          var id = this.__P_270_0[action];
          this.removeListenerById(id);
        }
      }
      this._resource.destruct();
      this._resource = this.__P_270_2 = this.__P_270_1 = this.__P_270_0 = null;
    }
  });
  qx.io.rest.Resource.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resource.js.map?dt=1702901313180