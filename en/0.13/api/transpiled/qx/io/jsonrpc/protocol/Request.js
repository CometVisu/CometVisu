  ...
  qx.Class.define("qx.io.jsonrpc.protocol.Request", {
    ...
    statics: {
      ...
      getCurrentId: function getCurrentId() {
        return qx.io.jsonrpc.protocol.Request.__P_246_0;
      },
      resetId: function resetId() {
        qx.io.jsonrpc.protocol.Request.__P_246_0 = 0;
      }
    },
    properties: {
      /**
    ...
    construct: function construct(method, params, id) {
      ...
      if (id === undefined) {
        id = ++qx.io.jsonrpc.protocol.Request.__P_246_0;
      }
      this.set({
        id: id
      });
...
//# sourceMappingURL=Request.js.map?dt=1673093860507