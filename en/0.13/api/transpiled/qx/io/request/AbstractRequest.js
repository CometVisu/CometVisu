  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.io.request.AbstractRequest", {
    ...
    construct: function construct(url) {
      ...
      this.__P_267_1 = qx.lang.Function.bind(this._onReadyStateChange, this);
      this.__P_267_2 = qx.lang.Function.bind(this._onLoad, this);
      this.__P_267_3 = qx.lang.Function.bind(this._onLoadEnd, this);
      this.__P_267_4 = qx.lang.Function.bind(this._onAbort, this);
      this.__P_267_5 = qx.lang.Function.bind(this._onTimeout, this);
      this.__P_267_6 = qx.lang.Function.bind(this._onError, this);
      transport.onreadystatechange = this.__P_267_1;
      transport.onload = this.__P_267_2;
      transport.onloadend = this.__P_267_3;
      transport.onabort = this.__P_267_4;
      transport.ontimeout = this.__P_267_5;
      transport.onerror = this.__P_267_6;
    },
    events: {
      /**
    ...
    members: {
      ...
      */
      ...
      _getAllRequestHeaders: function _getAllRequestHeaders() {
        ...
        // Authentication delegate
        qx.lang.Object.mergeWith(requestHeaders, this.__P_267_11());
        // User-defined, requestHeaders property (deprecated)
        qx.lang.Object.mergeWith(requestHeaders, this.__P_267_10);
        // User-defined
        qx.lang.Object.mergeWith(requestHeaders, this.__P_267_0);
      ...
      removeRequestHeader: function removeRequestHeader(key) {
        if (this.__P_267_0[key]) {
          delete this.__P_267_0[key];
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _setResponse: function _setResponse(response) {
        ...
        if (this.__P_267_7 !== response) {
          this.__P_267_7 = response;
          this.fireEvent("changeResponse", qx.event.type.Data, [this.__P_267_7, oldResponse]);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _setPhase: function _setPhase(phase) {
        var previousPhase = this.__P_267_9;
        this.__P_267_9 = phase;
...
//# sourceMappingURL=AbstractRequest.js.map?dt=1702815225023