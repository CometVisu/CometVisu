  ...
  qx.Class.define("qx.data.controller.website.List", {
    ...
    members: {
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_187_0 != undefined) {
            old.removeListenerById(this.__P_187_0);
          }
          if (this.__P_187_1 != undefined) {
            old.removeListenerById(this.__P_187_1);
          }
        }
        ...
        if (value != null) {
          ...
          if (value instanceof qx.core.Object) {
            // add new listeners
            this.__P_187_0 = value.addListener("change", this.update, this);
            this.__P_187_1 = value.addListener("changeBubble", this.update, this);
          }
        } else {
...
//# sourceMappingURL=List.js.map?dt=1735341767581