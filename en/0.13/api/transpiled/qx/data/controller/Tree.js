    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_186_7: function __P_186_7(ev) {
        // get the stored data
        var children = ev.getTarget();
        qx.core.ObjectRegistry.register(children);
        var treeNode = this.__P_186_2[children.toHashCode()].treeNode;
        var modelNode = this.__P_186_2[children.toHashCode()].modelNode;
        // update the subtree
        this.__P_186_8(treeNode, modelNode);
      ...
      __P_186_9: function __P_186_9(e) {
        ...
        delete this.__P_186_2[oldChildren.toHashCode()];
        ...
        var changeChildernListenerId = modelNode.addListener(eventName, this.__P_186_9, this);

        // add the new ref
        var treeNode = oldRef.treeNode;
        this.debug("1: adding children=" + children.toHashCode() + " to this=" + this.toHashCode());
        this.__P_186_2[children.toHashCode()] = {
          modelNode: modelNode,
          treeNode: treeNode,
      ...
      */
      ...
      __P_186_6: function __P_186_6() {
        ...
        if (this.getModel() != null) {
          ...
          // bind the root node
          this.__P_186_10(this.getModel(), rootNode);
          this.__P_186_8(rootNode, this.getModel());
       ...
       */
      __P_186_8: function __P_186_8(rootNode, modelNode) {
        ...
        if (this.__P_186_2[children.toHashCode()] == undefined) {
          // add the listener for the change
          var changeListenerId = children.addListener("change", this.__P_186_7, this);
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (rootNode.getChildren()[i] == null || children.getItem(i) != rootNode.getChildren()[i].getModel()) {
            ...
            if (oldIndex != undefined) {
              ...
              this.__P_186_10(children.getItem(i), treeNode);

              // add all children recursive
              this.__P_186_8(treeNode, children.getItem(i));
            }
          }
        }
        ...
        for (var i = rootNode.getChildren().length - 1; i >= children.length; i--) {
          ...
          this.__P_186_11(treeFolder, rootNode);
        }
      },
      /**
       ...
       */
      __P_186_5: function __P_186_5(tree) {
        if (tree == null) {
          tree = this.getTarget();
        }
        ...
        if (root != null) {
          tree.setRoot(null);
          this.__P_186_12(root);
          var model = root.getModel();
          if (model) {
            this.__P_186_13(model);
          }
          root.destroy();
       ...
       */
      __P_186_12: function __P_186_12(node) {
        var children = node.getChildren() || [];
        // remove all subchildren
        for (var i = children.length - 1; i >= 0; i--) {
          if (children[i].getChildren().length > 0) {
            this.__P_186_12(children[i]);
          }
          this.__P_186_11(children[i], node);
        }
      },
      /**
       ...
       *   treeFolder.
       */
      __P_186_11: function __P_186_11(treeFolder, rootNode) {
        // get the model
        var model = treeFolder.getModel();
        var childPath = this.__P_186_3 || this.getChildPath();
        ...
        if (model[childrenGetterName] != undefined) {
          ...
          var oldRef = this.__P_186_2[children.toHashCode()];
          ...
          this.__P_186_12(treeFolder);

          // delete the model reference
          delete this.__P_186_2[children.toHashCode()];
        }
      ...
      */
      ...
      bindProperty: function bindProperty(sourcePath, targetPath, options, targetWidget, modelNode) {
        ...
        if (this.__P_186_0[targetPath] == null) {
          this.__P_186_0[targetPath] = {};
        }
        // store the binding reference
        var storage = this.__P_186_0[targetPath];
        ...
        if (!this.__P_186_1.includes(targetPath)) {
          this.__P_186_1.push(targetPath);
        }
      },
      /**
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, modelNode) {
        ...
        // check for the storage for the references
        if (this.__P_186_0[sourcePath] == null) {
          this.__P_186_0[sourcePath] = {};
        }
        // check if there is already a stored item
        var storage = this.__P_186_0[sourcePath];
        qx.core.ObjectRegistry.register(modelNode);
        if (storage[modelNode.toHashCode()]) {
        ...
        // save the bound property
        if (!this.__P_186_1.includes(sourcePath)) {
          this.__P_186_1.push(sourcePath);
        }
      },
      /**
      ...
      __P_186_4: function __P_186_4() {
        ...
        for (var hash in this.__P_186_0[firstProp]) {
          // get the data
          var treeNode = this.__P_186_0[firstProp][hash].treeNode;
          var modelNode = qx.core.ObjectRegistry.fromHashCode(hash);
          // remove the old bindings
          this.__P_186_13(modelNode);
          // add the new bindings
          this.__P_186_10(modelNode, treeNode);
        }
      },
      /**
       ...
       *   to the model node.
       */
      __P_186_10: function __P_186_10(modelNode, treeNode) {
        var delegate = this.getDelegate();
       ...
       *   should be removed.
       */
      __P_186_13: function __P_186_13(modelNode) {
        for (var i = 0; i < this.__P_186_1.length; i++) {
          var property = this.__P_186_1[i];
          var bindingsMap = this.__P_186_0[property][modelNode.toHashCode()];
          if (bindingsMap != null) {
            if (bindingsMap.id) {
            ...
            delete this.__P_186_0[property][modelNode.toHashCode()];
          }
        }
      },
      /*
    ...
    destruct: function destruct() {
      ...
      this.__P_186_0 = this.__P_186_2 = this.__P_186_1 = null;
    }
  });
  qx.data.controller.Tree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree.js.map?dt=1735222417869