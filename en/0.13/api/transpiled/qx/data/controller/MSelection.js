    ...
    */
    construct: function construct() {
      ...
      if (this.getSelection() == null) {
        this.__P_174_0 = new qx.data.Array();
        this.setSelection(this.__P_174_0);
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        ...
        if (this.__P_174_2 != undefined && old != undefined) {
          old.removeListenerById(this.__P_174_2);
          this.__P_174_2 = null;
        }
        // add a new change listener to the changeArray
        if (value) {
          this.__P_174_2 = value.addListener("change", this.__P_174_3, this);
        }
      ...
      */
      ...
      _changeTargetSelection: function _changeTargetSelection() {
        ...
        if (!this.__P_174_4() && !this.__P_174_5()) {
          return;
        }
      ...
      */
      ...
      _addChangeTargetListener: function _addChangeTargetListener(value, old) {
        ...
        if (this.__P_174_1 != undefined && old != undefined) {
          old.removeListenerById(this.__P_174_1);
        }
        if (value != null) {
          // if a selection API is supported
          if (this.__P_174_4() || this.__P_174_5()) {
            // add a new selection listener
            this.__P_174_1 = value.addListener("changeSelection", this._changeTargetSelection, this);
          }
        }
      },
      /**
      ...
      _updateSelection: function _updateSelection() {
        ...
        if (this.__P_174_4()) {
          ...
          for (var i = 0; i < this.getSelection().length; i++) {
            ...
            var selectable = this.__P_174_6(model);
            if (selectable != null) {
       ...
       */
      __P_174_7: function __P_174_7(item) {
        var selectable = this.__P_174_6(item);
       ...
       */
      __P_174_6: function __P_174_6(model) {
        // get all list items
...
//# sourceMappingURL=MSelection.js.map?dt=1672653489576