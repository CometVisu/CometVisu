  ...
  qx.Class.define("qx.data.controller.CheckedList", {
    ...
    members: {
      _applyChecked: function _applyChecked(value, oldValue) {
        if (oldValue) {
          oldValue.removeListener("change", this.__P_189_1, this);
        }
        if (value) {
          value.addListener("change", this.__P_189_1, this);
        }
        this._updateChecked();
      },
      /**
       ...
       */
      __P_189_1: function __P_189_1(evt) {
      ...
      _applyTarget: function _applyTarget(value, oldValue) {
        ...
        if (oldValue) {
          oldValue.removeListener("changeChecked", this.__P_189_3, this);
          if (qx.Class.supportsEvent(oldValue.constructor, "attachResultsTag")) {
            oldValue.removeListener("attachResultsTag", this.__P_189_4, this);
            oldValue.removeListener("detachResultsTag", this.__P_189_5, this);
          }
        }
        if (value) {
          value.addListener("changeChecked", this.__P_189_3, this);
          if (qx.Class.supportsEvent(value.constructor, "attachResultsTag")) {
            value.addListener("attachResultsTag", this.__P_189_4, this);
            value.addListener("detachResultsTag", this.__P_189_5, this);
          }
        }
      },
      /**
       ...
       */
      __P_189_3: function __P_189_3(evt) {
        if (this.__P_189_6) {
          return;
        }
       ...
       */
      __P_189_4: function __P_189_4(evt) {
      ...
      __P_189_0: function __P_189_0() {
        ...
        target.getChecked().forEach(function (item) {
          ...
          _this.__P_189_8(tagWidget, item);
          _this.__P_189_7(tagWidget, item);
        });
      },
      /**
       ...
       */
      __P_189_7: function __P_189_7(tagWidget, item) {
        var itemModel = item.getModel();
        var bindData = {};
       ...
       * @param item {qx.ui.core.Widget} the list item that lists the model item that this tag is for
       */
      __P_189_8: function __P_189_8(tagWidget, item) {
        var itemModel = item.getModel();
...
//# sourceMappingURL=CheckedList.js.map?dt=1778272821616