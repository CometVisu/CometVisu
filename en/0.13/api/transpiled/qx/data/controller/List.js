  ...
  qx.Class.define("qx.data.controller.List", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_182_4 != undefined) {
            old.removeListenerById(this.__P_182_4);
          }
        }
        ...
        if (value != null) {
          // add a new listener
          this.__P_182_4 = value.addListener("change", this.__P_182_10, this);
      ...
      _applyTarget: function _applyTarget(value, old) {
        ...
        if (value != null) {
          if (this.getModel() != null) {
            ...
            for (var i = 0; i < this.__P_182_0.length; i++) {
              this.__P_182_13(this.__P_182_14(i));
            }
          }
        }
      },
      ...
      */
       ...
       */
      __P_182_10: function __P_182_10() {
        if (this.__P_182_15) {
          return;
        }
        this.__P_182_15 = true;
      ...
      syncWidget: function syncWidget() {
        ...
        this.__P_182_6 = this.__P_182_5 = null;
      },
      /**
      ...
      __P_182_7: function __P_182_7() {
        ...
        // get the length
        var newLength = this.__P_182_0.length;
        ...
        if (newLength > currentLength) {
          ...
          for (var j = currentLength; j < newLength; j++) {
            this.__P_182_13(this.__P_182_14(j));
          }
       ...
       */
      __P_182_16: function __P_182_16() {
        var model = this.getModel();
        // it can be that the bindings has been reset without the model so
        // maybe there is no model in some scenarios
        if (model != null) {
          model.removeListenerById(this.__P_182_4);
          this.__P_182_4 = model.addListener("change", this.__P_182_10, this);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_182_13: function __P_182_13(index) {
       ...
       */
      __P_182_12: function __P_182_12() {
      ...
      */
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        if (options != null) {
          ...
          this.__P_182_3[targetProperty] = options.onUpdate;
          delete options.onUpdate;
        } else {
          options = {};
          this.__P_182_3[targetProperty] = null;
        }
        ...
        if (!this.__P_182_1.includes(targetProperty)) {
          this.__P_182_1.push(targetProperty);
        }
      },
      /**
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, index) {
        ...
        // save the bound property
        if (!this.__P_182_2.includes(targetPath)) {
          this.__P_182_2.push(targetPath);
        }
      },
      /**
      ...
      _onBindingSet: function _onBindingSet(index, sourceObject, targetObject) {
        ...
        for (var i = 0; i < this.__P_182_1.length; i++) {
          // if there is an onUpdate for one of it, invoke it
          if (this.__P_182_3[this.__P_182_1[i]] != null) {
            this.__P_182_3[this.__P_182_1[i]]();
          }
        }
      },
      /**
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        ...
        for (var i = 0; i < this.__P_182_1.length; i++) {
          ...
          var id = item.getUserData(this.__P_182_1[i] + "BindingId");
          if (id != null) {
            this.removeBinding(id);
            item.setUserData(this.__P_182_1[i] + "BindingId", null);
          }
        }
        // go through all reverse bound properties
        for (var i = 0; i < this.__P_182_2.length; i++) {
          // get the binding id and remove it, if possible
          var id = item.getUserData(this.__P_182_2[i] + "ReverseBindingId");
          if (id != null) {
            item.removeBinding(id);
            item.getUserData(this.__P_182_2[i] + "ReverseBindingId", null);
          }
        }
      },
      /**
      ...
      __P_182_8: function __P_182_8() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          // add the new binding
          this._bindListItem(items[i], this.__P_182_14(i));
        }
      ...
      */
      ...
      _setFilter: function _setFilter(value, old) {
        ...
        var oldTable = this.__P_182_0;
        // generate a new lookup table
        this.__P_182_11();

        // if there are lesser items
        if (oldTable.length > this.__P_182_0.length) {
          // remove the unnecessary items
          for (var j = oldTable.length; j > this.__P_182_0.length; j--) {
            this.getTarget().removeAt(j - 1).destroy();
          }
          // if there are more items
        } else if (oldTable.length < this.__P_182_0.length) {
          // add the new elements
          for (var j = oldTable.length; j < this.__P_182_0.length; j++) {
        ...
        for (var i = 0; i < listItems.length; i++) {
          this._bindListItem(listItems[i], this.__P_182_14(i));
        }
       ...
       */
      __P_182_17: function __P_182_17() {
        // renew the index lookup table
        this.__P_182_11();
        // check for the new length
        this.__P_182_7();
      ...
      */
       ...
       */
      __P_182_11: function __P_182_11() {
        var model = this.getModel();
        if (model == null) {
          return;
        }
       ...
       */
      __P_182_14: function __P_182_14(index) {
        return this.__P_182_0[index];
      }
    },
    /*
     *****************************************************************************
    ...
    destruct: function destruct() {
      this.__P_182_0 = this.__P_182_3 = this.__P_182_1 = null;
      this.__P_182_2 = null;
...
//# sourceMappingURL=List.js.map?dt=1709410147599