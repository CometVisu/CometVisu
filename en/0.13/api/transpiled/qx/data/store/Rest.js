  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    construct: function construct(resource, actionName, delegate) {
      ...
      this.__P_192_1 = qx.lang.Function.bind(this.__P_192_2, this);
      this.__P_192_3();
    },
    properties: {
      /**
    ...
    members: {
      ...
      __P_192_3: function __P_192_3() {
        ...
        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__P_192_1);
        }
      },
      /**
       ...
       */
      __P_192_2: function __P_192_2(e) {
        var data = e.getData(),
...
//# sourceMappingURL=Rest.js.map?dt=1735222418036