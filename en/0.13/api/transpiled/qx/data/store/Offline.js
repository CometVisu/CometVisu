  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Offline", {
    ...
    construct: function construct(key, storage, delegate) {
      ...
      this._storeModel = qx.util.Function.debounce(this.__P_191_0.bind(this), qx.data.store.Offline.STORE_MODEL_DELAY);
    ...
    members: {
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old) {
          old.removeListenerById(this.__P_191_1);
          old.dispose();
          this.__P_191_1 = null;
        }
        if (value) {
          this.__P_191_1 = value.addListener("changeBubble", this._storeModel, this);
          this._storeModel();
        } else {
...
//# sourceMappingURL=Offline.js.map?dt=1735383850933