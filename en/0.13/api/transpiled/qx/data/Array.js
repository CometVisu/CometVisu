    ...
    construct: function construct(param) {
      ...
      if (param == undefined) {
        ...
        for (var i = 0; i < arguments.length; i++) {
          this.__P_178_0.push(arguments[i]);
        }

        // check for a number (length)
      } else if (typeof param == "number") {
        this.__P_178_0 = new Array(param);
        // check for an array itself
      } else if (param instanceof Array) {
        this.__P_178_0 = qx.lang.Array.clone(param);
      ...
      // propagate changes
      for (var i = 0; i < this.__P_178_0.length; i++) {
        this._applyEventPropagation(this.__P_178_0[i], null, i);
      }
    ...
    */
    ...
    members: {
      ...
      concat: function concat(array) {
        ...
        if (array) {
          var newArray = this.__P_178_0.concat(array);
        } else {
          var newArray = this.__P_178_0.concat();
        }
      ...
      join: function join(connector) {
        return this.__P_178_0.join(connector);
      },
      /**
      ...
      reverse: function reverse() {
        ...
        var oldArray = this.__P_178_0.concat();
        this.__P_178_0.reverse();
        this.__P_178_2(0, this.length);
        this.fireDataEvent("change", {
          start: 0,
          end: this.length - 1,
          type: "order",
        ...
        // fire change bubbles event
        this.fireDataEvent("changeBubble", {
          value: this.__P_178_0,
          name: "0-" + (this.__P_178_0.length - 1),
          old: oldArray,
          item: this
        });
      },
      ...
      slice: function slice(from, to) {
        return new qx.data.Array(this.__P_178_0.slice(from, to));
      },
      /**
      ...
      splice: function splice(startIndex, amount, varargs) {
        ...
        var returnArray = this.__P_178_0.splice.apply(this.__P_178_0, arguments);

        // fire a change event for the length
        if (this.__P_178_0.length != oldLength) {
          this.__P_178_1();
        ...
        this.__P_178_2(startIndex + (arguments.length - 2) - amount, this.length);
      ...
      sort: function sort(func) {
        ...
        var oldArray = this.__P_178_0.concat();
        this.__P_178_0.sort.apply(this.__P_178_0, arguments);

        // prevent changeBubble event if nothing has been changed
        if (qx.lang.Array.equals(this.__P_178_0, oldArray) === true) {
          return;
        }
        this.__P_178_2(0, this.length);
        this.fireDataEvent("change", {
      ...
      unshift: function unshift(varargs) {
        for (var i = arguments.length - 1; i >= 0; i--) {
          this.__P_178_0.unshift(arguments[i]);
          this.__P_178_1();
          ...
          // fire change bubbles event
          this.fireDataEvent("changeBubble", {
            value: [this.__P_178_0[0]],
            name: "0",
            old: [this.__P_178_0[1]],
            item: this
          });
      ...
      setItem: function setItem(index, item) {
        var oldItem = this.__P_178_0[index];
        // ignore settings of already set items [BUG #4106]
        if (oldItem === item) {
          return;
        }
        this.__P_178_0[index] = item;
        ...
        if (this.length != this.__P_178_0.length) {
          this.__P_178_1();
        }
      ...
      indexOf: function indexOf(item) {
        return this.__P_178_0.indexOf(item);
      },
      /**
      ...
      lastIndexOf: function lastIndexOf(item) {
        return this.__P_178_0.lastIndexOf(item);
      },
      /**
      ...
      toString: function toString() {
        if (this.__P_178_0 != null) {
          return this.__P_178_0.toString();
        }
        return "";
      },
      /*
      ...
      */
      ...
      includes: function includes(item) {
        return this.__P_178_0.indexOf(item) !== -1;
      },
      /**
      ...
      removeAll: function removeAll() {
        ...
        for (var i = 0; i < this.__P_178_0.length; i++) {
          this._registerEventChaining(null, this.__P_178_0[i], i);
        }
        ...
        var items = this.__P_178_0.concat();

        // change the length
        this.__P_178_0.length = 0;
        this.__P_178_1();
      ...
      forEach: function forEach(callback, context) {
        var _this2 = this;
        this.__P_178_0.forEach(function (element, index) {
      ...
      */
      ...
      filter: function filter(callback, self) {
        return new qx.data.Array(this.__P_178_0.filter(callback, self));
      },
      /**
      ...
      map: function map(callback, self) {
        return new qx.data.Array(this.__P_178_0.map(callback, self));
      },
      /**
      ...
      find: function find(callback, self) {
        return this.__P_178_0.find(callback, self);
      },
      /**
      ...
      some: function some(callback, self) {
        return this.__P_178_0.some(callback, self);
      },
      /**
      ...
      every: function every(callback, self) {
        return this.__P_178_0.every(callback, self);
      },
      /**
      ...
      reduce: function reduce(callback, initValue) {
        return this.__P_178_0.reduce(callback, initValue);
      },
      /**
       * Apply a function against an accumulator and each value of the array
      ...
      reduceRight: function reduceRight(callback, initValue) {
        return this.__P_178_0.reduceRight(callback, initValue);
      },
      /*
      ---------------------------------------------------------------------------
        INTERNAL HELPERS
      ...
      */
       ...
       * event will be fired.
       */
      __P_178_1: function __P_178_1() {
        var oldLength = this.length;
        this.length = this.__P_178_0.length;
       ...
       */
      __P_178_2: function __P_178_2(from, to) {
        for (var i = from; i < to; i++) {
          this._registerEventChaining(this.__P_178_0[i], this.__P_178_0[i], i);
        }
      }
    },
    /*
...
//# sourceMappingURL=Array.js.map?dt=1702815218031