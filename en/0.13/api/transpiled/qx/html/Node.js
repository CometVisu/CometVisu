  ...
  qx.Class.define("qx.html.Node", {
    ...
    members: {
      ...
      */
      ...
      getListeners: function getListeners() {
        ...
        for (var id in this.__P_260_0) {
          var listenerData = this.__P_260_0[id];
          listeners.push({
    ...
    */
    destruct: function destruct() {
      ...
      this._properties = this._propertyJobs = this._domNode = this._parent = this.__P_260_0 = null;
    }
  });
  qx.html.Node.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Node.js.map?dt=1778272826393