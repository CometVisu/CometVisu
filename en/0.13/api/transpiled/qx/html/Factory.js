  ...
  qx.Class.define("qx.html.Factory", {
    ...
    members: {
      ...
      registerFactory: function registerFactory(tagName, factory) {
        ...
        if (this.__P_254_0[tagName] === undefined) {
          this.__P_254_0[tagName] = [];
        }
        this.__P_254_0[tagName].push(factory);
      },
      /**
      ...
      createElement: function createElement(tagName, attributes) {
        ...
        var factories = this.__P_254_0[tagName];
        if (factories) {
...
//# sourceMappingURL=Factory.js.map?dt=1778272826174