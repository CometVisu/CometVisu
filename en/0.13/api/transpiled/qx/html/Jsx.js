  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Jsx", {
          ...
          Object.keys(attributes).forEach(function (prop) {
            ...
            if (prop === "ref") {
              if (attributes.ref instanceof qx.html.JsxRef || typeof attributes.ref === "function") {
                ...
                self.warn("Unsupported type of `ref` argument: " + _typeof(attributes.ref));
              }
            } else if (prop === "dangerouslySetInnerHTML") {
              // eslint-disable-next-line no-underscore-dangle
              innerHtml = attributes[prop].__P_240_0;
    ...
    defer: function defer(statics) {
      ...
      var synteticEvents = [MOUSE_EVENTS, TOUCH_EVENTS, KEYBOARD_EVENTS, FOCUS_EVENTS, FORM_EVENTS, UI_EVENTS, IMAGE_EVENTS];
...
//# sourceMappingURL=Jsx.js.map?dt=1672653497100