    ...
    */
    members: {
      ...
      createFlash: function createFlash() {
        this.__P_231_3 = qx.bom.Flash.create(this.getDomElement(), this.getAttributes(), this.__P_231_1, this.__P_231_0);
      },
      ...
      setAttribute: function setAttribute(key, value) {
        if (key.indexOf("$$") === 0) {
          qx.html.Flash.superclass.prototype.setAttribute.call(this, key, value);
        } else if (this.__P_231_3) {
          throw new Error("The attributes cannot be modified after initial creation");
        }

        if (value === null || value === undefined) {
          delete this.__P_231_2[key];
        } else {
          this.__P_231_2[key] = value;
        }
      },
      ...
      setParam: function setParam(key, value) {
        ...
        if (value === null || value === undefined) {
          delete this.__P_231_0[key];
        } else {
          this.__P_231_0[key] = value;
        }
      },
    ...
    destruct: function destruct() {
      if (this.__P_231_3) {
        qx.bom.Flash.destroy(this.__P_231_3);
      }
...
//# sourceMappingURL=Flash.js.map?dt=1664784629718