  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__P_253_0 = styles || null;
      this.__P_253_1 = attributes || null;
      this.__P_253_2 = new Map();
      if (attributes) {
    ...
    statics: {
      ...
      */
      ...
      _scheduleFlush: function _scheduleFlush(job) {
        qx.html.Element.__P_253_6.schedule();
      },
      /**
        ...
        }
        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              // ScrollToX
              if (obj.__P_253_10 != null) {
                obj._domNode.scrollLeft = obj.__P_253_10;
                delete obj.__P_253_10;
              }

              // ScrollToY
              if (obj.__P_253_11 != null) {
                obj._domNode.scrollTop = obj.__P_253_11;
                delete obj.__P_253_11;
              }

              // ScrollIntoViewX
              var intoViewX = obj.__P_253_12;
              if (intoViewX != null) {
       ...
       */
      __P_253_7: function __P_253_7() {
        {
          if (!this.__P_253_4) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__P_253_4 = eventManager.getHandler(qx.event.handler.Focus);
          }
          return this.__P_253_4;
        }
      },
      /**
       ...
       */
      __P_253_9: function __P_253_9() {
        {
          if (!this.__P_253_5) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__P_253_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
          }
          return this.__P_253_5.getCaptureElement();
        }
      },
      /**
       ...
       */
      __P_253_8: function __P_253_8(domElement) {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _serializeImpl: function _serializeImpl(serializer) {
        ...
        // Copy attributes
        if (this.__P_253_1) {
          for (var key in this.__P_253_1) {
            var result = qx.bom.element.Attribute.serialize(key, this.__P_253_1[key]);
      ...
      */
      ...
      hasSlots: function hasSlots(projection) {
        if (projection === null || projection === undefined) {
          return this.__P_253_2.size > 0;
        }
        if (projection === true || projection === qx.html.Slot.DEFAULT) {
          return this.__P_253_2.has(qx.html.Slot.DEFAULT);
        }
        if (typeof projection === "string") {
          return this.__P_253_2.has(projection);
        }
       ...
       */
      __P_253_18: function __P_253_18(slotName) {
      ...
      inject: function inject(childNode, slotNameOverride) {
        ...
        if (!this.__P_253_18(slotName)) {
          return;
        }
        this.__P_253_2.get(slotName).add(childNode);

        // Chaining support
        return this;
      },
      __P_253_19: function __P_253_19(element) {
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(function (child) {
          return slots.push.apply(slots, _toConsumableArray(_this.__P_253_19(child)));
        });
        return slots;
      },
      _slotScanAdd: function _slotScanAdd(element) {
        var _iterator = _createForOfIteratorHelper(this.__P_253_19(element)),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var slot = _step.value;
            this.__P_253_2.set(slot.getName(), slot);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      _slotScanRemove: function _slotScanRemove(child) {
        var _iterator2 = _createForOfIteratorHelper(this.__P_253_19(child)),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var slot = _step2.value;
            this.__P_253_2["delete"](slot.getName());
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      */
      ...
      _syncData: function _syncData() {
        ...
        if (jobs) {
          ...
          this.__P_253_16 = null;
        }

        // Sync styles
        var jobs = this.__P_253_15;
        if (jobs) {
          var data = this.__P_253_0;
          if (data) {
            var styles = {};
      ...
      */
      ...
      setRoot: function setRoot(root) {
        if (root && !this.__P_253_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_253_14) {
          qx.html.Element._hasRoots--;
        }
        this.__P_253_14 = root;
      },
      /*
       * @Override
       */
      isRoot: function isRoot() {
        return this.__P_253_14;
      },
      /**
      ...
      */
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_253_20, this);
      },
      /**
       * Re-enables browser-native scrolling
       */
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__P_253_20, this);
      },
      __P_253_21: null,
      /**
       ...
       */
      __P_253_20: function __P_253_20(e) {
        if (!this.__P_253_21) {
          this.__P_253_21 = true;
          this._domNode.scrollTop = 0;
          this._domNode.scrollLeft = 0;
          delete this.__P_253_21;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setTextSelection: function setTextSelection(start, end) {
        ...
        qx.html.Element.__P_253_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function clearTextSelection() {
        ...
        delete qx.html.Element.__P_253_3[this.toHashCode()];
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_253_22: function __P_253_22(action, args) {
        {
      ...
      capture: function capture(containerCapture) {
        {
          this.__P_253_22("capture", [containerCapture !== false]);
        }
      },
      /**
      ...
      releaseCapture: function releaseCapture() {
        {
          this.__P_253_22("releaseCapture");
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        ...
        if (this.__P_253_0[key] == value) {
          return this;
        }
        this._applyStyle(key, value, this.__P_253_0[key]);
        if (value == null) {
          delete this.__P_253_0[key];
        } else {
          this.__P_253_0[key] = value;
        }
      ...
      getStyle: function getStyle(key) {
        return this.__P_253_0 ? this.__P_253_0[key] : null;
      },
      /**
      ...
      ---------------------------------------------------------------------------
      */
      __P_253_23: function __P_253_23() {
        var map = {};
      ...
      __P_253_24: function __P_253_24(map) {
      ...
      addClass: function addClass(name) {
        ...
        this.setAttribute("class", this.__P_253_24(classes));
        return this;
      },
      /**
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        ...
        if (this.__P_253_1[key] == value) {
          return this;
        }
        if (value == null) {
          delete this.__P_253_1[key];
        } else {
          this.__P_253_1[key] = value;
        }
      ...
      getAttribute: function getAttribute(key) {
        return this.__P_253_1 ? this.__P_253_1[key] : null;
      }
    },
    /*
     *****************************************************************************
    ...
    defer: function defer(statics) {
      statics.__P_253_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
    *****************************************************************************
       DESTRUCT
    ...
    */
    destruct: function destruct() {
      ...
      this.setRoot(false);
      this.__P_253_1 = this.__P_253_0 = this.__P_253_16 = this.__P_253_15 = this.__P_253_12 = this.__P_253_13 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1778272826151