  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct: function construct(callback, context) {
      ...
      this.__P_745_0 = callback;
      this.__P_745_1 = context || null;
      this.__P_745_2 = qx.util.DeferredCallManager.getInstance();
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
      ...
      cancel: function cancel() {
        this.__P_745_2.cancel(this);
      },
      /**
       * Issue a deferred call of the callback.
       */
      schedule: function schedule() {
        this.__P_745_2.schedule(this);
      },
      /**
       * Calls the callback directly.
       */
      call: function call() {
        this.__P_745_1 ? this.__P_745_0.apply(this.__P_745_1) : this.__P_745_0();
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      this.cancel();
      this.__P_745_1 = this.__P_745_0 = this.__P_745_2 = null;
    }
  });
  qx.util.DeferredCall.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DeferredCall.js.map?dt=1782595082090