  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_733_0: function __P_733_0(dataA, dataB) {
       ...
       */
      __P_733_1: function __P_733_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_733_0(dataA, dataB);
        var operations = this.__P_733_1(distance, dataA, dataB);
        return operations;
      }
    }
  });
...
//# sourceMappingURL=EditDistance.js.map?dt=1735383884777