  ...
  qx.Bootstrap.define("qx.util.RingBuffer", {
    ...
    members: {
      ...
      getEntries: function getEntries(count, startingFromMark) {
        ...
        if (count > 0) {
          ...
          if (startIndex <= indexOfYoungestElementInHistory) {
            ...
            result = this.__P_510_4.slice(startIndex, this.__P_510_1).concat(this.__P_510_4.slice(0, indexOfYoungestElementInHistory + 1));
          }
        } else {
          result = [];
        }
      ...
      clear: function clear() {
        this.__P_510_4 = new Array(this.getMaxEntries());
        this.__P_510_1 = 0;
        this.__P_510_3 = 0;
        this.__P_510_0 = 0;
      },
...
//# sourceMappingURL=RingBuffer.js.map?dt=1677345957910