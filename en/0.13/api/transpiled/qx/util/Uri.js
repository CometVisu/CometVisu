  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.util.Uri", {
    statics: {
          ...
          if (obj.hasOwnProperty(key)) {
            ...
            if (value instanceof Array) {
              for (var i = 0; i < value.length; i++) {
                this.__P_741_0(key, value[i], parts, post);
              }
            } else {
              this.__P_741_0(key, value, parts, post);
            }
          }
        }
        return parts.join("&");
       ...
       * @param post {Boolean} Whether spaces should be encoded with "+".
       */
      __P_741_0: function __P_741_0(key, value, parts, post) {
...
//# sourceMappingURL=Uri.js.map?dt=1735341801882