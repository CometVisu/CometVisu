    ...
    members: {
      ...
      */
      ...
      getObject: function getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__P_734_0[clazz.classname];
        if (pool) {
          obj = pool.pop();
        }
        if (obj) {
      ...
      poolObject: function poolObject(obj) {
        ...
        var pool = this.__P_734_0[classname];
        if (obj.$$pooled) {
          throw new Error("Object is already pooled: " + obj);
        }
        if (!pool) {
          this.__P_734_0[classname] = pool = [];
        }
...
//# sourceMappingURL=ObjectPool.js.map?dt=1726089085631