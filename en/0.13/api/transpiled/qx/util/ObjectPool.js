  ...
  qx.Class.define("qx.util.ObjectPool", {
    ...
    members: {
      ...
      */
      ...
      getObject: function getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__P_515_0[clazz.classname];
        if (pool) {
          obj = pool.pop();
        }
        if (obj) {
      ...
      poolObject: function poolObject(obj) {
        ...
        var pool = this.__P_515_0[classname];
        if (obj.$$pooled) {
          throw new Error("Object is already pooled: " + obj);
        }
        if (!pool) {
          this.__P_515_0[classname] = pool = [];
        }
    ...
    */
    destruct: function destruct() {
      ...
      delete this.__P_515_0;
    }
  });
  qx.util.ObjectPool.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ObjectPool.js.map?dt=1702901337310