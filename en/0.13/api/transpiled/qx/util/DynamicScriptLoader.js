  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct: function construct(scriptArr) {
      ...
      this.__P_503_0 = false;
      this.__P_503_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    /*
    *****************************************************************************
       EVENTS
    ...
    */
    ...
    members: {
      ...
      __P_503_4: function __P_503_4() {
        ...
        var uri;
        var loader;
        script = this.__P_503_1.shift();
        if (!script) {
          this.fireEvent("ready");
          return;
        }
        if (DynamicScriptLoader.__P_503_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__P_503_2[script];
        if (dynLoader) {
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__P_503_3[script] = true;
          delete DynamicScriptLoader.__P_503_2[script];
          this.fireDataEvent("loaded", {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__P_503_2[script] = this;
        loader.send();
      }
    },
    destruct: function destruct() {
      var DynamicScriptLoader = qx.util.DynamicScriptLoader;
      for (var key in DynamicScriptLoader.__P_503_2) {
        if (DynamicScriptLoader.__P_503_2[key] === this) {
          delete DynamicScriptLoader.__P_503_2[key];
        }
      }
      this.__P_503_1 = undefined;
    }
  });
  qx.util.DynamicScriptLoader.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DynamicScriptLoader.js.map?dt=1672653519966