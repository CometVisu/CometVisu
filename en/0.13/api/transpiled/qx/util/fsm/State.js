  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_761_0(stateInfo[field], context));
            break;
          case "onexit":
            this.setOnexit(this.__P_761_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_761_1: function __P_761_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_761_2: function __P_761_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_761_3: function __P_761_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_761_8: function __P_761_8(value) {
       ...
       * @return {var} the final value
       */
      __P_761_4: function __P_761_4(value) {
       ...
       * @return {var} the final value
       */
      __P_761_5: function __P_761_5(value) {
       ...
       * @return {var} the final value
       */
      __P_761_6: function __P_761_6(value) {
       ...
       * @return {var} the final value
       */
      __P_761_7: function __P_761_7(value) {
       ...
       *   unaltered.
       */
      __P_761_0: function __P_761_0(f, context) {
...
//# sourceMappingURL=State.js.map?dt=1778272856165