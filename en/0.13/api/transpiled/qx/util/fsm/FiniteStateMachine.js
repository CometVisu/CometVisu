  ...
  qx.Class.define("qx.util.fsm.FiniteStateMachine", {
    ...
    members: {
      ...
      replaceState: function replaceState(state, bDispose) {
        ...
        var oldState = this.__P_743_0[stateName];
      ...
      addObject: function addObject(friendlyName, obj, groupNames) {
        ...
        this.__P_743_6[friendlyName] = hash;
        this.__P_743_7[hash] = friendlyName;
        this.__P_743_5[friendlyName] = obj;
        ...
        for (var i = 0; i < groupNames.length; i++) {
          ...
          if (!this.__P_743_8[groupName]) {
            // ... then create it.
            this.__P_743_8[groupName] = {};
          }

          // Add the friendly name to the list of names in this group
          this.__P_743_8[groupName][friendlyName] = true;

          // If the friendly name group mapping doesn't yet exist...
          if (!this.__P_743_9[friendlyName]) {
            // ... then create it.
            this.__P_743_9[friendlyName] = [];
          }

          // Append this group name to the list of groups this friendly name is
          // in
          this.__P_743_9[friendlyName].push(groupName);
        }
      },
      /**
      ...
      removeObject: function removeObject(friendlyName) {
        ...
        var objName;
        var bGroupEmpty;
        hash = this.__P_743_6[friendlyName];

        // Delete references to any groups this friendly name was in
        if (this.__P_743_9[friendlyName]) {
          for (var i = 0; i < this.__P_743_9[friendlyName].length; i++) {
            groupName = this.__P_743_9[friendlyName][i];
            delete this.__P_743_8[groupName][friendlyName];

            // Is the group empty now?
            bGroupEmpty = true;
            for (objName in this.__P_743_8[groupName]) {
            ...
            if (bGroupEmpty) {
              ...
              delete this.__P_743_8[groupName];
            }
          }
          delete this.__P_743_9[friendlyName];
        }

        // Delete the friendly name
        delete this.__P_743_7[hash];
        delete this.__P_743_6[friendlyName];
        delete this.__P_743_5[friendlyName];
      },
      /**
      ...
      getObject: function getObject(friendlyName) {
        return this.__P_743_5[friendlyName];
      },
      /**
      ...
      getFriendlyName: function getFriendlyName(obj) {
        ...
        return hash ? this.__P_743_7[hash] : null;
      },
      /**
      ...
      getGroupObjects: function getGroupObjects(groupName) {
        var a = [];
        for (var name in this.__P_743_8[groupName]) {
          a.push(name);
        }
        return a;
      },
      ...
      displayAllObjects: function displayAllObjects() {
        for (var friendlyName in this.__P_743_6) {
          var hash = this.__P_743_6[friendlyName];
          var obj = this.getObject(friendlyName);
          this.debug(friendlyName + " => " + hash);
          this.debug("  " + hash + " => " + this.__P_743_7[hash]);
      ...
      _getInternalData: function _getInternalData() {
        return {
          states: this.__P_743_0,
          startState: this.__P_743_1,
          eventQueue: this.__P_743_3,
          blockedEvents: this.__P_743_4,
          savedStates: this.__P_743_2,
          friendlyToObject: this.__P_743_5,
          friendlyToHash: this.__P_743_6,
          hashToFriendly: this.__P_743_7,
          groupToFriendly: this.__P_743_8,
          friendlyToGroups: this.__P_743_9
        };
      },
      /**
      ...
      start: function start() {
        this.__P_743_11 = false;
        var stateName = this.__P_743_1;
        if (stateName == null) {
      ...
      popState: function popState() {
        ...
        if (this.__P_743_2.length == 0) {
          // Nope. Programmer error.
          throw new Error("Saved-state stack is empty");
        }
        return this.__P_743_2.pop();
      },
      /**
      ...
      enqueueEvent: function enqueueEvent(event, bAddAtHead) {
        ...
        if (bAddAtHead) {
          ...
          this.__P_743_3.push(event);
        } else {
          // Put event at the tail of the queue
          this.__P_743_3.unshift(event);
        }
       ...
       *
       */
      __P_743_12: function __P_743_12() {
       ...
       */
      __P_743_13: function __P_743_13(event) {
        ...
        currentState = this.__P_743_0[thisState];
        ...
        for (var t in transitions) {
          ...
          if (typeof nextState == "string") {
            ...
            if (!nextState in this.__P_743_0) {
          ...
          currentState = this.__P_743_0[this.getNextState()];
          ...
          for (var i = 0; i < this.__P_743_4.length; i++) {
            e = this.__P_743_4.pop();
            this.__P_743_3.unshift(e);
          }
          if (debugTransitions) {
    ...
    destruct: function destruct() {
      this._disposeArray("__P_743_3");
      this._disposeArray("__P_743_4");
      this.__P_743_2 = this.__P_743_0 = null;
    }
  });
  qx.util.fsm.FiniteStateMachine.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FiniteStateMachine.js.map?dt=1717235421014