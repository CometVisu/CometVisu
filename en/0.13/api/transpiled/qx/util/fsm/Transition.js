  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_746_0(transitionInfo[field], context));
            break;
          case "nextState":
            this.setNextState(transitionInfo[field]);
            break;
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_746_0(transitionInfo[field], context));
            break;
          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_746_0(transitionInfo[field], context));
            break;
          case "ontransition":
            this.setOntransition(this.__P_746_0(transitionInfo[field], context));
            break;
          case "context":
            // already handled
            break;
    ...
    members: {
       ...
       */
      __P_746_1: function __P_746_1(value) {
       ...
       */
      __P_746_2: function __P_746_2(value) {
       ...
       * @return {Function} the final value
       */
      __P_746_3: function __P_746_3(value) {
       ...
       * @return {Function} the final value
       */
      __P_746_4: function __P_746_4(value) {
       ...
       * @return {Function} the final value
       */
      __P_746_5: function __P_746_5(value) {
       ...
       *   unaltered.
       */
      __P_746_0: function __P_746_0(f, context) {
...
//# sourceMappingURL=Transition.js.map?dt=1735383885398