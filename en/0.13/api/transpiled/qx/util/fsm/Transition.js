  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_762_0(transitionInfo[field], context));
            break;
          case "nextState":
            this.setNextState(transitionInfo[field]);
            break;
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_762_0(transitionInfo[field], context));
            break;
          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_762_0(transitionInfo[field], context));
            break;
          case "ontransition":
            this.setOntransition(this.__P_762_0(transitionInfo[field], context));
            break;
          case "context":
            // already handled
            break;
    ...
    members: {
       ...
       */
      __P_762_1: function __P_762_1(value) {
       ...
       */
      __P_762_2: function __P_762_2(value) {
       ...
       * @return {Function} the final value
       */
      __P_762_3: function __P_762_3(value) {
       ...
       * @return {Function} the final value
       */
      __P_762_4: function __P_762_4(value) {
       ...
       * @return {Function} the final value
       */
      __P_762_5: function __P_762_5(value) {
       ...
       *   unaltered.
       */
      __P_762_0: function __P_762_0(f, context) {
...
//# sourceMappingURL=Transition.js.map?dt=1778272856187