  ...
  qx.Class.define("qx.util.LibraryManager", {
    ...
    members: {
      ...
      has: function has(namespace) {
        return !!qx.util.LibraryManager.__P_750_0[namespace];
      },
      /**
      ...
      getNamespaces: function getNamespaces() {
        return Object.keys(qx.util.LibraryManager.__P_750_0);
      },
      /**
      ...
      get: function get(namespace, key) {
        return qx.util.LibraryManager.__P_750_0[namespace][key] ? qx.util.LibraryManager.__P_750_0[namespace][key] : null;
      },
      /**
      ...
      set: function set(namespace, key, value) {
        qx.util.LibraryManager.__P_750_0[namespace][key] = value;
      }
    }
  });
...
//# sourceMappingURL=LibraryManager.js.map?dt=1778272855604