    ...
    members: {
      ...
      testFilenameConverterDefault: function testFilenameConverterDefault() {
        ...
        for (var i = 0, l = stack.length; i < l; i++) {
          this.assertMatch(stack[i], /((?:qx\.)|(?:qxl\.testtapper)|(?:qxl\.testrunner)|(?:testrunner\.js)|(?:tests\.js)|(?:qooxdoo-adapter\.js))/);
        }
      },
...
//# sourceMappingURL=StackTrace.js.map?dt=1735383860682