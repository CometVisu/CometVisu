  ...
  qx.Class.define("qx.test.locale.Locale", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_363_0 = manager.getLocale();
      },
      tearDown: function tearDown() {
        var manager = qx.locale.Manager.getInstance();
        manager.setLocale(this.__P_363_0);
        if (this.__P_363_1) {
          manager.removeListenerById(this.__P_363_1);
        }
      },
      testTranslation: function testTranslation() {
        ...
        var fired = false;
        var evtLocale = "";
        this.__P_363_1 = manager.addListener("changeLocale", function (e) {
          fired = true;
          evtLocale = e.getData();
        });
...
//# sourceMappingURL=Locale.js.map?dt=1778272834212