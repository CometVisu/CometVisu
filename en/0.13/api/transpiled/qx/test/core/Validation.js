  ...
  qx.Class.define("qx.test.core.Validation", {
    ...
    construct: function construct() {
      ...
      qx.Class.define("qx.Model", {
        ...
        members: {
          _validateCustom: function _validateCustom(value) {
      ...
      this.__P_336_0 = new qx.Model();
    },
    members: {
      testNumber: function testNumber() {
        var model = this.__P_336_0;
      ...
      testColor: function testColor() {
        ...
        }, qx.core.ValidationError, null, "#FFFFGG is not a color!");
      ...
      testRange: function testRange() {
        ...
        }, qx.core.ValidationError, null, "A 2.000000001 is not between 1 and 2.");
      ...
      testInArray: function testInArray() {
        ...
        this.assertException(function () {
          model.setArray("");
        }, qx.core.ValidationError, null, "A empty string is not in ['male', 'female']");
      ...
      testCustom: function testCustom() {
        ...
        this.assertException(function () {
          model.setCustom("123");
        }, qx.core.ValidationError, null, "'123' is too short");
      ...
      testRegExp: function testRegExp() {
        ...
        this.assertException(function () {
          model.setRegExp("$%&!&/%");
        }, qx.core.ValidationError, null, "$%&!&/% does not fit /[0-9]*/.");
...
//# sourceMappingURL=Validation.js.map?dt=1782595061638