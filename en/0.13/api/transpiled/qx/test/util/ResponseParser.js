  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.util.ResponseParser", {
    ...
    members: {
      ...
      __P_463_0: function __P_463_0(contentType, parser) {
      ...
      "test: getParser() returns undefined for unknown": function test_getParser_returns_undefined_for_unknown() {
        this.__P_463_0("text/html", undefined);
        this.__P_463_0("application/pdf", undefined);
      },
      "test: getParser() returns undefined for malformed": function test_getParser_returns_undefined_for_malformed() {
        this.__P_463_0("", undefined);
        this.__P_463_0("json", undefined);
        this.__P_463_0("text/foo+json", undefined);
        this.__P_463_0("application/foo+jsonish", undefined);
        this.__P_463_0("application/foo+xmlish", undefined);
      },
      "test: getParser() detects json": function test_getParser_detects_json() {
        var json = qx.util.ResponseParser.PARSER.json;
        this.__P_463_0("application/json", json);
        this.__P_463_0("application/vnd.affe+json", json);
        this.__P_463_0("application/prs.affe+json", json);
        this.__P_463_0("application/vnd.oneandone.onlineoffice.email+json", json);
      },
      "test: getParser() detects xml": function test_getParser_detects_xml() {
        var xml = qx.util.ResponseParser.PARSER.xml;
        this.__P_463_0("application/xml", xml);
        this.__P_463_0("application/vnd.oneandone.domains.domain+xml", xml);
        this.__P_463_0("text/xml"); // Deprecated
      },
      "test: getParser() detects deprecated xml": function test_getParser_detects_deprecated_xml() {
        var xml = qx.util.ResponseParser.PARSER.xml;
        this.__P_463_0("text/xml");
      },
      "test: getParser() handles character set": function test_getParser_handles_character_set() {
        var json = qx.util.ResponseParser.PARSER.json;
        this.__P_463_0("application/json; charset=utf-8", json);
      },
...
//# sourceMappingURL=ResponseParser.js.map?dt=1782595068130