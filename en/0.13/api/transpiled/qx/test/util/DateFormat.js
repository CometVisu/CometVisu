  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.util.DateFormat", {
    ...
    members: {
      ...
      __P_447_1: function __P_447_1(number, minSize) {
        var str = "" + number;
      ...
      __P_447_2: function __P_447_2(absYear, formattedSize, yearsign) {
      ...
      testDateParse: function testDateParse() {
        for (var i = 0; i < this.__P_447_0.length; i++) {
          var date = this.__P_447_0[i].date;
      ...
      testPattern_y_: function testPattern_y_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          var expectedYear = this.__P_447_2(absYear, 4, yearsign);
          ...
          var expectedYear = this.__P_447_2(absYear, 3, yearsign);
          this.assertEquals(expectedYear, df.format(date));
          df.dispose();
          ...
          var expectedYear = this.__P_447_2(absYear, 5, yearsign);
          this.assertEquals(expectedYear, df.format(date));
          df.dispose();

          // case yyyyy
          df = new qx.util.format.DateFormat("yyyyyyyyyyy");
          var expectedYear = this.__P_447_2(absYear, 11, yearsign);
          this.assertEquals(expectedYear, df.format(date));
          df.dispose();
        }
      },
      testPattern_M_: function testPattern_M_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          this.assertEquals(expectedYear + "/" + this.__P_447_1(realMonth, 2), df.format(date));
          df.dispose();
      ...
      testPattern_L_: function testPattern_L_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          this.assertEquals(this.__P_447_1(realMonth, 2), df.format(date));
          df.dispose();
      ...
      testPattern_w_: function testPattern_w_() {
        var df;
        for (var i = 0; i < this.__P_447_0.length; i++) {
          if (this.__P_447_0[i].result.weekOfYear) {
            var date = this.__P_447_0[i].date;
            var weekOfYear = this.__P_447_0[i].result.weekOfYear + "";
            df = new qx.util.format.DateFormat("w");
            this.assertEquals(weekOfYear, df.format(date));
            df.dispose();
            df = new qx.util.format.DateFormat("ww");
            this.assertEquals(this.__P_447_1(weekOfYear, 2), df.format(date));
            df.dispose();
          }
        }
      },
      testPattern_d_: function testPattern_d_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          this.assertEquals(this.__P_447_1(dayOfMonth, 2), df.format(date));
          df.dispose();
        }
      },
      testPattern_D_: function testPattern_D_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          var date = this.__P_447_0[i].date;
          if (this.__P_447_0[i].result.dayOfYear) {
            var dayOfYear = this.__P_447_0[i].result.dayOfYear + "";
            df = new qx.util.format.DateFormat("D");
            this.assertEquals(dayOfYear, df.format(date));
            df.dispose();
            df = new qx.util.format.DateFormat("DD");
            this.assertEquals(this.__P_447_1(dayOfYear, 2), df.format(date));
            df.dispose();
            df = new qx.util.format.DateFormat("DDD");
            this.assertEquals(this.__P_447_1(dayOfYear, 3), df.format(date));
            df.dispose();
          }
      ...
      testPattern_E_: function testPattern_E_() {
        ...
        var locale = qx.locale.Manager.getInstance().getLocale();
        for (var i = 0; i < this.__P_447_0.length; i++) {
          if (this.__P_447_0[i].result.dayOfWeek) {
            var date = this.__P_447_0[i].date;
            var fullYear = "" + date.getFullYear();
            var dayOfWeek = this.__P_447_0[i].result.dayOfWeek;
      ...
      testPattern_h_: function testPattern_h_() {
        var df;
        for (var i = 0; i < this.__P_447_0.length; i++) {
          if (this.__P_447_0[i].result.h_hour) {
            var date = this.__P_447_0[i].date;
            var hour = this.__P_447_0[i].result.h_hour;
            df = new qx.util.format.DateFormat("h");
            this.assertEquals(hour + "", df.format(date));
            df.dispose();
            df = new qx.util.format.DateFormat("hh");
            this.assertEquals(this.__P_447_1(hour, 2), df.format(date));
            df.dispose();
          }
        }
      },
      ...
      testPattern_k_: function testPattern_k_() {
        var df;
        for (var i = 0; i < this.__P_447_0.length; i++) {
          if (this.__P_447_0[i].result.k_hour) {
            var date = this.__P_447_0[i].date;
            var hour = this.__P_447_0[i].result.k_hour;
      ...
      testPattern_m_: function testPattern_m_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          this.assertEquals(this.__P_447_1(min, 2), df.format(date));
          df.dispose();
        }
      },
      testPattern_s_: function testPattern_s_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          this.assertEquals(this.__P_447_1(sec, 2), df.format(date));
          df.dispose();
        }
      },
      testPattern_S_: function testPattern_S_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          var msec = this.__P_447_1(date.getMilliseconds(), 3);
          df = new qx.util.format.DateFormat("S");
      ...
      testPattern_z_: function testPattern_z_() {
        ...
        for (var i = 0; i < this.__P_447_0.length; i++) {
          ...
          var localTimeZone = "GMT" + (timezoneSign > 0 ? "-" : "+") + this.__P_447_1(Math.abs(timezoneHours), 2) + ":" + this.__P_447_1(timezoneMinutes, 2);
      ...
      testPattern_G_: function testPattern_G_() {
        var df;
        for (var i = 0; i < this.__P_447_0.length; i++) {
          if (this.__P_447_0[i].result.era) {
            var date = this.__P_447_0[i].date;
            var era = this.__P_447_0[i].result.era;
...
//# sourceMappingURL=DateFormat.js.map?dt=1729101247682