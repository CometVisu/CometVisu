(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.mobile.tabbar.TabBar", {
    ...
    members: {
      __P_373_0: function __P_373_0() {
        var tabBar = new qx.ui.mobile.tabbar.TabBar();
        this.getRoot().add(tabBar);
        return tabBar;
      },
      __P_373_1: function __P_373_1(tabBar, tabNumber) {
...
//# sourceMappingURL=TabBar.js.map?dt=1782595064489