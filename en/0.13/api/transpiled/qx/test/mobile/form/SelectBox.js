  ...
  qx.Class.define("qx.test.mobile.form.SelectBox", {
    ...
    members: {
      ...
      testNullable: function testNullable() {
        ...
        this.assertException(qx.lang.Function.bind(selectBox.setSelection, selectBox, null), qx.core.ValidationError, "Validation Error: SelectBox is not nullable", "Value should not be accepted when SelectBox is not nullable.");
...
//# sourceMappingURL=SelectBox.js.map?dt=1729101242553