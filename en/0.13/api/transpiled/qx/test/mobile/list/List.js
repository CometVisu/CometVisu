  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.mobile.list.List", {
    ...
    members: {
      ...
      __P_361_1: function __P_361_1(createItemRenderer, configureItemFunction) {
        var list = new qx.ui.mobile.list.List();
        this.getRoot().add(list);
        list.setDelegate({
          configureItem: configureItemFunction ? configureItemFunction : this.__P_361_2,
          createItemRenderer: createItemRenderer ? createItemRenderer : null
        });
        list.setModel(this.__P_361_0());
        return list;
      },
      __P_361_2: function __P_361_2(item, data, row) {
        item.setImage(data.image);
        item.setTitle(data.title);
        item.setSubtitle(data.subtitle);
      },
      __P_361_3: function __P_361_3(list, dataLength) {
        var childrenLength = list.getContentElement().childNodes.length;
        this.assertEquals(dataLength, childrenLength);
      },
      __P_361_4: function __P_361_4(list) {
        list.destroy();
      ...
      testCreate: function testCreate() {
        var list = this.__P_361_1();
        this.__P_361_3(list, 5);
        this.__P_361_4(list);
      },
      testCustomRenderer: function testCustomRenderer() {
        var list = this.__P_361_1(function () {
...
//# sourceMappingURL=List.js.map?dt=1735341779634