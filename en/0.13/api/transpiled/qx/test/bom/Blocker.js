  ...
  qx.Class.define("qx.test.bom.Blocker", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_316_0 = new qx.bom.Blocker();
        this.__P_316_0.setBlockerZIndex(199);
        this.__P_316_1 = qx.dom.Element.create("div");
        qx.bom.element.Style.setStyles(this.__P_316_1, {
          position: "absolute",
          top: "100px",
          left: "100px",
          width: "500px",
        ...
        qx.dom.Element.insertBegin(this.__P_316_1, document.body);
      },
      tearDown: function tearDown() {
        this.__P_316_0.unblock();
        this.__P_316_0.dispose();
        this.__P_316_0 = null;
        qx.dom.Element.remove(this.__P_316_1);
      },
      testBlockWholeDocument: function testBlockWholeDocument() {
        this.__P_316_0.block();
        var blockerElement = this.__P_316_0.getBlockerElement();
      ...
      testBlockElement: function testBlockElement() {
        this.__P_316_0.block(this.__P_316_1);
        ...
        qx.event.Timer.once(function () {
          ...
          this.resume(function () {
            var blockerElement = self.__P_316_0.getBlockerElement();
            self.assertNotNull(blockerElement, "Blocker element not inserted.");
            self.assertEquals(qx.bom.element.Dimension.getWidth(self.__P_316_1), qx.bom.element.Dimension.getWidth(blockerElement));
            self.assertEquals(qx.bom.element.Dimension.getHeight(self.__P_316_1), qx.bom.element.Dimension.getHeight(blockerElement));
            self.assertEquals(qx.bom.element.Location.getLeft(self.__P_316_1), qx.bom.element.Location.getLeft(blockerElement));
            self.assertEquals(qx.bom.element.Location.getTop(self.__P_316_1), qx.bom.element.Location.getTop(blockerElement));
            self.assertEquals(qx.bom.element.Style.get(self.__P_316_1, "zIndex") - 1, qx.bom.element.Style.get(blockerElement, "zIndex"));
            if (qx.core.Environment.get("engine.name") == "mshtml") {
              var childElements = qx.dom.Hierarchy.getChildElements(document.body);
              var blockerIframeElement = childElements[childElements.length - 1];
              self.assertEquals(qx.bom.element.Style.get(self.__P_316_1, "zIndex") - 2, qx.bom.element.Style.get(blockerIframeElement, "zIndex"));
            }
            self.__P_316_0.unblock();
          }, self);
        }, this, 1000);
        this.wait();
      },
      testBlockerColor: function testBlockerColor() {
        this.__P_316_0.setBlockerColor("#FF0000");
        this.__P_316_0.block();
        var blockerElement = this.__P_316_0.getBlockerElement();
      ...
      testBlockerOpacity: function testBlockerOpacity() {
        this.__P_316_0.setBlockerOpacity(0.7);
        this.__P_316_0.block();
        var blockerElement = this.__P_316_0.getBlockerElement();
      ...
      testDoubleUnBlocking: function testDoubleUnBlocking() {
        ...
        this.__P_316_0.unblock();
        var blockerElement = this.__P_316_0.getBlockerElement();
        this.assertNotEquals(blockerElement.parentNode, this.__P_316_1);
      }
    }
  });
...
//# sourceMappingURL=Blocker.js.map?dt=1778272830080