  ...
  qx.Class.define("qx.test.bom.Cookie", {
    ...
    members: {
      testSaveSimpleData: function testSaveSimpleData() {
        ...
        this.assertEquals(dataToSave, result, "It is expected that this test fails if you start this test from a file system with Google Chrome.");
      ...
      testSaveData: function testSaveData() {
        ...
        this.assertEquals(dataToSave2, result2, "It is expected that this test fails if you start this test from a file system with Google Chrome.");
...
//# sourceMappingURL=Cookie.js.map?dt=1735341775029