  ...
  qx.Class.define("qx.test.bom.Location", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_311_0 = qx.dom.Element.create("div", {
          id: "testRoot"
        });
        document.body.appendChild(this.__P_311_0);
        this.__P_311_1 = document.body.style;
        this.__P_311_2 = this.__P_311_1.marginTop;
        this.__P_311_3 = this.__P_311_1.marginLeft;
        this.__P_311_4 = this.__P_311_1.left;
        this.__P_311_5 = this.__P_311_1.top;
        this.__P_311_6 = this.__P_311_1.position;
        this.__P_311_7 = this.__P_311_1.border;
        this.__P_311_8 = this.__P_311_1.padding;

        // set up the defaults
        this.__P_311_1.marginLeft = "0px";
        this.__P_311_1.marginTop = "0px";
        this.__P_311_1.left = "0px";
        this.__P_311_1.top = "0px";
        this.__P_311_1.position = "static";
        this.__P_311_1.padding = "0px";
      },
      tearDown: function tearDown() {
        this.__P_311_1.marginTop = this.__P_311_2;
        this.__P_311_1.marginLeft = this.__P_311_3;
        this.__P_311_1.top = this.__P_311_5;
        this.__P_311_1.left = this.__P_311_4;
        this.__P_311_1.position = this.__P_311_6;
        this.__P_311_1.border = this.__P_311_7;
        this.__P_311_1.padding = this.__P_311_8;
        document.body.removeChild(this.__P_311_0);
        this.__P_311_0 = null;
      },
      ...
      testDivWithBodyMargin: function testDivWithBodyMargin() {
        this.__P_311_1.marginLeft = "10px";
        this.__P_311_1.marginTop = "20px";
        this.__P_311_0.innerHTML = '<div id="div">affe</div>';
      ...
      testDivWithBodyPadding: function testDivWithBodyPadding() {
        this.__P_311_1.padding = "10px";
        this.__P_311_0.innerHTML = '<div id="div"></div>';
        var div = document.getElementById("div");
        var pos = qx.bom.element.Location.get(div);
        this.assertEquals(10, pos.left);
        this.assertEquals(10, pos.top);
      ...
      testDivWithBodyBorder: function testDivWithBodyBorder() {
        this.__P_311_1.border = "10px solid black";
        this.__P_311_0.innerHTML = '<div id="div">juhu</div>';
        var div = document.getElementById("div");
        var pos = qx.bom.element.Location.get(div);
      ...
      testDivLocationMode: function testDivLocationMode() {
        this.__P_311_0.innerHTML = '<div id="div" style="margin: 5px; padding: 10px; border: 3px solid green;"></div>';
        var div = document.getElementById("div");
      ...
      testDivInline: function testDivInline() {
        this.__P_311_0.innerHTML = "<div style=\"width:100px\"><span id=\"span1\" style=\"margin-left: 10px\"><img src=\"about:blank\" width=\"10px\" height=\"10px\" style=\"border: 0px\"></img></span><span id=\"span2\" style=\"margin-left: 10px\">a</span></div>";
      ...
      testDivFixed: function testDivFixed() {
        this.__P_311_0.innerHTML = "<div style=\"position: absolute; left: 0px; top: 0px; width: 20px; height: 2000px;\"></div><div id=\"test\" style=\"position: fixed; width: 300px; height: 600px; top: 50px;\"></div>";
...
//# sourceMappingURL=Location.js.map?dt=1735222425567