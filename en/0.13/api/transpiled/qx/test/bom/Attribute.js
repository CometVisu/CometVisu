    ...
    members: {
      ...
      testGetAttribute: function testGetAttribute() {
        ...
        if (qx.core.Environment.get("browser.name") == "edge") {
          this.assertEquals(Attribute.get(this._input, "maxLength"), this.__P_315_0.mshtml);
        } else if (qx.core.Environment.get("browser.name") == "chrome" || qx.core.Environment.get("browser.name") == "safari") {
          this.assertEquals(Attribute.get(this._input, "maxLength"), this.__P_315_0["default"]);
        } else {
      ...
      testRemoveAttribute: function testRemoveAttribute() {
        ...
        var maxLengthValue = qx.core.Environment.select("engine.name", this.__P_315_0);
        if (qx.core.Environment.get("browser.name") == "edge") {
          maxLengthValue = this.__P_315_0.mshtml;
        } else if (qx.core.Environment.get("browser.name") == "chrome" || qx.core.Environment.get("browser.name") == "safari") {
          maxLengthValue = this.__P_315_0["default"];
        }
...
//# sourceMappingURL=Attribute.js.map?dt=1782595060462