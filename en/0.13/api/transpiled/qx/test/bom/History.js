  ...
  qx.Class.define("qx.test.bom.History", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_308_0 = qx.bom.History.getInstance();
      },
      ...
      testAddState: function testAddState() {
        this.__P_308_0.addToHistory("foo", "Title Foo");
        var self = this;
      ...
      __P_308_2: function __P_308_2() {
        var self = this;
        this.assertEquals("foo", this.__P_308_0._readState(), "check1");
        this.__P_308_0.addToHistory("bar", "Title Bar");
        window.setTimeout(function () {
          self.resume(function () {
            this.__P_308_3();
          }, self);
      ...
      __P_308_3: function __P_308_3() {
        var self = this;
        this.assertEquals("bar", this.__P_308_0._readState(), "check2");
        history.back();
        window.setTimeout(function () {
          self.resume(function () {
            this.__P_308_1();
      ...
      __P_308_1: function __P_308_1() {
        this.assertEquals("foo", this.__P_308_0._readState(), "check3");
        this.assertEquals("Title Foo", this.__P_308_0.getTitle());
      },
      testNavigateBackAfterSetState: function testNavigateBackAfterSetState() {
        this.__P_308_0.setState("affe");
        var self = this;
        window.setTimeout(function () {
          self.resume(function () {
            this.__P_308_4();
      ...
      __P_308_4: function __P_308_4() {
        var self = this;
        this.assertEquals("affe", this.__P_308_0._readState(), "check0");
        this.__P_308_0.setState("foo");
        window.setTimeout(function () {
          self.resume(function () {
            this.__P_308_5();
          }, self);
      ...
      __P_308_5: function __P_308_5() {
        var self = this;
        this.assertEquals("foo", this.__P_308_0._readState(), "check1");
        this.__P_308_0.setState("bar");
        window.setTimeout(function () {
          self.resume(function () {
            this.__P_308_6();
          }, self);
      ...
      testRequestEvent: function testRequestEvent() {
        ...
        // the history
        var self = this;
        this.__P_308_0.addListenerOnce("request", function () {
          self.resume(function () {
      ...
      testRequestEventAddHistory: function testRequestEventAddHistory() {
        var _this = this;
        this.__P_308_0.addListenerOnce("request", function (ev) {
        ...
        var self = this;
        window.setTimeout(function () {
          self.__P_308_0.addToHistory("baz");
        }, 250);
        this.wait(500);
      }
    }
...
//# sourceMappingURL=History.js.map?dt=1735383858318