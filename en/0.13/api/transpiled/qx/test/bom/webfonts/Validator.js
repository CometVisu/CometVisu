  ...
  qx.Class.define("qx.test.bom.webfonts.Validator", {
    ...
    members: {
      setUp: function setUp() {
        ...
        this.__P_333_0 = new qx.bom.webfonts.Validator();
      },
      tearDown: function tearDown() {
        if (this.__P_333_0) {
          this.__P_333_0.dispose();
          delete this.__P_333_0;
        }
        qx.bom.webfonts.Validator.removeDefaultHelperElements();
      },
      testValidFont: function testValidFont() {
        var _this = this;
        this.__P_333_0.setFontFamily("monospace, courier");
        this.__P_333_0.addListener("changeStatus", function (ev) {
        ...
        window.setTimeout(function () {
          that.__P_333_0.validate();
        }, 0);
        this.wait(10000);
      },
      testInvalidFont: function testInvalidFont() {
        var _this2 = this;
        this.__P_333_0.setFontFamily("zzzzzzzzzzzzzzz");
        this.__P_333_0.setTimeout(250);
        this.__P_333_0.addListener("changeStatus", function (ev) {
          var result = ev.getData();
...
//# sourceMappingURL=Validator.js.map?dt=1778272831041