  ...
  qx.Class.define("qx.test.ui.tree.TreeFolder", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        // - AA ("item")
        // - BB
        var tree = this.__P_435_0 = new qx.ui.tree.Tree();
        var root = this.__P_435_1 = new qx.ui.tree.TreeFolder("A");
        tree.setRoot(root);
        root.setOpen(true);
        var aa = this.__P_435_2 = new qx.ui.tree.TreeFolder("AA");
        var ab = this.__P_435_3 = new qx.ui.tree.TreeFolder("AB");
        root.add(aa, ab);

        // Reference to "aa" as "item"
        this.__P_435_4 = this.__P_435_2;
      ...
      testIconWhenClosed: function testIconWhenClosed() {
        var item = this.__P_435_4;
        this.flush();
        this.__P_435_5(item, this.__P_435_6(item));
      },
      testIconWhenClosedWithIcon: function testIconWhenClosedWithIcon() {
        var item = this.__P_435_4;
        item.setIcon(this.icon_closed);
        this.flush();
        this.__P_435_5(item, this.icon_closed);
      },
      ...
      testIconWhenOpened: function testIconWhenOpened() {
        ...
        item.setOpen(true);
        this.flush();
        this.__P_435_5(item, this.__P_435_7(item));
      },
      ...
      testIconWhenOpenedWithIconOpened: function testIconWhenOpenedWithIconOpened() {
        ...
        item.setIconOpened(this.icon_opened);
        this.flush();
        this.__P_435_5(item, this.icon_opened);
      },
      ...
      testRemoveAll: function testRemoveAll() {
        var removed = this.__P_435_1.removeAll();
        this.assertEquals(2, removed.length);
        this.assertEquals(this.__P_435_2, removed[0]);
        this.assertEquals(this.__P_435_3, removed[1]);
      },
      //
      // Helper methods
      //
      __P_435_6: function __P_435_6(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "icon");
      },
      __P_435_7: function __P_435_7(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "iconOpened");
      },
      __P_435_5: function __P_435_5(item, expected) {
      ...
      tearDown: function tearDown() {
        ...
        this.__P_435_0.destroy();
        this.__P_435_1.destroy();
        this.__P_435_2.destroy();
        this.__P_435_3.destroy();
      }
    }
  });
...
//# sourceMappingURL=TreeFolder.js.map?dt=1735222432820