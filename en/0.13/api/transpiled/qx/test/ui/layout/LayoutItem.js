  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.layout.LayoutItem", {
    ...
    members: {
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (changes.size || changes.local || changes.margin) {
          if (this.__P_435_0 && this.getLayoutChildren().length > 0) {
            this.__P_435_0.renderLayout(width, height, {
              top: 0,
              right: 0,
              bottom: 0,
              left: 0
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        if (this.__P_435_0) {
          this.__P_435_0.invalidateLayoutCache();
        }
      },
      invalidateLayoutChildren: function invalidateLayoutChildren() {
        var layout = this.__P_435_0;
        if (layout) {
      ...
      _getContentHint: function _getContentHint() {
        if (this.__P_435_0 && this.getLayoutChildren().length > 0) {
          return this.__P_435_0.getSizeHint();
        } else {
          return {
            width: 0,
            height: 0
      ...
      add: function add(child, options) {
        ...
        this.__P_435_1.push(child);
        this.__P_435_0.invalidateChildrenCache();
        if (options) {
      ...
      remove: function remove(child) {
        ...
        qx.lang.Array.remove(this.__P_435_1, child);
    ...
    destruct: function destruct() {
      this.bounds = this.__P_435_0 = this.__P_435_1 = null;
    }
  });
  qx.test.ui.layout.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1778272837154