  ...
  qx.Class.define("qx.test.ui.form.RadioButtonGroup", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_419_0 = new qx.ui.form.RadioButtonGroup();
        this.__P_419_1 = [];
        var radioButton;
        for (var i = 0, j = 10; i < j; i++) {
          radioButton = new qx.ui.form.RadioButton("option " + i);
          radioButton.setModel("option" + i);
          this.__P_419_1.push(radioButton);
          this.__P_419_0.add(radioButton);
        }
      },
      tearDown: function tearDown() {
        qx.test.ui.form.RadioButtonGroup.superclass.prototype.tearDown.call(this);
        this.__P_419_0.removeAll();
        this.__P_419_1 = null;
      },
      testRemoveAll: function testRemoveAll() {
        this.__P_419_0.removeAll();
        var amountOfRadioButtons = this.__P_419_0.getRadioGroup().getItems().length;
...
//# sourceMappingURL=RadioButtonGroup.js.map?dt=1778272836715