(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.BooleanFormat", {
    ...
    members: {
      __P_403_0: function __P_403_0(widget, initValue) {
      ...
      testCheckBox: function testCheckBox() {
        this.__P_403_0(new qx.ui.form.CheckBox(), false);
      },
      testToggleButton: function testToggleButton() {
        this.__P_403_0(new qx.ui.form.ToggleButton(), false);
      },
      testMenuCheckBox: function testMenuCheckBox() {
        this.__P_403_0(new qx.ui.menu.CheckBox(), false);
      },
      testRadioButton: function testRadioButton() {
        this.__P_403_0(new qx.ui.form.RadioButton(), false);
      },
      testMenuRadioButton: function testMenuRadioButton() {
        this.__P_403_0(new qx.ui.menu.RadioButton(), false);
      },
      testRadioGroupBox: function testRadioGroupBox() {
        this.__P_403_0(new qx.ui.groupbox.RadioGroupBox(), true);
      },
      testCheckGroupBox: function testCheckGroupBox() {
        this.__P_403_0(new qx.ui.groupbox.CheckGroupBox(), true);
      }
    }
  });
...
//# sourceMappingURL=BooleanFormat.js.map?dt=1778272836281