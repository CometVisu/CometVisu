(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Placeholder", {
    ...
    members: {
      __P_418_0: function __P_418_0(clazz, childControlName) {
        var widget = new clazz();
        widget.setValue("affe");
        widget.setPlaceholder("aaa");
        this.getRoot().add(widget);
        this.flush();
        this.assertEquals("affe", this.__P_418_1(widget), "placeholder visible");
        this.assertEquals("affe", widget.getValue(), "Wrong value returned.");
        this.assertFalse(this.__P_418_2(widget));
        widget.destroy();
        widget = new clazz();
        ...
        // sync the appearance
        this.__P_418_3(widget);
        this.assertTrue(this.__P_418_2(widget));
        this.assertEquals("abc", this.__P_418_4(widget), "placeholder not visible");
        this.assertNull(widget.getValue(), "Wrong value returned.");

        // get rid of the widget
        widget.destroy();
      },
      __P_418_5: function __P_418_5(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
        this.getRoot().add(widget);
        ...
        this.assertEquals("def", this.__P_418_1(widget), "wrong visible value");
        this.assertFalse(this.__P_418_2(widget));
        ...
        this.assertTrue(this.__P_418_2(widget));
        this.assertEquals("abc", this.__P_418_4(widget), "wrong visible value");

        // get rid of the widget
        widget.destroy();
      },
      __P_418_6: function __P_418_6(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
        this.getRoot().add(widget);
        ...
        widget.focus();
        this.flush();
        this.assertEquals("", this.__P_418_1(widget), "wrong visible value after focus");
        this.assertFalse(this.__P_418_2(widget), "1");
        ...
        window.setTimeout(function () {
          this.resume(function () {
            this.getRoot().focus();
            this.flush();
            this.assertTrue(this.__P_418_2(widget), "2");
            this.assertEquals("abc", this.__P_418_4(widget), "wrong visible value after blur");
      ...
      __P_418_7: function __P_418_7(clazz) {
        var widget = new clazz();
        widget.setPlaceholder("abc");
      ...
      __P_418_8: function __P_418_8(clazz) {
        var widget = new clazz();
        this.getRoot().add(widget);
        widget.setPlaceholder("abc");
        ...
        this.assertNull(widget.getValue(), "wrong value");
        this.assertFalse(this.__P_418_2(widget));
        this.assertEquals("", this.__P_418_1(widget), "wrong visible value");
      ...
      __P_418_9: function __P_418_9(widget) {
      ...
      __P_418_4: function __P_418_4(widget) {
      ...
      __P_418_2: function __P_418_2(widget) {
        var useQxPlaceholder = !qx.core.Environment.get("css.placeholder");
        if (!useQxPlaceholder) {
          var contentElem;
          if (qx.Class.isSubClassOf(widget.constructor, qx.ui.form.AbstractField)) {
...
//# sourceMappingURL=Placeholder.js.map?dt=1778272836703