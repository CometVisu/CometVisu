  ...
  qx.Class.define("qx.test.ui.form.Resetter", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_423_0 = new qx.ui.form.TextField();
        this.__P_423_1 = new qx.ui.form.TextField();
        this.__P_423_2 = new qx.ui.form.TextField();
        this.__P_423_3 = new qx.ui.form.Resetter();
      },
      tearDown: function tearDown() {
        this.__P_423_3.dispose();
        this.__P_423_0.dispose();
        this.__P_423_1.dispose();
        this.__P_423_2.dispose();
      },
      testReset: function testReset() {
        // set the initial values
        this.__P_423_0.setValue("A");
        this.__P_423_1.setValue("B");
        this.__P_423_2.setValue("C");
        // add the fields to the form manager
        this.__P_423_3.add(this.__P_423_0);
        this.__P_423_3.add(this.__P_423_1);
        this.__P_423_3.add(this.__P_423_2);
        // change the values of the fields
        this.__P_423_0.setValue("a");
        this.__P_423_1.setValue("b");
        this.__P_423_2.setValue("c");
        // reset the manager
        this.__P_423_3.reset();

        // check if the initial values are reset
        this.assertEquals("A", this.__P_423_0.getValue());
        this.assertEquals("B", this.__P_423_1.getValue());
        this.assertEquals("C", this.__P_423_2.getValue());
      },
      testRemove: function testRemove() {
        ...
        this.__P_423_1.setValue("b");
        // remove one item
        this.assertTrue(this.__P_423_3.remove(this.__P_423_1));
        // remove again to see that it has not been removed
        this.assertFalse(this.__P_423_3.remove(this.__P_423_1));
        // reset the manager
        this.__P_423_3.reset();
      ...
      testDifferentWidgets: function testDifferentWidgets() {
        ...
        // add the resetter
        this.__P_423_3.add(slider);
        this.__P_423_3.add(textarea);
        this.__P_423_3.add(radiobutton);
        this.__P_423_3.add(list);
        this.__P_423_3.add(vsb);
      ...
      testRedefine: function testRedefine() {
        ...
        this.__P_423_3.redefine();
        // change the values of the fields
        this.__P_423_0.setValue("aa");
        this.__P_423_1.setValue("bb");
        this.__P_423_2.setValue("cc");
      ...
      testResetOneItem: function testResetOneItem() {
        ...
        this.__P_423_3.resetItem(this.__P_423_0);
        this.__P_423_3.resetItem(this.__P_423_1);
      ...
      testRedefineOneItem: function testRedefineOneItem() {
        ...
        this.__P_423_3.redefineItem(this.__P_423_0);
        this.__P_423_3.redefineItem(this.__P_423_1);
        // change the first two items
        this.__P_423_0.setValue("1");
        this.__P_423_1.setValue("2");
        ...
        var self = this;
        this.assertException(function () {
          self.__P_423_3.redefineItem(this);
        }, Error);
      }
    }
  });
...
//# sourceMappingURL=Resetter.js.map?dt=1778272836791