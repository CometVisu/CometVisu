  ...
  qx.Class.define("qx.test.ui.form.Renderer", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_422_0 = new qx.ui.form.Form();
        this.__P_422_1 = new qx.ui.form.Button("a");
        this.__P_422_0.addButton(this.__P_422_1);
      },
      ...
      testDisposeSingle: function testDisposeSingle() {
        var renderer = new qx.ui.form.renderer.Single(this.__P_422_0);
        renderer.dispose();

        // check if the button container has been disposed
        this.assertNull(renderer._buttonRow);
        this.assertNotNull(this.__P_422_1);
        this.assertFalse(this.__P_422_1.isDisposed());
      },
      testDisposeDouble: function testDisposeDouble() {
        var renderer = new qx.ui.form.renderer.Double(this.__P_422_0);
        renderer.dispose();
      ...
      __P_422_2: function __P_422_2(clazz) {
        var text = new qx.ui.form.TextField();
        this.__P_422_0.add(text, "test");
        var renderer = new clazz(this.__P_422_0);
      ...
      testExcludeSingle: function testExcludeSingle() {
        this.__P_422_2(qx.ui.form.renderer.Single);
      },
      testExcludeDouble: function testExcludeDouble() {
        this.__P_422_2(qx.ui.form.renderer.Double);
      },
      __P_422_3: function __P_422_3(clazz) {
      ...
      testBindingsSingle: function testBindingsSingle() {
        this.__P_422_3(qx.ui.form.renderer.Single);
      },
      testBindingsDouble: function testBindingsDouble() {
        this.__P_422_3(qx.ui.form.renderer.Double);
      }
    }
  });
...
//# sourceMappingURL=Renderer.js.map?dt=1778272836761