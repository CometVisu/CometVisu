(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.StringFormat", {
    ...
    members: {
      __P_425_0: function __P_425_0(widget) {
      ...
      testTextField: function testTextField() {
        this.__P_425_0(new qx.ui.form.TextField());
      },
      testPasswordField: function testPasswordField() {
        this.__P_425_0(new qx.ui.form.PasswordField());
      },
      testTextArea: function testTextArea() {
        this.__P_425_0(new qx.ui.form.TextArea());
      },
      testComboBox: function testComboBox() {
        this.__P_425_0(new qx.ui.form.ComboBox());
      },
      testLabel: function testLabel() {
        this.__P_425_0(new qx.ui.basic.Label());
      }
    }
  });
...
//# sourceMappingURL=StringFormat.js.map?dt=1782595066389