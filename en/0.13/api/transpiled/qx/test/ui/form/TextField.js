  ...
  qx.Class.define("qx.test.ui.form.TextField", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_427_0 = new qx.ui.form.TextField();
        this.getRoot().add(this.__P_427_0);
      },
      tearDown: function tearDown() {
        this.__P_427_0.destroy();
        this.__P_427_0 = null;
      ...
      "test: reset max length": function test_reset_max_length() {
        ...
        var l = this.__P_427_0.getMaxLength();
        this.assertEquals(4, l);
        this.__P_427_0.resetMaxLength();
        var l = this.__P_427_0.getMaxLength();
        this.assertEquals(Infinity, l);
      },
      "test: validate input with filter": function test_validate_input_with_filter() {
        this.__P_427_0.setFilter(/[0-9]/);
        var s = this.__P_427_0._validateInput("a");
        this.assertEquals("", s);
        var s = this.__P_427_0._validateInput("111");
        this.assertEquals("111", s);
      },
      "test: validate input with complex filter": function test_validate_input_with_complex_filter() {
        this.__P_427_0.setFilter(/^(\+|-)?\d*$/);
        var s = this.__P_427_0._validateInput("a");
        this.assertEquals("", s);
        var s = this.__P_427_0._validateInput("1");
        this.assertEquals("1", s);
        var s = this.__P_427_0._validateInput("-");
        this.assertEquals("-", s);
        var s = this.__P_427_0._validateInput("111");
        this.assertEquals("111", s);
        var s = this.__P_427_0._validateInput("-111");
        this.assertEquals("-111", s);
        var s = this.__P_427_0._validateInput("-11-1");
        this.assertEquals("", s);
      },
      "test: validate input with complex filter 2": function test_validate_input_with_complex_filter_2() {
        this.__P_427_0.setFilter(/^xy$/);
        var s = this.__P_427_0._validateInput("x? y?");
        this.assertEquals("", s);
      },
      __P_427_0: null
    }
...
//# sourceMappingURL=TextField.js.map?dt=1778272836887