  ...
  qx.Class.define("qx.test.ui.form.FormValidator", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_411_0 = new qx.ui.form.TextField();
        this.__P_411_1 = new qx.ui.form.TextField();
        this.__P_411_2 = new qx.ui.form.TextField();
        this.__P_411_3 = new qx.ui.form.validation.Manager();
      },
      tearDown: function tearDown() {
        this.__P_411_3.dispose();
        this.__P_411_0.dispose();
        this.__P_411_1.dispose();
        this.__P_411_2.dispose();
      },
      // validator
      __P_411_4: function __P_411_4(value, formItem) {
      ...
      __P_411_5: function __P_411_5(value) {
        var isString = qx.lang.Type.isString(value);
        if (!isString || value.length == 0) {
          throw new qx.core.ValidationError("fail");
        }
      },
      __P_411_6: function __P_411_6(validator, value) {
      ...
      testSyncContext: function testSyncContext() {
        var self = this;
        this.__P_411_3.add(this.__P_411_0, function (value, formItem) {
          self.assertEquals(1, this.a);
        }, {
          a: 1
        });
        this.__P_411_3.validate();
      },
      testSync2Context: function testSync2Context() {
        ...
        this.__P_411_3.add(this.__P_411_1, function (value, formItem) {
      ...
      testAsyncContext: function testAsyncContext() {
        ...
        this.__P_411_3.add(this.__P_411_0, asyncValidator, {
          a: 1
        });
        this.__P_411_3.validate();
      ...
      testAsync2Context: function testAsync2Context() {
        ...
        this.__P_411_3.add(this.__P_411_1, asyncValidator2, {
          a: 2
        });
        this.__P_411_3.validate();
        asyncValidator.dispose();
      ...
      testSyncFormContext: function testSyncFormContext() {
        var self = this;
        this.__P_411_3.setValidator(function () {
          self.assertEquals(1, this.a);
        });
        this.__P_411_3.setContext({
          a: 1
        });
        this.__P_411_3.validate();
      },
      testAsyncFormContext: function testAsyncFormContext() {
        ...
        this.__P_411_3.setValidator(asyncValidator);
        this.__P_411_3.setContext({
          a: 1
        });
        this.__P_411_3.validate();
      ...
      testSyncSelfContained1NotNull: function testSyncSelfContained1NotNull() {
        this.__P_411_3.add(this.__P_411_0, this.__P_411_4);

        // validate = fail (no text entered)
        this.assertFalse(this.__P_411_3.validate());
        this.assertFalse(this.__P_411_3.getValid());
        this.assertFalse(this.__P_411_0.getValid());

        // check the invalid messages
        this.assertEquals("fail", this.__P_411_0.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[0]);

        // enter text in the usernamen
        this.__P_411_0.setValue("affe");

        // validate = true
        this.assertTrue(this.__P_411_3.validate());
        this.assertTrue(this.__P_411_3.getValid());
        this.assertTrue(this.__P_411_0.getValid());

        // remove the username
        this.__P_411_0.resetValue();
      ...
      testSyncSelfContained1NotNullEvents: function testSyncSelfContained1NotNullEvents(attributes) {
        this.__P_411_3.add(this.__P_411_0, this.__P_411_4);
        var self = this;
        this.assertEventFired(this.__P_411_3, "changeValid", function () {
          self.__P_411_3.validate();
        }, function (e) {
      ...
      __P_411_7: function __P_411_7(validator) {
        this.__P_411_3.add(this.__P_411_0, validator);
        this.__P_411_3.add(this.__P_411_1, validator);
        this.__P_411_3.add(this.__P_411_2, validator);

        // validate = fail (no text entered)
        this.assertFalse(this.__P_411_3.validate());
        this.assertFalse(this.__P_411_0.getValid());
        this.assertFalse(this.__P_411_1.getValid());
        this.assertFalse(this.__P_411_2.getValid());

        // check the invalid messages
        this.assertEquals("fail", this.__P_411_0.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_1.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_2.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[0]);
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[1]);
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[2]);
        this.assertEquals(3, this.__P_411_3.getInvalidMessages().length);

        // enter text to the two passwordfields
        this.__P_411_1.setValue("1");
        this.__P_411_2.setValue("2");

        // validate again = fail (username empty)
        this.assertFalse(this.__P_411_3.validate());
        this.assertFalse(this.__P_411_0.getValid());
        this.assertTrue(this.__P_411_1.getValid());
        this.assertTrue(this.__P_411_2.getValid());

        // check the invalid messages
        this.assertEquals("fail", this.__P_411_0.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[0]);
        this.assertEquals(1, this.__P_411_3.getInvalidMessages().length);
        ...
        this.assertTrue(this.__P_411_1.getValid());
        this.assertTrue(this.__P_411_2.getValid());
        this.assertEquals(0, this.__P_411_3.getInvalidMessages().length);
      ...
      testSyncSelfContained3NotNull: function testSyncSelfContained3NotNull() {
        this.__P_411_7(this.__P_411_4);
      },
      testSyncSelfContained3NotNullError: function testSyncSelfContained3NotNullError() {
        this.__P_411_7(this.__P_411_5);
      },
      // //////////////////////////////
      // sync related //////////////
      __P_411_8: function __P_411_8(validator) {
        this.__P_411_3.add(this.__P_411_0);
        this.__P_411_3.add(this.__P_411_1);
        this.__P_411_3.add(this.__P_411_2);
        this.__P_411_1.setValue("affe");
        this.__P_411_3.setValidator(validator);
        this.assertFalse(this.__P_411_3.validate());
        this.assertFalse(this.__P_411_3.getValid());
        this.assertEquals("fail", this.__P_411_3.getInvalidMessage());
        this.assertEquals("fail", this.__P_411_3.getInvalidMessages()[0]);
        this.__P_411_2.setValue("affe");
        this.assertTrue(this.__P_411_3.validate());
        this.assertTrue(this.__P_411_3.getValid());
        this.assertEquals(0, this.__P_411_3.getInvalidMessages().length);
      },
      testSyncRelatedNoIndividual: function testSyncRelatedNoIndividual() {
        this.__P_411_8(function (formItems, manager) {
      ...
      testSyncRelatedWithIndividual: function testSyncRelatedWithIndividual() {
        this.__P_411_3.add(this.__P_411_0, this.__P_411_4);
        this.__P_411_3.add(this.__P_411_1, this.__P_411_4);
        this.__P_411_3.add(this.__P_411_2, this.__P_411_4);
        this.__P_411_1.setValue("affe");
        this.__P_411_3.setValidator(function (formItems, manager) {
          var valid = formItems[1].getValue() == formItems[2].getValue();
          if (!valid) {
            manager.setInvalidMessage("fail");
          }
        ...
        this.assertFalse(this.__P_411_0.getValid());
        this.assertFalse(this.__P_411_2.getValid());
        var messages = this.__P_411_3.getInvalidMessages();
        this.assertEquals("fail", this.__P_411_3.getInvalidMessage());
      ...
      testRequired: function testRequired() {
        ...
        this.__P_411_0.setRequired(true);
        this.__P_411_1.setRequired(true);
        this.__P_411_2.setRequired(true);
      ...
      testRequiredFieldMessage: function testRequiredFieldMessage() {
        ...
        this.__P_411_3.setRequiredFieldMessage("affe");
        this.__P_411_1.setRequiredInvalidMessage("AFFEN");
        ...
        // check the messages
        this.assertEquals("affe", this.__P_411_0.getInvalidMessage());
        this.assertEquals("AFFEN", this.__P_411_1.getInvalidMessage());
      },
      ...
      testAsyncSelfContained1NotNullFail: function testAsyncSelfContained1NotNullFail() {
        var _this = this;
        var asyncValidator = new qx.ui.form.validation.AsyncValidator(this.__P_411_6);
        this.__P_411_3.add(this.__P_411_0, asyncValidator);
        this.__P_411_3.addListener("complete", function () {
          _this.resume(function () {
            // check the status after the complete
            this.assertFalse(this.__P_411_3.isValid());
            this.assertFalse(this.__P_411_0.getValid());
            this.assertEquals("fail", this.__P_411_0.getInvalidMessage());
          }, _this);
        });
      ...
      testAsyncSelfContained1NotNull: function testAsyncSelfContained1NotNull() {
        ...
        this.__P_411_3.addListener("complete", function () {
          _this2.resume(function () {
            // check the status after the complete
            this.assertTrue(this.__P_411_3.isValid());
            this.assertTrue(this.__P_411_0.getValid());
          }, _this2);
        });
        this.__P_411_3.validate();
      ...
      testAsyncSelfContained3NotNullFail: function testAsyncSelfContained3NotNullFail() {
        var _this3 = this;
        var asyncValidator1 = new qx.ui.form.validation.AsyncValidator(this.__P_411_6);
        var asyncValidator2 = new qx.ui.form.validation.AsyncValidator(this.__P_411_6);
        var asyncValidator3 = new qx.ui.form.validation.AsyncValidator(this.__P_411_6);
        this.__P_411_3.add(this.__P_411_0, asyncValidator1);
        this.__P_411_3.add(this.__P_411_1, asyncValidator2);
        this.__P_411_3.add(this.__P_411_2, asyncValidator3);
        this.__P_411_3.addListener("complete", function () {
      ...
      testAsyncSelfContained3NotNull: function testAsyncSelfContained3NotNull() {
        ...
        this.__P_411_0.setValue("a");
        this.__P_411_1.setValue("b");
        this.__P_411_2.setValue("c");
        this.__P_411_3.validate();
        this.wait();
      },
      testAsyncSelfContained2NotNullFailMixed: function testAsyncSelfContained2NotNullFailMixed() {
        ...
        this.__P_411_3.add(this.__P_411_1, asyncValidator2);
        this.__P_411_3.add(this.__P_411_2, asyncValidator3);
        this.__P_411_0.setValid(false);
        this.__P_411_1.setValid(false);
        this.__P_411_2.setValid(false);
        this.__P_411_3.addListener("complete", function () {
      ...
      testAsyncRelated3NotNullFail: function testAsyncRelated3NotNullFail() {
        ...
        this.__P_411_3.setValidator(new qx.ui.form.validation.AsyncValidator(function (formItems, validator) {
          window.setTimeout(function () {
            validator.setValid(formItems[1].getValue() == formItems[2].getValue());
          }, 100);
        }));
        this.__P_411_0.setValue("u");
        this.__P_411_1.setValue("a");
        this.__P_411_2.setValue("b");
        this.__P_411_3.validate();
        this.wait();
      },
      ...
      testAddWrong: function testAddWrong() {
        this.assertException(function () {
          this.__P_411_3.add(new qx.core.Object());
        });
        this.assertException(function () {
          this.__P_411_3.add(123);
        });
        this.assertException(function () {
          this.__P_411_3.add({});
        });
      ...
      testAddSelectBoxWithValidator: function testAddSelectBoxWithValidator() {
        ...
        this.assertException(function () {
          this.__P_411_3.add(box, function () {});
        });
        box.dispose();
      },
      // //////////////////////////////
      ...
      testRemove: function testRemove() {
        ...
        this.assertEquals(this.__P_411_0, this.__P_411_3.remove(this.__P_411_0));
        this.__P_411_3.validate();
      },
      // //////////////////////////////
      // get items ////////////////////
      testGetItems: function testGetItems() {
        this.__P_411_3.add(this.__P_411_0);
        this.__P_411_3.add(this.__P_411_1);
        var items = this.__P_411_3.getItems();
        this.assertInArray(this.__P_411_0, items);
        this.assertInArray(this.__P_411_1, items);
      },
      // //////////////////////////////
      // validate //////////////////////
...
//# sourceMappingURL=FormValidator.js.map?dt=1782595066163