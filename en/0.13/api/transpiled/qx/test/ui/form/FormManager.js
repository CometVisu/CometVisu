  ...
  qx.Class.define("qx.test.ui.form.FormManager", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_400_0 = new qx.ui.form.Form();
      ...
      testValidationContext: function testValidationContext() {
        var self = this;
        // add the widgets
        this.__P_400_0.add(this.__P_400_2, "TF2", function () {
          self.assertEquals(1, this.a);
        }, null, {
          a: 1
        });
        this.__P_400_0.validate();
      },
      testAddTwo: function testAddTwo() {
        // add the widgets
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.add(this.__P_400_2, "TF2");

        // get the view
        var view = new qx.test.DummyFormRenderer(this.__P_400_0);

        // check the items
        this.assertEquals(view.groups[0].items[0], this.__P_400_1);
        this.assertEquals(view.groups[0].items[1], this.__P_400_2);
      ...
      testRemove: function testRemove() {
        ...
        this.assertTrue(this.__P_400_0.remove(this.__P_400_1));
        this.assertFalse(this.__P_400_0.remove(this.__P_400_1));

        // get the view
        var view = new qx.test.DummyFormRenderer(this.__P_400_0);

        // check the items
        this.assertEquals(view.groups[0].items[0], this.__P_400_2);
        view.dispose();
      },
      ...
      testRemoveHeader: function testRemoveHeader() {
        this.__P_400_0.addGroupHeader("affe0");
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.addGroupHeader("affe1");
        this.__P_400_0.add(this.__P_400_2, "TF2");
        ...
        // check the items
        this.assertEquals(view.groups[0].items[0], this.__P_400_1);
        this.assertEquals(view.groups[1].items[0], this.__P_400_2);
        ...
        // remove twice to see if the remove is reported correctly
        this.assertTrue(this.__P_400_0.removeGroupHeader("affe1"));
        this.assertFalse(this.__P_400_0.removeGroupHeader("affe1"));
      ...
      testAddTwoWithTwoGroups: function testAddTwoWithTwoGroups() {
        this.__P_400_0.addGroupHeader("affe");
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.addGroupHeader("affee");
        this.__P_400_0.add(this.__P_400_2, "TF2");
      ...
      testAddTwoButtons: function testAddTwoButtons() {
        ...
        this.__P_400_0.addButton(b1);
        this.__P_400_0.addButton(b2);
      ...
      testRemoveButton: function testRemoveButton() {
        ...
        // remove twice to see if the remove is reported correctly
        this.assertTrue(this.__P_400_0.removeButton(b1));
        this.assertFalse(this.__P_400_0.removeButton(b1));
      ...
      testAddTwoWithOptions: function testAddTwoWithOptions() {
        // add the widgets
        this.__P_400_0.add(this.__P_400_1, "TF1", null, "tf1", null, {
          a: 1
        });
        this.__P_400_0.add(this.__P_400_2, "TF2", null, "tf2", null, {
          a: 2
        });
      ...
      testResetter: function testResetter() {
        ...
        this.__P_400_1.setValue("aaaa");
        this.__P_400_2.setValue("bbbb");
        ...
        this.__P_400_1.setValue("111");
        this.__P_400_2.setValue("222");
        this.__P_400_0.reset();

        // check
        this.assertEquals("aaaa", this.__P_400_1.getValue());
        this.assertEquals("bbbb", this.__P_400_2.getValue());
      },
      testAll: function testAll() {
        ...
        for (var i = 0; i < widgets.length; i++) {
          this.__P_400_0.add(widgets[i], "name" + i);
        }
      ...
      testGetItems: function testGetItems() {
        // add the widgets
        this.__P_400_0.add(this.__P_400_1, "TF1", null, "a");
        this.__P_400_0.add(this.__P_400_2, "TF2", null, "b");
        var items = this.__P_400_0.getItems();
        this.assertEquals(items.a, this.__P_400_1);
        this.assertEquals(items.b, this.__P_400_2);
      },
      testGetItemsFallback: function testGetItemsFallback() {
        // add the widgets
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.add(this.__P_400_2, "T F 2");
        var items = this.__P_400_0.getItems();
        this.assertEquals(items.TF1, this.__P_400_1);
        this.assertEquals(items.TF2, this.__P_400_2);
      },
      testGetItemsMixedWithGroups: function testGetItemsMixedWithGroups() {
        // add the widgets
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.add(this.__P_400_2, "TF2", null, "b");
        this.__P_400_0.addGroupHeader("x");
        var tf3 = new qx.ui.form.TextField();
        this.__P_400_0.add(tf3, "TF3");
        var items = this.__P_400_0.getItems();
        this.assertEquals(items.TF1, this.__P_400_1);
        this.assertEquals(items.b, this.__P_400_2);
      ...
      testSingleRenderer: function testSingleRenderer() {
        ...
        // add the widgets
        this.__P_400_0.addGroupHeader("header");
        this.__P_400_0.add(this.__P_400_1, "TF1");
        this.__P_400_0.addButton(b1);

        // just check if the renderer is created without an error
        new qx.ui.form.renderer.Single(this.__P_400_0).dispose();
        b1.dispose();
      },
      testSinglePlaceholderRenderer: function testSinglePlaceholderRenderer() {
        ...
        // just check if the renderer is created without an error
        new qx.ui.form.renderer.SinglePlaceholder(this.__P_400_0).dispose();
        b1.dispose();
      },
      testDoubleRenderer: function testDoubleRenderer() {
        ...
        // just check if the renderer is created without an error
        new qx.ui.form.renderer.Double(this.__P_400_0).dispose();
        b1.dispose();
      },
      testGetItem: function testGetItem() {
        ...
        this.__P_400_0.add(f1, "a");
        this.__P_400_0.add(f2, "c");
        this.__P_400_0.add(f3, "label", null, "x");
        this.assertIdentical(f1, this.__P_400_0.getItem("a"));
        this.assertNull(this.__P_400_0.getItem("b"));
        this.assertIdentical(f2, this.__P_400_0.getItem("c"));
        this.assertNull(this.__P_400_0.getItem("label"));
        this.assertIdentical(f3, this.__P_400_0.getItem("x"));
...
//# sourceMappingURL=FormManager.js.map?dt=1735383864376