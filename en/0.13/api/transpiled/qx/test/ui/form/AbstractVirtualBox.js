  ...
  qx.Class.define("qx.test.ui.form.AbstractVirtualBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_391_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_391_0);
        this.__P_391_1 = new qx.ui.form.VirtualComboBox();
      ...
      testListLengthAfterModelChangeSelectBox: function testListLengthAfterModelChangeSelectBox() {
        ...
        this.__P_391_0.setModel(model);
        this.__P_391_0.open();
        this.flush();
        var dropDown = this.__P_391_0.getChildControl("dropdown");
        ...
        this.__P_391_0.close();
        this.__P_391_0.resetModel();
      },
      testListLengthAfterModelChangeComboBox: function testListLengthAfterModelChangeComboBox() {
        var model = new qx.data.Array(["a", "b", "c"]);
        this.__P_391_1.setModel(model);
        this.__P_391_1.open();
        this.flush();
        var dropDown = this.__P_391_1.getChildControl("dropdown");
        var firstHeight = dropDown.getBounds().height;
        this.assertPositiveInteger(firstHeight);
        model.replace(["d", "e", "f", "g", "h", "j", "k", "l"]);
        this.flush();
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1726089058017