  ...
  qx.Class.define("qx.test.ui.form.AbstractVirtualBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_402_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_402_0);
        this.__P_402_1 = new qx.ui.form.VirtualComboBox();
        this.getRoot().add(this.__P_402_1);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.AbstractVirtualBox.superclass.prototype.tearDown.call(this);
        this.__P_402_0.dispose();
        this.__P_402_0 = null;
        this.__P_402_1.dispose();
        this.__P_402_1 = null;
      },
      testStatePopupOpen: function testStatePopupOpen() {
        this.__P_402_0.open();
        this.flush();
        this.assertTrue(this.__P_402_0.hasState("popupOpen"));
        this.__P_402_0.close();
        this.flush();
        this.assertFalse(this.__P_402_0.hasState("popupOpen"));
        this.__P_402_1.open();
        this.flush();
        this.assertTrue(this.__P_402_1.hasState("popupOpen"));
        this.__P_402_1.close();
        this.flush();
        this.assertFalse(this.__P_402_1.hasState("popupOpen"));
      },
      testListLengthAfterModelChangeSelectBox: function testListLengthAfterModelChangeSelectBox() {
        ...
        this.__P_402_0.setModel(model);
        this.__P_402_0.open();
        this.flush();
        var dropDown = this.__P_402_0.getChildControl("dropdown");
        ...
        this.__P_402_0.close();
        this.__P_402_0.resetModel();
      },
      testListLengthAfterModelChangeComboBox: function testListLengthAfterModelChangeComboBox() {
        var model = new qx.data.Array(["a", "b", "c"]);
        this.__P_402_1.setModel(model);
        this.__P_402_1.open();
        this.flush();
        var dropDown = this.__P_402_1.getChildControl("dropdown");
        var firstHeight = dropDown.getBounds().height;
        this.assertPositiveInteger(firstHeight);
        model.replace(["d", "e", "f", "g", "h", "j", "k", "l"]);
        this.flush();
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1778272836269