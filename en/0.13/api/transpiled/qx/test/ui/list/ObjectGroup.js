(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.list.ObjectGroup", {
    ...
    members: {
      __P_437_0: ["Luise Siemer", "Trauhard Franke", "Sarina Wilde", "Florine Bähr", "Sigurd Adolph", "Sigmund Kurz", "Pankratius Hill", "Gerlinda Seel", "Trixi Clauß", "Cecilia Hemmer", "Rosely Fröhlich", "Annemargret Hunger", "Dietgar Münster", "Bertwin Joseph", "Edwina Schwarz", "Riana Dirks"],
      __P_437_1: null,
      createModelData: function createModelData() {
        var model = new qx.data.Array();
        model.setAutoDisposeItems(true);
        var groups = this.__P_437_1 = {};
        for (var i = 0; i < this.__P_437_0.length; i++) {
          var name = this.__P_437_0[i];
      ...
      tearDown: function tearDown() {
        ...
        for (var key in this.__P_437_1) {
          if (this.__P_437_1.hasOwnProperty(key)) {
            this.__P_437_1[key].dispose();
          }
        }
        this.__P_437_1 = null;
      },
      testGroup: function testGroup() {
        ...
        this.flush();
        var groupedModel = this.__P_437_2(this._model);
      ...
      testGroupWithSorter: function testGroupWithSorter() {
        ...
        this._list.setDelegate(delegate);
        this.flush();
        var groupedModel = this.__P_437_2(sortedModel);
        this.assertModelEqualsRowData(groupedModel, this._list);
        this.assertEquals(groupedModel.getLength(), this._list.getPane().getRowConfig().getItemCount(), "On Layer");
        this.assertEquals(12, this._list.getGroups().getLength(), "On List");
        groupedModel.dispose();
      ...
      __P_437_2: function __P_437_2(model) {
...
//# sourceMappingURL=ObjectGroup.js.map?dt=1778272837296