  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.ui.list.Group", {
    ...
    construct: function construct() {
      qx.test.ui.list.AbstractListTest.constructor.call(this);
      this.__P_425_0 = ["Luise Siemer", "Trauhard Franke", "Sarina Wilde", "Florine Bähr", "Sigurd Adolph", "Sigmund Kurz", "Pankratius Hill", "Gerlinda Seel", "Trixi Clauß", "Cecilia Hemmer", "Rosely Fröhlich", "Annemargret Hunger", "Dietgar Münster", "Bertwin Joseph", "Edwina Schwarz", "Riana Dirks"];
    },
    members: {
      __P_425_0: null,
      createModelData: function createModelData() {
        return qx.data.marshal.Json.createModel(this.__P_425_0);
      },
...
//# sourceMappingURL=Group.js.map?dt=1726089059207