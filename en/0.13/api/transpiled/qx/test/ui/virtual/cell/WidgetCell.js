  ...
  qx.Class.define("qx.test.ui.virtual.cell.WidgetCell", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_452_0 = new qx.ui.virtual.cell.WidgetCell();
      },
      ...
      testCreateWidget: function testCreateWidget() {
        var item = this.__P_452_0.getCellWidget();
      ...
      testPoolOnDelegateChange: function testPoolOnDelegateChange() {
        var item1 = this.__P_452_0.getCellWidget();
        this.assertQxWidget(item1);
        var item2 = this.__P_452_0.getCellWidget();
        this.assertQxWidget(item2);
        this.__P_452_0.pool(item1);
        this.__P_452_0.pool(item2);
        this.__P_452_1();
        var item = this.__P_452_0.getCellWidget();
        this.assertInterface(item, qx.ui.form.ListItem);
        item.dispose();
      ...
      testEvent: function testEvent() {
        var that = this;
        var widget = null;
        this.assertEventFired(this.__P_452_0, "created", function () {
          widget = that.__P_452_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });
        this.__P_452_0.pool(widget);
        this.assertEventNotFired(this.__P_452_0, "created", function () {
          that.__P_452_0.getCellWidget();
        }, function (e) {
          that.assertQxWidget(e.getData());
        });
        widget.dispose();
      ...
      testUpdateData: function testUpdateData() {
        ...
        this.__P_452_0.updateData(item, data);
      ...
      testUpdateEmptyData: function testUpdateEmptyData() {
        this.__P_452_1();
        var item = this.__P_452_0.getCellWidget();
        this.__P_452_0.updateData(item);
      ...
      testUpdateWrongData: function testUpdateWrongData() {
        ...
        this.assertException(function () {
          that.__P_452_0.updateData(item, data);
        });
        item.dispose();
      },
      __P_452_1: function __P_452_1() {
        this.__P_452_0.setDelegate({
...
//# sourceMappingURL=WidgetCell.js.map?dt=1782595067568