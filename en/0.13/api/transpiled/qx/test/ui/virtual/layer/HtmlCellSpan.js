  ...
  qx.Class.define("qx.test.ui.virtual.layer.HtmlCellSpan", {
    ...
    members: {
      tearDown: function tearDown() {
        ...
        this.__P_454_0.dispose();
        this.__P_454_1.dispose();
        this.__P_454_2.dispose();
      },
      _createLayer: function _createLayer() {
        this.__P_454_0 = new qx.ui.virtual.cell.Cell();
        this.__P_454_1 = new qx.ui.virtual.core.Axis(10, 100);
        this.__P_454_2 = new qx.ui.virtual.core.Axis(20, 100);
        return new qx.ui.virtual.layer.HtmlCellSpan(this, this.__P_454_1, this.__P_454_2);
      },
      getCellProperties: function getCellProperties(row, column) {
        return this.__P_454_0.getCellProperties(row + " / " + column, {});
      },
...
//# sourceMappingURL=HtmlCellSpan.js.map?dt=1778272838375