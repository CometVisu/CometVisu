  ...
  qx.Class.define("qx.test.ui.embed.Iframe", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_400_0 = new qx.ui.embed.Iframe();
        this.__P_400_0.set({
          width: 200,
          height: 500
        });
      ...
      tearDown: function tearDown() {
        this.__P_400_0.destroy();
      },
      testHiddenSetSourceInitial: function testHiddenSetSourceInitial() {
        this.__P_400_0.set({
          visibility: "hidden"
        });
        this.getRoot().add(this.__P_400_0);
        qx.ui.core.queue.Manager.flush();
        this.assertNotNull(this.__P_400_0.getContentElement().getDomElement());
      },
      testHiddenSetSource: function testHiddenSetSource() {
        ...
        this.__P_400_0.setSource(src);
        qx.ui.core.queue.Manager.flush();
        this.__P_400_0.addListenerOnce("load", function () {
          _this.resume(function () {
            this.assertEquals(this.__P_400_0.getSource(), this.__P_400_0.getWindow().location.href);
          });
        });
        this.wait(10000);
      },
      testGetWindow: function testGetWindow() {
        var _this2 = this;
        this.getRoot().add(this.__P_400_0);
        this.__P_400_0.addListener("load", function () {
          _this2.resume(function () {
            this.assertNotNull(this.__P_400_0.getWindow());
          }, _this2);
        });
        var src = qx.util.ResourceManager.getInstance().toUri("qx/static/blank.html");
        this.__P_400_0.setSource(src);
...
//# sourceMappingURL=Iframe.js.map?dt=1778272836242