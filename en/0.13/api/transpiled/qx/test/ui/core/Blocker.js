  ...
  qx.Class.define("qx.test.ui.core.Blocker", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_385_0 = new qx.ui.core.Blocker(this.getRoot());
        this.__P_385_0.setColor("green");
        this.__P_385_0.setOpacity(0.5);
      },
      tearDown: function tearDown() {
        qx.test.ui.core.Blocker.superclass.prototype.tearDown.call(this);
        this.__P_385_0.dispose();
      },
      testBlocker: function testBlocker() {
        var blockerElement = this.__P_385_0.getBlockerElement();
        this.__P_385_0.block();
        this.flush();
        this.assertTrue(this.__P_385_0.isBlocked(), "isBlocked()");
        this.assertTrue(blockerElement.isIncluded(), "isIncluded()");
        this.__P_385_0.unblock();
        this.flush();
        this.assertFalse(this.__P_385_0.isBlocked(), "isBlocked()");
      ...
      testBlockedEvent: function testBlockedEvent() {
        var _this = this;
        this.__P_385_1 = false;
        this.__P_385_2 = false;
        this.__P_385_0.addListenerOnce("blocked", function (e) {
          _this.__P_385_1 = true;
        });
        this.__P_385_0.addListenerOnce("unblocked", function (e) {
          _this.__P_385_2 = true;
        });
        this.__P_385_0.block();
        this.__P_385_0.unblock();
        this.wait(100, function () {
          this.assertTrue(this.__P_385_1, "'blocked' event was not fired, after block() was executed!");
          this.assertTrue(this.__P_385_2, "'unblocked' event was not fired, after unblock() was executed!");
        }, this);
      },
...
//# sourceMappingURL=Blocker.js.map?dt=1722153831148