  ...
  qx.Class.define("qx.test.html.Element", {
    ...
    members: {
      ...
      testText: function testText() {
        ...
        el1.addAt(el2, 1);
        serialized = el1.serialize();
        this.assertEquals('<div id="el1" class="el1" abc="123" def="true" checked="checked">Hello Again<div id="el2"></div> World</div>', serialized);
      },
      testNestedSerialize: function testNestedSerialize() {
        var parseHtml = function parseHtml(raw) {
          var el = document.createElement("div");
          el.innerHTML = raw;
          var res = el.querySelector("*");
          res.remove();
          return res;
        };
        var elem = new qx.test.html.ExampleElement().set({
          qxObjectId: "rootExample"
        });
        var html = elem.serialize();
        ...
        this.assertTrue(tmp && tmp === elem.getQxObject("b1/b2/b3").getDomElement());
      },
...
//# sourceMappingURL=Element.js.map?dt=1735341778014