  ...
  qx.Class.define("qx.test.data.singlevalue.Simple", {
    ...
    members: {
      ...
      setUp: function setUp() {
        // create the widgets
        this.__P_337_0 = new qx.test.data.singlevalue.TextFieldDummy();
        this.__P_337_1 = new qx.test.data.singlevalue.TextFieldDummy();
      },
      tearDown: function tearDown() {
        qx.data.SingleValueBinding.removeAllBindingsForObject(this.__P_337_0);
        qx.data.SingleValueBinding.removeAllBindingsForObject(this.__P_337_1);
        this.__P_337_0.dispose();
        this.__P_337_1.dispose();
      },
      testStringPropertyBinding: function testStringPropertyBinding() {
        qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance");
        this.__P_337_0.setAppearance("affe");
        this.assertEquals("affe", this.__P_337_1.getAppearance(), "String binding does not work!");
        var affe = new qx.test.data.singlevalue.TextFieldDummy();
        affe.setAppearance("Jonny");
        qx.data.SingleValueBinding.bind(affe, "appearance", this.__P_337_1, "appearance");
        this.assertEquals("Jonny", this.__P_337_1.getAppearance(), "String binding does not work!");
        qx.data.SingleValueBinding.removeAllBindingsForObject(affe);
        affe.dispose();
      },
      testBooleanPropertyBinding: function testBooleanPropertyBinding() {
        qx.data.SingleValueBinding.bind(this.__P_337_0, "enabled", this.__P_337_1, "enabled");
        this.__P_337_0.setEnabled(false);
        this.assertFalse(this.__P_337_1.getEnabled(), "Boolean binding does not work!");
      },
      testNumberPropertyBinding: function testNumberPropertyBinding() {
        qx.data.SingleValueBinding.bind(this.__P_337_0, "zIndex", this.__P_337_1, "zIndex");
        this.__P_337_0.setZIndex(2456);
        this.assertEquals(2456, this.__P_337_1.getZIndex(), "Number binding does not work!");
      },
      testColorPropertyBinding: function testColorPropertyBinding() {
        qx.data.SingleValueBinding.bind(this.__P_337_0, "backgroundColor", this.__P_337_1, "backgroundColor");
        this.__P_337_0.setBackgroundColor("red");
        this.assertEquals("red", this.__P_337_1.getBackgroundColor(), "Color binding does not work!");
      },
      ...
      testDefaultConversion: function testDefaultConversion() {
        // String to number
        this.__P_337_0.setAppearance("0");
        qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "zIndex");
        this.__P_337_0.setAppearance("4879");
        this.assertEquals(4879, this.__P_337_1.getZIndex(), "String --> Number does not work!");

        // number to String
        this.__P_337_0.setZIndex(568);
        qx.data.SingleValueBinding.bind(this.__P_337_0, "zIndex", this.__P_337_1, "appearance");
        this.__P_337_0.setZIndex(1234);
        this.assertEquals("1234", this.__P_337_1.getAppearance(), "Number --> String does not work!");

        // boolean to string
        qx.data.SingleValueBinding.bind(this.__P_337_0, "enabled", this.__P_337_1, "appearance");
        this.__P_337_0.setEnabled(true);
        this.assertEquals("true", this.__P_337_1.getAppearance(), "Boolean --> String does not work!");

        // string to float
        var s = new qx.test.data.singlevalue.TextFieldDummy();
        s.setFloatt(0);
        qx.data.SingleValueBinding.bind(s, "floatt", this.__P_337_1, "appearance");
        s.setFloatt(13.5);
        this.assertEquals("13.5", this.__P_337_1.getAppearance(), "Float --> String does not work!");
        qx.data.SingleValueBinding.removeAllBindingsForObject(s);
        s.dispose();
      },
      testRemoveBinding: function testRemoveBinding() {
        // add a binding
        var id = qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance");

        // set and chech the name
        this.__P_337_0.setAppearance("hans");
        this.assertEquals("hans", this.__P_337_1.getAppearance(), "String binding does not work!");

        // remove the binding
        qx.data.SingleValueBinding.removeBindingFromObject(this.__P_337_0, id);
        // set and chech the name
        this.__P_337_0.setAppearance("hans2");
        this.assertEquals("hans", this.__P_337_1.getAppearance(), "Did not remove the binding!");

        // test if the binding is not listed anymore
        var bindings = qx.data.SingleValueBinding.getAllBindingsForObject(this.__P_337_0);
      ...
      testGetAllBindingsForObject: function testGetAllBindingsForObject() {
        // add two binding
        var id = qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance");
        var id2 = qx.data.SingleValueBinding.bind(this.__P_337_0, "zIndex", this.__P_337_1, "zIndex");

        // set and chech the binding
        this.__P_337_0.setAppearance("hans");
        this.assertEquals("hans", this.__P_337_1.getAppearance(), "String binding does not work!");
        this.__P_337_0.setZIndex(89);
        this.assertEquals(89, this.__P_337_1.getZIndex(), "Number binding does not work!");
      ...
      testRemoveAllBindingsForObject: function testRemoveAllBindingsForObject() {
        ...
        // set and check the binding
        this.__P_337_0.setAppearance("hans2");
        this.assertEquals("hans", this.__P_337_1.getAppearance(), "String binding not removed!");
        this.__P_337_0.setZIndex(892);
        this.assertEquals(89, this.__P_337_1.getZIndex(), "Number binding not removed!");
      ...
      testGetAllBindings: function testGetAllBindings() {
        // add three bindings
        var id1 = qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance");
        var id2 = qx.data.SingleValueBinding.bind(this.__P_337_0, "zIndex", this.__P_337_1, "zIndex");
        var id3 = qx.data.SingleValueBinding.bind(this.__P_337_1, "zIndex", this.__P_337_0, "zIndex");

        // get all bindings
        var allBindings = qx.data.SingleValueBinding.getAllBindings();

        // check for the binding ids
        this.assertEquals(id1, allBindings[this.__P_337_0.toHashCode()][0][0], "This id should be in!");
        this.assertEquals(id2, allBindings[this.__P_337_0.toHashCode()][1][0], "This id should be in!");
        this.assertEquals(id3, allBindings[this.__P_337_1.toHashCode()][0][0], "This id should be in!");

        // check for the length
        this.assertEquals(2, allBindings[this.__P_337_0.toHashCode()].length, "Not the right amount in the data!");
        this.assertEquals(1, allBindings[this.__P_337_1.toHashCode()].length, "Not the right amount in the data!");
      },
      testDebugStuff: function testDebugStuff() {
        // just a test if the method runs threw without an exception
        var id1 = qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance");
        qx.data.SingleValueBinding.bind(this.__P_337_0, "zIndex", this.__P_337_1, "zIndex");
        qx.data.SingleValueBinding.bind(this.__P_337_1, "appearance", this.__P_337_0, "appearance");
        qx.data.SingleValueBinding.bind(this.__P_337_1, "zIndex", this.__P_337_0, "zIndex");
        // test the single log
        qx.data.SingleValueBinding.showBindingInLog(this.__P_337_0, id1);
      },
      testMixinSupport: function testMixinSupport() {
        // create a new Binding
        var id1 = this.__P_337_0.bind("appearance", this.__P_337_1, "appearance");
        this.__P_337_0.setAppearance("hulk");
        this.assertEquals("hulk", this.__P_337_1.getAppearance(), "String binding does not work!");

        // remove the binding
        this.__P_337_0.removeBinding(id1);
        this.__P_337_0.setAppearance("hulk2");
        this.assertEquals("hulk", this.__P_337_1.getAppearance(), "Unbinding does not work!");

        // add another two bindings
        var id1 = this.__P_337_0.bind("changeAppearance", this.__P_337_1, "appearance");
        var id2 = this.__P_337_0.bind("zIndex", this.__P_337_1, "zIndex");

        // get the current bindings
        var bindings = this.__P_337_0.getBindings();
        ...
        // remove all bindings
        this.__P_337_0.removeAllBindings();
        var bindings = this.__P_337_0.getBindings();
        this.assertEquals(0, bindings.length, "Still bindings there?");
      },
      ...
      testFallback: function testFallback() {
        // change + "name" binding
        this.__P_337_0.bind("value", this.__P_337_1, "value");
        this.__P_337_0.setValue("affe");
        this.assertEquals(this.__P_337_0.getValue(), this.__P_337_1.getValue(), "change event binding is not working.");

        // event binding
        this.__P_337_0.bind("changeZIndex", this.__P_337_1, "zIndex");
        this.__P_337_0.setZIndex(123);
        this.assertEquals(this.__P_337_0.getZIndex(), this.__P_337_1.getZIndex(), "Event binding is not working.");
      },
      testNullWithConverter: function testNullWithConverter() {
        ...
        // starting point
        this.__P_337_0.setZIndex(null);
        this.__P_337_0.bind("zIndex", t, "a", options);
        this.assertEquals("affe", t.getA(), "Converter will not be executed.");
        this.__P_337_0.setZIndex(10);
        this.assertEquals(this.__P_337_0.getZIndex() + "", t.getA(), "Wrong start binding.");
      ...
      testCallbacksOnInitialSet: function testCallbacksOnInitialSet() {
        ...
        var options = {
          onUpdate: function onUpdate(sourceObject, targetObject, value) {
            ok = true;
            that.assertEquals(sourceObject, that.__P_337_0, "Wrong source object.");
        ...
        this.__P_337_0.setValue("affe");
        this.__P_337_0.bind("value", target, "value", options);
        ...
        this.__P_337_0.setZIndex(10);
        this.__P_337_0.bind("zIndex", target, "value", options);
      ...
      testConverterParam: function testConverterParam() {
        ...
        var options = {
          converter: function converter(data, model, source, target) {
            ...
            self.assertEquals(self.__P_337_0, source);
            self.assertEquals(self.__P_337_1, target);
            return data;
          }
        };
        qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, "appearance", options);
        this.__P_337_0.setAppearance("affe");
        this.assertEquals("affe", this.__P_337_1.getAppearance(), "String binding does not work!");
      },
      testWrongArguments: function testWrongArguments() {
        ...
        this.assertException(function () {
          qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", this.__P_337_1, undefined);
        }, qx.core.AssertionError, "");
        this.assertException(function () {
          qx.data.SingleValueBinding.bind(this.__P_337_0, "appearance", undefined, "appearance");
        }, qx.core.AssertionError, "");
        this.assertException(function () {
          qx.data.SingleValueBinding.bind(this.__P_337_0, undefined, this.__P_337_1, "appearance");
        }, qx.core.AssertionError, "");
        this.assertException(function () {
          qx.data.SingleValueBinding.bind(undefined, "appearance", this.__P_337_1, "appearance");
        }, qx.core.AssertionError, "");
      },
      testRemoveRelatedBindings: function testRemoveRelatedBindings() {
        ...
        qx.data.SingleValueBinding.bind(c, "appearance", this.__P_337_0, "appearance");

        // add another binding to __b, which should not be affected
        qx.data.SingleValueBinding.bind(c, "appearance", this.__P_337_1, "appearance");

        // check if the bindings are there
        var bindingsA = qx.data.SingleValueBinding.getAllBindingsForObject(this.__P_337_0);
        var bindingsB = qx.data.SingleValueBinding.getAllBindingsForObject(this.__P_337_1);
        ...
        qx.data.SingleValueBinding.removeRelatedBindings(this.__P_337_0, this.__P_337_1);

        // __a object should have one binding to object c
        bindingsA = qx.data.SingleValueBinding.getAllBindingsForObject(this.__P_337_0);
        ...
        bindingsB = qx.data.SingleValueBinding.getAllBindingsForObject(this.__P_337_1);
...
//# sourceMappingURL=Simple.js.map?dt=1722153826438