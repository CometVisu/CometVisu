  ...
  qx.Class.define("qx.test.data.controller.ListReverse", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_341_0 = new qx.ui.form.List();

        // create the model
        this.__P_341_2 = [];
        for (var i = 0; i < 5; i++) {
          this.__P_341_2.push("item" + i);
        }
        // create a new array
        this.__P_341_3 = new qx.data.Array(this.__P_341_2);
        this.__P_341_4 = {
          createItem: function createItem() {
            return new qx.test.ListItem();
          }
        };
        this.__P_341_1 = new qx.data.controller.List();
      },
      tearDown: function tearDown() {
        this.flush();
        this.__P_341_1.dispose();
        this.__P_341_1 = null;
        this.__P_341_3.dispose();
        this.__P_341_3 = null;
        this.__P_341_2 = null;
        this.__P_341_0.dispose();
      },
      testStringListModel: function testStringListModel() {
        this.__P_341_4.bindItem = function (controller, item, id) {
        ...
        this.__P_341_1.set({
          target: this.__P_341_0,
          delegate: this.__P_341_4,
          iconPath: "",
          model: this.__P_341_3
        });

        // check for the binding model --> target
        var items = this.__P_341_0.getChildren();
        for (var i = 0; i < items.length; i++) {
          this.__P_341_3.setItem(i, "abc" + i);
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getLabel(), this.__P_341_3.getItem(i));
        }

        // check for the binding target(icon) --> model
        for (var i = 0; i < items.length; i++) {
          items[i].setIcon("AFFE" + i);
          this.assertEquals(items[i].getIcon(), this.__P_341_3.getItem(i));
        }
        ...
        this.__P_341_1.update();

        // check for the removed binding target(icon) --> model
        for (var i = 0; i < items.length; i++) {
          items[i].setIcon("123-" + i);
          this.assertEquals("AFFE" + i, this.__P_341_3.getItem(i));
        }
      },
      ...
      testStringListModelDeepTarget: function testStringListModelDeepTarget() {
        ...
        this.__P_341_4.configureItem = function (item) {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getChild().getLabel(), this.__P_341_3.getItem(i));
        }
      ...
      testStringListModelArrayTarget: function testStringListModelArrayTarget() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getChildren().getItem(0).getLabel(), this.__P_341_3.getItem(i));
        }
...
//# sourceMappingURL=ListReverse.js.map?dt=1778272831866