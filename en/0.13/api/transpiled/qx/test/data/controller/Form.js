  ...
  qx.Class.define("qx.test.data.controller.Form", {
    ...
    members: {
      ...
      setUp: function setUp() {
        // create the objects
        this.__P_338_0 = new qx.ui.form.Form();
        this.__P_338_1 = new qx.ui.form.TextField();
        this.__P_338_2 = new qx.ui.form.TextField("init");
        this.__P_338_3 = new qx.ui.form.CheckBox();
        this.__P_338_4 = qx.data.marshal.Json.createModel({
          tf1: null,
          tf2: null,
          cb: null
        });
        ...
        // build the form
        this.__P_338_0.add(this.__P_338_1, "label1", null, "tf1");
        this.__P_338_0.add(this.__P_338_2, "label2", null, "tf2");
        this.__P_338_0.add(this.__P_338_3, "label3", null, "cb");
      },
      tearDown: function tearDown() {
        this.__P_338_0.dispose();
        this.__P_338_4.dispose();
        this.__P_338_1.dispose();
        this.__P_338_2.destroy();
        this.__P_338_3.destroy();
      },
      testSetModelNull: function testSetModelNull() {
        var c = new qx.data.controller.Form(this.__P_338_4, this.__P_338_0);

        // set some values
        this.__P_338_1.setValue("1111");
        this.__P_338_2.setValue("2222");
        this.__P_338_3.setValue(true);

        // set model to null
        c.setModel(null);

        // all values should be null as well
        this.assertNull(this.__P_338_1.getValue());
        this.assertNull(this.__P_338_2.getValue());
        this.assertFalse(this.__P_338_3.getValue());
        c.dispose();
      },
      testInitialResetter: function testInitialResetter() {
        ...
        var c = new qx.data.controller.Form(this.__P_338_4, this.__P_338_0);
        this.__P_338_2.setValue("affe");
        this.__P_338_0.reset();
        this.assertEquals(null, this.__P_338_2.getValue());
        c.dispose();
      },
      testUnidirectionalDeep: function testUnidirectionalDeep() {
        this.__P_338_0.dispose();
        this.__P_338_0 = new qx.ui.form.Form();
        this.__P_338_0.add(this.__P_338_1, "label1", null, "a.tf1");
        this.__P_338_0.add(this.__P_338_2, "label2", null, "a.tf2");
        // just create the controller
        var c = new qx.data.controller.Form(null, this.__P_338_0, true);
        var model = c.createModel();
        // check if the binding from the model to the view works
        model.getA().setTf1("affe");
        this.assertEquals("affe", this.__P_338_1.getValue());

        // check if the other direction does not work
        this.__P_338_2.setValue("affee");
      ...
      testUnidirectionalSelectionOptions: function testUnidirectionalSelectionOptions() {
        // just create the controller
        var c = new qx.data.controller.Form(this.__P_338_4, this.__P_338_0, true);
      ...
      testUnidirectionalOptions: function testUnidirectionalOptions() {
        ...
        // check if the other direction does not work
        this.__P_338_1.setValue("affe");
        this.assertEquals(null, this.__P_338_4.getTf1());

        // use the commit method
        c.updateModel();
        this.assertEquals("affea", this.__P_338_4.getTf1());
      ...
      testUnidirectional: function testUnidirectional() {
        ...
        // check if the binding from the model to the view works
        this.__P_338_4.setTf1("affe");
        this.assertEquals("affe", this.__P_338_1.getValue());

        // check if the other direction does not work
        this.__P_338_2.setValue("affee");
        this.assertEquals(null, this.__P_338_4.getTf2());

        // use the commit method
        c.updateModel();
        this.assertEquals("affee", this.__P_338_4.getTf2());
      ...
      testCreateWithModel: function testCreateWithModel() {
        // just create the controller
        var c = new qx.data.controller.Form(this.__P_338_4);
        // check for the properties
        this.assertEquals(this.__P_338_4, c.getModel());
        this.assertNull(c.getTarget());
        // destroy the objects
        c.dispose();
      },
      testCreateWithForm: function testCreateWithForm() {
        // just create the controller
        var c = new qx.data.controller.Form(null, this.__P_338_0);
        // check for the properties
        this.assertEquals(this.__P_338_0, c.getTarget());
        this.assertNull(c.getModel());
        // destroy the objects
        c.dispose();
      },
      ...
      testBindingCreate: function testBindingCreate() {
        ...
        this.__P_338_1.setValue("1");
        this.__P_338_2.setValue("2");
        this.__P_338_3.setValue(true);

        // check the binding
        this.assertEquals(this.__P_338_1.getValue(), this.__P_338_4.getTf1());
        this.assertEquals(this.__P_338_2.getValue(), this.__P_338_4.getTf2());
        this.assertEquals(this.__P_338_3.getValue(), this.__P_338_4.getCb());

        // change the values
        this.__P_338_1.setValue("11");
        this.__P_338_2.setValue("21");
        this.__P_338_3.setValue(false);
        ...
        this.__P_338_4.setTf1("a");
        this.__P_338_4.setTf2("b");
        this.__P_338_4.setCb(true);
      ...
      testBindingChangeModel: function testBindingChangeModel() {
        ...
        // set values in the form
        this.__P_338_1.setValue("11");
        this.__P_338_2.setValue("22");
        this.__P_338_3.setValue(false);

        // check the new model
        this.assertEquals(this.__P_338_1.getValue(), model2.getTf1());
        this.assertEquals(this.__P_338_2.getValue(), model2.getTf2());
        this.assertEquals(this.__P_338_3.getValue(), model2.getCb());

        // check the old model
        this.assertEquals("1", this.__P_338_4.getTf1());
        this.assertEquals("2", this.__P_338_4.getTf2());
        this.assertEquals(true, this.__P_338_4.getCb());
        model2.dispose();
        c.dispose();
      },
      testBindingChangeForm: function testBindingChangeForm() {
        ...
        // check the binding
        this.assertEquals(tf1.getValue(), this.__P_338_4.getTf1());
        this.assertEquals(tf2.getValue(), this.__P_338_4.getTf2());
        this.assertEquals(cb.getValue(), this.__P_338_4.getCb());

        // check the old from
        this.assertEquals(this.__P_338_1.getValue(), "1");
        this.assertEquals(this.__P_338_2.getValue(), "2");
        this.assertEquals(this.__P_338_3.getValue(), true);
        form.dispose();
        tf1.destroy();
        tf2.destroy();
        cb.destroy();
      ...
      testBindingModelSelection: function testBindingModelSelection() {
        ...
        this.__P_338_0.add(selectBox, "sb");
        ...
        // create the controller
        var c = new qx.data.controller.Form(model, this.__P_338_0);
      ...
      testModelCreation: function testModelCreation() {
        ...
        this.__P_338_1.setValue("A");
        this.__P_338_2.setValue("B");
        this.__P_338_3.setValue(true);
        ...
        this.assertEquals("A", this.__P_338_1.getValue());
        this.assertEquals("B", this.__P_338_2.getValue());
        this.assertTrue(this.__P_338_3.getValue());
        ...
        // check the binding
        this.assertEquals(this.__P_338_1.getValue() + "-", model.getTf1());
        this.assertEquals(this.__P_338_2.getValue(), model.getTf2());
        this.assertEquals(this.__P_338_3.getValue(), model.getCb());
      ...
      testRemoveTarget: function testRemoveTarget() {
        ...
        // add the selectBox to the form
        this.__P_338_0.add(selectBox, "sb");
        this.__P_338_0.add(this.__P_338_1, "tf1");
        var model = qx.data.marshal.Json.createModel({
          tf1: null,
          tf2: null,
          cb: null,
        ...
        this.__P_338_1.setValue("viele affen");
        selectBox.setSelection([i1]);
      ...
      testOptions: function testOptions() {
        ...
        // check the binding
        this.assertEquals("X" + this.__P_338_1.getValue(), this.__P_338_4.getTf1());
        this.assertEquals(this.__P_338_2.getValue(), this.__P_338_4.getTf2());
        ...
        // change the data in the model
        this.__P_338_4.setTf1("Xa");
        this.__P_338_4.setTf2("b");

        // check the binding
        this.assertEquals(this.__P_338_1.getValue(), this.__P_338_4.getTf1().substring(1));
        this.assertEquals(this.__P_338_2.getValue(), this.__P_338_4.getTf2());
      ...
      testDispose: function testDispose() {
        ...
        this.__P_338_4.setTf1("AFFE");
        this.assertNotEquals("AFFE", this.__P_338_1.getValue());
      },
      testBindingCreateMissingOne: function testBindingCreateMissingOne() {
        // add an unknown item
        var tf = new qx.ui.form.TextField();
        this.__P_338_0.add(tf, "Unknown");
...
//# sourceMappingURL=Form.js.map?dt=1782595061830