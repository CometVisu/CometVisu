  ...
  qx.Class.define("qx.test.data.controller.List", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        this.__P_330_1 ? this.__P_330_1.dispose() : null;
        this.__P_330_3 ? this.__P_330_3.dispose() : null;
        for (var i = 0; i < this.__P_330_0.getChildren().length; i++) {
          this.__P_330_0.getChildren()[i].destroy();
        }
      ...
      __P_330_4: function __P_330_4(attribute) {
        this.__P_330_2 = ["a", "b", "c", "d", "e"];
        // create a new array
        this.__P_330_3 = new qx.data.Array(this.__P_330_2);

        // create the controller
        this.__P_330_1 = new qx.data.controller.List(this.__P_330_3, this.__P_330_0);
      },
      ...
      testModelChangeCombobox: function testModelChangeCombobox() {
        ...
        var controller = new qx.data.controller.List(this.__P_330_3, box);
      ...
      testStringArray: function testStringArray() {
        ...
        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var label = this.__P_330_0.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i], label, "Binding " + i + " is wrong!");
        }
      },
      testEmptyList: function testEmptyList() {
        this.__P_330_4();
        this.__P_330_1.setModel(null);

        // check that the list is empty
        this.assertEquals(0, this.__P_330_0.getChildren().length);
      },
      testStringElementRemove: function testStringElementRemove() {
        this.__P_330_4();

        // remove the last elements
        this.__P_330_2.shift();
        this.__P_330_3.shift();
        ...
        // check the length
        this.assertEquals(this.__P_330_2.length, this.__P_330_0.getChildren().length, "Wrong length!");
      },
      testStringElementAdd: function testStringElementAdd() {
        this.__P_330_4();

        // remove the last elements
        this.__P_330_2.unshift("A");
        this.__P_330_3.unshift("A");
      ...
      testChangeModelSmaller: function testChangeModelSmaller() {
        ...
        // change one element
        this.__P_330_2 = ["f", "g", "h", "i"];
        this.__P_330_3 = new qx.data.Array(this.__P_330_2);
        this.__P_330_1.setModel(this.__P_330_3);
      ...
      testChangeTarget: function testChangeTarget() {
        ...
        this.assertEquals(0, this.__P_330_0.getChildren().length, "Wrong length!");
        list.dispose();
      },
      testReverse: function testReverse() {
        ...
        // reverse the datas
        this.__P_330_2.reverse();
        this.__P_330_3.reverse();
      ...
      testBooleanArray: function testBooleanArray() {
        this.__P_330_2 = [true, false, false];
        // create a new array
        this.__P_330_3 = new qx.data.Array(this.__P_330_2);
      ...
      testSelectBox: function testSelectBox() {
        ...
        this.__P_330_1 = new qx.data.controller.List(this.__P_330_3, box);

        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var label = box.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i], label, "SelectBox-Binding " + i + " is wrong!");
        }
        box.dispose();
      },
      testComboBox: function testComboBox() {
        ...
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var label = box.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i], label, "ComboBox-Binding " + i + " is wrong!");
        }
        box.dispose();
      },
      testResetSelectionSingle: function testResetSelectionSingle() {
        this.__P_330_4();
        var box = new qx.ui.form.SelectBox();
        this.__P_330_1.setTarget(box);
        var model = new qx.data.Array(["x", "y", "z"]);
        this.__P_330_1.getSelection().push("b");

        // change the model (should reset the selection)
        this.__P_330_1.setModel(model);

        // first element should be selected because its a select box

        this.wait(100, function () {
          this.assertEquals("x", this.__P_330_1.getSelection().getItem(0));
          model.dispose();
          box.destroy();
        }, this);
      },
      testSelectionSingle: function testSelectionSingle() {
        ...
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[0]);
        // test the selection
        this.assertEquals(this.__P_330_3.getItem(0), this.__P_330_1.getSelection().getItem(0), "Selection does not work.");

        // test for the length
        this.assertEquals(1, this.__P_330_1.getSelection().length, "Selection length is wrong.");

        // select the second object
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[1]);
        // test the selection
        this.assertEquals(this.__P_330_3.getItem(1), this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
      ...
      testSelectionSingleRemoveFirst: function testSelectionSingleRemoveFirst() {
        this.__P_330_4();
        var model = this.__P_330_3;
        this.__P_330_0.setSelectionMode("one");
        var selection = this.__P_330_1.getSelection();
        this.assertEquals(model.getItem(0), this.__P_330_0.getSelection()[0].getModel());
      ...
      testSelectionMultiple: function testSelectionMultiple() {
        ...
        this.__P_330_0.setSelectionMode("multi");
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[1]);
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[2]);

        // test the selection
        this.assertEquals(this.__P_330_3.getItem(1), this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
        this.assertEquals(this.__P_330_3.getItem(2), this.__P_330_1.getSelection().getItem(1), "Selection does not work.");

        // test for the selection length
        this.assertEquals(2, this.__P_330_1.getSelection().length, "Selection length is wrong.");
      },
      testSelectionBackSingle: function testSelectionBackSingle() {
        this.__P_330_4();

        // add the first element to the selection
        this.__P_330_1.getSelection().push(this.__P_330_3.getItem(0));

        // test the selection
        this.assertEquals(this.__P_330_3.getItem(0), this.__P_330_1.getSelection().getItem(0), "addToSelection does not work.");
      },
      testSelectionBackMultiple: function testSelectionBackMultiple() {
        ...
        this.__P_330_1.getSelection().push(this.__P_330_3.getItem(1));
        this.__P_330_1.getSelection().push(this.__P_330_3.getItem(2));

        // test the selection
        this.assertEquals(this.__P_330_3.getItem(1), this.__P_330_1.getSelection().getItem(0), "addToSelection does not work.");
        this.assertEquals(this.__P_330_3.getItem(2), this.__P_330_1.getSelection().getItem(1), "addToSelection does not work.");
      },
      testSelectionArrayChange: function testSelectionArrayChange() {
        this.__P_330_4();

        // set a new selection array
        this.__P_330_1.setSelection(new qx.data.Array([this.__P_330_3.getItem(0)]));

        // test the selection
        this.assertEquals(this.__P_330_3.getItem(0), this.__P_330_0.getSelection()[0].getLabel(), "Change the selection array does not work.");
        this.__P_330_1.getSelection().dispose();
      },
      ...
      testSelectionArrayReverse: function testSelectionArrayReverse() {
        ...
        var self = this;
        this.wait(100, function () {
          self.assertEquals(self.__P_330_3.getItem(self.__P_330_3.getLength() - 1), self.__P_330_0.getSelection()[0].getLabel(), "Can not handle reverse.");
        });
      },
      testSelectionAfterDelete: function testSelectionAfterDelete() {
        ...
        this.assertTrue(this.__P_330_1.getSelection().contains("b"), "Selection array wrong!");

        // selection updates work with the widget pool and can be async
        this.wait(100, function () {
          this.assertEquals("b", this.__P_330_0.getSelection()[0].getLabel(), "Remove from selection does not work!");
        }, this);
      },
      testSelectionAfterDeleteEmpty: function testSelectionAfterDeleteEmpty() {
        ...
        this.__P_330_1.getSelection().push("c");
        // remove the c
        this.__P_330_3.splice(2, 1);

        // selection updates work with the widget pool and can be async
        this.wait(100, function () {
          // check if the selection is empty
          this.assertEquals(0, this.__P_330_1.getSelection().length, "Remove from selection does not work!");
        }, this);
      },
      testResetBug: function testResetBug() {
        ...
        this.__P_330_1.bind("selection[0]", label, "value");
      ...
      testDates: function testDates() {
        this.__P_330_2 = [new Date(0), new Date(100)];
        // create a new array
        this.__P_330_3 = new qx.data.Array(this.__P_330_2);
        ...
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var label = this.__P_330_0.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i].toString(), label, "Date-Binding " + i + " is wrong!");
        }
      },
      testConversionLabel: function testConversionLabel() {
        ...
        this.__P_330_1.setLabelOptions(options);

        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var label = this.__P_330_0.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i] + " Converted", label, "Binding " + i + " is wrong!");
        }
      },
      ...
      testSelectBoxSelectionSingle: function testSelectBoxSelectionSingle() {
        ...
        this.__P_330_1.getSelection().push("10");
      ...
      testSelectionWithModelChange: function testSelectionWithModelChange() {
        ...
        // change the model
        this.__P_330_1.setModel(new qx.data.Array(["x", "y", "z"]));

        // test for an empty selection
        this.assertEquals(0, this.__P_330_1.getSelection().length, "Selection is not empty.");

        // select an item
        this.__P_330_1.getSelection().push("x");

        // test for the selection
        this.assertEquals("x", this.__P_330_1.getSelection().getItem(0), "Selection is wrong.");
        this.__P_330_1.getModel().dispose();
      },
      testSelectionWithModelChangeSelectBox: function testSelectionWithModelChangeSelectBox() {
        ...
        var selectBox = new qx.ui.form.SelectBox();
        // create the controller
        this.__P_330_1 = new qx.data.controller.List(this.__P_330_3, selectBox);

        // first object is selected (one selection mode)

        // test the selection
        this.assertEquals(this.__P_330_3.getItem(0), selectBox.getSelection()[0].getModel());
        this.assertEquals(this.__P_330_3.getItem(0), this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
        ...
        // select an item
        this.__P_330_1.getSelection().push("y");

        // test for the selection
        this.assertEquals(1, this.__P_330_1.getSelection().length, "Selection has a wrong length.");
        this.assertEquals("y", this.__P_330_1.getSelection().getItem(0), "Selection is wrong.");
        this.__P_330_1.setModel(new qx.data.Array(["1", "2", "3"]));
        this.__P_330_1.addListener("changeSelection", function () {
          _this.resume(function () {
            // test for the first selected item (one selection)
            this.assertEquals(1, this.__P_330_1.getSelection().length, "Selection has a wrong length.");
            this.assertEquals("1", this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
            selectBox.dispose();
          }, _this);
        });
        this.wait();
      ...
      testFilterApply: function testFilterApply() {
        ...
        this.__P_330_1.setDelegate(delegate);

        // check the binding
        for (var i = 0; i < this.__P_330_2.length - 2; i++) {
          var label = this.__P_330_0.getChildren()[i].getLabel();
          this.assertEquals(this.__P_330_2[i + 1], label, "Binding " + i + " is wrong!");
        }
      },
      testFilterChange: function testFilterChange() {
        ...
        this.__P_330_1.setDelegate(delegate1);
        this.__P_330_1.setDelegate(delegate2);
      ...
      testFilterChangeModel: function testFilterChangeModel() {
        ...
        this.assertEquals(0, this.__P_330_0.getChildren().length, "Some list items created.");
        var model = new qx.data.Array("A", "B", "C", "D", "E");
        this.__P_330_1.setModel(model);

        // check the length
        this.assertEquals(3, this.__P_330_0.getChildren().length, "Wrong number of list items");

        // check the labels
        this.assertEquals("B", this.__P_330_0.getChildren()[0].getLabel(), "Binding is wrong!");
        this.assertEquals("C", this.__P_330_0.getChildren()[1].getLabel(), "Binding is wrong!");
        this.assertEquals("D", this.__P_330_0.getChildren()[2].getLabel(), "Binding is wrong!");
        model.dispose();
      },
      testFilterReverseModel: function testFilterReverseModel() {
        ...
        // check for the right length
        this.assertEquals(3, this.__P_330_0.getChildren().length, "Some list items created.");

        // check the labels
        this.assertEquals("a", this.__P_330_0.getChildren()[0].getLabel(), "Binding is wrong!");
        this.assertEquals("b", this.__P_330_0.getChildren()[1].getLabel(), "Binding is wrong!");
        this.assertEquals("c", this.__P_330_0.getChildren()[2].getLabel(), "Binding is wrong!");
        ...
        // check the labels
        this.assertEquals("c", this.__P_330_0.getChildren()[0].getLabel(), "Binding is wrong!");
        this.assertEquals("b", this.__P_330_0.getChildren()[1].getLabel(), "Binding is wrong!");
        this.assertEquals("a", this.__P_330_0.getChildren()[2].getLabel(), "Binding is wrong!");
      },
      testFilterRemove: function testFilterRemove() {
        ...
        // remove the filter
        this.__P_330_1.setDelegate(null);

        // check for the right length
        this.assertEquals(5, this.__P_330_0.getChildren().length, "Some list items created.");

        // check the labels
        this.assertEquals("a", this.__P_330_0.getChildren()[0].getLabel(), "Binding is wrong!");
        this.assertEquals("b", this.__P_330_0.getChildren()[1].getLabel(), "Binding is wrong!");
        this.assertEquals("c", this.__P_330_0.getChildren()[2].getLabel(), "Binding is wrong!");
        this.assertEquals("d", this.__P_330_0.getChildren()[3].getLabel(), "Binding is wrong!");
        this.assertEquals("e", this.__P_330_0.getChildren()[4].getLabel(), "Binding is wrong!");
      },
      testFilterChangeTarget: function testFilterChangeTarget() {
        ...
        this.assertEquals(2, this.__P_330_0.getChildren().length, "Wrong number of list items");

        // change the target
        this.__P_330_1.setTarget(null);
        // check if everything is cleaned up
        this.assertEquals(0, this.__P_330_0.getChildren().length, "Wrong number of list items");
      ...
      testFilterWithSelection: function testFilterWithSelection() {
        ...
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[1]);
        // test the selection
        this.assertEquals(this.__P_330_3.getItem(4), this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
      ...
      testFilterAfterSelection: function testFilterAfterSelection() {
        ...
        this.__P_330_1.setDelegate(delegate);
        this.assertEquals("b", this.__P_330_1.getSelection().getItem(0), "Selection does not work.");
        this.assertEquals("b", this.__P_330_0.getSelection()[0].getLabel(), "Selection does not work.");
      },
      testDelegateLate: function testDelegateLate() {
        ...
        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var item = this.__P_330_0.getChildren()[i];
      ...
      testDelegateFirst: function testDelegateFirst() {
        ...
        this.__P_330_1.setDelegate(delegate);
        this.__P_330_1.setTarget(this.__P_330_0);
        this.__P_330_1.setModel(this.__P_330_3);
      ...
      testDelegateBindItem: function testDelegateBindItem() {
        this.__P_330_2 = [true, true, false, true, false];
        // create a new array
        this.__P_330_3 = new qx.data.Array(this.__P_330_2);
        this.__P_330_1 = new qx.data.controller.List();
        var delegate = {};
        ...
        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          this.assertEquals("qx.ui.form.CheckBox", this.__P_330_0.getChildren()[i].classname);
          var label = this.__P_330_0.getChildren()[i].getEnabled();
          this.assertEquals(this.__P_330_2[i], label, "Binding " + i + " is wrong!");
        }
      },
      ...
      testSelectionSequence: function testSelectionSequence() {
        ...
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[4]);
        this.__P_330_0.addToSelection(this.__P_330_0.getChildren()[3]);

        // special hack for chrome because his selection order is different
        selController.setModel(this.__P_330_1.getSelection());
        var labels = [];
      ...
      testGetVisibleModels: function testGetVisibleModels() {
        ...
        this.__P_330_1.setDelegate(delegate);
        var visibleModels = this.__P_330_1.getVisibleModels();
      ...
      testBindIconWithStringArray: function testBindIconWithStringArray() {
        this.__P_330_4();
        this.__P_330_1.setIconPath("");

        // check the binding
        for (var i = 0; i < this.__P_330_2.length; i++) {
          var icon = this.__P_330_0.getChildren()[i].getIcon();
          this.assertEquals(this.__P_330_2[i], icon, "Binding " + i + " is wrong!");
        }
      },
      testScrollBySelection: function testScrollBySelection() {
        this.__P_330_4();
        // set a smal hight (list has to scroll)
        this.__P_330_0.setHeight(40);
        this.getRoot().add(this.__P_330_0);
        var selectables = this.__P_330_0.getSelectables();

        // select the first item
        this.__P_330_0.setSelection([selectables[0]]);
        // scroll a bit down (scrollY is 40)
        this.__P_330_0.scrollByY(40);
        // select the current visible item
        this.__P_330_0.addToSelection(selectables[2]);
        // check that it has not been scrolled
        this.assertEquals(40, this.__P_330_0.getScrollY());
      },
      ...
      testSpliceAll: function testSpliceAll() {
        this.__P_330_4();
        this.__P_330_3.splice(0, 5, "A", "B", "C", "D", "E");
        this.assertEquals("E", this.__P_330_0.getChildren()[4].getLabel());
      }
    }
  });
...
//# sourceMappingURL=List.js.map?dt=1735383859994