  ...
  qx.Class.define("qx.test.data.controller.FormWithArrayAndModel", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        qx.Class.define("qx.test.data.controller.fixture.ArrayField", {
          ...
          members: {
            ...
            setValue: function setValue(value) {
              var oldValue = this.__P_328_4;
              this.__P_328_4 = value;
        ...
        this.__P_328_0 = new qx.test.data.controller.fixture.ArrayField();
        this.__P_328_1 = new qx.test.data.controller.fixture.ModelField();
        this.__P_328_2 = new qx.ui.form.Form();
        this.__P_328_2.add(this.__P_328_0, "One", null, "f1");
        this.__P_328_2.add(this.__P_328_1, "Two", null, "f2");
        this.__P_328_3 = qx.data.marshal.Json.createModel({
          f1: null,
          f2: null,
          f3: null
        });
      ...
      tearDown: function tearDown() {
        this._disposeObjects("__P_328_0", "__P_328_1", "__P_328_2", "__P_328_3");
      ...
      "test self update: array": function test_self_update_array() {
        ...
        this.assertNull(this.__P_328_0.getValue());
        this.assertNull(this.__P_328_3.getF1());

        // user changes field and hits ok button
        this.__P_328_0.setValue(arr);
        ctrl.updateModel();
        this.assertIdentical(arr, this.__P_328_3.getF1());
        ctrl.dispose();
        arr.dispose();
      },
      "test self update: model": function test_self_update_model() {
        ...
        this.__P_328_1.createModel(false);
        ...
        this.assertIdentical("42", this.__P_328_3.getF2().getHouseNr());
        this.assertIdentical("Nowhere Ln", this.__P_328_3.getF2().getStreetName());
        ctrl.dispose();
        addressForm.dispose();
      },
      ...
      "test updating model: array field": function test_updating_model_array_field() {
        ...
        this.__P_328_3.setF1(arr);
        this.assertIdentical(arr, this.__P_328_0.getValue());
        ctrl.dispose();
        arr.dispose();
      },
      "test updating model: model field": function test_updating_model_model_field() {
        ...
        this.assertNull(this.__P_328_1.getValue());
        this.__P_328_1.createModel(false);
        this.assertIdentical(this.__P_328_1.getModel(), this.__P_328_3.getF2());
        ctrl.dispose();
        addressForm.dispose();
      }
    }
...
//# sourceMappingURL=FormWithArrayAndModel.js.map?dt=1722153825675