  ...
  qx.Class.define("qx.test.io.transport.PostMessage", {
    ...
    members: {
      setUp: function setUp() {
        ...
        // create echo server
        var worker = createWorker(function (evt) {
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                return new qx.Promise(function (resolve, reject) {
                  _this.transport.addListenerOnce("message", function (evt) {
                    _this.assertEquals(message, evt.getData());
                  });
                  _this.transport.send(message).then(resolve)["catch"](reject);
                });
              case 3:
              case "end":
...
//# sourceMappingURL=PostMessage.js.map?dt=1717235390629