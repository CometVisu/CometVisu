      ...
      assertExceptionThrown: function assertExceptionThrown(response, exception) {
        ...
        var errorCallback = this.spy(function (err) {
          ...
          if (qx.lang.Type.isNumber(exception)) {
            ...
            _this.assertEquals(exception, err.code, "Error code does not match");
          } else {
        ...
        this.wait(100, function () {
          ...
          exception === qx.io.exception.Protocol) {
            _this.assertCalledTwice(errorCallback);
          } else {
            // the error handler will be called three times
            _this.assertCalledThrice(errorCallback);
          }
        });
      },
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                spy = _this2.spy(function (value) {
                  return _this2.assertEquals(result, value);
                });
                message_out.getPromise().then(spy);
                _context.next = 10;
                return client.send(message_out);
              case 10:
                _this2.assertCalled(spy);
              case 11:
              case "end":
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                client = new qx.io.jsonrpc.Client("http://jsonrpc");
                spy = _this3.spy(function (value) {
                  return _this3.assertEquals(result, value);
                });
                message_out.getPromise().then(spy);
                _context2.next = 10;
                return client.send(message_out);
              case 10:
                _this3.assertCalled(spy);
              case 11:
              case "end":
...
//# sourceMappingURL=Client.js.map?dt=1729101240985