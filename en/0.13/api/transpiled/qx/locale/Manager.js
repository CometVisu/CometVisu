  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_281_0 = qx.$$translations || {};
      this.__P_281_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_281_2 = this.getLocale();
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    members: {
      __P_281_3: qx.core.Environment.get("locale.default"),
      __P_281_4: null,
      __P_281_5: null,
      __P_281_0: null,
      __P_281_1: null,
      ...
      getAvailableLocales: function getAvailableLocales(includeNonloaded) {
        var locales = [];
        for (var locale in this.__P_281_1) {
          if (locale != this.__P_281_3) {
            if (this.__P_281_1[locale] === null && !includeNonloaded) {
       ...
       */
      __P_281_6: function __P_281_6(locale) {
        var language;
        if (locale == null) {
          return null;
        }
      ...
      _applyLocale: function _applyLocale(value, old) {
        this.__P_281_4 = value;
        this.__P_281_5 = this.__P_281_6(value);
      },
      /**
      ...
      translate: function translate(messageId, args, locale) {
        var catalog = this.__P_281_0;
        return this.__P_281_7(catalog, messageId, args, locale);
      },
      /**
       ...
       * @return {String|LocalizedString} translated message or localized string
       */
      __P_281_7: function __P_281_7(catalog, messageId, args, locale) {
        var txt;
        if (!catalog) {
          return messageId;
        }
        if (locale) {
          var language = this.__P_281_6(locale);
        } else {
          locale = this.__P_281_4;
          language = this.__P_281_5;
        }
        ...
        // C
        if (!txt && catalog[this.__P_281_3]) {
          txt = catalog[this.__P_281_3][messageId];
        }
        if (!txt) {
          txt = messageId;
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_281_1);
        }
        return txt;
      }
    }
...
//# sourceMappingURL=Manager.js.map?dt=1735222423964