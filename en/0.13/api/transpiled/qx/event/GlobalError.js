  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.GlobalError", {
    statics: {
       ...
       */
      __P_199_4: function __P_199_4(msg, uri, lineNumber, columnNumber, exception) {
        if (this.__P_199_0) {
      ...
      handleError: function handleError(ex) {
        if (this.__P_199_0) {
          this.__P_199_0.call(this.__P_199_2, ex);
        }
      }
    },
...
//# sourceMappingURL=GlobalError.js.map?dt=1692560709238