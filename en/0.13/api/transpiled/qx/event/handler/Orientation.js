  ...
  qx.Class.define("qx.event.handler.Orientation", {
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_227_3 = qx.lang.Function.listener(this._onNative, this);
        ...
        this.__P_227_2 = qx.bom.Event.supportsEvent(this.__P_227_1, "orientationchange") ? "orientationchange" : "resize";
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_227_1, this.__P_227_2, this.__P_227_3);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_227_1, this.__P_227_2, this.__P_227_3);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onOrientationChange: function _onOrientationChange(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          qx.event.Registration.fireEvent(this.__P_227_1, "orientationchange", qx.event.type.Orientation, [orientation, mode]);
        }
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      this._stopObserver();
      this.__P_227_0 = this.__P_227_1 = null;
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Orientation.js.map?dt=1729101231294