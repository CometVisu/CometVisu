  ...
  qx.Bootstrap.define("qx.event.handler.OrientationCore", {
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_237_1 = qx.lang.Function.listener(this._onNative, this);
        ...
        this.__P_237_2 = qx.bom.Event.supportsEvent(this._window, "orientationchange") ? "orientationchange" : "resize";
        qx.bom.Event.addNativeListener(this._window, this.__P_237_2, this.__P_237_1);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        qx.bom.Event.removeNativeListener(this._window, this.__P_237_2, this.__P_237_1);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onNative: function _onNative(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          domEvent._mode = mode;
          if (this.__P_237_0) {
            this.__P_237_0.emit("orientationchange", domEvent);
          }
        }
      },
      // ------------------------------------------------------------------------
    ...
    */
    destruct: function destruct() {
      this._stopObserver();
      this.__P_237_3 = this.__P_237_0 = null;
    }
  });
  qx.event.handler.OrientationCore.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=OrientationCore.js.map?dt=1778272825320