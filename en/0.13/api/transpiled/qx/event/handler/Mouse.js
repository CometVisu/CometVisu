  ...
  qx.Class.define("qx.event.handler.Mouse", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_226_2 = this.__P_226_1.document;
      this.__P_226_3 = qx.lang.Function.listener(this._onNative, this);
    ...
    */
    ...
    members: {
      ...
      */
      ...
      registerEvent: function registerEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.addNativeListener(target, type, this.__P_226_3);
      ...
      unregisterEvent: function unregisterEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.removeNativeListener(target, type, this.__P_226_3);
        } else if (qx.core.Environment.get("os.name") === "ios") {
      ...
      */
       ...
       */
      __P_226_10: function __P_226_10(domEvent, type, target) {
        if (!target) {
        ...
        qx.event.Registration.fireEvent(this.__P_226_1, "useraction", qx.event.type.Data, [type || domEvent.type]);
      },
      /**
      ...
      */
      ...
      _initButtonObserver: function _initButtonObserver() {
        this.__P_226_4 = qx.lang.Function.listener(this._onButtonEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_226_2, "mousedown", this.__P_226_4);
        Event.addNativeListener(this.__P_226_2, "mouseup", this.__P_226_4);
        Event.addNativeListener(this.__P_226_2, "click", this.__P_226_4);
        Event.addNativeListener(this.__P_226_2, "auxclick", this.__P_226_4);
        Event.addNativeListener(this.__P_226_2, "dblclick", this.__P_226_4);
        Event.addNativeListener(this.__P_226_2, "contextmenu", this.__P_226_4);
      },
      /**
      ...
      _initMoveObserver: function _initMoveObserver() {
        this.__P_226_5 = qx.lang.Function.listener(this._onMoveEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_226_2, "mousemove", this.__P_226_5);
        Event.addNativeListener(this.__P_226_2, "mouseout", this.__P_226_5);
        Event.addNativeListener(this.__P_226_2, "mouseover", this.__P_226_5);
      },
      /**
      ...
      _initWheelObserver: function _initWheelObserver() {
        this.__P_226_6 = qx.lang.Function.listener(this._onWheelEvent, this);
        var data = qx.bom.client.Event.getMouseWheel(this.__P_226_1);
        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_226_6);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopButtonObserver: function _stopButtonObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_226_2, "mousedown", this.__P_226_4);
        Event.removeNativeListener(this.__P_226_2, "mouseup", this.__P_226_4);
        Event.removeNativeListener(this.__P_226_2, "click", this.__P_226_4);
        Event.removeNativeListener(this.__P_226_2, "dblclick", this.__P_226_4);
        Event.removeNativeListener(this.__P_226_2, "contextmenu", this.__P_226_4);
      },
      /**
      ...
      _stopMoveObserver: function _stopMoveObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_226_2, "mousemove", this.__P_226_5);
        Event.removeNativeListener(this.__P_226_2, "mouseover", this.__P_226_5);
        Event.removeNativeListener(this.__P_226_2, "mouseout", this.__P_226_5);
      },
      /**
      ...
      _stopWheelObserver: function _stopWheelObserver() {
        var data = qx.bom.client.Event.getMouseWheel(this.__P_226_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__P_226_6);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onButtonEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        ...
        var target = qx.bom.Event.getTarget(domEvent);
        if (type == "click" && this.__P_226_9) {
          delete this.__P_226_9;
          return;
        }
        ...
        var isDrag = qx.event.handler.DragDrop && this.__P_226_0.getHandler(qx.event.handler.DragDrop).isSessionActive();
        if (isDrag && type == "click") {
          return;
        }
        if (this.__P_226_11) {
          this.__P_226_11(domEvent, type, target);
        }
        this.__P_226_10(domEvent, type, target);
        ...
        if (type == "auxclick" && domEvent.button == 1) {
          this.__P_226_10(domEvent, "click", target);
        }
        if (this.__P_226_12) {
          this.__P_226_12(domEvent, type, target);
        }
        if (this.__P_226_13 && !isDrag) {
          this.__P_226_13(domEvent, type, target);
        }
        this.__P_226_7 = type;
      }),
      /**
      ...
      _onWheelEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        this.__P_226_10(domEvent, "mousewheel");
      }),
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_226_12: qx.core.Environment.select("engine.name", {
        opera: function opera(domEvent, type, target) {
          if (type == "mouseup" && domEvent.button == 2) {
            this.__P_226_10(domEvent, "contextmenu", target);
          }
        },
        "default": null
      }),
       ...
       * @signature function(domEvent, type, target)
       */
      __P_226_11: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent, type, target) {
          ...
          if (type == "mouseup" && this.__P_226_7 == "click") {
            this.__P_226_10(domEvent, "mousedown", target);
       ...
       * @signature function(domEvent, type, target)
       */
      __P_226_13: qx.core.Environment.select("engine.name", {
        mshtml: null,
        "default": function _default(domEvent, type, target) {
          switch (type) {
            case "mousedown":
              this.__P_226_8 = target;
              break;
            case "mouseup":
              if (target !== this.__P_226_8) {
                var commonParent = qx.dom.Hierarchy.getCommonParent(target, this.__P_226_8);
                if (commonParent) {
                  this.__P_226_10(domEvent, "click", commonParent);
                }
              }
          }
        }
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_226_0 = this.__P_226_1 = this.__P_226_2 = this.__P_226_8 = null;
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Mouse.js.map?dt=1735341771016