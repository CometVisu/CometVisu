  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_207_0 = manager;
      this.__P_207_1 = {};

      // Register
      qx.event.handler.Appear.__P_207_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_207_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct: function destruct() {
      this.__P_207_0 = this.__P_207_1 = null;

      // Deregister
      delete qx.event.handler.Appear.__P_207_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Appear.js.map?dt=1672653494786