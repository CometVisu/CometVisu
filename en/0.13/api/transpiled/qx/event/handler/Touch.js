  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct: function construct(manager) {
      // Define shorthands
      this.__P_240_0 = manager;
      this.__P_240_1 = manager.getWindow();
      this.__P_240_2 = this.__P_240_1.document;
      qx.event.handler.TouchCore.apply(this, [this.__P_240_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_240_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      dispose: function dispose() {
        this.__P_240_4("dispose");
        this.__P_240_0 = this.__P_240_1 = this.__P_240_2 = null;
      },
      /**
       ...
       */
      __P_240_4: function __P_240_4(method, args) {
...
//# sourceMappingURL=Touch.js.map?dt=1782595056764