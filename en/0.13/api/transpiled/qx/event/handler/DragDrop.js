    ...
    members: {
      ...
      */
      ...
      getCurrentActionAsync: qx.core.Environment.select("qx.promise", {
        "true": function _true() {
          var self = this;
          return qx.Promise.resolve(self.__P_210_16()).then(function () {
            return self.__P_210_10;
          });
        },
      ...
      */
       ...
       */
      __P_210_16: function __P_210_16() {
        if (this.__P_210_4 == null) {
        ...
        if (current != old) {
          if (this.__P_210_3) {
            qx.event.Utils["catch"](function () {
              self.__P_210_13 = false;
              current = null;
            });
            qx.event.Utils.then(tracker, function () {
              self.__P_210_10 = current;
              return self.__P_210_17("dragchange", self.__P_210_3, self.__P_210_4, true);
            });
        ...
        return qx.event.Utils.then(tracker, function () {
          if (current != old) {
            self.__P_210_10 = current;
            return self.__P_210_17("dragchange", self.__P_210_4, self.__P_210_3, false);
          }
        });
      },
      /**
       ...
       */
      __P_210_18: function __P_210_18(elem) {
       ...
       */
      __P_210_19: function __P_210_19(elem) {
        while (elem && elem.nodeType == 1) {
      ...
      */
      ...
      _start: function _start(e) {
        ...
        if (draggable) {
          ...
          qx.event.Utils.then(tracker, function () {
            return self.__P_210_17("dragstart", self.__P_210_4, self.__P_210_3, true, e);
          });
      ...
      _onPointermove: function _onPointermove(e) {
        ...
        return qx.event.Utils.then(tracker, function () {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            return self.__P_210_17("drag", self.__P_210_4, self.__P_210_3, true, e);
          });
          qx.event.Utils.then(tracker, function (validAction) {
            if (!validAction) {
              this.clearSession();
            ...
            if (el !== cursorEl) {
              ...
              // only previous drop target
                ...
                var innerTracker = {};
                qx.event.Utils.then(innerTracker, function () {
                  return self.__P_210_17("dragleave", self.__P_210_3, self.__P_210_4, false, e);
                });
                return qx.event.Utils.then(innerTracker, function () {
                  self.__P_210_3 = null;
                  self.__P_210_12 = false;
                  return self.__P_210_16();
                });
              }
            }
          });
...
//# sourceMappingURL=DragDrop.js.map?dt=1692560710058