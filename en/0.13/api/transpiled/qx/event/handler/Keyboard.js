  ...
  qx.Class.define("qx.event.handler.Keyboard", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      if (qx.core.Environment.get("engine.name") == "gecko") {
        this.__P_225_2 = this.__P_225_1;
      } else {
        this.__P_225_2 = this.__P_225_1.document.documentElement;
      }
    ...
    members: {
      ...
      */
      ...
      _fireInputEvent: function _fireInputEvent(domEvent, charCode) {
        ...
        if (target && target.offsetWidth != 0) {
          ...
          qx.event.Utils.then(tracker, function () {
            self.__P_225_0.dispatchEvent(target, event);
          });
        }
        ...
        if (this.__P_225_1) {
          var self = this;
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_225_1, "useraction", qx.event.type.Data, ["keyinput"]);
          });
        }
      ...
      _fireSequenceEvent: function _fireSequenceEvent(domEvent, type, keyIdentifier) {
        ...
        qx.event.Utils.then(tracker, function () {
          return self.__P_225_0.dispatchEvent(target, event);
        });
        ...
        if (this.__P_225_1) {
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_225_1, "useraction", qx.event.type.Data, [type]);
          });
        }
        return tracker.promise;
      },
       ...
       */
      __P_225_8: function __P_225_8() {
        var focusHandler = this.__P_225_0.getHandler(qx.event.handler.Focus);
        ...
        if (!target || target.offsetWidth == 0) {
          target = this.__P_225_0.getWindow().document.body;
        }
        return target;
      },
      /*
      ...
      */
      ...
      _initKeyObserver: function _initKeyObserver() {
        this.__P_225_4 = qx.lang.Function.listener(this.__P_225_9, this);
        this.__P_225_7 = qx.lang.Function.listener(this.__P_225_10, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_225_2, "keyup", this.__P_225_4);
        Event.addNativeListener(this.__P_225_2, "keydown", this.__P_225_4);
        Event.addNativeListener(this.__P_225_2, "keypress", this.__P_225_7);
      },
      /**
      ...
      _stopKeyObserver: function _stopKeyObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_225_2, "keyup", this.__P_225_4);
        Event.removeNativeListener(this.__P_225_2, "keydown", this.__P_225_4);
        Event.removeNativeListener(this.__P_225_2, "keypress", this.__P_225_7);
        for (var key in this.__P_225_6 || {}) {
          var listener = this.__P_225_6[key];
          Event.removeNativeListener(listener.target, "keypress", listener.callback);
        }
        delete this.__P_225_6;
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_225_9: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko|webkit|mshtml": function geckoWebkitMshtml(domEvent) {
          ...
          // Store last type
          this.__P_225_3[keyCode] = type;
          return tracker.promise;
        },
        opera: function opera(domEvent) {
          this.__P_225_5 = domEvent.keyCode;
          ...
          if (type === "keydown" && (keyCode == 33 || keyCode == 34 || keyCode == 38 || keyCode == 40) && target.type == "text" && target.tagName.toLowerCase() === "input" && target.getAttribute("autoComplete") !== "off") {
            ...
            this.__P_225_6[hash] = {
              ...
              callback: function callback(domEvent) {
                ...
                self.__P_225_10(domEvent);
              }
            };
            var listener = qx.event.GlobalError.observeMethod(this.__P_225_6[hash].callback);
       ...
       * @param domEvent {Event} DOM event object
       */
      __P_225_10: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        ...
        opera: function opera(domEvent) {
          ...
          if (keyCode != this.__P_225_5) {
            return this._idealKeyHandler(0, this.__P_225_5, type, domEvent);
          } else {
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_225_5 = this.__P_225_0 = this.__P_225_1 = this.__P_225_2 = this.__P_225_3 = null;
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Keyboard.js.map?dt=1735341770980