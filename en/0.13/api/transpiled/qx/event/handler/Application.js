  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_217_0 = false;
      this.__P_217_1 = false;
      this.__P_217_2 = false;
      this.__P_217_3 = false;
      this.__P_217_4 = false;
    ...
    */
    ...
    members: {
      ...
      */
       ...
       *
       */
      __P_217_5: function __P_217_5() {
        // Wrapper qxloader needed to be compatible with old generator
        if (!this.__P_217_2 && this.__P_217_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_217_7),
          "false": this.__P_217_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_217_8),
          "false": this.__P_217_8
        });
        callback.apply(this, arguments);
      },
      /**
...
//# sourceMappingURL=Application.js.map?dt=1722151823185