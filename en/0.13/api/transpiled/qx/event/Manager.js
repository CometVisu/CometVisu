  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct: function construct(win, registration) {
      ...
      this.__P_201_2 = registration; // Register to the page unload event.
      ...
      this.__P_201_3 = {}; // The handler and dispatcher instances
    ...
    members: {
      ...
      */
      ...
      dispose: function dispose() {
        ...
        qx.util.DisposeUtil.disposeMap(this, "__P_201_5"); // Dispose data fields
...
//# sourceMappingURL=Manager.js.map?dt=1685978120606