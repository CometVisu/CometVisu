    ...
    statics: {
      ...
      startDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        "true": function _true() {
          ...
          this.__P_201_0 = qx.core.ObjectRegistry.getNextHash();
      ...
      stopDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        "true": function _true(checkFunction, startHandle) {
          ...
          var undisposedObjects = this.showDisposeProfiling(checkFunction, startHandle || this.__P_201_0);
          delete this.__P_201_0;
      ...
      showDisposeProfiling: qx.core.Environment.select("qx.debug.dispose", {
        "true": function _true(checkFunction) {
          ...
          for (var hash = this.__P_201_0; hash < nextHashLast; hash++) {
...
//# sourceMappingURL=Debug.js.map?dt=1782595054027