  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.TestCase", {
    ...
    members: {
       ...
       */
      resumeSetUp: function resumeSetUp() {
        var func = this.getTestFunc();
        var inst = this;
        var method = func.getName();
        return this.getTestResult().run(func, function () {
          try {
            inst[method]();
          } catch (ex) {
            throw ex;
       ...
       */
      resumeHandler: function resumeHandler(deferredFunction, self) {
      ...
      doAutoDispose: function doAutoDispose() {
        if (this.__P_202_0) {
          this.__P_202_0.forEach(function (obj) {
            if (!obj.isDisposed()) {
...
//# sourceMappingURL=TestCase.js.map?dt=1729101229882