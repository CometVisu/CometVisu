  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.dev.unit.MMock", {
    construct: function construct() {
      var sinon = this.__P_206_0();
      this.__P_206_1();
      this.__P_206_2 = sinon.createSandbox();
    },
    members: {
      __P_206_2: null,
      __P_206_3: null,
      ...
      spy: function spy(function_or_object, method) {
        return this.__P_206_2.spy.apply(this.__P_206_2, arguments);
      },
      /**
      ...
      stub: function stub(object, method, func) {
        var res = this.__P_206_2.stub.bind(this.__P_206_2)(object, method);
      ...
      useFakeXMLHttpRequest: function useFakeXMLHttpRequest() {
        return this.__P_206_3 = this.__P_206_2.useFakeServer();
      },
      /**
      ...
      getRequests: function getRequests() {
        return this.__P_206_3.requests;
      },
      /**
      ...
      deepStub: function deepStub(object) {
        this.__P_206_4(object).forEach(function (prop) {
          this.__P_206_5(object, prop);
        }, this);
        return object;
      },
      /**
      ...
      shallowStub: function shallowStub(object, targetClazz, propsToExclude) {
        this.__P_206_4(object, targetClazz).forEach(function (prop) {
      ...
      revealMock: function revealMock(object, property, customObject) {
        var source = customObject || this.__P_206_6(new object[property]());
       ...
       */
      __P_206_6: function __P_206_6(obj) {
        var clone = {};
       ...
       */
      __P_206_4: function __P_206_4(object, targetClazz) {
       ...
       */
      __P_206_5: function __P_206_5(object, prop) {
...
//# sourceMappingURL=MMock.js.map?dt=1782595054220