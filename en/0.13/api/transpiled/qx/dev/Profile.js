  ...
  qx.Bootstrap.define("qx.dev.Profile", {
    statics: {
      ...
      start: function start() {
        this.__P_195_2 = true;
        this.__P_195_0 = {};
        this.__P_195_1.splice(0, this.__P_195_1.length - 2);
      },
      /**
       * Stop profiling.
       */
      stop: function stop() {
        this.__P_195_2 = false;
      },
      /**
      ...
      showResults: function showResults(maxLength) {
        ...
        var data = Object.values(this.__P_195_0);
       ...
       */
      __P_195_5: function __P_195_5(count) {
      ...
      normalizeProfileData: function normalizeProfileData() {
        if (this.__P_195_3 == undefined) {
          this.__P_195_3 = this.__P_195_5(this.__P_195_4);
        }
        for (var key in this.__P_195_0) {
          var profileData = this.__P_195_0[key];
          profileData.calibratedOwnTime = Math.max(profileData.ownTime - profileData.subRoutineCalls * this.__P_195_3, 0);
      ...
      profileAfter: function profileAfter(fullName, fcn, type, args, returnValue) {
        ...
        var functionData = me.__P_195_0[fcnKey];
...
//# sourceMappingURL=Profile.js.map?dt=1735341767840