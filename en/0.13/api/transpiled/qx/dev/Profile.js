  ...
  qx.Bootstrap.define("qx.dev.Profile", {
    statics: {
      ...
      start: function start() {
        ...
        this.__P_182_1.splice(0, this.__P_182_1.length - 2);
      },
      ...
      showResults: function showResults(maxLength) {
        ...
        var data = Object.values(this.__P_182_0);
       ...
       */
      __P_182_5: function __P_182_5(count) {
      ...
      normalizeProfileData: function normalizeProfileData() {
        if (this.__P_182_3 == undefined) {
          this.__P_182_3 = this.__P_182_5(this.__P_182_4);
        }

        for (var key in this.__P_182_0) {
          var profileData = this.__P_182_0[key];
          profileData.calibratedOwnTime = Math.max(profileData.ownTime - profileData.subRoutineCalls * this.__P_182_3, 0);
      ...
      profileAfter: function profileAfter(fullName, fcn, type, args, returnValue) {
        ...
        var callData = me.__P_182_1.pop();

        var totalTime = endTime - callData.startTime;
        var ownTime = totalTime - callData.subRoutineTime;

        if (me.__P_182_1.length > 0) {
          var lastCall = me.__P_182_1[me.__P_182_1.length - 1];
        ...
        if (me.__P_182_0[fcnKey] === undefined) {
          me.__P_182_0[fcnKey] = {
            totalTime: 0,
            ownTime: 0,
            callCount: 0,
        ...
        var functionData = me.__P_182_0[fcnKey];
...
//# sourceMappingURL=Profile.js.map?dt=1664560754915