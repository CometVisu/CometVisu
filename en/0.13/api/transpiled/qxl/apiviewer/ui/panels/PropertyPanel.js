  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_826_0: function __P_826_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }
        if (node.isPrivate()) {
      ...
      __P_826_1: function __P_826_1(node) {
        var attributes = [];
        if (node.isNullable()) {
       ...
       */
      __P_826_2: function __P_826_2(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_826_1(node));
          textHtml.add(this.__P_826_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_826_2(node));
...
//# sourceMappingURL=PropertyPanel.js.map?dt=1778272860058