  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_562_0: function __P_562_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }
      ...
      __P_562_1: function __P_562_1(node) {
        var attributes = [];
       ...
       */
      __P_562_2: function __P_562_2(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_562_1(node));
          textHtml.add(this.__P_562_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_562_2(node));
...
//# sourceMappingURL=PropertyPanel.js.map?dt=1664613662082