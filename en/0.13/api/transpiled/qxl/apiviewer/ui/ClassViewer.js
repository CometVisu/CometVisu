    ...
    members: {
      ...
      _getDescriptionHtml: function _getDescriptionHtml(classNode) {
        ...
        if (classNode.getType() === "interface") {
          classHtml.add(this.__P_579_1(classNode));
        } else {
          classHtml.add(this.__P_579_2(classNode));
        }
        return classNode.getChildClasses().then(function (childClasses) {
          classHtml.add(_this2.__P_579_3(childClasses, "Direct " + subObjectsName + ":"));
          classHtml.add(_this2.__P_579_3(classNode.getInterfaces(), "Implemented interfaces:"));
          classHtml.add(_this2.__P_579_3(classNode.getMixins(), "Included mixins:"));
          return classNode.getImplementations();
        }).then(function (classes) {
          classHtml.add(_this2.__P_579_3(classes, "Implementations of this interface:"));
          return classNode.getIncluder();
        }).then(function (classes) {
          classHtml.add(_this2.__P_579_3(classes, "Classes including this mixin:"));
       ...
       */
      __P_579_3: function __P_579_3(dependentClasses, title) {
        var result = "";
       ...
       */
      __P_579_2: function __P_579_2(classNode) {
       ...
       * @return {String} HTML fragemnt
       */
      __P_579_1: function __P_579_1(classNode) {
        var ClassViewer = qxl.apiviewer.ui.ClassViewer;
       ...
       * @param itemNode
       */
      __P_579_0: function __P_579_0(itemNode) {
...
//# sourceMappingURL=ClassViewer.js.map?dt=1691935459157