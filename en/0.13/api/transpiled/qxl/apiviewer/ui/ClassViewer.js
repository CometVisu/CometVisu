        ...
        for (var i = classHierarchy.length - 1; i >= 0; i--) {
          ...
          if (i !== 0) {
            if (!qxl.apiviewer.dao.Class.isNativeObject(classHierarchy[i])) {
              ...
              classHtml.add('<span style="white-space: nowrap;"><a href="' + qxl.apiviewer.Constants.MDC_LINKS[name] + '" target="_blank" title="' + name + '">' + name + "</a></span>");
            }
          } else {
...
//# sourceMappingURL=ClassViewer.js.map?dt=1735222455738