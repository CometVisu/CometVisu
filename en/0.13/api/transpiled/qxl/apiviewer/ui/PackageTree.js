  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    construct: function construct() {
      ...
      this.setPadding(0);
      this.__P_565_0 = new qx.ui.tree.TreeFolder("Packages");
      this.__P_565_0.setOpen(true);
      this.setRoot(this.__P_565_0);
      this.setSelection([this.__P_565_0]);
    ...
    members: {
      ...
      setTreeData: function setTreeData(docTree) {
        ...
        this.__P_565_1(this.__P_565_0, docTree, 0);
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        if (!className) {
          this.__P_565_0.setOpen(true);
          this.setSelection([this.__P_565_0]);
          this.scrollChildIntoView(this.__P_565_0);
          return qx.Promise.resolve(true);
        }
       ...
       */
      __P_565_2: function __P_565_2(packageTreeNode, packageDoc, depth) {
        var self = this;
        return function () {
          if (!packageTreeNode.loaded) {
            packageTreeNode.loaded = true;
            self.__P_565_1(packageTreeNode, packageDoc, depth + 1);
       ...
       *          {var} current depth in the tree
       */
      __P_565_1: function __P_565_1(treeNode, docNode, depth) {
        var _this2 = this;
        ...
        qx.Promise.map(packagesDoc, function (packageDoc) {
          ...
          packageTreeNode.addListener("changeOpen", _this2.__P_565_2(packageTreeNode, packageDoc, depth + 1), _this2);
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_565_0");
    }
  });
  qxl.apiviewer.ui.PackageTree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=PackageTree.js.map?dt=1676809338034