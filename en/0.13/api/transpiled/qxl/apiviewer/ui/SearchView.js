  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    */
    ...
    members: {
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__P_796_3 = new qx.data.Array([true, true, true, true, true, true, true]);
        ...
        for (var i = 0; i < types.length; i++) {
          ...
          typeToggleButton.bind("value", this.__P_796_3, "[" + i + "]");
          ...
          this.__P_796_3.bind("[" + i + "]", typeToggleButton, "value");
        }
        ...
        typeToggleButtonAll.addListener("changeValue", function (e) {
          for (var i = 0; i < this.__P_796_3.length; i++) {
            this.__P_796_3.setItem(i, e.getData());
          }
          this._searchResult(this.sinput.getValue() || "");
      ...
      _searchResult: function _searchResult(svalue) {
        ...
        for (var i = 0; i < this.__P_796_3.length; i++) {
          if (this.__P_796_3.getItem(i) === true) {
      ...
      _isTypeFilteredIn: function _isTypeFilteredIn(type) {
        return this.__P_796_3.getItem(this.__P_796_4[type]);
      },
      /**
      ...
      __P_796_6: function __P_796_6(table) {
        this.__P_796_1 = new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({
          autoHide: false,
          width: 170
        });
        ...
        hint.setRich(true);
        this.__P_796_1.add(hint, {
          edge: 3
        });
        this.__P_796_1.setPosition("bottom-left");
        this.__P_796_1.placeToWidget(this.sinput, false);
        this.__P_796_1.show();
      },
      __P_796_7: function __P_796_7(e) {
        if (this.__P_796_1) {
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__P_796_2 = this._tableModel = this.__P_796_3 = this.__P_796_4 = this._selectionModel = null;
      this._disposeObjects("sinput", "__P_796_1");
...
//# sourceMappingURL=SearchView.js.map?dt=1717235425078