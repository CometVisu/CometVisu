        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return qxl.apiviewer.Application.superclass.prototype.main.call(_this);
              case 2:
                qx.Class.include(qx.ui.core.Widget, qxl.apiviewer.MWidgetRegistry);
                _this.viewer = new qxl.apiviewer.Viewer();
                _this.controller = new qxl.apiviewer.Controller();
                _context.next = 7;
                return qxl.apiviewer.RequestUtil.get(qxl.apiviewer.ClassLoader.getBaseUri() + "apiviewer.json");
              case 7:
                json = _context.sent;
                json = JSON.parse(json);
                _this.viewer._searchView.apiindex = json.apiindex;
                _this.controller.load(json.classes);
                _this.getRoot().add(_this.viewer, {
                  edge: 0
                });
              case 12:
              case "end":
...
//# sourceMappingURL=Application.js.map?dt=1722153859276