  ...
  qx.Class.define("qxl.apiviewer.dao.Class", {
    ...
    members: {
      ...
      load: function load() {
        ...
        var url = this.__P_551_0 = qxl.apiviewer.ClassLoader.getBaseUri() + this._className.replace(/\./g, "/") + ".json";
...
//# sourceMappingURL=Class.js.map?dt=1664560782599