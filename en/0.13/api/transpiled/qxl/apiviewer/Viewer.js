  ...
  qx.Class.define("qxl.apiviewer.Viewer", {
    ...
    */
    construct: function construct() {
      ...
      this.add(this.__P_780_1());
      this.add(this.__P_780_2());
      ...
      var toggleView = this.__P_780_3(tree, this._searchView, legend);
      var mainFrame = this.__P_780_4();
      this.add(this.__P_780_5(toggleView, mainFrame), {
        flex: 1
      });
      ...
      if (parsedUri.queryKey && parsedUri.queryKey.search) {
        ...
        this.__P_780_6.setSelection([this.__P_780_6.getChildren()[1]]);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
       ...
       */
      __P_780_3: function __P_780_3(treeWidget, searchWidget, infoWidget) {
        var stack = new qx.ui.container.Stack();
        stack.setAppearance("toggleview");
        stack.add(treeWidget);
        stack.add(searchWidget);
        stack.add(infoWidget);
        this.__P_780_6.addListener("changeSelection", function (e) {
       ...
       */
      __P_780_2: function __P_780_2() {
        var toolbar = new qx.ui.toolbar.ToolBar();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        this.__P_780_7 = part.toHashCode();
        ...
        this.__P_780_8 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__P_780_8);
      ...
      _getMenuItems: function _getMenuItems(toolbarPart) {
        ...
        if (toolbarPart.toHashCode() === this.__P_780_7) {
          var cachedItem = this.__P_780_0[toolbarPart.toHashCode()];
          if (!cachedItem) {
            cachedItem = new qx.ui.menu.Separator();
            this.__P_780_8.addAt(cachedItem, 0);
            this.__P_780_0[toolbarPart.toHashCode()] = cachedItem;
          }
        ...
        for (var i = partChildren.length - 1; i >= 0; i--) {
          ...
          cachedItem = this.__P_780_0[toolbarItem.toHashCode()];
          if (!cachedItem) {
            ...
            this.__P_780_8.addAt(cachedItem, 0);
            this.__P_780_0[toolbarItem.toHashCode()] = cachedItem;
          }
          menuItems.push(cachedItem);
        }
        return menuItems;
       ...
       */
      __P_780_9: function __P_780_9(toolbar, detailFrame) {
       ...
       */
      __P_780_5: function __P_780_5(leftWidget, rightWidget) {
    ...
    */
    destruct: function destruct() {
      this._classTreeNodeHash = this.__P_780_6 = null;
...
//# sourceMappingURL=Viewer.js.map?dt=1735341804656