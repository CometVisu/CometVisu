  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_553_3, this);
      btn_included.addListener("changeValue", this.__P_553_3, this);
      this._history = qx.bom.History.getInstance();

      this.__P_553_4();

      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_553_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_553_5: false,
      ...
      load: function load(classes) {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            if (state) {
              _this.__P_553_6(_this.__P_553_7(state));
            } else {
              _this.__P_553_6("");
            }
          });
      ...
      __P_553_4: function __P_553_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_553_7(evt.getData());
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_553_8(className), newTitle);
      },
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 7;
                return _this2._tabViewController.openClass(classNode, _this2.__P_553_5);
              ...
              case 9:
                _context.next = 11;
                return _this2._tabViewController.openPackage(classNode, _this2.__P_553_5);
       ...
       *
       */
      __P_553_6: function __P_553_6(fullItemName) {
        var _this3 = this;
      ...
      __P_553_8: function __P_553_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_553_7: function __P_553_7(encodedState) {
...
//# sourceMappingURL=Controller.js.map?dt=1685978161403