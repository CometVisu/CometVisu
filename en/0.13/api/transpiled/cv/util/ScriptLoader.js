  ...
  qx.Class.define('cv.util.ScriptLoader', {
    ...
    */
    construct: function construct() {
      ...
      this.__P_775_1 = new qx.data.Array();
      this.__P_775_2 = new qx.data.Array();
      this.__P_775_3 = [];
    },
    /*
    ***********************************************
    ...
    members: {
      ...
      addStyles: function addStyles(styleArr) {
        ...
        Promise.all(promises).then(function () {
          ...
          _this2.__P_775_6 = true;
          _this2.fireEvent('stylesLoaded');
          if (_this2.getFinished() && _this2.__P_775_4 && _this2.__P_775_5) {
      ...
      markAsLoaded: function markAsLoaded(path) {
        if (!this.__P_775_3.includes(path)) {
          this.debug('marking ' + path + ' as loaded');
          this.__P_775_3.push(path);
        }
      },
      isMarkedAsLoaded: function isMarkedAsLoaded(path) {
        return this.__P_775_3.includes(path);
      },
      addScripts: function addScripts(scriptArr, order) {
        ...
        this.__P_775_4 = true;
        for (; i < l; i++) {
          if (!this.__P_775_3.includes(queue[i])) {
       ...
       */
      __P_775_8: function __P_775_8(script) {
        var _this3 = this;
        var loader = new qx.util.DynamicScriptLoader(script);
        this.__P_775_1.push(loader);
        ...
        loader.addListenerOnce('ready', function () {
          _this3.__P_775_1.remove(loader);
      ...
      _onLoaded: function _onLoaded(ev) {
        var data = ev.getData();
        this.__P_775_0.remove(data.script);
      ...
      _checkQueue: function _checkQueue() {
        ...
        if (this.__P_775_0.length === 0) {
          if (this.isAllQueued()) {
            ...
            if (this.__P_775_6 && this.__P_775_4 && this.__P_775_5) {
              this.fireEvent('stylesAndScriptsLoaded');
            }
          } else if (!this.__P_775_7) {
            this.debug('script loader waiting for all scripts beeing queued');
            this.__P_775_7 = this.addListener('changeAllQueued', function (ev) {
              if (ev.getData() === true) {
                if (_this4.__P_775_0.length === 0) {
                  _this4.debug('script loader finished');
                  _this4.fireEvent('finished');
                  _this4.setFinished(true);
                }
                _this4.removeListenerById(_this4.__P_775_7);
                _this4.__P_775_7 = null;
              }
            });
          }
        } else {
          this.debug(this.__P_775_0.length + ' scripts remaining');
        }
      }
    }
  });
...
//# sourceMappingURL=ScriptLoader.js.map?dt=1778272856965