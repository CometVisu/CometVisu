    ...
    members: {
      ...
      */
      abort: function abort() {
        if (this.__P_554_1 && this.__P_554_1.abort) {
          this.__P_554_1.abort();
        }
      },
      getResponseHeader: function getResponseHeader(headerName) {
        if (this.__P_554_1) {
          return this.__P_554_1.getResponseHeader(headerName);
        }
        return null;
      }
    }
...
//# sourceMappingURL=Jquery.js.map?dt=1672653525328