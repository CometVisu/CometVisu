    ...
    */
    statics: {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 13:
                ...
                if (!cv.io.Fetch.__P_545_1) {
                  cv.io.Fetch.__P_545_1 = setInterval(function () {
                    cv.io.Fetch._gc();
      ...
      _gc: function _gc() {
        ...
        for (var resource in cv.io.Fetch.__P_545_0) {
          entry = cv.io.Fetch.__P_545_0[resource];
          if (entry.time <= eol && entry.ttl * 1000 < maxAge) {
            delete cv.io.Fetch.__P_545_0[resource];
          }
        }
      }
    }
...
//# sourceMappingURL=Fetch.js.map?dt=1703705695649