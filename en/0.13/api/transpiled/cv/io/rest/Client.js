    ...
    statics: {
      ...
      getConfigClient: function getConfigClient() {
        if (!this.__P_500_0) {
          ...
          this.__P_500_0 = new qx.io.rest.Resource(config);

          this.__P_500_0.setBaseUrl(this.getBaseUrl());

          this.__P_500_0.configureRequest(function (req, action) {
            if (action === 'save') {
          ...
          this._enableSync(this.__P_500_0, config);
        }
      ...
      getFsClient: function getFsClient() {
        if (!this.__P_500_1) {
          ...
          this.__P_500_1 = new qx.io.rest.Resource(config);

          this.__P_500_1.setBaseUrl(this.getBaseUrl());

          this.__P_500_1.configureRequest(function (req, action, params) {
            if (params.hash) {
          ...
          this._enableSync(this.__P_500_1, config); // general listeners


          this.__P_500_1.addListener('updateSuccess', this._onSaveSuccess, this);

          this.__P_500_1.addListener('createSuccess', this._onSaveSuccess, this);

          this.__P_500_1.addListener('updateError', this._onSaveError, this);

          this.__P_500_1.addListener('createError', this._onSaveError, this);
        }
      ...
      getDataProviderClient: function getDataProviderClient() {
        if (!this.__P_500_2) {
          ...
          this.__P_500_2 = new qx.io.rest.Resource(config);

          this.__P_500_2.setBaseUrl(this.getBaseUrl());

          this._enableSync(this.__P_500_2, config);
        }

        return this.__P_500_2;
      },
      _enableSync: function _enableSync(client, config) {
        ...
        Object.keys(config).forEach(function (callName) {
          client[callName + 'Sync'] = function () {
            ...
            this.__P_500_3[client[callName].apply(client, args)] = callback.bind(context);
          }.bind(this);
        ...
        client.addListener('success', function (ev) {
          ...
          if (Object.prototype.hasOwnProperty.call(this.__P_500_3, id)) {
            this.__P_500_3[id](null, ev.getData());

            delete this.__P_500_3[id];
          }
        }, this);
...
//# sourceMappingURL=Client.js.map?dt=1643473494422