    ...
    */
    statics: {
      ...
      addBackendClient: function addBackendClient(name, type, backendUrl, source) {
        ...
        if (this.__P_517_0[name]) {
          this.__P_517_0[name].dispose();

          delete this.__P_517_0[name];
        }
        ...
        if (!this.__P_517_3) {
          this.__P_517_3 = qx.core.Init.getApplication().addListener('changeActive', this._onActiveChanged, this);
      ...
      removeClient: function removeClient(client) {
        for (var name in this.__P_517_0) {
          if (this.__P_517_0[name] === client) {
            delete this.__P_517_0[name];
            break;
          }
        }
      ...
      hasClient: function hasClient(name) {
        return Object.prototype.hasOwnProperty.call(this.__P_517_0, name);
      },
      ...
      getClient: function getClient(backendName) {
        if (backendName === 'system') {
          if (!this.hasClient('system')) {
            this.__P_517_0.system = new cv.io.System();
          }

          return this.__P_517_0.system;
        }
        ...
        if (!this.__P_517_0[backendName] && cv.Config.testMode) {
          // in testMode the client might not have been initialized yet
          return this.addBackendClient('main', 'simulated');
        }

        return this.__P_517_0[backendName];
      },
      ...
      */
      startInitialRequest: function startInitialRequest() {
        ...
        Object.getOwnPropertyNames(this.__P_517_0).forEach(function (name) {
      ...
      _onActiveChanged: function _onActiveChanged() {
        ...
        if (app.isActive()) {
          Object.getOwnPropertyNames(this.__P_517_0).forEach(function (backendName) {
            var client = _this3.__P_517_0[backendName];

            if (!client.isConnected() && _this3.__P_517_2) {
              // reconnect
          ...
          if (!this.__P_517_1) {
            this.__P_517_1 = new qx.event.Timer(3000);

            this.__P_517_1.addListener('interval', function () {
              if (app.isActive()) {
                Object.getOwnPropertyNames(this.__P_517_0).forEach(this._checkBackendConnection, this);
              }
      ...
      _checkBackendConnection: function _checkBackendConnection(name) {
        ...
        var message = {
          ...
          unique: true,
          deletable: false,
          condition: !connected && this.__P_517_2 && qx.core.Init.getApplication().isActive()
        };
...
//# sourceMappingURL=BackendConnections.js.map?dt=1664617329841