    ...
    */
    members: {
      ...
      _initRequest: function _initRequest() {
        var _this = this;
        this.__P_7_0 = new qx.io.request.Xhr(qx.util.ResourceManager.getInstance().toUri('plugins/rsslog/rsslog.php'));
        this.__P_7_0.set({
      ...
      __P_7_1: function __P_7_1(ev) {
        ...
        if (typeof response === 'string') {
          ...
          var _iterator = _createForOfIteratorHelper(response.responseData.feed.entries),
            _step;
          try {
...
//# sourceMappingURL=RssLog.js.map?dt=1702901280683