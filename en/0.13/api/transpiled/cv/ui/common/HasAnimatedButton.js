(function () {
  ...
  qx.Mixin.define('cv.ui.common.HasAnimatedButton', {
    ...
    construct: function construct() {
      this.addListenerOnce('domReady', this.__P_793_0, this);
    },
    /*
    ******************************************************
      MEMBERS
    ...
    */
    members: {
      ...
      __P_793_2: null,
      __P_793_3: null,
      __P_793_0: function __P_793_0() {
        var actors = this.__P_793_4();
      ...
      buttonPressed: function buttonPressed(event) {
        ...
        this.__P_793_3 = actor;
        qx.event.Registration.addListener(document, 'pointerup', this.buttonReleased, this);
        var buttons = this.isBindClickToWidget() ? this.__P_793_4() : [actor];
        this.__P_793_5(buttons, true);
        this.__P_793_1 = qx.event.Registration.addListener(actor, 'pointerout', function () {
          this.__P_793_5(buttons, false);
        }, this);
        this.__P_793_2 = qx.event.Registration.addListener(actor, 'pointerover', function () {
          this.__P_793_5(buttons, true);
        }, this);
      },
      __P_793_5: function __P_793_5(buttons, pressed) {
        if (pressed) {
      ...
      buttonReleased: function buttonReleased(event) {
        ...
        var actor = this.__P_793_3;
        var buttons = this.isBindClickToWidget() ? this.__P_793_4() : [actor];
        this.__P_793_5(buttons, false);
        if (this.__P_793_1) {
          qx.event.Registration.removeListenerById(actor, this.__P_793_1);
        }
        if (this.__P_793_2) {
          qx.event.Registration.removeListenerById(actor, this.__P_793_2);
        }
        this.__P_793_1 = null;
        this.__P_793_2 = null;
        this.__P_793_3 = null;
...
//# sourceMappingURL=HasAnimatedButton.js.map?dt=1778272858378