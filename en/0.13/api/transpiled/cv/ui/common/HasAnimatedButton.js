    ...
    */
    members: {
      ...
      buttonPressed: function buttonPressed(event) {
        ...
        this.__P_549_2 = qx.event.Registration.addListener(actor, 'pointerover', function () {
          this.__P_549_5(buttons, true);
        }, this);
      },
      __P_549_5: function __P_549_5(buttons, pressed) {
        if (pressed) {
...
//# sourceMappingURL=HasAnimatedButton.js.map?dt=1691935456115