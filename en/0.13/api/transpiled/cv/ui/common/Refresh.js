  ...
  qx.Mixin.define('cv.ui.common.Refresh', {
    ...
    members: {
      ...
      _maintainTimerState: function _maintainTimerState() {
        ...
        if (this._timer) {
          if (this.isVisible()) {
            var delta = this.getRefresh() - (Date.now() - this.__P_540_2);
            if (delta <= 0) {
              // run immediately
              ...
              this.__P_540_3 = qx.event.Timer.once(function () {
                this._timer.start();
                this._timer.fireEvent('interval');
                this.__P_540_3 = null;
              }, this, delta);
          ...
          if (target.nodeName === 'IFRAME' && src.indexOf(parenthost) !== 0) {
            ...
            switch (cachecontrol) {
              ...
              case 'weak':
                ...
                break;
              case 'force':
                cv.ui.common.Refresh.__P_540_5(src);
    ...
    */
    ...
    statics: {
      ...
      __P_540_5: function __P_540_5(src) {
        window.fetch(src, {
          cache: 'reload',
          mode: 'no-cors'
        }).then(function () {
...
//# sourceMappingURL=Refresh.js.map?dt=1676809335548