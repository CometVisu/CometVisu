          ...
          if (!parentSchemaElement.areChildrenSortable() && position !== 'inside' && children.length > 0) {
            ...
            if (position === 'before') {
              ...
              if (_targetIndex < children.length - 1) {
                ...
                for (var _i2 = _targetIndex; _i2 < children.length; _i2++) {
                  var _sibling = children.getItem(_i2);
            ...
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                if (_this11.hasChildControl('add-button')) {
                  _this11.getChildControl('add-button').setVisibility(file.getWriteable() ? 'visible' : 'excluded'); // extra space für add-button
...
//# sourceMappingURL=Tree.js.map?dt=1685978095830