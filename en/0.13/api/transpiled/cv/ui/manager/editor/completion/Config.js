    ...
    */
    members: {
      ...
      providePureCompletionItems: function providePureCompletionItems(model, position) {
        ...
        var currentItem = this.findElements(this.__P_36_2.getElementNode('pages'), searchedElement, openedTags.length, openedTags.includes('meta')); // return available elements/attributes if the tag exists in the schema, or an empty
        // array if it doesn't
      ...
      provideTileCompletionItems: function provideTileCompletionItems(model, position) {
        ...
        var currentItem = this.findElements(this.__P_36_2.getElementNode('config'), searchedElement, openedTags.length, openedTags.includes('cv-meta')); // return available elements/attributes if the tag exists in the schema, or an empty
        // array if it doesn't
...
//# sourceMappingURL=Config.js.map?dt=1685978096194