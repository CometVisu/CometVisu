    ...
    members: {
      ...
      _processHandlerOptions: function _processHandlerOptions(content) {
        ...
        if (Object.prototype.hasOwnProperty.call(handlerOptions, 'upgradeVersion') && handlerOptions.upgradeVersion === true && content) {
          var _this$_upgradeConfig3 = this._upgradeConfig(content),
              _this$_upgradeConfig4 = _slicedToArray(_this$_upgradeConfig3, 2),
              err = _this$_upgradeConfig4[0],
              res = _this$_upgradeConfig4[1];
...
//# sourceMappingURL=Source.js.map?dt=1685978095280