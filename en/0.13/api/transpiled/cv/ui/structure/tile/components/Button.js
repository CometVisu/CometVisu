    ...
    */
    members: {
      ...
      _initProgress: function _initProgress() {
        ...
        circle.setAttribute('stroke-dasharray', this.__P_72_2 + ' ' + this.__P_72_2);
        circle.setAttribute('stroke-dashoffset', '' + this.__P_72_2);
      ...
      _applyOn: function _applyOn() {
        if (this.isConnected()) {
          ...
          if (this._element.hasAttribute('mapping')) {
            mappedValue = cv.Application.structureController.mapValue(this._element.getAttribute('mapping'), value, this.__P_72_0);
          }
          ...
          if (this._element.hasAttribute('styling')) {
            styleClass = cv.Application.structureController.styleValue(this._element.getAttribute('styling'), value, this.__P_72_0);
          }
      ...
      _applyProgress: function _applyProgress(value) {
        ...
        if (valueElement) {
          if (this._element.hasAttribute('progress-mapping')) {
            value = cv.Application.structureController.mapValue(this._element.getAttribute('progress-mapping'), value, this.__P_72_0);
          }

          valueElement.setAttribute('stroke-dashoffset', '' + (this.__P_72_2 - value / 100 * this.__P_72_2));
        }
      },
      ...
      _applyName: function _applyName(value) {
        if (!this.__P_72_1) {
          this.__P_72_1 = document.createElement('label');

          this.__P_72_1.classList.add('button-label');

          this._element.appendChild(this.__P_72_1);
        }

        this.__P_72_1.textContent = value;
      },
      ...
      onStateUpdate: function onStateUpdate(ev) {
        ...
        if (target === 'default') {
          ...
          this.__P_72_0.set(target.substring(6), ev.detail.state);
        }
      },
...
//# sourceMappingURL=Button.js.map?dt=1664617282415