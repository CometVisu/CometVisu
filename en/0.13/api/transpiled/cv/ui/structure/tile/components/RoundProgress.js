    ...
    */
    members: {
      ...
      _init: function _init() {
        ...
        var radius = this.__P_76_4 = element.getAttribute('radius') || parseInt(style.getPropertyValue('--tileCellWidth')) || 56;
        var strokeWidth = element.getAttribute('stroke') || 8;
        var normalizedRadius = this.__P_76_3 = radius - strokeWidth / 2;
        this.__P_76_1 = normalizedRadius * 2 * Math.PI;
        ...
        this.__P_76_7 = radius * 2 - strokeWidth * 2 - 24;

        if (!hasFixedRadius) {
          qx.event.message.Bus.subscribe('cv.design.tile.cellWidthChanged', function (ev) {
            _this.__P_76_4 = ev.getData();
            _this.__P_76_3 = _this.__P_76_4 - strokeWidth / 2;
            _this.__P_76_1 = _this.__P_76_3 * 2 * Math.PI;
            height = type === 'semiCircle' ? _this.__P_76_4 : _this.__P_76_4 * 2;
            var svg = element.querySelector(':scope > svg');
            svg.setAttribute('height', '' + height);
            svg.setAttribute('width', '' + _this.__P_76_4 * 2);

            if (type === 'circle') {
              _this._element.querySelectorAll(':scope > svg > circle').forEach(function (circle) {
                circle.setAttribute('r', '' + _this.__P_76_3);

                if (circle.classList.contains('bar')) {
                  circle.setAttribute('stroke-dasharray', _this.__P_76_1 + ' ' + _this.__P_76_1);
                  circle.setAttribute('stroke-dashoffset', '' + _this.__P_76_1);
                }
              });
            } else if (type === 'semiCircle') {
              _this.__P_76_2.y = _this.__P_76_4;

              var bg = _this._element.querySelector(':scope > svg > path.bg');

              if (bg) {
                bg.setAttribute('d', "M ".concat(strokeWidth / 2, " ").concat(_this.__P_76_4, " A ").concat(_this.__P_76_3, " ").concat(_this.__P_76_3, " 0 0 1 ").concat(_this.__P_76_4 * 2 - strokeWidth / 2, " ").concat(_this.__P_76_4));
              }
            }
      ...
      __P_76_9: function __P_76_9(angle) {
        var angleRad = angle * (Math.PI / 180.0);
        return {
          x: this.__P_76_4 - this.__P_76_3 * Math.cos(angleRad),
          y: this.__P_76_4 - this.__P_76_3 * Math.sin(angleRad)
        };
      },
        ...
        if (this.isConnected()) {
          ...
          switch (this.getType()) {
            case 'circle':
              ...
              valueElement.setAttribute('stroke-dashoffset', '' + this.__P_76_1 - percent / 100 * this.__P_76_1);
              break;

            case 'semiCircle':
              valueElement = this._element.querySelector(':scope > svg > path.bar');
              end = this.__P_76_9(1.8 * percent);
              valueElement.setAttribute('d', ['M', this.__P_76_2.x, this.__P_76_2.y, 'A', this.__P_76_3, this.__P_76_3, 0, 0, 1, end.x, end.y].join(' '));
              break;
          }
        }
      },
      _fitText: function _fitText() {
        if (this.__P_76_5 && this.__P_76_5.textContent) {
          if (this.isVisible()) {
            if (!this.__P_76_6) {
              this.__P_76_6 = document.createElement('canvas');
              this.__P_76_10 = this.__P_76_6.getContext('2d');
              var compStyle = window.getComputedStyle(this.__P_76_5);
              this.__P_76_10.font = compStyle.getPropertyValue('font');
              this.__P_76_8 = compStyle.getPropertyValue('font-size');
            }

            var metrics = this.__P_76_10.measureText(this.__P_76_5.textContent);

            if (metrics.width > this.__P_76_7) {
              // adjust font-size
              var factor = this.__P_76_7 / metrics.width;
              this.__P_76_5.style.fontSize = Math.floor(parseInt(this.__P_76_8) * factor) + 'px';
            } else {
              this.__P_76_5.style.fontSize = this.__P_76_8;
            }
      ...
      _applyText: function _applyText(value) {
        if (this.isConnected()) {
          if (!this.__P_76_5) {
            this.__P_76_5 = this._element.querySelector(':scope > label');
          }

          this.__P_76_5.textContent = value;
...
//# sourceMappingURL=RoundProgress.js.map?dt=1664552156034