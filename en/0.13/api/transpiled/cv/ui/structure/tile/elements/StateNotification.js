    ...
    members: {
      _init: function _init() {
        ...
        if (elem.hasAttribute('id')) {
          config.id = elem.getAttribute('id'); // notifications with id can be changed by the system backend, so we need to listen to some addresses
...
//# sourceMappingURL=StateNotification.js.map?dt=1685978104001