      ...
      _init: function _init() {
        ...
        if (mode === 'popup') {
          ...
          if (!popup) {
            ...
            this.__P_79_0.addListener('colorChanged', this._onColorChanged, this);
            this._onColorChanged();
            popup.innerHTML = "<div class=\"widget_container\" style=\"margin-top: 24px; max-width: 100vw; width: 320px; max-height: 100vh; min-height: 320px; align-self: center\" id=\"".concat(path, "\" data-type=\"colorchooser\">").concat(this.__P_79_0.getDomString(), "</div>");
            ...
            qx.event.Timer.once(function () {
              _this.__P_79_0._onDomReady();
            }, this, 0);
            this.setResizeTarget(popup);
            this.addListener('resized', function () {
              _this.__P_79_0.invalidateScreensize();
            });
          }
        }
      },
      _onColorChanged: function _onColorChanged() {
        var color = this.__P_79_0.getColor();
        var rgb = color.getComponent('rgb');
        var v = color.getComponent('v');
        this.setValue("#".concat(this.__P_79_1(rgb.r)).concat(this.__P_79_1(rgb.g)).concat(this.__P_79_1(rgb.b)).concat(this.__P_79_1(v)));
      },
      __P_79_1: function __P_79_1(v) {
...
//# sourceMappingURL=Color.js.map?dt=1735222412009