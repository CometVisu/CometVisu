  ...
  qx.Class.define('cv.ui.structure.tile.widgets.Dynamic', {
    ...
    */
    members: {
      ...
      _applyRef: function _applyRef(ref, old) {
        if (old) {
        ...
        if (ref) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var clonedNode = remote.cloneNode(true);
              ...
              if (ref.hasAttribute('modify-attribute')) {
                ...
                var _ref$getAttribute$spl = ref.getAttribute('modify-attribute').split(':'),
                  _ref$getAttribute$spl2 = _slicedToArray(_ref$getAttribute$spl, 2),
                  attribute = _ref$getAttribute$spl2[0],
                  value = _ref$getAttribute$spl2[1];
    ...
    defer: function defer(QxClass) {
      customElements.define(cv.ui.structure.tile.Controller.PREFIX + 'dynamic', /*#__PURE__*/function (_QxConnector) {
        "use strict";
...
//# sourceMappingURL=Dynamic.js.map?dt=1782595050314