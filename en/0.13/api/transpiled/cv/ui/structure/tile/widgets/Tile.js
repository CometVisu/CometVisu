      ...
      _applyOutdated: function _applyOutdated(value) {
        ...
        if (value) {
          ...
          if (!elem) {
            ...
            this._element.insertBefore(elem, this._element.firstElementChild); // capture all clicks by stealing the initial event
            ...
            elem.addEventListener('click', function (ev) {
              ...
              if (!valueElem) {
                ...
                _this2._element.insertBefore(valueElem, elem.nextElementSibling); // capture all clicks by stealing the initial event
...
//# sourceMappingURL=Tile.js.map?dt=1685978104302