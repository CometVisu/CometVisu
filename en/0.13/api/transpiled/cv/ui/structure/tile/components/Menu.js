    ...
    */
    members: {
      ...
      _applyModel: function _applyModel(model) {
        ...
        if (model) {
          ...
          if (model === 'pages') {
            ...
            this._element.appendChild(_icon); // listen on whole element
      ...
      _onPointerDown: function _onPointerDown(ev) {
        ...
        if (target.classList.contains('menu') || target.parentElement && target.parentElement.classList.contains('menu') || target.nodeName.toLowerCase() === 'cv-menu' || target.parentElement && target.parentElement.nodeName.toLowerCase() === 'cv-menu') {// clicked in hamburger menu, do nothing
...
//# sourceMappingURL=Menu.js.map?dt=1685978102985