        ...
        if (model.hasAttribute('src') || model.hasAttribute('config-section')) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return cv.io.Fetch.fetch(model.getAttribute('src'), options, model.getAttribute('proxy') === 'true');
                  case 4:
                    res = _context.sent;
          ...
          if (Clazz) {
            ...
            if (model.hasAttribute('parameters')) {
              var props = {};
              var _iterator = _createForOfIteratorHelper(model.getAttribute('parameters').split(',')),
                _step;
              try {
          ...
          if (script) {
            ...
            data.forEach(function (elem, i) {
              ...
              var _iterator2 = _createForOfIteratorHelper(elem.attributes),
                _step2;
              try {
                  ...
                  newModel.forEach(function (entry, i) {
                    ...
                    var html = template.innerHTML.replaceAll(/\${([^}]+)}/g, function (match, content) {
                      ...
                      if (content.includes('||')) {
                        ...
                        var val = '';
                        var _iterator3 = _createForOfIteratorHelper(content.split('||').map(function (n) {
                            return n.trim();
                          })),
                          _step3;
                        try {
...
//# sourceMappingURL=List.js.map?dt=1672653480782