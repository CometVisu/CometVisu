    ...
    */
    members: {
      ...
      _init: function _init() {
        ...
        var readAddresses = model.querySelectorAll(':scope > cv-address:not([mode="write"])'); // if we have top level write addresses, we need to listen to sendState Events from the list items
            ...
            if (model.hasAttribute('parameters')) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                  ...
                  var _entry$split$map3 = entry.split('=').map(function (n) {
                    return n.trim();
                  }),
                      _entry$split$map4 = _slicedToArray(_entry$split$map3, 2),
                      name = _entry$split$map4[0],
                      value = _entry$split$map4[1];
            ...
            while (1) switch (_context3.prev = _context3.next) {
              ...
              case 47:
                ...
                newModel.forEach(function (entry, i) {
                  ...
                  itemTemplate.innerHTML = html; // check for elements with when attributes
                  ...
                  itemTemplate.content.firstElementChild.querySelectorAll('[when]').forEach(function (elem) {
                    var _elem$getAttribute$sp = elem.getAttribute('when').split('=').map(function (n) {
                      return n.trim();
                        ...
                        rightVal = _elem$getAttribute$sp2[1]; // noinspection EqualityComparisonWithCoercionJS
...
//# sourceMappingURL=List.js.map?dt=1685978102782