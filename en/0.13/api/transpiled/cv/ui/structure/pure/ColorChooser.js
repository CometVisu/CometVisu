    ...
    */
    statics: {
      ...
      coord2sv: function coord2sv(x, y, hue, radius) {
        ...
        var By = 0.5 - Math.cos(hue2angle * (0.3333333333333333 - hue)) * radius;
        ...
        var v = Math.min(Math.max(0, uv[1]), 1);
...
//# sourceMappingURL=ColorChooser.js.map?dt=1677345913961