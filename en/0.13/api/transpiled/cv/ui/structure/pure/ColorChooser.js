    ...
    */
    members: {
      ...
      _update: function _update(address, data) {
        ...
        this.__P_58_5[variantType][variant] = _defineProperty({}, transform, data); // animate when visible, otherwise jump to the target value
      ...
      __P_58_2: function __P_58_2(newColor) {
        ...
        this.__P_58_9 = newColor; // move handles
          ...
          case 'pointerdown':
            {
              ...
              if (actorType === 'wheel') {
                ...
                if (distSqrd < Math.pow(0.535, 2)) {
                  ...
                  var clearlyOnWheel = Math.pow(radius * 1.1, 2) < distSqrd; // with 10% safety margin to the interior triangle
...
//# sourceMappingURL=ColorChooser.js.map?dt=1685978099328