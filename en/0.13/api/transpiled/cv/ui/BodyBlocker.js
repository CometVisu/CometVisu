    ...
    */
    members: {
      ...
      block: function block(topic, unique) {
        cv.ui.BodyBlocker.superclass.prototype.block.call(this, this.__P_559_3());
        if (!Object.prototype.hasOwnProperty.call(this.__P_559_0, topic)) {
          this.__P_559_0[topic] = 1;
        } else if (!unique) {
          this.__P_559_0[topic]++;
        }
      ...
      unblock: function unblock(topic) {
        if (topic) {
          if (Object.prototype.hasOwnProperty.call(this.__P_559_0, topic)) {
            this.__P_559_0[topic]--;
            if (this.__P_559_0[topic] === 0) {
              delete this.__P_559_0[topic];
              if (Object.keys(this.__P_559_0).length === 0) {
      ...
      __P_559_3: function __P_559_3() {
        if (!this.__P_559_2) {
          this.__P_559_2 = document.querySelector('body');
        }
        return this.__P_559_2;
      }
    }
  });
...
//# sourceMappingURL=BodyBlocker.js.map?dt=1676809337697