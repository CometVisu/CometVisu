  ...
  qx.Class.define('cv.ui.NotificationCenter', {
    ...
    */
    members: {
      ...
      disableBadge: function disableBadge(value) {
        if (value) {
          this.__P_772_4.classList.add('hidden');
        } else {
          this.__P_772_4.classList.remove('hidden');
        }
      },
      _onResize: function _onResize() {
        var height = document.documentElement.clientHeight;
        if (this.__P_772_0) {
          this.__P_772_0.style.left = document.documentElement.clientWidth + 'px';
          this.__P_772_0.style.height = height + 'px';
        }
        if (this.__P_772_1) {
          // get header+footer heights
          var headerRect = this.__P_772_0.querySelector(':scope > header').getBoundingClientRect();
          var footerRect = this.__P_772_0.querySelector(':scope > footer').getBoundingClientRect();
          var messageBoxHeight = height - Math.round(headerRect.bottom - headerRect.top) - Math.round(footerRect.bottom - footerRect.top);
          this.__P_772_1.style.height = messageBoxHeight + 'px';
        }
      },
      /**
      ...
      _init: function _init() {
        ...
        this.__P_772_3 = cv.ui.BodyBlocker.getInstance();
        this.__P_772_5 = new Favico({
          animation: 'fade',
          bgColor: '#1C391C'
        });

        // check if the element is already there (might have been cached)
        var elem = this.__P_772_0 = document.querySelector(this.getRootElementId());
        if (!elem) {
          // create new element
          elem = this.__P_772_0 = qx.dom.Element.create('div', {
        ...
        this.__P_772_1 = elem.querySelector('section.messages');
        this.__P_772_4 = elem.querySelector('.badge');
        qx.event.Registration.addListener(this.__P_772_4, 'tap', this.toggleVisibility, this);

        // add HTML template for messages to header
        if (this._list) {
          this._list.dispose();
        }
        this._list = new qx.data.controller.website.List(this._messages, this.__P_772_1, 'MessageTemplate');
        qx.event.Registration.addListener(this.__P_772_1, 'tap', this._onListTap, this);

        // connect badge content
        this._messages.addListener('changeLength', this.__P_772_6, this);
        this.__P_772_6();

        // update dimensions
        new qx.util.DeferredCall(this._onResize, this).schedule();
      },
      __P_772_6: function __P_772_6() {
        var currentContent = parseInt(this.__P_772_4.getAttribute('html'));
        ...
        var update = function () {
          ...
          if (this.getMessages().getLength() === 0) {
            ...
            this.__P_772_0.style.visibility = '';
        ...
        if (currentContent < messages) {
          ...
          qx.bom.element.Animation.animate(this.__P_772_4, cv.ui.NotificationCenter.BLINK);
        }
        if (messages) {
          this.__P_772_4.innerHTML = '' + messages;
        } else {
          this.__P_772_4.innerHTML = '';
        }
      },
      _onSeverityChange: function _onSeverityChange() {
        var severity = this.getGlobalSeverity();
        if (this.__P_772_4) {
          this.__P_772_4.classList.remove.apply(this.__P_772_4.classList, this._severities);
          this.__P_772_4.classList.add(severity);
        }
        if (this.__P_772_5) {
          // update favicon badge
          this.__P_772_5.badge(this.getMessages().getLength(), {
      ...
      show: function show() {
        if (!this.__P_772_2) {
          this.__P_772_2 = true;
          this.__P_772_3.block();
          this.__P_772_0.style.visibility = '';
          qx.event.Registration.addListener(this.__P_772_3.getBlockerElement(), 'tap', this.hide, this);
          if (cv.ui.NotificationCenter.SLIDE.duration > 0) {
            var anim = qx.bom.element.Animation.animate(this.__P_772_0, cv.ui.NotificationCenter.SLIDE);
            anim.on('end', function () {
              this.__P_772_0.style.transform = 'translate(-300px)';
            }, this);
          } else {
            this.__P_772_0.style.transform = 'translate(-300px)';
          }
      ...
      hide: function hide() {
        if (this.__P_772_2) {
          this.__P_772_2 = false;
          qx.event.Registration.removeListener(this.__P_772_3.getBlockerElement(), 'tap', this.hide, this);
          if (cv.ui.NotificationCenter.SLIDE.duration > 0) {
            var anim = qx.bom.element.Animation.animateReverse(this.__P_772_0, cv.ui.NotificationCenter.SLIDE);
            anim.on('end', function () {
              this.__P_772_0.style.transform = 'translate(0px)';
              this.__P_772_3.unblock();
            }, this);
          } else {
            this.__P_772_0.style.transform = 'translate(0px)';
            this.__P_772_3.unblock();
    ...
    */
    destruct: function destruct() {
      ...
      qx.event.Registration.removeListener(this.__P_772_3.getBlockerElement(), 'tap', this.hide, this);
      qx.event.Registration.removeListener(this.__P_772_1, 'tap', this._onListTap, this);
      this._disposeObjects("__P_772_3", "__P_772_1", '_openCommand', '_list');
    }
  });
  cv.ui.NotificationCenter.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=NotificationCenter.js.map?dt=1778272856873