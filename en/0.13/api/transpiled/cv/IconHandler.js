(function () {
  ...
  qx.Class.define('cv.IconHandler', {
    ...
    construct: function construct() {
      this.__P_766_0 = cv.IconConfig.DB;
    },
    /*
     ******************************************************
     MEMBERS
    ...
    members: {
      ...
      insert: function insert(name, uri) {
        ...
        if (!this.__P_766_0[name]) {
          this.__P_766_0[name] = {};
        }
        if (source) {
          this.__P_766_0[name].source = source;
        }
        if (!this.__P_766_0[name][type]) {
          this.__P_766_0[name][type] = {};
        }
        if (!this.__P_766_0[name][type][flavour]) {
          this.__P_766_0[name][type][flavour] = {};
        }
        if (dynamic && window[dynamic]) {
          this.__P_766_0[name][type][flavour][color] = window[dynamic](uri);
        } else if (dynamic && cv.util.IconTools[dynamic]) {
          this.__P_766_0[name][type][flavour][color] = cv.util.IconTools[dynamic](uri);
        } else {
          this.__P_766_0[name][type][flavour][color] = {
            uri: uri,
            styling: styling
          };
        }
      ...
      get: function get(name) {
        ...
        var all;
        if (typeof this.__P_766_0[name][type] === 'string') {
          type = this.__P_766_0[name][type]; // redirect link
        ...
        if (typeof this.__P_766_0[name][type][flavour] === 'string') {
          flavour = this.__P_766_0[name][type][flavour]; // redirect link
        ...
        if (!this.__P_766_0[name][type][flavour][color]) {
          if (/\.svg(#.+)?$/.test(this.__P_766_0[name][type][flavour]['*'].uri)) {
            // SVGs can be dynamically recolored, so create new entry for this color
            this.__P_766_0[name][type][flavour][color] = Object.assign({}, this.__P_766_0[name][type][flavour]['*']);
          } else {
            color = '*'; // undefined -> use default
          }
        }
        // handle a generic mapping function
        if (typeof this.__P_766_0[name][type][flavour]['*'] === 'function') {
          return this.__P_766_0[name][type][flavour]['*'];
        }
        if (typeof this.__P_766_0[name][type][flavour][color] === 'string') {
          color = this.__P_766_0[name][type][flavour][color];
        } // redirect link
        return this.__P_766_0[name][type][flavour][color];
      },
       ...
       */
      list: function list() {
        return Object.keys(this.__P_766_0);
      },
      /**
...
//# sourceMappingURL=IconHandler.js.map?dt=1735222453209