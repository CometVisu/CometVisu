    ...
    members: {
      seekTo: function seekTo(target, speed) {
        ...
        if (animationEnabled) {
          ...
          animationConfig = this.__P_521_0(direction); // show the new page (because animations do not work on hidden elements) + hide scrollbar
        ...
        if (!animationEnabled) {
          if (oldPageWidget) {
            this.__P_521_1(oldPageWidget);
          }

          this.__P_521_2(pageWidget, 0, true);
        } else {
          if (oldPageWidget) {
          ...
          qx.bom.AnimationFrame.request(function () {
            ...
            animation.addListenerOnce("end", function () {
              this.__P_521_2(pageWidget, oldPos);
            }, this);
          }, this);
        }
      },
       ...
       */
      __P_521_0: function __P_521_0(direction) {
       ...
       */
      __P_521_1: function __P_521_1(oldPageWidget) {
       ...
       */
      __P_521_2: function __P_521_2(pageWidget, oldPos, updateVisibility) {
...
//# sourceMappingURL=PageHandler.js.map?dt=1620070407770