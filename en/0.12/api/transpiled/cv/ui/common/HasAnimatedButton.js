(function () {
  ...
  qx.Mixin.define("cv.ui.common.HasAnimatedButton", {
    ...
    construct: function construct() {
      this.addListenerOnce("domReady", this.__P_500_0, this);
    },
    ...
    */
    members: {
      ...
      buttonPressed: function buttonPressed(event) {
        ...
        this.__P_500_3 = actor;
        qx.event.Registration.addListener(document, "pointerup", this.buttonReleased, this);
        var buttons = this.isBindClickToWidget() ? this.__P_500_4() : [actor];

        this.__P_500_5(buttons, true);

        this.__P_500_1 = qx.event.Registration.addListener(actor, "pointerout", function () {
          this.__P_500_5(buttons, false);
        }, this);
        this.__P_500_2 = qx.event.Registration.addListener(actor, "pointerover", function () {
          this.__P_500_5(buttons, true);
        }, this);
      },
      __P_500_5: function __P_500_5(buttons, pressed) {
        if (pressed) {
      ...
      buttonReleased: function buttonReleased(event) {
        ...
        var actor = this.__P_500_3;
        var buttons = this.isBindClickToWidget() ? this.__P_500_4() : [actor];

        this.__P_500_5(buttons, false);

        if (this.__P_500_1) {
          qx.event.Registration.removeListenerById(actor, this.__P_500_1);
        }

        if (this.__P_500_2) {
          qx.event.Registration.removeListenerById(actor, this.__P_500_2);
        }
...
//# sourceMappingURL=HasAnimatedButton.js.map?dt=1592777114047