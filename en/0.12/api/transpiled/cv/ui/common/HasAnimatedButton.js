(function () {
  ...
  qx.Mixin.define('cv.ui.common.HasAnimatedButton', {
    ...
    construct: function construct() {
      this.addListenerOnce('domReady', this.__P_515_0, this);
    },
    ...
    */
    members: {
      ...
      __P_515_2: null,
      __P_515_3: null,
      __P_515_0: function __P_515_0() {
        var actors = this.__P_515_4();
      ...
      buttonPressed: function buttonPressed(event) {
        ...
        this.__P_515_3 = actor;
        qx.event.Registration.addListener(document, 'pointerup', this.buttonReleased, this);
        var buttons = this.isBindClickToWidget() ? this.__P_515_4() : [actor];

        this.__P_515_5(buttons, true);

        this.__P_515_1 = qx.event.Registration.addListener(actor, 'pointerout', function () {
          this.__P_515_5(buttons, false);
        }, this);
        this.__P_515_2 = qx.event.Registration.addListener(actor, 'pointerover', function () {
          this.__P_515_5(buttons, true);
        }, this);
      },
      __P_515_5: function __P_515_5(buttons, pressed) {
        if (pressed) {
      ...
      buttonReleased: function buttonReleased(event) {
        ...
        var actor = this.__P_515_3;
        var buttons = this.isBindClickToWidget() ? this.__P_515_4() : [actor];

        this.__P_515_5(buttons, false);

        if (this.__P_515_1) {
          qx.event.Registration.removeListenerById(actor, this.__P_515_1);
        }

        if (this.__P_515_2) {
          qx.event.Registration.removeListenerById(actor, this.__P_515_2);
        }
...
//# sourceMappingURL=HasAnimatedButton.js.map?dt=1650119494005