  ...
  qx.Mixin.define("cv.ui.common.Refresh", {
    ...
    members: {
      ...
      _maintainTimerState: function _maintainTimerState() {
        ...
        if (this._timer) {
          if (this.isVisible()) {
            var delta = this.getRefresh() - (Date.now() - this.__P_491_2);
            ...
            if (delta <= 0) {
              ...
              this.__P_491_3 = qx.event.Timer.once(function () {
                this._timer.start();
        ...
        if (this._refreshAction) {
          ...
          if (target.nodeName === "IFRAME" && src.indexOf(parenthost) !== 0) {
            ...
            switch (cachecontrol) {
              ...
              case 'force':
                cv.ui.common.Refresh.__P_491_5(src);
    ...
    */
    ...
    statics: {
      ...
      __P_491_5: function __P_491_5(src, twostage) {
        var step = 0,
...
//# sourceMappingURL=Refresh.js.map?dt=1603737152042