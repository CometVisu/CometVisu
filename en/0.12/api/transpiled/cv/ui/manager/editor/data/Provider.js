  ...
  qx.Class.define('cv.ui.manager.editor.data.Provider', {
    ...
    */
    members: {
      ...
      __clearFromCache: function __clearFromCache(cacheId) {
        if (!cacheId) {
          this.__cache = {};
        } else {
       ...
       * @private
       */
      __getData: function __getData(cacheId, rpc, rpcContext, args, converter, converterContext) {
      ...
      getInfluxDBFields: function getInfluxDBFields(measurement) {
        return this.__getData('influxdbfields|' + measurement, 'influxdbfieldsSync', null, [{
          measurement: measurement
        }], this._parseDpResponse, this);
      },
      getInfluxDBTags: function getInfluxDBTags(measurement) {
        return this.__getData('influxdbtags|' + measurement, 'influxdbtagsSync', null, [{
          measurement: measurement
        }], function (res) {
      ...
      getMediaFiles: function getMediaFiles(typeFilter) {
        ...
        return this.__getData('media', fsClient.readSync, fsClient, [{
          path: 'media',
          recursive: true
        }], function (res) {
...
//# sourceMappingURL=Provider.js.map?dt=1589222697317