    ...
    */
    members: {
      ...
      _getFromCache: function _getFromCache(cacheId) {
        return this.__P_36_0[cacheId];
      },
      __P_36_1: function __P_36_1(cacheId) {
        if (!cacheId) {
          this.__P_36_0 = {};
        } else {
          delete this.__P_36_0[cacheId];
        }
      },
      _addToCache: function _addToCache(cacheId, data) {
        this.__P_36_0[cacheId] = data;
      },
      ...
      getDesigns: function getDesigns(format, config) {
        ...
        return this.__P_36_2('designs', 'designsSync', null, [], format === 'dp' ? function (res) {
       ...
       * @private
       */
      __P_36_2: function __P_36_2(cacheId, rpc, rpcContext, args, converter, converterContext, cache) {
      ...
      __P_36_3: function __P_36_3(url, converter, converterContext, cache) {
      ...
      getAddresses: function getAddresses(format, config) {
        ...
        if (client.hasProvider('addresses')) {
          return this.__P_36_3(client.getProviderUrl('addresses'), client.getProviderConvertFunction('addresses', format), client, config.cache);
        } else {
          return this.__P_36_2('addresses', 'addressesSync', null, [], format === 'dp' ? this._parseDpResponseForEditor : this._parseDpResponseForMonaco, this, config.cache);
        }
      },
      getRrds: function getRrds(format, config) {
        ...
        if (client.hasProvider('rrd')) {
          return this.__P_36_3(client.getProviderUrl('rrd'), client.getProviderConvertFunction('rrd', format), client, config.cache);
        } else {
          return this.__P_36_2('rrds', 'rrdsSync', null, [], format === 'dp' ? this._parseDpResponseForEditor : this._parseDpResponseForMonaco, this, config.cache);
        }
      },
      getInfluxDBs: function getInfluxDBs(format, config, element) {
        var args = this.__P_36_4(element, false);

        return this.__P_36_2('influxdbs', 'influxdbsSync', null, args, format === 'dp' ? this._parseDpResponseForEditor : this._parseDpResponseForMonaco, this, config.cache);
      },
      __P_36_4: function __P_36_4(element, withMeasurement) {
        var args = [];
      ...
      getInfluxDBFields: function getInfluxDBFields(format, config, element) {
        try {
          var args = this.__P_36_4(element, true);

          return this.__P_36_2('influxdbfields|' + args.measurement + "|" + args.auth, 'influxdbfieldsSync', null, args, format === 'dp' ? this._parseDpResponseForEditor : this._parseDpResponseForMonaco, this, config.cache);
        } catch (e) {
          return [];
        }
      },
      __P_36_5: function __P_36_5(format, config, element, converter) {
        try {
          var args = this.__P_36_4(element, true);

          return this.__P_36_2('influxdbtags|' + args.measurement + "|" + args.auth, 'influxdbtagsSync', null, args, converter, this, config.cache);
        } catch (e) {
          return [];
        }
      },
      getInfluxDBTags: function getInfluxDBTags(format, config, element) {
        return this.__P_36_5(format, config, element, function (res) {
          if (format === 'monaco') {
      ...
      _parseDpResponseForMonaco: function _parseDpResponseForMonaco(data) {
        return this.__P_36_6(data, 'monaco');
      },
      _parseDpResponseForEditor: function _parseDpResponseForEditor(data) {
        return this.__P_36_6(data, 'dp');
      },
      __P_36_6: function __P_36_6(data, format) {
        var target = [];
      ...
      getMediaFiles: function getMediaFiles(format, config, typeFilter) {
        ...
        return this.__P_36_2('media', fsClient.readSync, fsClient, [{
          path: 'media',
          recursive: true
        }], function (res) {
...
//# sourceMappingURL=Provider.js.map?dt=1620144796117