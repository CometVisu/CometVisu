  ...
  qx.Class.define('cv.ui.manager.editor.Xml', {
    ...
    */
    construct: function construct() {
      ...
      this.__P_32_0 = qx.util.Uri.getAbsolute(qx.util.LibraryManager.getInstance().get("cv", "resourceUri") + '/../editor/editor.html');
    ...
    members: {
      ...
      _loadFile: function _loadFile(file) {
        ...
        if (file) {
          ...
          if (match) {
            if (file.isWriteable()) {
              this._iframe = new qx.ui.embed.Iframe(qx.util.Uri.appendParamsToUrl(this.__P_32_0, 'embed=1&config=' + match[1]) + '&demo=' + (file.getParentFolder() === 'demo/' ? 'true' : 'false'));
...
//# sourceMappingURL=Xml.js.map?dt=1619883136866