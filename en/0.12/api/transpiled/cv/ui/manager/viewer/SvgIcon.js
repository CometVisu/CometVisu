    ...
    */
    members: {
      ...
      _applyName: function _applyName(value) {
        if (value) {
          if (!this.__P_53_0) {
            this.__P_53_0 = qx.util.ResourceManager.getInstance().toUri('icons/knx-uf-iconset.svg');
          }

          if (!this.__P_53_1.getDomElement()) {
            this.__P_53_1.addListenerOnce('appear', function () {
          ...
          this.__P_53_1.getDomElement().setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', this.__P_53_0 + '#kuf-' + value);
        } else {
          this.__P_53_1.removeAttribute('xlink:href');
        }
      },
      // overridden
      _createContentElement: function _createContentElement() {
        var svgElem = new cv.svg.Element('svg');
        this.__P_53_1 = new cv.svg.Element('use');
        svgElem.setAttribute('xmlns:xlink', 'http://www.w3.org/1999/xlink');
        svgElem.add(this.__P_53_1);
        return svgElem;
      }
    },
...
//# sourceMappingURL=SvgIcon.js.map?dt=1644052357282