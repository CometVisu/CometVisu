    ...
    members: {
      ...
      _onPhaseChange: function _onPhaseChange(ev) {
        ...
        if (ev.getData() === "opened") {
          this.__P_508_0 = Date.now(); // calculate Hash value for request
          ...
          delay = Date.now() - this.__P_508_0; // log the trigger that triggers the server responses
          ...
          this.__P_508_0 = null; // delete pending request
          ...
          delay = Date.now() - this.__P_508_0; // request aborted, maybe by watchdog
...
//# sourceMappingURL=MXhrHook.js.map?dt=1618502918356