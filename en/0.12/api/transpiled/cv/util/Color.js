  ...
  qx.Class.define('cv.util.Color', {
    ...
    */
    ...
    construct: function construct() {
      ...
      this.__P_503_0 = Rxy === undefined ? {
        x: 0.64,
        y: 0.33,
        Y: 0.2126
      } : Rxy; // default: sRGB

      this.__P_503_1 = Gxy === undefined ? {
        x: 0.30,
        y: 0.60,
        Y: 0.7152
      } : Gxy;
      this.__P_503_2 = Bxy === undefined ? {
        x: 0.15,
        y: 0.06,
        Y: 0.0722
      } : Bxy;

      if (this.__P_503_0.Y === undefined) {
        this.__P_503_0.Y = 1;
      }

      if (this.__P_503_1.Y === undefined) {
        this.__P_503_1.Y = 1;
      }

      if (this.__P_503_2.Y === undefined) {
        this.__P_503_2.Y = 1;
      } // normalize luminances


      var normFac = 1 / (this.__P_503_0.Y + this.__P_503_1.Y + this.__P_503_2.Y);
      this.__P_503_0.Y *= normFac;
      this.__P_503_1.Y *= normFac;
      this.__P_503_2.Y *= normFac; // precalculate X and Z

      this.__P_503_0.X = this.__P_503_0.x * this.__P_503_0.Y / this.__P_503_0.y;
      this.__P_503_0.Z = (1 - this.__P_503_0.x - this.__P_503_0.y) * this.__P_503_0.Y / this.__P_503_0.y;
      this.__P_503_1.X = this.__P_503_1.x * this.__P_503_1.Y / this.__P_503_1.y;
      this.__P_503_1.Z = (1 - this.__P_503_1.x - this.__P_503_1.y) * this.__P_503_1.Y / this.__P_503_1.y;
      this.__P_503_2.X = this.__P_503_2.x * this.__P_503_2.Y / this.__P_503_2.y;
      this.__P_503_2.Z = (1 - this.__P_503_2.x - this.__P_503_2.y) * this.__P_503_2.Y / this.__P_503_2.y;

      if (undefined !== Wxy) {
        this.__P_503_3 = Wxy;

        if (this.__P_503_3.Y === undefined) {
          this.__P_503_3.Y = 1;
        }

        this.__P_503_3.X = this.__P_503_3.x * this.__P_503_3.Y / this.__P_503_3.y;
        this.__P_503_3.Z = (1 - this.__P_503_3.x - this.__P_503_3.y) * this.__P_503_3.Y / this.__P_503_3.y;
      } else {
        this.__P_503_3 = {
          X: this.__P_503_0.X + this.__P_503_1.X + this.__P_503_2.X,
          Y: this.__P_503_0.Y + this.__P_503_1.Y + this.__P_503_2.Y,
          Z: this.__P_503_0.Z + this.__P_503_1.Z + this.__P_503_2.Z
        };
        this.__P_503_3.x = this.__P_503_3.X / (this.__P_503_3.X + this.__P_503_3.Y + this.__P_503_3.Z);
        this.__P_503_3.y = this.__P_503_3.Y / (this.__P_503_3.X + this.__P_503_3.Y + this.__P_503_3.Z);
    ...
    */
    members: {
       ...
       * @type {number}
       */
      __P_503_6: 0.3333333333333333,

      /**
       * CIE 1931 XYZ color space: y of xyY
       * @type {number}
       */
      __P_503_7: 0.3333333333333333,
       ...
       */
      __P_503_16: function __P_503_16() {
        return {
          X: this.__P_503_6 * (this.__P_503_8 / Math.max(0.001, this.__P_503_7)),
          Y: this.__P_503_8,
          Z: (1 - this.__P_503_6 - this.__P_503_7) * (this.__P_503_8 / Math.max(0.001, this.__P_503_7))
        };
      },
       ...
       * @param {number} Z
       */
      __P_503_17: function __P_503_17(X, Y, Z) {
        var XYZ = X + Y + Z; // best guess for a total black: completely unsaturated, i.e. the white point

        this.__P_503_6 = XYZ > 0 ? X / XYZ : this.__P_503_3.x;
        this.__P_503_7 = XYZ > 0 ? Y / XYZ : this.__P_503_3.y;
        this.__P_503_8 = Y;
      },
       ...
       * @returns {{x: number, y: number}}
       */
      __P_503_18: function __P_503_18() {
        var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.__P_503_6;
        var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.__P_503_7;
        // is x-y on the same side of the R-G axis as the white point?
        var iRG = cv.util.Color.intersect(this.__P_503_0, this.__P_503_1, this.__P_503_3, {
          x: x,
          y: y
        });
        ...
        var iGB = cv.util.Color.intersect(this.__P_503_1, this.__P_503_2, this.__P_503_3, {
          x: x,
          y: y
        });
        ...
        var iBR = cv.util.Color.intersect(this.__P_503_2, this.__P_503_0, this.__P_503_3, {
          x: x,
          y: y
        });
      ...
      __P_503_19: function __P_503_19(force) {
        /**
        ...
        if (this.__P_503_4 === undefined || force) {
          if (this.__P_503_8 < 1e-4) {
            this.__P_503_4 = {
              h: this.__P_503_9,
              s: 0,
              v: this.__P_503_8
          ...
          var hues = [this.__P_503_0, this.__P_503_1, this.__P_503_2, this.__P_503_0];
          var thisXYZ = {
            X: this.__P_503_6 * this.__P_503_8 / this.__P_503_7,
            Y: this.__P_503_8,
            Z: (1 - this.__P_503_6 - this.__P_503_7) * this.__P_503_8 / this.__P_503_7
          };

          if (Math.pow(this.__P_503_6 - this.__P_503_3.x, 2) + Math.pow(this.__P_503_7 - this.__P_503_3.y, 2) < 1e-6) {
            // color is white
            this.__P_503_4 = {
              h: this.__P_503_9,
              s: 0,
          ...
          for (var i = 0; i < 3; i++) {
            var inter1 = cv.util.Color.intersect(hues[i], colorAdd(hues[i], hues[i + 1]), this.__P_503_3, {
              x: this.__P_503_6,
              y: this.__P_503_7
            });
            var inter2 = cv.util.Color.intersect(colorAdd(hues[i], hues[i + 1]), hues[i + 1], this.__P_503_3, {
              x: this.__P_503_6,
              y: this.__P_503_7
            }); // hues[i] -> (hues[i]+hues[i+1])

            var fac = solve(hues[i + 1].X, hues[i + 1].Y, hues[i + 1].Z, hues[i].X - this.__P_503_3.X, hues[i].Y - this.__P_503_3.Y, hues[i].Z - this.__P_503_3.Z, this.__P_503_3.X, this.__P_503_3.Y, this.__P_503_3.Z, thisXYZ.X, thisXYZ.Y, thisXYZ.Z);
            ...
            if (inter1.factors[0] >= 0 && inter1.factors[1] >= 0 && inter1.factors[1] <= 1) {
              ...
              this.__P_503_9 = this.__P_503_4.h;
              break;
            } // (hues[i]+hues[i+1]) -> hues[i+1]


            var fac2 = solve(-hues[i].X, -hues[i].Y, -hues[i].Z, hues[i].X + hues[i + 1].X - this.__P_503_3.X, hues[i].Y + hues[i + 1].Y - this.__P_503_3.Y, hues[i].Z + hues[i + 1].Z - this.__P_503_3.Z, this.__P_503_3.X, this.__P_503_3.Y, this.__P_503_3.Z, thisXYZ.X, thisXYZ.Y, thisXYZ.Z);
      ...
      __P_503_20: function __P_503_20(force) {
        if (this.__P_503_21 === undefined || force) {
          this.__P_503_21 = {};

          var _this$__P_503_ = this.__P_503_16(),
              X = _this$__P_503_.X,
              Y = _this$__P_503_.Y,
              Z = _this$__P_503_.Z;

          var _cv$util$Color$solve = cv.util.Color.solve3d(this.__P_503_0.X, this.__P_503_0.Y, this.__P_503_0.Z, this.__P_503_1.X, this.__P_503_1.Y, this.__P_503_1.Z, this.__P_503_2.X, this.__P_503_2.Y, this.__P_503_2.Z, X, Y, Z);

          var _cv$util$Color$solve2 = _slicedToArray(_cv$util$Color$solve, 3);

          this.__P_503_21.r = _cv$util$Color$solve2[0];
          this.__P_503_21.g = _cv$util$Color$solve2[1];
          this.__P_503_21.b = _cv$util$Color$solve2[2];
          // scale and clamp:
          var max = Math.max(this.__P_503_21.r, this.__P_503_21.g, this.__P_503_21.b);

          if (max < 1) {
            max = 1;
          }

          this.__P_503_21.r = Math.max(0, this.__P_503_21.r / max);
          this.__P_503_21.g = Math.max(0, this.__P_503_21.g / max);
          this.__P_503_21.b = Math.max(0, this.__P_503_21.b / max);
        }
      },
      __P_503_22: function __P_503_22(force) {
        if (this.__P_503_23 === undefined || force) {
          var _this$__P_503_2 = this.__P_503_16(),
              X = _this$__P_503_2.X,
              Y = _this$__P_503_2.Y,
              Z = _this$__P_503_2.Z;

          var w2rgb = cv.util.Color.solve3d(this.__P_503_0.X, this.__P_503_0.Y, this.__P_503_0.Z, this.__P_503_1.X, this.__P_503_1.Y, this.__P_503_1.Z, this.__P_503_2.X, this.__P_503_2.Y, this.__P_503_2.Z, this.__P_503_3.X, this.__P_503_3.Y, this.__P_503_3.Z);
          this.__P_503_23 = {};

          var _cv$util$Color$solve3 = cv.util.Color.solve3d(this.__P_503_0.X, this.__P_503_0.Y, this.__P_503_0.Z, this.__P_503_1.X, this.__P_503_1.Y, this.__P_503_1.Z, this.__P_503_2.X, this.__P_503_2.Y, this.__P_503_2.Z, X, Y, Z);

          var _cv$util$Color$solve4 = _slicedToArray(_cv$util$Color$solve3, 3);

          this.__P_503_23.r = _cv$util$Color$solve4[0];
          this.__P_503_23.g = _cv$util$Color$solve4[1];
          this.__P_503_23.b = _cv$util$Color$solve4[2];
          this.__P_503_23.w = Math.min(this.__P_503_23.r / w2rgb[0], this.__P_503_23.g / w2rgb[1], this.__P_503_23.b / w2rgb[2]);
          this.__P_503_23.r -= this.__P_503_23.w * w2rgb[0];
          this.__P_503_23.g -= this.__P_503_23.w * w2rgb[1];
          this.__P_503_23.b -= this.__P_503_23.w * w2rgb[2]; // scale and clamp:

          var max = Math.max(this.__P_503_23.r, this.__P_503_23.g, this.__P_503_23.b, this.__P_503_23.w);

          if (max < 1) {
            max = 1;
          }

          this.__P_503_23.r = Math.max(0, this.__P_503_23.r / max);
          this.__P_503_23.g = Math.max(0, this.__P_503_23.g / max);
          this.__P_503_23.b = Math.max(0, this.__P_503_23.b / max);
          this.__P_503_23.w = Math.max(0, this.__P_503_23.w / max);
        }
      },
      __P_503_24: function __P_503_24(force) {
        ...
        if (this.__P_503_13 === undefined || force) {
          var n = (this.__P_503_6 - 0.3320) / (this.__P_503_7 - 0.1858);
          var T = ((-449 * n + 3525) * n - 6823.3) * n + 5520.33;
          this.__P_503_13 = Math.max(2000, Math.min(T, 12500));
        }
      },
      __P_503_25: function __P_503_25(force) {
        if (this.__P_503_14 === undefined || force) {
          var Xn = this.__P_503_3.X;
          var Yn = this.__P_503_3.Y;
          var Zn = this.__P_503_3.Z;

          var _this$__P_503_3 = this.__P_503_16(),
              X = _this$__P_503_3.X,
              Y = _this$__P_503_3.Y,
              Z = _this$__P_503_3.Z;
      ...
      __P_503_26: function __P_503_26(force) {
        this.__P_503_25();

        if (this.__P_503_15 === undefined || force) {
          this.__P_503_15 = {
            L: this.__P_503_14.L / 100,
            // map to 0...1
            C: Math.sqrt(Math.pow(this.__P_503_14.a, 2) + Math.pow(this.__P_503_14.b, 2)) / 150,
            // map to 0...1
            h: (Math.atan2(this.__P_503_14.b, this.__P_503_14.a) / (2 * Math.PI) + 1) % 1 // map angle to 0...1

          };

          if (this.__P_503_15.C < 1e-5) {
            this.__P_503_15.h = this.__P_503_10;
          } else {
            this.__P_503_10 = this.__P_503_15.h;
          }
        }
      },
       ...
       * @param {string} [keep2]
       */
      __P_503_27: function __P_503_27(keep) {
        var _this = this;

        var keep2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
        ["__P_503_21", "__P_503_23", "__P_503_4", "__P_503_14", "__P_503_15", "__P_503_13"].forEach(function (cache) {
      ...
      __P_503_5: function __P_503_5() {
        ...
        if (this.__P_503_4.h < 0.16666666666666666) {
          var _u = (this.__P_503_4.h - 0) * 6;

          r = 1;
          g = _u;
          b = 0; // eslint-disable-line max-statements-per-line
        } else if (this.__P_503_4.h < 0.3333333333333333) {
          u = (this.__P_503_4.h - 0.16666666666666666) * 6;
          d = 1 - u; // eslint-disable-line max-statements-per-line

          r = d;
          g = 1;
          b = 0; // eslint-disable-line max-statements-per-line
        } else if (this.__P_503_4.h < 0.5) {
          var _u2 = (this.__P_503_4.h - 0.3333333333333333) * 6;

          r = 0;
          g = 1;
          b = _u2; // eslint-disable-line max-statements-per-line
        } else if (this.__P_503_4.h < 0.6666666666666666) {
          u = (this.__P_503_4.h - 0.5) * 6;
          d = 1 - u; // eslint-disable-line max-statements-per-line

          r = 0;
          g = d;
          b = 1; // eslint-disable-line max-statements-per-line
        } else if (this.__P_503_4.h < 0.8333333333333334) {
          u = (this.__P_503_4.h - 0.6666666666666666) * 6;
          r = u;
          g = 0;
          b = 1; // eslint-disable-line max-statements-per-line
        } else {
          u = (this.__P_503_4.h - 0.8333333333333334) * 6;
          d = 1 - u; // eslint-disable-line max-statements-per-line
        ...
        var X = ((this.__P_503_0.X * r + this.__P_503_1.X * g + this.__P_503_2.X * b) * this.__P_503_4.s + (1 - this.__P_503_4.s) * this.__P_503_3.X) * this.__P_503_4.v;
        var Y = ((this.__P_503_0.Y * r + this.__P_503_1.Y * g + this.__P_503_2.Y * b) * this.__P_503_4.s + (1 - this.__P_503_4.s) * this.__P_503_3.Y) * this.__P_503_4.v;
        var Z = ((this.__P_503_0.Z * r + this.__P_503_1.Z * g + this.__P_503_2.Z * b) * this.__P_503_4.s + (1 - this.__P_503_4.s) * this.__P_503_3.Z) * this.__P_503_4.v;

        this.__P_503_17(X, Y, Z);

        this.__P_503_27("__P_503_4");
      },
      __P_503_28: function __P_503_28() {
        this.__P_503_8 = Math.max(this.__P_503_21.r, this.__P_503_21.g, this.__P_503_21.b);

        if (this.__P_503_8 > 0) {
          var X = this.__P_503_0.X * this.__P_503_21.r + this.__P_503_1.X * this.__P_503_21.g + this.__P_503_2.X * this.__P_503_21.b;
          var Y = this.__P_503_0.Y * this.__P_503_21.r + this.__P_503_1.Y * this.__P_503_21.g + this.__P_503_2.Y * this.__P_503_21.b;
          var Z = this.__P_503_0.Z * this.__P_503_21.r + this.__P_503_1.Z * this.__P_503_21.g + this.__P_503_2.Z * this.__P_503_21.b;
        ...
        this.__P_503_27("__P_503_21");
      },
      __P_503_29: function __P_503_29() {
        this.__P_503_8 = Math.max(this.__P_503_23.r, this.__P_503_23.g, this.__P_503_23.b, this.__P_503_23.w);

        if (this.__P_503_8 > 0) {
          var X = this.__P_503_0.X * this.__P_503_23.r + this.__P_503_1.X * this.__P_503_23.g + this.__P_503_2.X * this.__P_503_23.b + this.__P_503_3.X * this.__P_503_23.w;
          var Y = this.__P_503_0.Y * this.__P_503_23.r + this.__P_503_1.Y * this.__P_503_23.g + this.__P_503_2.Y * this.__P_503_23.b + this.__P_503_3.Y * this.__P_503_23.w;
          var Z = this.__P_503_0.Z * this.__P_503_23.r + this.__P_503_1.Z * this.__P_503_23.g + this.__P_503_2.Z * this.__P_503_23.b + this.__P_503_3.Z * this.__P_503_23.w;

          this.__P_503_17(X, Y, Z);
        } // else: do nothing and keep the current x and y to be able to restore it's value when just the brightness will be increased again


        this.__P_503_27("__P_503_23");
      },
      __P_503_30: function __P_503_30() {
        var xy = cv.util.Color.temperature2xy(this.__P_503_13);
        this.__P_503_6 = xy.x;
        this.__P_503_7 = xy.y;

        this.__P_503_27("__P_503_13");
      },
      __P_503_31: function __P_503_31() {
        this.__P_503_27("__P_503_13");
      },
      __P_503_32: function __P_503_32() {
        ...
        this.__P_503_27("__P_503_14", keepLCh ? "__P_503_15" : '');
      },
      __P_503_33: function __P_503_33() {
        this.__P_503_14 = {
          L: this.__P_503_15.L * 100,
          a: this.__P_503_15.C * Math.cos(this.__P_503_15.h * 2 * Math.PI) * 150,
          b: this.__P_503_15.C * Math.sin(this.__P_503_15.h * 2 * Math.PI) * 150
        };

        this.__P_503_32(true);
      },
      ...
      changeComponent: function changeComponent(component, value) {
        ...
        switch (component) {
          ...
          case 'v':
            ...
            this.__P_503_4[component] = clamp(value);
          ...
          case 'sv':
            ...
            this.__P_503_4.s = clamp(value[0]);
            this.__P_503_4.v = clamp(value[1]);
          ...
          case 'RGB-b':
            ...
            this.__P_503_21[component.split('-')[1]] = clamp(value);
          ...
          case 'RGBW-w':
            ...
            this.__P_503_23[component.split('-')[1]] = clamp(value);
          ...
          case 'T':
            this.__P_503_13 = Math.max(1667, Math.min(value, 25000));
          ...
          case 'x':
            this.__P_503_6 = clamp(value);

            this.__P_503_27(''); // all precalculated colors are invalid now


            break;

          case 'y':
            this.__P_503_7 = clamp(value);
          ...
          case 'xy':
            this.__P_503_6 = clamp(value.x);
            this.__P_503_7 = clamp(value.y);
          ...
          case 'LCh-C':
            ...
            this.__P_503_15[component.split('-')[1]] = clamp(value);
          ...
          case 'LCh-CL':
            ...
            this.__P_503_15.C = clamp(value[0]);
            this.__P_503_15.L = clamp(value[1]);
      ...
      getComponent: function getComponent(component) {
        ...
        switch (component) {
          case 'xy':
            return {
              x: clamp(0, this.__P_503_6, 1),
              y: clamp(0, this.__P_503_7, 1)
            };

          case 'Y':
            return clamp(0, this.__P_503_8, 1);

          case 'xyY':
            return {
              x: clamp(0, this.__P_503_6, 1),
              y: clamp(0, this.__P_503_7, 1),
              Y: clamp(0, this.__P_503_8, 1)
            };

          case 'h':
          case 's':
          case 'v':
            this.__P_503_19(force);

            return clamp(0, this.__P_503_4[component], 1);

          case 'hsv':
            this.__P_503_19(force);

            return {
              h: clamp(0, this.__P_503_4.h, 1),
              s: clamp(0, this.__P_503_4.s, 1),
              v: clamp(0, this.__P_503_4.v, 1)
            };
          ...
          case 'RGB-b':
            {
              this.__P_503_20(force);

              var map = gamutMap ? 1 / Math.max(this.__P_503_21.r, this.__P_503_21.g, this.__P_503_21.b, 1) : 1;
              return map * this.__P_503_21[component.split('-')[1]];
            }
          ...
          case 'rgb':
            {
              ...
              var _map = gamutMap ? 1 / Math.max(this.__P_503_21.r, this.__P_503_21.g, this.__P_503_21.b, 1) : 1;

              return {
                r: _map * this.__P_503_21.r,
                g: _map * this.__P_503_21.g,
                b: _map * this.__P_503_21.b
              };
            }
          ...
          case 'RGBW-w':
            {
              this.__P_503_22(force);

              var _map2 = gamutMap ? 1 / Math.max(this.__P_503_23.r, this.__P_503_23.g, this.__P_503_23.b, this.__P_503_23.w, 1) : 1;

              return _map2 * this.__P_503_23[component.split('-')[1]];
            }
          ...
          case 'rgbw':
            {
              ...
              var _map3 = gamutMap ? 1 / Math.max(this.__P_503_23.r, this.__P_503_23.g, this.__P_503_23.b, this.__P_503_23.w, 1) : 1;

              return {
                r: _map3 * this.__P_503_23.r,
                g: _map3 * this.__P_503_23.g,
                b: _map3 * this.__P_503_23.b,
                w: _map3 * this.__P_503_23.w
              };
            }

          case 'T':
            this.__P_503_24(force);

            return clamp(1667, this.__P_503_13, 25000);

          case 'Lab':
            this.__P_503_25(force);

            return this.__P_503_14;

          case 'LCh-L':
          case 'LCh-C':
          case 'LCh-h':
            this.__P_503_26(force);

            return clamp(0, this.__P_503_15[component.split('-')[1]], 1);

          case 'LCh':
            this.__P_503_26(force);

            return {
              L: clamp(0, this.__P_503_15.L, 1),
              C: clamp(0, this.__P_503_15.C, 1),
              h: clamp(0, this.__P_503_15.h, 1)
            };
        }
      ...
      delta: function delta(otherColor) {
        ...
        otherColor.__P_503_25();

        var Lab = otherColor.__P_503_14;
        var dL = this.__P_503_14.L - Lab.L;
        var da = this.__P_503_14.a - Lab.a;
        var db = this.__P_503_14.b - Lab.b;
      ...
      blend: function blend(otherColor, ratio) {
        ...
        var c = this.copy();
        var c1 = this.__P_503_15;
        var c2 = otherColor.__P_503_15;
...
//# sourceMappingURL=Color.js.map?dt=1674150494214