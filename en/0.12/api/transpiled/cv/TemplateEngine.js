(function () {
  ...
  qx.Class.define('cv.TemplateEngine', {
    ...
    construct: function construct() {
      ...
      this.__P_480_0 = new qx.data.Array();
      this._domFinishedQueue = [];

      this.__P_480_0.addListener("changeLength", function (ev) {
    ...
    members: {
      ...
      _onActiveChanged: function _onActiveChanged() {
        ...
        if (app.isActive()) {
          if (!this.visu.isConnected() && this.__P_480_2) {
            // reconnect
          ...
          if (!this.__P_480_1) {
            this.__P_480_1 = new qx.event.Timer(3000);

            this.__P_480_1.addListener('interval', function () {
              if (app.isActive()) {
      ...
      _checkBackendConnection: function _checkBackendConnection() {
        ...
        var message = {
          ...
          unique: true,
          deletable: false,
          condition: !connected && this.__P_480_2 && qx.core.Init.getApplication().isActive()
        };
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_480_1");
    }
  });
  cv.TemplateEngine.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TemplateEngine.js.map?dt=1604955494611