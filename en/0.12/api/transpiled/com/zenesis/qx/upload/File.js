  ...
  qx.Class.define("com.zenesis.qx.upload.File", {
    ...
    members: {
      ...
      setParam: function setParam(name, value) {
        ...
        if (!this.__P_511_1) this.__P_511_1 = {};
        this.__P_511_1[name] = value;
      },
      ...
      getParam: function getParam(name) {
        return this.__P_511_1 && this.__P_511_1[name];
      },
      ...
      getParamNames: function getParamNames() {
        var result = [];
        if (this.__P_511_1) for (var name in this.__P_511_1) {
          result.push(name);
        }
        return result;
      },
...
//# sourceMappingURL=File.js.map?dt=1641882237831