  ...
  qx.Mixin.define("com.zenesis.qx.upload.MParameters", {
    members: {
      ...
      setParam: function setParam(name, value) {
        ...
        if (!this.__P_514_0) this.__P_514_0 = {};
        this.__P_514_0[name] = value;
      },
      ...
      getParam: function getParam(name) {
        return this.__P_514_0 && this.__P_514_0[name];
      },
      ...
      getParamNames: function getParamNames() {
        var result = [];
        if (this.__P_514_0) for (var name in this.__P_514_0) {
          result.push(name);
        }
        return result;
      }
...
//# sourceMappingURL=MParameters.js.map?dt=1603737154902