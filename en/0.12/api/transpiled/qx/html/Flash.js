    ...
    */
    members: {
      ...
      createFlash: function createFlash() {
        this.__P_200_3 = qx.bom.Flash.create(this.getDomElement(), this.getAttributes(), this.__P_200_1, this.__P_200_0);
      },
      ...
      setParam: function setParam(key, value) {
        ...
        if (value === null || value === undefined) {
          delete this.__P_200_0[key];
        } else {
          this.__P_200_0[key] = value;
        }
      },
    ...
    destruct: function destruct() {
      if (this.__P_200_3) {
        qx.bom.Flash.destroy(this.__P_200_3);
      }

      this.__P_200_0 = this.__P_200_1 = this.__P_200_2 = null;
    }
  });
  qx.html.Flash.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Flash.js.map?dt=1618502890529