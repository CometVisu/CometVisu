    ...
    */
    members: {
      ...
      createFlash: function createFlash() {
        this.__P_203_3 = qx.bom.Flash.create(this.getDomElement(), this.getAttributes(), this.__P_203_1, this.__P_203_0);
      },
      ...
      setParam: function setParam(key, value) {
        ...
        if (value === null || value === undefined) {
          delete this.__P_203_0[key];
        } else {
          this.__P_203_0[key] = value;
        }
      },
    ...
    destruct: function destruct() {
      if (this.__P_203_3) {
        qx.bom.Flash.destroy(this.__P_203_3);
      }

      this.__P_203_0 = this.__P_203_1 = this.__P_203_2 = null;
    }
  });
  qx.html.Flash.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Flash.js.map?dt=1604955474738