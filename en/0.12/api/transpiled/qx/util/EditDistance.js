  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_461_0: function __P_461_0(dataA, dataB) {
       ...
       */
      __P_461_1: function __P_461_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_461_0(dataA, dataB);

        var operations = this.__P_461_1(distance, dataA, dataB);
...
//# sourceMappingURL=EditDistance.js.map?dt=1604955493162