  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_458_0: function __P_458_0(dataA, dataB) {
       ...
       */
      __P_458_1: function __P_458_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_458_0(dataA, dataB);

        var operations = this.__P_458_1(distance, dataA, dataB);
...
//# sourceMappingURL=EditDistance.js.map?dt=1612690419023