  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.Serializer", {
    statics: {
        ...
        for (var name in properties) {
          ...
          if (qx.lang.Type.isArray(value)) {
            ...
            for (var i = 0; i < value.length; i++) {
              ...
              result += this.__P_466_0(name, valueAtI, qxSerializer);
            }
          } else if (qx.lang.Type.isDate(value) && dateFormat != null) {
            result += this.__P_466_0(name, dateFormat.format(value), qxSerializer);
          } else {
            result += this.__P_466_0(name, value, qxSerializer);
          }
        }
       ...
       */
      __P_466_0: function __P_466_0(name, value, qxSerializer) {
...
//# sourceMappingURL=Serializer.js.map?dt=1592777110032