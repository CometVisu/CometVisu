  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_470_0(stateInfo[field], context));
            break;

          case "onexit":
            this.setOnexit(this.__P_470_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_470_1: function __P_470_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_470_2: function __P_470_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_470_3: function __P_470_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_470_8: function __P_470_8(value) {
       ...
       * @return {var} the final value
       */
      __P_470_4: function __P_470_4(value) {
       ...
       * @return {var} the final value
       */
      __P_470_5: function __P_470_5(value) {
       ...
       * @return {var} the final value
       */
      __P_470_6: function __P_470_6(value) {
       ...
       * @return {var} the final value
       */
      __P_470_7: function __P_470_7(value) {
       ...
       *   unaltered.
       */
      __P_470_0: function __P_470_0(f, context) {
...
//# sourceMappingURL=State.js.map?dt=1619883175446