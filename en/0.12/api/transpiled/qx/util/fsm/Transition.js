  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_471_0(transitionInfo[field], context));
            break;
          ...
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_471_0(transitionInfo[field], context));
            break;

          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_471_0(transitionInfo[field], context));
            break;

          case "ontransition":
            this.setOntransition(this.__P_471_0(transitionInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_471_1: function __P_471_1(value) {
       ...
       */
      __P_471_2: function __P_471_2(value) {
       ...
       * @return {Function} the final value
       */
      __P_471_3: function __P_471_3(value) {
       ...
       * @return {Function} the final value
       */
      __P_471_4: function __P_471_4(value) {
       ...
       * @return {Function} the final value
       */
      __P_471_5: function __P_471_5(value) {
       ...
       *   unaltered.
       */
      __P_471_0: function __P_471_0(f, context) {
...
//# sourceMappingURL=Transition.js.map?dt=1612690419872