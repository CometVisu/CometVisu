  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_474_0(transitionInfo[field], context));
            break;
          ...
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_474_0(transitionInfo[field], context));
            break;

          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_474_0(transitionInfo[field], context));
            break;

          case "ontransition":
            this.setOntransition(this.__P_474_0(transitionInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_474_1: function __P_474_1(value) {
       ...
       */
      __P_474_2: function __P_474_2(value) {
       ...
       * @return {Function} the final value
       */
      __P_474_3: function __P_474_3(value) {
       ...
       * @return {Function} the final value
       */
      __P_474_4: function __P_474_4(value) {
       ...
       * @return {Function} the final value
       */
      __P_474_5: function __P_474_5(value) {
       ...
       *   unaltered.
       */
      __P_474_0: function __P_474_0(f, context) {
...
//# sourceMappingURL=Transition.js.map?dt=1603737150784