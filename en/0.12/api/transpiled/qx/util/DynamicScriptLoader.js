  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.DynamicScriptLoader", {
    ...
    construct: function construct(scriptArr) {
      ...
      this.__P_457_0 = false;
      this.__P_457_1 = qx.lang.Type.isString(scriptArr) ? [scriptArr] : qx.lang.Array.clone(scriptArr);
    },
    ...
    */
    members: {
      ...
      __P_457_4: function __P_457_4() {
        ...
        if (DynamicScriptLoader.__P_457_3[script]) {
        ...
        dynLoader = DynamicScriptLoader.__P_457_2[script];
        ...
        loader.on("load", function (request) {
          ...
          DynamicScriptLoader.__P_457_3[script] = true;
          delete DynamicScriptLoader.__P_457_2[script];
          this.fireDataEvent('loaded', {
            script: script,
        ...
        loader.open("GET", uri);
        DynamicScriptLoader.__P_457_2[script] = this;
        loader.send();
      }
    },
    destruct: function destruct() {
      ...
      for (var key in DynamicScriptLoader.__P_457_2) {
        if (DynamicScriptLoader.__P_457_2[key] === this) {
          delete DynamicScriptLoader.__P_457_2[key];
        }
      }

      this.__P_457_1 = undefined;
    }
  });
  qx.util.DynamicScriptLoader.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DynamicScriptLoader.js.map?dt=1614015671896