  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_100_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_100_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_100_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_100_3()) {
      ...
      __P_100_0: function __P_100_0() {
        ...
        if (qx.bom.client.Engine.__P_100_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1702898797356