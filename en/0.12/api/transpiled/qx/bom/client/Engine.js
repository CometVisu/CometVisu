  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_89_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_89_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_89_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_89_3()) {
      ...
      __P_89_0: function __P_89_0() {
        ...
        if (qx.bom.client.Engine.__P_89_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1614107125661