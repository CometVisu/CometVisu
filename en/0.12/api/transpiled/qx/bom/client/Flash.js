    ...
    */
    statics: {
      ...
      getExpressInstall: function getExpressInstall() {
        ...
        return (os == "win" || os == "osx") && qx.bom.client.Flash.__P_90_0("6.0.65", availableVersion);
      },
      ...
      getStrictSecurityModel: function getStrictSecurityModel() {
        ...
        if (full[0] < 10) {
          return qx.bom.client.Flash.__P_90_0("9.0.151", version);
        } else {
          return qx.bom.client.Flash.__P_90_0("10.0.12", version);
        }
      },
       ...
       */
      __P_90_0: function __P_90_0(input, availableVersion) {
...
//# sourceMappingURL=Flash.js.map?dt=1614107125739