    ...
    statics: {
      ...
      getVersion: function getVersion() {
        if (navigator.plugins && _typeof(navigator.plugins["Shockwave Flash"]) === "object") {
          ...
          if (!fp6Crash && _typeof(obj) == "object") {
      ...
      getExpressInstall: function getExpressInstall() {
        ...
        return (os == "win" || os == "osx") && qx.bom.client.Flash.__P_101_0("6.0.65", availableVersion);
      },
      ...
      getStrictSecurityModel: function getStrictSecurityModel() {
        ...
        if (full[0] < 10) {
          return qx.bom.client.Flash.__P_101_0("9.0.151", version);
        } else {
          return qx.bom.client.Flash.__P_101_0("10.0.12", version);
        }
      },
       ...
       */
      __P_101_0: function __P_101_0(input, availableVersion) {
...
//# sourceMappingURL=Flash.js.map?dt=1625667775250