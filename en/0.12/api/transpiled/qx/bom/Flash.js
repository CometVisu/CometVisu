    ...
    statics: {
      ...
      */
      ...
      create: function create(element, attributes, variables, params, win) {
        ...
        var flash = this.__P_65_0(element, attributes, params, win);
      ...
      destroy: function destroy(element, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
          element = this.__P_65_1(element);

          if (element.readyState == 4) {
            this.__P_65_2(element);
          } else {
            if (!win) {
              win = window;
            }
       ...
       */
      __P_65_1: function __P_65_1(element) {
        if (!element) {
       ...
       */
      __P_65_2: qx.core.Environment.select("engine.name", {
       ...
       * @signature function()
       */
      __P_65_3: qx.event.GlobalError.observeMethod(function () {
        // IE Memory Leak Fix
        for (var key in qx.bom.Flash._flashObjects) {
          qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[key]);
        }

        window.__P_65_4 = function () {};

        window.__P_65_5 = function () {}; // Remove listener again


        qx.bom.Event.removeNativeListener(window, "beforeunload", qx.bom.Flash.__P_65_3);
      }),
       ...
       */
      __P_65_0: function __P_65_0(element, attributes, params, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
    ...
    */
    defer: function defer(statics) {
      if (qx.core.Environment.get("engine.name") == "mshtml") {
        qx.bom.Event.addNativeListener(window, "beforeunload", statics.__P_65_3);
      }
    }
  });
...
//# sourceMappingURL=Flash.js.map?dt=1592777076354