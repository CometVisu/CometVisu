  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.SimpleXhr", {
    ...
    construct: function construct(url, method) {
      ...
      this.__P_113_0 = {};
      this.__P_113_1 = this._createResponseParser();
    },
    members: {
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      getResponse: function getResponse() {
        if (this.__P_113_5 !== null) {
          return this.__P_113_5;
        } else {
      ...
      setParser: function setParser(parser) {
        return this.__P_113_1.setParser(parser);
      },
      ...
      send: function send() {
        var curTimeout = this.getTimeout(),
            ...
            hasCacheControlHeader = this.__P_113_0.hasOwnProperty("Cache-Control"),
        ...
        for (var key in this.__P_113_0) {
          this._transport.setRequestHeader(key, this.__P_113_0[key]);
        } // send
...
//# sourceMappingURL=SimpleXhr.js.map?dt=1618502883139