  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.PageVisibility", {
    ...
    construct: function construct(document) {
      this.__P_89_0 = document || window.document;

      this.__P_89_1();

      var self = this; // forward the event

      qx.bom.Event.addNativeListener(this.__P_89_0, this.__P_89_2, function (e) {
        self.emit("change", e);
      });
    },
    events: {
    ...
    members: {
      ...
      __P_89_1: function __P_89_1() {
        ...
        for (var i = 0; i < prefix.length; i++) {
          ...
          if (this.__P_89_0[attr] != undefined) {
            this.__P_89_3 = attr; // also use the same prefix for the event name

            this.__P_89_2 = prefix[i].toLowerCase() + "visibilitychange";
            break;
          }
        }
        ...
        if (this.__P_89_3 == null) {
          this.__P_89_3 = "hidden";
          this.__P_89_2 = "visibilitychange";
        }

        if (this.__P_89_4 == null) {
          this.__P_89_4 = "visibilityState";
        }
      },
      ...
      isHidden: function isHidden() {
        return !!this.__P_89_0[this.__P_89_3];
      },
      ...
      getVisibilityState: function getVisibilityState() {
        return this.__P_89_0[this.__P_89_4] || "visible";
      }
    }
  });
...
//# sourceMappingURL=PageVisibility.js.map?dt=1645980653124