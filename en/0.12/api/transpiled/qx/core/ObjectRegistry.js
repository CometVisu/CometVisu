    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_134_1++ + this.__P_134_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_134_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1614107128138