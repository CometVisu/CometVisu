    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_145_1++ + this.__P_145_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_145_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1650122780064