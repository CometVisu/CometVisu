    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_132_1) {
          ...
          if (owner) {
            owner.__P_132_2(this, value, oldValue);
          }
       ...
       */
      __P_132_2: function __P_132_2(obj, newId, oldId) {
        delete this.__P_132_0[oldId];
        this.__P_132_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_132_0) {
          for (var name in this.__P_132_0) {
            var obj = this.__P_132_0[name];
       ...
       */
      __P_132_3: function __P_132_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_132_0 ? Object.values(this.__P_132_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1618502884220