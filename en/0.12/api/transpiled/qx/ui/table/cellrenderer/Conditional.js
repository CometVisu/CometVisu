  ...
  qx.Class.define("qx.ui.table.cellrenderer.Conditional", {
    ...
    */
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.conditions = [];
      this.__P_397_0 = align || "";
      this.__P_397_1 = color || "";
      this.__P_397_2 = style || "";
      this.__P_397_3 = weight || "";
    },
    ...
    */
    members: {
       ...
       */
      __P_397_4: function __P_397_4(condition, style) {
        if (condition[1] != null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_397_0,
          "color": this.__P_397_1,
          "font-style": this.__P_397_2,
          "font-weight": this.__P_397_3
        };
        ...
        for (i in this.conditions) {
          ...
          if (cond_test == true) {
            this.__P_397_4(this.conditions[i], style);
          }
        }
...
//# sourceMappingURL=Conditional.js.map?dt=1604955488710