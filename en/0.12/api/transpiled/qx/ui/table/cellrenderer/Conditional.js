  ...
  qx.Class.define("qx.ui.table.cellrenderer.Conditional", {
    ...
    */
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.conditions = [];
      this.__P_394_0 = align || "";
      this.__P_394_1 = color || "";
      this.__P_394_2 = style || "";
      this.__P_394_3 = weight || "";
    },
    ...
    */
    members: {
       ...
       */
      __P_394_4: function __P_394_4(condition, style) {
        if (condition[1] != null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_394_0,
          "color": this.__P_394_1,
          "font-style": this.__P_394_2,
          "font-weight": this.__P_394_3
        };
        ...
        for (i in this.conditions) {
          ...
          if (cond_test == true) {
            this.__P_394_4(this.conditions[i], style);
          }
        }
...
//# sourceMappingURL=Conditional.js.map?dt=1612694007727