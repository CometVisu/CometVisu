    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (this.getConfig("selectionMode") == "single") {
          ...
          if (!this.__P_441_0) {
            this.__P_441_0 = value.map(function (val) {
      ...
      _selectDay: function _selectDay(e) {
        ...
        if (this.getConfig("selectionMode") == "range") {
          var range = this.__P_441_0.slice(0);
...
//# sourceMappingURL=Calendar.js.map?dt=1614551297577