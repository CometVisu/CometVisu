  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_370_0 = []; // Register pointerdown handler

      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_370_1, this, true); // Hide all popups on window blur
    ...
    */
    members: {
      ...
      remove: function remove(obj) {
        qx.lang.Array.remove(this.__P_370_0, obj);
      ...
      hideAll: function hideAll() {
        var l = this.__P_370_0.length,
            current = {};

        while (l--) {
          current = this.__P_370_0[l];
      ...
      */
      ...
      __P_370_2: function __P_370_2() {
        ...
        for (var i = 0; i < this.__P_370_0.length; i++) {
          this.__P_370_0[i].setZIndex(min++);
        }
      },
      ...
      */
       ...
       */
      __P_370_1: function __P_370_1(e) {
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_370_1, this, true);
...
//# sourceMappingURL=Manager.js.map?dt=1592777102503