    ...
    */
    members: {
      ...
      syncWidget: function syncWidget() {
        this.__P_451_0.forceUnblock();

        var windows = this.__P_451_0.getWindows(); // z-index for all three window kinds
        ...
        for (var i = 0, l = windows.length; i < l; i++) {
          ...
          if (win.isModal()) {
            ...
            this.__P_451_0.blockContent(zIndexModal - 1);
        ...
        this.__P_451_0.setActiveWindow(active);
      },
      // interface implementation
      bringToFront: function bringToFront(win) {
        var windows = this.__P_451_0.getWindows();
...
//# sourceMappingURL=Manager.js.map?dt=1592777109197