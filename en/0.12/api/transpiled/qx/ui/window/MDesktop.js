  ...
  qx.Mixin.define("qx.ui.window.MDesktop", {
    ...
    */
    members: {
      ...
      setWindowManager: function setWindowManager(manager) {
        if (this.__P_459_1) {
          this.__P_459_1.setDesktop(null);
        }

        manager.setDesktop(this);
        this.__P_459_1 = manager;
      },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__P_459_0");

      this._disposeObjects("__P_459_1");
    }
  });
  qx.ui.window.MDesktop.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MDesktop.js.map?dt=1625667803184