    ...
    */
    members: {
      ...
      __P_322_4: function __P_322_4() {
        ...
        this.__P_322_0 = result; // Cache edges for faster access

        var edges = [];

        for (var i = 0; i < length; i++) {
          edge = result[i].getLayoutProperties().edge;
          edges[i] = this.__P_322_2[edge] || 5;
        }

        this.__P_322_1 = edges; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        var children = this.__P_322_0;
        var edges = this.__P_322_1;
...
//# sourceMappingURL=Dock.js.map?dt=1592777098691