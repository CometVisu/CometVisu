  ...
  qx.Class.define("qx.ui.embed.Flash", {
    ...
    members: {
      ...
      */
      ...
      _checkLoading: function _checkLoading() {
        ...
        if (source != "" && source != null && source != "undefined") {
          if (!this.isLoaded()) {
            if (!this.__P_293_0) {
              this.__P_293_0 = new Date().getTime();
            }

            var timeDiff = new Date().getTime() - this.__P_293_0;
      ...
      */
       ...
       */
      __P_293_1: function __P_293_1(key, value) {
...
//# sourceMappingURL=Flash.js.map?dt=1612700583479