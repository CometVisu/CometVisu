    ...
    members: {
      ...
      */
      ...
      _startIframeObserver: function _startIframeObserver() {
        ...
        this.__P_298_1 = idle.addListener("interval", this._onIframeObserverInterval, this);
      },
      ...
      _stopIframeObserver: function _stopIframeObserver() {
        ...
        var idle = qx.event.Idle.getInstance();
        idle.removeListenerById(this.__P_298_1);
      },
      ...
      _onIframeObserverInterval: function _onIframeObserverInterval() {
        ...
        if (this.__P_298_0 && iframeSize.width == this.__P_298_0.width && iframeSize.height == this.__P_298_0.height) {
          return;
        }

        this.__P_298_0 = iframeSize;
...
//# sourceMappingURL=ThemedIframe.js.map?dt=1603737138015