  ...
  qx.Class.define("qx.ui.mobile.basic.Atom", {
    ...
    */
    ...
    members: {
      ...
      _applyIconPosition: function _applyIconPosition(value, old) {
        ...
        var hasNoLabel = !this.__P_336_2;

        this.__P_336_5(verticalLayout, hasNoLabel);

        var isReverse = ["right", "bottom"].indexOf(value) != -1;

        this.__P_336_4.setLayout(this.__P_336_1);

        this.__P_336_1.setReversed(isReverse);
      ...
      _applyLabel: function _applyLabel(value, old) {
        if (this.__P_336_2) {
          this.__P_336_2.setValue(value);
        } else {
          this.__P_336_2 = this._createLabelWidget(value);
        }
      },
      // property apply
      _applyIcon: function _applyIcon(value, old) {
        if (this.__P_336_3) {
          this.__P_336_3.setSource(value);
        } else {
          this.__P_336_3 = this._createIconWidget(value);
        }
      },
       ...
       */
      __P_336_5: function __P_336_5(verticalLayout, hasNoLabel) {
        if (verticalLayout || hasNoLabel) {
          if (this.__P_336_1) {
            if (this.__P_336_1.classname !== "qx.ui.mobile.layout.VBox") {
              this.__P_336_1.dispose();

              this.__P_336_1 = new qx.ui.mobile.layout.VBox();
            }
          } // layout == null
          else {
              this.__P_336_1 = new qx.ui.mobile.layout.VBox();
            ...
            if (this.__P_336_1) {
              if (this.__P_336_1.classname !== "qx.ui.mobile.layout.HBox") {
                this.__P_336_1.dispose();

                this.__P_336_1 = new qx.ui.mobile.layout.HBox();
              }
            } // layout == null
            else {
                this.__P_336_1 = new qx.ui.mobile.layout.HBox();
       ...
       *
       */
      __P_336_0: function __P_336_0(label, icon) {
        this.__P_336_2 = this._createLabelWidget(label);

        if (label) {
          this.setLabel(label);
        }

        this.__P_336_3 = this._createIconWidget(icon);
        ...
        if (this.__P_336_4) {
          this.__P_336_4.dispose();
        }

        this.__P_336_4 = new qx.ui.mobile.container.Composite(this.__P_336_1);

        this.__P_336_4.addCssClass("qx-flex-center");

        this.__P_336_4.setAnonymous(true);

        if (this.__P_336_3) {
          this.__P_336_4.add(this.__P_336_3);
        }

        if (this.__P_336_2) {
          this.__P_336_2.addCssClass("qx-flex-center");

          this.__P_336_4.add(this.__P_336_2);
        } // Show/Hide Label/Icon


        if (this.getShow() === 'icon' && this.__P_336_2) {
          this.__P_336_2.exclude();
        }

        if (this.getShow() === 'label' && this.__P_336_3) {
          this.__P_336_3.exclude();
        }

        this._add(this.__P_336_4);
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_336_1", "__P_336_2", "__P_336_3", "__P_336_4");
    }
  });
  qx.ui.mobile.basic.Atom.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Atom.js.map?dt=1604955484995