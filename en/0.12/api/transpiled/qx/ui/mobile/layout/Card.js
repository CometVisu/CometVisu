  ...
  qx.Class.define("qx.ui.mobile.layout.Card", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_361_0 = new qx.ui.mobile.layout.CardAnimation();
    },
    ...
    */
    ...
    members: {
      ...
      _showWidget: function _showWidget(widget, properties) {
        ...
        if (this.__P_361_2 && this.getShowAnimation() && qx.core.Environment.get("css.transform.3d")) {
      ...
      _swapWidget: function _swapWidget() {
        if (this.__P_361_2) {
          this.__P_361_2.removeCssClass("active");

          this.__P_361_2.exclude();
        }

        this.__P_361_2 = this.__P_361_1;

        this.__P_361_2.addCssClass("active");
      },
       ...
       * @param widget {qx.ui.mobile.core.Widget} The target widget
       */
      __P_361_7: function __P_361_7(widget) {
        ...
        this.__P_361_3 = true;
        this.fireDataEvent("animationStart", [this.__P_361_2, widget]);

        var fromElement = this.__P_361_2.getContainerElement();
        ...
        var fromCssClasses = this.__P_361_8("out");

        var toCssClasses = this.__P_361_8("in");

        this._widget.addCssClass("animationParent");

        var toElementAnimation = this.__P_361_0.getAnimation(this.__P_361_4, "in", this.__P_361_5);

        var fromElementAnimation = this.__P_361_0.getAnimation(this.__P_361_4, "out", this.__P_361_5);
      ...
      _onAnimationEnd: function _onAnimationEnd(evt) {
        ...
        this.fireDataEvent("animationEnd", [this.__P_361_2, this.__P_361_1]);
      },

      /**
       * Stops the animation for the page transition.
       */
      __P_361_6: function __P_361_6() {
        if (this.__P_361_3) {
          var fromElement = this.__P_361_2.getContainerElement();

          var toElement = this.__P_361_1.getContainerElement();
          ...
          qx.bom.element.Class.removeClasses(fromElement, this.__P_361_8("out"));
          qx.bom.element.Class.removeClasses(toElement, this.__P_361_8("in"));

          this._swapWidget();

          this._widget.removeCssClass("animationParent");

          this.__P_361_3 = false;
        }
      },
       ...
       */
      __P_361_8: function __P_361_8(direction) {
        var classes = ["animationChild", this.__P_361_4, direction];
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_361_0");
    }
  });
  qx.ui.mobile.layout.Card.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Card.js.map?dt=1592777101700