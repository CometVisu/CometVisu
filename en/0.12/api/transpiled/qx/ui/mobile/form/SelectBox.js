  ...
  qx.Class.define("qx.ui.mobile.form.SelectBox", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_353_0 = this._createSelectionDialog();
    ...
    */
    ...
    members: {
      ...
      setClearButtonLabel: function setClearButtonLabel(value) {
        this.__P_353_0.setClearButtonLabel(value);
      },
       ...
       */
      __P_353_1: function __P_353_1() {
        if (this.isEnabled() == true) {
          // Set index before items, because setItems() triggers rendering.
          this.__P_353_0.setSelectedIndex(this.getSelection());

          this.__P_353_0.setItems(this.getModel());
      ...
      */
      _onTap: function _onTap(evt) {
        this.__P_353_1(); // request focus so that it leaves previous widget
      ...
      _applyNullable: function _applyNullable(value, old) {
        ...
        this.__P_353_0.setNullable(value);
      }
    },
    destruct: function destruct() {
      this.__P_353_0.removeListener("changeSelection", this._onChangeSelection, this);

      this._disposeObjects("__P_353_0", "__selectionDialogTitle");
...
//# sourceMappingURL=SelectBox.js.map?dt=1619360995896