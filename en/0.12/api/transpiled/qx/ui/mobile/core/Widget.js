  ...
  qx.Class.define("qx.ui.mobile.core.Widget", {
    ...
    */
    statics: {
      ...
      onShutdown: function onShutdown() {
        window.clearTimeout(qx.ui.mobile.core.Widget.__P_355_3);
        delete qx.ui.mobile.core.Widget.__P_355_1;
      },
      ...
      getCurrentId: function getCurrentId() {
        return qx.ui.mobile.core.Widget.__P_355_2;
      },
      ...
      registerWidget: function registerWidget(widget) {
        var id = widget.getId();
        var registry = qx.ui.mobile.core.Widget.__P_355_1;
        registry[id] = widget;
      },
      ...
      unregisterWidget: function unregisterWidget(id) {
        delete qx.ui.mobile.core.Widget.__P_355_1[id];
      },
      ...
      getWidgetById: function getWidgetById(id) {
        return qx.ui.mobile.core.Widget.__P_355_1[id];
      },
      ...
      scheduleDomUpdated: function scheduleDomUpdated() {
        if (qx.ui.mobile.core.Widget.__P_355_3 == null) {
          qx.ui.mobile.core.Widget.__P_355_3 = window.setTimeout(qx.ui.mobile.core.Widget.domUpdated, 0);
        }
      },
      ...
      domUpdated: qx.event.GlobalError.observeMethod(function () {
        ...
        window.clearTimeout(clazz.__P_355_3);
        clazz.__P_355_3 = null;
    ...
    members: {
      ...
      */
      ...
      _transformId: function _transformId(value) {
        if (value == null) {
          var clazz = qx.ui.mobile.core.Widget;
          value = clazz.ID_PREFIX + clazz.__P_355_2++;
        }
      ...
      */
      ...
      _addAt: function _addAt(child, index, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__P_355_0, child);
        }

        var ref = this.__P_355_0[index];
      ...
      _addBefore: function _addBefore(child, beforeWidget, layoutProperties) {
        ...
        qx.lang.Array.insertBefore(this.__P_355_0, child, beforeWidget);
      ...
      _addAfter: function _addAfter(child, afterWidget, layoutProperties) {
        ...
        qx.lang.Array.insertAfter(this.__P_355_0, child, afterWidget);
      ...
      _removeAt: function _removeAt(index) {
        ...
        var child = this.__P_355_0[index];
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__P_355_0.concat();
      ...
      setLayoutParent: function setLayoutParent(parent) {
        if (this.__P_355_6 === parent) {
          return;
        }

        var oldParent = this.__P_355_6;

        if (oldParent && !oldParent.$$disposed) {
          this.__P_355_6.removeChild(this);
        }

        this.__P_355_6 = parent || null;
      },
      ...
      _hasChildren: function _hasChildren() {
        return this.__P_355_0 && this.__P_355_0.length > 0;
      },
      ...
      _setLayout: function _setLayout(layout) {
        if (this.__P_355_7) {
          this.__P_355_7.connectToWidget(null);

          for (var i = 0; i < this._getChildren().length; i++) {
            var child = this._getChildren()[i];

            this.__P_355_7.disconnectFromChildWidget(child);
          }
        }
      ...
      */
       ...
       * @param properties {Map} The animation properties to set. Key / value pairs.
       */
      __P_355_8: function __P_355_8(action, properties) {
      ...
      show: function show(properties) {
        this.__P_355_8("visible", properties);
      },
      ...
      hide: function hide(properties) {
        this.__P_355_8("hidden", properties);
      },
      ...
      exclude: function exclude(properties) {
        this.__P_355_8("excluded", properties);
      },
      ...
      */
      ...
      getContentElement: function getContentElement() {
        if (!this.__P_355_5) {
          this.__P_355_5 = this._getContentElement();
        }

        return this.__P_355_5;
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_355_6 = this.__P_355_4 = this.__P_355_5 = null;

      if (this.__P_355_7) {
        this.__P_355_7.dispose();
      }
...
//# sourceMappingURL=Widget.js.map?dt=1650119482924