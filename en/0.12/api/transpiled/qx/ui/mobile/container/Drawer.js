  ...
  qx.Class.define("qx.ui.mobile.container.Drawer", {
    ...
    */
    ...
    construct: function construct(parent, layout) {
      ...
      this.__P_336_0 = this.getLayoutParent();

      this.__P_336_0.addCssClass("drawer-parent");

      this.__P_336_0.addListener("swipe", this._onParentSwipe, this);

      this.__P_336_0.addListener("pointerdown", this._onParentPointerDown, this);
    ...
    */
    members: {
      ...
      _applyPositionZ: function _applyPositionZ(value, old) {
        ...
        if (this.__P_336_0) {
          this.__P_336_0.setTranslateX(0);

          this.__P_336_0.setTranslateY(0);
        }
      },
      // property apply
       ...
       */
      show: function show() {
        if (!this.isHidden() || this.__P_336_3 === true) {
          return;
        }

        this.__P_336_3 = true; // Make drawer visible before "changeVisibility" event is fired, after transition.

        this._setStyle("visibility", "visible");

        this.__P_336_0.addCssClass("blocked");

        if (this.getPositionZ() == "below") {
          if (this.getOrientation() == "left") {
            this.__P_336_0.setTranslateX(this.getSize());
          } else if (this.getOrientation() == "right") {
            this.__P_336_0.setTranslateX(-this.getSize());
          } else if (this.getOrientation() == "top") {
            this.__P_336_0.setTranslateY(this.getSize());
      ...
      hide: function hide() {
        ...
        if (this.getTransitionDuration() > 0) {
          ...
          var listenerId = qx.bom.Element.addListener(transitionTarget, "transitionEnd", function (evt) {
            ...
            this.__P_336_0.removeCssClass("blocked");
      ...
      */
      ...
      _onParentPointerDown: function _onParentPointerDown(evt) {
        this.__P_336_1 = [evt.getViewportLeft(), evt.getViewportTop()];
        ...
        if (isShown && this.isHideOnParentTap()) {
          ...
          if (orientation == "left" && this.__P_336_1[0] > location.right || orientation == "top" && this.__P_336_1[1] > location.bottom || orientation == "bottom" && this.__P_336_1[1] < location.top || orientation == "right" && this.__P_336_1[0] < location.left) {
      ...
      _onParentSwipe: function _onParentSwipe(evt) {
        ...
        if (isHidden) {
          ...
          if (direction == "right" && this.getOrientation() == "left" && this.__P_336_1[0] < location.right + this.getTapOffset() && this.__P_336_1[0] > location.right || direction == "left" && this.getOrientation() == "right" && this.__P_336_1[0] > location.left - this.getTapOffset() && this.__P_336_1[0] < location.left || direction == "down" && this.getOrientation() == "top" && this.__P_336_1[1] < this.getTapOffset() + location.bottom && this.__P_336_1[1] > location.bottom || direction == "up" && this.getOrientation() == "bottom" && this.__P_336_1[1] > location.top - this.getTapOffset() && this.__P_336_1[1] < location.top) {
            this.show();
          }
        }
      }
    ...
    destruct: function destruct() {
      ...
      this.__P_336_0.removeListener("swipe", this._onParentSwipe, this);

      this.__P_336_0.removeListener("pointerdown", this._onParentPointerDown, this);

      qx.util.DisposeUtil.destroyContainer(this);
      this.__P_336_1 = this.__P_336_0 = this.__P_336_2 = null;
    }
  });
  qx.ui.mobile.container.Drawer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Drawer.js.map?dt=1619883164899