  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.list.List", {
    ...
    construct: function construct(model) {
      ...
      this.__P_329_0 = new qx.data.Array();
      this.initGroups(this.__P_329_0);
    ...
    members: {
      ...
      _init: function _init() {
        ...
        this.__P_329_2 = [];
        this.__P_329_3 = {};
        this.__P_329_4 = false;
        this.__P_329_5 = false;
        this.__P_329_6 = false;
      ...
      */
      ...
      _lookupGroup: function _lookupGroup(row) {
        return this.__P_329_2.indexOf(row);
      },
      ...
      _reverseLookup: function _reverseLookup(index) {
        ...
        return this.__P_329_1.indexOf(index);
      },
      ...
      */
      ...
      _onLayerUpdated: function _onLayerUpdated() {
        ...
        if (this.__P_329_7 === null) {
          this.__P_329_7 = new qx.util.DeferredCall(function () {
            this._setRowItemSize();
          }, this);
        }

        this.__P_329_7.schedule();
      },
      ...
      */
       ...
       */
      __P_329_10: function __P_329_10() {
        this.getPane().getRowConfig().setItemCount(this.__P_329_1.length);
        this.getPane().fullUpdate();
      },
      ...
      __P_329_9: function __P_329_9() {
        ...
        if (gh) {
          for (var i = 0, l = this.__P_329_1.length; i < l; ++i) {
            if (this.__P_329_1[i] == -1) {
              rc.setItemSize(i, gh);
            }
          }
        }
      ...
      _runDelegateSorter: function _runDelegateSorter(model) {
        ...
        if (sorter != null) {
          this.__P_329_1.sort(function (a, b) {
      ...
      _runDelegateGroup: function _runDelegateGroup(model) {
        ...
        if (groupMethod != null) {
          for (var i = 0, l = this.__P_329_1.length; i < l; ++i) {
            var index = this.__P_329_1[i];
            var item = this.getModel().getItem(index);
            var group = groupMethod(item);

            this.__P_329_11(group, index);
          }

          this.__P_329_1 = this.__P_329_12();
        }
      },
       ...
       */
      __P_329_11: function __P_329_11(group, index) {
        ...
        var name = this.__P_329_13(group);

        if (this.__P_329_3[name] == null) {
          this.__P_329_3[name] = [];
        ...
        this.__P_329_3[name].push(index);
      },
       ...
       */
      __P_329_12: function __P_329_12() {
        this.__P_329_14();
        ...
        for (var i = 0; i < groups.getLength(); i++) {
          ...
          this.__P_329_2.push(row);

          row++;

          var key = this.__P_329_13(group);

          var groupMembers = this.__P_329_3[key];
       ...
       */
      __P_329_13: function __P_329_13(group) {
        var name = null;
       ...
       */
      __P_329_14: function __P_329_14() {
        if (this.__P_329_5 && this.__P_329_6 || this.__P_329_5 && this.__P_329_4) {
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_329_7");
      ...
      this._background = this._provider = this._layer = this.__P_329_1 = this.__P_329_2 = this.__P_329_3 = null;

      if (this.__P_329_0) {
        this.__P_329_0.dispose();
      }
    }
  });
...
//# sourceMappingURL=List.js.map?dt=1603737140581