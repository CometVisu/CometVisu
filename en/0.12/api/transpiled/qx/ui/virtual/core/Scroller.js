  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Scroller", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__P_442_0 = new qx.ui.virtual.core.Pane(rowCount, columnCount, cellHeight, cellWidth);

      this.__P_442_0.addListener("update", this._computeScrollbars, this);

      this.__P_442_0.addListener("scrollX", this._onScrollPaneX, this);

      this.__P_442_0.addListener("scrollY", this._onScrollPaneY, this);

      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this._add(this.__P_442_0, {
          edge: 0
        });
      } else {
        this._add(this.__P_442_0, {
    ...
    members: {
      ...
      */
      ...
      _onScrollBarX: function _onScrollBarX(e) {
        this.__P_442_0.setScrollX(e.getData());
      },
      // overridden
      _onScrollBarY: function _onScrollBarY(e) {
        this.__P_442_0.setScrollY(e.getData());
      }
    },
...
//# sourceMappingURL=Scroller.js.map?dt=1731946696112