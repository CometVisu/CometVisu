  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Scroller", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__P_434_0 = new qx.ui.virtual.core.Pane(rowCount, columnCount, cellHeight, cellWidth);

      this.__P_434_0.addListener("update", this._computeScrollbars, this);

      this.__P_434_0.addListener("scrollX", this._onScrollPaneX, this);

      this.__P_434_0.addListener("scrollY", this._onScrollPaneY, this);
    ...
    members: {
      ...
      */
      ...
      _onScrollBarX: function _onScrollBarX(e) {
        this.__P_434_0.setScrollX(e.getData());
      },
      // overridden
      _onScrollBarY: function _onScrollBarY(e) {
        this.__P_434_0.setScrollY(e.getData());
      }
    },
    destruct: function destruct() {
      this.__P_434_0.dispose();
...
//# sourceMappingURL=Scroller.js.map?dt=1603737148121