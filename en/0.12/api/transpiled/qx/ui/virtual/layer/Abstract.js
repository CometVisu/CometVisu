  ...
  qx.Class.define("qx.ui.virtual.layer.Abstract", {
    ...
    */
    members: {
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_443_0.fullUpdate || this.__P_443_0.updateLayerWindow && this.__P_443_0.updateLayerData) {
          this._fullUpdate.apply(this, this.__P_443_1);
        } else if (this.__P_443_0.updateLayerWindow) {
          this._updateLayerWindow.apply(this, this.__P_443_1);
        } else if (this.__P_443_0.updateLayerData && this.__P_443_4) {
          this._updateLayerData();
        }

        if (this.__P_443_0.fullUpdate || this.__P_443_0.updateLayerWindow) {
          var args = this.__P_443_1;
          this.__P_443_2 = args[0];
          this.__P_443_3 = args[1];
          this.__P_443_4 = args[2];
          this.__P_443_5 = args[3];
        }
      ...
      _updateLayerData: function _updateLayerData() {
        this._fullUpdate(this.__P_443_2, this.__P_443_3, this.__P_443_4, this.__P_443_5);
      },
    ...
    */
    destruct: function destruct() {
      this.__P_443_0 = this.__P_443_1 = this.__P_443_4 = this.__P_443_5 = null;
    }
  });
  qx.ui.virtual.layer.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1656748415866