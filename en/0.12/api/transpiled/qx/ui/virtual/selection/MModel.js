  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_443_0 = new qx.data.Array();

      this.__P_443_0.addListener("change", this._onChangeSelection, this);

      this._applySelection(this.__P_443_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
       ...
       */
      __P_443_5: function __P_443_5(newSelection) {
        var selection = this.getSelection();
...
//# sourceMappingURL=MModel.js.map?dt=1603737148591