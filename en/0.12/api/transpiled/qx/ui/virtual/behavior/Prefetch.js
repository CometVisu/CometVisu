  ...
  qx.Class.define("qx.ui.virtual.behavior.Prefetch", {
    ...
    */
    ...
    construct: function construct(scroller, settings) {
      ...
      this.__P_425_0 = new qx.event.Timer(this.getInterval());

      this.__P_425_0.addListener("interval", this._onInterval, this);
    ...
    */
    members: {
      ...
      setPrefetchX: function setPrefetchX(minLeft, maxLeft, minRight, maxRight) {
        this.__P_425_1 = [minLeft, maxLeft, minRight, maxRight];
      },
      ...
      setPrefetchY: function setPrefetchY(minAbove, maxAbove, minBelow, maxBelow) {
        this.__P_425_2 = [minAbove, maxAbove, minBelow, maxBelow];
      },
      ...
      _applyScroller: function _applyScroller(value, old) {
        if (old) {
          if (this.__P_425_3) {
            old.getChildControl("scrollbar-x").removeListenerById(this.__P_425_3);
          }

          if (this.__P_425_4) {
            old.getChildControl("scrollbar-y").removeListenerById(this.__P_425_4);
          }
        }
        ...
        if (value) {
          if (!value.getContentElement().getDomElement()) {
            ...
            value.addListenerOnce("appear", this.__P_425_0.start, this.__P_425_0);
          } else {
            this.__P_425_0.restart();
          } //        if (value.hasChildControl("scrollbar-x"))
          //        {


          this.__P_425_3 = value.getChildControl("scrollbar-x").addListener("scroll", this.__P_425_0.restart, this.__P_425_0); //        }
          //        if (value.hasChildControl("scrollbar-y"))
          //        {

          this.__P_425_4 = value.getChildControl("scrollbar-y").addListener("scroll", this.__P_425_0.restart, this.__P_425_0); //        }
        } else {
          this.__P_425_0.stop();
        }
      },
      ...
      _applyInterval: function _applyInterval(value, old) {
        this.__P_425_0.setInterval(value);
      }
    },
    ...
    destruct: function destruct() {
      ...
      this.__P_425_1 = this.__P_425_2 = null;
...
//# sourceMappingURL=Prefetch.js.map?dt=1592777107287