  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__P_430_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__P_430_1 = {};
      this.__P_430_2 = {};
      this.__P_430_3 = {};
      this.__P_430_4 = {};
    ...
    */
    members: {
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        ...
        if (this.__P_430_10) {
          store = this.__P_430_2;
        } else {
          store = this.__P_430_1;
        }
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        if (this.__P_430_10) {
          var paddingStore = this.__P_430_4;
        } else {
          paddingStore = this.__P_430_3;
        }
      ...
      */
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__P_430_0.getCssClass(this.__P_430_9) || "";
       ...
       */
      __P_430_11: function __P_430_11(states) {
        ...
        if (this.__P_430_9 == statesKey) {
          return;
        }

        this.__P_430_9 = statesKey;
        var themeStyles = this.__P_430_5[this.__P_430_9];

        if (!themeStyles) {
          this.__P_430_12();

          this.__P_430_13(states);

          this.__P_430_14(states);

          this.__P_430_15();

          this.__P_430_5[this.__P_430_9] = 1;
        }
       ...
       */
      __P_430_12: function __P_430_12() {
        var PropertyUtil = qx.util.PropertyUtil;
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __P_430_13: function __P_430_13(states) {
        this.__P_430_2 = {};
        ...
        this.__P_430_10 = false;
      },

      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __P_430_14: function __P_430_14() {
        var styleString = Object.values(this.__P_430_2).join(";");

        this.__P_430_0.computeClassForStyles(this.__P_430_9, styleString);
      },
      ...
      __P_430_15: function __P_430_15() {
        ...
        this.__P_430_6[this.__P_430_9] = themeValues;
      },

      /**
       * Apply the themed values to the properties
       */
      __P_430_16: function __P_430_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__P_430_6[this.__P_430_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__P_430_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__P_430_3;
        var theme = this.__P_430_4;
    ...
    destruct: function destruct() {
      this.__P_430_0 = this.__P_430_1 = this.__P_430_2 = this.__P_430_3 = this.__P_430_4 = this.__P_430_5 = this.__P_430_6 = this.__P_430_8 = null;
    }
  });
  qx.ui.virtual.cell.Cell.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Cell.js.map?dt=1604955491265