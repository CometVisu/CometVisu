  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_425_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_425_0.pop();
        }
      },
       ...
       */
      __P_425_1: function __P_425_1() {
        var widget = this.__P_425_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1614551296655