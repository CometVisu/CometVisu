  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_428_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_428_0.pop();
        }
      },
      ...
      __P_428_1: function __P_428_1() {
        var widget = this.__P_428_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1604955491200