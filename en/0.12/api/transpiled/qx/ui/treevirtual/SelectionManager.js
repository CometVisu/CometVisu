  ...
  qx.Class.define("qx.ui.treevirtual.SelectionManager", {
    ...
    members: {
      ...
      _handleSelectEvent: function _handleSelectEvent(index, evt) {
        ...
        var bNoSelect = handleButtonClick(this.__P_420_0, index, evt); // If we haven't been told not to do the selection...
...
//# sourceMappingURL=SelectionManager.js.map?dt=1613588123396