  ...
  qx.Class.define("qx.ui.form.SelectBox", {
    ...
    */
    construct: function construct() {
      ...
      this.addListener("changeSelection", this.__P_311_0, this);
    },
      ...
      */
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        if (iden == "Enter" || iden == "Space") {
          ...
          if (this.__P_311_1) {
            this.setSelection([this.__P_311_1]);
            this.__P_311_1 = null;
          }
      ...
      _onListChangeSelection: function _onListChangeSelection(e) {
        ...
        if (old && old.length > 0) {
          old[0].removeListener("changeIcon", this.__P_311_2, this);
          old[0].removeListener("changeLabel", this.__P_311_3, this);
        }
        ...
        if (current.length > 0) {
          ...
          current[0].addListener("changeIcon", this.__P_311_2, this);
          current[0].addListener("changeLabel", this.__P_311_3, this);
        } else {
          this.resetSelection();
        }
      },
...
//# sourceMappingURL=SelectBox.js.map?dt=1604955482941