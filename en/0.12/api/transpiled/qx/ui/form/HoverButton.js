  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.HoverButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_300_0 = new qx.event.AcceleratingTimer();

      this.__P_300_0.addListener("interval", this._onInterval, this);
    },
    properties: {
      // overridden
      appearance: {
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_300_0");
    }
  });
  qx.ui.form.HoverButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HoverButton.js.map?dt=1614015658072