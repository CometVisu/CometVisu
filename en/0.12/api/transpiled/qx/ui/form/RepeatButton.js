  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_317_0 = new qx.event.AcceleratingTimer();

      this.__P_317_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__P_317_1) {
            this.execute();
          }
        }
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_317_0");
    }
  });
  qx.ui.form.RepeatButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RepeatButton.js.map?dt=1650269559019