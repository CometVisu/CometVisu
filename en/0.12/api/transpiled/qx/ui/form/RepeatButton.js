  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_308_0 = new qx.event.AcceleratingTimer();

      this.__P_308_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__P_308_1) {
            this.execute();
          }
        }
...
//# sourceMappingURL=RepeatButton.js.map?dt=1592777097380