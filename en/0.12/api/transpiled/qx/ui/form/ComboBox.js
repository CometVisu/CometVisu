    ...
    members: {
      ...
      */
      ...
      _setPreselectedItem: function _setPreselectedItem() {
        if (this.__P_299_0) {
          var label = this.__P_299_0.getLabel();

          if (this.getFormat() != null) {
            label = this.getFormat().call(this, this.__P_299_0);
...
//# sourceMappingURL=ComboBox.js.map?dt=1592777096587