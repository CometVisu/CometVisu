  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.VirtualTree", {
    ...
    members: {
      ...
      */
      ...
      openNodeAndParents: function openNodeAndParents(node) {
        this.__P_418_7(this.getModel(), node);

        this.buildLookupTable();
      },
      // Interface implementation
      closeNode: function closeNode(node) {
        if (this.__P_418_1.includes(node)) {
          qx.lang.Array.remove(this.__P_418_1, node);
      ...
      isNodeOpen: function isNodeOpen(node) {
        return this.__P_418_1.includes(node);
      },
      ...
      openViaModelChanges: function openViaModelChanges(openProperty) {
        ...
        this.__P_418_5 = openProperty; // if no name is provided, just remove any prior open-close controller
      ...
      */
      ...
      _init: function _init() {
        this.__P_418_0 = new qx.data.Array();
        this.__P_418_1 = [];
        this.__P_418_2 = [];
      ...
      _getDataFromRow: function _getDataFromRow(row) {
        return this.__P_418_0.getItem(row);
      },
      ...
      */
      ...
      _onChangeBubble: function _onChangeBubble(event) {
        ...
        if (propertyName.startsWith(this.getChildProperty())) {
          ...
          if (this.__P_418_0.indexOf(item) != -1) {
            this.__P_418_8();
          }
        }
      },
      ...
      _onUpdated: function _onUpdated(event) {
        if (this.__P_418_3 == null) {
          this.__P_418_3 = new qx.util.DeferredCall(function () {
            qx.ui.core.queue.Widget.add(this);
          }, this);
        }

        this.__P_418_3.schedule();
      },
      ...
      _onOpen: function _onOpen(event) {
        ...
        var item = this.__P_418_0.getItem(row);
      ...
      */
      ...
      _beforeApplySelection: function _beforeApplySelection(newSelection) {
        if (newSelection.length === 0 && this.getSelectionMode() === "one") {
          var visibleParent = this.__P_418_9();
      ...
      _afterApplySelection: function _afterApplySelection() {
        ...
        if (selection.getLength() > 0 && this.getSelectionMode() === "one") {
          this.__P_418_10(selection.getItem(0));
        } else {
          this.__P_418_4 = [];
        }
      },
      ...
      */
      ...
      buildLookupTable: function buildLookupTable() {
        ...
        if (root != null) {
          if (!this.isHideRoot()) {
            ...
            this.__P_418_2.push(nestedLevel);
          }

          if (this.isNodeOpen(root)) {
            var visibleChildren = this.__P_418_11(root, nestedLevel);

            lookupTable = lookupTable.concat(visibleChildren);
          }
        }

        if (!qx.lang.Array.equals(this.__P_418_0.toArray(), lookupTable)) {
          this._provider.removeBindings();

          this.__P_418_0.removeAll();

          this.__P_418_0.append(lookupTable);
       ...
       */
      __P_418_11: function __P_418_11(node, nestedLevel) {
        var visible = [];
        nestedLevel++;
        ...
        for (var i = 0; i < children.getLength(); i++) {
          ...
          if (this.isNode(child)) {
            ...
            if (this.isNodeOpen(child)) {
              var visibleChildren = this.__P_418_11(child, nestedLevel);
       ...
       */
      __P_418_6: function __P_418_6(node) {
        if (!this.__P_418_1.includes(node)) {
          this.__P_418_1.push(node);
       ...
       */
      __P_418_7: function __P_418_7(startNode, targetNode) {
        if (startNode === targetNode) {
          this.__P_418_6(targetNode);
        ...
        for (var i = 0; i < children.getLength(); i++) {
          ...
          var result = this.__P_418_7(child, targetNode);

          if (result === true) {
            this.__P_418_6(child);
       ...
       */
      __P_418_12: function __P_418_12() {
        this.getPane().getRowConfig().setItemCount(this.__P_418_0.getLength());
      ...
      getParent: function getParent(item) {
        var index = this.__P_418_0.indexOf(item);

        if (index < 0) {
          return null;
        }

        var level = this.__P_418_2[index];

        while (index > 0) {
          index--;
          var levelBefore = this.__P_418_2[index];

          if (levelBefore < level) {
            return this.__P_418_0.getItem(index);
          }
        }
       ...
       */
      __P_418_10: function __P_418_10(item) {
        this.__P_418_4 = [];
        var parent = this.getParent(item);

        while (parent != null) {
          this.__P_418_4.unshift(parent);
    ...
    destruct: function destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown && this.__P_418_3 != null) {
        this.__P_418_3.cancel();

        this.__P_418_3.dispose();
      }
      ...
      this.__P_418_0.dispose();

      this._layer = this._provider = this.__P_418_0 = this.__P_418_1 = this.__P_418_3 = null;
    }
  });
  qx.ui.tree.VirtualTree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VirtualTree.js.map?dt=1604955490436