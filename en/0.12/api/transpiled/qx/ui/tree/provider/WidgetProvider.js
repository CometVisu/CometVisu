    ...
    members: {
      ...
      */
      ...
      getCellWidget: function getCellWidget(row, column) {
        ...
        widget.addListener("changeOpen", this.__P_422_0, this);
      ...
      poolCellWidget: function poolCellWidget(widget) {
        widget.removeListener("changeOpen", this.__P_422_0, this);
      ...
      */
       ...
       */
      __P_422_0: function __P_422_0(event) {
...
//# sourceMappingURL=WidgetProvider.js.map?dt=1604955490729