  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.core.AbstractTreeItem", {
    ...
    members: {
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        if (!this.__P_417_1) {
          this.__P_417_1 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
      ...
      */
      ...
      hasChildren: function hasChildren() {
        return this.__P_417_0 ? this.__P_417_0.length > 0 : false;
      },
      ...
      addAt: function addAt(treeItem, index) {
        if (index == this.__P_417_0.length) {
          this.add(treeItem);
          return;
        }
        ...
        treeItem.setParent(this);
        var hasChildren = this.hasChildren();
        var nextItem = this.__P_417_0[index];
        ...
        qx.lang.Array.insertAt(this.__P_417_0, treeItem, index);
      ...
      addBefore: function addBefore(treeItem, before) {
        ...
        this.addAt(treeItem, this.__P_417_0.indexOf(before));
      },
      ...
      addAfter: function addAfter(treeItem, after) {
        ...
        this.addAt(treeItem, this.__P_417_0.indexOf(after) + 1);
      },
      ...
      remove: function remove(varargs) {
        for (var i = 0, l = arguments.length; i < l; i++) {
          ...
          if (this.__P_417_0.indexOf(treeItem) == -1) {
          ...
          qx.lang.Array.remove(this.__P_417_0, treeItem);
      ...
      removeAll: function removeAll() {
        ...
        var children = this.__P_417_0.concat();

        for (var i = this.__P_417_0.length - 1; i >= 0; i--) {
          this.remove(this.__P_417_0[i]);
        }
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_417_1");
    }
  });
  qx.ui.tree.core.AbstractTreeItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractTreeItem.js.map?dt=1614107148319