  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.renderer.table.cell.Conditional", {
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.__P_388_0 = ["==", "!=", ">", "<", ">=", "<="];
      this.__P_388_1 = ["between", "!between"];
      this.__P_388_2 = [];
      this.__P_388_3 = align || "";
      this.__P_388_4 = color || "";
      this.__P_388_5 = style || "";
      this.__P_388_6 = weight || "";
    },
    members: {
      __P_388_0: null,
      __P_388_1: null,
       ...
       */
      __P_388_7: function __P_388_7(condition, style) {
        if (condition.align) {
      ...
      addNumericCondition: function addNumericCondition(condition, value1, align, color, style, weight, target) {
        if (!this.__P_388_0.includes(condition) || value1 == null) {
      ...
      addBetweenCondition: function addBetweenCondition(condition, value1, value2, align, color, style, weight, target) {
        if (!this.__P_388_1.includes(condition) || value1 == null || value2 == null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__P_388_3,
          "color": this.__P_388_4,
          "font-style": this.__P_388_5,
          "font-weight": this.__P_388_6
        };

        for (i = 0; i < this.__P_388_2.length; i++) {
          var test = this.__P_388_2[i];
          bTestPassed = false;

          if (this.__P_388_0.includes(test.condition)) {
            if (test.target == null) {
          ...
          } else if (this.__P_388_1.includes(test.condition)) {
            if (test.target == null) {
              compareValue = cellInfo.cellData;
            } else {
              compareValue = cellInfo.element.data[test.target];
    ...
    destruct: function destruct() {
      this.__P_388_0 = this.__P_388_1 = this.__P_388_2 = null;
    }
  });
  qx.ui.progressive.renderer.table.cell.Conditional.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Conditional.js.map?dt=1648713985926