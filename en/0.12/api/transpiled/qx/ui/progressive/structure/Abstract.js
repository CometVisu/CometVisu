  ...
  qx.Class.define("qx.ui.progressive.structure.Abstract", {
    ...
    construct: function construct(pane) {
      ...
      if (!pane) {
        ...
        this.__P_380_1 = this.__P_380_0;
      } else {
        this.__P_380_0 = null;
        this.__P_380_1 = pane;
      }

      this.__P_380_1.getContentElement().setStyle("overflowY", "auto");
    },
    members: {
      __P_380_0: null,
      __P_380_1: null,
    ...
    destruct: function destruct() {
      if (this.__P_380_0) {
        this.__P_380_0.dispose();
      }

      this.__P_380_0 = this.__P_380_1 = null;
    }
  });
  qx.ui.progressive.structure.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1613588119208