  ...
  qx.Class.define("qx.ui.root.Inline", {
    ...
    */
    ...
    construct: function construct(el, dynamicX, dynamicY) {
      ...
      this.__P_384_0 = el; // Avoid any problems with dynamic resizing

      el.style.overflow = "hidden"; // Avoid any problems with broken layout

      el.style.textAlign = "left";
      this.__P_384_1 = dynamicX || false;
      this.__P_384_2 = dynamicY || false;
    ...
    */
    members: {
       ...
       */
      __P_384_3: function __P_384_3() {
        if (this.__P_384_1 || this.__P_384_2) {
          // Check the DOM element for an usable width and height
          var elementDimensions = qx.bom.element.Dimension.getSize(this.__P_384_0);

          if (this.__P_384_1 && elementDimensions.width < 1) {
            throw new Error("The root element " + this.__P_384_0 + " of " + this + " needs a width when its width size should be used!");
          }

          if (this.__P_384_2) {
            if (elementDimensions.height < 1) {
              throw new Error("The root element " + this.__P_384_0 + " of " + this + " needs a height when its height size should be used!");
            } // check for implicit height. Set the height explicit to prevent that
            // the element grows indefinitely


            if (elementDimensions.height >= 1 && qx.bom.element.Style.get(this.__P_384_0, "height", 3) == "") {
              qx.bom.element.Style.set(this.__P_384_0, "height", elementDimensions.height + "px");
            }
          }

          qx.event.Registration.addListener(this.__P_384_0, "resize", this._onResize, this);
        }
      },
      // overridden
      _createContentElement: function _createContentElement() {
        var el = this.__P_384_0;
      ...
      _onResize: function _onResize(e) {
        ...
        if (data.oldWidth !== data.width && this.__P_384_1 || data.oldHeight !== data.height && this.__P_384_2) {
      ...
      _computeSizeHint: function _computeSizeHint() {
        var dynX = this.__P_384_1;
        var dynY = this.__P_384_2;
        ...
        if (dynX) {
          var width = Dimension.getContentWidth(this.__P_384_0);
          hint.width = width;
          hint.minWidth = width;
          hint.maxWidth = width;
        }
        ...
        if (dynY) {
          var height = Dimension.getContentHeight(this.__P_384_0);
          hint.height = height;
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(this.__P_384_0, "resize", this._onResize, this);
      this.__P_384_0 = null;
    }
  });
...
//# sourceMappingURL=Inline.js.map?dt=1613588119382