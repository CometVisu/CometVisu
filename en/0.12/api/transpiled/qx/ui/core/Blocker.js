  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__P_261_0, this);
      widget.addListener("move", this.__P_261_0, this);
      widget.addListener("disappear", this.__P_261_1, this);
    ...
    */
    members: {
       ...
       */
      __P_261_0: function __P_261_0(e) {
        var data = e.getData();
       ...
       */
      __P_261_1: function __P_261_1() {
        if (this.isBlocked()) {
          this.getBlockerElement().getParent().remove(this.getBlockerElement());

          this._widget.addListenerOnce("appear", this.__P_261_8, this);
        }
      },
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_261_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_261_9("opacity", value);
      },
       ...
       */
      __P_261_9: function __P_261_9(key, value) {
        var blockers = [];
        this.__P_261_4 && blockers.push(this.__P_261_4);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_261_2.push(activeWidget);

        this.__P_261_3.push(focusedWidget);
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_261_3.length;

        if (focusElementsLength > 0) {
          widget = this.__P_261_3.pop();
        ...
        var activeElementsLength = this.__P_261_2.length;

        if (activeElementsLength > 0) {
          widget = this.__P_261_2.pop();
       ...
       */
      __P_261_10: function __P_261_10() {
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_261_4) {
          this.__P_261_4 = this.__P_261_10();

          this.__P_261_4.setStyle("zIndex", 15);
          ...
          widget.getContentElement().add(this.__P_261_4);

          this.__P_261_4.exclude();
        }

        return this.__P_261_4;
      },
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_261_7) {
            this.__P_261_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
        ...
        if (this.__P_261_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__P_261_11, this);
          blocker.addListener("keypress", this.__P_261_12, this);
          blocker.addListener("keydown", this.__P_261_12, this);
          blocker.addListener("keyup", this.__P_261_12, this);
      ...
      unblock: function unblock() {
        if (this.__P_261_7) {
          this._widget.removeListenerById(this.__P_261_7);
       ...
       */
      __P_261_13: function __P_261_13() {
        this._restoreActiveWidget();

        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__P_261_11, this);
        blocker.removeListener("keypress", this.__P_261_12, this);
        blocker.removeListener("keydown", this.__P_261_12, this);
        blocker.removeListener("keyup", this.__P_261_12, this);
        blocker.exclude();
       ...
       */
      __P_261_12: function __P_261_12(e) {
       ...
       */
      __P_261_11: function __P_261_11() {
        //
    ...
    */
    destruct: function destruct() {
      ...
      this._widget.removeListener("resize", this.__P_261_0, this);

      this._widget.removeListener("move", this.__P_261_0, this);

      this._widget.removeListener("appear", this.__P_261_8, this);

      this._widget.removeListener("disappear", this.__P_261_1, this);

      if (this.__P_261_7) {
        this._widget.removeListenerById(this.__P_261_7);
      }

      this._disposeObjects("__P_261_4", "__P_261_6");

      this.__P_261_2 = this.__P_261_3 = this._widget = null;
    }
  });
  qx.ui.core.Blocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Blocker.js.map?dt=1604955479743