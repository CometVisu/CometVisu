  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_272_5(); // Bind target and livupdate to placeToWidget


          this.__P_272_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_272_2); // Remove the listener when the element disappears.

          this.__P_272_4 = function () {
            this.__P_272_5();
          };

          this.addListener("disappear", this.__P_272_4, this);
        }
       ...
       */
      __P_272_5: function __P_272_5() {
        if (this.__P_272_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_272_2);
          this.__P_272_2 = null;
        }

        if (this.__P_272_4) {
          this.removeListener("disappear", this.__P_272_4, this);
          this.__P_272_4 = null;
        }
      },
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_272_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_272_2); // Remove the listener when the element disappears.
       ...
       *    first argument
       */
      __P_272_6: function __P_272_6(callback) {
        var size = null;
...
//# sourceMappingURL=MPlacement.js.map?dt=1604955480287