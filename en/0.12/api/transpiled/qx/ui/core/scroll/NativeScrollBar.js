  ...
  qx.Class.define("qx.ui.core.scroll.NativeScrollBar", {
    ...
    members: {
      ...
      _getScrollPaneElement: function _getScrollPaneElement() {
        if (!this.__P_281_1) {
          this.__P_281_1 = new qx.html.Element();
        }

        return this.__P_281_1;
      },
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        return {
          width: this.__P_281_0 ? 100 : scrollbarWidth,
          maxWidth: this.__P_281_0 ? null : scrollbarWidth,
          minWidth: this.__P_281_0 ? null : scrollbarWidth,
          height: this.__P_281_0 ? scrollbarWidth : 100,
          maxHeight: this.__P_281_0 ? scrollbarWidth : null,
          minHeight: this.__P_281_0 ? scrollbarWidth : null
        };
      },
      // overridden
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        var isHorizontal = this.__P_281_0 = value === "horizontal";
        this.set({
      ...
      _updateScrollBar: function _updateScrollBar() {
        var isHorizontal = this.__P_281_0;
      ...
      scrollTo: function scrollTo(position, duration) {
        ...
        if (duration) {
          ...
          this.__P_281_3 = new qx.bom.AnimationFrame();

          this.__P_281_3.on("frame", function (timePassed) {
            var newPos = parseInt(timePassed / duration * (position - from) + from);
            this.updatePosition(newPos);
          }, this);

          this.__P_281_3.on("end", function () {
            this.setPosition(Math.max(0, Math.min(this.getMaximum(), position)));
            this.__P_281_3 = null;
            this.fireEvent("scrollAnimationEnd");
          }, this);

          this.__P_281_3.startSequence(duration);
        } else {
      ...
      _onScroll: function _onScroll(e) {
        ...
        var position = this.__P_281_0 ? container.getScrollX() : container.getScrollY();
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_281_1");
    }
  });
  qx.ui.core.scroll.NativeScrollBar.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=NativeScrollBar.js.map?dt=1613588110685