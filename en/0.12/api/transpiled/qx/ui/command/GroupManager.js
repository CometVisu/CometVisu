  ...
  qx.Class.define("qx.ui.command.GroupManager", {
    ...
    members: {
      ...
      add: function add(group) {
        if (this.__P_256_0.includes(group)) {
          return false;
        }

        this.__P_256_0.push(group); // deactivate added group to prevent collusions
      ...
      remove: function remove(group) {
        var index = this.__P_256_0.indexOf(group);
      ...
      block: function block() {
        if (this.__P_256_1) {
          this.__P_256_1.setActive(false);
        }
      },
      ...
      _getGroup: function _getGroup(group) {
        ...
        return this.__P_256_0[index];
      }
    },
    destruct: function destruct() {
      this.__P_256_0 = this.__P_256_1 = null;
    }
  });
  qx.ui.command.GroupManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=GroupManager.js.map?dt=1604955479307