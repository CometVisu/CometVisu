  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.dev.unit.MMock", {
    construct: function construct() {
      var sinon = this.__P_154_0();

      this.__P_154_1();

      this.__P_154_2 = sinon.sandbox;
    },
    members: {
      __P_154_2: null,
      __P_154_3: null,
      ...
      */
      spy: function spy(function_or_object, method) {
        return this.__P_154_2.spy.apply(this.__P_154_2, arguments);
      },
      ...
      */
      stub: function stub(object, method) {
        return this.__P_154_2.stub.apply(this.__P_154_2, arguments);
      },
      ...
      */
      useFakeXMLHttpRequest: function useFakeXMLHttpRequest() {
        return this.__P_154_3 = this.__P_154_2.useFakeXMLHttpRequest();
      },
      ...
      */
      getRequests: function getRequests() {
        return this.__P_154_3.requests;
      },
      ...
      */
      useFakeServer: function useFakeServer() {
        return this.__P_154_3 = this.__P_154_2.useFakeServer();
      },
      ...
      */
      ...
      deepStub: function deepStub(object) {
        this.__P_154_4(object).forEach(function (prop) {
          this.__P_154_5(object, prop);
        }, this);
      ...
      shallowStub: function shallowStub(object, targetClazz, propsToExclude) {
        this.__P_154_4(object, targetClazz).forEach(function (prop) {
       ...
       */
      injectStub: function injectStub(object, property, customStub) {
      ...
      revealMock: function revealMock(object, property, customObject) {
        var source = customObject || this.__P_154_6(new object[property]());
       ...
       */
      __P_154_6: function __P_154_6(obj) {
       ...
       */
      __P_154_4: function __P_154_4(object, targetClazz) {
       ...
       */
      __P_154_5: function __P_154_5(object, prop) {
...
//# sourceMappingURL=MMock.js.map?dt=1614107129577