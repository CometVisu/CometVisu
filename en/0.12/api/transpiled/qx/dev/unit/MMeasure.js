  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.dev.unit.MMeasure", {
    members: {
       ...
       */
      measureIterations: function measureIterations(msg, prepare, callback, finalize, time) {
        this.measure(msg, function () {
          var i = 0;
          var testTime = 0;
       ...
       */
      log: function log(msg, iterations, ownTime, renderTime) {
...
//# sourceMappingURL=MMeasure.js.map?dt=1604955470941