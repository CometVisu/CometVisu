  ...
  qx.Bootstrap.define("qx.module.event.OrientationHandler", {
    statics: {
      ...
      register: function register(element) {
        ...
        if (!element.__P_241_0) {
          if (!element.$$emitter) {
            element.$$emitter = new qx.event.Emitter();
          }

          element.__P_241_0 = new qx.event.handler.OrientationCore(element, element.$$emitter);
        }
      },
...
//# sourceMappingURL=OrientationHandler.js.map?dt=1612700578798