  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.TextSelection", {
    statics: {
       ...
       * @attach {qxWeb}
       */
      __P_249_0: function __P_249_0(el) {
       ...
       * @attach {qxWeb}
       */
      __P_249_1: function __P_249_1(el) {
    ...
    members: {
      ...
      getTextSelection: function getTextSelection() {
        ...
        if (el) {
          if (!qx.module.TextSelection.__P_249_0(el)) {
            el = qx.module.TextSelection.__P_249_1(el);
          }
...
//# sourceMappingURL=TextSelection.js.map?dt=1643139868330