  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Annotation", {
    statics: {
       ...
       */
      __P_64_0: function __P_64_0(clazz, name, group, annoClass) {
       ...
       * @return {Object[]} the annotations, never null
       */
      __P_64_1: function __P_64_1(clazz, name, group, annoClass) {
        var result = [];
      ...
      getOwnClass: function getOwnClass(clazz, annoClass) {
        return this.__P_64_0(clazz, "@", null, annoClass);
      },
      ...
      getClass: function getClass(clazz, annoClass) {
        return this.__P_64_1(clazz, "@", null, annoClass);
      },
      ...
      getOwnConstructor: function getOwnConstructor(clazz, annoClass) {
        return this.__P_64_0(clazz, "@construct", null, annoClass);
      },
      ...
      getConstructor: function getConstructor(clazz, annoClass) {
        return this.__P_64_1(clazz, "@construct", null, annoClass);
      },
      ...
      getOwnDestructor: function getOwnDestructor(clazz, annoClass) {
        return this.__P_64_0(clazz, "@destruct", null, annoClass);
      },
      ...
      getDestructor: function getDestructor(clazz, annoClass) {
        return this.__P_64_1(clazz, "@destruct", null, annoClass);
      },
      ...
      getOwnMember: function getOwnMember(clazz, name, annoClass) {
        return this.__P_64_0(clazz, name, "members", annoClass);
      },
      ...
      getMember: function getMember(clazz, name, annoClass) {
        return this.__P_64_1(clazz, name, "members", annoClass);
      },
      ...
      getOwnProperty: function getOwnProperty(clazz, name, annoClass) {
        return this.__P_64_0(clazz, name, "properties", annoClass);
      },
      ...
      getProperty: function getProperty(clazz, name, annoClass) {
        return this.__P_64_1(clazz, name, "properties", annoClass);
      },
      ...
      getStatic: function getStatic(clazz, name, annoClass) {
        return this.__P_64_0(clazz, name, "statics", annoClass);
      }
    }
  });
...
//# sourceMappingURL=Annotation.js.map?dt=1674150458845