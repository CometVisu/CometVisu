  ...
  qx.Class.define("qxl.apiviewer.Viewer", {
    ...
    */
    construct: function construct() {
      ...
      this.add(this.__P_516_1());
      this.add(this.__P_516_2());
      ...
      var toggleView = this.__P_516_3(tree, this._searchView, legend);

      var mainFrame = this.__P_516_4();

      this.add(this.__P_516_5(toggleView, mainFrame), {
        flex: 1
      ...
      if (parsedUri.queryKey && parsedUri.queryKey.search) {
        ...
        this.__P_516_6.setSelection([this.__P_516_6.getChildren()[1]]);
      }
    },
    ...
    */
    members: {
       ...
       */
      __P_516_3: function __P_516_3(treeWidget, searchWidget, infoWidget) {
        ...
        this.__P_516_6.addListener("changeSelection", function (e) {
       ...
       */
      __P_516_2: function __P_516_2() {
        var toolbar = new qx.ui.toolbar.ToolBar();
        var part = new qx.ui.toolbar.Part();
        toolbar.add(part);
        this.__P_516_7 = part.toHashCode();
        ...
        this.__P_516_8 = new qx.ui.menu.Menu();
        chevron.setMenu(this.__P_516_8); // add the listener
      ...
      _getMenuItems: function _getMenuItems(toolbarPart) {
        ...
        if (toolbarPart.toHashCode() === this.__P_516_7) {
          var cachedItem = this.__P_516_0[toolbarPart.toHashCode()];

          if (!cachedItem) {
            cachedItem = new qx.ui.menu.Separator();

            this.__P_516_8.addAt(cachedItem, 0);

            this.__P_516_0[toolbarPart.toHashCode()] = cachedItem;
          }
        ...
        for (var i = partChildren.length - 1; i >= 0; i--) {
          ...
          cachedItem = this.__P_516_0[toolbarItem.toHashCode()];
          ...
          if (!cachedItem) {
            ...
            this.__P_516_0[toolbarItem.toHashCode()] = cachedItem;
          }
       ...
       */
      __P_516_9: function __P_516_9(toolbar, detailFrame) {
       ...
       */
      __P_516_5: function __P_516_5(leftWidget, rightWidget) {
    ...
    */
    destruct: function destruct() {
      this._classTreeNodeHash = this.__P_516_6 = null;
...
//# sourceMappingURL=Viewer.js.map?dt=1620070407388