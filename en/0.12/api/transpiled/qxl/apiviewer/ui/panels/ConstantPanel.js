  ...
  qx.Class.define("qxl.apiviewer.ui.panels.ConstantPanel", {
    ...
    members: {
      ...
      itemHasDetails: function itemHasDetails(node, currentClassDocNode) {
        return node.getSee().length > 0 || node.getErrors().length > 0 || qxl.apiviewer.ui.panels.InfoPanel.descriptionHasDetails(node) || this.__P_531_0(node);
      },
       ...
       */
      __P_531_0: function __P_531_0(node) {
       ...
       */
      __P_531_1: function __P_531_1(node) {
        if (this.__P_531_0(node)) {
...
//# sourceMappingURL=ConstantPanel.js.map?dt=1603737156561