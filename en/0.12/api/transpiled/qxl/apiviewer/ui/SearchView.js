  ...
  qx.Class.define("qxl.apiviewer.ui.SearchView", {
    ...
    members: {
      ...
      search: function search(term) {
        ...
        if (qx.lang.Object.getLength(this.apiindex) == 0) {
          ...
          this.__searchTerm = null; // Set search box value
      ...
      _showSearchForm: function _showSearchForm() {
        ...
        this.__table = table; // table.addListener("appear", this.__handleNote, this);
      ...
      __initNote: function __initNote(table) {
      ...
      __handleNote: function __handleNote(e) {
        if (this.__note) {
    ...
    */
    destruct: function destruct() {
      this.apiindex = this._table = this.__table = this._tableModel = this.__typeFilter = this.__typesIndex = this._selectionModel = null;
...
//# sourceMappingURL=SearchView.js.map?dt=1589123589014