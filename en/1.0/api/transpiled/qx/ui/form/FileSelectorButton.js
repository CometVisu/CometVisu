  ...
  qx.Class.define("qx.ui.form.FileSelectorButton", {
    ...
    members: {
      ...
      _applyAttribute: function _applyAttribute(value, old, attr) {
        ...
        this.__P_585_0.setAttribute(attr, value);
      },
      /**
       * @param {Boolean} value
       * @return {Boolean}
      ...
      setEnabled: function setEnabled(value) {
        this.__P_585_0.setEnabled(value);
      ...
      _createContentElement: function _createContentElement() {
        ...
        var input = this.__P_585_0 = new qx.html.Input("file", null, {
          id: id
        });
...
//# sourceMappingURL=FileSelectorButton.js.map?dt=1782705798271