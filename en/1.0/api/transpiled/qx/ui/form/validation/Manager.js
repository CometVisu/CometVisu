  ...
  qx.Class.define("qx.ui.form.validation.Manager", {
    ...
    members: {
      ...
      add: function add(formItem, validator, context) {
        ...
        if (!this.__P_606_4(formItem)) {
          throw new Error("Added widget not supported.");
        }
        // check for the data type
        if (this.__P_606_5(formItem) && !formItem.getValue) {
      ...
      getItems: function getItems() {
        var items = [];
        for (var i = 0; i < this.__P_606_0.length; i++) {
          items.push(this.__P_606_0[i].item);
        }
        return items;
      },
      /**
      ...
      validate: function validate() {
        var valid = true;
        this.__P_606_3 = true; // collaboration of all synchronous validations
        var items = [];

        // check all validators for the added form items
        for (var i = 0; i < this.__P_606_0.length; i++) {
          var formItem = this.__P_606_0[i].item;
          var validator = this.__P_606_0[i].validator;
          ...
          if (validator == null) {
            ...
            this.__P_606_3 = validatorResult && this.__P_606_3;
            continue;
          }
          var validatorResult = this._validateItem(this.__P_606_0[i], formItem.getValue());
        ...
        var formValid = this.__P_606_6(items);
        if (qx.lang.Type.isBoolean(formValid)) {
          this.__P_606_3 = formValid && this.__P_606_3;
        }
        valid = formValid && valid;
        this._setValid(valid);
        if (qx.lang.Object.isEmpty(this.__P_606_1)) {
      ...
      _validateRequired: function _validateRequired(formItem) {
        if (formItem.getRequired()) {
          ...
          if (this.__P_606_5(formItem)) {
            validatorResult = !!formItem.getSelection()[0];
          } else if (this.__P_606_7(formItem)) {
      ...
      _validateItem: function _validateItem(dataEntry, value) {
        ...
        if (this.__P_606_8(validator)) {
          // used to check if all async validations are done
          this.__P_606_1[formItem.toHashCode()] = null;
       ...
       */
      __P_606_6: function __P_606_6(items) {
        ...
        if (this.__P_606_8(formValidator)) {
          this.__P_606_1[this.toHashCode()] = null;
       ...
       */
      __P_606_8: function __P_606_8(validator) {
        var async = false;
       ...
       *   necessary interface.
       */
      __P_606_4: function __P_606_4(formItem) {
       ...
       *   necessary interface.
       */
      __P_606_5: function __P_606_5(formItem) {
        var clazz = formItem.constructor;
       ...
       *   necessary interface.
       */
      __P_606_7: function __P_606_7(formItem) {
        var clazz = formItem.constructor;
      ...
      _setValid: function _setValid(value) {
        ...
        var oldValue = this.__P_606_2;
        this.__P_606_2 = value;
      ...
      _showToolTip: function _showToolTip(valid) {
        ...
        if (!valid) {
          var firstInvalid;
          for (var i = 0; i < this.__P_606_0.length; i++) {
            var item = this.__P_606_0[i].item;
            if (!item.isValid()) {
              firstInvalid = item;
      ...
      reset: function reset() {
        ...
        for (var i = 0; i < this.__P_606_0.length; i++) {
          var dataEntry = this.__P_606_0[i];
      ...
      setItemValid: function setItemValid(formItem, valid) {
        // store the result
        this.__P_606_1[formItem.toHashCode()] = valid;
      ...
      setFormValid: function setFormValid(valid) {
        this.__P_606_1[this.toHashCode()] = valid;
        this.__P_606_9();
      },
      /**
       ...
       */
      __P_606_9: function __P_606_9() {
        var valid = this.__P_606_3;

        // check if all async validators are done
        for (var hash in this.__P_606_1) {
          var currentResult = this.__P_606_1[hash];
...
//# sourceMappingURL=Manager.js.map?dt=1782705799080