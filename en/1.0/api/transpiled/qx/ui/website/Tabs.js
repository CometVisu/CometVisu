    ...
    members: {
      ...
      init: function init() {
        ...
        if (active.length > 0) {
          ...
          this.__P_736_1(activePage);
          this._showPage(active, null);
          this.__P_736_2(activePage);
        }
       ...
       */
      __P_736_1: function __P_736_1(elem) {
       ...
       * @param elem {qxWeb} Element
       */
      __P_736_2: function __P_736_2(elem) {
...
//# sourceMappingURL=Tabs.js.map?dt=1782967172679