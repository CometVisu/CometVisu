  ...
  qx.Bootstrap.define("qx.ui.website.Slider", {
    ...
    members: {
      ...
      _onDocPointerUp: function _onDocPointerUp(e) {
        if (this.__P_734_0 === true) {
          // Cleanup status flags
          delete this.__P_734_0;
          this.__P_734_1(this.getValue());
       ...
       */
      __P_734_1: function __P_734_1(value) {
        var pixels = this._getPixels();
        var paddingLeft = Math.ceil(parseFloat(this.getStyle("paddingLeft")) || 0);
        var valueToPixel;
        if (pixels.length > 0) {
...
//# sourceMappingURL=Slider.js.map?dt=1782705804225