  ...
  qx.Class.define("qx.ui.control.DateChooser", {
    ...
    */
    ...
    construct: function construct(date) {
      ...
      {
        this.__P_541_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._updateDatePane, this);
      }
    ...
    */
    ...
    members: {
      ...
      */
          ...
          case "date-pane":
            ...
            for (var y = 0; y < 6; y++) {
              ...
              for (var x = 0; x < 7; x++) {
                ...
                this.__P_541_2.push(label);
              }
            }
            this._add(control);
            break;
        }
        return control || qx.ui.control.DateChooser.superclass.prototype._createChildControlImpl.call(this, id);
      },
      // apply methods
      ...
      _applyMinValue: function _applyMinValue() {
        this._updateDatePane();
      },
      _applyMaxValue: function _applyMaxValue() {
        this._updateDatePane();
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_541_3[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_541_2[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_541_4(helpDate));
      ...
      __P_541_4: function __P_541_4(date) {
        var d = new Date(date);
        d.setHours(0, 0, 0, 0);
    ...
    */
    destruct: function destruct() {
      if (true && this.__P_541_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_541_0);
      }
      this.__P_541_1 = this.__P_541_2 = this.__P_541_3 = null;
    }
  });
  qx.ui.control.DateChooser.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DateChooser.js.map?dt=1782967165639