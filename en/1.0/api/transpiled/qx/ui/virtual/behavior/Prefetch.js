  ...
  qx.Class.define("qx.ui.virtual.behavior.Prefetch", {
    ...
    */
    ...
    construct: function construct(scroller, settings) {
      ...
      this.__P_713_0 = new qx.event.Timer(this.getInterval());
      this.__P_713_0.addListener("interval", this._onInterval, this);
      if (scroller) {
    ...
    */
    ...
    members: {
      ...
      setPrefetchX: function setPrefetchX(minLeft, maxLeft, minRight, maxRight) {
        this.__P_713_1 = [minLeft, maxLeft, minRight, maxRight];
      },
      /**
      ...
      setPrefetchY: function setPrefetchY(minAbove, maxAbove, minBelow, maxBelow) {
        this.__P_713_2 = [minAbove, maxAbove, minBelow, maxBelow];
      },
      /**
       * Update prefetching
       */
      _onInterval: function _onInterval() {
        var px = this.__P_713_1;
        if (px[1] && px[3]) {
          this.getScroller().getPane().prefetchX(px[0], px[1], px[2], px[3]);
          qx.ui.core.queue.Manager.flush();
        }
        var py = this.__P_713_2;
        if (py[1] && py[3]) {
      ...
      _applyScroller: function _applyScroller(value, old) {
        if (old) {
          if (this.__P_713_3) {
            old.getChildControl("scrollbar-x").removeListenerById(this.__P_713_3);
          }
          if (this.__P_713_4) {
            old.getChildControl("scrollbar-y").removeListenerById(this.__P_713_4);
          }
        }
        if (value) {
          if (!value.getContentElement().getDomElement()) {
            this.__P_713_0.stop();
            value.addListenerOnce("appear", this.__P_713_0.start, this.__P_713_0);
          } else {
            this.__P_713_0.restart();
          }

          //        if (value.hasChildControl("scrollbar-x"))
          //        {
          this.__P_713_3 = value.getChildControl("scrollbar-x").addListener("scroll", this.__P_713_0.restart, this.__P_713_0);

          //        }
          //        if (value.hasChildControl("scrollbar-y"))
          //        {
          this.__P_713_4 = value.getChildControl("scrollbar-y").addListener("scroll", this.__P_713_0.restart, this.__P_713_0);
      ...
      _applyInterval: function _applyInterval(value, old) {
        this.__P_713_0.setInterval(value);
      }
    },
    /*
     *****************************************************************************
    ...
    destruct: function destruct() {
      ...
      this.__P_713_1 = this.__P_713_2 = null;
      this._disposeObjects("__P_713_0");
    }
  });
  qx.ui.virtual.behavior.Prefetch.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Prefetch.js.map?dt=1782967171846