  ...
  qx.Class.define("qx.ui.layout.Dock", {
    ...
    */
    ...
    members: {
      ...
      __P_608_4: function __P_608_4() {
        ...
        this.__P_608_0 = result;

        // Cache edges for faster access
        var edges = [];
        for (var i = 0; i < length; i++) {
          edge = result[i].getLayoutProperties().edge;
          edges[i] = this.__P_608_2[edge] || 5;
        }
        this.__P_608_1 = edges;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        var children = this.__P_608_0;
        var edges = this.__P_608_1;
    ...
    */
    destruct: function destruct() {
      this.__P_608_1 = this.__P_608_0 = null;
    }
  });
  qx.ui.layout.Dock.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Dock.js.map?dt=1782967167945