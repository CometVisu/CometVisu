  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.treevirtual.SimpleTreeDataCellRenderer", {
    ...
    construct: function construct() {
      ...
      if (STDCR.__P_711_0) {
        STDCR.__P_711_1();
        STDCR.__P_711_0 = false;
      }
      qx.ui.table.cellrenderer.Abstract.constructor.call(this);
      this.__P_711_2 = qx.util.AliasManager.getInstance();
      this.__P_711_3 = qx.util.ResourceManager.getInstance();
      this.__P_711_4 = qx.theme.manager.Appearance.getInstance();

      // Base URL used for indentation
      this.BLANK = this.__P_711_3.toUri(this.__P_711_2.resolve("static/blank.png"));
    },
    statics: {
      ...
      __P_711_1: function __P_711_1() {
        ...
        STDCR.__P_711_5.line = tm.styleFrom("treevirtual-line");
        loadImage(STDCR.__P_711_5.line.icon);
        STDCR.__P_711_5.contract = tm.styleFrom("treevirtual-contract");
        loadImage(STDCR.__P_711_5.contract.icon);
        STDCR.__P_711_5.expand = tm.styleFrom("treevirtual-expand");
        loadImage(STDCR.__P_711_5.expand.icon);
        STDCR.__P_711_5.onlyContract = tm.styleFrom("treevirtual-only-contract");
        loadImage(STDCR.__P_711_5.onlyContract.icon);
        STDCR.__P_711_5.onlyExpand = tm.styleFrom("treevirtual-only-expand");
        loadImage(STDCR.__P_711_5.onlyExpand.icon);
        STDCR.__P_711_5.startContract = tm.styleFrom("treevirtual-start-contract");
        loadImage(STDCR.__P_711_5.startContract.icon);
        STDCR.__P_711_5.startExpand = tm.styleFrom("treevirtual-start-expand");
        loadImage(STDCR.__P_711_5.startExpand.icon);
        STDCR.__P_711_5.endContract = tm.styleFrom("treevirtual-end-contract");
        loadImage(STDCR.__P_711_5.endContract.icon);
        STDCR.__P_711_5.endExpand = tm.styleFrom("treevirtual-end-expand");
        loadImage(STDCR.__P_711_5.endExpand.icon);
        STDCR.__P_711_5.crossContract = tm.styleFrom("treevirtual-cross-contract");
        loadImage(STDCR.__P_711_5.crossContract.icon);
        STDCR.__P_711_5.crossExpand = tm.styleFrom("treevirtual-cross-expand");
        loadImage(STDCR.__P_711_5.crossExpand.icon);
        STDCR.__P_711_5.end = tm.styleFrom("treevirtual-end");
        loadImage(STDCR.__P_711_5.end.icon);
        STDCR.__P_711_5.cross = tm.styleFrom("treevirtual-cross");
        loadImage(STDCR.__P_711_5.cross.icon);
      }
    },
    properties: {
      /**
    ...
    */
    ...
    members: {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        qx.ui.treevirtual.SimpleTreeDataCellRenderer.__P_711_1();
      },
      // overridden
      ...
      _addImage: function _addImage(imageInfo) {
        ...
        // Resolve the URI
        var source = this.__P_711_3.toUri(this.__P_711_2.resolve(imageInfo.url));
      ...
      _addIcon: function _addIcon(cellInfo, pos) {
        ...
        if (!imageUrl) {
          if (node.type == qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF) {
            var o = this.__P_711_4.styleFrom("treevirtual-file");
          } else {
            var states = {
              opened: node.bOpened
            };
            var o = this.__P_711_4.styleFrom("treevirtual-folder", states);
          }
          imageUrl = o.icon;
        }
        var rowHeight = cellInfo.table.getRowHeight();
      ...
      _getIndentSymbol: function _getIndentSymbol(column, node, bUseTreeLines, bAlwaysShowOpenCloseSymbol, bExcludeFirstLevelTreeLines) {
        ...
        if (column < node.level - 1) {
          ...
          // bUseTreeLines
          return bUseTreeLines && !node.lastChild[column] ? STDCR.__P_711_5.line : {
            icon: this.BLANK
          };
        }
        ...
        if (node.type == qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH && !node.bHideOpenClose) {
          ...
          if (node.children.length > 0 || bAlwaysShowOpenCloseSymbol) {
            ...
            if (!bUseTreeLines) {
              ...
              return node.bOpened ? STDCR.__P_711_5.contract : STDCR.__P_711_5.expand;
            }
            ...
            if (column == 0 && node.bFirstChild) {
              ...
              if (bLastChild) {
                ...
                return node.bOpened ? STDCR.__P_711_5.onlyContract : STDCR.__P_711_5.onlyExpand;
              } else {
                // otherwise, use descender lines but no ascender.
                return node.bOpened ? STDCR.__P_711_5.startContract : STDCR.__P_711_5.startExpand;
              }
            }
            ...
            if (bLastChild) {
              ...
              return node.bOpened ? STDCR.__P_711_5.endContract : STDCR.__P_711_5.endExpand;
            }

            // Otherwise, return a crossing expand or contract.
            return node.bOpened ? STDCR.__P_711_5.crossContract : STDCR.__P_711_5.crossExpand;
          }
        }
        ...
        if (bUseTreeLines) {
          ...
          return bLastChild ? STDCR.__P_711_5.end : STDCR.__P_711_5.cross;
        }
        return {
          icon: this.BLANK
        };
    ...
    destruct: function destruct() {
      this.__P_711_2 = this.__P_711_3 = this.__P_711_4 = null;
    }
  });
  qx.ui.treevirtual.SimpleTreeDataCellRenderer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SimpleTreeDataCellRenderer.js.map?dt=1782967171718