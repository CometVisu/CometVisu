  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Simple", {
    ...
    members: {
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__P_690_2 == null) {
            this.__P_690_2 = [];
          }
          this.__P_690_2[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        return this.__P_690_2 ? this.__P_690_2[columnIndex] == true : false;
      },
      /**
      ...
      setColumnSortable: function setColumnSortable(columnIndex, sortable) {
        if (sortable != this.isColumnSortable(columnIndex)) {
          ...
          this.__P_690_3[columnIndex] = sortable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnSortable: function isColumnSortable(columnIndex) {
        return this.__P_690_3 ? this.__P_690_3[columnIndex] !== false : true;
      },
      // overridden
      sortByColumn: function sortByColumn(columnIndex, ascending) {
        ...
        var comparator;
        var sortMethods = this.__P_690_1[columnIndex];
        if (sortMethods) {
        ...
        this.__P_690_0 = columnIndex;
        this.__P_690_4 = ascending;
        var data = {
      ...
      setSortMethods: function setSortMethods(columnIndex, compare) {
        ...
        this.__P_690_1[columnIndex] = methods;
      },
      /**
      ...
      getSortMethods: function getSortMethods(columnIndex) {
        return this.__P_690_1[columnIndex];
      },
      /**
       * Clears the sorting.
       */
    ...
    destruct: function destruct() {
      this._rowArr = this.__P_690_2 = this.__P_690_1 = this.__P_690_3 = null;
    }
  });
  qx.ui.table.model.Simple.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Simple.js.map?dt=1782967170643