  ...
  qx.Class.define("qx.ui.root.Inline", {
    ...
    */
    ...
    construct: function construct(el, dynamicX, dynamicY) {
      ...
      this.__P_672_1 = dynamicX || false;
      this.__P_672_2 = dynamicY || false;
      this.__P_672_3();
    ...
    */
    ...
    members: {
       ...
       */
      __P_672_3: function __P_672_3() {
        if (this.__P_672_1 || this.__P_672_2) {
          // Check the DOM element for an usable width and height
          var elementDimensions = qx.bom.element.Dimension.getSize(this.__P_672_0);
          if (this.__P_672_1 && elementDimensions.width < 1) {
            throw new Error("The root element " + this.__P_672_0 + " of " + this + " needs a width when its width size should be used!");
          }
          if (this.__P_672_2) {
            if (elementDimensions.height < 1) {
              throw new Error("The root element " + this.__P_672_0 + " of " + this + " needs a height when its height size should be used!");
            }

            // check for implicit height. Set the height explicit to prevent that
            // the element grows indefinitely
            if (elementDimensions.height >= 1 && qx.bom.element.Style.get(this.__P_672_0, "height", 3) == "") {
              qx.bom.element.Style.set(this.__P_672_0, "height", elementDimensions.height + "px");
            }
          }
          qx.event.Registration.addListener(this.__P_672_0, "resize", this._onResize, this);
        }
      },
      // overridden
      _createContentElement: function _createContentElement() {
        var el = this.__P_672_0;
        if (this.__P_672_1 || this.__P_672_2) {
      ...
      _onResize: function _onResize(e) {
        var data = e.getData();
        if (data.oldWidth !== data.width && this.__P_672_1 || data.oldHeight !== data.height && this.__P_672_2) {
          qx.ui.core.queue.Layout.add(this);
        }
      },
      /**
      ...
      _computeSizeHint: function _computeSizeHint() {
        var dynX = this.__P_672_1;
        var dynY = this.__P_672_2;
        if (!dynX || !dynY) {
        ...
        if (dynX) {
          var width = Dimension.getContentWidth(this.__P_672_0);
          hint.width = width;
          hint.minWidth = width;
          hint.maxWidth = width;
        }
        if (dynY) {
          var height = Dimension.getContentHeight(this.__P_672_0);
          hint.height = height;
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(this.__P_672_0, "resize", this._onResize, this);
      this.__P_672_0 = null;
    }
  });
...
//# sourceMappingURL=Inline.js.map?dt=1782967169911