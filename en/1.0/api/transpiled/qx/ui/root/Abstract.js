  ...
  qx.Class.define("qx.ui.root.Abstract", {
    ...
    */
    construct: function construct() {
      ...
      this.initNativeHelp();
      this.addListener("keypress", this.__P_670_0, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    members: {
      ...
      _applyGlobalCursor: qx.core.Environment.select("engine.name", {
        ...
        "default": function _default(value, old) {
          ...
          var sheet = this.__P_670_1;
          if (!sheet) {
            this.__P_670_1 = sheet = Stylesheet.createElement();
          }
       ...
       */
      __P_670_0: function __P_670_0(e) {
...
//# sourceMappingURL=Abstract.js.map?dt=1782967169876