  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_535_1 || 0,
          height: this.__P_535_2 || 0
        };
      },
      // overridden
      ...
      */
      ...
      _applySource: function _applySource(value, old) {
        ...
        this.__P_535_7 = false;
        this.__P_535_8 = value;
        this._styleSource();
      },
      // property apply
       ...
       */
      __P_535_12: function __P_535_12(mode) {
        this.__P_535_3 = mode;
      },
      /**
       ...
       */
      __P_535_11: function __P_535_11() {
        if (this.__P_535_3 == null) {
          var source = this.__P_535_8;
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_535_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_535_3 = "scaled";
          } else {
            this.__P_535_3 = "nonScaled";
          }
        }
        return this.__P_535_3;
      },
      /**
       ...
       */
      __P_535_13: function __P_535_13(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_535_5 = new qx.html.Element("div");
            element.connectObject(this);
       ...
       */
      __P_535_9: function __P_535_9() {
        if (this.$$disposed) {
          return null;
        }
        var mode = this.__P_535_11();
        if (this.__P_535_0[mode] == null) {
          this.__P_535_0[mode] = this.__P_535_13(mode);
        }
        var element = this.__P_535_0[mode];
        if (!this.__P_535_4) {
          this.__P_535_4 = element;
        }
        return element;
      },
      /**
      ...
      _styleSource: function _styleSource() {
        ...
        var source = AliasManager.resolve(this.__P_535_8);
        var element = this.getContentElement();
        if (this.__P_535_5) {
          element = element.getChild(0);
        }
        if (!source) {
          this.__P_535_14(element);
          return;
        }
        this.__P_535_15(source);
        ...
        var contentEl = this.__P_535_16();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_535_17(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_535_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_535_19(contentEl, source);
          this.__P_535_18();
        } else {
          this.__P_535_20(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_535_15: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            this.__P_535_12("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_535_11() != "alphaScaled") {
              this.__P_535_12("alphaScaled");
            } else if (!this.getScale() && this.__P_535_11() != "nonScaled") {
              this.__P_535_12("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_535_11() != "scaled") {
              this.__P_535_12("scaled");
            } else if (!this.getScale() && this.__P_535_11() != "nonScaled") {
              this.__P_535_12("nonScaled");
            }
          }
          this.__P_535_21(this.__P_535_9());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_535_12("font");
          } else if (this.getScale() && this.__P_535_11() != "scaled") {
            this.__P_535_12("scaled");
          } else if (!this.getScale() && this.__P_535_11() != "nonScaled") {
            this.__P_535_12("nonScaled");
          }
       ...
       */
      __P_535_21: function __P_535_21(elementToAdd) {
        var currentContentElement = this.__P_535_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_535_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_535_17: function __P_535_17(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_535_22(source);
          ...
          this.__P_535_23(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_535_24: function __P_535_24(el, width, height) {
        if (this.getScale()) {
          el.setStyle("fontSize", (width > height ? height : width) + "px");
        } else {
          var source = qx.util.AliasManager.getInstance().resolve(this.__P_535_8);
      ...
      _applyDimension: function _applyDimension() {
        ...
        var isFont = this.__P_535_8 && qx.lang.String.startsWith(this.__P_535_8, "@");
        if (isFont) {
          var el = this.getContentElement();
          if (el) {
            var hint = this.getSizeHint();
            ...
            this.__P_535_24(el, width, height);
          }
        } else {
          this.__P_535_23();
        }
       ...
       * @param source {String} source path
       */
      __P_535_19: function __P_535_19(el, source) {
       ...
       * @param source {String} source path
       */
      __P_535_20: function __P_535_20(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_535_25, this);
        } else {
          this.__P_535_14(el);
          if (!this.__P_535_7 && this.getFallbackSource()) {
            this.__P_535_7 = true;
            this.__P_535_8 = this.getFallbackSource();
            this._styleSource();
          }
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_535_14: function __P_535_14(el) {
        if (el != null) {
      ...
      __P_535_22: function __P_535_22(source) {
       ...
       * @param source {String} source path
       */
      __P_535_10: function __P_535_10(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_535_22(source);
          ...
          this.__P_535_24(el, this.__P_535_1, this.__P_535_2);
       ...
       */
      __P_535_25: function __P_535_25(source, imageInfo) {
        ...
        if (source !== qx.util.AliasManager.getInstance().resolve(this.__P_535_8)) {
          this.fireEvent("aborted");
          return;
        }
        ...
        // Update image
        this.__P_535_19(this.__P_535_16(), source);
      },
      /**
       ...
       */
      __P_535_23: function __P_535_23(width, height) {
        if (width === undefined) {
          width = this.__P_535_1;
        }
        if (height === undefined) {
          height = this.__P_535_2;
        }
      ...
      _recalc: function _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_535_1 || height != this.__P_535_2) {
          this.__P_535_1 = width;
          this.__P_535_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_535_0) {
        if (this.__P_535_0.hasOwnProperty(mode)) {
          this.__P_535_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_535_4;
      if (this.__P_535_5) {
        delete this.__P_535_5;
      }
      this._disposeMap("__P_535_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1782967165378