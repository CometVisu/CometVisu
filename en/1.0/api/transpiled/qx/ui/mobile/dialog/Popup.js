    ...
    members: {
      ...
      _updatePosition: function _updatePosition() {
        ...
        if (this.__P_638_0) {
          ...
          var anchorPosition = qx.bom.element.Location.get(this.__P_638_0.getContainerElement());
          var popupDimension = qx.bom.element.Dimension.getSize(this.getContainerElement());
          this.__P_638_7 = popupDimension;
        ...
        } else if (this.__P_638_3 && !this.__P_638_2) {
      ...
      _trackUserTap: function _trackUserTap(evt) {
        ...
        var isOutsideWidget = clientX < popupLocation.left || clientX > popupLocation.left + this.__P_638_7.width || clientY > popupLocation.top + this.__P_638_7.height || clientY < popupLocation.top;
        if (isOutsideWidget) {
          this.hide();
        }
      },
      ...
      __P_638_9: function __P_638_9() {
        ...
        if (this.__P_638_0) {
          this.__P_638_0.addCssClass("anchor-target");
      ...
      __P_638_10: function __P_638_10() {
        ...
        if (this.__P_638_0) {
          this.__P_638_0.removeCssClass("anchor-target");
      ...
      _initializeChild: function _initializeChild(widget) {
        ...
        if (this.__P_638_3 == null) {
          ...
          this._add(this.__P_638_3);
        }
        if (this._createTitleWidget()) {
          this.__P_638_3.remove(this._createTitleWidget());
          this.__P_638_3.add(this._createTitleWidget());
        }
      ...
      _createTitleWidget: function _createTitleWidget() {
        if (this.__P_638_6) {
          return this.__P_638_6;
        }
        if (this.getTitle() || this.getIcon()) {
          this.__P_638_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), this.getIcon());
          this.__P_638_6.addCssClass("popup-title");
          return this.__P_638_6;
        } else {
          return null;
        }
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (value) {
          if (this.__P_638_6) {
            this.__P_638_6.setLabel(value);
          } else {
            this.__P_638_6 = new qx.ui.mobile.basic.Atom(value, this.getIcon());
            this.__P_638_6.addCssClass("popup-title");
            if (this.__P_638_5) {
              this.__P_638_3.addBefore(this._createTitleWidget(), this.__P_638_5);
            } else {
              if (this.__P_638_3) {
                this.__P_638_3.add(this._createTitleWidget());
              }
      ...
      _applyIcon: function _applyIcon(value, old) {
        if (value) {
          if (this.__P_638_6) {
            this.__P_638_6.setIcon(value);
          } else {
            this.__P_638_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), value);
            this.__P_638_6.addCssClass("popup-title");
            if (this.__P_638_5) {
              this.__P_638_3.addBefore(this._createTitleWidget(), this.__P_638_5);
            } else {
      ...
      removeWidget: function removeWidget() {
        if (this.__P_638_5) {
          this.__P_638_5.removeListener("domupdated", this._updatePosition, this);
          this.__P_638_3.remove(this.__P_638_5);
          return this.__P_638_5;
        } else {
          return null;
        }
      }
...
//# sourceMappingURL=Popup.js.map?dt=1782705800357