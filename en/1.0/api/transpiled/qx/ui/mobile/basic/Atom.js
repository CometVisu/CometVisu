  ...
  qx.Class.define("qx.ui.mobile.basic.Atom", {
    ...
    */
    ...
    members: {
      ...
      _applyIconPosition: function _applyIconPosition(value, old) {
        ...
        var hasNoLabel = !this.__P_622_2;
        this.__P_622_5(verticalLayout, hasNoLabel);
        var isReverse = ["right", "bottom"].indexOf(value) != -1;
        this.__P_622_4.setLayout(this.__P_622_1);
        this.__P_622_1.setReversed(isReverse);
        this._domUpdated();
      },
      // property apply
      ...
      _applyLabel: function _applyLabel(value, old) {
        if (this.__P_622_2) {
          this.__P_622_2.setValue(value);
        } else {
          this.__P_622_2 = this._createLabelWidget(value);
        }
      },
      // property apply
      _applyIcon: function _applyIcon(value, old) {
        if (this.__P_622_3) {
          this.__P_622_3.setSource(value);
        } else {
          this.__P_622_3 = this._createIconWidget(value);
        }
      },
      /**
       ...
       */
      __P_622_5: function __P_622_5(verticalLayout, hasNoLabel) {
        if (verticalLayout || hasNoLabel) {
          if (this.__P_622_1) {
            if (this.__P_622_1.classname !== "qx.ui.mobile.layout.VBox") {
              this.__P_622_1.dispose();
              this.__P_622_1 = new qx.ui.mobile.layout.VBox();
            }
          }
          // layout == null
          else {
        ...
        // horizontal layout and has label
          ...
          if (this.__P_622_1) {
            if (this.__P_622_1.classname !== "qx.ui.mobile.layout.HBox") {
              this.__P_622_1.dispose();
              this.__P_622_1 = new qx.ui.mobile.layout.HBox();
            }
          }
          // layout == null
          else {
       ...
       *
       */
      __P_622_0: function __P_622_0(label, icon) {
        this.__P_622_2 = this._createLabelWidget(label);
        if (label) {
          this.setLabel(label);
        }
        this.__P_622_3 = this._createIconWidget(icon);
        if (icon) {
          this.setIcon(icon);
        } else {
          this.__P_622_3.exclude();
        ...
        this.__P_622_5(verticalLayout, hasNoLabel);
        if (this.__P_622_4) {
          this.__P_622_4.dispose();
        }
        this.__P_622_4 = new qx.ui.mobile.container.Composite(this.__P_622_1);
        this.__P_622_4.addCssClass("qx-flex-center");
        this.__P_622_4.setAnonymous(true);
        if (this.__P_622_3) {
          this.__P_622_4.add(this.__P_622_3);
        }
        if (this.__P_622_2) {
          this.__P_622_2.addCssClass("qx-flex-center");
          this.__P_622_4.add(this.__P_622_2);
        }

        // Show/Hide Label/Icon
        if (this.getShow() === "icon" && this.__P_622_2) {
          this.__P_622_2.exclude();
        }
        if (this.getShow() === "label" && this.__P_622_3) {
          this.__P_622_3.exclude();
        }
        this._add(this.__P_622_4);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_622_1", "__P_622_2", "__P_622_3", "__P_622_4");
    }
  });
  qx.ui.mobile.basic.Atom.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Atom.js.map?dt=1782967168455