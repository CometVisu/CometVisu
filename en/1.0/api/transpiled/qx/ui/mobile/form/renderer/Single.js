  ...
  qx.Class.define("qx.ui.mobile.form.renderer.Single", {
    ...
    members: {
      ...
      resetForm: function resetForm() {
        for (var i = 0; i < this.__P_647_0.length; i++) {
          qx.dom.Element.remove(this.__P_647_0[i]);
        }
      }
    },
    /*
...
//# sourceMappingURL=Single.js.map?dt=1782967169231