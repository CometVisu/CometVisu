  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      scheduleFlush: function scheduleFlush(job) {
        ...
        self.__P_562_2[job] = true;
        if (!self.__P_562_0) {
          self.__P_562_1 = false;
      ...
      flush: function flush() {
        ...
        self.__P_562_1 = true;
        var jobs = self.__P_562_2;
        self.__P_562_5(function () {
          // Process jobs
       ...
       */
      __P_562_5: qx.core.Environment.select("qx.debug", {
        ...
        "false": function _false(callback, finallyCode) {
          ...
          try {
            ...
            self.__P_562_4 = false;
            self.__P_562_3 += 1;
            if (self.__P_562_3 <= self.MAX_RETRIES) {
              self.scheduleFlush();
            } else {
              throw new Error("Fatal Error: Flush terminated " + (self.__P_562_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
            }
            throw e;
          } finally {
            finallyCode();
       ...
       */
      __P_562_6: function __P_562_6(e) {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__P_562_6 : statics.flush);
    }
  });
  qx.ui.core.queue.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1782705797467