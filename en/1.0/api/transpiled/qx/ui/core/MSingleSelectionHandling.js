  ...
  qx.Mixin.define("qx.ui.core.MSingleSelectionHandling", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      setValue: function setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__P_556_1().setSelected(item);
          return null;
        } else {
      ...
      getValue: function getValue() {
        return this.__P_556_1().getSelected() || null;
      },
      /**
       * resetValue implements part of the {@link qx.ui.form.IField} interface.
       */
      resetValue: function resetValue() {
        this.__P_556_1().resetSelected();
      },
      /**
      ...
      getSelection: function getSelection() {
        var selected = this.__P_556_1().getSelected();
        if (selected) {
          return [selected];
        } else {
          return [];
      ...
      setSelection: function setSelection(items) {
        switch (items.length) {
          case 0:
            ...
            break;
          case 1:
            this.__P_556_1().setSelected(items[0]);
            break;
          default:
      ...
      isSelected: function isSelected(item) {
        return this.__P_556_1().isSelected(item);
      },
      /**
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_556_1().isSelectionEmpty();
      },
      /**
      ...
      getSelectables: function getSelectables(all) {
        return this.__P_556_1().getSelectables(all);
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
      ...
      */
       ...
       */
      __P_556_1: function __P_556_1() {
        if (this.__P_556_0 == null) {
          var that = this;
          this.__P_556_0 = new qx.ui.core.SingleSelectionManager({
          ...
          this.__P_556_0.addListener("changeSelected", this._onChangeSelected, this);
        }
        this.__P_556_0.setAllowEmptySelection(this._isAllowEmptySelection());
        return this.__P_556_0;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_556_0");
    }
  });
  qx.ui.core.MSingleSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MSingleSelectionHandling.js.map?dt=1782705797216