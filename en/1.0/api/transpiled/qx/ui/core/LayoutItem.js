  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    construct: function construct() {
      ...
      {
        this.__P_546_0 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      getBounds: function getBounds() {
        return this.__P_546_6 || this.__P_546_2 || null;
      },
      /**
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        var computed = this.__P_546_2;
        if (!computed) {
          computed = this.__P_546_2 = {};
        }
        ...
        if (this.__P_546_3) {
          changes.local = true;
          delete this.__P_546_3;
        }
        if (this.__P_546_5) {
          changes.margin = true;
          delete this.__P_546_5;
        }
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_546_1) {
            // This variable is used in the next computation of the size hint
            this.__P_546_1 = flowHeight;
      ...
      getSizeHint: function getSizeHint(compute) {
        ...
        // Compute as defined
        hint = this.__P_546_4 = this._computeSizeHint();

        // Respect height for width
        if (this._hasHeightForWidth() && this.__P_546_1 && this.getHeight() == null) {
          hint.height = this.__P_546_1;
        }
      ...
      */
      ...
      setLayoutProperties: function setLayoutProperties(props) {
        ...
        var storage = this.__P_546_7;
        if (!storage) {
          storage = this.__P_546_7 = {};
        }
      ...
      getLayoutProperties: function getLayoutProperties() {
        return this.__P_546_7 || this.__P_546_8;
      },
      /**
      ...
      */
      ...
      clone: function clone() {
        ...
        var props = this.__P_546_7;
        if (props) {
          clone.__P_546_7 = qx.lang.Object.clone(props);
        }
        return clone;
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_546_0) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_546_0);
      }
      this.$$parent = this.$$subparent = this.__P_546_7 = this.__P_546_2 = this.__P_546_6 = this.__P_546_4 = null;
    }
  });
  qx.ui.core.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1782705796982