  ...
  qx.Class.define("qx.ui.tabview.TabView", {
    ...
    */
    ...
    construct: function construct(barPosition) {
      ...
      // Create manager
      var mgr = this.__P_700_1 = this._createRadioGroupInstance();
      mgr.setWrap(false);
    ...
    members: {
      ...
      */
      ...
      add: function add(page) {
        ...
        // Register button
        this.__P_700_1.add(button);

        // Add state to page
        page.addState(this.__P_700_0[this.getBarPosition()]);
        this.__P_700_2();
        page.addListener("close", this._onPageClose, this);
        page.addListener("changeTabVisibility", this.__P_700_3, this);
      },
      /**
       * Adds a page to the tabview including its needed button
       * (contained in the page).
      ...
      remove: function remove(page) {
        ...
        this.__P_700_1.remove(button);

        // Remove state from page
        page.removeState(this.__P_700_0[this.getBarPosition()]);
        this.__P_700_2();
        page.removeListener("close", this._onPageClose, this);
        page.removeListener("changeTabVisibility", this.__P_700_3, this);
      },
      /**
      ...
      */
      ...
      _applyBarPosition: function _applyBarPosition(value, old) {
        ...
        // Toggle state to bar
        if (old) {
          var oldState = this.__P_700_0[old];
        ...
        if (value) {
          var newState = this.__P_700_0[value];
      ...
      */
      ...
      getSelection: function getSelection() {
        var buttons = this.__P_700_1.getSelection();
        var result = [];
      ...
      setSelection: function setSelection(items) {
        ...
        this.__P_700_1.setSelection(buttons);
      },
      /**
       * Clears the whole selection at once.
       */
      resetSelection: function resetSelection() {
        this.__P_700_1.resetSelection();
      },
      /**
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__P_700_1.isSelected(button);
      },
      /**
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_700_1.isSelectionEmpty();
      },
      /**
      ...
      getSelectables: function getSelectables(all) {
        var buttons = this.__P_700_1.getSelectables(all);
        var result = [];
        for (var i = 0; i < buttons.length; i++) {
          result.push(buttons[i].getUserData("page"));
        }
      ...
      */
      ...
      __P_700_3: function __P_700_3() {
        this.__P_700_2();
      },
      __P_700_2: function __P_700_2() {
        var _firstPage, _lastPage;
        var firstPage = null;
        var lastPage = null;
        for (var pages = this.getChildren(), i = 0; i < pages.length; i++) {
          var page = pages[i];
        ...
        (_firstPage = firstPage) === null || _firstPage === void 0 || _firstPage.addState("firstTab");
        (_lastPage = lastPage) === null || _lastPage === void 0 || _lastPage.addState("lastTab");
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_700_1");
      this.__P_700_0 = null;
    }
  });
...
//# sourceMappingURL=TabView.js.map?dt=1782705802768