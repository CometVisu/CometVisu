  ...
  qx.Class.define("qx.event.handler.Transition", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_242_0 = {};
      this.__P_242_1 = qx.lang.Function.listener(this._onNative, this);
    },
    /*
    *****************************************************************************
       STATICS
      ...
      */
      ...
      registerEvent: qx.core.Environment.select("engine.name", {
        webkit: function webkit(target, type, capture) {
          ...
          qx.bom.Event.addNativeListener(target, nativeType, this.__P_242_1);
        },
      ...
      unregisterEvent: qx.core.Environment.select("engine.name", {
        webkit: function webkit(target, type, capture) {
          ...
          qx.bom.Event.removeNativeListener(target, qx.event.handler.Transition.TYPE_TO_NATIVE[type], this.__P_242_1);
        },
        gecko: function gecko(target, type, capture) {
          var events = this.__P_242_0;
          if (!events) {
    ...
    */
    destruct: function destruct() {
      ...
      for (var id in events) {
        event = events[id];
        if (event.target) {
          qx.bom.Event.removeNativeListener(event.target, event.type, this.__P_242_1);
        }
      }
      this.__P_242_0 = this.__P_242_1 = null;
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Transition.js.map?dt=1782705778508