  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      // Register
      qx.event.handler.Appear.__P_225_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_225_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct: function destruct() {
      ...
      // Deregister
      delete qx.event.handler.Appear.__P_225_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=Appear.js.map?dt=1782705777933