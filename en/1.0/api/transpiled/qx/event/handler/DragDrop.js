  ...
  qx.Class.define("qx.event.handler.DragDrop", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      // Define shorthands
      this.__P_227_0 = manager;
      this.__P_227_1 = manager.getWindow().document.documentElement;

      // Initialize listener
      this.__P_227_0.addListener(this.__P_227_1, "longtap", this._onLongtap, this);
      this.__P_227_0.addListener(this.__P_227_1, "pointerdown", this._onPointerdown, this, true);
    ...
    members: {
      ...
      */
      ...
      getDataAsync: function getDataAsync(type) {
        ...
        if (!this.__P_227_8[type]) {
          qx.event.Utils.then(tracker, function () {
            self.__P_227_9 = type;
            return self.__P_227_17("droprequest", self.__P_227_4, self.__P_227_3, false);
          });
        }
      ...
      getCurrentActionAsync: qx.core.Environment.select("qx.promise", {
        "true": function _true() {
          var self = this;
          return qx.Promise.resolve(self.__P_227_16()).then(function () {
            return self.__P_227_10;
          });
        },
      ...
      */
       ...
       */
      __P_227_16: function __P_227_16() {
        if (this.__P_227_4 == null) {
          {
            return qx.Promise.reject();
          }
        }
        var actions = this.__P_227_6;
        var keys = this.__P_227_7;
        var current = null;
        if (this.__P_227_12) {
        ...
        var self = this;
        var tracker = {};
        var old = this.__P_227_10;
        if (current != old) {
          if (this.__P_227_3) {
            qx.event.Utils["catch"](function () {
              self.__P_227_13 = false;
              current = null;
            });
            qx.event.Utils.then(tracker, function () {
              self.__P_227_10 = current;
              return self.__P_227_17("dragchange", self.__P_227_3, self.__P_227_4, true);
            });
            qx.event.Utils.then(tracker, function (validAction) {
              self.__P_227_13 = validAction;
              if (!validAction) {
                current = null;
              }
            });
        ...
        return qx.event.Utils.then(tracker, function () {
          if (current != old) {
            self.__P_227_10 = current;
            return self.__P_227_17("dragchange", self.__P_227_4, self.__P_227_3, false);
          }
        });
      },
      /**
       ...
       * not prevented
       */
      __P_227_17: function __P_227_17(type, target, relatedTarget, cancelable, original, async) {
       ...
       */
      __P_227_18: function __P_227_18(elem) {
       ...
       */
      __P_227_19: function __P_227_19(elem) {
        while (elem && elem.nodeType == 1) {
      ...
      clearSession: function clearSession() {
        ...
        this.__P_227_0.removeListener(this.__P_227_1, "pointermove", this._onPointermove, this);
        this.__P_227_0.removeListener(this.__P_227_1, "pointerup", this._onPointerup, this, true);
        this.__P_227_0.removeListener(this.__P_227_1, "keydown", this._onKeyDown, this, true);
        this.__P_227_0.removeListener(this.__P_227_1, "keyup", this._onKeyUp, this, true);
        this.__P_227_0.removeListener(this.__P_227_1, "keypress", this._onKeyPress, this, true);
        this.__P_227_0.removeListener(this.__P_227_1, "roll", this._onRoll, this, true);
        var tracker = {};
        var self = this;
        ...
        if (this.__P_227_4) {
          qx.event.Utils.then(tracker, function () {
            return self.__P_227_17("dragend", self.__P_227_4, self.__P_227_3, false);
          });
        }
        return qx.event.Utils.then(tracker, function () {
          // Cleanup
          self.__P_227_12 = false;
          self.__P_227_3 = null;
          if (self.__P_227_14) {
            self.__P_227_14.removeState("drag");
            self.__P_227_14 = null;
          }

          // Clear init
          //self.debug("Clearing drag target");
          self.__P_227_4 = null;
          self.__P_227_11 = false;
          self.__P_227_15 = null;
          self.__P_227_2();
        });
      },
      /*
      ...
      */
      ...
      _onLongtap: function _onLongtap(e) {
        ...
        // prevent scrolling
        this.__P_227_0.addListener(this.__P_227_1, "roll", this._onRoll, this, true);
      ...
      _start: function _start(e) {
        ...
        var target = this.__P_227_15 ? this.__P_227_15.target : e.getTarget();
        var draggable = this.__P_227_18(target);
        if (draggable) {
          // This is the source target
          //this.debug("Setting dragtarget = " + draggable);
          this.__P_227_4 = draggable;
          var widgetOriginalTarget = qx.ui.core.Widget.getWidgetByElement(this.__P_227_15.original);
          ...
          if (widgetOriginalTarget) {
            this.__P_227_14 = widgetOriginalTarget;
          ...
          qx.event.Utils.then(tracker, function () {
            return self.__P_227_17("dragstart", self.__P_227_4, self.__P_227_3, true, e);
          });
          return qx.event.Utils.then(tracker, function (validAction) {
            ...
            self.__P_227_0.addListener(self.__P_227_1, "keydown", self._onKeyDown, self, true);
            self.__P_227_0.addListener(self.__P_227_1, "keyup", self._onKeyUp, self, true);
            self.__P_227_0.addListener(self.__P_227_1, "keypress", self._onKeyPress, self, true);
            self.__P_227_11 = true;
          });
        }
      },
      /**
      ...
      _onPointerdown: function _onPointerdown(e) {
        if (e.isPrimary()) {
          ...
          this.__P_227_0.addListener(this.__P_227_1, "pointermove", this._onPointermove, this);
          this.__P_227_0.addListener(this.__P_227_1, "pointerup", this._onPointerup, this, true);
        }
      },
      /**
      ...
      _onPointermove: function _onPointermove(e) {
        ...
        if (!self.__P_227_11 && e.getPointerType() == "mouse") {
        ...
        return qx.event.Utils.then(tracker, function () {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            return self.__P_227_17("drag", self.__P_227_4, self.__P_227_3, true, e);
          });
          qx.event.Utils.then(tracker, function (validAction) {
            if (!validAction) {
              this.clearSession();
            ...
            if (el !== cursorEl) {
              var droppable = self.__P_227_19(el);

              // new drop target detected
              if (droppable && droppable != self.__P_227_3) {
                var dropLeaveTarget = self.__P_227_3;
                self.__P_227_12 = true; // initial value should be true
                self.__P_227_3 = droppable;
                var innerTracker = {};
                ...
                if (dropLeaveTarget) {
                  qx.event.Utils.then(innerTracker, function () {
                    return self.__P_227_17("dragleave", dropLeaveTarget, self.__P_227_4, false, e);
                  });
                }
                qx.event.Utils.then(innerTracker, function () {
                  return self.__P_227_17("dragover", droppable, self.__P_227_4, true, e);
                });
                return qx.event.Utils.then(innerTracker, function (validDrop) {
                  self.__P_227_12 = validDrop;
                });
              }

              // only previous drop target
              else if (!droppable && self.__P_227_3) {
                var innerTracker = {};
                qx.event.Utils.then(innerTracker, function () {
                  return self.__P_227_17("dragleave", self.__P_227_3, self.__P_227_4, false, e);
                });
                return qx.event.Utils.then(innerTracker, function () {
                  self.__P_227_3 = null;
                  self.__P_227_12 = false;
                  return self.__P_227_16();
                });
              }
            }
          });
      ...
      _getDelta: function _getDelta(e) {
        ...
        var deltaX = e.getDocumentLeft() - this.__P_227_15.left;
        var deltaY = e.getDocumentTop() - this.__P_227_15.top;
        return {
          x: deltaX,
          y: deltaY
        };
      ...
      _onPointerup: function _onPointerup(e) {
        ...
        if (this.__P_227_12 && this.__P_227_13) {
          qx.event.Utils.then(tracker, function () {
            return self.__P_227_17("drop", self.__P_227_3, self.__P_227_4, false, e);
          });
        }
        return qx.event.Utils.then(tracker, function () {
          // Stop event
          if (e.getTarget() == self.__P_227_4) {
            e.stopPropagation();
          }
      ...
      _onKeyDown: function _onKeyDown(e) {
        ...
        switch (iden) {
          ...
          case "Control":
          case "Shift":
            if (!this.__P_227_7[iden]) {
              this.__P_227_7[iden] = true;
              return this.__P_227_16();
            }
        }
      },
      /**
    ...
    */
    destruct: function destruct() {
      ...
      // Clear fields
      this.__P_227_4 = this.__P_227_3 = this.__P_227_0 = this.__P_227_1 = this.__P_227_5 = this.__P_227_6 = this.__P_227_7 = this.__P_227_8 = null;
    },
    /*
    *****************************************************************************
       DEFER
...
//# sourceMappingURL=DragDrop.js.map?dt=1782705778027