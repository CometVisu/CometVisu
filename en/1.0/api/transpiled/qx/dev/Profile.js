  ...
  qx.Bootstrap.define("qx.dev.Profile", {
    statics: {
      ...
      start: function start() {
        this.__P_203_2 = true;
        this.__P_203_0 = {};
        this.__P_203_1.splice(0, this.__P_203_1.length - 2);
      },
      /**
       * Stop profiling.
       */
      stop: function stop() {
        this.__P_203_2 = false;
      },
      /**
      ...
      showResults: function showResults(maxLength) {
        ...
        var data = Object.values(this.__P_203_0);
       ...
       */
      __P_203_5: function __P_203_5(count) {
      ...
      normalizeProfileData: function normalizeProfileData() {
        if (this.__P_203_3 == undefined) {
          this.__P_203_3 = this.__P_203_5(this.__P_203_4);
        }
        for (var key in this.__P_203_0) {
          var profileData = this.__P_203_0[key];
          profileData.calibratedOwnTime = Math.max(profileData.ownTime - profileData.subRoutineCalls * this.__P_203_3, 0);
      ...
      profileAfter: function profileAfter(fullName, fcn, type, args, returnValue) {
        ...
        var functionData = me.__P_203_0[fcnKey];
...
//# sourceMappingURL=Profile.js.map?dt=1782967146161