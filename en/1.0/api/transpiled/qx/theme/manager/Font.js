    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var createdFonts = this.__P_469_0(theme.fonts);
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.fonts[value]) {
          var fontClass = this.__P_469_1(theme.fonts[value]);
       ...
       */
      __P_469_2: function __P_469_2(fonts, fontName) {
       ...
       */
      __P_469_0: function __P_469_0(fontDefs) {
        var _this = this;
        var webFontDefs = [];
        var createdFonts = {};
        var _loop = function _loop() {
            ...
            if (fontDef.include && fontDefs[fontDef.include]) {
              _this.__P_469_2(fontDefs, fontId);
            }
            if (fontDef.fontName) {
            ...
            fontClass = _this.__P_469_1(fontDef);
      ...
      _applyTheme: function _applyTheme(value) {
        ...
        if (value) {
          ...
          createdFonts = this.__P_469_0(fonts);
        }
       ...
       * @return {Class}
       */
      __P_469_1: function __P_469_1(config) {
...
//# sourceMappingURL=Font.js.map?dt=1782705790856