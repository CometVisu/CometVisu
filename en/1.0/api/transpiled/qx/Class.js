  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
       ...
       * should be included.
       */
      __P_107_0: true ? qx.core.Property : null,
      /*
      ---------------------------------------------------------------------------
         PUBLIC METHODS
      ---------------------------------------------------------------------------
      */
      ...
      define: function define(name, config) {
        try {
          return this.__P_107_1(name, config);
        } catch (ex) {
       ...
       * @returns  @see `define()`
       */
      __P_107_1: function __P_107_1(name, config) {
        if (!config) {
          config = {};
        }
        ...
        // Create the class
        var clazz = this.__P_107_2(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include);

        // Initialise class and constructor/destructor annotations
        ["@", "@construct", "@destruct"].forEach(function (id) {
          this.__P_107_3(clazz, id, null, config[id]);
        }, this);
        ...
        if (config.extend) {
          ...
          if (config.properties) {
            this.__P_107_4(clazz, config.properties, true);
          }

          // Attach members
          if (config.members) {
            this.__P_107_5(clazz, config.members, true, true, false);
          }

          // Process events
          if (config.events) {
            this.__P_107_6(clazz, config.events, true);
          }

          //Process cached objects
          if (config.objects) {
            this.__P_107_7(clazz, config.objects);
          }
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__P_107_8(clazz, config.include[i], false);
            }
          }
        }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__P_107_9(clazz, config.implement[i]);
          }
        }
        // Process defer
        if (config.defer) {
          ...
          qx.Bootstrap.addPendingDefer(clazz, function () {
            ...
            config.defer(clazz, clazz.prototype, {
              add: function add(name, config) {
                ...
                qx.Class.__P_107_4(clazz, properties, true);
              }
            });
          });
        }
      ...
      include: function include(clazz, mixin) {
        qx.Class.__P_107_8(clazz, mixin, false);
      },
      /**
      ...
      patch: function patch(clazz, mixin) {
        qx.Class.__P_107_8(clazz, mixin, true);
      ...
      */
      ...
      __P_107_10: qx.core.Environment.select("qx.debug", {
        "true": {
          "@": "object",
          "@construct": "object",
          "@destruct": "object",
      ...
      __P_107_11: qx.core.Environment.select("qx.debug", {
        "true": {
          "@": "object",
          type: "string",
          // String
       ...
       */
      __P_107_12: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          ...
          // Validate keys
          var allowed = config.type === "static" ? this.__P_107_11 : this.__P_107_10;
       ...
       */
      __P_107_13: qx.core.Environment.select("qx.debug", {
       ...
       */
      __P_107_3: function __P_107_3(clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __P_107_2: function __P_107_2(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__P_107_14();
            }
            clazz = this.__P_107_15(construct, name, type);
          ...
          if (statics) {
            ...
            for (var i = 0, a = Object.keys(statics), l = a.length; i < l; i++) {
              ...
              // Attach annotations
              this.__P_107_3(clazz, "statics", key, statics["@" + key]);
            }
          }
        }
      ...
      */
       ...
       */
      __P_107_6: function __P_107_6(clazz, events, patch) {
        if (clazz.$$events) {
      ...
      __P_107_7: function __P_107_7(clazz, objects) {
       ...
       */
      __P_107_4: function __P_107_4(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          if (config.event !== undefined) {
            ...
            this.__P_107_6(clazz, event, patch);
          }

          // Remember inheritable properties
          if (config.inheritable) {
            this.__P_107_0.$$inheritable[name] = true;
            if (!proto.$$refreshInheritables) {
              this.__P_107_0.attachRefreshInheritables(clazz);
            }
          }
          if (!config.refine) {
            this.__P_107_0.attachMethods(clazz, name, config);
          }

          // Add annotations
          this.__P_107_3(clazz, "properties", name, config["@"]);
        }
      },
      /**
       ...
       */
      __P_107_16: qx.core.Environment.select("qx.debug", {
        "true": function _true(clazz, name, config, patch) {
          ...
          // Check 0.7 keys
          var allowed = config.group ? this.__P_107_0.$$allowedGroupKeys : this.__P_107_0.$$allowedKeys;
          for (var key in config) {
       ...
       */
      __P_107_5: function __P_107_5(clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          if (key.charAt(0) === "@") {
            ...
            if (members[annoKey] === undefined) {
              this.__P_107_3(clazz, "members", annoKey, members[key]);
            }
            continue;
          }
          ...
          // Attach annotations
          this.__P_107_3(clazz, "members", key, members["@" + key]);
        }
      },
      /**
       ...
       */
      __P_107_9: function __P_107_9(clazz, iface) {
       ...
       */
      __P_107_8: function __P_107_8(clazz, mixin, patch) {
      ...
      */
       ...
       */
      __P_107_14: function __P_107_14() {
       ...
       */
      __P_107_15: function __P_107_15(construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1782967142989