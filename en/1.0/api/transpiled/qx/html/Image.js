    ...
    */
    ...
    members: {
      ...
      setPadding: function setPadding(paddingLeft, paddingTop) {
        this.__P_256_1 = paddingLeft;
        this.__P_256_0 = paddingTop;
      ...
      */
      ...
      _setSourceProperty: function _setSourceProperty(value) {
        ...
        if (source != null) {
          // Normalize "" to null
          source = source || null;
          styles.paddingTop = this.__P_256_0;
          styles.paddingLeft = this.__P_256_1;
...
//# sourceMappingURL=Image.js.map?dt=1782967149288