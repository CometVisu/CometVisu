    ...
    members: {
      ...
      */
      ...
      _createDomElement: function _createDomElement() {
        return qx.bom.Input.create(this.__P_257_0);
      },
      /**
      ...
      setEnabled: function setEnabled(value) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          if (!value) {
            ...
            this.setStyles({
              userModify: null,
              userSelect: this.__P_257_1 ? null : "none"
            });
          }
        }
      },
      ...
      setSelectable: qx.core.Environment.select("engine.name", {
        webkit: function webkit(value) {
          this.__P_257_1 = value;

          // Only apply the value when it is enabled
          qx.html.Input.superclass.prototype.setSelectable.call(this, this.__P_257_2 && value);
        },
...
//# sourceMappingURL=Input.js.map?dt=1782705779100