  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Serializer", {
    ...
    members: {
       ...
       * @returns {TagData}
       */
      __P_261_5: function __P_261_5() {
        return this.__P_261_2[this.__P_261_2.length - 1];
      },
      /**
       ...
       */
      __P_261_4: function __P_261_4(closeTag) {
        var _this = this;
        var tagData = this.__P_261_5();
        if (!tagData) {
          return;
        ...
        if (!tagData.openTagWritten) {
          ...
          this.write(tmp.join(" "));
          if (closeTag) {
            if (qx.html.Serializer.__P_261_6[tagData.tagName]) {
              this.write("/>");
            } else {
      ...
      peekQxObject: function peekQxObject() {
        return this.__P_261_1[this.__P_261_1.length - 1] || null;
      },
      /**
      ...
      getQxObjectIdFor: function getQxObjectIdFor(target) {
        ...
        if (stackTop === target) {
          var secondTop = this.__P_261_1.slice(-2)[0] || null;
        ...
        var stackFirst = this.__P_261_1[0];
        var tmp = target;
        do {
          var owner = tmp.getQxOwner();
          if (this.__P_261_1.indexOf(owner) < 0) {
            break;
    ...
    defer: function defer(statics) {
      ...
      ["area", "base", "br", "col", "embed", "hr", "img", "input", "link", "meta", "param", "source", "track", "wbr"].forEach(function (tagName) {
        statics.__P_261_6[tagName] = true;
      });
    }
  });
...
//# sourceMappingURL=Serializer.js.map?dt=1782967149480