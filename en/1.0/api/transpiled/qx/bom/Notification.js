    ...
    members: {
      ...
      _show: function _show(tag, title, message, icon, expire) {
        ...
        notification.onshow = function () {
          that.__P_128_0[tag] = notification;
          that.fireDataEvent("appear", tag);
        };
        notification.onclose = function () {
          that.fireDataEvent("close", tag);
          if (that.__P_128_0[tag]) {
            that.__P_128_0[tag] = null;
            delete that.__P_128_0[tag];
          }
        };
      ...
      close: function close(tag) {
        if (this.__P_128_0[tag]) {
          this.__P_128_0[tag].close();
        }
      },
      /**
...
//# sourceMappingURL=Notification.js.map?dt=1782967143615