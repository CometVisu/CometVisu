  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      this.__P_162_0();
      this.__P_162_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_162_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_162_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_162_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_162_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        this.__P_162_8 = null;
        this.__P_162_9 = url;
        if (this.__P_162_10("qx.debug.io")) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_162_9 = qx.util.Uri.appendParamsToUrl(this.__P_162_9, param);
        return this;
      },
      /**
       * Sends request.
      ...
      send: function send() {
        ...
        var script = this.__P_162_11(),
          head = this.__P_162_4,
          that = this;
        if (this.timeout > 0) {
          this.__P_162_12 = window.setTimeout(this.__P_162_3, this.timeout);
        }
        if (this.__P_162_10("qx.debug.io")) {
      ...
      setDetermineSuccess: function setDetermineSuccess(check) {
        this.__P_162_6 = check;
      },
      /**
       * Dispose object.
       */
      dispose: function dispose() {
        var script = this.__P_162_14;
        if (!this.__P_162_7) {
          ...
          if (this.__P_162_12) {
            window.clearTimeout(this.__P_162_12);
          }
          this.__P_162_7 = true;
        }
      },
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__P_162_14,
          determineSuccess = this.__P_162_6,
          that = this;
        ...
        if (this.__P_162_10("engine.name") === "mshtml" && this.__P_162_10("browser.documentmode") < 9) {
      ...
      */
       ...
       * Handle failure.
       */
      __P_162_15: function __P_162_15() {
        this.__P_162_13();
        this.readyState = 4;
        this.status = 0;
       ...
       */
      __P_162_5: function __P_162_5() {
        var isLegacyIe = this.__P_162_10("engine.name") === "mshtml" && this.__P_162_10("browser.documentmode") < 9;
        var isOpera = this.__P_162_10("engine.name") === "opera";
       ...
       */
      __P_162_11: function __P_162_11() {
        var script = this.__P_162_14 = document.createElement("script");
        script.src = this.__P_162_9;
        script.onerror = this.__P_162_2;
        script.onload = this.__P_162_1;

        // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event
        if (this.__P_162_10("engine.name") === "mshtml" && this.__P_162_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_162_1;
        }
        return script;
      },
      /**
       ...
       */
      __P_162_13: function __P_162_13() {
        var script = this.__P_162_14;
        if (script && script.parentNode) {
          this.__P_162_4.removeChild(script);
        }
      },
      /**
       ...
       */
      __P_162_10: function __P_162_10(key) {
...
//# sourceMappingURL=Script.js.map?dt=1782705774295