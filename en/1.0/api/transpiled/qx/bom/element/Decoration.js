  ...
  qx.Class.define("qx.bom.element.Decoration", {
    ...
    */
    ...
    statics: {
      ...
      __P_155_1: qx.core.Environment.select("engine.name", {
        mshtml: {
          "scale-x": true,
          "scale-y": true,
          scale: true,
      ...
      getTagName: function getTagName(repeat, source) {
        if (source && qx.core.Environment.get("css.alphaimageloaderneeded") && this.__P_155_1[repeat] && source.endsWith(".png")) {
          return "div";
        }
        return this.__P_155_2[repeat];
      },
      /**
      ...
      getAttributes: function getAttributes(source, repeat, style) {
        ...
        if (qx.core.Environment.get("css.alphaimageloaderneeded") && this.__P_155_1[repeat] && format === "png") {
          var dimension = this.__P_155_3(source);
          this.__P_155_4(style, dimension.width, dimension.height);
          result = this.processAlphaFix(style, repeat, source);
        } else {
          delete style.clip;
          if (repeat === "scale") {
            result = this.__P_155_5(style, repeat, source);
          } else if (repeat === "scale-x" || repeat === "scale-y") {
            result = this.__P_155_6(style, repeat, source);
          } else {
            // Native repeats or "no-repeat"
            result = this.__P_155_7(style, repeat, source);
          }
        }
        return result;
      },
       ...
       */
      __P_155_4: function __P_155_4(style, width, height) {
       ...
       */
      __P_155_3: function __P_155_3(source) {
       ...
       */
      __P_155_5: function __P_155_5(style, repeat, source) {
       ...
       * @return {Map} image URI and style infos
       */
      __P_155_6: function __P_155_6(style, repeat, sourceid) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        var clipped = ResourceManager.getCombinedFormat(sourceid);
        var dimension = this.__P_155_3(sourceid);
        var uri;
        if (clipped) {
          ...
          if (repeat === "scale-x") {
            style = this.__P_155_8(style, data, dimension.height);
          } else {
            style = this.__P_155_9(style, data, dimension.width);
          }
          return {
            src: uri,
            style: style
       ...
       */
      __P_155_8: function __P_155_8(style, data, height) {
       ...
       * @return {Map} style infos and image URI
       */
      __P_155_9: function __P_155_9(style, data, width) {
        // Use clipped image (multi-images on x-axis)
       ...
       * @return {Map} image URI and style infos
       */
      __P_155_7: function __P_155_7(style, repeat, sourceid) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        var clipped = ResourceManager.getCombinedFormat(sourceid);
        var dimension = this.__P_155_3(sourceid);
        ...
        if (clipped && repeat !== "repeat") {
          ...
          this.__P_155_4(style, dimension.width, dimension.height);
          this.__P_155_10(style, sourceid, repeat);
          return {
            style: style
          };
        }
       ...
       * @param source {String} image source
       */
      __P_155_10: function __P_155_10(style, source, repeat) {
...
//# sourceMappingURL=Decoration.js.map?dt=1782705774057