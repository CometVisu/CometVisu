  ...
  qx.Class.define("qx.test.bom.element.Dimension", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_329_0 = document.createElement("span");
        document.body.appendChild(this.__P_329_0);
        this.__P_329_1 = document.createElement("span");
        this.__P_329_1.style.padding = "2px";
        document.body.appendChild(this.__P_329_1);
        this.__P_329_2 = document.createElement("div");
        this.__P_329_2.style.width = "200px";
        document.body.appendChild(this.__P_329_2);
        this.__P_329_3 = document.createElement("div");
        this.__P_329_3.style.padding = "2px";
        this.__P_329_3.style.width = "200px";
        document.body.appendChild(this.__P_329_3);
      },
      tearDown: function tearDown() {
        document.body.removeChild(this.__P_329_0);
        this.__P_329_0 = null;
        document.body.removeChild(this.__P_329_1);
        this.__P_329_1 = null;
        document.body.removeChild(this.__P_329_2);
        this.__P_329_2 = null;
        document.body.removeChild(this.__P_329_3);
        this.__P_329_3 = null;
      },
      testContentWidthOfInlineElement: function testContentWidthOfInlineElement() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_329_0));
      },
      testContentWidthOfInlineElementWithPadding: function testContentWidthOfInlineElementWithPadding() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_329_1));
      },
      testContentWidthOfBlockElement: function testContentWidthOfBlockElement() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_329_2));
      },
      testContentWidthOfBlockElementWithPadding: function testContentWidthOfBlockElementWithPadding() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_329_3));
      },
...
//# sourceMappingURL=Dimension.js.map?dt=1782967152694