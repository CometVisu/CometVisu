  ...
  qx.Class.define("qx.test.bom.element.Style", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_330_0 = document.createElement("div");
        document.body.appendChild(this.__P_330_0);
      },
      tearDown: function tearDown() {
        document.body.removeChild(this.__P_330_0);
        this.__P_330_0 = null;
      },
      testSetStylesWithCss3: function testSetStylesWithCss3() {
        if (this.require(["cssBoxshadow"])) {
          ...
          qx.bom.element.Style.setStyles(this.__P_330_0, styles);
          ...
          this.assertEquals(expected, this.__P_330_0.style["boxShadow"]);
        }
      },
      testSetAndGetCss: function testSetAndGetCss() {
        var css = "font-weight: bold;";
        qx.bom.element.Style.setCss(this.__P_330_0, css);
        this.assertMatch(qx.bom.element.Style.getCss(this.__P_330_0), /font-weight.*?bold/i);
      },
      testSet: function testSet() {
        var name = "border";
        var style = ["1px", "solid", "red"];
        qx.bom.element.Style.set(this.__P_330_0, name, style.join(" "));
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
          this.assertEquals("red 1px solid", this.__P_330_0.style.border);
        } else {
          this.assertEquals(style.join(" "), this.__P_330_0.style.border);
        }
        this.assertEquals(style[0], this.__P_330_0.style.borderWidth);
        this.assertEquals(style[1], this.__P_330_0.style.borderStyle);
        this.assertEquals(style[2], this.__P_330_0.style.borderColor);
      },
      testGet: function testGet() {
        ...
        if (engine == "gecko" || engine == "opera" || engine == "webkit" && !isOldSafari && qx.core.Environment.get("browser.name") !== "edge") {
          expected = ["1px", "solid", "rgb(255, 0, 0)"];
        }
        qx.bom.element.Style.set(this.__P_330_0, name, style);
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && qx.core.Environment.get("browser.name") !== "edge") {
          this.assertEquals("red 1px solid", qx.bom.element.Style.get(this.__P_330_0, name));
        } else {
          this.assertEquals(expected.join(" "), qx.bom.element.Style.get(this.__P_330_0, name));
        }
        this.assertEquals(expected[0], qx.bom.element.Style.get(this.__P_330_0, "borderWidth"));
        this.assertEquals(expected[1], qx.bom.element.Style.get(this.__P_330_0, "borderStyle"));
        this.assertEquals(expected[2], qx.bom.element.Style.get(this.__P_330_0, "borderColor"));
      },
      testSetFloat: function testSetFloat() {
        qx.bom.element.Style.set(this.__P_330_0, "float", "left");
        this.assertEquals("left", this.__P_330_0.style["float"] || this.__P_330_0.style.styleFloat);
      },
      ...
      testGetFloat: function testGetFloat() {
        ...
        this.__P_330_0.className = "right";
        var floatValue = qx.bom.element.Style.get(this.__P_330_0, "float");
        this.assertEquals("right", floatValue);
        qx.bom.Stylesheet.removeSheet(sheet);
        this.__P_330_0.className = "";
      },
      ...
      testSetOpacity: function testSetOpacity() {
        ...
        qx.bom.element.Style.set(this.__P_330_0, "opacity", 1);
        this.assertEquals("1", this.__P_330_0.style.opacity);
      },
...
//# sourceMappingURL=Style.js.map?dt=1782705782815