  ...
  qx.Class.define("qx.test.bom.Label", {
    ...
    members: {
      setUp: function setUp() {
        ...
        this.__P_320_7 = {};
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_0);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_1);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_2);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_3);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_4);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_5);
        qx.lang.Object.mergeWith(this.__P_320_7, this.__P_320_6);
      },
      ...
      testMeasureSizeTextNormal: function testMeasureSizeTextNormal() {
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul") && qx.core.Environment.get("os.name") == "win") {
          ...
          size = qx.bom.Label.getTextSize(text, this.__P_320_4);
          this.assertEquals(94, size.width);
          this.assertEquals(24, size.height);
          size = qx.bom.Label.getTextSize(text, this.__P_320_3);
          this.assertEquals(64, size.width);
          this.assertEquals(13, size.height);
          size = qx.bom.Label.getTextSize(text, this.__P_320_5);
          this.assertEquals(53, size.width);
          this.assertEquals(14, size.height);
          size = qx.bom.Label.getTextSize(text, this.__P_320_6);
          this.assertEquals(53, size.width);
          this.assertEquals(14, size.height);
          size = qx.bom.Label.getTextSize(text, this.__P_320_7);
      ...
      testMeasureSizeTextBold: function testMeasureSizeTextBold() {
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul") && qx.core.Environment.get("os.name") == "win") {
          var text = "vanillebaer";
          var size = null;
          size = qx.bom.Label.getTextSize(text, this.__P_320_0);
      ...
      testMeasureSizeTextItalic: function testMeasureSizeTextItalic() {
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul") && qx.core.Environment.get("os.name") == "win") {
          var text = "vanillebaer";
          var size = null;
          size = qx.bom.Label.getTextSize(text, this.__P_320_1);
      ...
      testMeasureSizeTextBoldItalic: function testMeasureSizeTextBoldItalic() {
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul") && qx.core.Environment.get("os.name") == "win") {
          var text = "vanillebaer";
          var size = null;
          size = qx.bom.Label.getTextSize(text, this.__P_320_2);
          this.assertEquals(64, size.width);
          this.assertEquals(13, size.height);
        } else {
          this.assertTrue(true);
      ...
      testMeasureSizeTextFontSize: function testMeasureSizeTextFontSize() {
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul") && qx.core.Environment.get("os.name") == "win") {
          var text = "vanillebaer";
          var size = null;
          size = qx.bom.Label.getTextSize(text, this.__P_320_8);
          this.assertEquals(53, size.width);
          this.assertEquals(14, size.height);
        } else {
          this.assertTrue(true);
...
//# sourceMappingURL=Label.js.map?dt=1782967152470