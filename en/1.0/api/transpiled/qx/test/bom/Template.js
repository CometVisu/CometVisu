  ...
  qx.Class.define("qx.test.bom.Template", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        if (this.__P_324_0) {
          qx.dom.Element.removeChild(this.__P_324_0, document.body);
        }
      },
      /**
       * render()
      ...
      testGet: function testGet() {
        // add template
        this.__P_324_0 = qx.dom.Element.create("div");
        qx.bom.element.Attribute.set(this.__P_324_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__P_324_0, "display", "none");
        this.__P_324_0.innerHTML = "<div>{{a}}</div>";
        qx.dom.Element.insertEnd(this.__P_324_0, document.body);
      ...
      testGetMixed: function testGetMixed() {
        ...
        qx.bom.element.Attribute.set(this.__P_324_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__P_324_0, "display", "none");
        this.__P_324_0.innerHTML = "<div>{{a}}<span>{{b}}</span></div>";
        qx.dom.Element.insertEnd(this.__P_324_0, document.body);
...
//# sourceMappingURL=Template.js.map?dt=1782967152569