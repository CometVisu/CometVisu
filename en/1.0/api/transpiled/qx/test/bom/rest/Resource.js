  ...
  qx.Class.define("qx.test.bom.rest.Resource", {
    ...
    members: {
      ...
      setUpDoubleRequest: function setUpDoubleRequest() {
        ...
        this.__P_332_0 = this.__P_332_0 || [];
        this.__P_332_0.push(this.req);
        return req;
      },
      ...
      tearDown: function tearDown() {
        ...
        this.res.dispose();
        this.__P_332_0.forEach(function (req) {
          req.dispose();
        });
      },
      //
      ...
      "test: fire started": function test_fire_started() {
        qx.bom.request.SimpleXhr.restore();
        var res = this.res,
          req = this.req,
          that = this;
...
//# sourceMappingURL=Resource.js.map?dt=1782705783148