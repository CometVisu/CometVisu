  ...
  qx.Class.define("qx.test.log.DeprecationMethodOverriding", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_364_1 = qx.log.Logger.warn;
        this.__P_364_2 = qx.log.Logger.trace;
        var that = this;
      ...
      tearDown: function tearDown() {
        qx.log.Logger.warn = this.__P_364_1;
        qx.log.Logger.trace = this.__P_364_2;
        this.__P_364_1 = null;
        this.__P_364_2 = null;
        this.__P_364_0 = null;
      },
      ...
      "testClassC1: doesn't override method": function testClassC1_doesnT_override_method() {
        ...
        this.__P_364_3(instance, 2, 3, /qx.test.log.fixture.ClassB1._applyOldProperty/);
        instance.dispose();
      },
      "testClassB2: doesn't override method": function testClassB2_doesnT_override_method() {
        ...
        this.__P_364_3(instance, 1, 2, null);
        instance.dispose();
      },
      "testClassC2: overrides method": function testClassC2_overrides_method() {
        var instance = new qx.test.log.fixture.ClassC2();
        this.__P_364_3(instance, 2, 3, /qx.test.log.fixture.ClassC2._applyOldProperty/);
        instance.dispose();
      },
      __P_364_3: function __P_364_3(instance, callCountOldProperty, callCountNewProperty, reqExpWarnMsg) {
...
//# sourceMappingURL=DeprecationMethodOverriding.js.map?dt=1782705785938