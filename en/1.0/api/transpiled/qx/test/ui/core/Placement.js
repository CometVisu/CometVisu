  ...
  qx.Class.define("qx.test.ui.core.Placement", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_397_0 = new qx.ui.core.Widget().set({
          backgroundColor: "red",
          width: 100,
          height: 300
        });
        ...
        qx.ui.core.MPlacement.setVisibleElement(this.__P_397_0);
      },
      ...
      __P_397_1: function __P_397_1(w) {
      ...
      __P_397_2: function __P_397_2(w) {
        // force an addition to the dom!
        w.show();
        w.hide();
        // modify the placed widget
      ...
      __P_397_3: function __P_397_3(w) {
        // force an addition to the dom!
        w.show();
        w.hide();
        this.__P_397_0.setLayoutProperties({
          top: 100
        });
      ...
      __P_397_4: function __P_397_4(w) {
        // force an addition to the dom!
        w.show();
        w.hide();
        // modify the placed widget
...
//# sourceMappingURL=Placement.js.map?dt=1782705787537