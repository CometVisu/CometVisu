  ...
  qx.Class.define("qx.test.ui.core.AbstractScrollArea", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_394_1 = new qx.ui.container.Composite(new qx.ui.layout.Grow());
        this.__P_394_1.set({
          maxWidth: 100,
          maxHeight: 100,
          width: 100,
        ...
        this.__P_394_0 = new qx.test.ui.core.AbstractScrollArea.fixture.CustomWidget();
        this.__P_394_1.add(this.__P_394_0);
        this.getRoot().add(this.__P_394_1);
      ...
      "test default behaviour": function test_default_behaviour() {
        ...
        this.__P_394_0.setSingleChild(inner);
        this.flush();
        this.assertBounds(inner, this.__P_394_0);
      },
      "test smaller widget than container": function test_smaller_widget_than_container() {
        ...
        this.flush();
        this.assertBounds(inner, this.__P_394_0);
        this.assertFalse(this.__P_394_0.hasScrollBar("x"));
        this.assertFalse(this.__P_394_0.hasScrollBar("y"));
      },
      "test bigger widget than container": function test_bigger_widget_than_container() {
        ...
        this.assertTrue(this.__P_394_0.hasScrollBar("x"));
        this.assertTrue(this.__P_394_0.hasScrollBar("y"));
      },
      ...
      "test bigger widget than smaller preferred container": function test_bigger_widget_than_smaller_preferred_container() {
        ...
        this.__P_394_1.resetMaxWidth();
        this.__P_394_1.resetMaxHeight();
        this.flush();
        this.assertBounds({
          left: 0,
          top: 0,
...
//# sourceMappingURL=AbstractScrollArea.js.map?dt=1782967156935