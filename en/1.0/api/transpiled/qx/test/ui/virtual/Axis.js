  ...
  qx.Class.define("qx.test.ui.virtual.Axis", {
    ...
    members: {
      ...
      testItemAtPosition: function testItemAtPosition() {
        ...
        // in the middle
        this.assertItem(500, 5, this.axis.getItemAtPosition(5005));

        // position at the edge
        this.assertItem(0, 0, this.axis.getItemAtPosition(0));
        this.assertItem(999, 9, this.axis.getItemAtPosition(9999));
        ...
        this.assertNull(this.axis.getItemAtPosition(10100));
...
//# sourceMappingURL=Axis.js.map?dt=1782967158912