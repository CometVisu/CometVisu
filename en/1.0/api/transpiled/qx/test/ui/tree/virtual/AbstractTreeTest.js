    ...
    members: {
      ...
      */
      _createNodes: function _createNodes(parent, level) {
        if (level > 0) {
          for (var i = 0; i < 5; i++) {
            var item = new qx.test.ui.tree.virtual.Node("Node " + this.__P_446_0(parent) + i);
      ...
      _createLeafs: function _createLeafs(parent) {
        for (var i = 0; i < 5; i++) {
          var child = new qx.test.ui.tree.virtual.Leaf("Leaf " + this.__P_446_0(parent) + i);
          parent.getChildren().push(child);
        }
      },
      __P_446_0: function __P_446_0(item) {
...
//# sourceMappingURL=AbstractTreeTest.js.map?dt=1782705789363