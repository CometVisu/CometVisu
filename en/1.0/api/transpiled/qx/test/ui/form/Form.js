(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Form", {
    ...
    members: {
      __P_409_0: function __P_409_0(widget) {
      ...
      __P_409_1: function __P_409_1(widget, where) {
        // check if the interface is implemented
        this.assert(qx.Class.hasInterface(widget.constructor, qx.ui.form.IForm), "Interface not implemented.");
      ...
      __P_409_2: function __P_409_2(widget) {
        this.flush();
      ...
      testRequiredRadioGroup: function testRequiredRadioGroup() {
        this.__P_409_0(new qx.ui.form.RadioGroup());
      },
      testRequiredRadioButtonGroup: function testRequiredRadioButtonGroup() {
        this.__P_409_0(new qx.ui.form.RadioButtonGroup());
      },
...
//# sourceMappingURL=Form.js.map?dt=1782705788167