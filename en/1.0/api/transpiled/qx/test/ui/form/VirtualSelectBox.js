  ...
  qx.Class.define("qx.test.ui.form.VirtualSelectBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_429_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_429_0);
        this.flush();
      },
      tearDown: function tearDown() {
        qx.test.ui.form.VirtualSelectBox.superclass.prototype.tearDown.call(this);
        this.__P_429_0.destroy();
        this.__P_429_0 = null;
      },
      __P_429_1: function __P_429_1() {
        // focus -> array key down -> array key down -> enter
        this.__P_429_0.getSelection().setItem(0, this.__P_429_0.getModel().getItem(1));
      },
      testChangeValueEvent: function testChangeValueEvent() {
        var m = qx.data.marshal.Json.createModel(["a", "b"]);
        this.__P_429_0.addListenerOnce("changeValue", function (e) {
          this.assertIdentical("a", e.getData());
          this.assertNull(e.getOldData());
        }.bind(this));
        this.__P_429_0.setModel(m);
        this.__P_429_0.addListenerOnce("changeValue", function (e) {
      ...
      "test dropdown list same width as selectbox": function test_dropdown_list_same_width_as_selectbox() {
        ...
        this.__P_429_0.setAllowGrowDropDown(false);
        this.__P_429_0.setModel(m);
        this.__P_429_0.setWidth(150);
        this.__P_429_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_429_0.getWidth(), test.__P_429_0.getBounds().width);
          test.assertIdentical(test.__P_429_0.getWidth(), test.__P_429_0.getChildControl("dropdown").getBounds().width);
          test.resume();
        }, 10);
        this.wait();
      },
      "test dropdown list wider than selectbox": function test_dropdown_list_wider_than_selectbox() {
        ...
        this.__P_429_0.setAllowGrowDropDown(true);
        this.__P_429_0.setModel(m);
        this.__P_429_0.setWidth(150);
        this.__P_429_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_429_0.getWidth(), test.__P_429_0.getBounds().width);
          test.assertTrue(test.__P_429_0.getChildControl("dropdown").getBounds().width > 666, "dropdown could not fit the whole item");
          test.resume();
        }, 10);
        this.wait();
      }
...
//# sourceMappingURL=VirtualSelectBox.js.map?dt=1782705788593