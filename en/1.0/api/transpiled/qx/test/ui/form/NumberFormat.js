(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.NumberFormat", {
    ...
    members: {
      __P_417_0: function __P_417_0(widget) {
      ...
      testSpinner: function testSpinner() {
        this.__P_417_0(new qx.ui.form.Spinner());
      },
      testSlider: function testSlider() {
        this.__P_417_0(new qx.ui.form.Slider());
      }
    }
  });
...
//# sourceMappingURL=NumberFormat.js.map?dt=1782705788373