  ...
  qx.Class.define("qx.test.ui.form.virtual.VirtualDropDownList", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_431_0 = new qx.ui.form.core.AbstractVirtualBoxMock();
        this.__P_431_1 = new qx.ui.form.core.VirtualDropDownList(this.__P_431_0);
        this.__P_431_2 = this.__P_431_3();
        this.__P_431_1.getChildControl("list").setModel(this.__P_431_2);
      ...
      testCreation: function testCreation() {
        var model = this.__P_431_2;
        var listModel = this.__P_431_1.getChildControl("list").getModel();
        this.assertEquals(model, listModel, "Model instance not equals!");
        this.__P_431_4(model);
      },
      testCreationWithSorter: function testCreationWithSorter() {
        var sortedModel = this.__P_431_5();
        this.__P_431_4(sortedModel);
        sortedModel.dispose();
      },
      testCreationWithFilter: function testCreationWithFilter() {
        var filteredModel = this.__P_431_6();
        this.__P_431_4(filteredModel);
        filteredModel.dispose();
      },
      __P_431_4: function __P_431_4(model) {
        var list = this.__P_431_1.getChildControl("list");
        this.assertModelEqualsRowData(model, list);
        this.__P_431_7(model.getItem(0));
      },
      testSelection: function testSelection() {
        this.__P_431_8(this.__P_431_2);
      },
      testSelectionWithSorter: function testSelectionWithSorter() {
        var sortedModel = this.__P_431_5();
        this.__P_431_8(sortedModel);
        sortedModel.dispose();
      },
      testSelectionWithFilter: function testSelectionWithFilter() {
        ...
        this.__P_431_4(filteredModel);
        var model = this.__P_431_2;
        var selection = this.__P_431_1.getSelection();
        var invalidItem = model.getItem(2);
        this.assertFalse(filteredModel.contains(invalidItem));
        var that = this;
        this.__P_431_9(selection, function () {
          selection.push(invalidItem);
        }, 2);
        this.__P_431_7(filteredModel.getItem(0));
        filteredModel.dispose();
      },
      __P_431_8: function __P_431_8(model) {
        var selection = this.__P_431_1.getSelection();
        var that = this;
      ...
      __P_431_7: function __P_431_7(item) {
        this.assertTrue(this.__P_431_2.contains(item), "The itme '" + item + "' is not in the model!");
        var modelIndex = this.__P_431_2.indexOf(item);
        var selection = this.__P_431_1.getSelection();
        var listSelection = this.__P_431_1.getChildControl("list").getSelection();
        this.assertEquals(1, selection.getLength(), "Selection length not equals!");
        this.assertEquals(this.__P_431_2.getItem(modelIndex), selection.getItem(0), "Selection instance not equals!");
      ...
      __P_431_9: function __P_431_9(target, callback, fired) {
        var count = 0;
      ...
      __P_431_5: function __P_431_5() {
        ...
        this.__P_431_1.getChildControl("list").setDelegate({
          sorter: sorter
        });
        var sortedModel = this.__P_431_2.copy();
      ...
      __P_431_6: function __P_431_6() {
        ...
        for (var i = 0; i < this.__P_431_2.getLength(); i++) {
          var item = this.__P_431_2.getItem(i);
          if (filter(item)) {
...
//# sourceMappingURL=VirtualDropDownList.js.map?dt=1782967158031