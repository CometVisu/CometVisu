(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.Executable", {
    ...
    members: {
      __P_408_0: function __P_408_0(widget) {
      ...
      testToggleButton: function testToggleButton() {
        this.__P_408_0(new qx.ui.form.ToggleButton());
      },
      testCheckBox: function testCheckBox() {
        this.__P_408_0(new qx.ui.form.CheckBox());
      },
      testButton: function testButton() {
        this.__P_408_0(new qx.ui.form.Button());
      },
      testRepeatButton: function testRepeatButton() {
        this.__P_408_0(new qx.ui.form.RepeatButton());
      },
      testMenuButton: function testMenuButton() {
        this.__P_408_0(new qx.ui.form.MenuButton());
      },
      testRadioButton: function testRadioButton() {
        this.__P_408_0(new qx.ui.form.RadioButton());
      },
      testToolbarButton: function testToolbarButton() {
        this.__P_408_0(new qx.ui.toolbar.Button());
      },
      testSplitButton: function testSplitButton() {
        this.__P_408_0(new qx.ui.toolbar.SplitButton());
      },
      testMenuCheckBox: function testMenuCheckBox() {
        this.__P_408_0(new qx.ui.menu.CheckBox());
      },
      testMenuRadioButton: function testMenuRadioButton() {
        this.__P_408_0(new qx.ui.menu.RadioButton());
      },
      testButtonInMenu: function testButtonInMenu() {
        this.__P_408_0(new qx.ui.menu.Button());
      },
      testCheckGroupBox: function testCheckGroupBox() {
        this.__P_408_0(new qx.ui.groupbox.CheckGroupBox());
      },
      testRadioGroupBox: function testRadioGroupBox() {
        this.__P_408_0(new qx.ui.groupbox.RadioGroupBox());
      },
      testDateChooser: function testDateChooser() {
        this.__P_408_0(new qx.ui.control.DateChooser());
      }
    }
  });
...
//# sourceMappingURL=Executable.js.map?dt=1782705787756