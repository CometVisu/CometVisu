  ...
  qx.Class.define("qx.test.ui.form.DateField", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_407_0 = new qx.ui.form.DateField();
        this.getRoot().add(this.__P_407_0);
      },
      tearDown: function tearDown() {
        this.__P_407_0.destroy();
      ...
      formatDate: function formatDate(date) {
        return this.__P_407_0.getDateFormat().format(date);
      },
...
//# sourceMappingURL=DateField.js.map?dt=1782967157223