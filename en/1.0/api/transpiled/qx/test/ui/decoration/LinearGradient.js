  ...
  qx.Class.define("qx.test.ui.decoration.LinearGradient", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_399_0 = new qx.ui.core.Widget();
        this.__P_399_0.setHeight(100);
        this.__P_399_1 = new qx.ui.decoration.Decorator();
        this.__P_399_1.set({
          startColor: "red",
          endColor: "black"
        });
        this.getRoot().add(this.__P_399_0);
      },
      tearDown: function tearDown() {
        this.__P_399_0.destroy();
      ...
      testDefault: function testDefault() {
        ...
        this.__P_399_0.setDecorator(this.__P_399_1);
        this.flush();
      },
...
//# sourceMappingURL=LinearGradient.js.map?dt=1782705787654