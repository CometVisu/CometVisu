  ...
  qx.Class.define("qx.test.util.LibraryManager", {
    ...
    members: {
      ...
      testHas: function testHas() {
        this.assert(this.__P_461_0.has("qx"));
        this.assertFalse(this.__P_461_0.has("foo"));
      },
      testGet: function testGet() {
        for (var i = 0, l = this.libKeys.length; i < l; i++) {
          var key = this.libKeys[i];
          this.assertEquals(qx.$$libraries.qx[key], this.__P_461_0.get("qx", key));
        }
      },
      testSet: function testSet() {
        for (var i = 0, l = this.libKeys.length; i < l; i++) {
          var key = this.libKeys[i];
          this.__P_461_0.set("qx", key, "foo");
          this.assertEquals("foo", qx.$$libraries.qx[key]);
        }
      },
      tearDownTestSet: function tearDownTestSet() {
        for (var key in this.__P_461_1) {
          qx.$$libraries.qx[key] = this.__P_461_1[key];
        }
      }
    }
  });
...
//# sourceMappingURL=LibraryManager.js.map?dt=1782967159499