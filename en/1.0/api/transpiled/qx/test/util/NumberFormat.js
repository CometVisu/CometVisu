  ...
  qx.Class.define("qx.test.util.NumberFormat", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_462_1 = qx.locale.Manager.getInstance().getLocale();
        qx.locale.Manager.getInstance().setLocale("de_DE");
        this.__P_462_0 = new qx.util.format.NumberFormat();
      },
      tearDown: function tearDown() {
        this.__P_462_0.dispose();
        qx.locale.Manager.getInstance().setLocale(this.__P_462_1);
      },
...
//# sourceMappingURL=NumberFormat.js.map?dt=1782967159514