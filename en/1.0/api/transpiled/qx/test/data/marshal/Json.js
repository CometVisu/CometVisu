  ...
  qx.Class.define("qx.test.data.marshal.Json", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_345_0 = new qx.data.marshal.Json();
        this.__P_345_1 = {
          s: "String",
          n: 12,
          b: true
        };
        this.__P_345_2 = ["s", "n", "b"];
      },
      tearDown: function tearDown() {
        this.__P_345_0.dispose();
      ...
      testClassCreationSingle: function testClassCreationSingle() {
        ...
        var i = 0;
        for (var name in clazz.$$properties) {
          this.assertEquals(this.__P_345_2[i], name, "Property " + i + "does have the wrong name.");
          this.assertEquals("change" + qx.lang.String.firstUp(this.__P_345_2[i]), clazz.$$properties[name].event, "event has a wrong name.");
          i++;
        }
      },
      ...
      testModelWithNumber: function testModelWithNumber() {
        ...
        this.__P_345_0.toClass(this.__P_345_1);
        // set the data
        var model = this.__P_345_0.toModel(this.__P_345_1);
      ...
      testBubbleEventsDepth1: function testBubbleEventsDepth1() {
        ...
        // first create the classes before setting the data
        this.__P_345_0.toClass(this.__P_345_1, true);
        // set the data
        var model = this.__P_345_0.toModel(this.__P_345_1);
      ...
      testAddValidationRule: function testAddValidationRule() {
        ...
        this.__P_345_0.dispose();
        this.__P_345_0 = new qx.data.marshal.Json(delegate);
        this.__P_345_0.toClass(this.__P_345_1);
        var model = this.__P_345_0.toModel(this.__P_345_1);
      ...
      testNonPojoObjects: function testNonPojoObjects() {
...
//# sourceMappingURL=Json.js.map?dt=1782967153958