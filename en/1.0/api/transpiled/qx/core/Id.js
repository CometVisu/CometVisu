  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      getAbsoluteIdOf: function getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__P_178_1 && this.__P_178_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_178_1 && this.__P_178_1[owner.toHashCode()] || null;
            }
      ...
      register: function register(obj, id) {
        ...
        this.__P_178_0[id] = obj;
        this.__P_178_1[obj.toHashCode()] = id;
      ...
      unregister: function unregister(data) {
        ...
        if (obj) {
          ...
          delete this.__P_178_1[obj.toHashCode()];
          obj._cascadeQxObjectIdChanges();
          return true;
        }
        return false;
...
//# sourceMappingURL=Id.js.map?dt=1782705774764