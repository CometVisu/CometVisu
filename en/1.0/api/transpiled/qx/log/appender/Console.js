  ...
  qx.Class.define("qx.log.appender.Console", {
    statics: {
      ...
      */
      ...
      init: function init() {
        ...
        this.__P_291_0 = main;
        this.__P_291_1 = main.childNodes[1];
        this.__P_291_2 = main.childNodes[2].firstChild;
      ...
      dispose: function dispose() {
        qx.event.Registration.removeListener(document.documentElement, "keypress", this.__P_291_5, this);
      ...
      */
      ...
      process: function process(entry) {
        ...
        this.__P_291_1.appendChild(formatter.toHtml(entry));
      ...
      __P_291_6: function __P_291_6() {
        this.__P_291_1.scrollTop = this.__P_291_1.scrollHeight;
      },
      /*
      ---------------------------------------------------------------------------
        VISIBILITY TOGGLING
      ...
      */
      ...
      toggle: function toggle() {
        if (!this.__P_291_0) {
          this.init();
        } else if (this.__P_291_0.style.display == "none") {
          this.show();
        } else {
          this.__P_291_0.style.display = "none";
        }
      },
      /**
       * Shows the console.
      ...
      show: function show() {
        if (!this.__P_291_0) {
          ...
          this.__P_291_0.style.display = "block";
          this.__P_291_1.scrollTop = this.__P_291_1.scrollHeight;
        }
      },
      /*
      ...
      */
      ...
      execute: function execute() {
        var value = this.__P_291_2.value;
        if (value == "") {
          return;
        }
        if (value == "clear") {
        ...
        this.__P_291_8.push(value);
        this.__P_291_3 = this.__P_291_8.length;
        this.__P_291_1.appendChild(command);
        this.__P_291_6();
        try {
      ...
      */
       ...
       */
      __P_291_4: function __P_291_4(e) {
        this.__P_291_1.style.height = this.__P_291_0.clientHeight - this.__P_291_0.firstChild.offsetHeight - this.__P_291_0.lastChild.offsetHeight + "px";
      },
      /**
       ...
       * @param e {Event} Event object
       */
      __P_291_5: function __P_291_5(e) {
        ...
        if (!qx.dom.Hierarchy.contains(this.__P_291_0, e.getTarget())) {
          return;
        }

        // Command execution
        if (iden == "Enter" && this.__P_291_2.value != "") {
          this.execute();
          this.__P_291_2.value = "";
        }

        // History management
        if (iden == "Up" || iden == "Down") {
          this.__P_291_3 += iden == "Up" ? -1 : 1;
          this.__P_291_3 = Math.min(Math.max(0, this.__P_291_3), this.__P_291_8.length);
          var entry = this.__P_291_8[this.__P_291_3];
          this.__P_291_2.value = entry || "";
          this.__P_291_2.select();
        }
      }
    },
    /*
    ...
    */
    defer: function defer(statics) {
      qx.event.Registration.addListener(document.documentElement, "keypress", statics.__P_291_5, statics);
      qx.event.Registration.addListener(document.documentElement, "longtap", statics.__P_291_5, statics);
    }
  });
  qx.log.appender.Console.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Console.js.map?dt=1782967150729