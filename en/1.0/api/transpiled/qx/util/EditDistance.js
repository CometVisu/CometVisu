  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.EditDistance", {
    statics: {
       ...
       */
      __P_749_0: function __P_749_0(dataA, dataB) {
       ...
       */
      __P_749_1: function __P_749_1(distance, dataA, dataB) {
        var operations = [];
      ...
      getEditOperations: function getEditOperations(dataA, dataB) {
        var distance = this.__P_749_0(dataA, dataB);
        var operations = this.__P_749_1(distance, dataA, dataB);
        return operations;
      }
    }
  });
...
//# sourceMappingURL=EditDistance.js.map?dt=1782705804685