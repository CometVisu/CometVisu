  ...
  qx.Class.define("qx.tool.compiler.app.Application", {
    ...
    construct: function construct(classname) {
      ...
      args.forEach(function (arg) {
        if (qx.lang.Type.isArray(arg)) {
          qx.lang.Array.append(t.__P_495_0, arg);
        } else {
          t.__P_495_0.push(arg);
        }
      });
      this.set({
        include: [],
    ...
    members: {
      ...
      calcDependencies: function calcDependencies() {
        ...
        if (this.__P_495_3 && this.__P_495_3.length) {
          parts = [];
          t.__P_495_3.forEach(function (part) {
        ...
        exclude = {};
        t.__P_495_7(t.getExclude()).forEach(function (name) {
        ...
        */
        ...
        this.__P_495_2 = allDeps.toArray();
        var requiredLibs = {};
        this.__P_495_2.forEach(function (classname) {
        ...
        for (var ns in requiredLibs) {
          if (analyser.findLibrary(ns)) {
            this.__P_495_4.push(ns);
          } else {
            Console.print("qx.tool.compiler.application.missingRequiredLibrary", ns);
          }
        }
        this.__P_495_6 = parts;
        this.__P_495_5 = fatalCompileErrors.length ? fatalCompileErrors : null;
      },
      /**
      ...
      getAssetUris: function getAssetUris(target, resManager, environment) {
        ...
        var classNames = this.__P_495_2.slice();
      ...
      getRequiredClasses: function getRequiredClasses() {
        var result = {};
        this.__P_495_0.forEach(function (name) {
          return result[name] = true;
        });
        this.__P_495_7(this.getInclude()).forEach(function (name) {
          return result[name] = true;
        });
        this.__P_495_7(this.getExclude()).forEach(function (name) {
       ...
       * @return String[]
       */
      __P_495_7: function __P_495_7(names) {
        var t = this;
        var result = {};
       ...
       */
      __P_495_1: function __P_495_1(value) {
        if (!value) {
          return null;
        }
        if (!qx.lang.Type.isArray(value)) {
...
//# sourceMappingURL=Application.js.map?dt=1782967162858