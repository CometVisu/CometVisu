...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.ClassFile", {
    ...
    construct: function construct(analyser, className, library) {
      ...
      this.__P_489_0 = analyser;
      this.__P_489_1 = className;
      this.__P_489_2 = [];
      this.__P_489_3 = {};
      this.__P_489_4 = library;
      this.__P_489_5 = analyser.getClassSourcePath(library, className);
      this.__P_489_6 = {};
      this.__P_489_7 = {
        provided: {},
        required: {}
      ...
      this.__P_489_15 = {};
      this.__P_489_16 = [];
      this.__P_489_17 = async.queue(function (task, cb) {
        task(cb);
      });
      this.__P_489_17.drain = this._onTaskQueueDrain;
      this.__P_489_17.error = function (err) {
    ...
    members: {
      ...
      _waitForTaskQueueDrain: function _waitForTaskQueueDrain(cb) {
        if (this.__P_489_17.length() == 0) {
          cb();
        } else {
          this.__P_489_16.push(cb);
        }
      },
      _queueTask: function _queueTask(cb) {
        this.__P_489_17.push(cb);
      },
      /**
      ...
      getOutputPath: function getOutputPath() {
        return this.__P_489_0.getClassOutputPath(this.__P_489_1);
      },
      /**
      ...
      load: function load(callback) {
        ...
        fs.readFile(this.getSourcePath(), {
          ...
          var result;
          try {
            var babelConfig = t.__P_489_0.getBabelConfig() || {};
          ...
          if (!t.__P_489_3[className]) {
            t.addMarker("compiler.wrongClassName", null, className, Object.keys(t.__P_489_3).join(", "));
            t._compileDbClassInfo();
          }
          ...
          qx.tool.utils.Utils.mkParentPath(outputPath, function (err) {
            ...
            if (qx.lang.Array.contains(t.__P_489_0.getApplicationTypes(), "browser")) {
      ...
      writeDbInfo: function writeDbInfo(dbClassInfo) {
        ...
        for (var key in this.__P_489_28) {
          dbClassInfo[key] = this.__P_489_28[key];
        }
      },
      /**
      ...
      _compileDbClassInfo: function _compileDbClassInfo() {
        var t = this;
        var dbClassInfo = this.__P_489_28 = {};
        ...
        // Environment Checks
        if (Object.keys(this.__P_489_7.provided).length || Object.keys(this.__P_489_7.required).length) {
          dbClassInfo.environment = {
            provided: [],
            required: {}
          };
          for (var key in this.__P_489_7.provided) {
            dbClassInfo.environment.provided.push(key);
          }
          for (var _key in this.__P_489_7.required) {
            dbClassInfo.environment.required[_key] = this.__P_489_7.required[_key];
          }
        }
        ...
        for (var _name in this.__P_489_13.unresolved) {
          var item = this.__P_489_13.unresolved[_name];
          // item is undefined if it has already been removed from the list
          if (item === undefined) {
            continue;
          }
          // One of multiple classes defined in this file
          if (this.__P_489_3[_name]) {
            continue;
          }
          var info = t.__P_489_0.getSymbolType(_name);
        ...
        // Fonts
        var fontNames = Object.keys(this.__P_489_9);
        if (fontNames.length) {
          dbClassInfo.fonts = fontNames;
          for (var fontName in this.__P_489_9) {
            if (!this.__P_489_0.getFont(fontName)) {
              t.addMarker("fonts.unresolved#" + fontName, this.__P_489_9[fontName].loc.start, fontName);
            }
          }
        }
        if (meta) {
        ...
        if (this.__P_489_14.length) {
          dbClassInfo.externals = this.__P_489_14;
        }

        // Translation
        if (this.__P_489_10.length) {
          dbClassInfo.translations = this.__P_489_10.slice(0);
        }

        // Markers
        if (this.__P_489_11.length) {
          dbClassInfo.markers = qx.lang.Array.clone(this.__P_489_11);
        }
        ...
        // CommonJS modules
        if (Object.keys(this.__P_489_15).length > 0) {
          dbClassInfo.commonjsModules = {};
          for (var moduleName in this.__P_489_15) {
            dbClassInfo.commonjsModules[moduleName] = _toConsumableArray(this.__P_489_15[moduleName]);
          }
        }
        return dbClassInfo;
      },
      ...
      getOuterClassMeta: function getOuterClassMeta() {
        var src = this.__P_489_3[this.__P_489_1] || null;
        if (!src) {
          return src;
        }
        var dest = {};
      ...
      _babelClassPlugins: function _babelClassPlugins() {
        ...
        function enterFunction(path, node, idNode) {
          ...
          var isClassMember = t.__P_489_26 && t.__P_489_26._topLevel && t.__P_489_26._topLevel.keyName == "members" && path.parentPath.parentPath.parentPath == t.__P_489_26._topLevel.path;
          if (idNode) {
          ...
          if (((_node$key = node.key) === null || _node$key === void 0 ? void 0 : _node$key.name) === "_createQxObjectImpl" && t.__P_489_26.type !== "interface") {
            var _t$__P_489_26$classNa;
            if (t.__P_489_26.type === "mixin") {
              if (t.__P_489_26.className === "qx.core.MObjectId") {
                return;
              }
              qx.tool.compiler.Console.print("qx.tool.compiler.compiler.mixinQxObjectImpl", t.__P_489_26.className);
            }
            var injectCode = "{\n            let object = qx.core.MObjectId.handleObjects(".concat((_t$__P_489_26$classNa = t.__P_489_26.className) !== null && _t$__P_489_26$classNa !== void 0 ? _t$__P_489_26$classNa : "this.constructor", ", this, ...arguments);\n            if (object !== undefined) {\n              return object;\n            }\n          }");
        ...
        function makeMeta(sectionName, functionName, node) {
          var meta;
          if (functionName) {
            var section = t.__P_489_26[sectionName];
            if (section === undefined) {
              section = t.__P_489_26[sectionName] = {};
            }
        ...
        var COLLECT_CLASS_NAMES_VISITOR = {
          MemberExpression: function MemberExpression(path) {
            ...
            var info = t.__P_489_0.getSymbolType(str);
        ...
        var CODE_ELIMINATION_VISITOR = {
          ...
          CallExpression: function CallExpression(path) {
            ...
            var env = t.__P_489_0.getEnvironment();
        ...
        function collectJson(node, isProperties, jsonPath) {
          ...
          if (node.type == "ObjectExpression") {
            ...
            t.warn("Cannot interpret AST " + node.type + " at " + t.__P_489_1 + (node.loc ? " [" + node.loc.start.line + "," + node.loc.start.column + "]" : ""));
            result = null;
          }
          return result;
        }
        ...
        function ensureCreateQxObjectImpl(membersPropertyPath) {
          ...
          if (!memberNames) {
            t.addMarker("compiler.membersNotAnObject", membersPropertyPath.loc, t.__P_489_26.type);
            return;
          }
        ...
        function checkValidTopLevel(path) {
          ...
          var allowedKeys = ALLOWED_KEYS[t.__P_489_26.type];
          if (t.__P_489_26.type === "class") {
            allowedKeys = allowedKeys[t.__P_489_26.isStatic ? "static" : "normal"];
          }
          if (allowedKeys[keyName] === undefined) {
            t.addMarker("compiler.invalidClassDefinitionEntry", prop.loc, t.__P_489_26.type, keyName);
          }
        }
        function handleTopLevelMethods(path, keyName, functionNode) {
          ...
          t.__P_489_26.functionName = isSpecialFunctionName ? FUNCTION_NAMES[keyName] : keyName;
          ...
          path.skip();
          t.__P_489_26.functionName = null;
        }
          ...
          ObjectProperty: function ObjectProperty(path) {
            ...
            if (keyName == "extend") {
              if (!isValidExtendClause(prop)) {
                ...
                t.__P_489_26.superClass = collapseMemberExpression(prop.value);
                t._requireClass(t.__P_489_26.superClass, {
                  location: path.node.loc
                });
              }
            } else if (keyName == "type") {
              var type = prop.value.value;
              t.__P_489_26.isAbstract = type === "abstract";
              t.__P_489_26.isStatic = type === "static";
              t.__P_489_26.isSingleton = type === "singleton";
            } else if (keyName == "implement") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__P_489_26.interfaces
              });
            } else if (keyName == "include" || keyName == "patch") {
              path.skip();
              path.traverse(COLLECT_CLASS_NAMES_VISITOR, {
                collectedClasses: t.__P_489_26.mixins
              });
            } else if (keyName == "members" || keyName == "statics" || keyName == "objects" || keyName == "@") {
              t.__P_489_26._topLevel = {
                path: path,
                keyName: keyName
              };
              path.skip();
              if (keyName === "members" && t.__P_489_26.type === "class") {
                ensureCreateQxObjectImpl(path);
              }
              path.traverse(VISITOR);
              t.__P_489_26._topLevel = null;
                  ...
                  if (data.check !== undefined) {
                    ...
                    checks.forEach(function (check) {
                      if (!qx.tool.compiler.ClassFile.SYSTEM_CHECKS[check]) {
                        var symbolData = t.__P_489_0.getSymbolType(check);
        ...
        var VISITOR = {
          NewExpression: {
            ...
            exit: function exit(path) {
              if (t.__P_489_0.isAddCreatedAt()) {
                var fn = types.memberExpression(types.identifier("qx"), types.identifier("$$createdAt"));
                var tmp = types.callExpression(fn, [path.node, types.stringLiteral(t.__P_489_1.replace(/\./g, "/") + ".js"), types.numericLiteral(path.node.loc ? path.node.loc.start.line : 0), types.numericLiteral(path.node.loc ? path.node.loc.start.column : 0), types.booleanLiteral(t.__P_489_0.isVerboseCreatedAt())]);
          ...
          Program: {
            exit: function exit(path) {
              ...
              tmp = babylon.parse(t.__P_489_1 + ".$$dbClassInfo = $$dbClassInfo;").program.body;
              inject.push(tmp[0]);
          ...
          CallExpression: {
            enter: function enter(path) {
              ...
              function addTranslation(entry) {
                ...
                var cur = t.__P_489_10[entry.msgid];
                if (cur) {
              ...
              var scope;
              var applicationTypes = t.__P_489_0.getApplicationTypes();
              if (path.node.callee.type == "Identifier" && ((_path$node = path.node) === null || _path$node === void 0 || (_path$node = _path$node.callee) === null || _path$node === void 0 ? void 0 : _path$node.name) == "require" && ((_path$node$arguments = path.node.arguments) === null || _path$node$arguments === void 0 ? void 0 : _path$node$arguments.length) == 1 && applicationTypes.includes("browser")) {
                ...
                for (scope = t.__P_489_13; scope; scope = scope.parent) {
                  ...
                  if (types.isLiteral(arg)) {
                    if (typeof arg.value != "string") {
                      ...
                      if (qx.tool.compiler.Console.getInstance().getVerbose()) {
                        qx.tool.compiler.Console.log("".concat(t.__P_489_1, ":").concat(path.node.loc.start.line, ":") + " automatically detected 'require(".concat(arg.value, ")`"));
                      }
                      t.addCommonjsModule(arg.value, t.__P_489_1, path.node.loc.start.line);
              ...
              if (types.isMemberExpression(path.node.callee) || es6ClassDeclarations == 0 && (((_path$node$callee$obj = path.node.callee.object) === null || _path$node$callee$obj === void 0 ? void 0 : _path$node$callee$obj.type) == "Super" || path.node.callee.type == "Super")) {
                ...
                if (((_path$node$callee$obj2 = path.node.callee.object) === null || _path$node$callee$obj2 === void 0 ? void 0 : _path$node$callee$obj2.type) == "Identifier") {
                  ...
                  for (var _scope = t.__P_489_13; _scope; _scope = _scope.parent) {
                    while (!aliasIsThis) {
                ...
                if (TYPE[name]) {
                  t.__P_489_30 = name.match(/\.([a-zA-Z]+)\./)[1];
                  var node = path.node;
                  ...
                  t.__P_489_26.type = TYPE[name];
                  if (t.__P_489_30 == "Class" || t.__P_489_30 == "Bootstrap") {
                    var typeProp = classDef.properties.find(function (prop) {
                      return prop.key.type == "Identifier" && prop.key.value == "type";
                    });
                    if (typeProp) {
                      t.__P_489_26.isStatic == typeProp.value.type == "Literal" && typeProp.value.value === "static";
                    }
                  }
                  ...
                  if (types.isLiteral(_arg)) {
                    if (typeof _arg.value != "string") {
                      ...
                      t.__P_489_7.provided[_arg.value] = true;
                      if (!_arg.value.startsWith(t.__P_489_1) && !Object.prototype.hasOwnProperty.call(qx.tool.compiler.ClassFile.ENVIRONMENT_CONSTANTS, _arg.value)) {
                        var symbol = t.__P_489_4.getSymbolType(_arg.value);
                  ...
                  if (t.__P_489_30 == "Mixin") {
                    expr = types.callExpression(expandMemberExpression("qx.Mixin.baseClassMethod"), [expandMemberExpression("this.constructor"), types.identifier(t.__P_489_26.className), types.stringLiteral(t.__P_489_26.functionName)]);
                    expr = types.memberExpression(expr, types.identifier("call"));
                  } else if (t.__P_489_26.functionName == "$$constructor") {
                    expr = expandMemberExpression(t.__P_489_26.superClass + ".constructor.call");
                  } else if (t.__P_489_26.className) {
                    expr = expandMemberExpression(t.__P_489_26.className + ".superclass" + ".prototype." + t.__P_489_26.functionName + ".call");
                  } else {
                    expr = expandMemberExpression(t.__P_489_26.superClass + ".prototype." + t.__P_489_26.functionName + ".call");
                  }
                  ...
                  var _expr;
                  if (t.__P_489_30 == "Mixin") {
                    _expr = expandMemberExpression("this.constructor.superclass.prototype." + t.__P_489_26.functionName + ".call");
                  } else if (t.__P_489_26.functionName == "$$constructor") {
                    _expr = expandMemberExpression(t.__P_489_26.superClass + ".constructor." + methodName);
                  } else {
                    _expr = expandMemberExpression(t.__P_489_1 + ".prototype." + t.__P_489_26.functionName + ".base." + methodName);
                  }
                  ...
                  var _expr2 = expandMemberExpression(t.__P_489_26.className);
          ...
          MemberExpression: {
            exit: function exit(path) {
              ...
              if (t.__P_489_18[members[0]] || t.hasDeclaration(members[0])) {
                return;
              }
          ...
          Property: function Property(path) {
            if (t.__P_489_26 && t.__P_489_26._topLevel && t.__P_489_26._topLevel.path == path.parentPath.parentPath) {
              t.__P_489_26.functionName = getKeyName(path.node.key);
              makeMeta(t.__P_489_26._topLevel.keyName, t.__P_489_26.functionName, path.node);
              path.skip();
              var functionId = null;
              if (this.__P_489_21 == "readable") {
                if (path.node.value.type == "FunctionExpression" && path.node.value.id === null) {
          ...
          ObjectMethod: function ObjectMethod(path) {
            ...
            if (t.__P_489_26 && t.__P_489_26._topLevel && t.__P_489_26._topLevel.path == path.parentPath.parentPath) {
              t.__P_489_26.functionName = t.__P_489_26._topLevel.keyName == "objects" ? "_createQxObjectImpl" : getKeyName(path.node.key);
              makeMeta(t.__P_489_26._topLevel.keyName, t.__P_489_26.functionName, path.node);
              path.skip();
              enterFunction(path);
              path.traverse(VISITOR);
       ...
       */
      __P_489_33: function __P_489_33(className) {
        var pos = (className || "").lastIndexOf(".");
        var meta = {
          className: className,
        ...
        this.__P_489_2.push(meta);
        this.__P_489_26 = meta;
        this.__P_489_3[className] = meta;
        this.__P_489_22++;
      },
      /**
       * Pops the current meta off the stack, optionally checking that the classname is correct
       */
      __P_489_34: function __P_489_34(className) {
        if (!this.__P_489_2.length) {
          throw new Error("No __metaStack entries to pop");
        }
        var meta = this.__P_489_2[this.__P_489_2.length - 1];
        ...
        this.__P_489_2.pop();
        meta = this.__P_489_2[this.__P_489_2.length - 1] || null;
        this.__P_489_26 = meta;
      },
      /**
      ...
      popScope: function popScope(node) {
        var old = this.__P_489_13;
        var scope = this.__P_489_13 = this.__P_489_13.parent;
      ...
      addDeclaration: function addDeclaration(name, valueName) {
        if (this.__P_489_13.vars[name] === undefined) {
          this.__P_489_13.vars[name] = valueName || true;
          var unresolved = this.__P_489_13.unresolved;
      ...
      hasDeclaration: function hasDeclaration(name) {
        ...
        for (var tmp = this.__P_489_13; tmp; tmp = tmp.parent) {
      ...
      addReference: function addReference(name, loc) {
        ...
        var scope = this.__P_489_13;
        if (scope.vars[name[0]] !== undefined) {
          return;
        }

        // Global variable or a local variable?
        if (name[0] === "this" || name[0] === "[]" || this.__P_489_18[name[0]] || this.hasDeclaration(name[0])) {
          return;
        }
        var str = "";
        for (var i = 0; i < name.length; i++) {
          ...
          str += name[i];
          if (this.__P_489_18[str] || this.isIgnored(str)) {
            return;
          }
        }
        name = str;
        if (name == this.__P_489_1 || name.startsWith(this.__P_489_1 + ".") || name.startsWith("(")) {
          return;
        }
      ...
      encodePrivate: function encodePrivate(name, isIdentifier, location) {
        ...
        if (DO_NOT_ENCODE[name] || this.__P_489_21 == "off" || !name.startsWith("__") || !name.match(/^[0-9a-z_$]+$/i)) {
          return name;
        }
        if (name.indexOf("__P_") > -1) {
          return name;
        }
        var coded = this.__P_489_19[name];
        if (!coded) {
          ...
          if (!isIdentifier) {
            this.__P_489_20[name] = true;
            return name;
          }
          if (this.__P_489_20[name]) {
            this.addMarker("class.blockedMangle", location, name);
            return name;
          }
          var db = this.__P_489_0.getDatabase();
          ...
          var prefix = prefixes.classPrefixes[this.__P_489_1];
          if (!prefix) {
            prefix = "__P_" + ++prefixes.nextPrefix + "_";
            prefixes.classPrefixes[this.__P_489_1] = prefix;
          }
          if (this.__P_489_21 == "readable") {
            coded = this.__P_489_19[name] = name + prefix + Object.keys(this.__P_489_19).length;
          } else {
            coded = this.__P_489_19[name] = prefix + Object.keys(this.__P_489_19).length;
          }
        }
        return coded;
      },
      ...
      deleteReference: function deleteReference(name) {
        delete this.__P_489_13.unresolved[name];
        var stub = name + ".";
        for (var id in this.__P_489_13.unresolved) {
          if (id.startsWith(stub)) {
            delete this.__P_489_13.unresolved[id];
          }
        }
      },
      /**
      ...
      addExternal: function addExternal(name) {
        if (this.__P_489_14.indexOf(name) < 0) {
          this.__P_489_14.push(name);
        }
      },
      /**
      ...
      addCommonjsModule: function addCommonjsModule(moduleName, className, linenum) {
        if (!this.__P_489_15[moduleName]) {
          this.__P_489_15[moduleName] = new Set();
        }
        this.__P_489_15[moduleName].add("".concat(className, ":").concat(linenum));
      },
      /**
      ...
      addEnvCheck: function addEnvCheck(name, location) {
        ...
        var requiredOpts = {
          load: t.isLoadScope(),
          defer: t.__P_489_24,
          construct: t.__P_489_26 && t.__P_489_26.functionName == "$$constructor",
          location: location
        };
        var dest = t.__P_489_7.required[name];
        if (!dest) {
          dest = t.__P_489_7.required[name] = {};
        }
        ...
        var info = t.__P_489_0.getSymbolType(name);
      ...
      addMarker: function addMarker(msgId, pos) {
        ...
        if (this.__P_489_12[key]) {
          return;
        }
        this.__P_489_12[key] = true;
        var marker = {
          msgId: msgId
        };
      ...
      _requireClass: function _requireClass(name, opts) {
        ...
        if (symbolType != "package" && className && className != t.__P_489_1) {
          // Re-check the class name as ignored if this is a member
          if (symbolType == "member" && t.isIgnored(className)) {
            return null;
          }
          var data = t.__P_489_6[className];
          if (!data) {
            data = t.__P_489_6[className] = {};
          }
          ...
          if (requireOpts.defer) {
            ...
            if (!name.startsWith(t.__P_489_1)) {
      ...
      _requireAsset: function _requireAsset(path) {
        ...
        if (!qx.lang.Array.contains(this.__P_489_8, path)) {
          this.__P_489_8.push(path);
        }
      },
      /**
       ...
       * @returns
       */
      __P_489_35: function __P_489_35(props, name) {
      ...
      getUnresolvedSymbols: function getUnresolvedSymbols() {
        return this.__P_489_13.unresolved;
      },
      /**
...
//# sourceMappingURL=ClassFile.js.map?dt=1782705793562