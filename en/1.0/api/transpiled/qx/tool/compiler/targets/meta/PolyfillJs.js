...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.PolyfillJs", {
    ...
    construct: function construct(appMeta) {
      qx.tool.compiler.targets.meta.AbstractJavascriptMeta.constructor.call(this, appMeta, "".concat(appMeta.getApplicationRoot(), "polyfill.js"));
    },
    properties: {
      needsWriteToDisk: {
        init: true,
    ...
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return _this.__P_519_0(path.join(require.resolve("core-js-bundle"), "../minified.js"), ws);
              case 1:
                _context.n = 2;
              ...
              case 2:
                _context.n = 3;
                return _this.__P_519_0(path.join(require.resolve("regenerator-runtime"), "../runtime.js"), ws);
              case 3:
                return _context.a(2);
            }
          }, _callee);
      ...
      __P_519_0: function __P_519_0(srcFilename, ws) {
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
          var rs;
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              case 0:
                rs = fs.createReadStream(srcFilename, "utf8");
                _context2.n = 1;
...
//# sourceMappingURL=PolyfillJs.js.map?dt=1782705795411