(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.Part", {
    ...
    construct: function construct(target, name, partIndex) {
      ...
      this.__P_518_0 = target;
      this.__P_518_1 = name;
      this.__P_518_2 = partIndex;
      this.__P_518_3 = [];
      this.__P_518_4 = {};
    },
    members: {
      ...
      addPackage: function addPackage(pkg) {
        if (!this.__P_518_4[pkg.toHashCode()]) {
          this.__P_518_3.push(pkg);
          this.__P_518_4[pkg.toHashCode()] = pkg;
        }
      },
      hasPackage: function hasPackage(pkg) {
        return Boolean(this.__P_518_4[pkg.toHashCode()]);
      },
      getDefaultPackage: function getDefaultPackage() {
        return this.__P_518_3[0] || null;
      },
      serializeInto: function serializeInto(parts) {
        var arr = parts[this.__P_518_1] = [];
        this.__P_518_3.forEach(function (pkg) {
...
//# sourceMappingURL=Part.js.map?dt=1782705795389