(function () {
  ...
  qx.Class.define("qx.tool.compiler.targets.meta.Package", {
    ...
    construct: function construct(appMeta, packageIndex) {
      ...
      this.__P_516_0 = appMeta;
      this.__P_516_1 = packageIndex;
      this.__P_516_2 = [];
      this.__P_516_3 = {};
      this.__P_516_4 = {};
      this.__P_516_5 = [];
      this.__P_516_6 = [];
      this.__P_516_7 = new qx.tool.compiler.targets.meta.PackageJavascript(this.__P_516_0, this);
    },
    properties: {
    ...
    members: {
      ...
      isEmpty: function isEmpty() {
        ...
        for (var localeId in this.__P_516_3) {
          if (this.__P_516_3[localeId]) {
            return false;
          }
        }
        for (var _localeId in this.__P_516_4) {
          if (this.__P_516_4[_localeId]) {
            return false;
          }
        }
        if (this.isEmbedAllJavascript()) {
          if (this.__P_516_5.length > 0) {
            return false;
          }
        }
        return true;
      ...
      addLocale: function addLocale(localeId, localeData) {
        this.__P_516_3[localeId] = localeData;
      },
      /**
      ...
      addTranslationEntry: function addTranslationEntry(localeId, entry) {
        var translations = this.__P_516_4[localeId];
        if (!translations) {
          this.__P_516_4[localeId] = translations = {};
        }
      ...
      removeJavascriptMeta: function removeJavascriptMeta(jsMeta) {
        qx.lang.Array.remove(this.__P_516_5, jsMeta);
      },
      /**
      ...
      serializeInto: function serializeInto(packages) {
        var _this = this;
        var data = packages[String(this.__P_516_1)] = {
          uris: []
        };
        var appRoot = this.__P_516_0.getApplicationRoot();
        var target = this.__P_516_0.getTarget();
        var privateArtifacts = target.isPrivateArtifacts() && this.__P_516_0.getApplication().getType() == "browser";
        ...
        var toUri = function toUri(filename) {
          ...
          if (_this.__P_516_0.isAddTimestampsToUrls()) {
        ...
        if (!this.isEmbedAllJavascript()) {
          data.uris = this.__P_516_5.map(function (js) {
            return toUri(js.getFilename());
          });
        }
        if (this.isNeedsWriteToDisk()) {
          data.uris.unshift(toUri(this.__P_516_7.getFilename()));
        }
      },
      /**
      ...
      _applyNeedsWriteToDisk: function _applyNeedsWriteToDisk(value) {
        this.__P_516_7.setNeedsWriteToDisk(value);
      }
    }
  });
...
//# sourceMappingURL=Package.js.map?dt=1782967164258