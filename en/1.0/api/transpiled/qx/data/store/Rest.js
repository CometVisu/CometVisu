  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    construct: function construct(resource, actionName, delegate) {
      ...
      this.__P_200_1 = qx.lang.Function.bind(this.__P_200_2, this);
      this.__P_200_3();
    },
    properties: {
      /**
    ...
    members: {
       ...
       */
      __P_200_3: function __P_200_3() {
        var resource = this.getResource(),
          actionName = this.getActionName();
        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__P_200_1);
        }
      },
      /**
       ...
       */
      __P_200_2: function __P_200_2(e) {
        var data = e.getData(),
...
//# sourceMappingURL=Rest.js.map?dt=1782967146083