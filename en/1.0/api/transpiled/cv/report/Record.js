  ...
  qx.Class.define('cv.report.Record', {
    ...
    */
    members: {
      ...
      record: function record(category, path, data, options) {
        switch (category) {
          case cv.report.Record.XHR:
            if (path === 'response') {
              this.__P_770_10(category, data);
            }
            data.t = Date.now();
            this.__P_770_3[path].push(data);
            break;
          case cv.report.Record.CACHE:
          case cv.report.Record.RUNTIME:
            this.__P_770_4[category] = data;
            break;
          case cv.report.Record.STORAGE:
            if (!Object.prototype.hasOwnProperty.call(this.__P_770_4, category)) {
              this.__P_770_4[category] = {};
            }
            this.__P_770_4[category][path] = data;
            break;
          default:
            this.__P_770_0.push({
              c: category,
       ...
       * @private
       */
      __P_770_10: function __P_770_10(category, data) {
       ...
       */
      __P_770_11: function __P_770_11(nativeEvent) {
        var _this$__P_770_, _this$__P_770_2;
        var data = {
          ...
          "native": {
            ...
            currentTarget: (_this$__P_770_ = this.__P_770_12(nativeEvent.currentTarget)) !== null && _this$__P_770_ !== void 0 ? _this$__P_770_ : undefined,
            relatedTarget: (_this$__P_770_2 = this.__P_770_12(nativeEvent.relatedTarget)) !== null && _this$__P_770_2 !== void 0 ? _this$__P_770_2 : undefined,
      ...
      recordNativeEvent: function recordNativeEvent(ev) {
        ...
        ev.$$RID = this.__P_770_9;
        if (ev.type.endsWith('down') || ev.type.endsWith('start')) {
          this.__P_770_6 = this.__P_770_7;
        } else if (ev.type.endsWith('up') || ev.type.endsWith('end')) {
          this.__P_770_6 = this.__P_770_8;
        }
        if (/.+(move|over|out)/.test(ev.type)) {
          if (!this.__P_770_5[ev.type]) {
            this.__P_770_5[ev.type] = {
              x: ev.clientX,
              y: ev.clientY
            };
          } else {
            var lastDelta = this.__P_770_5[ev.type];
            if (Math.abs(lastDelta.x - ev.clientX) <= this.__P_770_6 || Math.abs(lastDelta.y - ev.clientY) <= this.__P_770_6) {
       ...
       */
      __P_770_12: function __P_770_12(el) {
        if (!el) {
          return '';
        }
        if (el === window) {
        ...
        var sel = stack.length > 1 ? stack.slice(1).join('>') : stack[0]; // removes the html element
...
//# sourceMappingURL=Record.js.map?dt=1782705805581