  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.LoadingIndicator", {
    ...
    construct: function construct() {
      this.__P_817_0 = new qx.ui.core.Blocker(qxl.apiviewer.MWidgetRegistry.getWidgetById("tabView"));
      this.__P_817_0.setColor("#D5D5D5");
      this.__P_817_0.setOpacity(0.5);
    ...
    members: {
      __P_817_0: null,
      show: function show() {
        this.__P_817_0.block();
      },
      hide: function hide() {
        this.__P_817_0.unblock();
      }
    }
  });
...
//# sourceMappingURL=LoadingIndicator.js.map?dt=1782967175961