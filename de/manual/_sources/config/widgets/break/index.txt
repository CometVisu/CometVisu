...
Hier der minimale Beispielcode der das Break Widget aus dem folgenden Screenshot erzeugt:

.. widget_example::

        <settings>
            <screenshot name="break_simple">
                <caption>Break, einfaches Beispiel</caption>
...
ein Break-Widget ohne die Rückmeldeaddresse in der Praxis keinen Sinn,
...
Hier der Beispielcode der das Break-Widget mit den allen gezeigten
Eigenschaften einfügt, inkl. der benutzten Mappings / Stylings:

.. widget_example::

        <settings>
            <screenshot name="break_complete">
                <caption>Break mit mapping + styling</caption>
        ...
        <break mapping="OnOff" styling="RedGreen">
          <label>Break</label>
          <address transform="DPT:1.001" mode="readwrite">1/1/0</address>
          <address transform="DPT:1.001" mode="read">1/4/0</address>
        </break>
