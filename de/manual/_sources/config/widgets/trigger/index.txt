...
Hier der minimale Beispielcode der das Trigger Widget aus dem folgenden Screenshot erzeugt:

.. widget_example::

        <settings>
            <screenshot name="trigger_simple">
                <caption>Trigger, einfaches Beispiel</caption>
...
ein Trigger-Widget ohne die Rückmeldeaddresse in der Praxis keinen Sinn,
...
Hier der Beispielcode der das Trigger-Widget mit den allen gezeigten
Eigenschaften einfügt, inkl. der benutzten Mappings / Stylings:

.. widget_example::

        <settings>
            <screenshot name="trigger_complete">
                <caption>Trigger mit mapping + styling</caption>
        ...
        <trigger mapping="OnOff" styling="RedGreen">
          <label>Trigger</label>
          <address transform="DPT:1.001" mode="readwrite">1/1/0</address>
          <address transform="DPT:1.001" mode="read">1/4/0</address>
        </trigger>
