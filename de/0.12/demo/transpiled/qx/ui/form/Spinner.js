    ...
    members: {
      ...
      */
      ...
      _applyValue: function _applyValue(value, old) {
        ...
        this.__P_169_0 = value; // write the value of the spinner to the textfield
      ...
      _applyNumberFormat: function _applyNumberFormat(value, old) {
        ...
        this._applyValue(this.__P_169_0, undefined);
      },
      ...
      */
      ...
      _onTextChange: function _onTextChange(e) {
        ...
        if (!isNaN(value)) {
          ...
          if (value === this.__P_169_0) {
            this._applyValue(this.__P_169_0);
          } else {
            this.setValue(value);
          }
        } else {
...
//# sourceMappingURL=Spinner.js.map?dt=1620071713584