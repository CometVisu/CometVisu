    ...
    members: {
      ...
      */
      ...
      _setPreselectedItem: function _setPreselectedItem() {
        if (this.__P_300_0) {
          var label = this.__P_300_0.getLabel();

          if (this.getFormat() != null) {
            label = this.getFormat().call(this, this.__P_300_0);
...
//# sourceMappingURL=ComboBox.js.map?dt=1612694638205