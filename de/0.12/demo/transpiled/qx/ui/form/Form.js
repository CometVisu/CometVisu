  ...
  qx.Class.define("qx.ui.form.Form", {
    ...
    members: {
      ...
      */
      ...
      add: function add(item, label, validator, name, validatorContext, options) {
        ...
        this.__P_110_0[this._groupCounter].items.push(item);

        this.__P_110_0[this._groupCounter].labels.push(label);

        this.__P_110_0[this._groupCounter].options.push(options); // if no name is given, use the label without not working character
        ...
        this.__P_110_0[this._groupCounter].names.push(name); // add the item to the validation manager
      ...
      __P_110_1: function __P_110_1() {
        return this.__P_110_0.length === 0;
      },
      ...
      */
      ...
      remove: function remove(item) {
        for (var i = 0; i < this.__P_110_0.length; i++) {
          var group = this.__P_110_0[i];
          ...
          if (group.title === title) {
            ...
            if (i == 0) {
              ...
              if (this.__P_110_0.length == 1) {
                ...
                // add to the next
                targetGroup = this.__P_110_0[i + 1];
              }
            } else {
      ...
      getItems: function getItems() {
        ...
        for (var i = 0; i < this.__P_110_0.length; i++) {
          var group = this.__P_110_0[i]; // get all items
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_110_0 = this._buttons = this._buttonOptions = null;
...
//# sourceMappingURL=Form.js.map?dt=1619884696515