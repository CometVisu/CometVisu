  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_341_0, this);
      this.__P_341_1 = new qx.data.Array();
      this.initSelection(this.__P_341_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__P_341_5(helper, listSelection);

        helper.dispose();
        this.__P_341_3 = false;
      },
      ...
      */
       ...
       */
      __P_341_7: function __P_341_7(event) {
        if (this.__P_341_2) {
          return;
        }
        ...
        this.__P_341_5(selection, listSelection);

        this.__P_341_3 = false;
        this.__P_341_2 = true;

        this.__P_341_5(listSelection, selection);
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_341_5(listSelection, this.getSelection());
       ...
       */
      __P_341_0: function __P_341_0(event) {
        if (this.isVisible()) {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__P_341_7, this);

        if (old != null) {
          old.removeListener("change", this.__P_341_7, this);
        }

        this.__P_341_5(value, this.getChildControl("list").getSelection(value));
      },
      ...
      */
       ...
       */
      __P_341_5: function __P_341_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          if (this.__P_341_4 > 0) {
            uiList.setWidth(this.__P_341_4);
          } else {
...
//# sourceMappingURL=VirtualDropDownList.js.map?dt=1620071728554