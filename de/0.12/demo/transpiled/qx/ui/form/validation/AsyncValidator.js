  ...
  qx.Class.define("qx.ui.form.validation.AsyncValidator", {
    ...
    members: {
      ...
      validate: function validate(item, value, manager, context) {
        ...
        this.__P_170_3 = false; // store the item and the manager

        this.__P_170_1 = item;
        this.__P_170_2 = manager; // invoke the user set validator function

        this.__P_170_0.call(context || this, this, value);
      },
      ...
      validateForm: function validateForm(items, manager, context) {
        this.__P_170_3 = true;
        this.__P_170_2 = manager;

        this.__P_170_0.call(context, items, this);
      },
      ...
      setValid: function setValid(valid, message) {
        ...
        if (this.__P_170_3) {
          ...
          if (message !== undefined) {
            this.__P_170_2.setInvalidMessage(message);
          }

          this.__P_170_2.setFormValid(valid);
        } else {
          // message processing
          if (message !== undefined) {
            this.__P_170_1.setInvalidMessage(message);
          }

          this.__P_170_2.setItemValid(this.__P_170_1, valid);
        }
      }
    },
    ...
    destruct: function destruct() {
      this.__P_170_2 = this.__P_170_1 = null;
    }
  });
  qx.ui.form.validation.AsyncValidator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AsyncValidator.js.map?dt=1620071713695