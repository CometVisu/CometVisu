    ...
    members: {
      ...
      remove: function remove(field) {
        ...
        for (var i = 0; i < this.__P_224_0.length; i++) {
          var storedItem = this.__P_224_0[i];

          if (storedItem.item === field) {
            this.__P_224_0.splice(i, 1);
      ...
      resetItem: function resetItem(field) {
        ...
        for (var i = 0; i < this.__P_224_0.length; i++) {
          var dataEntry = this.__P_224_0[i];
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__P_224_0.length; i++) {
          var item = this.__P_224_0[i].item; // set the new init value for the item

          this.__P_224_0[i].init = item.getValue();
        }
      },
      ...
      redefineItem: function redefineItem(field) {
        this.__P_224_1(field); // get the data entry


        var dataEntry;

        for (var i = 0; i < this.__P_224_0.length; i++) {
          if (this.__P_224_0[i].item === field) {
            dataEntry = this.__P_224_0[i];
       ...
       * @private
       */
      __P_224_1: function __P_224_1(field) {
...
//# sourceMappingURL=Resetter.js.map?dt=1592778978378