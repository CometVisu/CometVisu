    ...
    members: {
      ...
      */
      __P_299_3: function __P_299_3() {
        if (this.isAutoSize()) {
          var clone = this.__P_299_4();

          if (clone && this.getBounds()) {
            // Remember original area height
            this.__P_299_2 = this.__P_299_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__P_299_2); // Set new height
      ...
      * original element
      */
      __P_299_4: function __P_299_4() {
        this.__P_299_0 = this.__P_299_0 || this.__P_299_7();
      ...
      */
      __P_299_6: function __P_299_6(clone) {
      ...
      */
      ...
      _applyAutoSize: function _applyAutoSize(value, old) {
        if (value) {
          ...
          this.addListener("input", this.__P_299_3, this); // This is done asynchronously on purpose. The style given would
          ...
          this.removeListener("input", this.__P_299_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__P_299_1 || hint.height;
        }
...
//# sourceMappingURL=TextArea.js.map?dt=1618504466728