  ...
  qx.Class.define("qx.ui.form.TextArea", {
    ...
    */
    members: {
      ...
      *
      */
      __P_298_3: function __P_298_3() {
        if (this.isAutoSize()) {
          var clone = this.__P_298_4();

          if (clone && this.getBounds()) {
            // Remember original area height
            this.__P_298_2 = this.__P_298_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__P_298_2); // Set new height
      ...
      * original element
      */
      __P_298_4: function __P_298_4() {
        this.__P_298_0 = this.__P_298_0 || this.__P_298_7();
      ...
      */
      __P_298_6: function __P_298_6(clone) {
      ...
      */
      ...
      _applyAutoSize: function _applyAutoSize(value, old) {
        if (value) {
          ...
          this.addListener("input", this.__P_298_3, this); // This is done asynchronously on purpose. The style given would
          ...
          this.removeListener("input", this.__P_298_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__P_298_1 || hint.height;
        }
...
//# sourceMappingURL=TextArea.js.map?dt=1612699094125