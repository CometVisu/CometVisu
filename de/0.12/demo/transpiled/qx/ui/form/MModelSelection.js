  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_182_0 = new qx.data.Array(); // listen to the changes

      this.__P_182_0.addListener("change", this.__P_182_1, this);

      this.addListener("changeSelection", this.__P_182_2, this);
    },
    events: {
      /**
    ...
    members: {
       ...
       */
      __P_182_1: function __P_182_1() {
        this.__P_182_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];

        var modelSelection = this.__P_182_0.toArray();
        ...
        this.__P_182_3 = false; // check if the setting has worked
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__P_182_0.removeAll();

          return;
        }

        // add the first two parameter
        modelSelection.unshift(this.__P_182_0.getLength()); // remove index

        modelSelection.unshift(0); // start index

        var returnArray = this.__P_182_0.splice.apply(this.__P_182_0, modelSelection);

        returnArray.dispose();
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_182_0");
    }
  });
  qx.ui.form.MModelSelection.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MModelSelection.js.map?dt=1620513286547