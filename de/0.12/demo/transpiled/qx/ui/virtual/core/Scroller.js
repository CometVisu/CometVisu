  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Scroller", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__P_274_0 = new qx.ui.virtual.core.Pane(rowCount, columnCount, cellHeight, cellWidth);

      this.__P_274_0.addListener("update", this._computeScrollbars, this);

      this.__P_274_0.addListener("scrollX", this._onScrollPaneX, this);

      this.__P_274_0.addListener("scrollY", this._onScrollPaneY, this);

      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this._add(this.__P_274_0, {
          edge: 0
        });
      } else {
        this._add(this.__P_274_0, {
    ...
    members: {
      ...
      */
      ...
      _onScrollBarX: function _onScrollBarX(e) {
        this.__P_274_0.setScrollX(e.getData());
      },
      // overridden
      _onScrollBarY: function _onScrollBarY(e) {
        this.__P_274_0.setScrollY(e.getData());
      }
    },
    destruct: function destruct() {
      this.__P_274_0.dispose();
...
//# sourceMappingURL=Scroller.js.map?dt=1620513293434