  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_337_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_337_0.pop();
        }
      },
      ...
      __P_337_1: function __P_337_1() {
        var widget = this.__P_337_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1603737763521