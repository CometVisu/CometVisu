  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_338_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_338_0.pop();
        }
      },
      ...
      __P_338_1: function __P_338_1() {
        var widget = this.__P_338_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1612699096758