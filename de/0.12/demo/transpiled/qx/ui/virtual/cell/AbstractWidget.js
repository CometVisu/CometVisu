  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_336_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_336_0.pop();
        }
      },
      ...
      __P_336_1: function __P_336_1() {
        var widget = this.__P_336_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1592778987831