  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__P_339_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__P_339_0.pop();
        }
      },
      ...
      __P_339_1: function __P_339_1() {
        var widget = this.__P_339_0.shift();
...
//# sourceMappingURL=AbstractWidget.js.map?dt=1618504470167