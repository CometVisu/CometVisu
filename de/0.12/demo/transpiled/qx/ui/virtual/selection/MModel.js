  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_250_0 = new qx.data.Array();

      this.__P_250_0.addListener("change", this._onChangeSelection, this);

      this._applySelection(this.__P_250_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
      ...
      setSelection: function setSelection(value) {
        if (value) {
          this.__P_250_0.replace(value);
        } else {
          this.__P_250_0.removeAll();
        }
      },
      ...
      */
       ...
       */
      __P_250_5: function __P_250_5(newSelection) {
        var selection = this.getSelection();
...
//# sourceMappingURL=MModel.js.map?dt=1592778980752