  ...
  qx.Mixin.define("qx.ui.core.MDragDropScrolling", {
    ...
    */
    construct: function construct() {
      ...
      widget.addListener("drag", this.__P_300_0, this);
      widget.addListener("dragend", this.__P_300_1, this);
      this.__P_300_2 = ["left", "right"];
      this.__P_300_3 = ["top", "bottom"];
    },
    ...
    */
    members: {
      ...
      _getAxis: function _getAxis(edgeType) {
        if (this.__P_300_2.indexOf(edgeType) !== -1) {
          return "x";
        } else if (this.__P_300_3.indexOf(edgeType) !== -1) {
          return "y";
        } else {
      ...
      */
       ...
       */
      __P_300_0: function __P_300_0(e) {
        if (this.__P_300_4) {
        ...
        while (scrollable) {
          ...
          if (this._isScrollbarVisible(scrollable, axis)) {
            ...
            if (this.__P_300_4) {
              this.__P_300_4.dispose();
            }

            this.__P_300_4 = new qx.event.Timer(50);

            this.__P_300_4.addListener("interval", function (scrollable, axis, amount) {
              this._scrollBy(scrollable, axis, amount);
            }.bind(this, scrollable, axis, exceedanceAmount));

            this.__P_300_4.start();
       ...
       * @param e {qx.event.type.Drag} The drag event instance.
       */
      __P_300_1: function __P_300_1(e) {
        if (this.__P_300_4) {
          this.__P_300_4.stop();
        }
      }
...
//# sourceMappingURL=MDragDropScrolling.js.map?dt=1592778985027