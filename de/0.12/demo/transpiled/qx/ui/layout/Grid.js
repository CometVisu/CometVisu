  ...
  qx.Class.define("qx.ui.layout.Grid", {
    ...
    */
    members: {
      ...
      __P_130_9: function __P_130_9() {
        ...
        this.__P_130_2 = grid;
        this.__P_130_3 = colSpans;
        this.__P_130_4 = rowSpans;
        this.__P_130_5 = maxRowIndex;
        this.__P_130_6 = maxColIndex;
        this.__P_130_7 = null;
        this.__P_130_8 = null; // Clear invalidation marker
      ...
      _setRowData: function _setRowData(row, key, value) {
        var rowData = this.__P_130_0[row];

        if (!rowData) {
          this.__P_130_0[row] = {};
          this.__P_130_0[row][key] = value;
        } else {
          rowData[key] = value;
        }
      },
      ...
      _setColumnData: function _setColumnData(column, key, value) {
        var colData = this.__P_130_1[column];

        if (!colData) {
          this.__P_130_1[column] = {};
          this.__P_130_1[column][key] = value;
        } else {
          colData[key] = value;
        }
      },
      ...
      getCellAlign: function getCellAlign(row, column) {
        ...
        var rowData = this.__P_130_0[row];
        var colData = this.__P_130_1[column];
        var widget = this.__P_130_2[row][column];
      ...
      _fixHeightsRowSpan: function _fixHeightsRowSpan(rowHeights) {
        ...
        for (var i = 0, l = this.__P_130_4.length; i < l; i++) {
          var widget = this.__P_130_4[i];
      ...
      _getRowHeights: function _getRowHeights() {
        if (this.__P_130_7 != null) {
          return this.__P_130_7;
        }

        var rowHeights = [];
        var maxRowIndex = this.__P_130_5;
        var maxColIndex = this.__P_130_6;
        ...
        for (var row = 0; row <= maxRowIndex; row++) {
          ...
          for (var col = 0; col <= maxColIndex; col++) {
            var widget = this.__P_130_2[row][col];
        ...
        if (this.__P_130_4.length > 0) {
          this._fixHeightsRowSpan(rowHeights);
        }

        this.__P_130_7 = rowHeights;
        return rowHeights;
      },
      ...
      _getColWidths: function _getColWidths() {
        if (this.__P_130_8 != null) {
          return this.__P_130_8;
        }
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        for (var col = 0; col <= maxColIndex; col++) {
          ...
          for (var row = 0; row <= maxRowIndex; row++) {
            var widget = this.__P_130_2[row][col]; // ignore empty cells
    ...
    */
    destruct: function destruct() {
      this.__P_130_2 = this.__P_130_0 = this.__P_130_1 = this.__P_130_3 = this.__P_130_4 = this.__P_130_8 = this.__P_130_7 = null;
    }
  });
  qx.ui.layout.Grid.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Grid.js.map?dt=1592778971605