      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        while (lineCalculator.hasMoreLines()) {
          ...
          this.__P_143_0(line, lineTop, availWidth, padding);
       ...
       * <code>top</code>, <code>bottom</code>, <code>left</code>, <code>right</code>
       */
      __P_143_0: function __P_143_0(line, lineTop, availWidth, padding) {
      ...
      _computeSizeHint: function _computeSizeHint() {
        return this.__P_143_1(Infinity);
      },
      // overridden
      ...
      getHeightForWidth: function getHeightForWidth(width) {
        return this.__P_143_1(width).height;
      },
       ...
       */
      __P_143_1: function __P_143_1(availWidth) {
        var lineCalculator = new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(), this.getSpacingX());
        var height = 0;
        var width = 0;
        var lineCount = 0;
...
//# sourceMappingURL=Flow.js.map?dt=1619884700521