  ...
  qx.Class.define("qx.ui.layout.Abstract", {
    ...
    members: {
      ...
      */
      ...
      getSizeHint: function getSizeHint() {
        ...
        return this.__P_199_0 = this._computeSizeHint();
      },
      ...
      _renderSeparator: function _renderSeparator(separator, bounds) {
        this.__P_199_1.renderSeparator(separator, bounds);
      },
      ...
      _applyLayoutChange: function _applyLayoutChange() {
        if (this.__P_199_1) {
          this.__P_199_1.scheduleLayoutUpdate();
        }
      },
      ...
      _getLayoutChildren: function _getLayoutChildren() {
        return this.__P_199_1.getLayoutChildren();
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__P_199_1 = this.__P_199_0 = null;
    }
  });
  qx.ui.layout.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1603737752683