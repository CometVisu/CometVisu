    ...
    */
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_121_2: function __P_121_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_121_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_121_1) {
          this.__P_121_1.call(this);

          delete this.__P_121_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1612694623778