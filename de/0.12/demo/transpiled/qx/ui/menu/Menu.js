    ...
    */
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_134_2: function __P_134_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_134_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_134_1) {
          this.__P_134_1.call(this);

          delete this.__P_134_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1620071709956