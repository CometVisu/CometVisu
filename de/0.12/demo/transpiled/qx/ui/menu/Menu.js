    ...
    */
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_135_2: function __P_135_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_135_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_135_1) {
          this.__P_135_1.call(this);

          delete this.__P_135_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1625668973456