    ...
    members: {
      ...
      */
      ...
      __P_122_2: function __P_122_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_122_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_122_1) {
          this.__P_122_1.call(this);

          delete this.__P_122_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1618504449971