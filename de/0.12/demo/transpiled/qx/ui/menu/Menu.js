    ...
    members: {
      ...
      */
      ...
      __P_123_2: function __P_123_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_123_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_123_1) {
          this.__P_123_1.call(this);

          delete this.__P_123_1;
        }
      },
...
//# sourceMappingURL=Menu.js.map?dt=1619362526939