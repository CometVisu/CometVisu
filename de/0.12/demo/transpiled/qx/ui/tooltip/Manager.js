  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_113_0, this, true); // Instantiate timers

      this.__P_113_1 = new qx.event.Timer();

      this.__P_113_1.addListener("interval", this.__P_113_2, this);

      this.__P_113_3 = new qx.event.Timer();

      this.__P_113_3.addListener("interval", this.__P_113_4, this); // Init pointer position
    ...
    */
    members: {
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__P_113_6) {
          this.__P_113_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }

        return this.__P_113_6;
      },
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__P_113_7) {
          this.__P_113_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });

          this.__P_113_7.setLabel(""); // trigger label widget creation


          this.__P_113_7.syncAppearance();
        }

        return this.__P_113_7;
      },
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_113_1.startWith(value.getShowTimeout()); // Register hide handler


          Registration.addListener(el, "pointerout", this.__P_113_8, this, true);
          Registration.addListener(el, "focusout", this.__P_113_9, this, true);
          Registration.addListener(el, "pointermove", this.__P_113_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__P_113_8, this, true);
          Registration.removeListener(el, "focusout", this.__P_113_9, this, true);
          Registration.removeListener(el, "pointermove", this.__P_113_10, this, true);
        }
      },
      ...
      */
       ...
       */
      __P_113_2: function __P_113_2(e) {
        var current = this.getCurrent();

        if (current && !current.isDisposed()) {
          this.__P_113_3.startWith(current.getHideTimeout());

          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__P_113_5);
          }
       ...
       * @param e {qx.event.type.Event} Event object
       */
      __P_113_4: function __P_113_4(e) {
        var current = this.getCurrent();
      ...
      */
       ...
       */
      __P_113_10: function __P_113_10(e) {
        var pos = this.__P_113_5;
       ...
       */
      __P_113_0: function __P_113_0(e) {
       ...
       */
      __P_113_8: function __P_113_8(e) {
      ...
      */
       ...
       */
      __P_113_9: function __P_113_9(e) {
        var target = qx.ui.core.Widget.getWidgetByElement(e.getTarget());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_113_0, this, true); // Dispose timers

      this._disposeObjects("__P_113_1", "__P_113_3", "__P_113_6");
...
//# sourceMappingURL=Manager.js.map?dt=1619362525881