  ...
  qx.Class.define("qx.ui.embed.Iframe", {
    ...
    */
    ...
    construct: function construct(source) {
      ...
      this.__P_130_1 = this._createBlockerElement();
    ...
    */
    members: {
      ...
      _createContentElement: function _createContentElement() {
        var iframe = new qx.html.Iframe(this.__P_130_0);
      ...
      */
      ...
      block: function block() {
        this.__P_130_1.setStyle("display", "block");
      },
      ...
      release: function release() {
        this.__P_130_1.setStyle("display", "none");
      },
      ...
      */
      ...
      setLayoutParent: function setLayoutParent(parent) {
        ...
        if (parent) {
          this.getLayoutParent().getContentElement().add(this.__P_130_1);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      if (this.getLayoutParent() && this.__P_130_1.getParent()) {
        this.getLayoutParent().getContentElement().remove(this.__P_130_1);
      }

      this._disposeObjects("__P_130_1");
...
//# sourceMappingURL=Iframe.js.map?dt=1618504450627