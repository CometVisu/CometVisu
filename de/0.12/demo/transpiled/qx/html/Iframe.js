  ...
  qx.Class.define("qx.html.Iframe", {
    ...
    */
    ...
    construct: function construct(url, styles, attributes) {
      ...
      this.setSource(url);
      this.addListener("navigate", this.__P_241_0, this); // add yourself to the element queue to enforce the creation of DOM element
    ...
    */
    members: {
      ...
      */
      __P_241_0: function __P_241_0(e) {
...
//# sourceMappingURL=Iframe.js.map?dt=1592778980301