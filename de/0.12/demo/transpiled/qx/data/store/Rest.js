  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.store.Rest", {
    ...
    construct: function construct(resource, actionName, delegate) {
      ...
      this.__P_102_1 = qx.lang.Function.bind(this.__P_102_2, this);
    ...
    members: {
       ...
       */
      __P_102_3: function __P_102_3() {
        var resource = this.getResource(),
            actionName = this.getActionName();

        if (resource && actionName) {
          resource.addListener(this.getActionName() + "Success", this.__P_102_1);
        }
      },
       ...
       */
      __P_102_2: function __P_102_2(e) {
        var data = e.getData(),
...
//# sourceMappingURL=Rest.js.map?dt=1592778967405