  ...
  qx.Class.define("qx.data.controller.List", {
    ...
    */
    ...
    construct: function construct(model, target, labelPath) {
      ...
      this.__P_120_0 = []; // register for bound target properties and onUpdate methods
    ...
    */
    members: {
      ...
      */
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_120_4 != undefined) {
            old.removeListenerById(this.__P_120_4);
          }
        ...
        if (value != null) {
          // add a new listener
          this.__P_120_4 = value.addListener("change", this.__P_120_10, this); // renew the index lookup table

          this.__P_120_11(); // check for the new length


          this.__P_120_7(); // as we only change the labels of the items, the selection change event
        ...
        if (value != null) {
          if (this.getModel() != null) {
            ...
            for (var i = 0; i < this.__P_120_0.length; i++) {
              this.__P_120_13(this.__P_120_14(i));
            }
          }
        }
      },
      ...
      */
       ...
       */
      __P_120_10: function __P_120_10() {
        if (this.__P_120_15) {
          return;
        }

        this.__P_120_15 = true; // need an asynchronous selection update because the bindings have to be
      ...
      syncWidget: function syncWidget() {
        ...
        this.__P_120_6 = this.__P_120_5 = null;
      },
      ...
      __P_120_7: function __P_120_7() {
        ...
        this.__P_120_11(); // sync the target selection in case someone deleted a item in
       ...
       */
      __P_120_16: function __P_120_16() {
        ...
        if (model != null) {
          model.removeListenerById(this.__P_120_4);
          this.__P_120_4 = model.addListener("change", this.__P_120_10, this);
        }
      },
      ...
      */
       ...
       */
      __P_120_13: function __P_120_13(index) {
       ...
       */
      __P_120_12: function __P_120_12() {
      ...
      */
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        if (options != null) {
          ...
          this.__P_120_3[targetProperty] = options.onUpdate;
          delete options.onUpdate;
        } else {
          options = {};
          this.__P_120_3[targetProperty] = null;
        }
        ...
        if (!this.__P_120_1.includes(targetProperty)) {
          this.__P_120_1.push(targetProperty);
        }
      },
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, index) {
        ...
        if (!this.__P_120_2.includes(targetPath)) {
          this.__P_120_2.push(targetPath);
        }
      },
      ...
      _onBindingSet: function _onBindingSet(index, sourceObject, targetObject) {
        ...
        for (var i = 0; i < this.__P_120_1.length; i++) {
          // if there is an onUpdate for one of it, invoke it
          if (this.__P_120_3[this.__P_120_1[i]] != null) {
            this.__P_120_3[this.__P_120_1[i]]();
          }
        }
      },
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        ...
        for (var i = 0; i < this.__P_120_1.length; i++) {
          ...
          var id = item.getUserData(this.__P_120_1[i] + "BindingId");

          if (id != null) {
            this.removeBinding(id);
            item.setUserData(this.__P_120_1[i] + "BindingId", null);
          }
        } // go through all reverse bound properties


        for (var i = 0; i < this.__P_120_2.length; i++) {
          // get the binding id and remove it, if possible
          var id = item.getUserData(this.__P_120_2[i] + "ReverseBindingId");

          if (id != null) {
            item.removeBinding(id);
            item.getUserData(this.__P_120_2[i] + "ReverseBindingId", null);
          }
        }
      ...
      __P_120_8: function __P_120_8() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this._bindListItem(items[i], this.__P_120_14(i));
      ...
      */
      ...
      _setFilter: function _setFilter(value, old) {
        ...
        var oldTable = this.__P_120_0; // generate a new lookup table

        this.__P_120_11(); // if there are lesser items


        if (oldTable.length > this.__P_120_0.length) {
          // remove the unnecessary items
          for (var j = oldTable.length; j > this.__P_120_0.length; j--) {
            this.getTarget().removeAt(j - 1).destroy();
          } // if there are more items

        } else if (oldTable.length < this.__P_120_0.length) {
          // add the new elements
          for (var j = oldTable.length; j < this.__P_120_0.length; j++) {
        ...
        for (var i = 0; i < listItems.length; i++) {
          this._bindListItem(listItems[i], this.__P_120_14(i));
        } // move the controllers change handler for the model to the end of the
        // listeners queue
       ...
       */
      __P_120_17: function __P_120_17() {
        // renew the index lookup table
        this.__P_120_11(); // check for the new length


        this.__P_120_7(); // renew the bindings


        this.__P_120_8(); // need an asynchronous selection update because the bindings have to be
        // executed to update the selection probably (using the widget queue)
      ...
      */
       ...
       */
      __P_120_11: function __P_120_11() {
        ...
        this.__P_120_0 = []; // -1 is a special lookup value, to represent the "null" option 

        if (this.isAllowNull()) {
          this.__P_120_0.push(-1);
        }

        for (var i = 0; i < model.getLength(); i++) {
          if (filter == null || filter(model.getItem(i))) {
            this.__P_120_0.push(i);
          }
        }
      },
       ...
       */
      __P_120_14: function __P_120_14(index) {
        return this.__P_120_0[index];
      }
    },
    ...
    destruct: function destruct() {
      this.__P_120_0 = this.__P_120_3 = this.__P_120_1 = null;
      this.__P_120_2 = null; // remove yourself from the widget queue
...
//# sourceMappingURL=List.js.map?dt=1619362526552