  ...
  qx.Class.define("qx.data.controller.website.List", {
    ...
    members: {
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_179_0 != undefined) {
            old.removeListenerById(this.__P_179_0);
          }

          if (this.__P_179_1 != undefined) {
            old.removeListenerById(this.__P_179_1);
          }
        } // if a model is set
        ...
        if (value != null) {
          ...
          if (value instanceof qx.core.Object) {
            // add new listeners
            this.__P_179_0 = value.addListener("change", this.update, this);
            this.__P_179_1 = value.addListener("changeBubble", this.update, this);
          }
        } else {
      ...
      update: function update() {
        ...
        this.__P_179_2(); // delegate methods
...
//# sourceMappingURL=List.js.map?dt=1614016355357