    ...
    */
    construct: function construct() {
      ...
      if (this.getSelection() == null) {
        this.__P_260_0 = new qx.data.Array();
        this.setSelection(this.__P_260_0);
      }
    },
    ...
    members: {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        ...
        if (this.__P_260_2 != undefined && old != undefined) {
          old.removeListenerById(this.__P_260_2);
          this.__P_260_2 = null;
        } // add a new change listener to the changeArray


        if (value) {
          this.__P_260_2 = value.addListener("change", this.__P_260_3, this);
      ...
      */
      ...
      _changeTargetSelection: function _changeTargetSelection() {
        ...
        if (!this.__P_260_4() && !this.__P_260_5()) {
          return;
      ...
      */
      ...
      _addChangeTargetListener: function _addChangeTargetListener(value, old) {
        ...
        if (this.__P_260_1 != undefined && old != undefined) {
          old.removeListenerById(this.__P_260_1);
        }
        ...
        if (value != null) {
          ...
          if (this.__P_260_4() || this.__P_260_5()) {
            ...
            this.__P_260_1 = value.addListener("changeSelection", this._changeTargetSelection, this);
          }
        }
      },
      ...
      _updateSelection: function _updateSelection() {
        ...
        if (this.__P_260_4()) {
          ...
          for (var i = 0; i < this.getSelection().length; i++) {
            ...
            var selectable = this.__P_260_6(model);
          ...
          if (item !== undefined) {
            ...
            this.__P_260_7(item); // remove the other items from the selection data array and get
       ...
       */
      __P_260_7: function __P_260_7(item) {
        var selectable = this.__P_260_6(item); // if no selectable could be found, just return
       ...
       */
      __P_260_6: function __P_260_6(model) {
        // get all list items
...
//# sourceMappingURL=MSelection.js.map?dt=1625668983587