  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct: function construct(callback, context) {
      ...
      this.__P_100_0 = callback;
      this.__P_100_1 = context || null;
      this.__P_100_2 = qx.util.DeferredCallManager.getInstance();
    },
    ...
    */
    members: {
       ...
       */
      call: function call() {
        this.__P_100_1 ? this.__P_100_0.apply(this.__P_100_1) : this.__P_100_0();
      }
    },
    ...
    */
    destruct: function destruct() {
      this.cancel();
      this.__P_100_1 = this.__P_100_0 = this.__P_100_2 = null;
    }
  });
  qx.util.DeferredCall.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DeferredCall.js.map?dt=1619884695599