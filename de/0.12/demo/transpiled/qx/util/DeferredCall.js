  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct: function construct(callback, context) {
      ...
      this.__P_111_0 = callback;
      this.__P_111_1 = context || null;
      this.__P_111_2 = qx.util.DeferredCallManager.getInstance();
    },
    ...
    */
    members: {
       ...
       */
      call: function call() {
        this.__P_111_1 ? this.__P_111_0.apply(this.__P_111_1) : this.__P_111_0();
      }
    },
    ...
    */
    destruct: function destruct() {
      this.cancel();
      this.__P_111_1 = this.__P_111_0 = this.__P_111_2 = null;
    }
  });
  qx.util.DeferredCall.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DeferredCall.js.map?dt=1625668971329