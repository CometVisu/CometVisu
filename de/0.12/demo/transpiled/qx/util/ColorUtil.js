    ...
    statics: {
      ...
      stringToRgb: function stringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          return this.__P_108_0(str);
        } else if (this.isRgbString(str)) {
          return this.__P_108_1();
...
//# sourceMappingURL=ColorUtil.js.map?dt=1592778967967