  ...
  qx.Class.define("qx.log.appender.Formatter", {
    ...
    members: {
      ...
      formatEntryTime: function formatEntryTime(entry) {
        ...
        if (!qx.log.appender.Formatter.__P_311_0) {
          qx.log.appender.Formatter.__P_311_0 = new qx.util.format.DateFormat("YYYY-MM-dd HH:mm:ss");
        }

        return qx.log.appender.Formatter.__P_311_0.format(entry.time);
      },
    ...
    statics: {
      ...
      getFormatter: function getFormatter() {
        if (!qx.log.appender.Formatter.__P_311_1) {
          qx.log.appender.Formatter.__P_311_1 = new qx.log.appender.Formatter();
        }

        return qx.log.appender.Formatter.__P_311_1;
      },
      ...
      setFormatter: function setFormatter(instance) {
        qx.log.appender.Formatter.__P_311_1 = instance;
      },
      ...
      escapeHTML: function escapeHTML(value) {
        return String(value).replace(/[<>&"']/g, qx.log.appender.Formatter.__P_311_2);
      },
       ...
       */
      __P_311_2: function __P_311_2(ch) {
        var map = {
          "<": "&lt;",
          ">": "&gt;",
          "&": "&amp;",
...
//# sourceMappingURL=Formatter.js.map?dt=1620146219429