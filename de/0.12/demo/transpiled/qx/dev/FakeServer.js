  ...
  qx.Bootstrap.define("qx.dev.FakeServer", {
    ...
    members: {
      ...
      addFilter: function addFilter(filter) {
        this.__P_152_1.FakeXMLHttpRequest.addFilter(filter);
      },
      ...
      removeFilter: function removeFilter(filter) {
        qx.lang.Array.remove(this.__P_152_1.FakeXMLHttpRequest.filters, filter);
      },
      ...
      removeResponse: function removeResponse(method, url) {
        qx.lang.Array.remove(this.__P_152_1.FakeXMLHttpRequest.filters, this.__P_152_3);
        var urlRegExp = url instanceof RegExp ? url : this._getRegExp(url);
        this.__P_152_0 = this.__P_152_0.filter(function (response) {
          return response[0] != method || response[1].toString() != urlRegExp.toString();
        });
        this.__P_152_2.responses = this.__P_152_2.responses.filter(function (response) {
          return response.method != method || response.url.toString() != urlRegExp.toString();
        });
        this.removeFilter(this.__P_152_3);
        this.__P_152_3 = this.__P_152_4();
        this.addFilter(this.__P_152_3);
      },
      ...
      getFakeServer: function getFakeServer() {
        if (!this.__P_152_2) {
          var sinon = this.__P_152_1 = qx.dev.unit.Sinon.getSinon();
          sinon.FakeXMLHttpRequest.useFilters = true;
          this.__P_152_2 = sinon.sandbox.useFakeServer();
          this.__P_152_2.autoRespond = true;
        }

        return this.__P_152_2;
      },
    ...
    destruct: function destruct() {
      this.restore();
      this.__P_152_2 = this.__P_152_1 = null;
    }
  });
  qx.dev.FakeServer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=FakeServer.js.map?dt=1592778973578