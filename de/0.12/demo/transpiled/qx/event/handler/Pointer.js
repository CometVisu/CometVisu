  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Pointer", {
    ...
    construct: function construct(manager) {
      ...
      this.__P_266_2 = this.__P_266_1.document;
      qx.event.handler.PointerCore.apply(this, [this.__P_266_2]);
    },
    members: {
      __P_266_0: null,
      __P_266_1: null,
        ...
        if (target && target.nodeType) {
          ...
          qx.event.Utils.then(tracker, function () {
            if ((domEvent.getPointerType() !== "mouse" || domEvent.button <= qx.event.handler.PointerCore.LEFT_BUTTON) && (type == "pointerdown" || type == "pointerup" || type == "pointermove" || type == "pointercancel")) {
              return qx.event.Registration.fireEvent(self.__P_266_2, qx.event.handler.PointerCore.POINTER_TO_GESTURE_MAPPING[type], qx.event.type.Pointer, [domEvent, target, null, false, false]);
            }
          });
          qx.event.Utils.then(tracker, function () {
            // Fire user action event
            return qx.event.Registration.fireEvent(self.__P_266_1, "useraction", qx.event.type.Data, [type]);
          });
       ...
       */
      __P_266_3: function __P_266_3(method, args) {
...
//# sourceMappingURL=Pointer.js.map?dt=1592778982731