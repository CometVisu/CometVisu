    ...
    */
    ...
    members: {
      ...
      _applyTimeoutInterval: function _applyTimeoutInterval(value) {
        if (this.__P_304_0) {
          this.__P_304_0.setInterval(value);
        }
      },
       ...
       */
      __P_304_2: function __P_304_2() {
        if (this.__P_304_0 && !this.hasListener("interval")) {
          this.__P_304_0.stop();

          this.__P_304_0.dispose();
...
//# sourceMappingURL=Idle.js.map?dt=1592778985204