  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.AcceleratingTimer", {
    ...
    construct: function construct() {
      ...
      this.__P_337_0 = new qx.event.Timer(this.getInterval());
    ...
    members: {
      ...
      start: function start() {
        this.__P_337_0.setInterval(this.getFirstInterval());
      ...
      _onInterval: function _onInterval() {
        ...
        if (this.__P_337_1 == null) {
          this.__P_337_1 = this.getInterval();
        }

        this.__P_337_1 = Math.max(this.getMinimum(), this.__P_337_1 - this.getDecrease());

        this.__P_337_0.setInterval(this.__P_337_1);
...
//# sourceMappingURL=AcceleratingTimer.js.map?dt=1619362546571