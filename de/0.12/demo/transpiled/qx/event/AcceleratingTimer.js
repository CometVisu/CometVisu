  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.AcceleratingTimer", {
    ...
    construct: function construct() {
      ...
      this.__P_334_0 = new qx.event.Timer(this.getInterval());

      this.__P_334_0.addListener("interval", this._onInterval, this);
    },
    events: {
    ...
    members: {
      ...
      start: function start() {
        this.__P_334_0.setInterval(this.getFirstInterval());

        this.__P_334_0.start();
      },
      ...
      _onInterval: function _onInterval() {
        ...
        if (this.__P_334_1 == null) {
          this.__P_334_1 = this.getInterval();
        }

        this.__P_334_1 = Math.max(this.getMinimum(), this.__P_334_1 - this.getDecrease());

        this.__P_334_0.setInterval(this.__P_334_1);
...
//# sourceMappingURL=AcceleratingTimer.js.map?dt=1603737763348