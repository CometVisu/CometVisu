  ...
  qx.Mixin.define("qx.core.MLogging", {
    members: {
      ...
      debug: function debug(varargs) {
        this.__P_185_1("debug", arguments);
      },
      ...
      error: function error(varargs) {
        this.__P_185_1("error", arguments);
      },
      ...
      trace: function trace(varargs) {
        this.__P_185_1("trace", arguments);
      },
       ...
       */
      __P_185_1: function __P_185_1(level, varargs) {
        var argumentsArray = qx.lang.Array.fromArguments(varargs);
        argumentsArray.unshift(this);

        this.__P_185_0[level].apply(this.__P_185_0, argumentsArray);
      }
    }
  });
...
//# sourceMappingURL=MLogging.js.map?dt=1619884703680