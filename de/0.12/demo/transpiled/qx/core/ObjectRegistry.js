    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_211_1++ + this.__P_211_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_211_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1620513288809