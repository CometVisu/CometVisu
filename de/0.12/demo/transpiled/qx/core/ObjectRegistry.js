    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_173_1++ + this.__P_173_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_173_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1618504455386