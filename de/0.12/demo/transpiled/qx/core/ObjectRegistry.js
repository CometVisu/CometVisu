    ...
    */
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_170_1++ + this.__P_170_2);
        return hash;
      },
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_170_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1592778974621