  ...
  qx.Class.define("qx.core.Object", {
    ...
    members: {
      ...
      */
      ...
      clone: function clone() {
        ...
        var user = this.__P_98_0.$$store.user;
        var setter = this.__P_98_0.$$method.set;
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_98_1 = null; // only of properties are available

      {
        // Cleanup properties
        var clazz = this.constructor;
        var properties;
        var store = this.__P_98_0.$$store;
...
//# sourceMappingURL=Object.js.map?dt=1620071706277