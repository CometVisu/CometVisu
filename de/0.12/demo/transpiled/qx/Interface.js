  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_85_0: function __P_85_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
        ...
        if (members) {
          for (var key in members) {
            if (qx.Bootstrap.isFunction(members[key])) {
              var isPropertyMethod = this.__P_85_1(clazz, key);
              ...
              if (shouldWrapFunction) {
                object[key] = this.__P_85_2(iface, object[key], key, members[key]);
              }
            } else {
       ...
       *   system.
       */
      __P_85_1: function __P_85_1(clazz, methodName) {
       ...
       */
      __P_85_3: function __P_85_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_85_4: function __P_85_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_85_0(object, clazz, iface, false, true);

        this.__P_85_3(clazz, iface, true);

        this.__P_85_4(clazz, iface, true); // Validate extends, recursive
      ...
      assert: function assert(clazz, iface, wrap) {
        this.__P_85_0(clazz.prototype, clazz, iface, wrap, true);
      ...
      objectImplements: function objectImplements(object, iface) {
        ...
        if (!this.__P_85_0(object, clazz, iface) || !this.__P_85_3(clazz, iface) || !this.__P_85_4(clazz, iface)) {
          return false;
      ...
      classImplements: function classImplements(clazz, iface) {
        if (!this.__P_85_0(clazz.prototype, clazz, iface) || !this.__P_85_3(clazz, iface) || !this.__P_85_4(clazz, iface)) {
          return false;
        } // Validate extends, recursive
      ...
      */
       ...
       */
      __P_85_2: function __P_85_2(iface, origFunction, functionName, preCondition) {},
       ...
       */
      __P_85_6: function __P_85_6(name, config) {}
    }
  });
  qx.Interface.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Interface.js.map?dt=1618504446199