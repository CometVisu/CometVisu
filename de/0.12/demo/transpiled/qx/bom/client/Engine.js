  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_146_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_146_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_146_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_146_3()) {
      ...
      __P_146_0: function __P_146_0() {
        ...
        if (qx.bom.client.Engine.__P_146_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1625668974201