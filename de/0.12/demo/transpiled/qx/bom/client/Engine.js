  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_161_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_161_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_161_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_161_3()) {
      ...
      __P_161_0: function __P_161_0() {
        ...
        if (qx.bom.client.Engine.__P_161_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1619884702127