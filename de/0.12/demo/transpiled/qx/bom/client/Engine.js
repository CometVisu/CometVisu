  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_145_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_145_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_145_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_145_3()) {
      ...
      __P_145_0: function __P_145_0() {
        ...
        if (qx.bom.client.Engine.__P_145_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1620513282691