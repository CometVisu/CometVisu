    ...
    members: {
      ...
      __P_271_0: function __P_271_0() {
        if (qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT) {
          var boundFunc = qx.lang.Function.bind(this.__P_271_2, this);
          this.__P_271_1 = qx.event.GlobalError.observeMethod(boundFunc);
          qx.bom.Event.addNativeListener(window, "hashchange", this.__P_271_1);
        } else {
          qx.event.Idle.getInstance().addListener("interval", this.__P_271_2, this);
        }
      },
       ...
       */
      __P_271_3: function __P_271_3() {
        if (qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT) {
          qx.bom.Event.removeNativeListener(window, "hashchange", this.__P_271_1);
        } else {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_271_2, this);
        }
      },
...
//# sourceMappingURL=NativeHistory.js.map?dt=1592778983184