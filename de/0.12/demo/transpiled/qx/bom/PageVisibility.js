  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.PageVisibility", {
    ...
    construct: function construct(document) {
      this.__P_68_0 = document || window.document;
    ...
    members: {
      ...
      __P_68_1: function __P_68_1() {
        ...
        for (var i = 0; i < prefix.length; i++) {
          ...
          if (this.__P_68_0[attr] != undefined) {
            this.__P_68_3 = attr; // also use the same prefix for the event name

            this.__P_68_2 = prefix[i].toLowerCase() + "visibilitychange";
            break;
          }
        }
        ...
        if (this.__P_68_3 == null) {
          this.__P_68_3 = "hidden";
          this.__P_68_2 = "visibilitychange";
        }

        if (this.__P_68_4 == null) {
          this.__P_68_4 = "visibilityState";
        }
      },
      ...
      isHidden: function isHidden() {
        return !!this.__P_68_0[this.__P_68_3];
      },
      ...
      getVisibilityState: function getVisibilityState() {
        return this.__P_68_0[this.__P_68_4] || "visible";
      }
    }
  });
...
//# sourceMappingURL=PageVisibility.js.map?dt=1625668968125