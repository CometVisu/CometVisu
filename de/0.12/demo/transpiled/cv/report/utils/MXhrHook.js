    ...
    members: {
      ...
      _onPhaseChange: function _onPhaseChange(ev) {
        ...
        if (ev.getData() === "opened") {
          this.__sendTime = Date.now(); // calculate Hash value for request
          ...
          delay = Date.now() - this.__sendTime; // log the trigger that triggers the server responses
          ...
          this.__sendTime = null; // delete pending request
          ...
          delay = Date.now() - this.__sendTime; // request aborted, maybe by watchdog
...
//# sourceMappingURL=MXhrHook.js.map?dt=1587971959963