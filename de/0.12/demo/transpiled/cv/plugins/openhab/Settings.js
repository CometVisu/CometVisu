  ...
  qx.Class.define("cv.plugins.openhab.Settings", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_22_0 = "org.openhab.cometvisu";
      this.__P_22_1 = "ui:cometvisu";
    ...
    members: {
      ...
      _initStore: function _initStore(pid) {
        ...
        this._store.addListenerOnce("changeModel", function () {
          this.__P_22_6 = JSON.parse(qx.util.Serializer.toJson(this._store.getModel()));
        }, this);
      },
      _saveConfig: function _saveConfig() {
        ...
        this.__P_22_3.put(null, data);

        this.__P_22_3.addListenerOnce("putSuccess", this.close, this);
      },
      _initConfigRestClient: function _initConfigRestClient() {
        var description = {
          "get": {
            method: "GET",
            url: "/rest/config-descriptions/" + this.__P_22_1
          }
        };
      ...
      _onFormFieldChange: function _onFormFieldChange() {
        ...
        Object.getOwnPropertyNames(items).some(function (name) {
          ...
          if (this.__P_22_6[name] != items[name].getValue()) {
            // jshint ignore:line
            this.debug(name + " has changed from " + this.__P_22_6[name] + " to " + items[name].getValue());
            modified = true;
            return true;
          }
        }, this);
...
//# sourceMappingURL=Settings.js.map?dt=1619362516863