    ...
    members: {
      seekTo: function seekTo(target, speed) {
        ...
        if (animationEnabled) {
          ...
          animationConfig = this.__P_164_0(direction); // show the new page (because animations do not work on hidden elements) + hide scrollbar
        ...
        if (!animationEnabled) {
          if (oldPageWidget) {
            this.__P_164_1(oldPageWidget);
          }

          this.__P_164_2(pageWidget, 0, true);
        } else {
          if (oldPageWidget) {
          ...
          qx.bom.AnimationFrame.request(function () {
            ...
            animation.addListenerOnce("end", function () {
              this.__P_164_2(pageWidget, oldPos);
            }, this);
          }, this);
        }
      },
       ...
       */
      __P_164_0: function __P_164_0(direction) {
       ...
       */
      __P_164_1: function __P_164_1(oldPageWidget) {
       ...
       */
      __P_164_2: function __P_164_2(pageWidget, oldPos, updateVisibility) {
...
//# sourceMappingURL=PageHandler.js.map?dt=1592778974244