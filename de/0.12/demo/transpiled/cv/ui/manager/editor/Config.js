    ...
    */
    members: {
      ...
      _applyContent: function _applyContent(value) {
        ...
        model.removeAll();
        this.__P_32_0 = Object.keys(value).length;
      ...
      __P_32_1: function __P_32_1() {
        ...
        if (this.__P_32_0 !== this._listController.getModel().length) {
          ...
          case 'list':
            ...
            this._listController.setDelegate({
              ...
              configureItem: function (item) {
                ...
                item.addListener('changeModified', this.__P_32_1, this);
              }.bind(this),
...
//# sourceMappingURL=Config.js.map?dt=1620146190721