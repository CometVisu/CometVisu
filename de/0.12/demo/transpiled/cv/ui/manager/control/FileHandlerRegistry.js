  ...
  qx.Class.define('cv.ui.manager.control.FileHandlerRegistry', {
    ...
    */
    construct: function construct() {
      ...
      this.__registry = {};
      this.__defaults = []; // register viewers
      ...
      this.registerFileHandler(cv.ui.manager.editor.Xml.SUPPORTED_FILES, cv.ui.manager.editor.Xml, {
        ...
        // the old XML-Editor cannot handle temporary files,
    ...
    */
    members: {
      ...
      getFileHandler: function getFileHandler(file, type) {
        ...
        if (!(file instanceof cv.ui.manager.model.CompareFiles)) {
          ...
          Object.keys(this.__defaults).some(function (key) {
            if (this.__defaults[key].regex.test(file.getFullPath()) && (!file.isTemporary() || !this.__defaults[key].noTemporaryFiles) && (file.isWriteable() || !this.__defaults[key].noReadOnlyFiles)) {
              if (type) {
      ...
      __canHandle: function __canHandle(config, file) {
...
//# sourceMappingURL=FileHandlerRegistry.js.map?dt=1591014030909