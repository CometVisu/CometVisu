  ...
  qx.Mixin.define("cv.ui.common.HasAnimatedButton", {
    ...
    */
    members: {
      ...
      __ilid: null,
      __downTarget: null,
      __initListeners: function __initListeners() {
      ...
      __getActors: function __getActors() {
      ...
      __updateButtons: function __updateButtons(buttons, pressed) {
        if (pressed) {
...
//# sourceMappingURL=HasAnimatedButton.js.map?dt=1588446002059