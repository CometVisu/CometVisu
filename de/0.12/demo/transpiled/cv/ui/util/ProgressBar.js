    ...
    */
    members: {
      ...
      _applyValue: function _applyValue(value) {
        var rect = this.__domElement.getBoundingClientRect(),
      ...
      _createDomElement: function _createDomElement() {
        var container = this.__domElement = qx.dom.Element.create("div", {
          "class": "progressbar"
        });
        this.__domElement.$$widget = this;
        var progress = this.__progressElement = qx.dom.Element.create("div", {
          "class": "completed"
        });
...
//# sourceMappingURL=ProgressBar.js.map?dt=1589401113175