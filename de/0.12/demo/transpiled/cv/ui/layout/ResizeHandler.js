    ...
    */
    statics: {
      ...
      queueJob: function queueJob(callback) {
        ...
        if (!this.__P_86_2) {
          this.__P_86_2 = qx.bom.AnimationFrame.request(this.flush, this);
        }
      },
      ...
      makeBackdropValid: function makeBackdropValid() {
        this.queueJob(this.__P_86_3);
      },
      __P_86_3: function __P_86_3() {
        ...
        if ('2d' === page.getPageType()) {
          ...
          try {
            ...
            if (e.name === 'NotSupportedError') {
              if (this.__P_86_1 <= 5) {
                qx.bom.AnimationFrame.request(this.__P_86_3, this);
                this.__P_86_1++;
              }
            }
      ...
      makeNavbarValid: function makeNavbarValid() {
        this.queueJob(this.__P_86_4);
      },
      __P_86_4: function __P_86_4() {
      ...
      makePagesizeValid: function makePagesizeValid() {
        if (this.__P_86_0 === true) {
          // do not queue -> call now
          this.__P_86_0 = false;

          this.__P_86_5();
        } else {
          this.queueJob(this.__P_86_5);
        }
      },
      __P_86_5: function __P_86_5() {
        ...
        if (page && !page.isInitialized()) {
          page.addListenerOnce("changeInitialized", this.__P_86_5, this);
          return;
        }
      ...
      makeRowspanValid: function makeRowspanValid() {
        this.queueJob(this.__P_86_6);
      },
      __P_86_6: function __P_86_6() {
        ...
        this.__P_86_7(elem.querySelector("#containerDiv"));
      },
      __P_86_7: function __P_86_7(elem) {
...
//# sourceMappingURL=ResizeHandler.js.map?dt=1620146197533