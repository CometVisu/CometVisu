  ...
  qx.Class.define("cv.ui.ToastManager", {
    ...
    members: {
      ...
      _init: function _init() {
        if (!this.__P_75_0) {
          ...
          this.__P_75_0 = document.querySelector(this.getRootElementId());

          if (!this.__P_75_0) {
            this.__P_75_0 = qx.dom.Element.create("div", {
        ...
        if (document.querySelectorAll(this.getRootElementId()).length === 0) {
          document.body.appendChild(this.__P_75_0);
        }
        ...
        this._list = new qx.data.controller.website.List(this._messages, this.__P_75_0, "ToastTemplate");
        qx.event.Registration.addListener(this.__P_75_0, "tap", this._onListTap, this);
      },
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__P_75_0) {
        this.__P_75_0.parentNode.removeChild(this.__P_75_0);
...
//# sourceMappingURL=ToastManager.js.map?dt=1614551887604