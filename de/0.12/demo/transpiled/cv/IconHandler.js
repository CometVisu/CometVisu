(function () {
  ...
  qx.Class.define('cv.IconHandler', {
    ...
    construct: function construct() {
      this.__P_79_0 = cv.IconConfig.DB;
    },
    ...
    members: {
      ...
      insert: function insert() {
        ...
        if (!this.__P_79_0[name]) {
          this.__P_79_0[name] = {};
        }

        if (!this.__P_79_0[name][type]) {
          this.__P_79_0[name][type] = {};
        }

        if (!this.__P_79_0[name][type][flavour]) {
          this.__P_79_0[name][type][flavour] = {};
        }

        if (dynamic && window[dynamic]) {
          this.__P_79_0[name][type][flavour][color] = window[dynamic](uri);
        } else {
          this.__P_79_0[name][type][flavour][color] = {
            uri: uri,
            styling: styling
          };
        }
      ...
      get: function get(name, type, flavour, color) {
        ...
        if (typeof this.__P_79_0[name][type] === 'string') {
          type = this.__P_79_0[name][type]; // redirect link
        ...
        if (typeof this.__P_79_0[name][type][flavour] === 'string') {
          flavour = this.__P_79_0[name][type][flavour]; // redirect link
        ...
        if (!this.__P_79_0[name][type][flavour][color]) {
          color = '*'; // undefined -> use default
        } // handle a generic mapping function


        if (typeof this.__P_79_0[name][type][flavour]['*'] === 'function') {
          return this.__P_79_0[name][type][flavour]['*'];
        }

        if (typeof this.__P_79_0[name][type][flavour][color] === 'string') {
          color = this.__P_79_0[name][type][flavour][color];
        } // redirect link


        return this.__P_79_0[name][type][flavour][color];
      },
       ...
       */
      list: function list() {
        return Object.keys(this.__P_79_0);
      },
...
//# sourceMappingURL=IconHandler.js.map?dt=1604956071325