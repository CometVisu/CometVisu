  ...
  qx.Class.define('cv.io.transport.Sse', {
    ...
    members: {
      ...
      connect: function connect() {
        ...
        Object.getOwnPropertyNames(this.__P_156_0).forEach(this.__P_156_1, this);
      ...
      dispatchTopicMessage: function dispatchTopicMessage(topic, message) {
        ...
        if (this.__P_156_0[topic]) {
          this.__P_156_0[topic].forEach(function (entry) {
      ...
      subscribe: function subscribe(topic, callback, context) {
        if (!this.__P_156_0[topic]) {
          this.__P_156_0[topic] = [];
        }

        this.__P_156_0[topic].push([callback, context]);

        if (this.isConnectionRunning()) {
          this.__P_156_1(topic);
        }
      },
      __P_156_1: function __P_156_1(topic) {
...
//# sourceMappingURL=Sse.js.map?dt=1618504454249