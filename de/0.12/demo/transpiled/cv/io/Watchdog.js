    ...
    */
    members: {
      ...
      start: function start(watchdogTimer) {
        ...
        this.__P_263_0 = setInterval(this.aliveCheckFunction.bind(this), watchdogTimer * 1000);
      },
      stop: function stop() {
        if (this.__P_263_0) {
          clearInterval(this.__P_263_0);
          this.__P_263_0 = null;
        }
      },
...
//# sourceMappingURL=Watchdog.js.map?dt=1618504462625