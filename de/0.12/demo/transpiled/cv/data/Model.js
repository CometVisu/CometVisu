    ...
    */
    members: {
      ...
      onUpdate: function onUpdate(address, state) {
        var initial = !this.__P_79_0.hasOwnProperty(address);
        var changed = initial || this.__P_79_0[address] !== state;
        this.__P_79_0[address] = state; // notify listeners

        if (this.__P_79_1[address]) {
          this.__P_79_1[address].forEach(function (listener) {
      ...
      addUpdateListener: function addUpdateListener(address, callback, context) {
        if (!this.__P_79_1[address]) {
          this.__P_79_1[address] = [];
        }

        this.__P_79_1[address].push([callback, context]);
      },
      ...
      removeUpdateListener: function removeUpdateListener(address, callback, context) {
        if (this.__P_79_1[address]) {
          ...
          this.__P_79_1[address].some(function (entry, i) {
          ...
          if (removeIndex >= 0) {
            this.__P_79_1[address].splice(removeIndex, 1);

            if (this.__P_79_1[address].length === 0) {
              delete this.__P_79_1[address];
            }
          }
        }
      },
      ...
      getAddresses: function getAddresses() {
        return Object.keys(this.__P_79_2);
      },
      ...
      getWidgetData: function getWidgetData(path) {
        return this.__P_79_3[path] || (this.__P_79_3[path] = {});
      },
...
//# sourceMappingURL=Model.js.map?dt=1618504445803