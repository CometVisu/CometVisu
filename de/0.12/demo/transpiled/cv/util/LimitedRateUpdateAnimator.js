  ...
  qx.Class.define('cv.util.LimitedRateUpdateAnimator', {
    ...
    */
    ...
    construct: function construct(displayRatioFn) {
      ...
      this.__P_147_0 = context;
      this.__P_147_1 = displayRatioFnParameters;
    },
    ...
    */
    destruct: function destruct() {
      if (this.__P_147_2 !== undefined) {
        window.cancelAnimationFrame(this.__P_147_2);
        this.__P_147_2 = undefined;
      }
    },
    ...
    */
    members: {
      ...
      setTo: function setTo(targetRatio) {
        ...
        this.__P_147_4 = targetRatio;

        if (instant) {
          this.__P_147_3 = targetRatio;
        }

        if (this.__P_147_2 === undefined) {
          this.__P_147_5(now, now - 10);
        }
      },
       ...
       * @private
       */
      __P_147_5: function __P_147_5(thistime, lasttime) {
        var _this = this;
        ...
        var nextRatio = this.__P_147_4 * alpha + this.__P_147_3 * (1 - alpha);
        var delta = nextRatio - this.__P_147_3;

        if (Math.abs(delta) > maxLinearDelta) {
          nextRatio = this.__P_147_3 + Math.sign(delta) * maxLinearDelta;
        }

        if (Math.abs(nextRatio - this.__P_147_4) < this.getEpsilon()) {
          nextRatio = this.__P_147_4;
        }

        this.__P_147_3 = nextRatio;
        this.getDisplayRatioFn().call(this.__P_147_0, this.__P_147_3, this.__P_147_1);

        if (this.__P_147_3 !== this.__P_147_4) {
          this.__P_147_2 = window.requestAnimationFrame(function (time) {
            _this.__P_147_5(time, thistime);
          });
        } else {
          this.__P_147_2 = undefined;
        }
...
//# sourceMappingURL=LimitedRateUpdateAnimator.js.map?dt=1618504453032