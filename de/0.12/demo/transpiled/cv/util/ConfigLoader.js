  ...
  qx.Class.define('cv.util.ConfigLoader', {
    ...
    */
    construct: function construct() {
      ...
      this.__P_89_0 = new qx.data.Array();
    },
    ...
    */
    members: {
      ...
      load: function load(callback, context) {
        this.__P_89_1 = callback;
        this.__P_89_2 = context; // get the data once the page was loaded
        ...
        ajaxRequest.addListenerOnce("success", function (e) {
          ...
          this.__P_89_0.remove(ajaxRequest.getUrl());
      ...
      _checkQueue: function _checkQueue() {
        if (this.__P_89_0.length === 0) {
          this.__P_89_1.call(this.__P_89_2, this.__P_89_3);
...
//# sourceMappingURL=ConfigLoader.js.map?dt=1620513277984