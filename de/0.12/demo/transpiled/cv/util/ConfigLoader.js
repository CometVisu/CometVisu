    ...
    */
    members: {
      ...
      load: function load(callback, context) {
        this.__P_77_1 = callback;
        this.__P_77_2 = context; // get the data once the page was loaded
        ...
        ajaxRequest.addListenerOnce("success", function (e) {
          ...
          this.__P_77_0.remove(ajaxRequest.getUrl());
      ...
      _checkQueue: function _checkQueue() {
        if (this.__P_77_0.length === 0) {
          this.__P_77_1.call(this.__P_77_2, this.__P_77_3);
...
//# sourceMappingURL=ConfigLoader.js.map?dt=1618504445709