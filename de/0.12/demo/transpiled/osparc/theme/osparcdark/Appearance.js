    ...
    appearances: {
      ...
      */
      ...
      "slidebar/button-forward": {
        ...
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["arrow-" + (states.vertical ? "down" : "right")]
          };
        }
      },
      "slidebar/button-backward": {
        ...
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["arrow-" + (states.vertical ? "up" : "left")]
          };
        }
      },
      ...
      */
      ...
      "treevirtual-line": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-line"]
          };
        }
      },
      "treevirtual-contract": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["tree-minus"]
          };
        }
      },
      "treevirtual-expand": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["tree-plus"]
          };
        }
      },
      "treevirtual-only-contract": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-minus-only"]
          };
        }
      },
      "treevirtual-only-expand": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-plus-only"]
          };
        }
      },
      "treevirtual-start-contract": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-minus-start"]
          };
        }
      },
      "treevirtual-start-expand": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-plus-start"]
          };
        }
      },
      "treevirtual-end-contract": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-minus-end"]
          };
        }
      },
      "treevirtual-end-expand": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-plus-end"]
          };
        }
      },
      "treevirtual-cross-contract": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-minus-cross"]
          };
        }
      },
      "treevirtual-cross-expand": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-plus-cross"]
          };
        }
      },
      "treevirtual-end": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-end"]
          };
        }
      },
      "treevirtual-cross": {
        style: function style(states) {
          return {
            icon: osparc.theme.osparcdark.Image.URLS["treevirtual-cross"]
          };
        }
      },
      ...
      */
      "radiobutton": {
        style: function style(states) {
          ...
          if (states.checked) {
            icon = osparc.theme.osparcdark.Image.URLS["radiobutton-checked"]; // Checked
          } else {
            icon = osparc.theme.osparcdark.Image.URLS["radiobutton-unchecked"]; // Unchecked
          }
      ...
      */
      "checkbox": {
        ...
        style: function style(states) {
          ...
          if (states.checked) {
            icon = osparc.theme.osparcdark.Image.URLS["checkbox-checked"]; // Undetermined
          } else if (states.undetermined) {
            icon = osparc.theme.osparcdark.Image.URLS["checkbox-undetermined"]; // Unchecked
          } else {
            // empty icon
...
//# sourceMappingURL=Appearance.js.map?dt=1589223285452