    ...
    members: {
      ...
      addWidget: function addWidget(widget) {
        var appearId = widget.addListenerOnce("appear", function (evt) {
          var data = this.__P_137_0[widget.toHashCode()];
        ...
        this.__P_137_0[widget.toHashCode()] = {
          appearId: appearId,
          keydownId: keydownId,
          widget: widget,
          inputElement: null
      ...
      removeWidget: function removeWidget(widget) {
        ...
        if (data) {
          ...
          delete this.__P_137_0[widget.toHashCode()];
        }
      },
       ...
       */
      __P_137_4: function __P_137_4(widget) {
        var data = this.__P_137_0[widget.toHashCode()];
      ...
      _applyRequireMultipartFormData: function _applyRequireMultipartFormData(value, oldValue) {
        if (this.__P_137_2) throw new Error("Changing the requireMultipartFormData property of " + this + " has no effect once uploads have started");
      },
      ...
      _createInputElement: function _createInputElement(widget) {
        ...
        var name = this.getInputNamePrefix() + '-' + ++this.__P_137_1;
      ...
      getUploadHandler: function getUploadHandler() {
        if (!this.__P_137_2) {
          if (com.zenesis.qx.upload.XhrHandler.isSupported(this.isRequireMultipartFormData())) this.__P_137_2 = new com.zenesis.qx.upload.XhrHandler(this);else this.__P_137_2 = new com.zenesis.qx.upload.FormHandler(this);
        }

        return this.__P_137_2;
      },
      ...
      allocateUploadId: function allocateUploadId() {
        return "uploadId:" + ++this.__P_137_3;
      }
    }
  });
...
//# sourceMappingURL=UploadMgr.js.map?dt=1618504452333