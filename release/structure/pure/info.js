...
define(["_common"],function(e){var t=e.basicdesign;e.basicdesign.addCreator("info",{create:function(e,n,r,i){var s=$(e),o=t.createDefaultWidget("info",s,n,r,i,this.update),u='<div class="actor"><div class="value">-</div></div>';return o+=u,o+"</div>"},update:function(e,n){var r=$(this);t.defaultUpdate(e,n,r,!0,r.parent().attr("id"))},update3d:e.basicdesign.defaultUpdate3d})});