...
qx.Class.define("cv.parser.widgets.Roundbar", {
 ...
 return []; 
              ...
              value.split(";").forEach(function (range) {
                var
                  ...
                  var thisRange = {start: parseFloat(startEnd[0]), end: parseFloat(startEnd[1])};
 ...
 return []; 
          ...
          "arrowtype": { "default": 0, transform: function(t) {
 return ({"angle":0, "distance":1})[t] || 0; 
} },
          "spacing": {"default": 10.0, transform: parseFloat},
          "overflowarrow": { "default": "true", transform: function (value) {
 return value === "true"; 
} },
          ...
          "debug": {"default": false, transform: function(v) {
 return v === "true"; 
}}
        };
        var thisPreset = ({
