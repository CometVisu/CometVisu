...
describe('testing a infotrigger widget', function() {
 ...
 return m.matches('.actor'); 
  ...
  it('should test the infotrigger creator centered', function() {
    ...
    // check infoposition
    var info = obj.getInfoActor();
    actors = Array.from(widget.getElementsByTagName('*')).filter(function(m) {
 return m.matches('.actor'); 
});
  ...
  it('should test the infotrigger creator aligned right', function() {
