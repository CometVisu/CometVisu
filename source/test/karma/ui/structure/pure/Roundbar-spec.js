...
describe("testing a roundbar widget", function() {
  ...
  it("should update a multiple bar roundbar widget", function(done) {
    ...
    expect(label[ 5].getAttribute('alignment-baseline')).toBe('baseline');
    ...
    expect(label[ 6].getAttribute('alignment-baseline')).toBe('hanging');
    ...
    expect(label[ 7].getAttribute('alignment-baseline')).toBe('middle');
    ...
    expect(label[ 8].getAttribute('alignment-baseline')).toBe('middle');
