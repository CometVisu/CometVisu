...
/**
 * Unit tests for cv.ui.structure.tile.components.chart.LineGroup
 *
 * @author Tobias Bräutigam
 * @since 2025
 */
describe('testing the LineGroup chart component', () => {
  let chart;
  let group;
  ...
  it('should initialize with chart', () => {
    group = new cv.ui.structure.tile.components.chart.LineGroup(chart, 'line');
    expect(chart.getSvgElement).toHaveBeenCalledWith('g', ['line'], jasmine.any(Object));
  });
});
