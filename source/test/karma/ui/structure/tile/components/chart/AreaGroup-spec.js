...
/**
 * Unit tests for cv.ui.structure.tile.components.chart.AreaGroup
 *
 * @author Tobias Bräutigam
 * @since 2025
 */
describe('testing the AreaGroup chart component', () => {
  let chart;
  let group;
  ...
  it('should create an AreaGroup', () => {
    group = new cv.ui.structure.tile.components.chart.AreaGroup(chart, 'area');
    expect(group).not.toBeNull();
    expect(group.getType()).toBe('area');
  });
  ...
  it('should initialize with chart', () => {
    group = new cv.ui.structure.tile.components.chart.AreaGroup(chart, 'area');
    expect(chart.getSvgElement).toHaveBeenCalledWith('g', ['area'], jasmine.any(Object));
  });
