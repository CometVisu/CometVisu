...
define( [ 'lib/cv/Config', 'joose' ], function(Config) {
  ...
  Class('cv.layout.Manager', {
      ...
      have: {
        ...
        oldWidth : -1,
        usedRowspans : Joose.I.Object
      },

      methods: {
        getCurrentPageNavbarVisibility : function() {
          if (this.currentPageNavbarVisibility==null) {
            this.currentPageNavbarVisibility = thisTemplateEngine.pagePartsHandler.getNavbarsVisibility(thisTemplateEngine.currentPage);
          }
        ...
        adjustColumns : function() {
          var
            ...
            oldClass = this.getColspanClass( oldWidth ),
        ...
        applyColumnWidths : function() {
          ...
          ['#navbarTop', '#navbarLeft', '#main', '#navbarRight', '#navbarBottom'].forEach( function( area ){
            ...
            adjustableElements.each(function(i, e) {
              ...
              if (ourColspan > 0) {
                var areaColspan = areaColumns || Config.defaultColumns;
                var groupColspan = Math.min(areaColspan, dataColspan(Config.templateEngine.getWidgetDataByElement($e.parentsUntil(
