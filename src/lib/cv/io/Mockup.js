...
define( ['joose', 'lib/cv/Config'], function(joose, Config) {
  "use strict";
  ...
  Class('cv.io.Mockup', {
    ...
    has: {
      dataReceived: { is: 'ro', init: true },
      addresses: { is: 'ro', init: Joose.I.Array }
    },
    ...
    after: {
      initialize: function() {
        ...
        window._widgetDataGet = Config.templateEngine.widgetDataGet.bind(Config.templateEngine);
        window.writeHistory = [];
      }
    },
