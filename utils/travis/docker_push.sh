...
docker build -t $IMAGE_NAME:$VERSION_TAG --build-arg BUILD_DATE --build-arg VCS_REF --build-arg VERSION_TAG --build-arg TRAVIS_JOB_NUMBER --build-arg TRAVIS_JOB_WEB_URL --build-arg TRAVIS_BUILD_WEB_URL .
