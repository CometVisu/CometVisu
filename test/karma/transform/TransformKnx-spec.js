...
define(['TransformDefault', 'TransformKnx'], function(Transform) {
  ...
  var testcases = [
    ...
    { transform: 'DPT:9.001', type: 'encode', source: -272.96,    target: '80a156'  },
    ...
    { transform: 'DPT:9.001', type: 'encode', source: 670433.28,  target: '807ffe'  },
    ...
    { transform: 'DPT:9.020', type: 'encode', source: -670433.28, target: '80f802' },
  ];
