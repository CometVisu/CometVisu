...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Living room" y-format="%.1f °C" series="day" refresh="300" colspan="6" rowspan="3">
...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Power" y-format="%.1f kWh" series="month" refresh="300" colspan="6" rowspan="3" x-format="%d. %b">
...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Power" selection="week,month,year" y-format="%.1f kWh" series="month" refresh="300" colspan="6" rowspan="3" x-format="%d. %b">
                <dataset src="openhab://Meter_Energy_Grid_Import_Today" title="Grid withdrawal" color="#FF0000" show-area="false"/>
              </cv-chart>
        </cv-tile>
    </cv-widget>
...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Living room" y-format="%.1f °C" series="day" refresh="300" colspan="6" rowspan="3" show-grid="false">
...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Power" selection="month" y-format="%.1f kWh" series="month" refresh="300" colspan="6" rowspan="3" x-format="%d. %b">
                <dataset src="openhab://Meter_Energy_Grid_Import_Today" title="Grid withdrawal" color="#FF0000" show-area="false"/>
...
.. code-block:: xml
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Strom" selection="month" y-format="%.1f kWh" series="month" refresh="300" colspan="6" rowspan="3" x-format="%d. %b">
...
.. widget-example::
    ...
    <cv-widget size="2x1">
        <cv-tile>
            <cv-chart title="Power" selection="day" y-format="%.1f kWh" series="day" refresh="300" colspan="6" rowspan="3" x-format="%d. %b">
                <dataset src="openhab://Meter_Energy_Grid_Import_Today" title="Grid withdrawal" color="#FF0000" show-area="false"/>
