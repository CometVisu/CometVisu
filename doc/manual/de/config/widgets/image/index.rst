...
Hier der minimale Beispielcode der das Image Widget aus dem folgenden Screenshot erzeugt:

.. widget_example::

        <settings>
            <screenshot name="image_simple">
                <caption>Image, einfaches Beispiel</caption>
...
ein Image-Widget ohne die Rückmeldeaddresse in der Praxis keinen Sinn,
...
.. widget_example::
        ...
        <settings>
            <screenshot name="image_complete">
                <caption>Image mit mapping + styling</caption>
        ...
        <image mapping="OnOff" styling="RedGreen">
          <label>Image</label>
          <address transform="DPT:1.001" mode="readwrite">1/1/0</address>
          <address transform="DPT:1.001" mode="read">1/4/0</address>
        </image>
