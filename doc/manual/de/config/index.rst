...
Kommunikation mit dem Backend was darüber die ensprechenden Informationen
...
transform Legt den Datentyp im Backend fest, z.B. ``DPT:1.001`` für den KNX
          Datenpunkttyp 1.001
mode      Legt fest, ob auf dieser Adresse nur gehocht (``read``), geschrieben
          (``write``) oder beides (``readwrite``) werden soll
variant   Optional und Widget spezifisch: manche Widgets können mehrere Adressen
          gleichzeitig benötigen, z.B. um für eine Farbe den roten, grünen und
          blauen Kanal unterscheiden zu können
========= ======================================================================
