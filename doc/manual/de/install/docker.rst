...
+=====================+==============================-----------+=================================================================+
|KNX_INTERFACE        |````                                     |knxd-URL für die KNX Schnittstelle. Wenn leer, so wird der       |
|                     |                                         |``knxd`` nicht geladen.                                          |
+---------------------+-----------------------------------------+-----------------------------------------------------------------+
|KNX_PA               |``1.1.238``                              |Physikalische Schnittstelle (PA) für den ``knxd``.               |
+---------------------+-----------------------------------------+-----------------------------------------------------------------+
|KNX_CLIENT_PAS       |``1.1.239:10``                           |An Client-Verbindungen zu verteilender Adressbereich.            |
+---------------------+-----------------------------------------+-----------------------------------------------------------------+
|KNX_INTERFACE_OPTIONS|``-B single -A retry-delay=1``           |Spezifische Aufruf-Parameter für das KNX_INTERFACE des ``knxd``. |
+---------------------+-----------------------------------------+-----------------------------------------------------------------+
