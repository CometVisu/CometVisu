...
ein Web-Widget ohne die Rückmeldeaddresse in der Praxis keinen Sinn,
...
Hier der Beispielcode der das Web-Widget mit den allen gezeigten
Eigenschaften einfügt, inkl. der benutzten Mappings / Stylings:

.. widget_example::

        <settings>
            <screenshot name="web_complete">
                <caption>Web mit mapping + styling</caption>
        ...
        <web mapping="OnOff" styling="RedGreen">
          <label>Web</label>
          <address transform="DPT:1.001" mode="readwrite">1/1/0</address>
          <address transform="DPT:1.001" mode="read">1/4/0</address>
        </web>
